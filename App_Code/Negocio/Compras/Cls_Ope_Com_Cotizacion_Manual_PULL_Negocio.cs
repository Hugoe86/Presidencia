...
using Presidencia.Cotizacion_Manual_Pull.Datos;

/// <summary>
/// Summary description for Cls_Ope_Com_Cotizacion_Manual_PULL_Negocio
/// </summary>
/// 
namespace Presidencia.Cotizacion_Manual_Pull.Negocio
{

    public class Cls_Ope_Com_Cotizacion_Manual_PULL_Negocio
    {
        ///*******************************************************************************
        /// VARIABLES INTERNAS 
        ///******************************************************************************
        ...
        private String Busqueda_Fecha_Elaboracion_Ini;
        private String Busqueda_Fecha_Elaboracion_Fin;
        ...
        public String P_Busqueda_Fecha_Elaboracion_Ini
        {
            get { return Busqueda_Fecha_Elaboracion_Ini; }
            set { Busqueda_Fecha_Elaboracion_Ini = value; }
        }
        public String P_Busqueda_Fecha_Elaboracion_Fin
        {
            get { return Busqueda_Fecha_Elaboracion_Fin; }
            set { Busqueda_Fecha_Elaboracion_Fin = value; }
        }
        ...
        {
            return Cls_Ope_Com_Cotizacion_Manual_PULL_Datos.Consultar_Productos_Servicios(this);
        }

        public DataTable Consultar_Requisiciones()
        {
            return Cls_Ope_Com_Cotizacion_Manual_PULL_Datos.Consultar_Requisiciones(this);
        }

        public DataTable Consultar_Detalle_Requisicion()
        {
            return Cls_Ope_Com_Cotizacion_Manual_PULL_Datos.Consultar_Detalle_Requisicion(this);
        }

        public DataTable Consultar_Impuesto_Producto()
        {
            return Cls_Ope_Com_Cotizacion_Manual_PULL_Datos.Consultar_Impuesto_Producto(this);
        }

        public bool Guardar_Cotizacion()
        {
            return Cls_Ope_Com_Cotizacion_Manual_PULL_Datos.Guardar_Cotizacion(this);
        }

        public DataTable Consultar_Propuesta_Cotizacion()
        {
            return Cls_Ope_Com_Cotizacion_Manual_PULL_Datos.Consultar_Propuesta_Cotizacion(this);
        }

        public DataTable Consultar_Proveedores()
        {
            return Cls_Ope_Com_Cotizacion_Manual_PULL_Datos.Consultar_Proveedores(this);

        }

        public DataTable Consultar_Cotizadores()
        {
            return Cls_Ope_Com_Cotizacion_Manual_PULL_Datos.Consultar_Cotizadores(this);
        }
        #endregion
