...
using Presidencia.Rpt_Retencion_IMSS.Datos;

namespace Presidencia.Rpt_Retencion_IMSS.Negocio
{
    public class Cls_Rpt_Nom_Retencion_IMSS_Negocio
    {
        ...
        #region(Métodos)
        public DataTable Consultar_Rpt_Retencion_Imss()
        {
            return Cls_Rpt_Nom_Retencion_IMSS_Datos.Consultar_Rpt_Retencion_Imss(this);
        }
        #endregion
    }
}
