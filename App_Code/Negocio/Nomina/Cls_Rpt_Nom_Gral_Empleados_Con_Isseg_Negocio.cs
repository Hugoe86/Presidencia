...
using Presidencia.Rpt_Gral_Empleados_Con_Isseg.Datos;

namespace Presidencia.Rpt_Gral_Empleados_Con_Isseg.Negocio
{
    public class Cls_Rpt_Nom_Gral_Empleados_Con_Isseg_Negocio
    {
        ...
        #region(Métodos)
        public DataTable Consultar_Rpt_Gral_Empleados_Isseg()
        {
            return Cls_Rpt_Nom_Gral_Empleados_Con_Isseg_Datos.Consultar_Rpt_Gral_Empleados_Isseg(this);
        }
        #endregion
    }
}
