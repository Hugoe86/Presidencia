...
using Presidencia.Reportes_Nomina.Prestamos.Datos;

/// <summary>
/// Summary description for Cls_Rpt_Nom_Prestamos_Negocio
/// </summary>
namespace Presidencia.Reportes_Nomina.Prestamos.Negocio {
    public class Cls_Rpt_Nom_Prestamos_Negocio {
        ...
        #region "Metodos"
            public DataTable Consultar_Datos_Prestamos() {
                return Cls_Rpt_Nom_Prestamos_Datos.Consultar_Datos_Prestamos(this);
            }
            public static DataTable Consultar_Dependencias_Activas() {
                return Cls_Rpt_Nom_Prestamos_Datos.Consultar_Dependencias_Activas();
            }
            public static DataTable Consultar_Tipos_Nomina() {
                return Cls_Rpt_Nom_Prestamos_Datos.Consultar_Tipos_Nomina();
            }
        #endregion
	}
}