...
using Presidencia.Operacion_Predial_Convenios_Impuestos_Traslado_Dominio.Datos;

/// <summary>
/// Summary description for Cls_Ope_Pre_Convenios_Impuestos_Traslado_Dominio_Negocio
/// </summary>

namespace Presidencia.Operacion_Predial_Convenios_Impuestos_Traslado_Dominio.Negocio
{

    public class Cls_Ope_Pre_Convenios_Impuestos_Traslado_Dominio_Negocio
    {
        ...
        private Boolean Mostrar_Convenio_Con_Reestructura;
        ...
        public Boolean P_Mostrar_Convenio_Con_Reestructura
        {
            get { return Mostrar_Convenio_Con_Reestructura; }
            set { Mostrar_Convenio_Con_Reestructura = value; }
        }
        ...
        #region Metodos
            ...
            public Boolean Alta_Convenio_Traslado_Dominio()
            {
                return Cls_Ope_Pre_Convenios_Impuestos_Traslado_Dominio_Datos.Alta_Convenio_Traslado_Dominio(this);
            }

            public Boolean Alta_Reestructura_Convenio_Traslado_Dominio()
            {
                return Cls_Ope_Pre_Convenios_Impuestos_Traslado_Dominio_Datos.Alta_Reestructura_Convenio_Traslado_Dominio(this);
            }

            public Boolean Modificar_Convenio_Traslado_Dominio()
            {
                return Cls_Ope_Pre_Convenios_Impuestos_Traslado_Dominio_Datos.Modificar_Convenio_Traslado_Dominio(this);
            }

            public Boolean Modificar_Reestructura_Convenio_Traslado_Dominio()
            {
                return Cls_Ope_Pre_Convenios_Impuestos_Traslado_Dominio_Datos.Modificar_Reestructura_Convenio_Traslado_Dominio(this);
            }

            public Boolean Modificar_Estatus_Convenio_Reestructura()
            {
                return Cls_Ope_Pre_Convenios_Impuestos_Traslado_Dominio_Datos.Modificar_Estatus_Convenio_Reestructura(this);
            }

            public Boolean Convenio_Incumplido()
            {
                return Cls_Ope_Pre_Convenios_Impuestos_Traslado_Dominio_Datos.Convenio_Incumplido(this);
            }

            public DataTable Consultar_Convenio_Traslado_Dominio()
            {
                return Cls_Ope_Pre_Convenios_Impuestos_Traslado_Dominio_Datos.Consultar_Convenio_Traslado_Dominio(this);
            }

            public Boolean Consultar_Convenio_Existente()
            {
                return Cls_Ope_Pre_Convenios_Impuestos_Traslado_Dominio_Datos.Consultar_Convenio_Existente(this);
            }

            public DataTable Consultar_Adeudos_Convenio(Boolean Total_O_A_Pagar)
            {
                return Cls_Ope_Pre_Convenios_Impuestos_Traslado_Dominio_Datos.Consultar_Adeudos_Convenio(this,Total_O_A_Pagar);
            }

            public DataTable Consultar_Descuentos()
            {
                return Cls_Ope_Pre_Convenios_Impuestos_Traslado_Dominio_Datos.Consultar_Descuentos(this);
            }

            public Boolean Cancelar_Pasivo(String Referencia, String Monto)
            {
                return Cls_Ope_Pre_Convenios_Impuestos_Traslado_Dominio_Datos.Cancelar_Pasivo(Referencia, Monto);
            }

            public bool Eliminar_Pasivo(String Referencia)
            {
                return Cls_Ope_Pre_Convenios_Impuestos_Traslado_Dominio_Datos.Eliminar_Pasivo(Referencia);
            }

            public bool Consultar_Cuenta_Pendiente()
            {
                return Cls_Ope_Pre_Convenios_Impuestos_Traslado_Dominio_Datos.Consultar_Cuenta_Pendiente(this);
            }
