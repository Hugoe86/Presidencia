...
using Presidencia.Operacion_Cancelacion_Pago.Datos;

/// <summary>
/// Summary description for Cls_Cat_Pre_Cancelacion_Pago_Negocio
/// </summary>

namespace Presidencia.Operacion_Cancelacion_Pago.Negocio
{
    public class Cls_Ope_Pre_Cancelacion_Pago_Negocio
    {
        ...
        public void Alta_Cancelacion_Pago()
        {
            Cls_Ope_Pre_Cancelacion_Pago_Datos.Alta_Cancelacion_Pago(this);
        }

        public DataTable Consultar_Cancelacion_Pagos()
        {
            return Cls_Ope_Pre_Cancelacion_Pago_Datos.Consultar_Cancelaciones(this);
        }

        public Cls_Ope_Pre_Cancelacion_Pago_Negocio Consultar_Datos_cancelacion_Pagos()
        {
            return Cls_Ope_Pre_Cancelacion_Pago_Datos.Consultar_Datos_Cancelaciones(this);
        }

        public DataTable Consulta_Caja_Empleado()
        {
            return Cls_Ope_Pre_Cancelacion_Pago_Datos.Consulta_Caja_Empleado(this);
        }

        public DataTable Consulta_Recibos_Cancelados_Acumulado()
        {
            return Cls_Ope_Pre_Cancelacion_Pago_Datos.Consulta_Recibos_Cancelados_Acumulado(this);
        }
        #endregion
    }
}