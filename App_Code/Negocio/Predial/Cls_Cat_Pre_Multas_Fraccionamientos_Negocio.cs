...
using Presidencia.Catalogo_Multas_Fraccionamientos.Datos;

/// <summary>
/// Summary description for Cls_Cat_Pre_Multas_Fraccionamientos_Negocio
/// </summary>

namespace Presidencia.Catalogo_Multas_Fraccionamientos.Negocio
{
    public class Cls_Cat_Pre_Multas_Fraccionamientos_Negocio
    {
        ...
        {
            Cls_Cat_Pre_Multas_Fraccionamientos_Datos.Alta_Multa(this);
        }

        public void Modificar_Multa()
        {
            Cls_Cat_Pre_Multas_Fraccionamientos_Datos.Modificar_Multa(this);
        }

        public void Eliminar_Multa()
        {
            Cls_Cat_Pre_Multas_Fraccionamientos_Datos.Eliminar_Multa(this);
        }

        public DataTable Consultar_Multas()
        {
            return Cls_Cat_Pre_Multas_Fraccionamientos_Datos.Consultar_Multas(this);
        }

        public DataTable Consultar_Cuotas_Multas()
        {
            return Cls_Cat_Pre_Multas_Fraccionamientos_Datos.Consultar_Cuotas_Multas(this);
        }

        public Cls_Cat_Pre_Multas_Fraccionamientos_Negocio Consultar_Datos_Multa()
        {
            return Cls_Cat_Pre_Multas_Fraccionamientos_Datos.Consultar_Datos_Multa(this);
        }
