...
using Presidencia.Operacion_Predial_Convenios_Derechos_Supervision.Datos;

/// <summary>
/// Summary description for Cls_Ope_Pre_Convenios_Derechos_Supervision_Negocio
/// </summary>

namespace Presidencia.Operacion_Predial_Convenios_Derechos_Supervision.Negocio
{

    public class Cls_Ope_Pre_Convenios_Derechos_Supervision_Negocio
    {
        ...
        private String No_Impuesto_Dereho_Supervisio;
        ...
        public String P_No_Impuesto_Dereho_Supervisio
        {
            get { return No_Impuesto_Dereho_Supervisio; }
            set { No_Impuesto_Dereho_Supervisio = value; }
        }
        ...
        #region Metodos
            ...
            public Boolean Alta_Convenio_Derecho_Supervision()
            {
                return Cls_Ope_Pre_Convenios_Derechos_Supervision_Datos.Alta_Convenio_Derecho_Supervision(this);
            }

            public Boolean Alta_Reestructura_Convenio_Derecho_Supervision()
            {
                return Cls_Ope_Pre_Convenios_Derechos_Supervision_Datos.Alta_Reestructura_Convenio_Derecho_Supervision(this);
            }

            public Boolean Modificar_Convenio_Derecho_Supervision()
            {
                return Cls_Ope_Pre_Convenios_Derechos_Supervision_Datos.Modificar_Convenio_Derecho_Supervision(this);
            }

            public Boolean Modificar_Reestructura_Convenio_Derecho_Supervision()
            {
                return Cls_Ope_Pre_Convenios_Derechos_Supervision_Datos.Modificar_Reestructura_Convenio_Derecho_Supervision(this);
            }

            public Boolean Modificar_Estatus_Convenio_Reestructura()
            {
                return Cls_Ope_Pre_Convenios_Derechos_Supervision_Datos.Modificar_Estatus_Convenio_Reestructura(this);
            }

            public Boolean Convenio_Incumplido()
            {
                return Cls_Ope_Pre_Convenios_Derechos_Supervision_Datos.Convenio_Incumplido(this);
            }

            public DataTable Consultar_Convenio_Derecho_Supervisions()
            {
                return Cls_Ope_Pre_Convenios_Derechos_Supervision_Datos.Consultar_Convenio_Derecho_Supervision(this);
            }

            public DataTable Consultar_Adeudos_Derecho_Supervisions(Boolean Total_O_A_Pagar)
            {
                return Cls_Ope_Pre_Convenios_Derechos_Supervision_Datos.Consultar_Adeudos_Derecho_Supervisions(this, Total_O_A_Pagar);
            }

            public Boolean Cancelar_Pasivo(String Referencia, String Monto)
            {
                return Cls_Ope_Pre_Convenios_Derechos_Supervision_Datos.Cancelar_Pasivo(Referencia, Monto);
            }

            public DataTable Consultar_Descuentos()
            {
                return Cls_Ope_Pre_Convenios_Derechos_Supervision_Datos.Consultar_Descuentos(this);
            }

            public bool Eliminar_Pasivo(String Referencia)
            {
                return Cls_Ope_Pre_Convenios_Derechos_Supervision_Datos.Eliminar_Pasivo(Referencia);
            }

            public DataTable Consultar_Datos_A_Eliminar()
            {
                return Cls_Ope_Pre_Convenios_Derechos_Supervision_Datos.Impuesto_Para_Eliminar_Pasivo(this);
            }
