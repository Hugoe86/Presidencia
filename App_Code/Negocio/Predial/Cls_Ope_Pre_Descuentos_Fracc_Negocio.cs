...
using System.Web;
using System.Data;
using Presidencia.Ope_Pre_Descuentos_Fracc.Datos;

/// <summary>
/// Summary description for Cls_Ope_Pre_Descuentos_Fracc_Negocio
/// </summary>

namespace Presidencia.Ope_Pre_Descuentos_Fracc.Negocio
{
    public class Cls_Ope_Pre_Descuentos_Fracc_Negocio
    {
        ...
        private String No_Impuesto_Fracc;
        ...
        public String P_No_Impuesto_Fracc
        {
            get { return No_Impuesto_Fracc; }
            set { No_Impuesto_Fracc = value; }
        }
        ...
        {
            return Cls_Ope_Pre_Descuentos_Fracc_Datos.Consultar_Descuentos(this);
        }
        public DataTable Consultar_Descuento_Activo()
        {
            return Cls_Ope_Pre_Descuentos_Fracc_Datos.Consultar_Descuento_Activo(this);
        }
        public void Alta_Descuento()
        {
            Cls_Ope_Pre_Descuentos_Fracc_Datos.Alta_Descuento(this);
        }
        public void Modificar_Descuentos()
        {
            Cls_Ope_Pre_Descuentos_Fracc_Datos.Modificar_Descuento(this);
        }
