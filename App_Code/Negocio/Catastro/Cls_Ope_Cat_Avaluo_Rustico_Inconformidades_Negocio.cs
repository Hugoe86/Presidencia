...
using System.Linq;
using System.Web;
using Presidencia.Operacion_Cat_Avaluo_Rustico_Inconformidades.Datos;
using System.Data;


/// <summary>
/// Summary description for Cls_Ope_Cat_Avaluo_Rustico_Inconformidades_Negocio
/// </summary>
/// 
namespace Presidencia.Operacion_Cat_Avaluo_Rustico_Inconformidades.Negocio
{
public class Cls_Ope_Cat_Avaluo_Rustico_Inconformidades_Negocio
{
    ...
    {
        return Cls_Ope_Cat_Avaluo_Rustico_Inconformidades_Datos.Alta_Avaluo_Rustico_Inconformidades(this);
    }

    public Boolean Modificar_Avaluo_Rustico()
    {
        return Cls_Ope_Cat_Avaluo_Rustico_Inconformidades_Datos.Modificar_Avaluo_Rustico_Inconformidades(this);
    }

    public Boolean Modificar_Observaciones_Ara()
    {
        return Cls_Ope_Cat_Avaluo_Rustico_Inconformidades_Datos.Modificar_Observaciones_Ari(this);
    }

    public DataTable Consultar_Avaluo_Rustico()
    {
        return Cls_Ope_Cat_Avaluo_Rustico_Inconformidades_Datos.Consultar_Avaluo_Rustico_Inconformidades(this);
    }

    public DataTable Consultar_Tabla_Valores_Construccion()
    {
        return Cls_Ope_Cat_Avaluo_Rustico_Inconformidades_Datos.Consultar_Tabla_Valores_Construccion_Inconformidades(this);
    }

    public DataTable Consultar_Motivos_Rechazo_Avaluo()
    {
        return Cls_Ope_Cat_Avaluo_Rustico_Inconformidades_Datos.Consultar_Motivos_Rechazo_Avaluo_Inconformidades(this);
    }

    public DataTable Consultar_Tabla_Terreno()
    {
        return Cls_Ope_Cat_Avaluo_Rustico_Inconformidades_Datos.Consultar_Tabla_Terreno_Inconformidades(this);
    }

    public DataTable Consultar_Solicitud_Tramite()
    {
        return Cls_Ope_Cat_Avaluo_Rustico_Inconformidades_Datos.Consultar_Solicitud_Tramite(this);
    }

    public DataTable Consultar_Tabla_Caracteristicas_Terreno()
    {
        return Cls_Ope_Cat_Avaluo_Rustico_Inconformidades_Datos.Consultar_Tabla_Caracteristicas_Terreno_Inconformidades(this);
    }
    public DataTable Consultar_Tabla_Elementos_Construccion_Inconformidades()
    {
        return Cls_Ope_Cat_Avaluo_Rustico_Inconformidades_Datos.Consultar_Tabla_Elementos_Construccion_Inconformidades(this);
    }

    public Boolean Modificar_Estatus_Avaluo_Rustico_In()
    {
        return Cls_Ope_Cat_Avaluo_Rustico_Inconformidades_Datos.Modificar_Estatus_Avaluo_Rustico_In(this);
    }
    public DataTable Consultar_Solicitud_Tramite_Avaluos()
    {
        return Cls_Ope_Cat_Avaluo_Rustico_Inconformidades_Datos.Consultar_Solicitud_Tramite_Avaluos(this);
    }
    #endregion
