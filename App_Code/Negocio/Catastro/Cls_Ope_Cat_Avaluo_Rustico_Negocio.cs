...
using System.Linq;
using System.Web;
using Presidencia.Operacion_Cat_Avaluo_Rustico.Datos;
using System.Data;

/// <summary>
/// Summary description for Cls_Ope_Cat_Avaluo_Rustico_Negocio
/// </summary>

namespace Presidencia.Operacion_Cat_Avaluo_Rustico.Negocio
{
    public class Cls_Ope_Cat_Avaluo_Rustico_Negocio
    {
        ...
        {
            return Cls_Ope_Cat_Avaluo_Rustico_Datos.Alta_Avaluo_Rustico(this);
        }

        public Boolean Modificar_Avaluo_Rustico()
        {
            return Cls_Ope_Cat_Avaluo_Rustico_Datos.Modificar_Avaluo_Rustico(this);
        }

        public Boolean Modificar_Observaciones_Ara()
        {
            return Cls_Ope_Cat_Avaluo_Rustico_Datos.Modificar_Observaciones_Ara(this);
        }

        public DataTable Consultar_Avaluo_Rustico()
        {
            return Cls_Ope_Cat_Avaluo_Rustico_Datos.Consultar_Avaluo_Rustico(this);
        }

        public DataTable Consultar_Tabla_Valores_Construccion()
        {
            return Cls_Ope_Cat_Avaluo_Rustico_Datos.Consultar_Tabla_Valores_Construccion(this);
        }

        public DataTable Consultar_Motivos_Rechazo_Avaluo()
        {
            return Cls_Ope_Cat_Avaluo_Rustico_Datos.Consultar_Motivos_Rechazo_Avaluo(this);
        }

        public DataTable Consultar_Tabla_Terreno()
        {
            return Cls_Ope_Cat_Avaluo_Rustico_Datos.Consultar_Tabla_Terreno(this);
        }

        public DataTable Consultar_Tabla_Caracteristicas_Terreno()
        {
            return Cls_Ope_Cat_Avaluo_Rustico_Datos.Consultar_Tabla_Caracteristicas_Terreno(this);
        }

        public DataTable Consultar_Tabla_Elementos_Construccion()
        {
            return Cls_Ope_Cat_Avaluo_Rustico_Datos.Consultar_Tabla_Elementos_Construccion(this);
        }
