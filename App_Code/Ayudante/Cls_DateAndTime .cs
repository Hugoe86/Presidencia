...
namespace Presidencia.DateDiff
{
    ...
    public class Cls_DateAndTime
    {
        ...
        {
            if (nMonth <= 3)
                return 1; if (nMonth <= 6)
                return 2; if (nMonth <= 9)
                return 3; return 4;
        }
        ...
        public static long DateDiff(DateInterval interval, DateTime dt1, DateTime dt2, DayOfWeek eFirstDayOfWeek)
        {
            ...
            if (interval == DateInterval.Month)
                return (dt2.Month - dt1.Month) + (12 * (dt2.Year - dt1.Year)); TimeSpan ts = dt2 - dt1;
            ...
            if (interval == DateInterval.WeekOfYear)
            {
                while (dt2.DayOfWeek != eFirstDayOfWeek)
                    ...
                    dt1 = dt1.AddDays(-1); ts = dt2 - dt1; return Round(ts.TotalDays / 7.0);
            }
