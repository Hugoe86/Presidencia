...
/// <summary>
/// Summary description for Cls_Ope_Com_Cotizacion_Manua_Datos
/// </summary>
/// 

namespace Presidencia.Cotizacion_Manual.Datos
{

    
    public class Cls_Ope_Com_Cotizacion_Manual_Datos
    {
        #region Metodos
        ///*******************************************************************************
        ...
        ///CAUSA_MODIFICACIÓN:
        ///*******************************************************************************
        public static DataTable Consultar_Productos_Servicios(Cls_Ope_Com_Cotizacion_Manual_Negocio Clase_Negocio)
        {
            String Mi_SQL = "";
        ...
        public static DataTable Consultar_Requisiciones()
        {
            ...
            Mi_SQL = Mi_SQL + " WHERE REQ." + Ope_Com_Requisiciones.Campo_Estatus + "='FILTRADA'";
        ...
        ///CAUSA_MODIFICACIÓN:
        ///*******************************************************************************
        public static DataTable Consultar_Detalle_Requisicion(Cls_Ope_Com_Cotizacion_Manual_Negocio Clase_Negocio)
        {
        ...
        public static DataTable Consultar_Proveedores(Cls_Ope_Com_Cotizacion_Manual_Negocio Clase_Negocio)
        {
        ...
        ///CAUSA_MODIFICACIÓN:
        ///*******************************************************************************
        public static DataTable Consultar_Impuesto_Producto(Cls_Ope_Com_Cotizacion_Manual_Negocio Clase_Negocio)
        {
            String Mi_SQL = "";
            switch(Clase_Negocio.P_Tipo_Articulo)
            {
        ...
        public static bool Agregar_Cotizaciones(Cls_Ope_Com_Cotizacion_Manual_Negocio Clase_Negocio)
        {
            ...
            try
            {
                ...
                for (int i = 0; i < Clase_Negocio.P_Dt_Productos.Rows.Count; i++)
                {
                    ...
                    Mi_SQL = "UPDATE " + Ope_Com_Req_Producto.Tabla_Ope_Com_Req_Producto +
                             ...
                             "='" + Clase_Negocio.P_Dt_Productos.Rows[i][Ope_Com_Req_Producto.Campo_Precio_U_Sin_Imp_Cotizado] + "'" +
                             ", " + Ope_Com_Req_Producto.Campo_Precio_U_Con_Imp_Cotizado +
                             "='" + Clase_Negocio.P_Dt_Productos.Rows[i][Ope_Com_Req_Producto.Campo_Precio_U_Con_Imp_Cotizado] + "'" +
                             ", " + Ope_Com_Req_Producto.Campo_IVA_Cotizado +
                             "='" + Clase_Negocio.P_Dt_Productos.Rows[i][Ope_Com_Req_Producto.Campo_IVA_Cotizado] + "'" +
                             ", " + Ope_Com_Req_Producto.Campo_IEPS_Cotizado +
                             "='" + Clase_Negocio.P_Dt_Productos.Rows[i][Ope_Com_Req_Producto.Campo_IEPS_Cotizado] + "'" +
                             ", " + Ope_Com_Req_Producto.Campo_Subtota_Cotizado +
                             "='" + Clase_Negocio.P_Dt_Productos.Rows[i][Ope_Com_Req_Producto.Campo_Subtota_Cotizado] + "'" +
                             ", " + Ope_Com_Req_Producto.Campo_Total_Cotizado +
                             "='" + Clase_Negocio.P_Dt_Productos.Rows[i][Ope_Com_Req_Producto.Campo_Total_Cotizado] + "'" +
                             ", " + Ope_Com_Req_Producto.Campo_Proveedor_ID +
                             "='" + Clase_Negocio.P_Dt_Productos.Rows[i][Ope_Com_Req_Producto.Campo_Proveedor_ID] + "'" +
                             ", " + Ope_Com_Req_Producto.Campo_Nombre_Proveedor +
                             "='" + Clase_Negocio.P_Dt_Productos.Rows[i][Ope_Com_Req_Producto.Campo_Nombre_Proveedor] + "'" +
                             " WHERE " + Ope_Com_Req_Producto.Campo_Ope_Com_Req_Producto_ID +
                             "='" + Clase_Negocio.P_Dt_Productos.Rows[i][Ope_Com_Req_Producto.Campo_Ope_Com_Req_Producto_ID] + "'";
        ...
        public static bool Modificar_Requisicion(Cls_Ope_Com_Cotizacion_Manual_Negocio Clase_Negocio)
        {
            bool Operacion_Realizada = false;
            String Mi_SQL = "";
            try
