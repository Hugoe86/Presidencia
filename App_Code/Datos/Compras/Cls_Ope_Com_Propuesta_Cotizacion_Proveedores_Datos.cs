...
/// <summary>
/// Summary description for Cls_Ope_Com_Propuesta_Cotizacion_Proveedores_Datos
/// </summary>
/// 
namespace Presidencia.Propuesta_Cotizacion.Datos
{
    public class Cls_Ope_Com_Propuesta_Cotizacion_Proveedores_Datos
    {
        public static bool Guardar_Cotizacion(Cls_Ope_Com_Propuesta_Cotizacion_Proveedores_Negocio Clase_Negocio)
        {
            String Mi_SQL = "";
        ...
        ///CAUSA_MODIFICACIÓN:
        ///*******************************************************************************
        public static DataTable Consultar_Propuesta_Cotizacion(Cls_Ope_Com_Propuesta_Cotizacion_Proveedores_Negocio Clase_Negocio)
        {
        ...
        ///CAUSA_MODIFICACIÓN:
        ///*******************************************************************************
        public static DataTable Consultar_Productos_Servicios(Cls_Ope_Com_Propuesta_Cotizacion_Proveedores_Negocio Clase_Negocio)
        {
            String Mi_SQL = "";
            switch (Clase_Negocio.P_Tipo_Articulo)
            {
                case "PRODUCTO":
                    ...
                    Mi_SQL = Mi_SQL + " AND PROPUESTA." + Ope_Com_Propuesta_Cotizacion.Campo_Proveedor_ID;
                    Mi_SQL = Mi_SQL + "='" + Clase_Negocio.P_Proveedor_ID + "'";
                    Mi_SQL = Mi_SQL + " ORDER BY PRO." + Cat_Com_Productos.Campo_Nombre + " ASC";
                    break;
                case "SERVICIO":
                    Mi_SQL = "SELECT PROPUESTA." + Ope_Com_Propuesta_Cotizacion.Campo_Prod_Serv_ID;
                    Mi_SQL = Mi_SQL + ", PROPUESTA." + Ope_Com_Propuesta_Cotizacion.Campo_Ope_Com_Req_Producto_ID;
                    ...
                    Mi_SQL = Mi_SQL + " ORDER BY SER." + Cat_Com_Servicios.Campo_Nombre + " ASC";
        ...
        public static DataTable Consultar_Requisiciones()
        {
            ...
            Mi_SQL = Mi_SQL + " AND REQ." + Ope_Com_Requisiciones.Campo_Estatus + " IN ('PROVEEDOR') ";
        ...
        ///CAUSA_MODIFICACIÓN:
        ///*******************************************************************************
        public static DataTable Consultar_Detalle_Requisicion(Cls_Ope_Com_Propuesta_Cotizacion_Proveedores_Negocio Clase_Negocio)
        {
            String Mi_SQL = "SELECT ";
        ...
        ///CAUSA_MODIFICACIÓN:
        ///*******************************************************************************
        public static DataTable Consultar_Impuesto_Producto(Cls_Ope_Com_Propuesta_Cotizacion_Proveedores_Negocio Clase_Negocio)
        {
            String Mi_SQL = "";
