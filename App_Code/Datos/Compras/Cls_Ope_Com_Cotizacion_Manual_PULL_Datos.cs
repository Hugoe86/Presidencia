...
/// <summary>
/// Summary description for Cls_Ope_Com_Cotizacion_Manual_PULL_Datos
/// </summary>
namespace Presidencia.Cotizacion_Manual_Pull.Datos
{

    public class Cls_Ope_Com_Cotizacion_Manual_PULL_Datos
    {

        public static bool Guardar_Cotizacion(Cls_Ope_Com_Cotizacion_Manual_PULL_Negocio Clase_Negocio)
        {
            String Mi_SQL = "";
            ...
            try
            {
                for (int i = 0; i < Clase_Negocio.P_Dt_Productos.Rows.Count; i++)
                {
                    ...
                    Mi_SQL = Mi_SQL + ", " + "ELABORO_PROPUESTA" + "='";
                    Mi_SQL = Mi_SQL + Clase_Negocio.P_Elabora_Propuesta + "' ";
        ...
        ///CAUSA_MODIFICACIÓN:
        ///*******************************************************************************
        public static DataTable Consultar_Propuesta_Cotizacion(Cls_Ope_Com_Cotizacion_Manual_PULL_Negocio Clase_Negocio)
        {
            ...
            Mi_SQL = Mi_SQL + ", PROPUESTA." + Ope_Com_Propuesta_Cotizacion.Campo_Proveedor_ID + " AS " + Ope_Com_Propuesta_Cotizacion.Campo_Registro_Padron_Prov;
            ...
            Mi_SQL = Mi_SQL + ", PROPUESTA.ELABORO_PROPUESTA ";
        ...
        ///CAUSA_MODIFICACIÓN:
        ///*******************************************************************************
        public static DataTable Consultar_Productos_Servicios(Cls_Ope_Com_Cotizacion_Manual_PULL_Negocio Clase_Negocio)
        {
            String Mi_SQL = "";
            switch (Clase_Negocio.P_Tipo_Articulo)
            {
                case "PRODUCTO":
                    ...
                    Mi_SQL = Mi_SQL + " PRO." + Cat_Com_Productos.Campo_Descripcion + " AS NOMBRE_DESCRIPCION";
                    ...
                    Mi_SQL = Mi_SQL + " AND PROPUESTA." + Ope_Com_Propuesta_Cotizacion.Campo_Proveedor_ID;
                    Mi_SQL = Mi_SQL + "='" + Clase_Negocio.P_Proveedor_ID + "'";
                    Mi_SQL = Mi_SQL + " ORDER BY PROPUESTA." + Ope_Com_Propuesta_Cotizacion.Campo_Nombre_Producto_Servicion + " ASC";
                ...
                case "SERVICIO":
                    ...
                    Mi_SQL = Mi_SQL + " SER." + Cat_Com_Servicios.Campo_Comentarios + " AS NOMBRE_DESCRIPCION";
        ...
        ///CAUSA_MODIFICACIÓN:
        ///*******************************************************************************
        public static DataTable Consultar_Requisiciones(Cls_Ope_Com_Cotizacion_Manual_PULL_Negocio Clase_Negocio)
        {
            ...
            Mi_SQL = Mi_SQL + " WHERE PROPUESTA." + Ope_Com_Propuesta_Cotizacion.Campo_Estatus + "='EN CONSTRUCCION'";
            Mi_SQL = Mi_SQL + " AND REQ." + Ope_Com_Requisiciones.Campo_Requisicion_ID + " IN";
        ...
        ///CAUSA_MODIFICACIÓN:
        ///*******************************************************************************
        public static DataTable Consultar_Detalle_Requisicion(Cls_Ope_Com_Cotizacion_Manual_PULL_Negocio Clase_Negocio)
        {
            String Mi_SQL = "SELECT ";
        ...
        ///CAUSA_MODIFICACIÓN:
        ///*******************************************************************************
        public static DataTable Consultar_Impuesto_Producto(Cls_Ope_Com_Cotizacion_Manual_PULL_Negocio Clase_Negocio)
        {
            String Mi_SQL = "";
            ...
            switch (Clase_Negocio.P_Tipo_Articulo)
            {
                ...
                case "SERVICIO":
                   ...
                   ", NULL AS " + Cat_Com_Productos.Campo_Impuesto_2_ID + " " +
                   ",(SELECT " + Cat_Com_Impuestos.Campo_Nombre +
                   " FROM " + Cat_Com_Impuestos.Tabla_Cat_Impuestos +
                   " WHERE SER." + Cat_Com_Servicios.Campo_Impuesto_ID + "=" +
                   Cat_Com_Impuestos.Campo_Impuesto_ID + ") AS TIPO_IMPUESTO_1 " +
                   ", NULL AS TIPO_IMPUESTO_2" +
                   ",(SELECT " + Cat_Com_Impuestos.Campo_Porcentaje_Impuesto +
                   " FROM " + Cat_Com_Impuestos.Tabla_Cat_Impuestos +
                   " WHERE SER." + Cat_Com_Servicios.Campo_Impuesto_ID + "=" +
                   Cat_Com_Impuestos.Campo_Impuesto_ID + ") AS IMPUESTO_PORCENTAJE_1 " +
                   ", NULL AS IMPUESTO_PORCENTAJE_2" +
                   " FROM " + Cat_Com_Servicios.Tabla_Cat_Com_Servicios + " SER" +
                   " INNER JOIN " + Cat_Com_Impuestos.Tabla_Cat_Impuestos + " IMPUESTOS" +
                   ...
                   " ='" + Clase_Negocio.P_Producto_ID.Trim() + "'";
        ...
        public static DataTable Consultar_Proveedores(Cls_Ope_Com_Cotizacion_Manual_PULL_Negocio Clase_Negocio)
        {
        ...
        public static DataTable Consultar_Cotizadores(Cls_Ope_Com_Cotizacion_Manual_PULL_Negocio Clase_Negocio)
        {
            
            String Mi_SQL = "";

            Mi_SQL = "SELECT " + Ope_Com_Propuesta_Cotizacion.Campo_Nombre_Cotizador + "," + Ope_Com_Propuesta_Cotizacion.Campo_Nombre_Cotizador;
            Mi_SQL = Mi_SQL + " FROM " + Ope_Com_Propuesta_Cotizacion.Tabla_Ope_Com_Propuesta_Cotizacion;
            Mi_SQL = Mi_SQL + " GROUP BY " + Ope_Com_Propuesta_Cotizacion.Campo_Nombre_Cotizador;
            return OracleHelper.ExecuteDataset(Cls_Constantes.Str_Conexion, CommandType.Text, Mi_SQL).Tables[0];
