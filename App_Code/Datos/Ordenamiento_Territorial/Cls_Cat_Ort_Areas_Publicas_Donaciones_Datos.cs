...
namespace Presidencia.Ordenamiento_Territorial_Areas_Publicas.Datos
{
    public class Cls_Cat_Ort_Areas_Publicas_Donaciones_Datos
    {
        #region Consultas
        ///*******************************************************************************
        ...
        ///CAUSA_MODIFICACIÓN   :
        ///*******************************************************************************
        public static DataTable Consultar_Areas(Cls_Cat_Ort_Areas_Publicas_Donaciones_Negocio Negocio)
        {
            ...
            try
            {
                ...
                {
                    Mi_Sql.Append(" where upper( " + Cat_Ort_Area_Public_Donac.Campo_Descripcion + " ) ");
        ...
        ///CAUSA_MODIFICACIÓN   :
        ///*******************************************************************************
        internal static Boolean Alta(Cls_Cat_Ort_Areas_Publicas_Donaciones_Negocio Negocio)
        {
            ...
            String Elemento_ID = Consecutivo_ID(Cat_Ort_Area_Public_Donac.Campo_Area_ID, Cat_Ort_Area_Public_Donac.Tabla_Cat_Ort_Area_Publica_Donacion, "5");

            try
            {
                Mi_SQL.Append("INSERT INTO " + Cat_Ort_Area_Public_Donac.Tabla_Cat_Ort_Area_Publica_Donacion + "(");
                Mi_SQL.Append(Cat_Ort_Area_Public_Donac.Campo_Area_ID);
                Mi_SQL.Append(", " + Cat_Ort_Area_Public_Donac.Campo_Descripcion);
                Mi_SQL.Append(", " + Cat_Ort_Area_Public_Donac.Campo_Usuario_Creo);
                Mi_SQL.Append(", " + Cat_Ort_Area_Public_Donac.Campo_Fecha_Creo);
        ...
        ///CAUSA_MODIFICACIÓN   :
        ///*******************************************************************************
        internal static Boolean Modificar(Cls_Cat_Ort_Areas_Publicas_Donaciones_Negocio Negocio)
        {
            StringBuilder Mi_SQL = new StringBuilder();//Variable que almacenará la consulta.
            Boolean Operacion_Completa = false;//Estado de la operacion.
            try
            {
                Mi_SQL.Append("UPDATE " + Cat_Ort_Area_Public_Donac.Tabla_Cat_Ort_Area_Publica_Donacion + " set ");
                Mi_SQL.Append(Cat_Ort_Area_Public_Donac.Campo_Descripcion + "='" + Negocio.P_Nombre + "' ");
                Mi_SQL.Append(", " + Cat_Ort_Area_Public_Donac.Campo_Usuario_Modifico + "='" + Negocio.P_Usuario + "' ");
                Mi_SQL.Append(", " + Cat_Ort_Area_Public_Donac.Campo_Fecha_Modifico + "= SYSDATE ");
                Mi_SQL.Append(" WHERE " + Cat_Ort_Area_Public_Donac.Campo_Area_ID + "='" + Negocio.P_Area_ID + "'");
        ...
        ///CAUSA_MODIFICACIÓN   :
        ///*******************************************************************************
        internal static Boolean Eliminar(Cls_Cat_Ort_Areas_Publicas_Donaciones_Negocio Negocio)
        {
            StringBuilder Mi_SQL = new StringBuilder();//Variable que almacenará la consulta.
            Boolean Operacion_Completa = false;//Estado de la operacion.
            try
            {
                Mi_SQL.Append("DELETE " + Cat_Ort_Area_Public_Donac.Tabla_Cat_Ort_Area_Publica_Donacion);
                Mi_SQL.Append(" WHERE " + Cat_Ort_Area_Public_Donac.Campo_Area_ID + "='" + Negocio.P_Area_ID + "'");
