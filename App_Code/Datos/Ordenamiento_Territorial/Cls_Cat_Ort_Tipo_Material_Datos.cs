...
namespace Presidencia.Ordenamiento_Territorial_Tipo_Material.Datos
{
    public class Cls_Cat_Ort_Tipo_Material_Datos
    {
        #region Consultas
        ///*******************************************************************************
        ...
        ///CAUSA_MODIFICACIÓN   :
        ///*******************************************************************************
        public static DataTable Consultar_Tipos_Materiales(Cls_Cat_Ort_Tipo_Material_Negocio Negocio)
        {
            ...
            try
            {
                ...
                {
                    Mi_Sql.Append(" where upper( " + Cat_Ort_Tipo_Material.Campo_Nombre + " ) ");
        ...
        ///CAUSA_MODIFICACIÓN   :
        ///*******************************************************************************
        internal static Boolean Alta(Cls_Cat_Ort_Tipo_Material_Negocio Negocio)
        {
            ...
            String Elemento_ID = Consecutivo_ID(Cat_Ort_Tipo_Material.Campo_Material_ID, Cat_Ort_Tipo_Material.Tabla_Cat_Ort_Tipo_Material, "5");

            try
            {
                Mi_SQL.Append("INSERT INTO " + Cat_Ort_Tipo_Material.Tabla_Cat_Ort_Tipo_Material + "(");
                Mi_SQL.Append(Cat_Ort_Tipo_Material.Campo_Material_ID);
                Mi_SQL.Append(", " + Cat_Ort_Tipo_Material.Campo_Nombre);
                Mi_SQL.Append(", " + Cat_Ort_Tipo_Material.Campo_Usuario_Creo);
                Mi_SQL.Append(", " + Cat_Ort_Tipo_Material.Campo_Fecha_Creo);
        ...
        ///CAUSA_MODIFICACIÓN   :
        ///*******************************************************************************
        internal static Boolean Modificar(Cls_Cat_Ort_Tipo_Material_Negocio Negocio)
        {
            StringBuilder Mi_SQL = new StringBuilder();//Variable que almacenará la consulta.
            Boolean Operacion_Completa = false;//Estado de la operacion.
            try
            {
                Mi_SQL.Append("UPDATE " + Cat_Ort_Tipo_Material.Tabla_Cat_Ort_Tipo_Material + " set ");
                Mi_SQL.Append(Cat_Ort_Tipo_Material.Campo_Nombre + "='" + Negocio.P_Nombre + "' ");
                Mi_SQL.Append(", " + Cat_Ort_Tipo_Material.Campo_Usuario_Modifico + "='" + Negocio.P_Usuario + "' ");
                Mi_SQL.Append(", " + Cat_Ort_Tipo_Material.Campo_Fecha_Modifico + "= SYSDATE ");
                Mi_SQL.Append(" WHERE " + Cat_Ort_Tipo_Material.Campo_Material_ID + "='" + Negocio.P_Tipo_Material_ID + "'");
        ...
        ///CAUSA_MODIFICACIÓN   :
        ///*******************************************************************************
        internal static Boolean Eliminar(Cls_Cat_Ort_Tipo_Material_Negocio Negocio)
        {
            StringBuilder Mi_SQL = new StringBuilder();//Variable que almacenará la consulta.
            Boolean Operacion_Completa = false;//Estado de la operacion.
            try
            {
                Mi_SQL.Append("DELETE " + Cat_Ort_Tipo_Material.Tabla_Cat_Ort_Tipo_Material);
                Mi_SQL.Append(" WHERE " + Cat_Ort_Tipo_Material.Campo_Material_ID + "='" + Negocio.P_Tipo_Material_ID + "'");
