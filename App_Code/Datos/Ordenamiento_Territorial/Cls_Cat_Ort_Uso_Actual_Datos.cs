...
using System.Text;
using Presidencia.Ordenamiento_Territorial_Uso_Actual.Negocio;

namespace Presidencia.Ordenamiento_Territorial_Uso_Actual.Datos
{
    public class Cls_Cat_Ort_Uso_Actual_Datos
    {
        #region Consultas
        ///*******************************************************************************
        ...
        ///CAUSA_MODIFICACIÓN   :
        ///*******************************************************************************
        public static DataTable Consultar_Uso_Actual(Cls_Cat_Ort_Uso_Actual_Negocio Negocio)
        {
            ...
            try
            {
                ...
                {
                    Mi_Sql.Append(" where upper( " + Cat_Ort_Uso_Actual.Campo_Descripcion + " ) ");
        ...
        ///CAUSA_MODIFICACIÓN   :
        ///*******************************************************************************
        internal static Boolean Alta(Cls_Cat_Ort_Uso_Actual_Negocio Negocio)
        {
            ...
            String Elemento_ID = Consecutivo_ID(Cat_Ort_Uso_Actual.Campo_Uso_Actual_ID, Cat_Ort_Uso_Actual.Tabla_Cat_Ort_Uso_Actual, "5");

            try
            {
                Mi_SQL.Append("INSERT INTO " + Cat_Ort_Uso_Actual.Tabla_Cat_Ort_Uso_Actual + "(");
                Mi_SQL.Append(Cat_Ort_Uso_Actual.Campo_Uso_Actual_ID);
                Mi_SQL.Append(", " + Cat_Ort_Uso_Actual.Campo_Descripcion);
                Mi_SQL.Append(", " + Cat_Ort_Uso_Actual.Campo_Usuario_Creo);
                Mi_SQL.Append(", " + Cat_Ort_Uso_Actual.Campo_Fecha_Creo);
        ...
        ///CAUSA_MODIFICACIÓN   :
        ///*******************************************************************************
        internal static Boolean Modificar(Cls_Cat_Ort_Uso_Actual_Negocio Negocio)
        {
            StringBuilder Mi_SQL = new StringBuilder();//Variable que almacenará la consulta.
            Boolean Operacion_Completa = false;//Estado de la operacion.
            try
            {
                Mi_SQL.Append("UPDATE " + Cat_Ort_Uso_Actual.Tabla_Cat_Ort_Uso_Actual + " set ");
                Mi_SQL.Append(Cat_Ort_Uso_Actual.Campo_Descripcion + "='" + Negocio.P_Nombre + "' ");
                Mi_SQL.Append(", " + Cat_Ort_Uso_Actual.Campo_Usuario_Modifico + "='" + Negocio.P_Usuario + "' ");
                Mi_SQL.Append(", " + Cat_Ort_Uso_Actual.Campo_Fecha_Modifico + "= SYSDATE ");
                Mi_SQL.Append(" WHERE " + Cat_Ort_Uso_Actual.Campo_Uso_Actual_ID + "='" + Negocio.P_Uso_Actual_ID + "'");
            ...
            {
                throw new Exception("Error al ejecutar al modificar. Error: [" + Ex.Message + "]");
            }
            return Operacion_Completa;
        }
        ///*******************************************************************************
        ...
        ///CAUSA_MODIFICACIÓN   :
        ///*******************************************************************************
        internal static Boolean Eliminar(Cls_Cat_Ort_Uso_Actual_Negocio Negocio)
        {
            StringBuilder Mi_SQL = new StringBuilder();//Variable que almacenará la consulta.
            Boolean Operacion_Completa = false;//Estado de la operacion.
            try
            {
                Mi_SQL.Append("DELETE " + Cat_Ort_Uso_Actual.Tabla_Cat_Ort_Uso_Actual);
                Mi_SQL.Append(" WHERE " + Cat_Ort_Uso_Actual.Campo_Uso_Actual_ID + "='" + Negocio.P_Uso_Actual_ID + "'");
