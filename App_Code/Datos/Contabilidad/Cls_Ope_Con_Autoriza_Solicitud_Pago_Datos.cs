...
using System.Text;
using Presidencia.Autoriza_Solicitud_Pago.Negocio;

/// <summary>
/// Summary description for Cls_Ope_Con_Autoriza_Solicitud_Pago_Datos
/// </summary>

namespace Presidencia.Autoriza_Solicitud_Pago.Datos
{
    public class Cls_Ope_Con_Autoriza_Solicitud_Pago_Datos
    {
        ...
        public static DataTable Consulta_Solicitudes_SinAutotizar(Cls_Ope_Con_Autoriza_Solicitud_Pago_Negocio   Datos)
        {
            ...
            try
            {
                ...
                Mi_SQL += " WHERE solicitud." + Ope_Con_Solicitud_Pagos.Campo_Estatus  + " = 'PENDIENTE' AND Solicitud."+ Ope_Con_Solicitud_Pagos.Campo_Tipo_Solicitud_Pago_ID +" = Tipo."+ Cat_Con_Tipo_Solicitud_Pagos.Campo_Tipo_Solicitud_Pago_ID ;
