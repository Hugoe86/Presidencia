...
namespace Presidencia.Tramites_Actividades.Datos
{
    public class Cls_Cat_Tra_Actividades_Datos
    {
        #region Consultas
        ///*******************************************************************************
        ///NOMBRE DE LA FUNCIÓN : Consultar_Actividades
        ...
        ///CAUSA_MODIFICACIÓN   :
        ///*******************************************************************************
        public static DataTable Consultar_Actividades(Cls_Cat_Tra_Actividades_Negocio Negocio)
        {
            StringBuilder Mi_Sql = new StringBuilder();
            try
            {
                Mi_Sql.Append("SELECT * " + " FROM " + Cat_Tra_Actividades.Tabla_Cat_Tra_Actividades);

                if (!String.IsNullOrEmpty(Negocio.P_Nombre))
                {
                    Mi_Sql.Append(" where upper( " + Cat_Tra_Actividades.Campo_Nombre + " ) ");
                    Mi_Sql.Append(" LIKE ( upper ( '%" + Negocio.P_Nombre + "%' ) ) ");
                }

                Mi_Sql.Append(" ORDER BY " + Cat_Tra_Actividades.Campo_Nombre);
        ...
        ///CAUSA_MODIFICACIÓN   :
        ///*******************************************************************************
        internal static Boolean Alta(Cls_Cat_Tra_Actividades_Negocio Negocio)
        {
            ...
            String Elemento_ID = Consecutivo_ID(Cat_Tra_Actividades.Campo_Actividad_ID, Cat_Tra_Actividades.Tabla_Cat_Tra_Actividades, "5");

            try
            {
                Mi_SQL.Append("INSERT INTO " + Cat_Tra_Actividades.Tabla_Cat_Tra_Actividades + "(");
                Mi_SQL.Append(Cat_Tra_Actividades.Campo_Actividad_ID);
                Mi_SQL.Append(", " + Cat_Tra_Actividades.Campo_Nombre);
                Mi_SQL.Append(", " + Cat_Tra_Actividades.Campo_Usuario_Creo);
                Mi_SQL.Append(", " + Cat_Tra_Actividades.Campo_Fecha_Creo);
        ...
        ///CAUSA_MODIFICACIÓN   :
        ///*******************************************************************************
        internal static Boolean Modificar(Cls_Cat_Tra_Actividades_Negocio Negocio)
        {
            StringBuilder Mi_SQL = new StringBuilder();//Variable que almacenará la consulta.
            Boolean Operacion_Completa = false;//Estado de la operacion.
            try
            {
                Mi_SQL.Append("UPDATE " + Cat_Tra_Actividades.Tabla_Cat_Tra_Actividades + " set ");
                Mi_SQL.Append(Cat_Tra_Actividades.Campo_Nombre + "='" + Negocio.P_Nombre + "' ");
                Mi_SQL.Append(", " + Cat_Tra_Actividades.Campo_Usuario_Modifico + "='" + Negocio.P_Usuario + "' ");
                Mi_SQL.Append(", " + Cat_Tra_Actividades.Campo_Fecha_Modifico + "= SYSDATE ");
                Mi_SQL.Append(" WHERE " + Cat_Tra_Actividades.Campo_Actividad_ID + "='" + Negocio.P_Actividad_ID + "'");
        ...
        ///CAUSA_MODIFICACIÓN   :
        ///*******************************************************************************
        internal static Boolean Eliminar(Cls_Cat_Tra_Actividades_Negocio Negocio)
        {
            StringBuilder Mi_SQL = new StringBuilder();//Variable que almacenará la consulta.
            Boolean Operacion_Completa = false;//Estado de la operacion.
            try
            {
                Mi_SQL.Append("DELETE " + Cat_Tra_Actividades.Tabla_Cat_Tra_Actividades);
                Mi_SQL.Append(" WHERE " + Cat_Tra_Actividades.Campo_Actividad_ID + "='" + Negocio.P_Actividad_ID + "'");
