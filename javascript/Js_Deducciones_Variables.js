...
var Pagina;
Pagina=$(document);
Pagina.ready(Inicializar_Eventos_Deducciones_Variables);

function Inicializar_Eventos_Deducciones_Variables()
{
    Contar_Caracteres_Comentarios_Deducciones_Var();
...
function Contar_Caracteres_Comentarios_Deducciones_Var(){
