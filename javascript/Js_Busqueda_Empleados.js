 ...
 //inicializamos el grid
    $('#Tbl_Empleados').datagrid({
        ...
        onClickRow: function (rowIndex, rowData) {
            LLenar_Grid_Periodos_Vacacionales(rowData.NO_EMPLEADO);      
            $('#Div_Busquedas').window('close');         
        }
    });
}
...
///*********************************************************************************************************
 ...
 //inicializamos el grid
    $('#Tbl_Periodos_Vacacionales').datagrid({
        ...
        frozenColumns:[[
            ...
            {field:'ANIO', title: 'Año', width:75, sortable: true , resizable:true,
                formatter:function(value){
                	return '<span style="font-size:x-small">' + value + '</span>';
                }
            }          
        ...
        [[
            ...
            {field:'DIAS_DISPONIBLES', title: 'Días Disponibles', width:150, sortable: true , resizable:true,
                formatter:function(value){
                	return '<span style="font-size:x-small">' + value + '</span>';
                }
            },
