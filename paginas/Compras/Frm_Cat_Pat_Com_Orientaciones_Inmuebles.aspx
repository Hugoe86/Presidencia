<%@ Page Language="C#" MasterPageFile="~/paginas/Paginas_Generales/MasterPage.master" AutoEventWireup="true" CodeFile="Frm_Cat_Pat_Com_Orientaciones_Inmuebles.aspx.cs" Inherits="paginas_Control_Patrimonial_Frm_Cat_Pat_Com_Orientaciones_Inmuebles" Title="Catalogo de Orientaciones Inmuebles" %>
        ...
        <ContentTemplate>
            ...
            <div id="Div_Requisitos" style="background-color:#ffffff; width:100%; height:100%;">
                <table width="98%"  border="0" cellspacing="0" class="estilo_fuente">
                    <tr align="center">
                        <td class="label_titulo" colspan="2">Catálogo de Orientaciones de Bienes Inmuebles</td>
                    </tr>
                    <tr>
                        <td colspan="2">
                ...
                <center>
                    <table width="98%" class="estilo_fuente">
                        <tr>
                            <td colspan="4">
                                <asp:HiddenField ID="Hdf_Orientacion_ID" runat="server" />
                            </td>
                        </tr>
                        <tr>
                            <td style="width:18%; text-align:left;">
                                <asp:Label ID="Lbl_Orientacion_ID" runat="server" Text="Orientacion ID" ></asp:Label></td>
                            <td style="width:32%; text-align:left;">
                                <asp:TextBox ID="Txt_Orientacion_ID" runat="server" Width="50%" MaxLength="10" 
                    ...
                    <asp:GridView ID="Grid_Listado" runat="server" CssClass="GridView_1"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="ORIENTACION_ID" HeaderText="Orientación ID" 
                                SortExpression="ORIENTACION_ID"  >
