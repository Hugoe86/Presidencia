...
public partial class paginas_Compras_Frm_Ope_Modificar_Requisicion_Almacen : System.Web.UI.Page
{
    ...
    private static String P_Dt_Productos_Servicios_Auxiliares = "P_Dt_Productos_Servicios_Aux";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //if (Session.Timeout < 3)
        //{
        //    Session.Timeout = 45;
        //}
        //Mensaje de sistema
        //if (DateTime.Now >= new DateTime(2011, 10, 3, 13, 0, 0, 0))
            if (DateTime.Now <= new DateTime(2011, 10, 3, 13, 0, 0, 0))
            {
        ...
        if(!IsPostBack)
        {
            ...
            if (Session["Inicio_M"] == null)
            {
                Session["Inicio_M"] = "Inicio";
            ...
            //Cmb_Dependencia_Panel.SelectedValue = Cls_S;
    ...
    private void Evento_Grid_Requisiciones_Seleccionar(String Dato)
    {
        ...
        Llenar_Combos_Generales(Requisicion[0][Ope_Com_Requisiciones.Campo_Dependencia_ID].ToString().Trim());
    ...
    public void Llenar_Combos_Generales(String Dependencia_ID)
    {
        ...
        Cmb_Dependencia.SelectedValue = Dependencia_ID;//Cmb_Dependencia_Panel.SelectedValue;//Cls_Sessiones.Dependencia_ID_Empleado.ToString();
        Cmb_Programa.Items.Clear();
    ...
    ///*******************************************************************************
    ///NOMBRE DE LA FUNCIÓN: Actualizar_Grid_Partidas_Productos
    ///DESCRIPCIÓN:  
    ///
    ///CREO: Gustavo Angeles
    ///FECHA_CREO: 9/Diciembre/2010 
