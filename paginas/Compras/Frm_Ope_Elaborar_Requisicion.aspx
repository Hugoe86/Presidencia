<%@ Page Language="C#" MasterPageFile="~/paginas/Paginas_Generales/MasterPage.master"
    AutoEventWireup="true" CodeFile="Frm_Ope_Elaborar_Requisicion.aspx.cs" Inherits="paginas_Compras_Frm_Ope_Elaborar_Requisicion"
        ...
        <asp:UpdatePanel ID="Upl_Contenedor" runat="server">
            <ContentTemplate>
                ...
                <div id="Div_Listado_Requisiciones" runat="server">
                    <table style="width: 100%;">
                        <tr>
                            ...
                            <td colspan="3">
                                <asp:DropDownList ID="Cmb_Dependencia_Panel" runat="server" Width="99.5%" />
                            </td>
                        </tr>
                        <tr>
                            <td style="width: 15%;">
                                ...
                                <div style="overflow: auto; height: 320px; width: 99%; vertical-align: top; border-style: outset;
                                    ...
                                    <asp:GridView ID="Grid_Requisiciones" runat="server" AllowPaging="false" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="ESPECIAL_RAMO_33" HeaderText="Especial" Visible="True" SortExpression="ESPECIAL_RAMO_33">
                                                <FooterStyle HorizontalAlign="Left" />
                                                <HeaderStyle HorizontalAlign="Left" />
                                            ...
                                            <asp:BoundField DataField="Estatus" HeaderText="Estatus" Visible="True" SortExpression="Estatus">
                                                <FooterStyle HorizontalAlign="Left" />
                                                <HeaderStyle HorizontalAlign="Left" />
                                                <ItemStyle HorizontalAlign="Left" Width="14%" Font-Size="X-Small"/>
                                            </asp:BoundField>
                ...
                <div id="Div_Contenido" runat="server">
                        ...
                        <table style="width: 100%;">
                            <tr>
                                ...
                                <td style="width: 84%;" align="left" colspan="3">
                                    <asp:DropDownList ID="Cmb_Dependencia" runat="server" Width="100%" OnSelectedIndexChanged="Cmb_Dependencia_SelectedIndexChanged"
                                        AutoPostBack="true">
                                    </asp:DropDownList>
                                </td>                                
                            </tr>
                            ...
                            <tr>
                                ...
                                <td style="width: 35%;" align="left">
                                    <asp:DropDownList ID="Cmb_Compra_Especial" runat="server" Width="100%" Enabled="false">
                                    </asp:DropDownList>
                                </td>
                            </tr>
                        </table>
                    </asp:Panel>    
                    <asp:Panel ID="Panel1" runat="server" GroupingText="Datos Presupuestales"
                        Width="100%">
                        <table style="width: 100%;">
                            <tr>                            
                                ...
                                <td align="left" style="width: 34%;">
                                    <asp:DropDownList ID="Cmb_Fte_Financiamiento" runat="server" 
                                        AutoPostBack="true" 
                                        OnSelectedIndexChanged="Cmb_Fte_Financiamiento_SelectedIndexChanged" 
                                        Width="98%" />
                                </td>
                                ...
                                <td align="left" style="width: 35%;">
                                    <asp:DropDownList ID="Cmb_Programa" runat="server" AutoPostBack="true" 
                                        OnSelectedIndexChanged="Cmb_Programa_SelectedIndexChanged" Width="99%">
                                    </asp:DropDownList>
                                </td>
                            <tr>
                                ...
                                <td style="width: 35%;" align="left">
                                    <asp:Label ID="Lbl_Disponible_Partida" runat="server" Text=" $ 0.00" ForeColor="Blue"
                                        BorderColor="Blue" BorderWidth="1px" Width="98%"> </asp:Label>
                                </td>
                            </tr>
                            <tr style="display:none;">
                                ...
                                <td style="width: 84%;" align="left" colspan="3">
                                    <asp:DropDownList ID="Cmb_Partida_Presupuestal" runat="server" Width="100%" 
                                        OnSelectedIndexChanged="Cmb_Partida_Presupuestal_SelectedIndexChanged" AutoPostBack="true">
                                    </asp:DropDownList>
                                </td>
                            </tr>
                            <tr style="display:none;">
                                ...
                                <td style="width: 84%;" align="left" colspan="3">
                                    <asp:Label ID="Lbl_Codigo_Programatico" runat="server" Text="Label"></asp:Label>
                                </td>
                            </tr>                            
                        </table>
                    </asp:Panel>
                    ...
                    <asp:Panel ID="Pnl_Busqueda_Prod_Serv" runat="server" GroupingText="Búsqueda Productos - Servicios"
                        Width="100%">
                        <table style="width: 100%;">
                            <tr>
                                <td style="width: 15%;" align="left">
                            ...
                            <tr>
                                ...
                                <td style="width: 55%;" align="left" colspan="2">
                                    <asp:Label ID="Lbl_Disponible_Producto" runat="server" Text="Disponible: 0 / Precio aproximado: $ 0.00"
                                        ForeColor="Blue" BorderColor="Blue" BorderWidth="2px" Width="98%"> </asp:Label>
                                </td>
                                <td style="width: 35%;" align="left" valign="middle">
                                </td>
                            </tr>
                    ...
                    <table style="width: 100%;">
                            ...
                            <td align="center" colspan="4">
                                <asp:GridView ID="Grid_Productos_Servicios" runat="server" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="">
                                            <ItemTemplate>
                                                <asp:ImageButton ID="Btn_Eliminar_Producto" runat="server" ImageUrl="~/paginas/imagenes/gridview/grid_garbage.png"
                                                    OnClick="Btn_Eliminar_Producto_Click" CommandArgument='<%# Eval("Prod_Serv_ID") %>' />
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Center" Width="3%" />
                                            <ItemStyle HorizontalAlign="Center" Width="3%" Font-Size="X-Small"/>
                                        </asp:TemplateField>                                        
                                        ...
                                        <asp:TemplateField HeaderText="">
                                            <ItemTemplate>
                                                <asp:ImageButton ID="Btn_Restar_Producto" runat="server" ImageUrl="~/paginas/imagenes/gridview/minus_grid.png"
                                                    OnClick="Btn_Restar_Producto_Click" CommandArgument='<%# Eval("Prod_Serv_ID") %>' />
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Center" Width="10px" />
                                            <ItemStyle HorizontalAlign="Center" Width="10px" Font-Size="X-Small"/>
                                        </asp:TemplateField>                                         
  
                                        <asp:TemplateField HeaderText="">
                                            <ItemTemplate>
                                                <asp:ImageButton ID="Btn_Sumar_Producto" runat="server" ImageUrl="~/paginas/imagenes/gridview/add_grid.png"
                                                    OnClick="Btn_Sumar_Producto_Click" CommandArgument='<%# Eval("Prod_Serv_ID") %>' />
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Center" Width="10px" />
                                            <ItemStyle HorizontalAlign="Center" Width="10px" Font-Size="X-Small"/>
                                        </asp:TemplateField>                                         
                                        ...
                                        <asp:BoundField DataField="Precio_Unitario" HeaderText="$ Costo" Visible="True"
                        ...
                        <tr>
                            <td align="left" colspan="4">
                                <asp:CheckBox ID="Chk_Verificar" runat="server" Text="Verificar características de productos" Visible="false"
                        ...
                        <tr>
                            <td align="left" colspan="4">
                                ...
                                <cc1:textboxwatermarkextender id="TextBoxWatermarkExtender3" runat="server" targetcontrolid="Txt_Justificacion"
                                    watermarktext="&lt;Límite de Carácteres 3000&gt;" watermarkcssclass="watermarked">
                                    </cc1:textboxwatermarkextender>
                                    ...
                                    <tr>
                                        <td align="center">
                                            <asp:GridView ID="Grid_Productos_Servicios_Modal" runat="server" AllowPaging="false"
                                                ...
                                                GridLines="Vertical" PageSize="10" Width="98%" 
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="NOMBRE_DESCRIPCION" HeaderText="Nombre" Visible="True">
                                                        <FooterStyle HorizontalAlign="Left" />
                                                        <HeaderStyle HorizontalAlign="Left" />
