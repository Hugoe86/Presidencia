...
public partial class paginas_Control_Patrimonial_Frm_Cat_Pat_Com_Orientaciones_Inmuebles : System.Web.UI.Page {
    ...
    #region Metodos
        ...
        private void Limpiar_Catalogo() {
            Hdf_Orientacion_ID.Value = "";
            Txt_Orientacion_ID.Text = "";
        ...
        private void Llenar_Grid_Listado(int Pagina) {
            try{
                Cls_Cat_Pat_Com_Orientaciones_Inmuebles_Negocio Negocio = new Cls_Cat_Pat_Com_Orientaciones_Inmuebles_Negocio();
                Negocio.P_Descripcion = Txt_Busqueda.Text.Trim();
                Grid_Listado.DataSource = Negocio.Consultar_Orientaciones();
        ...
        protected void Grid_Listado_SelectedIndexChanged(object sender, EventArgs e)
        {
            try{
                if (Grid_Listado.SelectedIndex > (-1)){
                    Limpiar_Catalogo();
                    Cls_Cat_Pat_Com_Orientaciones_Inmuebles_Negocio Negocio = new Cls_Cat_Pat_Com_Orientaciones_Inmuebles_Negocio();
                    Negocio.P_Orientacion_ID = HttpUtility.HtmlDecode(Grid_Listado.SelectedRow.Cells[1].Text.Trim());
                    Negocio = Negocio.Consultar_Detalles_Orientacion();
                    Hdf_Orientacion_ID.Value = Negocio.P_Orientacion_ID;
                    Txt_Orientacion_ID.Text = Negocio.P_Orientacion_ID;
                    Txt_Descripcion.Text = Negocio.P_Descripcion;
        ...
        protected void Btn_Modificar_Click(object sender, EventArgs e){
            try{
                if (Btn_Modificar.AlternateText.Equals("Modificar")){
                    ...
                    if (Validar_Componentes()){
                        Cls_Cat_Pat_Com_Orientaciones_Inmuebles_Negocio Negocio = new Cls_Cat_Pat_Com_Orientaciones_Inmuebles_Negocio();
                        Negocio.P_Orientacion_ID = Hdf_Orientacion_ID.Value;
                        Negocio.P_Descripcion = Txt_Descripcion.Text.Trim();
                        Negocio.P_Estatus = Cmb_Estatus.SelectedItem.Value;
                        Negocio.P_Usuario = Cls_Sessiones.Nombre_Empleado;
                        Negocio.Modificar_Orientacion();
                        Configuracion_Formulario(true);
                        Limpiar_Catalogo();
                        Llenar_Grid_Listado(Grid_Listado.PageIndex);
