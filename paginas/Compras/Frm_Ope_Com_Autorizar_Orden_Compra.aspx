<%@ Page Language="C#" MasterPageFile="~/paginas/Paginas_Generales/MasterPage.master" AutoEventWireup="true" CodeFile="Frm_Ope_Com_Autorizar_Orden_Compra.aspx.cs" Inherits="paginas_Compras_Frm_Ope_Com_Autorizar_Orden_Compra" Title="Asignación de reserva" %>
           ...
           <ContentTemplate>
              <asp:UpdateProgress ID="Upgrade" runat="server" AssociatedUpdatePanelID="Upl_Contenedor"
                ...
                <div id="Div_Encabezado" runat="server">  
                    ...
                    <tr align="center">
                        <td colspan="2" class="label_titulo">Asignación de Reserva a Orden de Compra</td>
                    </tr>
