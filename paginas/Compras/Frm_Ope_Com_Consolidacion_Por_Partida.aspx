...
CodeFile="Frm_Ope_Com_Consolidacion_Por_Partida.aspx.cs" 
Inherits="paginas_Compras_Frm_Ope_Com_Consolidacion_Por_Partida" 
Title="Consolidaciones" Culture="es-MX"%>
                    ...
                    <table style="width: 100%;" border="0" cellspacing="0">
                        <tr align="center">
                            <td colspan="4" class="label_titulo">
                                Requisiciones con partida presupuestal similar <br />
                                (Consolidaciones)
                            </td>
                        </tr>
                        <tr align="left">
                        ...
                        <tr >
                            ...
                            <td colspan="3">
                                <asp:DropDownList ID="Cmb_Partida_Presupuestal" runat="server" Width="100%"
                                    AutoPostBack="true" 
                                    onselectedindexchanged="Cmb_Partida_Presupuestal_SelectedIndexChanged">
                                </asp:DropDownList>
                            </td>
                            ...
                            <td style="width: 99%;" align="center" colspan="4">
                              <div style="overflow:auto;height:320px;width:99%;vertical-align:top;
                                ...
                                <asp:GridView ID="Grid_Requisiciones" runat="server" AutoGenerateColumns="False" CssClass="GridView_1" GridLines="None" Width="100%"
                                    ...
                                    AllowSorting="false" HeaderStyle-CssClass="tblHead" OnSorting="Grid_Requisiciones_Sorting" 
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="ORDEN" HeaderText="Orden" Visible="false" SortExpression="No_Requisicion">
                                            <HeaderStyle HorizontalAlign="Left" />
                                            <ItemStyle HorizontalAlign="Center" Width="8%" Font-Size="X-Small"/>
                                        </asp:BoundField>                                         
                                        
                                        <asp:BoundField DataField="GRUPO" HeaderText="Grupo" Visible="True" SortExpression="No_Requisicion">
                                            <HeaderStyle HorizontalAlign="Left" />
                                            <ItemStyle HorizontalAlign="Center" Width="8%" Font-Size="X-Small"/>
                                        </asp:BoundField>                                                                                                                    
                                        ...
                                        <asp:BoundField DataField="UR" HeaderText="Unidad Responsable" Visible="True" SortExpression="UR">
                                            <FooterStyle HorizontalAlign="Left" />
                                            <HeaderStyle HorizontalAlign="Left" />
                                            <ItemStyle HorizontalAlign="Left" Font-Size="X-Small"/>
                                        </asp:BoundField>                                                                             
                                                                                  
                                        <asp:BoundField DataField="CLAVE_NOMBRE_PARTIDA" HeaderText="Partida" Visible="True" SortExpression="Estatus">
                                            <FooterStyle HorizontalAlign="Left" />
                                            <HeaderStyle HorizontalAlign="Left" />
                                        ...
                                        <asp:BoundField DataField="IMPORTE" HeaderText="Importe" DataFormatString="{0:c}">
                                            ...
                                            <ItemStyle HorizontalAlign="Right" Font-Size="X-Small" Width="10%"/>
                                        </asp:BoundField>                                       
                                    </Columns>
