<%@ Page Title="Catálogo de Marcas" Language="C#" MasterPageFile="~/paginas/Paginas_Generales/MasterPage.master" AutoEventWireup="true" CodeFile="Frm_Cat_Com_Marcas.aspx.cs" Inherits="paginas_Compras_Frm_Cat_Com_Marcas" %>
...
<asp:ScriptManager ID="ScriptManager1" runat="server">
    ...
    <asp:UpdatePanel ID="Upd_Panel" runat="server">
        <ContentTemplate>
        <asp:UpdateProgress ID="Uprg_Marcas" runat="server" AssociatedUpdatePanelID="Upd_Panel" DisplayAfter="0">
                    <ProgressTemplate>
                        <div id="progressBackgroundFilter" class="progressBackgroundFilter"></div>
                        <div  class="processMessage" id="div_progress"> <img alt="" src="../imagenes/paginas/Updating.gif" /></div>
                    </ProgressTemplate>                     
            </asp:UpdateProgress>
            <div id="Div_Marcas" style="background-color:#ffffff; width:100%; height:100%;">
                <table border="0" cellspacing="0" class="estilo_fuente" style="width: 98%;">
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="Lbl_ID" runat="server" Text="Marca ID"></asp:Label>
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td style="width:18%">
                            <asp:Label ID="Lbl_Tipo" runat="server" Text="*Estatus"></asp:Label>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td align="center" colspan="4">
                            <asp:GridView ID="Grid_Marcas" runat="server" CssClass="GridView_1" Style="white-space:normal"
                            AutoGenerateColumns="False" AllowPaging="true" PageSize="5" Width="96%" 
                            GridLines="none" onpageindexchanging="Grid_Marcas_PageIndexChanging" 
                                onselectedindexchanged="Grid_Marcas_SelectedIndexChanged">
