<%@ Page Language="C#" MasterPageFile="~/paginas/Paginas_Generales/MasterPage.master" AutoEventWireup="true" CodeFile="Frm_Cat_Pat_Com_Tipos_Vehiculo.aspx.cs" Inherits="paginas_Compras_Frm_Cat_Pat_Com_Tipos_Vehiculo" Title="Catalogo de Tipos de Vehiculo" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Cph_Area_Trabajo1" Runat="Server">
    <asp:ScriptManager ID="ScptM_Tipos_Vehiculo" runat="server" EnableScriptLocalization="true" EnableScriptGlobalization="true" />  
        ...
        <ContentTemplate>
            ...
            <div id="Div_Requisitos" style="background-color:#ffffff; width:100%; height:100%;">
                <table width="98%"  border="0" cellspacing="0" class="estilo_fuente">
                    <tr align="center">
                        <td class="label_titulo" colspan="2">Catálogo de Tipos de Vehiculo</td>
                    </tr>
                    <tr>
                        <td colspan="2">    
                ...
                <cc1:TabContainer ID="Tab_Contenedor_Pestagnas" runat="server" Width="98%" ActiveTabIndex="0" CssClass="Tab" style="visibility:visible;">
                    <cc1:TabPanel  runat="server" HeaderText="Datos Generales"  ID="Tab_Datos_Generales"  Width="100%">
                        ...
                        <ContentTemplate>    
                            <center>
                                <table width="100%" class="estilo_fuente">
                                    ...
                                    <tr>
                                        <td style="width:13%; text-align:left; vertical-align:top;">
                                            <asp:Label ID="Lbl_Tipo_Vehiculo_ID" runat="server" Text="Tipo ID" 
                                ...
                                <br />                                
                                <asp:GridView ID="Grid_Tipos_Vehiculo" runat="server" CssClass="GridView_1"
                                    AutoGenerateColumns="False" AllowPaging="True" PageSize="10" Width="100%"
                                    GridLines= "None"
                                    onselectedindexchanged="Grid_Tipos_Vehiculo_SelectedIndexChanged" 
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="TIPO_VEHICULO_ID" HeaderText="Tipo ID" 
                                            SortExpression="TIPO_VEHICULO_ID">
                                        ...
                                        <asp:BoundField DataField="ASEGURADORA_ID" HeaderText="ASEGURADORA_ID" 
                                            SortExpression="ASEGURADORA_ID" />
                                    </Columns>
                            ...
                            <table width="100%" class="estilo_fuente">                             
                                <tr>
                                    ...
                                    <td style="width:87%; text-align:left;">
                                        ...
                                        <cc1:FilteredTextBoxExtender ID="FTE_Txt_Nombre_Archivo" runat="server" TargetControlID="Txt_Nombre_Archivo" InvalidChars="<,>,&,',!," 
                                ...
                                <tr>
                                    ...
                                    <td style="width:87%; text-align:left;">
                                        ...
                                        <cc1:FilteredTextBoxExtender ID="FTE_Txt_Comentarios_Archivo" runat="server" TargetControlID="Txt_Comentarios_Archivo" InvalidChars="<,>,&,',!," 
                                                                        FilterType="Custom, Numbers, UppercaseLetters, LowercaseLetters" ValidChars="Ññ.,:;()áéíóúÁÉÍÓÚ " Enabled="True">   
                                        </cc1:FilteredTextBoxExtender>
                                        <cc1:TextBoxWatermarkExtender ID="TWE_Txt_Comentarios_Archivo" runat="server" WatermarkText="Longitud Maxima de 200 Caracteres" TargetControlID="Txt_Comentarios_Archivo" 
                                                                        WatermarkCssClass="watermarked"></cc1:TextBoxWatermarkExtender>                                                
                                    </td>
                                </tr>                  
                                <tr>
                                    ...
                                    <td style="width:87%; text-align:left;">
                                        <cc1:AsyncFileUpload ID="AFU_Archivo" runat="server" Width="650px" CompleteBackColor="LightBlue" ErrorBackColor="Red" 
                                            ThrobberID="Throbber" UploadingBackColor="LightGray" Enabled="true" />
                                        <asp:ImageButton ID="Btn_Limpiar_FileUpload" runat="server" ImageUrl="~/paginas/imagenes/paginas/icono_limpiar.png" Width="16px" Height="16px" CssClass="Img_Button"
                                            AlternateText="Limpiar Archivo" ToolTip="Limpiar Archivo"/>                                      
                                    </td>
                                </tr>  
                                <tr>
                                    <td colspan="4">
                                        <asp:GridView ID="Grid_Archivos" runat="server" AutoGenerateColumns="False" 
                                            ...
                                            GridLines="None" AllowPaging="True" Width="99%" PageSize="10" 
                    ...
                    <cc1:TabPanel  runat="server" HeaderText="Detalles de Vehículo"  ID="Tab_Detalles_Vehiculo"  Width="100%">
                        <HeaderTemplate>Detalles de Vehículo</HeaderTemplate>
                        <ContentTemplate>
                            <table width="100%">          
                                <tr>
                                    <td colspan="4">
                                        <div id="Div_Detalles_Vehiculos" runat="server" style="width:98%; height:500px; overflow:auto;">
                                            <asp:GridView ID="Grid_Detalles_Vehiculo" runat="server" AutoGenerateColumns="False" 
                                                CellPadding="4" ForeColor="#333333" 
                                                GridLines="None"  Width="98%" PageSize="5" >
                                                <RowStyle CssClass="GridItem" />
                                                <Columns>
                                                    <asp:TemplateField>
                                                        <ItemTemplate>
                                                    ...
                                                    <asp:BoundField DataField="NOMBRE" HeaderText="Listado de Partes que contendrá el Tipo Vehículo" SortExpression="NOMBRE">
                                                        <ItemStyle Font-Size="X-Small" />
                                                    </asp:BoundField>
                                                </Columns>
                                                <PagerStyle CssClass="GridHeader" />
