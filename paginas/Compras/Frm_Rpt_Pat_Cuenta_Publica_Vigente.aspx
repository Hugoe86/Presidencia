<%@ Page Language="C#" MasterPageFile="~/paginas/Paginas_Generales/MasterPage.master" AutoEventWireup="true" CodeFile="Frm_Rpt_Pat_Cuenta_Publica_Vigente.aspx.cs" Inherits="paginas_Compras_Frm_Rpt_Pat_Cuenta_Publica_Vigente" Title="Cuenta Pública Vigente" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Cph_Area_Trabajo1" Runat="Server">
    ...
    <asp:UpdatePanel ID="Upd_Panel" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            ...
            <div id="Div_Requisitos" style="background-color:#ffffff; width:100%; height:100%;">
                <table width="99%"  border="0" cellspacing="0" class="estilo_fuente">
                    <tr align="center">
                        <td class="label_titulo" colspan="4">Listado de Cuenta Pública Vigente</td>
                    </tr>
                    <tr>
                        <td colspan="4">
                ...
                <table width="99%" class="estilo_fuente">                
                    ...
                    <tr>
                        <td style="width:18%; text-align:left;">
                            <asp:Label ID="Lbl_Fecha_Inicial" runat="server" Text="Fecha Adquisición Inicio" ></asp:Label>
                        </td>
                        <td style="width:32%; text-align:left;">
                            <asp:TextBox ID="Txt_Fecha_Inicial" runat="server" Width="80%" MaxLength="20" CausesValidation="true"></asp:TextBox>
                        ...
                        <td style="width:18%; text-align:left;">
                            <asp:Label ID="Lbl_Fecha_Final" runat="server" Text="Fecha Adquisición Final" ></asp:Label>
                        </td>
                        <td style="width:32%; text-align:left;">
                ...
                <table width="99%"  border="0" cellspacing="0" class="estilo_fuente">
                    <tr align="center">
                        <td style="text-align:right;">
                            <asp:Button ID="Btn_Descargar_Excel" runat="server" Text="Descargar Registros" onclick="Btn_Descargar_Excel_Click" style="border-style:outset; background-color:White; width:98%; height:50px; font-weight:bolder; font-size:medium; cursor:hand;" />   
                            &nbsp;&nbsp;&nbsp;  
                        </td>
                    </tr>
                </table>
        ...
        <Triggers>
            <asp:PostBackTrigger ControlID="Btn_Descargar_Excel" />
        </Triggers>       
    </asp:UpdatePanel>  
    <br />
    <br />
