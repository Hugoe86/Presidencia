...
public partial class paginas_Compras_Frm_Ope_Com_Seguimiento_Requisiciones : System.Web.UI.Page
{
    ...
    private static String P_Dt_Productos_Servicios = "P_Dt_Productos_Servicios_Seguimiento_Almacen";
    //private static String P_Dt_Partidas = "P_Dt_Partidas";
    private static String P_Dt_Requisiciones = "P_Dt_Requisiciones_Transitorias_Seguimiento_Almacen";
        ...
        try
        {
            switch (Modo)
            {
                case MODO_LISTADO:
                    ...
                    Configuracion_Acceso("Frm_Ope_Com_Seguimiento_Requisiciones_Almacen.aspx");
    ...
    public void Llenar_Grid_Requisiciones()
    {
        ...
        DataTable Dt_RQ = Requisicion_Negocio.Consultar_Requisiciones_Generales();        
        
        if (Dt_RQ != null && Dt_RQ.Rows.Count > 0)
        {
            Div_Contenido.Visible = false;
            Grid_Requisiciones.DataSource = Dt_RQ;
            Grid_Requisiciones.DataBind();
            Session[P_Dt_Requisiciones] = Dt_RQ;
        }
        else
        {
            //Mostrar_Informacion("No se encontraron requisiciones con los criterios de búsqueda", true);
            Grid_Requisiciones.DataSource = null;//Session[P_Dt_Requisiciones] as DataTable;
            Grid_Requisiciones.DataBind();
