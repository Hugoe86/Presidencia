<%@ Page Language="C#" MasterPageFile="~/paginas/Paginas_Generales/MasterPage.master" AutoEventWireup="true" CodeFile="Frm_Rpt_Pat_Cuenta_Publica.aspx.cs" Inherits="paginas_Compras_Frm_Rpt_Pat_Cuenta_Publica" Title="Cuenta Pública" %>
                    ...
                    <tr>
                        ...
                        <td style="width:32%; text-align:left;">
                            <asp:DropDownList ID="Cmb_Movimiento" runat="server" Width="100%">
                                ...
                                <asp:ListItem Value="ALTAS">ALTAS</asp:ListItem>
                                <asp:ListItem Value="BAJAS">BAJAS</asp:ListItem>
                            </asp:DropDownList>                                                 
                        </td>
                        <td style="width:18%; text-align:left; ">
