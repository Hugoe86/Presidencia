...
public partial class paginas_Compras_Frm_Rpt_Pat_Cuenta_Publica_Vigente : System.Web.UI.Page {
    ...
    private void Generar_Reporte(String Tipo) {
        try {
            ...
            DataTable Dt_Datos = Negocio.Obtener_Datos_Reporte_Cuenta_Publica_Vigente();
    ...
    {
        String Ruta = "Cuenta Publica Vigente [" + (String.Format("{0:ddMMyyyy_HHmmss}", DateTime.Now)) + "].xls";
        ...
        try
        {
            ...
            Hoja.Table.Columns.Add(new CarlosAg.ExcelXmlWriter.WorksheetColumn(250));//ObservSaciones.
