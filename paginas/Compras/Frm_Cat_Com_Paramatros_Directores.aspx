<%@ Page Language="C#" MasterPageFile="~/paginas/Paginas_Generales/MasterPage.master" AutoEventWireup="true" CodeFile="Frm_Cat_Com_Paramatros_Directores.aspx.cs" Inherits="paginas_Compras_Frm_Cat_Com_Paramatros_directores" Title="Untitled Page" %>
                        ...
                        <table id="Tbl_Comandos" border="0" cellspacing="0" class="estilo_fuente" style="width: 98%;">                        
                            <tr>
                                <td colspan="4" class="label_titulo">
                                    Catálogo de Parámetros Directores</td>
                            </tr>
     ...
     <div id="Div_Datos" runat="server">
                ...
                <div id="Div_Controles" runat="server" style="background-color:#ffffff; width:100%; height:100%;">        
                       <table id="Datos Generales_Inner" border="0" cellspacing="0" class="estilo_fuente" style="width: 98%;">
                            ...
                            <tr>
                                <td style="width:18%">
                                    <asp:Label ID="Lbl_Sociedad" runat="server" Text="Oficialia Mayor"></asp:Label></td>
                                <td style="width:32%" colspan="3">
                                    <asp:TextBox ID="Txt_Oficialia" runat="server" Width="95%" ></asp:TextBox>
                                    <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender1" 
                                        runat="server" FilterType="Custom, UppercaseLetters, LowercaseLetters, Numbers" 
                                        TargetControlID="Txt_Oficialia" ValidChars="ÑñáéíóúÁÉÍÓÚ. ">
                                    </cc1:FilteredTextBoxExtender>
                                </td>                                
                            </tr>
                            <tr>
                                <td style="width:18%">
                                    <asp:Label ID="Lbl_Fondo" runat="server" Text="Tesorero"></asp:Label>
                                </td>
                                <td style="width:32%" colspan="3">
                                    <asp:TextBox ID="Txt_Tesorero" runat="server" Width="95%"></asp:TextBox>
                                    <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender2" 
                                        runat="server" FilterType="Custom, UppercaseLetters, LowercaseLetters, Numbers" 
                                        TargetControlID="Txt_Tesorero" ValidChars="ÑñáéíóúÁÉÍÓÚ. ">
                                    </cc1:FilteredTextBoxExtender>
                                    </td>                                
                            </tr>
                            <tr>
                                <td style="width:18%">
                                    ...
                                    <asp:Label ID="Lbl_Division" runat="server" Text="Director de Adquisiciones"></asp:Label>                                    
                                </td>
                                <td style="width:32%" colspan="3">
                                    <asp:TextBox ID="Txt_Adquisicion" runat="server" Width="95%"></asp:TextBox>
                                    <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender3" 
                                        runat="server" FilterType="Custom, UppercaseLetters, LowercaseLetters, Numbers" 
                                        TargetControlID="Txt_Adquisicion" ValidChars="ÑñáéíóúÁÉÍÓÚ. ">
