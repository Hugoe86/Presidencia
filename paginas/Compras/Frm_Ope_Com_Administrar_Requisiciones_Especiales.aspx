<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/paginas/Paginas_Generales/MasterPage.master" CodeFile="Frm_Ope_Com_Administrar_Requisiciones_Especiales.aspx.cs" Inherits="paginas_Compras_Frm_Ope_Com_Administrar_Requisiciones_Especiales" %>
    ...
    <asp:UpdatePanel ID="Upd_Panel" runat="server">
        <ContentTemplate>
           ...
           <table width="97%"  border="0" cellspacing="0" class="estilo_fuente">
            ...
            <tr>
                <td colspan ="4" class="label_titulo">Autorizar Requisiciones de Programas Especiales y Ramo 33</td>
            </tr>
                    ...
                    <table width="100%" class="estilo_fuente">
                      ...
                      <tr>
                        ...
                        <tr>
                            ...
                            <td align="left" colspan="3">
                                <asp:DropDownList ID="Cmb_Estatus_Busqueda" runat="server" Width="57%" 
                                Enabled="False">
                                </asp:DropDownList>
                            </td>
                        </tr>
