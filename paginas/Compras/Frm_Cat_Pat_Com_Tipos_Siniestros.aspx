<%@ Page Language="C#" MasterPageFile="~/paginas/Paginas_Generales/MasterPage.master" AutoEventWireup="true" CodeFile="Frm_Cat_Pat_Com_Tipos_Siniestros.aspx.cs" Inherits="paginas_predial_Frm_Cat_Pat_Com_Tipos_Siniestros" Title="Catalogo de Tipos de Siniestros" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Cph_Area_Trabajo1" Runat="Server">
    <asp:ScriptManager ID="ScptM_Tipos_Siniestros" runat="server" />  
        ...
        <ContentTemplate>
            ...
            <div id="Div_Requisitos" style="background-color:#ffffff; width:100%; height:100%;">
                <table width="98%"  border="0" cellspacing="0" class="estilo_fuente">
                    <tr align="center">
                        <td class="label_titulo" colspan="2">Catálogo de Tipos de Siniestros</td>
                    </tr>
                    <tr>
                        <td colspan="2">
                ...
                <center>
                    <table width="98%" class="estilo_fuente">
                        <tr>
                            <td colspan="4">
                                <asp:HiddenField ID="Hdf_Tipo_Siniestro_ID" runat="server" />
                            </td>
                        </tr>
                        <tr>
                            <td style="width:13%; text-align:left;">
                                <asp:Label ID="Lbl_Tipo_Siniestro_ID" runat="server" Text="Tipo ID" ></asp:Label></td>
                            <td style="width:37%; text-align:left;">
                                <asp:TextBox ID="Txt_Tipo_Siniestro_ID" runat="server" Width="50%" 
                    ...
                    <br />                                
                    <asp:GridView ID="Grid_Tipos_Siniestros" runat="server" CssClass="GridView_1"
                        AutoGenerateColumns="False" AllowPaging="True" PageSize="10" Width="99%"
                        GridLines= "None"
                        onselectedindexchanged="Grid_Tipos_Siniestros_SelectedIndexChanged" 
                        onpageindexchanging="Grid_Tipos_Siniestros_PageIndexChanging">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="TIPO_SINIESTRO_ID" HeaderText="Tipo ID" 
                                SortExpression="TIPO_SINIESTRO_ID">
