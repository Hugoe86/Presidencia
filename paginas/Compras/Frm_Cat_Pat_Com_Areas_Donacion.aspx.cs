...
public partial class paginas_Control_Patrimonial_Frm_Cat_Pat_Com_Areas_Donacion : System.Web.UI.Page {
    ...
    #region Metodos
        ...
        private void Llenar_Grid_Listado(int Pagina) {
            try{
                Cls_Cat_Pat_Com_Areas_Donacion_Negocio Negocio = new Cls_Cat_Pat_Com_Areas_Donacion_Negocio();
                Negocio.P_Descripcion = Txt_Busqueda.Text.Trim();
                Grid_Listado.DataSource = Negocio.Consultar_Areas();
        ...
        protected void Grid_Listado_SelectedIndexChanged(object sender, EventArgs e)
        {
            try{
                if (Grid_Listado.SelectedIndex > (-1)){
                    Limpiar_Catalogo();
                    Cls_Cat_Pat_Com_Areas_Donacion_Negocio Negocio = new Cls_Cat_Pat_Com_Areas_Donacion_Negocio();
                    Negocio.P_Area_ID = HttpUtility.HtmlDecode(Grid_Listado.SelectedRow.Cells[1].Text.Trim());
                    Negocio = Negocio.Consultar_Detalles_Area();
                    Hdf_Area_ID.Value = Negocio.P_Area_ID;
                    Txt_Area_ID.Text = Negocio.P_Area_ID;
        ...
        protected void Btn_Modificar_Click(object sender, EventArgs e){
            try{
                if (Btn_Modificar.AlternateText.Equals("Modificar")){
                    ...
                    if (Validar_Componentes()){
                        Cls_Cat_Pat_Com_Areas_Donacion_Negocio Negocio = new Cls_Cat_Pat_Com_Areas_Donacion_Negocio();
                        Negocio.P_Area_ID = Hdf_Area_ID.Value;
                        Negocio.P_Descripcion = Txt_Descripcion.Text.Trim();
                        Negocio.P_Estatus = Cmb_Estatus.SelectedItem.Value;
                        Negocio.P_Usuario = Cls_Sessiones.Nombre_Empleado;
                        Negocio.Modificar_Area();
                        Configuracion_Formulario(true);
                        Limpiar_Catalogo();
                        Llenar_Grid_Listado(Grid_Listado.PageIndex);
