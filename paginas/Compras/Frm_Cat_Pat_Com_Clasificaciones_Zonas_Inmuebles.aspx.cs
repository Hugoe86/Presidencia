...
public partial class paginas_Control_Patrimonial_Frm_Cat_Pat_Com_Clasificaciones_Zonas_Inmuebles : System.Web.UI.Page{
    ...
    #region Metodos
        ...
        private void Llenar_Grid_Listado(int Pagina) {
            try{
                ...
                Grid_Listado.DataSource = Negocio.Consultar_Clasificaciones();
        ...
        protected void Grid_Listado_SelectedIndexChanged(object sender, EventArgs e)
        {
            try{
                if (Grid_Listado.SelectedIndex > (-1)){
                    Limpiar_Catalogo();
                    Cls_Cat_Pat_Com_Clasificaciones_Zonas_Inmuebles_Negocio Negocio = new Cls_Cat_Pat_Com_Clasificaciones_Zonas_Inmuebles_Negocio();
                    Negocio.P_Clasificacion_ID = HttpUtility.HtmlDecode(Grid_Listado.SelectedRow.Cells[1].Text.Trim());
                    Negocio = Negocio.Consultar_Detalles_Clasificacion();
                    Hdf_Clasificacion_ID.Value = Negocio.P_Clasificacion_ID;
                    Txt_Clasificacion_ID.Text = Negocio.P_Clasificacion_ID;
        ...
        protected void Btn_Modificar_Click(object sender, EventArgs e){
            try{
                if (Btn_Modificar.AlternateText.Equals("Modificar")){
                    ...
                    if (Validar_Componentes()){
                        Cls_Cat_Pat_Com_Clasificaciones_Zonas_Inmuebles_Negocio Negocio = new Cls_Cat_Pat_Com_Clasificaciones_Zonas_Inmuebles_Negocio();
                        Negocio.P_Clasificacion_ID = Hdf_Clasificacion_ID.Value;
                        Negocio.P_Descripcion = Txt_Descripcion.Text.Trim();
                        Negocio.P_Estatus = Cmb_Estatus.SelectedItem.Value;
                        Negocio.P_Usuario = Cls_Sessiones.Nombre_Empleado;
                        Negocio.Modificar_Clasificacion();
                        Configuracion_Formulario(true);
                        Limpiar_Catalogo();
                        Llenar_Grid_Listado(Grid_Listado.PageIndex);
        ...
        protected void Btn_Eliminar_Click(object sender, EventArgs e){
            try{
                if (Grid_Listado.Rows.Count > 0 && Grid_Listado.SelectedIndex > (-1)){
                    Cls_Cat_Pat_Com_Clasificaciones_Zonas_Inmuebles_Negocio Negocio = new Cls_Cat_Pat_Com_Clasificaciones_Zonas_Inmuebles_Negocio();
                    Negocio.P_Clasificacion_ID = Hdf_Clasificacion_ID.Value;
                    Negocio.Eliminar_Clasificacion();
                    Grid_Listado.SelectedIndex = (-1);
                    Llenar_Grid_Listado(Grid_Listado.PageIndex);
