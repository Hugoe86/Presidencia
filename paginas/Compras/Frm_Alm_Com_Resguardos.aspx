<%@ Page Language="C#" MasterPageFile="~/paginas/Paginas_Generales/MasterPage.master" AutoEventWireup="true" CodeFile="Frm_Alm_Com_Resguardos.aspx.cs" Inherits="paginas_Compras_Frm_Alm_Com_Resguardos" Title="Untitled Page" %>
        ...
        <asp:UpdatePanel ID="Upl_Contenedor" runat="server">
            <ContentTemplate>
                ...
                <table width="98%" border="0" cellspacing="0" class="estilo_fuente">
                    <tr align="center">
                        <td colspan="2" class="label_titulo">Generar Resguardo</td>
                    </tr>
                    <tr align="left">
                        <td colspan="2" >
