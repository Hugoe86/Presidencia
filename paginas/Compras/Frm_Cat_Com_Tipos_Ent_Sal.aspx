<%@ Page Title="Catálogo de Tipos Entradas-Salidas" Language="C#" MasterPageFile="~/paginas/Paginas_Generales/MasterPage.master" AutoEventWireup="true" CodeFile="Frm_Cat_Com_Tipos_Ent_Sal.aspx.cs" Inherits="paginas_Compras_Frm_Cat_Com_Tipos_Ent_Sal" %>
...
<asp:ScriptManager ID="ScriptManager1" runat="server">
    ...
    <asp:UpdatePanel ID="Upd_Panel" runat="server">
        <ContentTemplate>
        <asp:UpdateProgress ID="Uprg_Tipos_Ent_Sal" runat="server" AssociatedUpdatePanelID="Upd_Panel" DisplayAfter="0">
                    <ProgressTemplate>
                        <div id="progressBackgroundFilter" class="progressBackgroundFilter"></div>
                        <div  class="processMessage" id="div_progress"> <img alt="" src="../imagenes/paginas/Updating.gif" /></div>
                    </ProgressTemplate>                     
            </asp:UpdateProgress>
            <div id="Div_Tipos_Ent_Sal" style="background-color:#ffffff; width:100%; height:100%;">
                <table border="0" cellspacing="0" class="estilo_fuente" style="width: 98%;">
                    <tr>
                        <td colspan="4" class="label_titulo">
                            Catálogo de Tipos Entradas-Salidas
                        </td>                        
                    </tr>
                    <tr>
                        <td colspan="4">
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="Lbl_ID" runat="server" Text="Tipo Movimiento ID"></asp:Label>
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="Cmb_Tipos" runat="server" Width="92%">
                            </asp:DropDownList>
                        </td>
                        <td style="width:18%">
                            &nbsp;</td>
                    ...
                    <tr>
                        <td align="center" colspan="4">
                            <asp:GridView ID="Grid_Tipos" runat="server" CssClass="GridView_1"
                            AutoGenerateColumns="False" AllowPaging="true" PageSize="5" Width="96%" 
                            GridLines="none" onpageindexchanging="Grid_Tipos_PageIndexChanging" 
                                onselectedindexchanged="Grid_Tipos_SelectedIndexChanged" >
                            ...
                            <asp:BoundField DataField="TIPO_MOVIMIENTO_ID" HeaderText="Tipo Movimiento ID"
                                SortExpression="TIPO_MOVIMIENTO_ID" >
                                <ItemStyle Width="14%" />
                            </asp:BoundField>
