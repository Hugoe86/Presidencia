...
public partial class paginas_Compras_Frm_Ope_Com_Administrar_Requisiciones : System.Web.UI.Page
{
    ...
    public void Estado_Formulario(String Estado)
    {
        switch (Estado)
        {
            case "inicial":
                ...
                Configuracion_Acceso("Frm_Ope_Com_Administrar_Requisiciones.aspx");
                Configuracion_Acceso_LinkButton("Frm_Ope_Com_Administrar_Requisiciones.aspx");
                ...
                if (Div_Contenedor_Msj_Error.Visible == false)
                {
                    try
                    {
                        ...
                        if (Cmb_Estatus.SelectedValue != "CANCELADA")
                        {
                            if (Cmb_Estatus.SelectedValue == "COTIZADA-RECHAZADA")
                            {
                                Requisicion.Registrar_Historial("COTIZADA-RECHAZADA", Requisicion_Negocio.P_Requisicion_ID);
