<%@ Page Language="C#" MasterPageFile="~/paginas/Paginas_Generales/MasterPage.master" AutoEventWireup="true" CodeFile="Frm_Ope_Com_Modificar_Requisicion.aspx.cs" Inherits="paginas_Compras_Frm_Ope_Com_Modificar_Requisicion" Title="Modificar Requisiciones" %>
            ...
            <ContentTemplate>
                    ...
                    <table style="width: 100%;">
                        ...
                        <tr>
                            <td style="width: 99%" align="center" colspan="4">
                                <asp:GridView ID="Grid_Requisiciones" runat="server" AllowPaging="True" AutoGenerateColumns="False" CssClass="GridView_1" GridLines="None" Width="100%" OnPageIndexChanging="Grid_Requisiciones_PageIndexChanging"
                ...
                <div id="Div_Contenido" runat="server">
                    <table style="width: 100%;">
                        ...
                        <tr visible="false" id="Tr_Presupuesto" runat="server">
                            <td style="width: 15%;" align="left">
                        ...
                        <tr visible="false" id="Tr_Partida" runat="server">
...
<%--                        <tr>
                        ...
                        <div visible="false" id="Div_Buscar_Producto" runat="server">
                        <tr >
                            <td style="width: 15%;" align="left">
        ...
        <asp:Panel ID="Modal_Productos_Servicios" runat="server" CssClass="drag" HorizontalAlign="Center" Style="display: none; border-style: outset; border-color: Silver; width: 860px;">
            ...
            <center>
                <asp:UpdatePanel ID="MP_UDPpdatePanel1" runat="server" UpdateMode="Conditional">
                        ...
                        <div>
                            <table width="100%" style="color: Black;">
                                ...
                                <tr align="left">
                                    ...
                                    <td colspan="3">
                                        <asp:TextBox ID="Txt_Nombre" runat="server" Width="98.5%">
                                        </asp:TextBox>
                                    </td>
                                    <td style="width: 10%;">
                                ...
                                <tr>
                                    <td align="center">
                                        <asp:GridView ID="Grid_Productos_Servicios_Modal" runat="server" AllowPaging="false" 
                                            ...
                                            DataKeyNames="ID,NOMBRE,DISPONIBLE,COSTO" GridLines="None" PageSize="10"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="COSTO" HeaderText="P. Unitario" Visible="True">
                                                    <FooterStyle HorizontalAlign="Right" />
                                                    <HeaderStyle HorizontalAlign="Right" />
                    ...
                    <Triggers>
                        <%--<asp:AsyncPostBackTrigger ControlID="Ibtn_Buscar_Producto" EventName="Click" />--%>
                    </Triggers>
                </asp:UpdatePanel>
            </center>
        </asp:Panel>
