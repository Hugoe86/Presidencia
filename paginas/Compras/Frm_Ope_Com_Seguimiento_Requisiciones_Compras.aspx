<%@ Page Language="C#" MasterPageFile="~/paginas/Paginas_Generales/MasterPage.master" AutoEventWireup="true" CodeFile="Frm_Ope_Com_Seguimiento_Requisiciones_Compras.aspx.cs" Inherits="paginas_Compras_Frm_Ope_Com_Seguimiento_Requisiciones" 
                    ...
                    <table style="width: 100%;" border="0" cellspacing="0">
                        <tr align="center">
                            <td colspan="4" class="label_titulo">
                                Seguimiento a Requisiciones (Compras)
                            </td>
                        </tr>
                        <tr align="left">
                            <td colspan="4">
                ...
                <div id="Div_Listado_Requisiciones" runat="server">
                    <table style="width: 100%;">
                        ...
                        <tr>
                            ...
                            <td visible="false">
                                <asp:TextBox ID="Txt_Busqueda" runat="server" Width="85%" MaxLength="13" OnTextChanged="Txt_Busqueda_TextChanged" AutoPostBack="true"></asp:TextBox>
                                ...
                                <asp:GridView ID="Grid_Requisiciones" runat="server" AutoGenerateColumns="False" CssClass="GridView_1" GridLines="None" Width="100%"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="">
                                         ...
                                         <asp:TemplateField HeaderText="">
                                            <ItemTemplate>
                                                <asp:ImageButton ID="Btn_Imprimir_Requisicion_SC" runat="server" 
                                                    ImageUrl="~/paginas/imagenes/gridview/pdf.png" 
                                                    OnClick="Btn_Imprimir_Requisicion_SC_Click"                                                    
                                                    CommandArgument='<%# Eval("No_Requisicion") %>'
                                                    ToolTip="ver requisición sin precios"/>
                                            </ItemTemplate >
                                            <HeaderStyle HorizontalAlign="Center" Width="5%" />
                                            <ItemStyle HorizontalAlign="Center" Width="5%" />
                                        </asp:TemplateField>                                                                                                                                                                   
