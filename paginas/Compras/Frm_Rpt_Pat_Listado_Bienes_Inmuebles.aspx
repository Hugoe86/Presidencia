<%@ Page Language="C#" MasterPageFile="~/paginas/Paginas_Generales/MasterPage.master" AutoEventWireup="true" CodeFile="Frm_Rpt_Pat_Listado_Bienes_Inmuebles.aspx.cs" Inherits="paginas_Control_Patrimonial_Frm_Rpt_Pat_Listado_Bienes_Inmuebles" Title="Listado de Bienes Inmuebles" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
     <script type="text/javascript" language="javascript">
            function Limpiar_Ctlr_Campos(){
                ...
                document.getElementById("<%=Chk_Valor_Total_Comercial.ClientID%>").checked=false; 
                document.getElementById("<%=Chk_Inluir_Columna_Valores_Fiscales.ClientID%>").checked=false;
    ...
    <asp:UpdatePanel ID="Upd_Panel" runat="server">
        <ContentTemplate> 
            ...
            <table width="99%"  border="0" cellspacing="0" class="estilo_fuente">
                <tr align="center">
                    <td class="label_titulo" colspan="4">Listado de Bienes Inmuebles</td>
                </tr>
                <tr>
                    <td colspan="4">
            ...
            <center>
                ...
                <table width="98%" class="estilo_fuente">  
                    <tr>
                        ...
                        <td style="width:35%;">
                            <asp:TextBox ID="Txt_Escritura" runat="server" style="width:100%;"></asp:TextBox>
                        </td>
                        <td colspan="4"></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td style="width:35%;">
                            <asp:DropDownList ID="Cmb_Estatus" runat="server" style="width:100%;">
                                ...
                                <asp:ListItem Value="SIN_ASIGNACION">&lt;SIN ASIGNACI&Oacute;N&gt;</asp:ListItem>
                    ...
                    <tr>
                        <td colspan="4">
                            <asp:CheckBox ID="Chk_Inluir_Columna_Valores_Fiscales" runat="server" Text="Incluir el Valor Fiscal de Cada Bien" Font-Bold="true" /><br />
                            <asp:CheckBox ID="Chk_Valor_Total_Comercial" runat="server" Text="Incluir el Valor Total Fiscal" Font-Bold="true" />
                        </td>
                    </tr>       
                </table>     
            </center>
