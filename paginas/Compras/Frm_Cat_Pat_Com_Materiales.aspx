<%@ Page Language="C#" MasterPageFile="~/paginas/Paginas_Generales/MasterPage.master" AutoEventWireup="true" CodeFile="Frm_Cat_Pat_Com_Materiales.aspx.cs" Inherits="paginas_predial_Frm_Cat_Pat_Com_Materiales" Title="Catalogo de Materiales" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Cph_Area_Trabajo1" Runat="Server">
    <asp:ScriptManager ID="ScptM_Materiales" runat="server" />  
        ...
        <ContentTemplate>
            ...
            <div id="Div_Requisitos" style="background-color:#ffffff; width:100%; height:100%;">
                <table width="98%"  border="0" cellspacing="0" class="estilo_fuente">
                    <tr align="center">
                        <td class="label_titulo" colspan="2">Catálogo de Materiales</td>
                    </tr>
                    <tr>
                        <td colspan="2">
                ...
                <center>
                    <table width="98%" class="estilo_fuente">
                        <tr>
                            <td colspan="4">
                                <asp:HiddenField ID="Hdf_Material_ID" runat="server" />
                            </td>
                        </tr>
                        <tr>
                            <td style="width:13%; text-align:left;">
                                <asp:Label ID="Lbl_Material_ID" runat="server" Text="Material ID" ></asp:Label></td>
                            <td style="width:37%; text-align:left;">
                                <asp:TextBox ID="Txt_Material_ID" runat="server" Width="50%" MaxLength="10" Enabled="False"></asp:TextBox>
                            </td>
                            <td colspan="2">&nbsp;</td>
                        </tr>                                    
                        <tr>
                    ...
                    <br />                                
                    <asp:GridView ID="Grid_Materiales" runat="server" CssClass="GridView_1"
                        AutoGenerateColumns="False" AllowPaging="True" PageSize="10" Width="96%"
                        GridLines= "None"
                        onselectedindexchanged="Grid_Materiales_SelectedIndexChanged" 
                        onpageindexchanging="Grid_Materiales_PageIndexChanging">
