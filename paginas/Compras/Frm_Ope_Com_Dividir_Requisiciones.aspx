<%@ Page Language="C#" MasterPageFile="~/paginas/Paginas_Generales/MasterPage.master" AutoEventWireup="true" 
    CodeFile="Frm_Ope_Com_Dividir_Requisiciones.aspx.cs" 
    Inherits="paginas_Compras_Frm_Ope_Com_Dividir_Requisiciones" 
    Title="Dividir Requisiciones" %>
           ...
           <ContentTemplate>
               <asp:UpdateProgress ID="Upgrade" runat="server" AssociatedUpdatePanelID="Upl_Contenedor"
                ...
                <div id="Div_Encabezado" runat="server">  
                    ...
                    <tr align="center">
                        <td colspan="2" class="label_titulo">Dividir Requisiciones</td>
                    </tr>
                   ...
                   <table style="width:100%" >
                       ...
                       <tr>
                            <td style="width:100%;" colspan="2">
                                Presione el icono                                
                                <asp:Image
                                    ID="Image1" runat="server" ImageUrl="~/paginas/imagenes/gridview/grid_docto2.png"/>
                                para dividir las requisiciones
                            </td>                       
                       </tr>
                       <tr>
                           <td colspan="2">
                               <asp:GridView ID="Grid_Requisiciones_Cotizadas" runat="server" AutoGenerateColumns="False"
                                   ...
                                   <Columns>
                                       <asp:ButtonField ButtonType="Image" CommandName="Select" ImageUrl="~/paginas/imagenes/gridview/grid_docto2.png" >
                                           <ItemStyle Width="5%"/>
                                       </asp:ButtonField>
                                       ...
                                       <asp:BoundField DataField="FECHA_COTIZACION" HeaderText="Fecha Cotizada" SortExpression="FECHA_COTIZACION" Visible="false"
