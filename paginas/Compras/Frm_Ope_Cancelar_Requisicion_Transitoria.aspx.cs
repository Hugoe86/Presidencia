...
public partial class paginas_Compras_Frm_Ope_Cancelar_Requisicion_Transitoria : System.Web.UI.Page
{
    ...
    private static String P_Dt_Productos_Servicios = "P_Dt_Productos_Servicios_Modif";
    private static String P_Dt_Productos_Servicios_Auxiliares = "P_Dt_Productos_Servicios_Aux_Modif";
    private static String P_Dt_Partidas = "P_Dt_Partidas_Modif";
    private static String P_Dt_Productos = "P_Dt_Productos_Modif";
    private static String P_Dt_Requisiciones = "P_Dt_Requisiciones_Modif";
    private static String P_Dt_Productos_Servicios_Modal = "P_Dt_Productos_Servicios_Modal_Modif";
    private static String P_Dt_Programas = "P_Dt_Programas_Modif";
    ...
    private const String EST_CANCELADA_PARCIAL = "CANCELADA PARCIAL";
    private const String EST_CANCELADA_TOTAL = "CANCELADA TOTAL";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if(!IsPostBack)
        {
            ...
            if (Session["Inicio_Modif"] == null)
            {
                Session["Inicio_Modif"] = "Inicio";
            ...
            String[] Datos_Combo = 
                { "PROCESAR",EST_FILTRADA, "PROVEEDOR",EST_COTIZADA, EST_COTIZADA_RECHAZADA };
    ...
    private void Construir_DataTables() 
    {
        ...
        Session[P_Dt_Productos_Servicios_Auxiliares] = Construir_Tabla_Detalles_Requisicion();
    ...
    protected void Btn_Nuevo_Click(object sender, ImageClickEventArgs e)
    {
        ...
        else if (Btn_Nuevo.ToolTip == "Dar de Alta")
        {
            if (Validaciones(true))
            {
                ...
                Requisicion_Negocio.P_Subtotal = Quitar_Formato_Double(Txt_Subtotal.Text);
                Requisicion_Negocio.P_IEPS = Quitar_Formato_Double( Txt_IEPS.Text);
                Requisicion_Negocio.P_IVA = Quitar_Formato_Double(Txt_IVA.Text);
                Requisicion_Negocio.P_Total = Quitar_Formato_Double(Txt_Total.Text);
                ...
                String Respuesta = Requisicion_Negocio.Proceso_Insertar_Requisicion();

                if (Respuesta.Contains("EXITO"))
                {
                    String Consecutivo = Respuesta.Replace("EXITO-", "");
                ...
                {
                    ScriptManager.RegisterStartupScript(
                        this, this.GetType(), "Requisiciones", "alert('" + Respuesta + "');", true); 
                }
    ...
    protected void Btn_Modificar_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (Btn_Modificar.ToolTip == "Modificar")
        {
            if (Txt_Folio.Text.Trim() != "" )
            {
                    ...
                    String[] Datos_Combo = null;
                    if (Hdn_Listado_Almacen.Value == "SI")
                    {
                        Datos_Combo = new String[] {EST_CANCELADA_PARCIAL, EST_CANCELADA_TOTAL};
                    }
                    else
                    {
                        Datos_Combo = new String[] { EST_CANCELADA };
                    }
        ...
        else if (Btn_Modificar.ToolTip == "Actualizar")
        {
            ...
            if (Validaciones(true))
            {
                ...
                Requisicion_Negocio.P_Comentarios = Txt_Comentario.Text;
                Requisicion_Negocio.P_Dt_Productos_Servicios = Session[P_Dt_Productos_Servicios] as DataTable;
                Requisicion_Negocio.P_Dt_Productos_Servicios_Aux = Session[P_Dt_Productos_Servicios_Auxiliares] as DataTable;
                ...
                Requisicion_Negocio.P_Listado_Almacen = Hdn_Listado_Almacen.Value;
                ...
                Requisicion_Negocio.P_Dt_Productos_Almacen = ((DataTable)Session[P_Dt_Productos]);
                Requisicion_Negocio.P_Dt_Partidas = ((DataTable)Session[P_Dt_Partidas]);
                String Resultado = Requisicion_Negocio.Proceso_Actualizar_Requisicion();
                if (Resultado == "EXITO")
                {
                    Administrar_Requisicion = new Cls_Ope_Com_Administrar_Requisiciones_Negocio();
                ...
                else 
                {
                    ScriptManager.RegisterStartupScript(this, this.GetType(), 
                        "Requisiciones", "alert('No se guaradron los cambios, consulte a su administrador [" + Resultado + "]');", true);
                }
                Habilitar_Controles("Inicial");
                Llenar_Grid_Requisiciones();
            }
    ...
    protected void Btn_Salir_Click(object sender, ImageClickEventArgs e)
    {
        ...
        {            
            ...
            //Habilitar_Controles("Inicial");
            //String[] Datos_Combo = 
            //    { "PROCESAR","PROVEEDOR",EST_EN_CONSTRUCCION, EST_GENERADA, EST_CANCELADA, EST_AUTORIZADA, 
    ...
    protected void Cmb_Tipo_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        if (Cmb_Tipo.SelectedValue == "STOCK")
        {
            //Response.Redirect("../Paginas_Generales/Frm_Apl_Mensajes.aspx");
    ...
    private void Evento_Grid_Requisiciones_Seleccionar(String Dato)
    {
        ...
        //hidden
        Hdn_Listado_Almacen.Value = Requisicion[0][Ope_Com_Requisiciones.Campo_Listado_Almacen].ToString();

        Llenar_Combos_Generales(Requisicion[0]["DEPENDENCIA_ID"].ToString());
        Div_Listado_Requisiciones.Visible = false;
        Div_Contenido.Visible = true;
        ...
        //este para caso de modificar requisicion
        Session[P_Dt_Productos_Servicios_Auxiliares] = Requisicion_Negocio.Consultar_Productos_Servicios_Requisiciones();
        ...
        if (Requisicion[0][Ope_Com_Requisiciones.Campo_Listado_Almacen].ToString() == "NO")
        {
            //combos
            Cmb_Fte_Financiamiento.SelectedValue =
                ((DataTable)Session[P_Dt_Productos_Servicios]).Rows[0]["FUENTE_FINANCIAMIENTO_ID"].ToString().Trim();
        ...
        try
        {
            switch (Modo)
            {
                ...
                case "Nuevo":
                    ...
                    Txt_Cantidad.Enabled = true;
                    Txt_Justificacion.Enabled = false;
                    Txt_Especificaciones.Visible = false;
    ...
    private String Quitar_Formato_Double(String Numero)
    {
    ...
    public void Llenar_Grid_Requisiciones()
    {
        ...
        Requisicion_Negocio.P_Fecha_Inicial = String.Format("{0:dd-MMM-yyyy}", Convert.ToDateTime(Txt_Fecha_Inicial.Text)); 
        //Requisicion_Negocio.P_Fecha_Final = Txt_Fecha_Final.Text;
        Requisicion_Negocio.P_Fecha_Final = String.Format("{0:dd-MMM-yyyy}", Convert.ToDateTime(Txt_Fecha_Final.Text));
        ...
        Requisicion_Negocio.P_Tipo = "TRANSITORIA";//Cmb_Tipo_Busqueda.SelectedValue.Trim();
        Requisicion_Negocio.P_Estatus = "PROCESAR,FILTRADA,PROVEEDOR,COTIZADA,COTIZADA-RECHAZADA";
    ...
    // CAUSA_MODIFICACIÓN:
    //********************************************************************************/
    public void Llenar_Combos_Generales(String Dependencia_ID)
    {
        //Limpiar_Formulario();
        Txt_Subtotal.Text = "0.0";
        Txt_Total.Text = "0.0";
        ...
        Requisicion_Negocio = new Cls_Ope_Com_Requisiciones_Negocio();
        Requisicion_Negocio.P_Dependencia_ID = Dependencia_ID;//Cmb_Dependencia.SelectedValue;//Cls_Sessiones.Dependencia_ID_Empleado.ToString();
    ...
    public void Llenar_Combos_Busqueda()
    {
        String[] Datos_Combo = 
                {"CONST ,GENERADA, REVISAR", EST_EN_CONSTRUCCION, EST_GENERADA, EST_CANCELADA, EST_AUTORIZADA, 
                  EST_FILTRADA,EST_RECHAZADA,EST_REVISAR, EST_COTIZADA, EST_COTIZADA_RECHAZADA, EST_COMPRA, "PROCESAR" ,EST_ALMACEN, EST_TERMINADA };
    ...
    private Boolean Validaciones(bool Validar_Completo)
    {
        ...
        {
            if (Validar_Longitud(Txt_Comentario, 450))
            {
    ...
    protected void Grid_Requisiciones_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            if (Renglon.Length > 0)
            {
                ...
                {                    
                    Boton.ImageUrl = "../imagenes/gridview/circle_green.png";
                    Boton.Visible = true;
                    e.Row.Cells[2].Style.Add("foreground", "white");
                }
                    
                else if (Estatus == EST_RECHAZADA && Renglon[0]["ALERTA"].ToString().Trim() == "ROJA")
                {                    
