<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/paginas/Paginas_Generales/MasterPage.master" CodeFile="Frm_Rpt_Com_Orden_Compra.aspx.cs" Inherits="paginas_Compras_Frm_Rpt_Com_Orden_Compra" %>
    ...
    <ContentTemplate>
        ...
        <div id="Div_Contenido" style="width:99%;">
            <table border="0" cellspacing="0" class="estilo_fuente" width="100%">
                 <tr>
                    <td class="label_titulo">Reporte Ordenes de Compra</td>
                </tr>
