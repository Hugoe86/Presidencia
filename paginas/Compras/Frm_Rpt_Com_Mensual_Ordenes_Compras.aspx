...
CodeFile="Frm_Rpt_Com_Mensual_Ordenes_Compras.aspx.cs" Inherits="paginas_Compras_Frm_Rpt_Com_Mensual_Ordenes_Compras" 
Title="Reporte Mensual de Ordenes de Compra" EnableEventValidation="false" %>
        ...
        <ContentTemplate>
            ...
            <div style="width:100%;">
                <table width="98%"  border="0" cellspacing="0" class="estilo_fuente">
                    <tr align="center">
                        <td class="label_titulo" colspan="2">Reporte de Ordenes de Compra</td>
                    </tr>
                    <tr>
                        <td colspan ="2">
                    ...
                    <table width="98%">
                        <tr>
                            <td style="width:10%; text-align:left;">
                                <asp:Label ID="Lbl_Fecha_Inicio" runat="server" Text="Fecha de Pago del" CssClass="estilo_fuente"></asp:Label>
                            </td>
