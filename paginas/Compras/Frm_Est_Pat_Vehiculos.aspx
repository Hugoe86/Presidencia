<%@ Page Language="C#" MasterPageFile="~/paginas/Paginas_Generales/MasterPage.master" AutoEventWireup="true" CodeFile="Frm_Est_Pat_Vehiculos.aspx.cs" Inherits="paginas_Compras_Frm_Est_Pat_Vehiculos" Title="Estadisticas Vehículos" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <script type="text/javascript" language="javascript">
        ...
        function Limpiar_Ctlr_Campos(){ 
            ...
            document.getElementById("<%=Chk_Tipo_Vehiculo.ClientID%>").checked = false;  
            document.getElementById("<%=Chk_Estatus.ClientID%>").checked = false;   
            document.getElementById("<%=Chk_Por_Procedencia.ClientID%>").checked = false;  
            return false;
        }  
    </script>  
        ...
        <ContentTemplate>
            ...
            <div id="Div_Requisitos" style="background-color:#ffffff; width:100%; height:100%;">
                <table width="98%"  border="0" cellspacing="0" class="estilo_fuente">              
                    <tr align="center">
                        <td class="label_titulo" colspan="2">Estadisticas de Vehículos</td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr class="barra_busqueda" align="right">
                        <td align="left">
                            ...
                            <asp:ImageButton ID="Btn_Generar_Reporte_Excel" runat="server" ToolTip="Generar (Excel)" Width="24px" ImageUrl="~/paginas/imagenes/paginas/icono_rep_excel.png" OnClick="Btn_Generar_Reporte_Excel_Click" />
                    ...
                    <table width="98%"  border="0" cellspacing="0" class="estilo_fuente">
                        ...
                        <tr>
                            <td style="width:100%; text-align:left;">
                                <asp:CheckBox ID="Chk_Tipo_Vehiculo" runat="server" Text="Por Tipo de Vehículo."></asp:CheckBox>
                            </td>
                        </tr>
                        <tr>
                            <td style="width:100%; text-align:left;">
                                <asp:CheckBox ID="Chk_Estatus" runat="server" Text="Por Estatus."></asp:CheckBox>
                            </td>
                        </tr>
                        <tr>
                            <td style="width:100%; text-align:left;">
                                <asp:CheckBox ID="Chk_Por_Procedencia" runat="server" Text="Por Procedencia."></asp:CheckBox>
                            </td>
                        </tr>
                    </table>
                </center>                 
