...
CodeFile="Frm_Cat_Ort_Zona.aspx.cs" Inherits="paginas_Ordenamiento_Territorial_Frm_Cat_Ort_Zona" %>
        ...
        <ContentTemplate>
           ...
           <div id="Div_Contenido" style="background-color: #ffffff; width: 100%; height: 100%;">
                <table width = "98%" border="0" cellspacing="0">                     
                    <tr>
                        <td colspan ="4" class="label_titulo">Catálogo Clasificacion</td>
                    </tr>
                    ...
                    <table width="98%">
                        <tr>
                            <td >
                                ...
                                <asp:HiddenField ID="Hdf_Area" runat="server" />
                            </td>
                        </tr>
                    </table>
                     <table width="98%">
                ...
                <div id="Div_Datos_Formato" runat="server" style="display: block">
                    <table width="98%">
                        ...
                        <tr>
                            ...
                            <td  style="width:85%" align="left">
                                <asp:DropDownList ID="Cmb_Responsable_Empleado" runat="server" Width="85%" ></asp:DropDownList>  
                                <%--<asp:ImageButton ID="Btn_Buscar_Empleado" runat="server" ToolTip="Seleccionar Unidad responsable"
                         ...
                         <tr>
                            ...
                            <td  style="width:85%" align="left">
                                <asp:DropDownList ID="Cmb_Area" runat="server" Width="85%" ></asp:DropDownList>
                            </td>
                         </tr>
                    </table>
                </div>
                            ...
                            <td style="width:100%;text-align:center;vertical-align:top;">
                                <center>
                                    <div id="Div_Avance_Obra" runat="server" 
                                        ...
                                        <asp:GridView ID="Grid_Zona" runat="server" AutoGenerateColumns="False" 
                                            CssClass="GridView_1" Width="96%"  
                                            EmptyDataText="No se encontraron datos"
                                            onselectedindexchanged="Grid_Zona_SelectedIndexChanged" 
                                            OnSorting="Grid_Zona_Sorting" AllowSorting="True"
                                            GridLines="None">
                                            ...
                                            <Columns>
                                                ...
                                                <%-- 1 --%>
                                                <asp:BoundField DataField="ZONA_ID" HeaderText="ID" Visible="True">
                                                ...
                                                <%-- 3 --%>  
                                                <asp:BoundField DataField="RESPONSABLE_ZONA" HeaderText="Responsable" Visible="True" SortExpression="RESPONSABLE_ZONA">
                                                ...
                                                <asp:BoundField DataField="EMPLEADO_ID" HeaderText="empleado id" Visible="True">
                                                 ...
                                                 <%-- 5 --%>  
                                                <asp:BoundField DataField="AREA" HeaderText="Area" Visible="True" SortExpression="AREA">
                                                    <HeaderStyle Font-Size="13px" HorizontalAlign="Left" Width="35%" />
                                                    <ItemStyle Font-Size="12px" HorizontalAlign="Left" Width="35%" />
                                                </asp:BoundField>                                                 
                                            </Columns>
