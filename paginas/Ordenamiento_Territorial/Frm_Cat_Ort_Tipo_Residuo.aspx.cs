...
using Presidencia.Ordenamiento_Territorial_Tipos_Residuos.Negocio;

public partial class paginas_Ordenamiento_Territorial_Frm_Cat_Ort_Tipo_Residuo : System.Web.UI.Page
{
    #region Load
    ///*******************************************************************************
    ...
    private void Habilitar_Controles(String Operacion)
    {
        ...
        try
        {
            ...
            Grid_Tipo_Residuo.Enabled = !Habilitado;
        }
        catch (Exception ex)
        {
    ...
    ///*******************************************************************************
    ///NOMBRE DE LA FUNCIÓN : Cargar_Tipos_Residuos
    ...
    ///CAUSA_MODIFICACIÓN
    ///*******************************************************************************  
    private void Cargar_Tipos_Residuos()
    {
        Cls_Cat_Ort_Tipo_Residuo_Negocio Negocio_Consulta = new Cls_Cat_Ort_Tipo_Residuo_Negocio();
        DataTable Dt_Consulta = new DataTable();
        try
        {
            Dt_Consulta = Negocio_Consulta.Consultar_Tipos_Residuos();
            Cargar_Grid_Tipos_Residuos(Dt_Consulta);
        }
        catch (Exception ex)
        {
            throw new Exception("Cargar_Tipos_Residuos " + ex.Message.ToString());
        }
    }
    ///*******************************************************************************
    ///NOMBRE DE LA FUNCIÓN : Cargar_Grid_Tipos_Residuos
    ...
    ///CAUSA_MODIFICACIÓN
    ///*******************************************************************************  
    private void Cargar_Grid_Tipos_Residuos(DataTable Dt_Consulta)
    {
        try
        {
            if (Dt_Consulta != null && Dt_Consulta.Rows.Count > 0)
            {
                Grid_Tipo_Residuo.Columns[1].Visible = true;
                Grid_Tipo_Residuo.DataSource = Dt_Consulta;
                Grid_Tipo_Residuo.DataBind();
                Grid_Tipo_Residuo.Columns[1].Visible = false;
                Grid_Tipo_Residuo.SelectedIndex = -1;
            }
            else
            {
                Grid_Tipo_Residuo.Columns[1].Visible = true;
                Grid_Tipo_Residuo.DataSource = new DataTable();
                Grid_Tipo_Residuo.DataBind();
                Grid_Tipo_Residuo.Columns[1].Visible = false;
            }
        }
        ...
        {
            throw new Exception("Cargar_Grid_Tipos_Residuos " + ex.Message.ToString());
        }
    }
    ///*******************************************************************************
    ...
    private void Alta()
    {
        Cls_Cat_Ort_Tipo_Residuo_Negocio Negocio_Alta = new Cls_Cat_Ort_Tipo_Residuo_Negocio();
        try
        {
    ...
    {
        Cls_Cat_Ort_Tipo_Residuo_Negocio Negocio_Modificar = new Cls_Cat_Ort_Tipo_Residuo_Negocio();
        try
        {
            Negocio_Modificar.P_Tipo_Residuo_ID = Hdf_Elemento_ID.Value;
    ...
    {
        Cls_Cat_Ort_Tipo_Residuo_Negocio Negocio_Eliminar = new Cls_Cat_Ort_Tipo_Residuo_Negocio();
        try
        {
            Negocio_Eliminar.P_Tipo_Residuo_ID = Hdf_Elemento_ID.Value;
    ...
    private void Buscar()
    {
        Cls_Cat_Ort_Tipo_Residuo_Negocio Negocio_Buscar = new Cls_Cat_Ort_Tipo_Residuo_Negocio();
        DataTable Dt_Consulta = new DataTable();
        try
        {
            Negocio_Buscar.P_Nombre = Txt_Busqueda.Text;
            Dt_Consulta = Negocio_Buscar.Consultar_Tipos_Residuos();
            Cargar_Grid_Tipos_Residuos(Dt_Consulta);
        }
        catch (Exception ex)
        {
    ...
    #region Grid
    ///*******************************************************************************
    /// NOMBRE DE LA FUNCION: Grid_Tipo_Residuo_SelectedIndexChanged
    ...
    /// CAUSA_MODIFICACION:
    ///*******************************************************************************
    protected void Grid_Tipo_Residuo_SelectedIndexChanged(object sender, EventArgs e)
    {
        try
        {
            Limpiar_Controles();
            GridViewRow selectedRow = Grid_Tipo_Residuo.Rows[Grid_Tipo_Residuo.SelectedIndex];
