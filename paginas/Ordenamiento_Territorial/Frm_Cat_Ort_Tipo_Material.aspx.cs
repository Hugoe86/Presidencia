...
using Presidencia.Ordenamiento_Territorial_Tipo_Material.Negocio;

public partial class paginas_Ordenamiento_Territorial_Frm_Cat_Ort_Tipo_Material : System.Web.UI.Page
{
    #region Load
    ///*******************************************************************************
    ...
    private void Habilitar_Controles(String Operacion)
    {
        ...
        try
        {
            ...
            Grid_Material.Enabled = !Habilitado;
        }
        catch (Exception ex)
        {
    ...
    ///*******************************************************************************
    ///NOMBRE DE LA FUNCIÓN : Cargar_Materiales
    ...
    {
        Cls_Cat_Ort_Tipo_Material_Negocio Negocio_Consulta = new Cls_Cat_Ort_Tipo_Material_Negocio();
        DataTable Dt_Consulta = new DataTable();
        try
        {
            Dt_Consulta = Negocio_Consulta.Consultar_Tipos_Materiales();
            Cargar_Grid_Materiales(Dt_Consulta);
        }
        catch (Exception ex)
        {
    ...
    ///*******************************************************************************
    ///NOMBRE DE LA FUNCIÓN : Cargar_Grid_Materiales
    ...
    ///CAUSA_MODIFICACIÓN
    ///*******************************************************************************  
    private void Cargar_Grid_Materiales(DataTable Dt_Consulta)
    {
        try
        {
            if (Dt_Consulta != null && Dt_Consulta.Rows.Count > 0)
            {
                Grid_Material.Columns[1].Visible = true;
                Grid_Material.DataSource = Dt_Consulta;
                Grid_Material.DataBind();
                Grid_Material.Columns[1].Visible = false;
                Grid_Material.SelectedIndex = -1;
            }
            else
            {
                Grid_Material.Columns[1].Visible = true;
                Grid_Material.DataSource = new DataTable();
                Grid_Material.DataBind();
                Grid_Material.Columns[1].Visible = false;
            }
        }
    ...
    private void Alta()
    {
        Cls_Cat_Ort_Tipo_Material_Negocio Negocio_Alta = new Cls_Cat_Ort_Tipo_Material_Negocio();
        try
        {
    ...
    {
        Cls_Cat_Ort_Tipo_Material_Negocio Negocio_Modificar = new Cls_Cat_Ort_Tipo_Material_Negocio();
        try
        {
            Negocio_Modificar.P_Tipo_Material_ID= Hdf_Elemento_ID.Value;
    ...
    {
        Cls_Cat_Ort_Tipo_Material_Negocio Negocio_Eliminar = new Cls_Cat_Ort_Tipo_Material_Negocio();
        try
        {
            Negocio_Eliminar.P_Tipo_Material_ID = Hdf_Elemento_ID.Value;
    ...
    private void Buscar()
    {
        Cls_Cat_Ort_Tipo_Material_Negocio Negocio_Buscar = new Cls_Cat_Ort_Tipo_Material_Negocio();
        DataTable Dt_Consulta = new DataTable();
        try
        {
            Negocio_Buscar.P_Nombre = Txt_Busqueda.Text;
            Dt_Consulta = Negocio_Buscar.Consultar_Tipos_Materiales();
            Cargar_Grid_Materiales(Dt_Consulta);
        }
        catch (Exception ex)
        {
    ...
    #region Grid
    ///*******************************************************************************
    /// NOMBRE DE LA FUNCION: Grid_Material_SelectedIndexChanged
    ...
    /// CAUSA_MODIFICACION:
    ///*******************************************************************************
    protected void Grid_Material_SelectedIndexChanged(object sender, EventArgs e)
    {
        try
        {
            Limpiar_Controles();
            GridViewRow selectedRow = Grid_Material.Rows[Grid_Material.SelectedIndex];
