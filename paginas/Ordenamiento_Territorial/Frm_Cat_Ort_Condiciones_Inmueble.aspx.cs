...
public partial class paginas_Ordenamiento_Territorial_Frm_Cat_Ort_Condiciones_Inmueble : System.Web.UI.Page
{
    #region Load
    ///*******************************************************************************
    ...
    private void Limpiar_Controles()
    {
        try
        {
            Hdf_Condicion_Inmueble_ID.Value = "";
            Txt_Busqueda.Text = "";
            Txt_Nombre.Text = "";
    ...
    private void Habilitar_Controles(String Operacion)
    {
        ...
        try
        {
            ...
            Grid_Condiciones_Inmueble.Enabled = !Habilitado;
        }
        catch (Exception ex)
        {
    ...
    private Boolean Validar_Datos_Modificar()
    {
        ...
        if (Hdf_Condicion_Inmueble_ID.Value == "")
        {
    ...
    ///*******************************************************************************
    ///NOMBRE DE LA FUNCIÓN : Cargar_Condiciones_Inmueble
    ///DESCRIPCIÓN          : se cargara las condiciones del inmueble
    ///PARAMETROS           : 
    ///CREO                 : Hugo Enrique Ramírez Aguilera
    ///FECHA_CREO           : 11/Junio/2012
    ///MODIFICO:
    ...
    ///CAUSA_MODIFICACIÓN
    ///*******************************************************************************  
    private void Cargar_Condiciones_Inmueble()
    {
        Cls_Cat_Ort_Condiciones_Inmueble_Negocio Negocio_Consulta = new Cls_Cat_Ort_Condiciones_Inmueble_Negocio();
        DataTable Dt_Consulta = new DataTable();
        try
        {
            Dt_Consulta = Negocio_Consulta.Consultar_Condiciones_Inmueble();
            Cargar_Grid_Condiciones_Inmueble(Dt_Consulta);
        }
        catch (Exception ex)
        {
            throw new Exception("Cargar_Condiciones_Inmueble " + ex.Message.ToString());
        }
    }
    ///*******************************************************************************
    ///NOMBRE DE LA FUNCIÓN : Cargar_Grid_Condiciones_Inmueble
    ...
    ///CAUSA_MODIFICACIÓN
    ///*******************************************************************************  
    private void Cargar_Grid_Condiciones_Inmueble(DataTable Dt_Formatos)
    {
        DataTable Dt_Consulta = new DataTable();
        try
        {
            ...
            {
                Grid_Condiciones_Inmueble.Columns[1].Visible = true;
                Grid_Condiciones_Inmueble.DataSource = Dt_Formatos;
                Grid_Condiciones_Inmueble.DataBind();
                Grid_Condiciones_Inmueble.Columns[1].Visible = false;
                Grid_Condiciones_Inmueble.SelectedIndex = -1;
            }
            else
            {
                Grid_Condiciones_Inmueble.Columns[1].Visible = true;
                Grid_Condiciones_Inmueble.DataSource = new DataTable();
                Grid_Condiciones_Inmueble.DataBind();
                Grid_Condiciones_Inmueble.Columns[1].Visible = false;
            }
        }
        ...
        {
            throw new Exception("Cargar_Grid_Condiciones_Inmueble " + ex.Message.ToString());
        }
    }
    ///*******************************************************************************
    ...
    private void Alta()
    {
        Cls_Cat_Ort_Condiciones_Inmueble_Negocio Negocio_Alta = new Cls_Cat_Ort_Condiciones_Inmueble_Negocio();
        try
        {
            Negocio_Alta.P_Nombre = Txt_Nombre.Text;
            Negocio_Alta.P_Usuario = Cls_Sessiones.Nombre_Empleado;
            Negocio_Alta.Alta_Condicion_Inmueble();
        }
        catch (Exception ex)
        {
    ...
    {
        Cls_Cat_Ort_Condiciones_Inmueble_Negocio Negocio_Modificar = new Cls_Cat_Ort_Condiciones_Inmueble_Negocio();
        try
        {
            Negocio_Modificar.P_Condicion_Inmueble_ID = Hdf_Condicion_Inmueble_ID.Value;
            Negocio_Modificar.P_Nombre = Txt_Nombre.Text;
            Negocio_Modificar.P_Usuario = Cls_Sessiones.Nombre_Empleado;
            Negocio_Modificar.Modificar_Condicion_Inmueble();
        }
        catch (Exception ex)
        {
    ...
    {
        Cls_Cat_Ort_Condiciones_Inmueble_Negocio Negocio_Eliminar = new Cls_Cat_Ort_Condiciones_Inmueble_Negocio();
        try
        {
            Negocio_Eliminar.P_Condicion_Inmueble_ID = Hdf_Condicion_Inmueble_ID.Value;
            Negocio_Eliminar.Eliminar_Condicion_Inmueble();
        }
        catch (Exception ex)
        {
    ...
    private void Buscar()
    {
        Cls_Cat_Ort_Condiciones_Inmueble_Negocio Negocio_Buscar = new Cls_Cat_Ort_Condiciones_Inmueble_Negocio();
        DataTable Dt_Consulta = new DataTable();
        try
        {
            Negocio_Buscar.P_Nombre = Txt_Busqueda.Text;
            Dt_Consulta = Negocio_Buscar.Consultar_Condiciones_Inmueble();
            Cargar_Grid_Condiciones_Inmueble(Dt_Consulta);
        }
        catch (Exception ex)
        {
    ...
    protected void Btn_Modificar_Click(object sender, ImageClickEventArgs e)
    {
        try
        {
            ...
            if (Btn_Modificar.ToolTip == "Modificar" && Hdf_Condicion_Inmueble_ID.Value != "")
            {
    ...
    protected void Btn_Eliminar_Click(object sender, ImageClickEventArgs e)
    {
        try
        {
            ...
            if (!string.IsNullOrEmpty(Hdf_Condicion_Inmueble_ID.Value))
            {
                Eliminar();
                Inicializar_Controles();
    ...
    #region Grid
    ///*******************************************************************************
    /// NOMBRE DE LA FUNCION: Grid_Condiciones_Inmueble_SelectedIndexChanged
    ...
    /// CAUSA_MODIFICACION:
    ///*******************************************************************************
    protected void Grid_Condiciones_Inmueble_SelectedIndexChanged(object sender, EventArgs e)
    {
        try
        {
            Limpiar_Controles();
            GridViewRow selectedRow = Grid_Condiciones_Inmueble.Rows[Grid_Condiciones_Inmueble.SelectedIndex];
            Hdf_Condicion_Inmueble_ID.Value = HttpUtility.HtmlDecode(selectedRow.Cells[1].Text).ToString();
