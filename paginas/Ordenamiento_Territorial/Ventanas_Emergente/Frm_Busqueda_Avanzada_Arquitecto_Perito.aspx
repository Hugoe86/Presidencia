<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Frm_Busqueda_Avanzada_Arquitecto_Perito.aspx.cs" 
Inherits="paginas_Ordenamiento_Territorial_Ventanas_Emergente_Frm_Busqueda_Avanzada_Arquitecto_Perito" %>
        ...
        <div id="Div_Cuerpo" style="width: 98%;" runat="server" visible="true">
            ...
            <table width="99%">   
                <tr>
                    ...
                    <td style="width:80%">
                        <asp:TextBox ID="Txt_Nombre" runat="server" Width="98%"></asp:TextBox>
                    </td> 
                    ...
                    <td style="width:100%;text-align:center;vertical-align:top;">
                        <center>
                            <div id="Div_Tramites_Generales" runat="server" 
                                ...
                                <asp:GridView ID="Grid_Personal" runat="server" CssClass="GridView_1"
                                    AutoGenerateColumns="False"  Width="90%"
                                    GridLines= "None"
                                    EmptyDataText="No se encuentra ningun registro"
                                    onselectedindexchanged="Grid_Personal_SelectedIndexChanged" >
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="INSPECTOR_ID" HeaderText="INSPECTOR_ID"
                                            SortExpression="INSPECTOR_ID">
                                        ...
                                        <asp:BoundField DataField="NOMBRE" HeaderText="Nombre" 
                                            ...
                                            <HeaderStyle HorizontalAlign="Left" Width="100%" Font-Size="13px" />
                                            <ItemStyle HorizontalAlign="Left" Width="100%" Font-Size="12px" />
                                        </asp:BoundField>   
                                    </Columns>
