...
public partial class paginas_Ordenamiento_Territorial_Frm_Cat_Ort_Uso_Actual : System.Web.UI.Page
{
    #region Load
    ///*******************************************************************************
    ...
    private void Habilitar_Controles(String Operacion)
    {
        ...
        try
        {
            ...
            Grid_Uso_Actual.Enabled = !Habilitado;
        }
        catch (Exception ex)
        {
    ...
    ///CAUSA_MODIFICACIÓN
    ///*******************************************************************************  
    private void Cargar_Uso_Actual()
    {
        Cls_Cat_Ort_Uso_Actual_Negocio Negocio_Consulta = new Cls_Cat_Ort_Uso_Actual_Negocio();
        DataTable Dt_Consulta = new DataTable();
        try
        {
            Dt_Consulta = Negocio_Consulta.Consultar_Uso_Actual();
            Cargar_Grid_Uso_Actual(Dt_Consulta);
        }
        catch (Exception ex)
        {
    ...
    ///*******************************************************************************
    ///NOMBRE DE LA FUNCIÓN : Cargar_Grid_Uso_Actual
    ...
    ///CAUSA_MODIFICACIÓN
    ///*******************************************************************************  
    private void Cargar_Grid_Uso_Actual(DataTable Dt_Consulta)
    {
        try
        {
            if (Dt_Consulta != null && Dt_Consulta.Rows.Count > 0)
            {
                Grid_Uso_Actual.Columns[1].Visible = true;
                Grid_Uso_Actual.DataSource = Dt_Consulta;
                Grid_Uso_Actual.DataBind();
                Grid_Uso_Actual.Columns[1].Visible = false;
                Grid_Uso_Actual.SelectedIndex = -1;
            }
            else
            {
                Grid_Uso_Actual.Columns[1].Visible = true;
                Grid_Uso_Actual.DataSource = new DataTable();
                Grid_Uso_Actual.DataBind();
                Grid_Uso_Actual.Columns[1].Visible = false;
            }
        }
    ...
    private void Alta()
    {
        Cls_Cat_Ort_Uso_Actual_Negocio Negocio_Alta = new Cls_Cat_Ort_Uso_Actual_Negocio();
        try
        {
    ...
    {
        Cls_Cat_Ort_Uso_Actual_Negocio Negocio_Modificar = new Cls_Cat_Ort_Uso_Actual_Negocio();
        try
        {
            Negocio_Modificar.P_Uso_Actual_ID = Hdf_Elemento_ID.Value;
    ...
    {
        Cls_Cat_Ort_Uso_Actual_Negocio Negocio_Eliminar = new Cls_Cat_Ort_Uso_Actual_Negocio();
        try
        {
            Negocio_Eliminar.P_Uso_Actual_ID = Hdf_Elemento_ID.Value;
    ...
    private void Buscar()
    {
        Cls_Cat_Ort_Uso_Actual_Negocio Negocio_Buscar = new Cls_Cat_Ort_Uso_Actual_Negocio();
        DataTable Dt_Consulta = new DataTable();
        try
        {
            Negocio_Buscar.P_Nombre = Txt_Busqueda.Text;
            Dt_Consulta = Negocio_Buscar.Consultar_Uso_Actual();
            Cargar_Grid_Uso_Actual(Dt_Consulta);
        }
        catch (Exception ex)
        {
    ...
    #region Grid
    ///*******************************************************************************
    /// NOMBRE DE LA FUNCION: Grid_Uso_Actual_SelectedIndexChanged
    ...
    /// CAUSA_MODIFICACION:
    ///*******************************************************************************
    protected void Grid_Uso_Actual_SelectedIndexChanged(object sender, EventArgs e)
    {
        try
        {
            Limpiar_Controles();
            GridViewRow selectedRow = Grid_Uso_Actual.Rows[Grid_Uso_Actual.SelectedIndex];
