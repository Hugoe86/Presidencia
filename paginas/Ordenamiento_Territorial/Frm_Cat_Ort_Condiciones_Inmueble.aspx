...
CodeFile="Frm_Cat_Ort_Condiciones_Inmueble.aspx.cs" Inherits="paginas_Ordenamiento_Territorial_Frm_Cat_Ort_Condiciones_Inmueble" 
Title="Catalogo Condiciones del inmueble" %>
        ...
        <ContentTemplate>
           ...
           <div id="Div_Contenido" style="background-color: #ffffff; width: 100%; height: 100%;">
                <table width = "98%" border="0" cellspacing="0">                     
                    <tr>
                        <td colspan ="4" class="label_titulo">Catálogo Condiciones del inmueble</td>
                    </tr>
                ...
                <div id="Div_Plantilla_id" runat="server" style="display:none">
                    <table width="98%">
                        <tr>
                            <td >
                                <asp:HiddenField ID="Hdf_Condicion_Inmueble_ID" runat="server" />
                            </td>
                        </tr>
                    </table>
                     <table width="98%">
                    ...
                    <table width="98%">
                        <tr>
                            <td style="width:100%;text-align:center;vertical-align:top;">
                                <center>
                                    <div id="Div_Condiciones_Inmueble" runat="server" 
                                        style="overflow:auto;height:200px;width:99%;vertical-align:top;border-style:solid;border-color:Silver;display:block">                              
                                        <asp:GridView ID="Grid_Condiciones_Inmueble" runat="server" AutoGenerateColumns="False" 
                                            CssClass="GridView_1" Width="100%"  
                                            EmptyDataText="No se encontraron datos"
                                            onselectedindexchanged="Grid_Condiciones_Inmueble_SelectedIndexChanged" 
                                            GridLines="None">
                                            ...
                                            <Columns>
                                                ...
                                                <%-- 1 --%>
                                                <asp:BoundField DataField="CONDICION_INMUEBLE_ID" HeaderText="ID" Visible="True">
