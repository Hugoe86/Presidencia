...
CodeFile="Frm_Cat_Ort_Area_Publicas_Donacion.aspx.cs" Inherits="paginas_Ordenamiento_Territorial_Frm_Cat_Ort_Area_Publicas_Donacion" %>
        ...
        <ContentTemplate>
           ...
           <div id="Div_Contenido" style="background-color: #ffffff; width: 100%; height: 100%;">
                <table width = "98%" border="0" cellspacing="0">                     
                    <tr>
                        <td colspan ="4" class="label_titulo">Catálogo Respecto a la via publica y ares de donacion</td>
                    </tr>
                            ...
                            <td style="width:100%;text-align:center;vertical-align:top;">
                                <center>
                                    <div id="Div_Avance_Obra" runat="server" 
                                        ...
                                        <asp:GridView ID="Grid_Areas" runat="server" AutoGenerateColumns="False" 
                                            ...
                                            <Columns>
                                                ...
                                                <%-- 1 --%>
                                                <asp:BoundField DataField="AREA_ID" HeaderText="ID" Visible="True">
