...
CodeFile="Frm_Rpt_Ort_Seguimiento_Solicitud_Tramite.aspx.cs" Inherits="paginas_Ordenamiento_Territorial_Frm_Rpt_Ort_Seguimiento_Solicitud_Tramite" %>
        ...
        <ContentTemplate>
           ...
           <div id="Div_Contenido" runat="server" style="background-color: #ffffff; width: 100%; height: 100%;">
                <table width = "98%" border="0" cellspacing="0">                     
                    <tr>
                        <td colspan ="4" class="label_titulo">Seguimiento de solicitud de tramite</td>
                    </tr>
                ...
                <table width="98%">
                    <tr>                          
                        ...
                        <td  style="width:85%" align="left">
                            <asp:DropDownList ID="Cmb_Solicitud" runat="server" Width="90%" ></asp:DropDownList>  
