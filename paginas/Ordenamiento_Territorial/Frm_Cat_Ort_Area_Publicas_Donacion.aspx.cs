...
public partial class paginas_Ordenamiento_Territorial_Frm_Cat_Ort_Area_Publicas_Donacion : System.Web.UI.Page
{
    #region Load
    ///*******************************************************************************
    ...
    ///*******************************************************************************
    ///NOMBRE DE LA FUNCIÓN : Cargar_Area
    ...
    {
        Cls_Cat_Ort_Areas_Publicas_Donaciones_Negocio Negocio_Consulta = new Cls_Cat_Ort_Areas_Publicas_Donaciones_Negocio();
        DataTable Dt_Consulta = new DataTable();
        try
        {
            Dt_Consulta = Negocio_Consulta.Consultar_Areas();
            Cargar_Gridr_Area(Dt_Consulta);
        }
        catch (Exception ex)
        {
    ...
    ///*******************************************************************************
    ///NOMBRE DE LA FUNCIÓN : Cargar_Gridr_Area
    ...
    ///CAUSA_MODIFICACIÓN
    ///*******************************************************************************  
    private void Cargar_Gridr_Area(DataTable Dt_Consulta)
    {
        try
        {
            if (Dt_Consulta != null && Dt_Consulta.Rows.Count > 0)
            {
                Grid_Areas.Columns[1].Visible = true;
                Grid_Areas.DataSource = Dt_Consulta;
                Grid_Areas.DataBind();
                Grid_Areas.Columns[1].Visible = false;
                Grid_Areas.SelectedIndex = -1;
            }
            else
            {
                Grid_Areas.Columns[1].Visible = true;
                Grid_Areas.DataSource = new DataTable();
                Grid_Areas.DataBind();
                Grid_Areas.Columns[1].Visible = false;
            }
        }
    ...
    private void Alta()
    {
        Cls_Cat_Ort_Areas_Publicas_Donaciones_Negocio Negocio_Alta = new Cls_Cat_Ort_Areas_Publicas_Donaciones_Negocio();
        try
        {
    ...
    {
        Cls_Cat_Ort_Areas_Publicas_Donaciones_Negocio Negocio_Modificar = new Cls_Cat_Ort_Areas_Publicas_Donaciones_Negocio();
        try
        {
            Negocio_Modificar.P_Area_ID = Hdf_Elemento_ID.Value;
    ...
    {
        Cls_Cat_Ort_Areas_Publicas_Donaciones_Negocio Negocio_Eliminar = new Cls_Cat_Ort_Areas_Publicas_Donaciones_Negocio();
        try
        {
            Negocio_Eliminar.P_Area_ID = Hdf_Elemento_ID.Value;
    ...
    private void Buscar()
    {
        Cls_Cat_Ort_Areas_Publicas_Donaciones_Negocio Negocio_Buscar = new Cls_Cat_Ort_Areas_Publicas_Donaciones_Negocio();
        DataTable Dt_Consulta = new DataTable();
        try
        {
            Negocio_Buscar.P_Nombre = Txt_Busqueda.Text;
            Dt_Consulta = Negocio_Buscar.Consultar_Areas();
            Cargar_Gridr_Area(Dt_Consulta);
        }
        catch (Exception ex)
        {
    ...
    protected void Grid_Areas_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        {
            Limpiar_Controles();
            GridViewRow selectedRow = Grid_Areas.Rows[Grid_Areas.SelectedIndex];
