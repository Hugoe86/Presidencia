...
public partial class paginas_Ordenamiento_Territorial_Frm_Cat_Ort_Avance_Obra : System.Web.UI.Page
{
    #region Load
    ///*******************************************************************************
    ...
    private void Habilitar_Controles(String Operacion)
    {
        ...
        try
        {
            ...
            Grid_Avance_Obra.Enabled = !Habilitado;
        }
        catch (Exception ex)
        {
    ...
    ///*******************************************************************************
    ///NOMBRE DE LA FUNCIÓN : Cargar_Avance
    ...
    ///CAUSA_MODIFICACIÓN
    ///*******************************************************************************  
    private void Cargar_Avance()
    {
        Cls_Cat_Ort_Avance_Obra_Negocio Negocio_Consulta = new Cls_Cat_Ort_Avance_Obra_Negocio();
        DataTable Dt_Consulta = new DataTable();
        try
        {
            Dt_Consulta = Negocio_Consulta.Consultar_Avance_Obra();
            Cargar_Gridr_Avance(Dt_Consulta);
        }
        catch (Exception ex)
        {
    ...
    ///*******************************************************************************
    ///NOMBRE DE LA FUNCIÓN : Cargar_Grid_Cargar_Avance
    ...
    ///CAUSA_MODIFICACIÓN
    ///*******************************************************************************  
    private void Cargar_Gridr_Avance(DataTable Dt_Consulta)
    {
        try
        {
            if (Dt_Consulta != null && Dt_Consulta.Rows.Count > 0)
            {
                Grid_Avance_Obra.Columns[1].Visible = true;
                Grid_Avance_Obra.DataSource = Dt_Consulta;
                Grid_Avance_Obra.DataBind();
                Grid_Avance_Obra.Columns[1].Visible = false;
                Grid_Avance_Obra.SelectedIndex = -1;
            }
            else
            {
                Grid_Avance_Obra.Columns[1].Visible = true;
                Grid_Avance_Obra.DataSource = new DataTable();
                Grid_Avance_Obra.DataBind();
                Grid_Avance_Obra.Columns[1].Visible = false;
            }
        }
    ...
    private void Alta()
    {
        Cls_Cat_Ort_Avance_Obra_Negocio Negocio_Alta = new Cls_Cat_Ort_Avance_Obra_Negocio();
        try
        {
    ...
    {
        Cls_Cat_Ort_Avance_Obra_Negocio Negocio_Modificar = new Cls_Cat_Ort_Avance_Obra_Negocio();
        try
        {
            Negocio_Modificar.P_Avance_Obra_ID = Hdf_Elemento_ID.Value;
    ...
    {
        Cls_Cat_Ort_Avance_Obra_Negocio Negocio_Eliminar = new Cls_Cat_Ort_Avance_Obra_Negocio();
        try
        {
            Negocio_Eliminar.P_Avance_Obra_ID = Hdf_Elemento_ID.Value;
    ...
    private void Buscar()
    {
        Cls_Cat_Ort_Avance_Obra_Negocio Negocio_Buscar = new Cls_Cat_Ort_Avance_Obra_Negocio();
        DataTable Dt_Consulta = new DataTable();
        try
        {
            Negocio_Buscar.P_Nombre = Txt_Busqueda.Text;
            Dt_Consulta = Negocio_Buscar.Consultar_Avance_Obra();
            Cargar_Gridr_Avance(Dt_Consulta);
        }
        catch (Exception ex)
        {
    ...
    #region Grid
    ///*******************************************************************************
    /// NOMBRE DE LA FUNCION: Grid_Avance_Obra_SelectedIndexChanged
    ...
    /// CAUSA_MODIFICACION:
    ///*******************************************************************************
    protected void Grid_Avance_Obra_SelectedIndexChanged(object sender, EventArgs e)
    {
        try
        {
            Limpiar_Controles();
            GridViewRow selectedRow = Grid_Avance_Obra.Rows[Grid_Avance_Obra.SelectedIndex];
