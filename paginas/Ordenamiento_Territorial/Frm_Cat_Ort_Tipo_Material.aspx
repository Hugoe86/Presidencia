...
CodeFile="Frm_Cat_Ort_Tipo_Material.aspx.cs" Inherits="paginas_Ordenamiento_Territorial_Frm_Cat_Ort_Tipo_Material" %>
        ...
        <ContentTemplate>
           ...
           <div id="Div_Contenido" style="background-color: #ffffff; width: 100%; height: 100%;">
                <table width = "98%" border="0" cellspacing="0">                     
                    <tr>
                        <td colspan ="4" class="label_titulo">Catálogo Materiales</td>
                    </tr>
                            ...
                            <td style="width:100%;text-align:center;vertical-align:top;">
                                <center>
                                    <div id="Div_Avance_Obra" runat="server" 
                                        ...
                                        <asp:GridView ID="Grid_Material" runat="server" AutoGenerateColumns="False" 
                                            CssClass="GridView_1" Width="100%"  
                                            EmptyDataText="No se encontraron datos"
                                            onselectedindexchanged="Grid_Material_SelectedIndexChanged" 
                                            GridLines="None">
                                            ...
                                            <Columns>
                                                ...
                                                <%-- 1 --%>
                                                <asp:BoundField DataField="MATERIAL_ID" HeaderText="ID" Visible="True">
