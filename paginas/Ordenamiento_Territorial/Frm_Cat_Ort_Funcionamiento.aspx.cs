...
using Presidencia.Ordenamiento_Territorial_Funcionamiento.Negocio;


public partial class paginas_Ordenamiento_Territorial_Frm_Cat_Ort_Funcionamiento : System.Web.UI.Page
{
    #region Load
    ///*******************************************************************************
    ...
    private void Habilitar_Controles(String Operacion)
    {
        ...
        try
        {
            ...
            Grid_Funcionamiento.Enabled = !Habilitado;
        }
        catch (Exception ex)
        {
    ...
    ///*******************************************************************************
    ///NOMBRE DE LA FUNCIÓN : CargarCargar_Funcionamiento_Inspectores
    ...
    ///CAUSA_MODIFICACIÓN
    ///*******************************************************************************  
    private void Cargar_Funcionamiento()
    {
        Cls_Cat_Ort_Funcionamiento_Negocio Negocio_Consulta = new Cls_Cat_Ort_Funcionamiento_Negocio();
        DataTable Dt_Consulta = new DataTable();
        try
        {
            Dt_Consulta = Negocio_Consulta.Consultar_Funcionamiento();
            Cargar_Grid_Funcionamiento(Dt_Consulta);
        }
        catch (Exception ex)
        {
    ...
    ///*******************************************************************************
    ///NOMBRE DE LA FUNCIÓN : Cargar_Grid_Funcionamiento
    ...
    ///CAUSA_MODIFICACIÓN
    ///*******************************************************************************  
    private void Cargar_Grid_Funcionamiento(DataTable Dt_Consulta)
    {
        try
        {
            if (Dt_Consulta != null && Dt_Consulta.Rows.Count > 0)
            {
                Grid_Funcionamiento.Columns[1].Visible = true;
                Grid_Funcionamiento.DataSource = Dt_Consulta;
                Grid_Funcionamiento.DataBind();
                Grid_Funcionamiento.Columns[1].Visible = false;
                Grid_Funcionamiento.SelectedIndex = -1;
            }
            else
            {
                Grid_Funcionamiento.Columns[1].Visible = true;
                Grid_Funcionamiento.DataSource = new DataTable();
                Grid_Funcionamiento.DataBind();
                Grid_Funcionamiento.Columns[1].Visible = false;
            }
        }
        ...
        {
            throw new Exception("Cargar_Grid_Funcionamiento " + ex.Message.ToString());
        }
    }
    ///*******************************************************************************
    ...
    private void Alta()
    {
        Cls_Cat_Ort_Funcionamiento_Negocio Negocio_Alta = new Cls_Cat_Ort_Funcionamiento_Negocio();
        try
        {
    ...
    {
        Cls_Cat_Ort_Funcionamiento_Negocio Negocio_Modificar = new Cls_Cat_Ort_Funcionamiento_Negocio();
        try
        {
            Negocio_Modificar.P_Funcionamiento_ID = Hdf_Elemento_ID.Value;
    ...
    {
        Cls_Cat_Ort_Funcionamiento_Negocio Negocio_Eliminar = new Cls_Cat_Ort_Funcionamiento_Negocio();
        try
        {
            Negocio_Eliminar.P_Funcionamiento_ID = Hdf_Elemento_ID.Value;
    ...
    private void Buscar()
    {
        Cls_Cat_Ort_Funcionamiento_Negocio Negocio_Buscar = new Cls_Cat_Ort_Funcionamiento_Negocio();
        DataTable Dt_Consulta = new DataTable();
        try
        {
            Negocio_Buscar.P_Nombre = Txt_Busqueda.Text;
            Dt_Consulta = Negocio_Buscar.Consultar_Funcionamiento();
            Cargar_Grid_Funcionamiento(Dt_Consulta);
        }
        catch (Exception ex)
        {
    ...
    #region Grid
    ///*******************************************************************************
    /// NOMBRE DE LA FUNCION: Grid_Funcionamiento_SelectedIndexChanged
    ...
    /// CAUSA_MODIFICACION:
    ///*******************************************************************************
    protected void Grid_Funcionamiento_SelectedIndexChanged(object sender, EventArgs e)
    {
        try
        {
            Limpiar_Controles();
            GridViewRow selectedRow = Grid_Funcionamiento.Rows[Grid_Funcionamiento.SelectedIndex];
