...
public partial class paginas_Atencion_Ciudadana_Reportes_Unidad_Responsable : System.Web.UI.Page
{
    ...
    public void LLenar_Combos()
    {
        ...
        var Obj_Dependencias = new Cls_Ope_Consulta_Peticiones_Negocio();
        ...
        try
        {
            ...
            Llenar_Combo_Con_DataTable(Cmb_Dependencias, Obj_Dependencias.Consultar_Unidad_Responsable_De_Empleado(Cls_Sessiones.Empleado_ID, Cls_Sessiones.Dependencia_ID_Empleado));
            // eliminar el primer elemento del combo <SELECCIONE>
            if (Cmb_Dependencias.Items.Count > 0)
            {
                Cmb_Dependencias.Items.RemoveAt(0);
            }
            // Combo de Asunto
            Obj_Asunto.P_Estatus = "ACTIVO";
            Obj_Asunto.P_Dependencia_ID = Cls_Sessiones.Dependencia_ID_Empleado;
            Llenar_Combo_Con_DataTable(Cmb_Asunto, Obj_Asunto.Consultar_Registros());
        }
        catch (Exception Ex)
        {
            Mostrar_Informacion("No se pudo mostrar información: " + Ex.Message);
        }
    }
    ...
    protected string Crear_Ds_Consulta_Peticiones(out DataSet Ds_Peticiones)
    {
        ...
        // asignar la dependencia del usuario que inició la sesión
        ...
        else
        {
            ...
            else if (Cmb_Tipo_Reporte.SelectedValue == "ESTADISTICAS_DEPENDENCIA" || Cmb_Tipo_Reporte.SelectedValue == "ESTADISTICAS_ASUNTO")
            {
    ...
    protected string Obtener_Texto_Filtros_Aplicados()
    {
        ...
        Cls_Cat_Dependencias_Negocio Neg_Consulta_Dependencias = new Cls_Cat_Dependencias_Negocio();
        DataTable Dt_Dependencias;

        // obtener el nombre de la dependencia
        Neg_Consulta_Dependencias.P_Estatus = "ACTIVO";
        Neg_Consulta_Dependencias.P_Dependencia_ID = Cmb_Dependencias.SelectedValue;
        Dt_Dependencias = Neg_Consulta_Dependencias.Consulta_Dependencias();
        ...
        {
            Filtros[Contador_Filtros++] = "de la Unidad responsable: " + Dt_Dependencias.Rows[0][Cat_Dependencias.Campo_Nombre].ToString();
        }
        ...
        {
            Texto_Filtros = Filtros[0];
        }
        else if (Contador_Filtros == 2)
        {
            Texto_Filtros = Filtros[0] + " y " + Filtros[1];
        }
        else if (Contador_Filtros >= 3 && Contador_Filtros <= Filtros.Length)
        {
            Texto_Filtros = string.Join(", ", Filtros, 0, Filtros.Length - 2) + ", " + string.Join(", ", Filtros, Filtros.Length - 2, 2);
        }

        return Texto_Filtros.Substring(0, 1).ToUpper() + Texto_Filtros.Substring(1, Texto_Filtros.Length - 1);
    }
            ...
            if (Mensaje.Length <= 0)
            {
                ...
                if (Data_Set != null && Data_Set.Tables.Count > 0 && Data_Set.Tables[0].Rows.Count > 0)
                {
                    ...
                    if (Cmb_Tipo_Reporte.SelectedValue == "REPORTE_DETALLADO")
                    {
                        ...
                        Generar_Reporte_PDF_Detallado(Data_Set, ds_informacion_detallada, "Rpt_Rep_Ate_Informacion_Detalllada_Sin_Agrupar.rpt", "Rpt_Informacion_Detalllada.pdf");
                    }
                    else if (Cmb_Tipo_Reporte.SelectedValue == "REPORTE_ACUMULADO")
                    {
                        Ds_Reporte_Acumulado ds_reporte_acumulado = new Ds_Reporte_Acumulado();
                        Generar_Reporte_PDF(Data_Set, ds_reporte_acumulado, "Rpt_Informacion_Acumulados.rpt", "Rpt_Acumulados.pdf");
                    }
                    else if (Cmb_Tipo_Reporte.SelectedValue == "ESTADISTICAS_DEPENDENCIA")
                    {
                        ...
                        Generar_Reporte_PDF(Data_Set, Ds_Reporte, "Rpt_Ope_Ate_Estadisticas_Peticiones.rpt", "Rpt_Estadistica_Dependencia.pdf");
                    }
                    else if (Cmb_Tipo_Reporte.SelectedValue == "ESTADISTICAS_ASUNTO")
                    {
                        Ds_Ate_Estadisticas_Peticiones Ds_Reporte = new Ds_Ate_Estadisticas_Peticiones();
                        Generar_Reporte_PDF(Data_Set, Ds_Reporte, "Rpt_Ope_Ate_Estadisticas_Peticiones_Asunto.rpt", "Rpt_Estadistica_Asunto.pdf");
                    }
                    else if (Cmb_Tipo_Reporte.SelectedValue == "TIEMPOS_RESPUESTA")
                    {
                        Ds_Graficas_Tiempos Ds_Reporte = new Ds_Graficas_Tiempos();
                        Generar_Reporte_PDF(Data_Set, Ds_Reporte, "Rpt_Grafica_Tiempos_Dependencias.rpt", "Rpt_Tiempos_Respuesta.pdf");
                    }
                }
                else
                {
        ...
        try
        {
            ...
            if (Mensaje.Length <= 0)
            {
                if (Data_Set != null && Data_Set.Tables[0].Rows.Count > 0)
                {
                    ...
                    {
                        Ds_Reporte_Informacion_Detallada ds_informacion_detallada = new Ds_Reporte_Informacion_Detallada();
                        Exportar_Excel_Detallado(Data_Set, ds_informacion_detallada, "Rpt_Informacion_Detalllada.rpt", "Rpt_Informacion_Detalllada.xls");
                    }
                    else if (Cmb_Tipo_Reporte.SelectedValue == "REPORTE_ACUMULADO")
                    {
                        Ds_Reporte_Acumulado ds_reporte_acumulado = new Ds_Reporte_Acumulado();
                        Exportar_Excel(Data_Set, ds_reporte_acumulado, "Rpt_Informacion_Acumulados.rpt", "Rpt_Acumulados.xls");
                    }
                    else if (Cmb_Tipo_Reporte.SelectedValue == "ESTADISTICAS_DEPENDENCIA")
                    {
                        Ds_Ate_Estadisticas_Peticiones Ds_Reporte = new Ds_Ate_Estadisticas_Peticiones();
                        Exportar_Excel(Data_Set, Ds_Reporte, "Rpt_Ope_Ate_Estadisticas_Peticiones.rpt", "Rpt_Acumulados.xls");
                    }
                    else if (Cmb_Tipo_Reporte.SelectedValue == "ESTADISTICAS_ASUNTO")
                    {
                        Ds_Ate_Estadisticas_Peticiones Ds_Reporte = new Ds_Ate_Estadisticas_Peticiones();
                        Exportar_Excel(Data_Set, Ds_Reporte, "Rpt_Ope_Ate_Estadisticas_Peticiones_Asunto.rpt", "Rpt_estadistica_Asunto.xls");
                    }
                    else if (Cmb_Tipo_Reporte.SelectedValue == "TIEMPOS_RESPUESTA")
                    {
                        Ds_Graficas_Tiempos Ds_Reporte = new Ds_Graficas_Tiempos();
                        Exportar_Excel(Data_Set, Ds_Reporte, "Rpt_Grafica_Tiempos_Dependencias.rpt", "Rpt_Tiempos_Respuesta.xls");
                    }
                }
                else
                {
