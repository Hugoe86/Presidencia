<%@ Page Title="Programas" Language="C#" MasterPageFile="~/paginas/Paginas_Generales/MasterPage.master"
    AutoEventWireup="true" CodeFile="Frm_Cat_Ate_Programas.aspx.cs" Inherits="paginas_Atencion_Ciudadana_Frm_Cat_Ate_Programas" %>
                ...
                <div id="Div_Contenido1" runat="server" style="width: 99%;">
                    <table width="99.5%" border="0" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td colspan="4">
                                <asp:TextBox ID="Txt_Descripcion" runat="server" Width="99%" TextMode="MultiLine"></asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="Txt_Prefijo" runat="server" MaxLength="5"></asp:TextBox>
                                <cc1:FilteredTextBoxExtender ID="Filteredtextboxextender1" runat="server" TargetControlID="Txt_Prefijo"
                                    FilterType="Custom, UppercaseLetters, LowercaseLetters, Numbers" ValidChars="ÑñáéíóúÁÉÍÓÚ./*-!$%&()=,[]{}+<>@?¡?¿# ">
                                </cc1:FilteredTextBoxExtender>
                            </td>
                            <td>
                            ...
                            <td style="text-align: right;">
                                <asp:DropDownList ID="Cmb_Folio_Anual" runat="server" Width="100%" ToolTip="El folio se reinicia con el cambio de año">
                        ...
                        <tr>
                            <td colspan="5">
                                <asp:GridView ID="Grid_Datos" runat="server" AutoGenerateColumns="False" CssClass="GridView_1"
                                    GridLines="None" Width="100%" DataKeyNames="PROGRAMA_ID" HeaderStyle-CssClass="tblHead"
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="">
                                            <ItemTemplate>
                                                <asp:ImageButton ID="Btn_Seleccionar" runat="server" ImageUrl="~/paginas/imagenes/gridview/blue_button.png"
                                                    OnClick="Btn_Seleccionar_Click" CommandArgument='<%# Eval("PROGRAMA_ID") %>' />
                                            </ItemTemplate>
                                        ...
                                        <asp:BoundField DataField="PREFIJO_FOLIO" HeaderText="Prefijo" Visible="True">
                                            <FooterStyle HorizontalAlign="Left" />
                                            <HeaderStyle HorizontalAlign="Left" />
                                        ...
                                        <asp:BoundField DataField="PROGRAMA_ID" HeaderText="ID" Visible="false">
                                            <FooterStyle HorizontalAlign="Left" />
                                            <HeaderStyle HorizontalAlign="Left" />
