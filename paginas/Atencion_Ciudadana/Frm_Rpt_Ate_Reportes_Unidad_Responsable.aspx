<%@ Page Language="C#" MasterPageFile="~/paginas/Paginas_Generales/MasterPage.master"
    AutoEventWireup="true" CodeFile="Frm_Rpt_Ate_Reportes_Unidad_Responsable.aspx.cs" Inherits="paginas_Atencion_Ciudadana_Reportes_Unidad_Responsable"
                ...
                <table border="0" cellspacing="0" class="estilo_fuente" style="height: auto;">
                    ...
                    <tr>
                        <td align="center" colspan="4">
                            Tipo de reporte
                            <asp:DropDownList ID="Cmb_Tipo_Reporte" runat="server" AutoPostBack="true"
                                OnSelectedIndexChanged="Cmb_Tipo_Reporte_OnSelectedIndexChanged" style="width:500px;">
                                <asp:ListItem Value="REPORTE_DETALLADO">Reporte detallado de peticiones</asp:ListItem>
                                <asp:ListItem Value="ESTADISTICAS_DEPENDENCIA">Estadísticas de peticiones</asp:ListItem>
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:label ID="Lbl_Cmb_Dependencias" runat="server" Text="Unidad Responsable" />
                        </td>
                        <td class="style2">
                            <asp:DropDownList ID="Cmb_Dependencias" runat="server" CssClass="tamanio_combos"
                                AutoPostBack="True" OnSelectedIndexChanged="Cmb_Dependencias_SelectedIndexChanged">
                            </asp:DropDownList>
                        </td>
                        <td>
                            &nbsp;
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:CheckBox ID="Chk_Colonias" runat="server" Text="Por Colonia" AutoPostBack="True"
                                OnCheckedChanged="Chk_Colonias_CheckedChanged" />
                        </td>
                        <td class="style2">
