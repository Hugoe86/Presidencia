<%@ Page Language="C#" MasterPageFile="~/paginas/Paginas_Generales/MasterPage.master" AutoEventWireup="true" CodeFile="Frm_Rpt_Nom_Gral_Empleados_Con_Imss.aspx.cs" Inherits="paginas_Nomina_Frm_Rpt_Nom_Gral_Empleados_Con_Imss" Title="Untitled Page" %>
            ...
            <table width="100%" title="Control_Errores"> 
                <tr>
                    <td class="button_autorizar" style="width:100%; text-align:center; cursor:default; font-size:12px;">
                        Reporte General de Empleados con ISSEG
                    </td>               
                </tr>            
                <tr>
    ...
    <tr>
        <td class="button_autorizar" style="width:100%; text-align:right; cursor:default;" colspan="4">
                ...
                <ContentTemplate>
                    <asp:UpdateProgress ID="UpdateProgress1" runat="server" AssociatedUpdatePanelID="Upnl_Export_PDF" DisplayAfter="0">
                        <ProgressTemplate>
                            ...
                            <div  class="processMessage" id="div_progress1"><img alt="" src="../Imagenes/paginas/Updating.gif" /></div>
                        </ProgressTemplate>
                    </asp:UpdateProgress> 
            ...
            <asp:UpdatePanel ID="Upnl_Export_EXCEL" runat="server" UpdateMode="Conditional" RenderMode="Inline">
                <ContentTemplate>
                    <asp:UpdateProgress ID="UpdateProgress2" runat="server" AssociatedUpdatePanelID="Upnl_Export_EXCEL" DisplayAfter="0">
                        <ProgressTemplate>
                            <div id="progressBackgroundFilter2" class="progressBackgroundFilter"></div>
                            <div  class="processMessage" id="div_progress2"><img alt="" src="../Imagenes/paginas/Updating.gif" /></div>
                        </ProgressTemplate>
                    </asp:UpdateProgress> 
