<%@ Page Language="C#" MasterPageFile="~/paginas/Paginas_Generales/MasterPage.master" AutoEventWireup="true" CodeFile="Frm_Ope_Nom_Seguimiento_Dias_Festivos.aspx.cs" Inherits="paginas_Nomina_Frm_Ope_Nom_Seguimiento_Dias_Festivos" Title="Seguimiento Dias Festivos" %>
...
<asp:ScriptManager ID="ScriptManager_Dia_Festivo" runat="server"/>

<asp:UpdatePanel ID="UPnl_Autorizacion_Dia_Festivo" runat="server" UpdateMode="Conditional">
  <ContentTemplate>       

    <asp:HiddenField ID="Hf_No_Dia_Festivo" runat="server" />
    <asp:HiddenField ID="Hf_Estatus" runat="server" />
    
    <table width="98%"  border="0" cellspacing="0" class="estilo_fuente">
        <tr align="center">
            <td class="label_titulo">Autorizaci&oacute;n Dia Festivo</td>
        </tr>
        <tr>
            <td>
    ...
    <center>
        <asp:Panel ID="Pnl_Gral_Autirizar_Dia_Festivo" runat="server" CssClass="drag" HorizontalAlign="Center" Width="650px"
                    ...
                    <tr>
                        <td style="color:Black;font-size:12;font-weight:bold;">
                           <asp:Image ID="Img_Informacion" runat="server"  ImageUrl="~/paginas/imagenes/paginas/C_Tips_Md_N.png" />
                             Informacion: Autorizaci&oacute;n de Dia Festivo
                        </td>
                                             ...
                                             >
                                                <Columns>           
                                                        <asp:ButtonField ButtonType="Image" CommandName="Select"
                                                                ...
                                                                <ItemStyle Width="0%"  HorizontalAlign="Left" VerticalAlign="Top"/>
                                                        ...
                                                        <asp:TemplateField HeaderText="Autorizar" ItemStyle-VerticalAlign="Top">
                                                            <ItemTemplate>
                                                                <asp:Button ID="Btn_Autorizar_Dia_Festivo" runat="server" Text="Autorizar" 
                                                                    OnClick="Btn_Autorizar_Dia_Festivo_Click" style="border-style:none;background-color:#FFFFFF"
                                                                    ...
                                                                    />
                                                                <asp:Button ID="Btn_Rechazar_Dia_Festivo" runat="server" Text="Rechazar"
                                                                    OnClick="Btn_Rechazar_Dia_Festivo_Click" style="border-style:none;background-color:#FFFFFF;"
                                                                    onmouseover="this.style.backgroundColor='#FFFFCC';this.style.cursor='hand';this.style.color='DarkBlue';this.style.borderStyle='none';this.style.borderColor='Silver';"
                                                                    onmouseout="this.style.backgroundColor='#FFFFFF';this.style.color='Black';this.style.borderStyle='none';"                                                                    
                                                                    />
                                                            </ItemTemplate>
