...
AutoEventWireup="true" CodeFile="Frm_Cat_Nom_Pago_Indemnizacion.aspx.cs" Inherits="paginas_Nomina_Frm_Cat_Nom_Pago_Indemnizacion" 
Title="Catálogopago de Indemnización" %>
...
<asp:UpdatePanel ID="UpPnl_aux_Busqueda" runat="server" UpdateMode="Conditional">
    <ContentTemplate>
        ...
        <table width="98%"  border="0" cellspacing="0">
             <tr>
               <td align="left" class="label_titulo">
                  Catálogo de pago de finiquito
               </td>            
             </tr>            
             <tr align="center">
                 <td>
        ...
        <table width="98%">
            ...
            <tr>  
                ...
                <td style="text-align:left;width:30%;">
                    <asp:TextBox ID="Txt_Fecha_Baja" runat="server" Width="85%"/>
                           ...
                           <tr>
                            ...
                            <tr>
                                ...
                                <td style="width:80%;text-align:left;font-size:11px;">
                                   <asp:TextBox ID="Txt_Busqueda_No_Empleado" runat="server" Width="30%" />
                              ...
                              <asp:GridView ID="Grid_Busqueda_Empleados" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                    ...
                                    <Columns>
                                        <asp:ButtonField ButtonType="Image" CommandName="Select" ImageUrl="~/paginas/imagenes/gridview/blue_button.png">
                                            <ItemStyle Width="10px" Font-Size="X-Small" HorizontalAlign="Center" />
                                        ...
                                        <asp:BoundField DataField="NO_EMPLEADO" HeaderText="No. Empleado" SortExpression="NO_EMPLEADO" >
                                            ...
                                            <HeaderStyle Width="60px" Font-Size="X-Small" HorizontalAlign="Center" />
                                        </asp:BoundField>
                                        ...
                                        <asp:BoundField DataField="FECHA_BAJA" HeaderText="Fecha baja" 
                                           DataFormatString="{0:dd/MM/yyyy}" SortExpression="DEPENDENCIA" NullDisplayText="-" >
                                            <ItemStyle Width="25px" Font-Size="X-Small" HorizontalAlign="Left" />
                                            <HeaderStyle Width="25px"  Font-Size="X-Small" HorizontalAlign="Center" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="tipo_finiquito" HeaderText="finiquito baja" 
                                         DataFormatString="{0:dd/MM/yyyy}" SortExpression="DEPENDENCIA" NullDisplayText="-" >
                                            <ItemStyle Width="25px" Font-Size="X-Small" HorizontalAlign="Left" />
                                            <HeaderStyle Width="25px" Font-Size="X-Small" HorizontalAlign="Center" />
                                        </asp:BoundField>
