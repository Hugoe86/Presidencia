<%@ Page Language="C#" MasterPageFile="~/paginas/Paginas_Generales/MasterPage.master" AutoEventWireup="true" CodeFile="Frm_Rpt_Nom_Despensa.aspx.cs" Inherits="paginas_Nomina_Frm_Rpt_Nom_Despensa" Title="Untitled Page" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Cph_Area_Trabajo1" Runat="Server">
    <asp:ScriptManager ID="Sm_Reporte_Despensa" runat="server"/>
    <asp:UpdatePanel ID="UPnl_Reporte_Despensa" runat="server">
        <ContentTemplate>
        
            <asp:UpdateProgress ID="UPgrs_Reporte_Despensa" runat="server" AssociatedUpdatePanelID="UPnl_Reporte_Despensa" DisplayAfter="0">
                <ProgressTemplate>
                   ...
                   <tr>
                    ...
                    <tr>
                        <td style="width:100%;text-align:left;" colspan="4">
                            <center>
                               <asp:Button ID="Btn_Busqueda_Empleados" runat="server"  Text="Ejecutar Búsqueda" CssClass="button_autorizar"
                      ...
                      <asp:GridView ID="Grid_Busqueda_Empleados" runat="server" AutoGenerateColumns="False" CellPadding="4"
                            ...
                            <Columns>
                                <asp:BoundField DataField="EMPLEADO" HeaderText="Nombre" SortExpression="NOMBRE" NullDisplayText="-" >
                                    <ItemStyle Width="300px" Font-Size="X-Small" HorizontalAlign="Left" />
                                    <HeaderStyle Width="300px" Font-Size="X-Small" HorizontalAlign="Left" />
                                </asp:BoundField>
                                <asp:BoundField DataField="DESPENSA" HeaderText="Despensa" NullDisplayText="-">
                                    <ItemStyle Width="200px" Font-Size="X-Small" HorizontalAlign="Left" Font-Names="Courier New"/>
                                    <HeaderStyle Width="200px" Font-Size="X-Small" HorizontalAlign="Left" />
                                </asp:BoundField>    
                                <asp:BoundField DataField="MONTO" HeaderText="Monto" NullDisplayText="-"  DataFormatString="{0:c}">
                                    <ItemStyle Width="100px" Font-Size="X-Small" HorizontalAlign="Center"  Font-Names="Courier New"/>
                                    <HeaderStyle Width="100px" Font-Size="X-Small" HorizontalAlign="Center" />
                                </asp:BoundField>                                                                
                                <asp:BoundField DataField="CALENDARIO" HeaderText="Calendario" NullDisplayText="-" >
                                ...
                                <asp:BoundField DataField="NO_NOMINA" HeaderText="Periodo" NullDisplayText="-" >
                                    <ItemStyle Width="50px"  Font-Size="X-Small" HorizontalAlign="Center" />
                                    <HeaderStyle Width="50px" Font-Size="X-Small" HorizontalAlign="Center" />
                                </asp:BoundField>                                                                  
                            </Columns>
