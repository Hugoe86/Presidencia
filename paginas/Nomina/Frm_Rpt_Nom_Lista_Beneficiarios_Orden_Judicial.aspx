...
AutoEventWireup="true" CodeFile="Frm_Rpt_Nom_Lista_Beneficiarios_Orden_Judicial.aspx.cs" Inherits="paginas_Nomina_Frm_Rpt_Nom_Lista_Beneficiarios_Orden_Judicial" 
Title="Reporte de Personas Beneficiadas por la Orden Judicial"%>
        ...
        <asp:UpdateProgress ID="Uprg_Reporte" runat="server" AssociatedUpdatePanelID="UPnl_Rpt_Incidencias_Empleados" DisplayAfter="0">
            ...
            <div style="width:98%; background-color:White;">
                        ...
                        <tr>
                            ...
                            <td class="button_autorizar" style="width:80%; text-align:left; cursor:default;">
                                <asp:DropDownList ID="Cmb_Tipo_Reporte" runat="server" Width="100%" TabIndex="3" >
                                    <asp:ListItem Value ="REPORTE DE ORDEN JUDICIAL">REPORTE DE ORDEN JUDICIAL</asp:ListItem>
                                    <asp:ListItem Value ="REPORTE DE LISTA ORDEN JUDICIAL">REPORTE DE LISTA ORDEN JUDICIAL</asp:ListItem>
                ...
                <asp:Panel ID="Pnl_Filtros_Empleado" runat="server" Width="100%" GroupingText="Empleado">        
                    ...
                    <asp:Panel ID="Pnl_Dependencia" runat="server" Width="100%" GroupingText="Filtrar por tipo nomina">   
                        <table width="100%"> 
                            <tr>
                                <td class="button_autorizar" style="width:20%; text-align:left; cursor:default;">
                                    Tipo Nómina
