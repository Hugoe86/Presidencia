...
public partial class paginas_Nomina_Frm_Cat_Reingreso_Empleados : System.Web.UI.Page
{
    #region (Page Load)
    ///*******************************************************************************
    ...
    private void Habilitar_Controles(String Operacion)
    {
        ...
        try
        {
            ...
            //  y de esta manera cargarlo con INACTIVO
    ...
    private void Modificar_Empleado()
    {
        ...
        try
        {
            ...
            ///Bitacora de movimientos
            Rs_Modificar_Cat_Empleados.P_Tipo_Movimiento = "REINGRESO";
