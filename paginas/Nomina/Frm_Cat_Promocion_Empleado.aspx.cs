...
public partial class paginas_Nomina_Frm_Cat_Promocion_Empleado : System.Web.UI.Page
{
    #region (Page Load)
    ///*******************************************************************************
        ...
        try
        {
            ...
            switch (Operacion)
            {
                case "Inicial":
                    ...
                    Txt_Fecha_Nacimiento_Empleado.Enabled = false;
                    Cmb_Sexo_Empleado.Enabled = false;
                    Txt_RFC_Empleado.Enabled = false;
                    Txt_CURP_Empleado.Enabled = false;
                    Txt_Domicilio_Empleado.Enabled = false;
                    Txt_Colonia_Empleado.Enabled = false;
                    Txt_Codigo_Postal_Empleado.Enabled = false;
                    Txt_Ciudad_Empleado.Enabled = false;
                    Txt_Estado_Empleado.Enabled = false;
                    Txt_Telefono_Casa_Empleado.Enabled = false;
                    Txt_Celular_Empleado.Enabled = false;
                    Txt_Nextel_Empleado.Enabled = false;
                    Txt_Telefono_Oficina_Empleado.Enabled = false;
                    Txt_Extension_Empleado.Enabled = false;
                    Txt_Fax_Empleado.Enabled = false;
                    Txt_Correo_Electronico_Empleado.Enabled = false;
                    break;
                ...
                case "Modificar":
                    ...
                    Txt_Fecha_Nacimiento_Empleado.Enabled = true;
                    Cmb_Sexo_Empleado.Enabled = true;
                    Txt_RFC_Empleado.Enabled = true;
                    Txt_CURP_Empleado.Enabled = true;
                    Txt_Domicilio_Empleado.Enabled = true;
                    Txt_Colonia_Empleado.Enabled = true;
                    Txt_Codigo_Postal_Empleado.Enabled = true;
                    Txt_Ciudad_Empleado.Enabled = true;
                    Txt_Estado_Empleado.Enabled = true;
                    Txt_Telefono_Casa_Empleado.Enabled = true;
                    Txt_Celular_Empleado.Enabled = true;
                    Txt_Nextel_Empleado.Enabled = true;
                    Txt_Telefono_Oficina_Empleado.Enabled = true;
                    Txt_Extension_Empleado.Enabled = true;
                    Txt_Fax_Empleado.Enabled = true;
                    Txt_Correo_Electronico_Empleado.Enabled = true;
                    break;
            }
            ///Datos Personales
            ...
            Cmb_Estatus_Empleado.Enabled = Habilitado;
            ///Datos Presidencia
            Cmb_Areas_Empleado.Enabled = Habilitado;
            ...
            Grid_Tipo_Nomina_Percepciones.Enabled = false;
            Grid_Tipo_Nomina_Deducciones.Enabled = false;

            Cmb_Percepciones_All.Enabled = false;
            Btn_Agregar_Percepcion.Enabled = false;

            Cmb_Deducciones_All.Enabled = false;
            Btn_Agregar_Deduccion.Enabled = false;
            ...
            ////SAP Código Programático.
            Cmb_SAP_Fuente_Financiamiento.Enabled = Habilitado;
            Cmb_SAP_Area_Funcional.Enabled = Habilitado;
            Cmb_SAP_Programas.Enabled = Habilitado;
            Cmb_SAP_Unidad_Responsable.Enabled = Habilitado;
            Cmb_SAP_Partida.Enabled = Habilitado;
            ...
            Cmb_Cuentas_Contables.Enabled = false;

            //Cmb_Busqueda_Estatus.Enabled = Habilitado;
        }
        catch (Exception ex)
        {
    ...
    private void Modificar_Empleado()
    {
        ...
        try
        {
            ...
            ///Bitacora de movimientos
            Rs_Modificar_Cat_Empleados.P_Tipo_Movimiento = "PROMOCION";
