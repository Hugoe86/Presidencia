<%@ Page Language="C#" MasterPageFile="~/paginas/Paginas_Generales/MasterPage.master" AutoEventWireup="true" CodeFile="Frm_Ope_Nom_Vacaciones_Dependencia.aspx.cs" Inherits="paginas_Nomina_Frm_Ope_Nom_Vacaciones_Dependencia" Title="Autorizacion Vacaciones U. Responsable" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Cph_Area_Trabajo1" Runat="Server">
    ...
    <asp:UpdatePanel ID="Upd_Panel" runat="server">
        <ContentTemplate>
            ...
            <asp:UpdateProgress ID="Uprg_Reporte" runat="server" AssociatedUpdatePanelID="Upd_Panel" DisplayAfter="0">
             ...
             <div id="Div_Vacaciones_Empleado" style="background-color:#ffffff; width:100%; height:100%;">
                    ...
                    <table width="98%"  border="0" cellspacing="0" class="estilo_fuente">
                        <tr align="center">
                            <td class="label_titulo">U. Responsable Seguimiento Vacaciones</td>
                        </tr>
                        <tr>
                            <td>
                                    ...
                                    <tr>
                                        ...
                                        <td style="width:60%; vertical-align:middle; text-align:left;">
                                            <asp:ImageButton ID="Btn_Consultar_Dias_Vacaciones" runat="server" ImageUrl="~/paginas/imagenes/paginas/busqueda.png"
                                                    ToolTip="Buscar al Empleado" OnClick="Btn_Consultar_Dias_Vacaciones_Click"/>    
                                        </td>
                                    </tr>
                                </table>
                            </td>
                 ...
                 <table width="98%">
                        <tr>
                            <td  style="width:100%;" colspan="4" align="center">
                                <asp:Button ID="Btn_Autorizacion_Vacaciones" runat="server" Text="Autorización Vacaciones" Visible="false" 
                                         ...
                                         <Columns>
                                             ...
                                             <asp:BoundField DataField="COMENTARIOS_ESTATUS" HeaderText="Estatus">
                                               ...
                                               <asp:TemplateField>
                                                <ItemTemplate>
                                                    <center>
                                                        <asp:ImageButton ID="Btn_Reporte_Vacaciones" runat="server"
                                                           ImageUrl="~/paginas/imagenes/paginas/icono_rep_pdf.png" Width="24px" Height="24px"
                                                           OnClick="Btn_Reporte_Vacaciones_Click" 
            ...
            <%--<cc1:ModalPopupExtender ID="MPE_Msj" runat="server" BackgroundCssClass="popUpStyle" 
                PopupControlID="Pnl_Mensaje" TargetControlID="Btn_Mostrar_Busqueda" PopupDragHandleControlID="Pnl_Interno" 
            ...
            <tr>
                <td style="color:Black;font-size:12;font-weight:bold;">
                   <asp:Image ID="Img_Informatcion_Autorizacion" runat="server"  ImageUrl="~/paginas/imagenes/paginas/C_Tips_Md_N.png" />
                     Unidad Responsable: Aceptación de Vacaciones
                </td>
                <td align="right" style="width:10%;">
               ...
               <tr>
                    <td style="width:100%" colspan="4" align="right">
                        <asp:ImageButton ID="Btn_Guardar_Autorizacion_Vacacion" runat="server" ImageUrl="~/paginas/imagenes/paginas/icono_guardar.png"
                            style="border-style:none;background-color:White;font-weight:bold;cursor:hand;"  ToolTip="Aceptación"
