...
public partial class paginas_Nomina_Frm_Rpt_Nom_Variables : System.Web.UI.Page
{
    #region Page_Load
    ...
    private Boolean Validar_Reporte()
    {
        ...
        Txt_Fecha_Inicial.Text = Txt_Fecha_Inicial.Text.Trim().Replace("/", "");
        Txt_Fecha_Final.Text = Txt_Fecha_Final.Text.Trim().Replace("/", "");
        ...
        else
        {
            ...
            else if (Txt_Fecha_Inicial.Text.Trim().Length != 8)
            {
            ...
            else if (Txt_Fecha_Final.Text.Trim().Length != 8)
            {
                Lbl_Mensaje_Error.Text += Espacios_Blanco + "*La longitud de la fecha final debe de ser de 8 caracteres " + Txt_Fecha_Final.Text.Trim().Length + ".<br>";
                Datos_Validos = false;
            }
    ...
    protected void Consultar_Percepciones_Variable()
    {
        ...
        try
        {
            ...
            Obj_Percepciones_Fijas.P_TIPO_ASIGNACION = "VARIABLE";
    ...
    private void Generar_Reporte_Percepciones(String Formato)
    {
        ...
        try
        {
            ...
            Rs_Percepciones.P_Tipo_Asignacion = "VARIABLE";
            //  se realiza la consulta
            Dt_Reporte = Rs_Percepciones.Consultar_Percepciones();
            Dt_Reporte.TableName = "Dt_Deducciones_Fijas";

            //  para la tabla de elaboro
            Dt_Elaboro = Construir_Tabla_Elaboro("PERCEPCIONES VARIABLES");
    ...
    protected void Btn_Reporte_Pdf_Click(object sender, ImageClickEventArgs e)
    {
        try
        {
            ...
            if (Validar_Reporte())
            {
                ...
                else if (Cmb_Tipo_Reporte.SelectedValue == "REPORTE DE PERCEPCIONES (VARIABLES)")
                {
    ...
    protected void RBtn_Tipo_Percepcion_Deduccion_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        if (index >= 0)
        {
            Consultar_Percepciones_Variable();
