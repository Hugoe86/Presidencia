...
public partial class paginas_Nomina_Frm_Cat_Empleados : System.Web.UI.Page
{
        ...
        try
        {
            ...
            switch (Operacion)
            {
                case "Inicial":
                    ...
                    Contenedor_Datos_Personales.ActiveTabIndex = 0;
            ...
            Btn_Actualizar_Salario.Enabled = Habilitado;
    ...
    private void Alta_Empleado()
    {
        ...
        try
        {
            ...
            Rs_Alta_Cat_Empleados.P_Password = "123456";
            ...
            if (!string.IsNullOrEmpty(Txt_Fecha_Vencimiento_Licencia.Text) && !(Txt_Fecha_Vencimiento_Licencia.Text.Equals("__/___/____")))
    ...
    private void Consultar_Turnos() {
        ...
        try
        {
            ...
            Cmb_Turno.DataTextField = "INF_TURNO";
            Cmb_Turno.DataBind();
            Cmb_Turno.Items.Insert(0, new ListItem("<- Seleccione ->", ""));
            Cmb_Turno.SelectedIndex = 34;
        }
        catch (Exception ex)
        {
    ...
    private Boolean Validar_Datos()
    {
        ...
        else if (Es_Numero_Empleado_Repetido(Txt_No_Empleado.Text.Trim()))
        {
            Lbl_Mensaje_Error.Text += "+ El No. de Empleado [ << " + Txt_No_Empleado.Text.Trim() + " >> ] ya esta asignado en el sistema a un empleado. <br>";
            Datos_Validos = false;
        }
        ...
        //{
        //    Lbl_Mensaje_Error.Text += "+ Sindicatos al cual pertenece el Empleado <br>";
        //    Datos_Validos = false;
        //}
        ...
        if (string.IsNullOrEmpty(Txt_Fecha_Vencimiento_Licencia.Text.Trim()) || (Txt_Fecha_Vencimiento_Licencia.Text.Trim().Equals("__/___/____")))
        {
            ...
            //Datos_Validos = false;
            Txt_Fecha_Vencimiento_Licencia.Text = string.Empty;
        }
        ...
        try
        {
            ...
            if (Dt_Empleados.Rows.Count > 0)
            {
                ...
                foreach (DataRow Registro in Dt_Empleados.Rows)
                {
                    ...
                    if (!string.IsNullOrEmpty(Registro[Cat_Empleados.Campo_Cuenta_Contable_ID].ToString())) Cmb_Cuentas_Contables.SelectedIndex = Cmb_Cuentas_Contables.Items.IndexOf(Cmb_Cuentas_Contables.Items.FindByValue(Registro[Cat_Empleados.Campo_Cuenta_Contable_ID].ToString()));
                    ...
                    if (!string.IsNullOrEmpty(Registro[Cat_Empleados.Campo_Nombre_Beneficiario].ToString())) Txt_Beneficiario_Empleado.Text = Registro[Cat_Empleados.Campo_Beneficiario].ToString();
    ...
    protected void Btn_Nuevo_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (Btn_Nuevo.ToolTip == "Nuevo")
            {
                ...
                Txt_No_Empleado.Text = new Cls_Cat_Empleados_Negocios().Consultar_No_Empleado_Consecutivo();
            }
            else
            {
    ...
    protected Boolean Es_Numero_Empleado_Repetido(String No_Empleado_Validar)
    {
        Cls_Cat_Empleados_Negocios Obj_Empleados = new Cls_Cat_Empleados_Negocios();//Variable de conexión con la capa de negocios.
        DataTable Dt_Empleados = null;//Variable que almacena el listado de empleados.
        Boolean Estatus = false;//Variable que guarda el estatus. [SI/NO] Si el resulrado es si significa que el número de empleado a crear 
                                //ya se encuentra asignado en el sistema. No que aun se encuentra disponible.

        try
        {
            Obj_Empleados.P_No_Empleado = No_Empleado_Validar;
        ...
        {
            throw new Exception("Error al validar que el número de empleado no se encuentre en el sistema. Error: [" + Ex.Message + "]");
        }
        return Estatus;
    }
