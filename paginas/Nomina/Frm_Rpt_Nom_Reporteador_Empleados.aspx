<%@ Page Language="C#" MasterPageFile="~/paginas/Paginas_Generales/MasterPage.master" AutoEventWireup="true" CodeFile="Frm_Rpt_Nom_Reporteador_Empleados.aspx.cs" Inherits="paginas_Nomina_Frm_Rpt_Nom_Reporteador_Empleados" Title="Reporteador Empleados" %>
    ...
    <cc1:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server"  AsyncPostBackTimeout="36000" EnableScriptLocalization="true" EnableScriptGlobalization="true"/> 
        ...
        <div id="Div_Requisitos" style="background-color:#ffffff; width:100%; height:100%;">
            <table width="99%"  border="0" cellspacing="0" class="estilo_fuente">
                <tr align="center">
                    <td class="label_titulo" colspan="4">Reporteador de Empleados</td>
                </tr>
                <tr>
                    <td colspan="4">
                                    ...
                                    <tr>
                                        <td style="text-align:left;">
                                            <asp:RadioButtonList ID="RBL_Listado_Reportes_Disponibles" runat="server" RepeatDirection="Horizontal">
                                                ...
                                                <asp:ListItem Text="Sindicato" Value="SINDICATO"></asp:ListItem>
                                                <asp:ListItem Text="Antigüedad" Value="ANTIWEDAD"></asp:ListItem>
                                                <asp:ListItem Text="Altas" Value="ALTAS"></asp:ListItem>
                                                <asp:ListItem Text="Bajas" Value="BAJAS"></asp:ListItem>
                                                <asp:ListItem Text="Promociones" Value="PROMOCIONES"></asp:ListItem>
                                                <asp:ListItem Text="Sexo" Value="SEXO"></asp:ListItem>
                                                <asp:ListItem Text="Seguro de Vida" Value="SEGURO_VIDA"></asp:ListItem>
                                                <asp:ListItem Text="Reingresos" Value="REINGRESOS"></asp:ListItem>
                                            </asp:RadioButtonList>
                                        </td>
                                    </tr>
                                </table> 
                                ...
                                <table class="estilo_fuente" width="99%">  
                                    ...
                                    <tr>
                                        ...
                                        <td style="width:30%; text-align:left;">
                                            <asp:TextBox ID="Txt_Fecha_Inicial" runat="server" Width="80%" MaxLength="20" AutoPostBack="true" ></asp:TextBox>
