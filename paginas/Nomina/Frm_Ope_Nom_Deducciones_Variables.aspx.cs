...
public partial class paginas_Nomina_Frm_Ope_Nom_Deducciones_Variables : System.Web.UI.Page
{
    #region (Page_Load)
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            Btn_Autorizacion_Deduccion_Variable.Visible = false;
        }
        catch (Exception Ex)
        {
        ...
        try
        {
            ...
            switch (Operacion)
            {
                case "Inicial":
                    ...
                    Configuracion_Acceso("Frm_Ope_Nom_Deducciones_Variables.aspx");
                    break;
                case "Nuevo":
                    Habilitado = true;
    ...
    private void Alta_Asignacion_Deducciones_Variables()
    {
        ...
        try
        {
            ...
            Alta_Asiganacion_Deduccion_Variable.P_Empleado_ID = Cmb_Empleados.SelectedValue.Trim();
    ...
    private void Modificar_Asignacion_Deducciones_Variables()
    {
        ...
        try
        {
            ...
            Modificar_Asignacion_Deduccion_Variable.P_Empleado_ID = Cmb_Empleados.SelectedValue.Trim();
        ...
        try
        {
            ...
            if (indice > 0)
            {
                ...
                else
                {
                    ...
                    Dt_Temporal = Juntar_No_Empleado_Empleado(Dt_Temporal);

                    if (Dt_Temporal is DataTable)
                    {
    ...
    {
        Cls_Ope_Nom_Deducciones_Var_Negocio _Cat_Empleados = new Cls_Ope_Nom_Deducciones_Var_Negocio();//Variable de conexion con la capa de negocios
    ...
    protected void Grid_Deducciones_Variables_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (Cls_Util.Consultar_Grupo_Rol_ID(Cls_Sessiones.Datos_Empleado.Rows[0][Cat_Empleados.Campo_Rol_ID].ToString()).Rows[0][Apl_Grupos_Roles.Campo_Grupo_Roles_ID].ToString().Equals("00006"))
            {
                if (!Cls_Ope_Nom_Deduccion_Variable_Consultada.P_Estatus.Trim().ToUpper().Equals("ACEPTADO"))
                {
                    Btn_Autorizacion_Deduccion_Variable.Visible = true;
                    Btn_Autorizacion_Deduccion_Variable.NavigateUrl = "Frm_Ope_Nom_Seguimiento_Deduc_Var.aspx?No_Deduccion=" + Grid_Deducciones_Variables.Rows[Grid_Deducciones_Variables.SelectedIndex].Cells[1].Text.Trim() + "&Deduccion=" + Cmb_Deducciones.SelectedItem.Text.Trim() + "&PAGINA=" + Request.QueryString["PAGINA"];
                }
            }
        }
        catch (Exception ex)
    ...
    private void Consultar_Deducciones_Variables_Asignadas()
    {
        ...
        try
        {
            Grid_Deducciones_Variables.Columns[4].Visible = true;
            ...
            Grid_Deducciones_Variables.Columns[4].Visible = false;
        }
        catch (Exception Ex)
        {
    ...
    protected void Btn_Nuevo_Click(object sender, ImageClickEventArgs e)
    {
        try
        {
            ...
            ScriptManager.RegisterStartupScript(Upd_Panel, typeof(string), "Imagen", "javascript:Inicializar_Eventos_Deducciones_Variables();", true);
        }
        catch (Exception Ex)
        {
            Lbl_Mensaje_Error.Visible = true;
    ...
    protected void Btn_Busqueda_Deducciones_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            if (!String.IsNullOrEmpty(Txt_Busqueda_No_Empleado.Text.Trim())) Cls_Ope_Nom_Deducciones_Variables_Consulta.P_No_Empleado = Txt_Busqueda_No_Empleado.Text.Trim();
            if (!String.IsNullOrEmpty(Txt_Busqueda_Nombre_Empleado.Text.Trim())) Cls_Ope_Nom_Deducciones_Variables_Consulta.P_Nombre_Empleado = Txt_Busqueda_Nombre_Empleado.Text.Trim();
    ...
    protected void Btn_Agregar_Empleado_Click(object sender, EventArgs e)
    {
        try
        {
            if (Cmb_Empleados.SelectedIndex > 0)
            {
                ...
                else
                {
                    ...
                    Dt_Empleados.Columns.Add(Cat_Empleados.Campo_Empleado_ID, typeof(System.String));
                    Dt_Empleados.Columns.Add(Cat_Empleados.Campo_Nombre, typeof(System.String));
                    Dt_Empleados.Columns.Add(Ope_Nom_Deduc_Var_Emp_Det.Campo_Cantidad, typeof(System.String));
        ...
        {
            throw new Exception("Error al agregar ala empleado. Error: [" + Ex.Message + "]");
        }
    }
    ///*******************************************************************************
