<%@ Page Language="C#" MasterPageFile="~/paginas/Paginas_Generales/MasterPage.master" AutoEventWireup="true" CodeFile="Frm_Ope_Nom_Seguimiento_Perc_Var.aspx.cs" Inherits="paginas_Nomina_Frm_Ope_Nom_Seguimiento_Perc_Var" Title="Seguimiento Percepciones Variables" %>
...
<asp:ScriptManager ID="ScriptManager_Percepcion_Variable" runat="server"/>

<asp:UpdatePanel ID="UPnl_Autorizacion_Percepcion_Variable" runat="server" UpdateMode="Conditional">
  <ContentTemplate>       

    <asp:HiddenField ID="Hf_No_Percepcion" runat="server" />
    <asp:HiddenField ID="Hf_Percepcion" runat="server" />
    <asp:HiddenField ID="Hf_Estatus" runat="server" />   
    
    <table width="98%"  border="0" cellspacing="0" class="estilo_fuente">
        <tr align="center">
            <td class="label_titulo">Autorizaci&oacute;n Percepciones Variables</td>
        </tr>
        <tr>
            <td>
    ...
    <center>
        <asp:Panel ID="Pnl_Gral_Autirizar_Percepciones_Variables" runat="server" CssClass="drag" HorizontalAlign="Center" Width="650px"
                    ...
                    <tr>
                        <td style="color:Black;font-size:12;font-weight:bold;">
                           <asp:Image ID="Img_Informacion" runat="server"  ImageUrl="~/paginas/imagenes/paginas/C_Tips_Md_N.png" />
                             Informacion: Autorizaci&oacute;n de Percepciones Variables
                        </td>
                               ...
                               <tr>
                                    <td style="width:100%" colspan="4" align="center">
                                        <asp:Button ID="Btn_Autorizar" runat="server" Text="Guardar Comentario" 
                                            ...
                                            ToolTip="Guardar el Estatus del Dia Festivo" OnClick="Btn_Autorizar_Click"/>    
                                             ...
                                             >
                                                <Columns>           
                                                        ...
                                                        <asp:TemplateField HeaderText="Autorizar">
                                                            <ItemTemplate>
                                                                <asp:Button ID="Btn_Autorizar_Percepcion_Variable" runat="server" Text="Autorizar"
                                                                    OnClick="Btn_Autorizar_Percepcion_Variable_Click" style="border-style:none;background-color:#FFFFFF"
                                                                    ...
                                                                    />
                                                                <asp:Button ID="Btn_Rechazar_Percepcion_Variable" runat="server" Text="Rechazar"
                                                                    OnClick="Btn_Rechazar_Percepcion_Variable_Click" style="border-style:none;background-color:#FFFFFF;"
                                                                    onmouseover="this.style.backgroundColor='#FFFFCC';this.style.cursor='hand';this.style.color='DarkBlue';this.style.borderStyle='none';this.style.borderColor='Silver';"
                                                                    onmouseout="this.style.backgroundColor='#FFFFFF';this.style.color='Black';this.style.borderStyle='none';"                                                                    
                                                                    />
                                                            </ItemTemplate>
