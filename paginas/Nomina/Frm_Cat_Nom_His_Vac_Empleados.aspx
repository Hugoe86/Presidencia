<%@ Page Language="C#" MasterPageFile="~/paginas/Paginas_Generales/MasterPage.master" AutoEventWireup="true" CodeFile="Frm_Cat_Nom_His_Vac_Empleados.aspx.cs" Inherits="paginas_Nomina_Frm_Cat_Nom_His_Vac_Empleados" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Cph_Area_Trabajo2" Runat="Server">
    ...
    <script src="../../javascript/Js_Cat_Nom_His_Vac_Empleados.js" type="text/javascript"></script>
</asp:Content>
   ...
   <table id="tabla_cabecera" width="830px"  border="0" cellspacing="0" class="estilo_fuente">
        <tr align="center">
            <td colspan="2" class="label_titulo">
                <br />Consultar Historial Vacaciones Tomadas<br /><br />
            </td>
        </tr>
    ...
    <table id="Tbl_Vacacionales"></table>
    
    <div  id="Div_Busquedas" class="easyui-window" 
        style='border-style:outset;border-color:Silver;background-image:url(../imagenes/paginas/fondo1.jpg);background-repeat:repeat-y;top:0px; left:0px;'>
        <center></center>
    </div>
