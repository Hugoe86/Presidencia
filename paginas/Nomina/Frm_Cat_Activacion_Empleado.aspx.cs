...
public partial class paginas_Nomina_Frm_Cat_Activacion_Empleado : System.Web.UI.Page
{
    #region (Page Load)
    ///*******************************************************************************
    ...
    private void Limpia_Controles()
    {
        try
        {
            ...
            Cmb_Busqueda_Estatus.SelectedIndex = 2;
        }
        catch (Exception ex)
        {
    ...
    ///               para a siguiente operación(de los cuales solo se habilitara
    ///               el de estatus activo o inactivo)
    ...
    private void Habilitar_Controles(String Operacion)
    {
        ...
        try
        {
            ...
            //  y de esta manera cargarlo con INACTIVO(se selecciona dentro del metodo limpiar)
    ...
    private void Modificar_Empleado()
    {
        ...
        try
        {
            ...
            ///Bitacora de movimientos
            Rs_Modificar_Cat_Empleados.P_Tipo_Movimiento = "REACTIVACION";
