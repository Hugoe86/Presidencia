<%@ Page Language="C#" MasterPageFile="~/paginas/Paginas_Generales/MasterPage.master" AutoEventWireup="true" CodeFile="Frm_Rpt_Nom_Pago_Por_Deducciones_Diversas.aspx.cs" Inherits="paginas_Nomina_Frm_Rpt_Nom_Pago_Por_Deducciones_Diversas" Title="Untitled Page" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Cph_Area_Trabajo1" Runat="Server">
    ...
    <div style="width:100%;">
        <table width="98%"  border="0" cellspacing="0" class="estilo_fuente">
            ...
            <tr align="center">
                <td class="label_titulo" colspan="2">Reporte de Pago por Deducciones Diversas</td>
            </tr>
            <tr>
                <td colspan="2">
          ...
          <asp:Panel ID="Panel1" runat="server" GroupingText="Filtros de reporte" Width="96%">
            <center>
                <table width="97%">
                    ...
                    <tr>
                        <td style="width:18%; text-align:left; cursor:default;" class="button_autorizar">
                        ...
                        <td colspan="4" style="width:57%; text-align:left; vertical-align:middle; cursor:default;" class="button_autorizar">
                    ...
                    <tr>
                        <td style="text-align:left; width:18%; cursor:default;" class="button_autorizar">
                        ...
                        <td style="width:42%; text-align:left; cursor:default;" class="button_autorizar" colspan="3">
                            <asp:DropDownList ID="Cmb_Periodo" runat="server" Width="55%"></asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
                        <td style="text-align:left; width:18%; cursor:default;" class="button_autorizar">
                            <asp:Label ID="Lbl_Tipo_Orden" runat="server" Text="* Orden Judicial"></asp:Label>
                        </td>
                        <td style="text-align:left; width:82%; cursor:default;" class="button_autorizar" colspan="7">
                            <asp:DropDownList ID="Cmb_Tipo_Orden_Judicial" runat="server" Width="77%"></asp:DropDownList>
                        </td>
                    </tr>
                    <tr><td colspan="6" style="height:0.3em;"></td></tr>
                </table>
