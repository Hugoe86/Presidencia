...
public partial class paginas_Nomina_Frm_Ope_Captura_Masiva_Percepciones_Var : System.Web.UI.Page
{
    #region (Page_Load)
        ...
        try
        {
            ...
            while (!((string)xlHoja1.get_Range("A" + Contador_Columnas, Missing.Value).Text).Trim().Equals(""))
            {
                ...
                else if (Contador_Filas > 2)
                {
                    ...
                    string Unidad_Responsable = (string)xlHoja1.get_Range("D" + Contador_Columnas, Missing.Value).Text;
    ...
    /// CAUSA_MODIFICACION:
    ///*******************************************************************************
    private void Alta_Asignacion_Percepcion_Variables()
    {
        ...
        try
        {
            Alta_Asiganacion_Percepcion_Variable.P_Dependencia_ID = String.Empty;
            Alta_Asiganacion_Percepcion_Variable.P_Percepcion_Deduccion_ID = Cmb_Percepciones.SelectedValue.Trim();
    ...
    /// CAUSA_MODIFICACION:
    ///*******************************************************************************
    private void Modificar_Asignacion_Percepcion_Variables()
    {
        ...
        try
        {
            ...
            Modificar_Asignacion_Percepcion_Variable.P_Dependencia_ID = String.Empty;
            Modificar_Asignacion_Percepcion_Variable.P_Percepcion_Deduccion_ID = Cmb_Percepciones.SelectedValue.Trim();
    ...
    /// CAUSA_MODIFICACION:
    ///*******************************************************************************
    private void Eliminar_Asignacion_Percepcion_Variables()
    {
    ...
    private void Consultar_Percepciones_Variables_Opcionales()
    {
        ...
        DataTable Dt_Percepciones_Variables_Opcionales = null;//Variable que almacenara una lista de las percepciones variables asignadas
        ...
        try
        {
            ...
            Dt_Percepciones_Variables_Opcionales = Cat_Percepciones_Deducciones_Consulta.Consulta_Avanzada_Percepciones_Deducciones();
            Dt_Percepciones_Variables_Opcionales = Juntar_Clave_Percepcion_Deduccion(Dt_Percepciones_Variables_Opcionales);
            Cmb_Percepciones.DataSource = Dt_Percepciones_Variables_Opcionales;
    ...
    protected void Grid_Percepciones_Variables_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            Cmb_Percepciones.SelectedIndex = Cmb_Percepciones.Items.IndexOf(Cmb_Percepciones.Items.FindByValue(Cls_Ope_Nom_Percepcion_Variable_Consultada.P_Percepcion_Deduccion_ID));
    ...
    private void Consultar_Percepciones_Variables_Asignadas()
    {
        ...
        try
        {
            ...
            Grid_Percepciones_Variables.Columns[3].Visible = true;
            Grid_Percepciones_Variables.Columns[5].Visible = true;
            ...
            Grid_Percepciones_Variables.Columns[3].Visible = false;
            Grid_Percepciones_Variables.Columns[5].Visible = false;
        }
        catch (Exception Ex)
        {
    ...
    protected void Btn_Nuevo_Click(object sender, ImageClickEventArgs e)
    {
        try
        {
            ...
            else
            {
                ...
                {
                    Alta_Asignacion_Percepcion_Variables();//ejecuta el alta.
                }
                else
                {
                    Lbl_Mensaje_Error.Visible = true;
    ...
    protected void Btn_Modificar_Click(object sender, ImageClickEventArgs e)
    {
        try
        {
            ...
            else
            {
                ...
                if (Validar_Datos_Asignacion_Percepciones_Variables())
                {
                    Modificar_Asignacion_Percepcion_Variables();//Ejecuta la modificacion.
                }
                else
                {
                    Lbl_Mensaje_Error.Visible = true;
    ...
    protected void Btn_Eliminar_Click(object sender, ImageClickEventArgs e)
    {
        try
        {
            ...
            if (Btn_Eliminar.ToolTip.Equals("Eliminar"))
            {
                ...
                if (Grid_Percepciones_Variables.SelectedIndex != -1 & !Txt_No_Percepcion.Text.Equals(""))
                {
                    Eliminar_Asignacion_Percepcion_Variables();//Ejecuta la baja.
                }
                else
                {
                    Lbl_Mensaje_Error.Visible = true;
            ...
            if (AFU_Cargar_Archivo_Variables is AsyncFileUpload)
            {
                if (AFU_Cargar_Archivo_Variables.HasFile)
                {
                    ...
                    if (Extension.Equals(".xlsx") || Extension.Equals(".xls"))
                    {
                        ...
                        Dt_Empleados = Presidencia.Ayudante_Excel.Cls_Ayudante_Leer_Excel.Leer_Tabla_Excel(Full_Path, "PERCEPCIONES_VARIABLES");
