...
AutoEventWireup="true" CodeFile="Frm_Rpt_Nom_Cantidad_Recibos_Nomina_Impresos.aspx.cs" Inherits="paginas_Nomina_Frm_Rpt_Nom_Cantidad_Recibos_Nomina_Impresos" 
Title="Reporte de recibos de nomina(impresos)"%>
            ...
            <div style="background-color: White; width: 98%;">
                                ...
                                <table width="100%">
                                    ...
                                    <tr>
                                        <td width="100%" align="left">
                                            <font style="color: Black; font-weight: bold;">Reporte de recibos de nomina (Impresos)</font>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                ...
                <table width="100%" class="estilo_fuente">
                 ...
                 <asp:Panel ID="Pnl_Tipo_Nomina" runat="server" Width="100%" GroupingText="Tipo Nomina">   
                  ...
                  <asp:Panel ID="Panel1" runat="server" Width="100%" GroupingText="Tipo Nomina">   
                    <table width="100%"> 
                        <tr>
                            <td class="button_autorizar" style="width:20%; text-align:left; cursor:default;">
                                Banco
                            ...
                            <td class="button_autorizar" style="width:80%; text-align:left; cursor:default;">
                                <asp:DropDownList ID="Cmb_Banco" runat="server" Width="100%" TabIndex="3"/>
                            </td> 
                        </tr> 
                      </table>
                </asp:Panel>
                 ...
                 <asp:Panel ID="Pnl_Fechas" runat="server" Width="100%" GroupingText="Fechas">  
                     <table width="100%"> 
                        ...
                        <tr>
                            ...
                            <td class="button_autorizar" style="width:30%; text-align:left; cursor:default;">
                                <asp:TextBox ID="Txt_Fecha_Inicial" runat="server" Width="98%" ReadOnly="true" MaxLength="8" ToolTip="ddmmaaaa"></asp:TextBox>
                            ...
                            <td class="button_autorizar" style="width:30%; text-align:left; cursor:default;">
                                <asp:TextBox ID="Txt_Fecha_Final" runat="server" Width="98%" ReadOnly="true" MaxLength="8" ToolTip="ddmmaaaa"></asp:TextBox>
