...
public partial class paginas_Nomina_Frm_Cat_Nom_Ctlr_Historial_Vac : System.Web.UI.Page
{
    #region (Load/Init)
        ...
        try
        {
            ...
            switch (Opcion)
            {
                ...
                case "consultar_empleados":
                    ...
                    break;
                case "consutar_periodos_vacacionales":
                    Str_Respuesta_JSON = JSON_Consutar_Periodos_Vacacionales(Tabla, No_Empleado, Pagina, Filas);
                    break;
                case "consutar_vacacionales":
                    Str_Respuesta_JSON = JSON_Consutar_Vacacionales(Tabla, No_Empleado, Pagina, Filas);
                    break;
                default:
                    break;
            }
    ...
    private String JSON_Consultar_Empleados(String Tabla, String No_Empleado, String RFC, String CURP, String UR, String Tipo_Nomina_ID, String Pagina, String Filas)
    {
        ...
        return Ayudante_JQuery.Crear_Tabla_Formato_JSON_DataGrid(Dt_Informacion_Mostrar_Empleado, Total_No_Registros);
    }
    ///********************************************************************************************************
    ///NOMBRE DE LA FUNCIÓN : JSON_Consutar_Periodos_Vacacionales
    ///DESCRIPCIÓN          : Metodo para generar el JSON de los Periodos Vacacionales.
    ///PROPIEDADES          :
    ///CREO                 : Juan Alberto Hernandez Negrete
    ///FECHA_CREO           : Noviembre/2011 
    ///MODIFICO             :
    ...
    ///CAUSA_MODIFICACIÓN...:
    ///*********************************************************************************************************
    private String JSON_Consutar_Periodos_Vacacionales(String Tabla, String No_Empleado, String Pagina, String Filas)
    {
        Cls_Cat_Nom_Periodos_Vacacionales_Negocio Obj_Periodos_Vacacionales = new Cls_Cat_Nom_Periodos_Vacacionales_Negocio();//Variable de conexion con la capa de negocios.
        DataTable Dt_Periodos_Vacacionales = null;//Variable que listara los empleados.
        Int32 _Pagina = Convert.ToInt32((String.IsNullOrEmpty(Pagina)) ? "0" : Pagina);
        Int32 _Filas = Convert.ToInt32((String.IsNullOrEmpty(Filas)) ? "0" : Filas);
        Int32 Total_No_Registros = 0;
        ...
        {
            if (!String.IsNullOrEmpty(No_Empleado))
                Obj_Periodos_Vacacionales.P_No_Empleado = No_Empleado;

            Dt_Periodos_Vacacionales = Obj_Periodos_Vacacionales.Consultar_Periodos_Vacacionales();
            Total_No_Registros = Dt_Periodos_Vacacionales.Rows.Count;
            Dt_Periodos_Vacacionales = Obtener_Registros_Mostrar_Tabla(Dt_Periodos_Vacacionales, _Filas, _Pagina);
            Dt_Periodos_Vacacionales.TableName = Tabla;
        }
        catch (Exception Ex)
        {
            throw new Exception("Error al consultar los periodos vacacionales. Error: [" + Ex.Message + "]");
        }
        return Ayudante_JQuery.Crear_Tabla_Formato_JSON_DataGrid(Dt_Periodos_Vacacionales, Total_No_Registros);
    }
    ///********************************************************************************************************
    ///NOMBRE DE LA FUNCIÓN : JSON_Consutar_Vacacionales
    ///DESCRIPCIÓN          : Metodo para generar el JSON de las Vacaciones que ha tomado el empleado..
    ///PROPIEDADES          :
    ///CREO                 : Juan Alberto Hernandez Negrete
    ///FECHA_CREO           : Noviembre/2011 
    ///MODIFICO             :
    ...
    ///CAUSA_MODIFICACIÓN...:
    ///*********************************************************************************************************
    private String JSON_Consutar_Vacacionales(String Tabla, String No_Empleado, String Pagina, String Filas)
    {
        Cls_Cat_Nom_Periodos_Vacacionales_Negocio Obj_Vacacionales = new Cls_Cat_Nom_Periodos_Vacacionales_Negocio();//Variable de conexion con la capa de negocios.
        DataTable Dt_Vacacionales = null;//Variable que listara los empleados.
        Int32 _Pagina = Convert.ToInt32((String.IsNullOrEmpty(Pagina)) ? "0" : Pagina);
        Int32 _Filas = Convert.ToInt32((String.IsNullOrEmpty(Filas)) ? "0" : Filas);
        Int32 Total_No_Registros = 0;
        ...
        {
            if (!String.IsNullOrEmpty(No_Empleado))
                Obj_Vacacionales.P_No_Empleado = No_Empleado;

            Dt_Vacacionales = Obj_Vacacionales.Consultar_Vacaciones_Tomadas();
            Total_No_Registros = Dt_Vacacionales.Rows.Count;
            Dt_Vacacionales = Obtener_Registros_Mostrar_Tabla(Dt_Vacacionales, _Filas, _Pagina);
            Dt_Vacacionales.TableName = Tabla;
        }
        catch (Exception Ex)
        {
            throw new Exception("Error al consultar los periodos vacacionales. Error: [" + Ex.Message + "]");
        }
        return Ayudante_JQuery.Crear_Tabla_Formato_JSON_DataGrid(Dt_Vacacionales, Total_No_Registros);
    }
    #endregion
