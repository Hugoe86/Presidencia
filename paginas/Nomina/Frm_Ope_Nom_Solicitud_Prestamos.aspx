<%@ Page Language="C#" MasterPageFile="~/paginas/Paginas_Generales/MasterPage.master" AutoEventWireup="true" CodeFile="Frm_Ope_Nom_Solicitud_Prestamos.aspx.cs" Inherits="paginas_Nomina_Frm_Ope_Nom_Solicitud_Prestamos" Title="Solicitud de Prestamos" %>
        ...
        <ContentTemplate>
            ...
            <div id="Div_Solicitud_Prestamos" style="background-color:#ffffff; width:99%; height:100%;">
                ...
                <table width="98%"  border="0" cellspacing="0" class="estilo_fuente">
                    <tr align="center">
                        <td class="label_titulo">Solicitud Prestamos</td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <tr>
                            ...
                            <td style="width:30%;text-align:left;">
                                <asp:Button ID="Btn_Autorizacion_Prestamos" runat="server" Text="Autorizacion de Prestamos" Visible="false" 
                                   OnClientClick="javascript:return Abrir_Modal_Popup();" CssClass="button_autorizar"
                        ...
                        <table width="98%">
                            <tr>
                                <td style="width:20%;text-align:left;vertical-align:top;color:Black;">
                                    <asp:Label ID="Lbl_Motivo_Cancelacion_Rechazo_Prestamo" runat="server" Text="Label"/> 
                                </td>
                ...
                <asp:Panel ID="Pnl_Datos_Prestamo" runat="server" GroupingText="Datos del Prestamo">
                    ...
                    <table style="width:100%;">
                        <tr>
                            ...
                            <td style="width:30%;text-align:left;">
                                <asp:TextBox ID="Txt_Importe_Prestamo" runat="server" MaxLength="10" TabIndex="10" CssClass="text_cantidades_grid"
                                    Width="200px" onblur="$('input[id$=Txt_Importe_Prestamo]').formatCurrency({colorize:true, region: 'es-MX'});"
                        ...
                        <tr>
                            <td style="width:97%;" colspan="4" align="center">
                                <div id="Div_Periodo_Pago"  style="font-size:12;color:White; font-weight:bold;border-style:outset; cursor:auto;width:98%;">
                                    <table width="98%">
                                        <tr>
                        ...
                        <tr>
                            ...
                            <td style="width:30%;text-align:left;">
                                <asp:TextBox ID="Txt_No_Pagos" runat="server" Width="98%" TabIndex="13" MaxLength="10"
                                    OnTextChanged="Txt_No_Pagos_TextChanged" AutoPostBack="true"/>    
            ...
            <tr>
                <td style="color:Black;font-size:12;font-weight:bold;">
                   <asp:Image ID="Img_Informatcion_Autorizacion" runat="server"  ImageUrl="~/paginas/imagenes/paginas/C_Tips_Md_N.png" />
                     B&uacute;squeda: Solicitudes de Prestamos
                </td>
                                  ...
                                  <table width="100%">
                                   ...
                                   <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td style="width:30%;text-align:left;font-size:11px;">
                                           <asp:TextBox ID="Txt_Busqueda_Empleado_Solicitante" runat="server" Width="98%" Enabled="false"/>
