<%@ Page Language="C#" MasterPageFile="~/paginas/Paginas_Generales/MasterPage.master" AutoEventWireup="true" CodeFile="Frm_Ope_Nom_Percepciones_Variables.aspx.cs" Inherits="paginas_Nomina_Frm_Ope_Nom_Percepciones_Variables" Title="Percepciones Variables" %>
...
<script src="../../javascript/Js_Percepciones_Variables.js" type="text/javascript"></script>
 ...
 <script type="text/javascript" language="javascript">
        ...
        function pageLoad(){
            Inicializar_Eventos_Percepciones_Variables();
...
<asp:Content ID="Content3" ContentPlaceHolderID="Cph_Area_Trabajo1" Runat="Server">
    <cc1:ToolkitScriptManager ID="Tsm_Percepciones_Variables" runat="server"  AsyncPostBackTimeout="36000"  EnableScriptGlobalization = "true" EnableScriptLocalization = "True"/>
    <asp:UpdatePanel ID="Upd_Panel" runat="server">
        <ContentTemplate>  
            ...
            <asp:Button ID="Btn_Comodin_Perder_Foco" runat="server" style="background-color:Transparent;border-style:none;" OnClientClick="javascript:return false;"/>
             ...
             <div id="Div_Percepciones_Variables" style="background-color:#ffffff; width:100%; height:100%;">
            
                    <table width="98%"  border="0" cellspacing="0" class="estilo_fuente">
                        <tr align="center">
                            <td class="label_titulo">Percepciones Variables</td>
                        </tr>
                        <tr>
                            <td>
                                              ...
                                              <td align="left" style="width:59%;">                                                  
                                                   <asp:ImageButton ID="Btn_Nuevo" runat="server" ToolTip="Nuevo" CssClass="Img_Button"
                                                    ...
                                                    <asp:ImageButton ID="Btn_Eliminar" runat="server" ToolTip="Eliminar" CssClass="Img_Button" 
                                                        ...
                                                        OnClientClick="return confirm('¿Está seguro de eliminar el numero de percepcion variable seleccionado?');"/>
                                                ...
                                                <table style="width:100%;height:28px;">
                                                    <tr>
                                                        <td style="width:60%;vertical-align:top;">
                                                            B&uacute;squeda
                                                            <asp:ImageButton ID="Btn_Busqueda_No_Percepcion_Variable" runat="server" ToolTip="Avanzada"  
                ...
                <table width="98%">
                    <tr style="display:none;">
                        ...
                        <td  style="text-align:left;width:30%;" >
                            <asp:TextBox ID="Txt_No_Percepcion" runat="server" Width="98%" />
                        </td>
                    ...
                    <tr>
                        <td style="width:100%;vertical-align:top;" colspan="4" align="right">
                            <asp:HyperLink ID="Btn_Autorizacion_Percepcion_Variable" runat="server" Text="Autorizacion Percepcion Variable" Visible="false" ForeColor="#0000FF"
                ...
                <cc1:TabContainer ID="TPnl_Contenedor" runat="server" ActiveTabIndex="0" Width="98%" CssClass="Tab">
                    <cc1:TabPanel ID="Pnl_No_Percepciones_Variables" runat="server" HeaderText="Percepciones Variables">
                        <HeaderTemplate>
...
<%--                                            <asp:BoundField DataField="DEPENDENCIA" HeaderText="U. Responsable">
                        ...
                        <ContentTemplate>
                             <table style="width:100%;">
                                <tr>
                                    ...
                                    <td style="text-align:left;width:30%;">     
                                        <asp:TextBox ID="Txt_Empleados" runat="server" Width="98%" AutoPostBack="true"
                                            OnTextChanged="Txt_Empleados_TextChanged"/>
                                    ...
                                    <td style="text-align:left;width:45%;">
                                        Cantidad
                                        <asp:TextBox ID="Txt_Cantidad" runat="server" Width="81%" style="text-align:right;" Text="0.00" AutoPostBack="true"
            ...
            <cc1:ModalPopupExtender ID="MPE_Msj" runat="server" BackgroundCssClass="popUpStyle" BehaviorID="MPE_Msj_Interno"
                PopupControlID="Pnl_Mensaje" TargetControlID="Btn_Busqueda_No_Percepcion_Variable" PopupDragHandleControlID="Pnl_Interno" 
            ...
            <table width="100%" style="background-color:#ffffff;">
               ...
               <tr>
                ...
                <tr>
                    ...
                    <td style="width:30%;text-align:left;">
                        <asp:TextBox ID="Txt_Busqueda_No_Percepcion" runat="server" Width="98%" MaxLength="10"/>
...
<%--                <tr>
               ...
               <tr>
                    <td style="width:100%" colspan="4" align="center">
                        <asp:Button ID="Btn_Busqueda_Percepcion" runat="server" Text="Búsqueda Percepciones" OnClick="Btn_Busqueda_Percepcion_Click" CausesValidation="false"
                            style="border-style:none;background-color:White;"  ToolTip="Ejecuatar la búsqueda de Percepciones en el sistema"/>   
                    </td>
                </tr>                  
               <tr>
                    <td style="width:100%" colspan="4">
