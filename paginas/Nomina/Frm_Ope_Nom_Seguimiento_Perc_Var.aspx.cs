...
public partial class paginas_Nomina_Frm_Ope_Nom_Seguimiento_Perc_Var : System.Web.UI.Page
{
    #region (Load)
    ///*******************************************************************************
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (!IsPostBack)
            {
                Hf_No_Percepcion.Value = (String)Request.QueryString["No_Percepcion"];
                Hf_Percepcion.Value = (String)Request.QueryString["Percepcion"];
    ...
    {
        Cls_Ope_Nom_Percepciones_Var_Negocio Consulta_Percepciones_Variables_Asiganadas = new Cls_Ope_Nom_Percepciones_Var_Negocio(); //Variable de conexión a la capa de Negocios para la consulta de los datos del puesto
        Cls_Ope_Nom_Percepciones_Var_Negocio Percepcion_Variable_Consultada = null;
        try
        {
            Pnl_Gral_Autirizar_Percepciones_Variables.Visible = true;
            Consulta_Percepciones_Variables_Asiganadas.P_No_Percepcion = Hf_No_Percepcion.Value;
            Percepcion_Variable_Consultada = Consulta_Percepciones_Variables_Asiganadas.Consulta_Percepciones_Variables();
            LLenar_Grid_Emplados_Autorizar(Percepcion_Variable_Consultada.P_Dt_Empleados, 0);
    ...
    protected void Grid_Emplados_Autorizar_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        try
        {
            if (e.Row.RowType.Equals(DataControlRowType.DataRow))
            {
                ...
                ((Button)e.Row.Cells[5].FindControl("Btn_Autorizar_Percepcion_Variable")).CommandArgument = e.Row.Cells[1].Text.Trim();
                ((Button)e.Row.Cells[5].FindControl("Btn_Autorizar_Percepcion_Variable")).ToolTip = "Autorizar Empleado " + HttpUtility.HtmlDecode(e.Row.Cells[2].Text);
                //Rechazar el dia festivo
                ((Button)e.Row.Cells[5].FindControl("Btn_Rechazar_Percepcion_Variable")).CommandArgument = e.Row.Cells[1].Text.Trim();
                ((Button)e.Row.Cells[5].FindControl("Btn_Rechazar_Percepcion_Variable")).ToolTip = "Rechazar Empleado " + HttpUtility.HtmlDecode(e.Row.Cells[2].Text);
    ...
    ///*******************************************************************************
    ///NOMBRE DE LA FUNCIÓN: Cambio_Estatus_Asignacion_Percepcion_Var
    ...
    ///CAUSA_MODIFICACIÓN
    ///*******************************************************************************
    private void Cambio_Estatus_Asignacion_Percepcion_Var()
    {
        Cls_Ope_Nom_Percepciones_Var_Negocio Cls_Ope_Percepcion_Var_Consulta = new Cls_Ope_Nom_Percepciones_Var_Negocio();
        try
        {
            Cls_Ope_Percepcion_Var_Consulta.P_Empleado_ID = Txt_Autorizacion_Empleado_ID.Text;
            Cls_Ope_Percepcion_Var_Consulta.P_No_Percepcion = Hf_No_Percepcion.Value.Trim();
            Cls_Ope_Percepcion_Var_Consulta.P_Estatus = Hf_Estatus.Value;
            Cls_Ope_Percepcion_Var_Consulta.P_Comentarios_Estatus = Txt_Autorizacion_Comentarios_Estatus.Text;

            if (Cls_Ope_Percepcion_Var_Consulta.Cambiar_Estatus_Percepciones_Variables())
            {
    ...
    protected void Btn_Autorizar_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                Cambio_Estatus_Asignacion_Percepcion_Var();
                Consultar_Empleados_Autorizar();
                Habilitar_Controles(true);
    ...
    {
        Response.Redirect("Frm_Ope_Nom_Percepciones_Variables.aspx?PAGINA=" + Request.QueryString["PAGINA"]);  
    }
    ///*******************************************************************************
    ...
    ///CAUSA_MODIFICACIÓN
    ///*******************************************************************************
    protected void Btn_Rechazar_Percepcion_Variable_Click(object sender, EventArgs e)
    {
        Button Btn_Rechazar_Percepcion_Variable_Asiganada = (Button)sender;
        Cls_Cat_Empleados_Negocios Cat_Empleados_Consulta = new Cls_Cat_Empleados_Negocios(); //Variable de conexión a la capa de Negocios para la consulta de los datos del puesto
        DataTable Dt_Datos_Empleado = null;//Variable que almacenara iuna lista de empleados
        try
        {
            ...
            Txt_Autorizacion_Comentarios_Estatus.Text = "";
            Txt_Autorizacion_Empleado_ID.Text = Btn_Rechazar_Percepcion_Variable_Asiganada.CommandArgument.Trim();
            Hf_Estatus.Value = "Rechazado";
            Grid_Emplados_Autorizar.Enabled = false;

            //Consultamos datos del empleado.
            Cat_Empleados_Consulta.P_Empleado_ID = Btn_Rechazar_Percepcion_Variable_Asiganada.CommandArgument.Trim();
            Dt_Datos_Empleado = Cat_Empleados_Consulta.Consulta_Datos_Empleado();
    ...
    ///CAUSA_MODIFICACIÓN
    ///*******************************************************************************
    protected void Btn_Autorizar_Percepcion_Variable_Click(object sender, EventArgs e)
    {
        Button Btn_Autorizar_Asignacion_Percepcion_Var = (Button)sender;

        try
        {
            Txt_Autorizacion_Empleado_ID.Text = Btn_Autorizar_Asignacion_Percepcion_Var.CommandArgument.Trim();
    ...
    ///CAUSA_MODIFICACIÓN
    ///*********************************************************************************************
    private DataTable Obtener_Informacion_Empleado(String Empleado_ID, String No_Perc_Var)
    {
        Cls_Ope_Nom_Percepciones_Var_Negocio Obj_Perc_Var = new Cls_Ope_Nom_Percepciones_Var_Negocio();//Variable de conexion con la capa de negocios.
        Cls_Cat_Empleados_Negocios Obj_Empleados = new Cls_Cat_Empleados_Negocios();//Variable de conexion con la capa de negocios.
        DataTable Dt_Perc_Var = null;                                      //Variable que almacenara una lista de dias festivos
        ...
        try
        {
            ...
            Dt_Informacion_Incidencias.Columns.Add("PERCEPCION", typeof(String));
                ...
                if (Dt_Empleados.Rows.Count > 0)
                {
                    foreach (DataRow Empleado in Dt_Empleados.Rows)
                    {
                        if (Empleado is DataRow)
                        {
                            ...
                            Fila["PERCEPCION"] = Hf_Percepcion.Value.Trim();
                            ...
                            Obj_Perc_Var.P_No_Percepcion = No_Perc_Var;
                            Dt_Perc_Var = Obj_Perc_Var.Consulta_Percepciones_Variables().P_Dt_Empleados;

                            if (Dt_Perc_Var is DataTable)
                            {
                                if (Dt_Perc_Var.Rows.Count > 0)
                                {
                                    foreach (DataRow Detalle_Percepcion_Variable in Dt_Perc_Var.Rows)
                                    {
                                        if (Detalle_Percepcion_Variable is DataRow)
                                        {
                                            if (!String.IsNullOrEmpty(Detalle_Percepcion_Variable[Ope_Nom_Perc_Var_Emp_Det.Campo_Cantidad].ToString()))
                                            {
                                                Cantidad = Detalle_Percepcion_Variable[Ope_Nom_Perc_Var_Emp_Det.Campo_Cantidad].ToString();
                                                if (Empleado_ID.Trim().Equals(Detalle_Percepcion_Variable[Cat_Empleados.Campo_Empleado_ID].ToString()))
                                                {
    ...
    private void Agregar_Informacion_Etiqueta(Label Etiqueta, String Empleado_ID)
    {
        ...
        try
        {
            ...
            Dt_Informacion_Incidencias = Obtener_Informacion_Empleado(Empleado_ID, Hf_No_Percepcion.Value.Trim());
                ...
                if (Dt_Informacion_Incidencias.Rows.Count > 0)
                {
                    foreach (DataRow Incidencia in Dt_Informacion_Incidencias.Rows)
                    {
                        if (Incidencia is DataRow)
                        {
                            ...
                            Tooltip.Append("<b style='color:white;'>Percepción:</b> ");
                            if (!String.IsNullOrEmpty(Incidencia["PERCEPCION"].ToString()))
                                Tooltip.Append("&nbsp;" + Incidencia["PERCEPCION"].ToString());
                            Tooltip.Append("<br />");
