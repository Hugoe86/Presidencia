...
public partial class paginas_Nomina_Frm_Ope_Nom_Vacaciones_Dependencia : System.Web.UI.Page
{
        ...
        try
        {
            ...
            switch (Operacion)
            {
                case "Inicial":
                    ...
                    Configuracion_Acceso("Frm_Ope_Nom_Vacaciones_Dependencia.aspx");
                    break;
                case "Nuevo":
                    Habilitado = true;
    ...
    private void Consultar_Dias_Vacaciones_Empleado()
    {
        ...
        Int32 Dias_Comprometidos = 0;//Variable que almacena los dias que el empleado tiene como comprometidos.
        ...
        try
        {
            if (!String.IsNullOrEmpty(Txt_No_Empleado.Text))
            {
                ...
                if (Dt_Empleado != null)
                {
                    ...
                    {
                        if (Dt_Empleado.Rows[0][Cat_Empleados.Campo_Dependencia_ID].ToString().Equals(Cls_Sessiones.Datos_Empleado.Rows[0][Cat_Empleados.Campo_Dependencia_ID].ToString()))
                        {
                ...
                //Aqui se establece el texto que mostrara la etiqueta.
    ...
    private void Consultar_Vacaciones(Int32 Pagina)
    {
        ...
        try
        {
            ...
            if (!String.IsNullOrEmpty(Txt_No_Empleado_Busqueda.Text.Trim()) && !(Txt_No_Empleado_Busqueda.Text.Trim().Equals("000000")))
            {
            ...
            if (Cmb_Busqueda_Estatus.SelectedIndex > 0)
            {
                ...
                Cls_Vacaciones_Emplados.P_Estatus = "Pendiente";
            }
    ...
    private void LLenar_Grid_Vacaciones(DataTable Dt_Vacaciones, Int32 Pagina)
    {
        ...
        Grid_Vacaciones_Empleados.Columns[8].Visible = true;
        ...
        if (Cmb_Busqueda_Estatus.SelectedValue != "Rechazado")
            Grid_Vacaciones_Empleados.Columns[8].Visible = false;
    ...
    protected void Grid_Vacaciones_Empleados_PageIndexChanging(object sender, GridViewPageEventArgs e)
    {
        try
        {
            ...
            ScriptManager.RegisterStartupScript(Upd_Panel, typeof(string), "Imagen", "javascript:Inicializar_Eventos_Autoriazacion_Vacaciones_Dependencia();", true);
        }
        catch (Exception Ex)
        {
            Lbl_Mensaje_Error.Visible = true;
    ...
    /// CAUSA_MODIFICACION:
    ///*******************************************************************************
    protected void Btn_Reporte_Vacaciones_Click(object sender, EventArgs e)
    {
        Cls_Ope_Nom_Vacaciones_Empleado_Negocio Vacaciones_Consulta = new Cls_Ope_Nom_Vacaciones_Empleado_Negocio();
        String No_Vacacion = String.Empty;
        ...
        try
        {
            ...
            Grid_Vacaciones_Empleados.SelectedIndex = Row.RowIndex;
            int Fila = Row.RowIndex;


            Grid_Vacaciones_Empleados.Columns[1].Visible = true;
            No_Vacacion = Grid_Vacaciones_Empleados.Rows[Fila].Cells[1].Text.Trim();
            Grid_Vacaciones_Empleados.Columns[1].Visible = false;
            Vacaciones_Consulta.P_No_Vacacion = No_Vacacion;
            Dt_Reporte = Vacaciones_Consulta.Consultar_Reporte_Vacaciones();
    ...
    protected void Btn_Guardar_Autorizacion_Vacacion_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            Cls_Vacaciones_Consulta.P_Estatus = (Chk_Autorizar.Checked) ? "Aceptado" : "Rechazado";
