...
public partial class paginas_Nomina_Frm_Ope_Nom_Solicitud_Prestamos : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (Cls_Sessiones.Datos_Empleado != null)
            {
                ...
                {
                    Txt_No_Empleado_Solicitante_Prestamo.Text = Cls_Sessiones.Datos_Empleado.Rows[0][Cat_Empleados.Campo_No_Empleado].ToString();
                }
            }
        }
        catch (Exception Ex)
    ...
    private void Limpiar_Controles_Empleado_Solicitante()
    {
        try
        {
            ...
            Txt_Clase_Nomina_Empleado.Text = "";
        ...
        try
        {
            ...
            switch (Operacion)
            {
                case "Inicial":
                    ...
                    Configuracion_Acceso("Frm_Ope_Nom_Solicitud_Prestamos.aspx");
                    break;
                case "Nuevo":
                    Habilitado = true;
            ...
            Txt_Importe_Interes.Enabled = false;
            Txt_Total_Prestamo.Enabled = false;
            Txt_No_Pagos.Enabled = false;
            ...
            Chk_Aplica_Porcentaje.Enabled = false;
            //Controles Datos Empleado Solicita Credito
        ...
        try
        {
            ...
            if (!string.IsNullOrEmpty(Txt_Importe_Interes.Text.Trim()))
            {
                ...
                if (Lbl_Importe_Interes.Text.Trim().Contains("%"))
                {
                    ...
                    {
                        Txt_Importe_Interes.Text = "";
                        throw new Exception("El porcentaje no puede ser mayor a 100 o menor a 0.");
                    }
                }
            }
            ...
            Txt_Importe_Interes.Text = string.Format("{0:#,###,#0.00}", Importe_Interes);
        }
        catch (Exception Ex)
        {
    ...
    private void Calculo_Abono()
    {
        ...
        try
        {
            ...
            if (Total_Importes > 0 && No_Abonos > 0)
            {
                ...
                Txt_Abono.Text = string.Format("{0:#,###,###.00}", Abono);
                Txt_No_Abonos.Text = "0";
                Txt_Saldo_Actual.Text = string.Format("{0:#,###,###.00}", Total_Importes);
            }
        }
        catch (Exception Ex)
        {
    ...
    private void Modificar_Solicitud_Prestamo()
    {
        ...
        try
        {
            ...
            Modificar_Solicitud_Prestamo.P_Total_Prestamo = Convert.ToDouble(Txt_Importe_Prestamo.Text.Trim());
    ...
    private void Consultar_Mostrar_Informacion_Empleado_Solicitante()
    {
        ...
        Cls_Cat_Nom_Bancos_Negocio Rs_Consulta_Cat_Nom_Bancos = new Cls_Cat_Nom_Bancos_Negocio();       //Variable de conexión hacia la capa de negocios.
        ...
        DataTable Dt_Bancos = null;              //Variable que almacena el banco en el cual se le depósita la nómina al empleado
        ...
        String Dependencia_Usuario_Sistema = ""; //Variable que almacenara la dependencia a la que pertenece el usuario del sistema.
        ...
        try
        {
            ...
            //Obtenemos la dependencia a la que pertenece el usuario que se encuantra logueado al sistema actualmente.
            if (Cls_Sessiones.Datos_Empleado != null)
            {
                if (Cls_Sessiones.Datos_Empleado.Rows.Count > 0)
                {
                    Dependencia_Usuario_Sistema = Cls_Sessiones.Datos_Empleado.Rows[0][Cat_Empleados.Campo_Dependencia_ID].ToString();
                }
            }
            ...
            if (!string.IsNullOrEmpty(Txt_No_Empleado_Solicitante_Prestamo.Text.Trim()))
            {
                ...
                if (Dt_Empleados != null)
                {
                    if (Dt_Empleados.Rows.Count > 0)
                    {
                        if (Dt_Empleados.Rows[0][Cat_Empleados.Campo_Dependencia_ID].ToString().Trim().Equals(Dependencia_Usuario_Sistema))
                        {
                            ///Estas operaciones solo se realizaran si el no de empleado pertenece aun empleado de de la misma dependencia.
                            ...
                            Sueldo_Mensual = string.Format("{0:#,###,###.00}", (Convert.ToDouble((Dt_Empleados.Rows[0][Cat_Empleados.Campo_Salario_Diario].ToString().Trim().Equals("")) ? "0" : Dt_Empleados.Rows[0][Cat_Empleados.Campo_Salario_Diario].ToString().Trim()) * (new Cls_Utlidades_Nomina(DateTime.Now).P_Dias_Promedio_Mes_Anio )));
                        ...
                        else
                        {
                            Lbl_Mensaje_Error.Visible = true;
                            Img_Error.Visible = true;
                            Lbl_Mensaje_Error.Text = "El Numero de Empleado pertenece a un empleado de otra dependencia. para solicitar un prestamo acuda con su dependencia.";
                        }
                    }
                    else
                    {
            ...
            if (!string.IsNullOrEmpty(Txt_No_Empleado_Aval.Text.Trim()))
            {
                ...
                if (Dt_Empleados != null)
                {
                    if (Dt_Empleados.Rows.Count > 0)
                    {
                        ...
                        //    Lbl_Mensaje_Error.Visible = true;
                        //    Img_Error.Visible = true;
                        //    Lbl_Mensaje_Error.Text = "El Numero de Empleado pertenece a un empleado de otra dependencia. Un empleado solo puede ser aval en la dependencia a la que pertenece.";
                        //}
                    }
                    else
                    {
    ...
    {
        Txt_Busqueda_Empleado_Solicitante.Text = Cls_Sessiones.Datos_Empleado.Rows[0][Cat_Empleados.Campo_No_Empleado].ToString();
    ...
    private Boolean Aplica_Sueldo_Prestamo()
    {
        ...
        Double Salario_Mensual_Empleado = 0.0;//Variable que almacena el salario mensual del empleado.
        String Empleado_ID = "";//Variable que almacena el identificador uniko del empleado, para uso interno del sistema.
