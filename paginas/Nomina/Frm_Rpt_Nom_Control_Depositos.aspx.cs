...
public partial class paginas_Nomina_Frm_Rpt_Nom_Control_Depositos : System.Web.UI.Page
{
    #region (Load/Init)
    ...
    /// *************************************************************************************
    /// NOMBRE: Consultar_Control_Deposito
    ...
    /// CAUSA MODIFICACIÓN:
    /// *************************************************************************************
    protected DataTable Consultar_Control_Deposito()
    {
        var Obj_Empleados = new Cls_Rpt_Nom_Control_Deposito_Negocio();// Variable de conexión con la capa de negocios.
        ...
        try
        {
            ...
            Dt_Percepcion_Deduccion = Obj_Empleados.Consultar_Control_Deposito();
    ...
    {
        DataSet Ds_Reporte;
        DataTable Dt_Control_Deposito;//Variable que almacena un listado de empleados.
        ...
        try
        {
            if (Validar_Reporte())
            {
                ...
                Dt_Control_Deposito = Consultar_Control_Deposito();
                Dt_Control_Deposito.TableName = "Dt_Control_Deposito"; ;

                Dt_Parametros = Consultar_Parametros_Reporte();
                Dt_Parametros.TableName = "Dt_Parametros";

                Ds_Reporte.Tables.Add(Dt_Control_Deposito.Copy());
                Ds_Reporte.Tables.Add(Dt_Parametros.Copy());

                Generar_Reporte(ref Ds_Reporte, "Cr_Rpt_Nom_Control_Deposito.rpt", "Reporte_Nomina_Control_Deposito" + Session.SessionID + ".pdf");
            }
        }
        catch (Exception Ex)
        {
    ...
    protected void Btn_Generar_Reporte_Excel_Click(object sender, ImageClickEventArgs e)
    {
        ...
        try
        {
            if (Validar_Reporte())
            {
                ...
                Exportar_Reporte(Ds_Reporte, "Cr_Rpt_Nom_Control_Deposito.rpt", "Reporte_Nomina_Control_Deposito" + Session.SessionID, "xls", ExportFormatType.Excel);
            }
        }
