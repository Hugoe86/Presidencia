...
AutoEventWireup="true" CodeFile="Frm_Rpt_Nom_Variables.aspx.cs" Inherits="paginas_Nomina_Frm_Rpt_Nom_Variables" 
Title="Reporte Variables"%>
                        ...
                        <tr>
                            ...
                            <td class="button_autorizar" style="width:80%; text-align:left; cursor:default;">
                                <asp:DropDownList ID="Cmb_Tipo_Reporte" runat="server" Width="100%" TabIndex="3" >
                                    <asp:ListItem Value ="REPORTE DE DEDUCCIONES (VARIABLES)">REPORTE DE DEDUCCIONES (VARIABLES)</asp:ListItem>
                                    <asp:ListItem Value ="REPORTE DE PERCEPCIONES (VARIABLES)">REPORTE DE PERCEPCIONES (VARIABLES)</asp:ListItem>
