<%@ Page Language="C#" MasterPageFile="~/paginas/Paginas_Generales/MasterPage.master" AutoEventWireup="true" CodeFile="Frm_Ope_Nom_Seguimiento_Domingos.aspx.cs" Inherits="paginas_Nomina_Frm_Ope_Nom_Seguimiento_Domingos" Title="Segumiento de Días Domingos Laborados" %>
...
<asp:UpdatePanel ID="UPnl_Autorizacion_Domingos" runat="server" UpdateMode="Conditional">
  <ContentTemplate>       
    <asp:HiddenField ID="Hf_No_Domingo" runat="server" />
    <asp:HiddenField ID="Hf_Estatus" runat="server" />
    
    <table width="98%"  border="0" cellspacing="0" class="estilo_fuente">
        <tr align="center">
            <td class="label_titulo">Autorización Prima Dominical</td>
        </tr>
        <tr>
            <td>
    ...
    <center>
        <asp:Panel ID="Pnl_Gral_Autirizar_Domingo" runat="server" CssClass="drag" HorizontalAlign="Center" Width="650px"
            ...
            <asp:Panel ID="Pnl_Header_Autirizar_Domingo" runat="server" 
                    ...
                    <tr>
                        <td style="color:Black;font-size:12;font-weight:bold;">
                           <asp:Image ID="Img_Informacion" runat="server"  ImageUrl="~/paginas/imagenes/paginas/C_Tips_Md_N.png" />
                             Informacion: Autorizaci&oacute;n de Domingos 
                        </td>
                            ...
                            <table width="100%" style="background-color:#ffffff;">
                               <tr>
                                    <td style="width:100%" colspan="4" align="right">
                                        <asp:ImageButton ID="Btn_Clear_Ctlr" runat="server" 
                               ...
                               <tr>
                                    <td style="width:100%" colspan="4" align="center">
                                        <asp:Button ID="Btn_Autorizar" runat="server" Text="Guardar Comentarios" 
                                            style="border-style:none;background-color:White;"  TabIndex="16" 
                                            ToolTip="Guardar Comentarios" OnClick="Btn_Autorizar_Click" />    
                                    ...
                                    <td style="width:100%" colspan="4">
                                        ...
                                        <asp:GridView ID="Grid_Emplados_Autorizar" runat="server" CssClass="GridView_1"
                                             AutoGenerateColumns="False"  GridLines="None" 
                                                ...
                                                onselectedindexchanged="Grid_Emplados_Autorizar_SelectedIndexChanged"
                                             >
                                                <Columns>           
                                                        ...
                                                        <asp:BoundField DataField="EMPLEADO_ID" HeaderText="Clave">
                                                            ...
                                                            <ItemStyle HorizontalAlign="Left" Width="0%" VerticalAlign="Top"/>
                                                        </asp:BoundField>
                                                        ...
                                                        <asp:TemplateField HeaderText="Autorizar">
                                                            <ItemTemplate>
                                                                <asp:Button ID="Btn_Autorizar_Domingo" runat="server" Text="Autorizar"
                                                                    ...
                                                                    OnClick="Btn_Autorizar_Domingo_Click"/>
                                                                <asp:Button ID="Btn_Rechazar_Domingo" runat="server" Text="Rechazar"
                                                                    style="border-style:none;background-color:#FFFFFF;"
                                                                    onmouseover="this.style.backgroundColor='#FFFFCC';this.style.cursor='hand';this.style.color='DarkBlue';this.style.borderStyle='none';this.style.borderColor='Silver';"
                                                                    onmouseout="this.style.backgroundColor='#FFFFFF';this.style.color='Black';this.style.borderStyle='none';"       
                                                                    OnClick="Btn_Rechazar_Domingo_Click"                                                             
                                                                    />
                                                            </ItemTemplate>
                                                            <HeaderStyle HorizontalAlign="Center" Width="25%" />
                                                            <ItemStyle HorizontalAlign="Center" Width="25%" VerticalAlign="Top"/> 
                                                        </asp:TemplateField>   
                                                        <asp:TemplateField HeaderText="Información">
                                                            ...
                                                            <ItemStyle HorizontalAlign="Left" Width="30%"  Font-Size="10px"/> 
                                                        </asp:TemplateField>                                                                                                                                                                                                                                
                                                </Columns>
