<%@ Page Language="C#" MasterPageFile="~/paginas/Paginas_Generales/MasterPage.master" 
    AutoEventWireup="true" CodeFile="Frm_Cat_Alta_Empleados.aspx.cs" Inherits="paginas_Nomina_Frm_Cat_Empleados" 
...
<asp:Content ID="Content2" ContentPlaceHolderID="Cph_Area_Trabajo2" Runat="Server">
 ...
 <script type="text/javascript" language="javascript">
        ...
        function Limpiar_Ctlr(){
            ...
            document.getElementById("<%=Txt_Busqueda_Codigo_Programatico.ClientID%>").value="";
            return false;
        }  
    ...
    <asp:UpdatePanel ID="Upd_Panel" runat="server" UpdateMode="Conditional">
        <ContentTemplate>  
            ...
            <asp:UpdatePanel ID="Upnl_Catalogo_Empleados" runat="server" UpdateMode="Conditional">
                            ...
                            <td style="width:90%;">
                                <table width="100%" class="estilo_fuente">
                                    ...
                                    <tr>
                                        ...
                                        <td style="width:30%;text-align:left;">
                                            <asp:TextBox ID="Txt_Nombre_Empleado" runat="server" TabIndex="3" MaxLength="100" Width="98%"
                                        ...
                                        <td colspan="3" style="width:30%;text-align:left;">
                                            <asp:DropDownList ID="Cmb_Roles_Empleado" runat="server" Width="100%" TabIndex="4" style="display:none;"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width:20%;text-align:left;">
                                        ...
                                        <td style="width:30%;text-align:left;">
                                            <asp:TextBox ID="Txt_Apellido_Paterno_Empleado" runat="server" TabIndex="5" MaxLength="100" Width="98%"
                                                onkeyup="javascript:Generar_CONFRONTO();this.value = this.value.toUpperCase();"/>
                                        ...
                                        <td style="width:30%;text-align:left;">
                                            <asp:TextBox ID="Txt_Apellido_Materno_Empleado" runat="server" TabIndex="6" MaxLength="100" Width="98%"
                                                onkeyup="javascript:Generar_CONFRONTO();this.value = this.value.toUpperCase();"/>
                                    ...
                                    <tr style="display:none;">
                                        ...
                                        <td style="width:30%;text-align:left;">
                                            <asp:TextBox ID="Txt_Password_Empleado" runat="server" TabIndex="7" MaxLength="100" Text="123456"
                                        ...
                                        <td style="width:30%;text-align:left;">
                                            <asp:TextBox ID="Txt_Confirma_Password_Empleado" runat="server" TabIndex="8" MaxLength="100" Text="123456"
                                                Width="98%" TextMode="Password"/>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3" style="width:80%;text-align:left;">
                                            <asp:TextBox ID="Txt_Comentarios_Empleado" runat="server" TabIndex="9" MaxLength="250"
                                                TextMode="MultiLine" Width="100%" Height="60px" onkeyup='this.value = this.value.toUpperCase();'/>
                        ...
                        <ContentTemplate>
                            ...
                            <table style="width:100%;">
                                <tr>
                                    ...
                                    <td style="width:30%;text-align:left;">
                                        <asp:TextBox ID="Txt_Fecha_Nacimiento_Empleado" runat="server" Width="84%" TabIndex="10" MaxLength="11" Height="18px" onblur='this.value = this.value.toLowerCase();'/>
                                    ...
                                    <td style="width:30%;text-align:left;">
                                        <asp:DropDownList ID="Cmb_Sexo_Empleado" runat="server" Width="100%" TabIndex="11">
                                ...
                                <tr>
                                    ...
                                    <td style="width:30%;text-align:left;">
                                        <asp:TextBox ID="Txt_RFC_Empleado" runat="server" Width="98%" TabIndex="12"
                                    ...
                                    <td style="width:30%;text-align:left;">
                                        <asp:TextBox ID="Txt_CURP_Empleado" runat="server" Width="98%" TabIndex="13"
                                ...
                                <tr>
                                    ...
                                    <td colspan="3" style="width:80%;text-align:left;">
                                        <asp:TextBox ID="Txt_Domicilio_Empleado" runat="server" Width="99.5%" TabIndex="14" MaxLength="100" onkeyup='this.value = this.value.toUpperCase();'/>
                                ...
                                <tr>
                                    ...
                                    <td style="width:30%;text-align:left;">
                                        <asp:TextBox ID="Txt_Colonia_Empleado" runat="server" Width="98%" TabIndex="15" MaxLength="100" onkeyup='this.value = this.value.toUpperCase();'/>
                                    ...
                                    <td style="width:30%;text-align:left;">
                                        <asp:TextBox ID="Txt_Codigo_Postal_Empleado" runat="server" Width="98%" TabIndex="16" MaxLength="5"
                                ...
                                <tr>
                                    ...
                                    <td style="width:30%;text-align:left;">
                                        <asp:TextBox ID="Txt_Ciudad_Empleado" runat="server" Width="98%" TabIndex="17" MaxLength="50" onkeyup='this.value = this.value.toUpperCase();'/>
                                    ...
                                    <td style="width:30%;text-align:left;">
                                        <asp:TextBox ID="Txt_Estado_Empleado" runat="server" Width="98%" TabIndex="18" MaxLength="50" onkeyup='this.value = this.value.toUpperCase();'/>
                                ...
                                <tr>
                                    ...
                                    <td style="width:30%;text-align:left;">
                                        <asp:TextBox ID="Txt_Telefono_Casa_Empleado" runat="server" Width="98%" TabIndex="19" MaxLength="20"
                                    ...
                                    <td style="width:30%;text-align:left;">
                                        <asp:TextBox ID="Txt_Celular_Empleado" runat="server" Width="98%" TabIndex="20" MaxLength="20"
                                ...
                                <tr>
                                    ...
                                    <td style="width:30%;text-align:left;">
                                        <asp:TextBox ID="Txt_Nextel_Empleado" runat="server" Width="98%" TabIndex="21" MaxLength="20"/>
                                    ...
                                    <td style="width:30%;text-align:left;">
                                        <asp:TextBox ID="Txt_Telefono_Oficina_Empleado" runat="server" Width="98%" TabIndex="22" MaxLength="20"
                                ...
                                <tr>
                                    ...
                                    <td style="width:20%;text-align:left;">
                                        <asp:TextBox ID="Txt_Extension_Empleado" runat="server" Width="98%" TabIndex="23" MaxLength="10" onkeyup='this.value = this.value.toUpperCase();'/>
                                    ...
                                    <td style="width:20%;text-align:left;">
                                        <asp:TextBox ID="Txt_Fax_Empleado" runat="server" Width="98%" TabIndex="24" MaxLength="20"/>
                                ...
                                <tr>
                                    ...
                                    <td colspan="3" style="width:80%;text-align:left;">
                                        <asp:TextBox ID="Txt_Correo_Electronico_Empleado" runat="server" Width="99.5%" TabIndex="25" MaxLength="100"
                             ...
                             <table style="width:100%;">
                                ...
                                <tr>    
                                    ...
                                    <td style="text-align:left;width:30%;">  
                                        <asp:TextBox ID="Txt_No_IMSS" runat="server" Width="98%" MaxLength="20"
                                            onkeyup='this.value = this.value.toUpperCase();' TabIndex="40"/> 
                                    ...
                                    <td style="text-align:left;width:30%;">
                                        <asp:DropDownList ID="Cmb_Reloj_Checador" runat="server" Width="100%" TabIndex="41">
                                            <asp:ListItem>&lt;- Seleccione -&gt;</asp:ListItem>
                                ...
                                <tr>    
                                    ...
                                    <td style="text-align:left;width:30%;" colspan="3">  
                                        <asp:DropDownList ID="Cmb_Tipo_Nomina" runat="server" Width="100%" AutoPostBack="True" 
                                            OnSelectedIndexChanged="Cmb_Tipo_Nomina_SelectedIndexChanged" TabIndex="42">
                                            <asp:ListItem>&lt;- Seleccione -&gt;</asp:ListItem>
                                ...
                                <tr>    
                                    ...
                                    <td style="text-align:left;width:30%;">  
                                        <asp:TextBox ID="Txt_No_Tarjeta" runat="server" Width="98%" MaxLength="50"
                                ...
                                <tr>    
                                    ...
                                    <td style="text-align:left;width:30%;">
                                        <asp:DropDownList ID="Cmb_Bancos" runat="server" Width="100%" TabIndex="45"/>
                                    </td>
                                    <td style="text-align:left;width:20%;">
                                        &nbsp;&nbsp;No Cuenta Bancaria
                                    </td>
                                    <td style="text-align:left;width:30%;">
                                        <asp:TextBox ID="Txt_Cuenta_Bancaria" runat="server" Width="98%" MaxLength="20"
                                ...
                                <tr>    
                                    ...
                                    <td style="text-align:left;width:30%;">
                                        <asp:TextBox ID="Txt_Fecha_Inicio" runat="server" Width="85%" TabIndex="47" onblur='this.value = this.value.toLowerCase();'/>
                                        ...
                                        <cc1:MaskedEditExtender 
                                            ...
                                            Mask="99/LLL/9999" 
                                            runat="server" 
                                            UserDateFormat="DayMonthYear" Filtered="/"
                                        ...
                                        <cc1:MaskedEditValidator 
                                            ...
                                            ErrorMessage="Mev_Txt_Fecha_Inicio"/>
                                    </td>
                                    <td style="text-align:left;width:20%;">
                                        &nbsp;&nbsp;Fecha de Termino
                                    </td>
                                    <td style="text-align:left;width:30%;">
                                        <asp:TextBox ID="Txt_Fecha_Termino" runat="server" Width="85%" TabIndex="48" onblur='this.value = this.value.toLowerCase();'/>
                                         <cc1:CalendarExtender ID="Txt_Fecha_Termino_CalendarExtender" 
                                            runat="server" TargetControlID="Txt_Fecha_Termino" 
                                            Format="dd/MMM/yyyy"  
                                            PopupButtonID="Btn_Txt_Fecha_Termino_CalendarExtender" Enabled="True"  />
                                        ...
                                        <cc1:MaskedEditValidator 
                                            ...
                                            style="font-size:10px;background-color:#F0F8FF;color:Black;font-weight:bold;" 
                                            ErrorMessage="Mev_Txt_Fecha_Termino"/>
                                    </td>
                                </tr>
                                <tr>    
                                    <td style="text-align:left;width:20%;">
                                    ...
                                    <td style="text-align:left;width:30%;">  
                                        <asp:DropDownList ID="Cmb_Tipo_Finiquito" runat="server" Width="100%" TabIndex="49"/>
                                    </td>
                                    <td style="text-align:left;width:20%;">
                                        &nbsp;&nbsp;Fecha de Baja
                                    </td>
                                    <td style="text-align:left;width:30%;">
                                        <asp:TextBox ID="Txt_Fecha_Baja" runat="server" Width="85%" TabIndex="50" onblur='this.value = this.value.toLowerCase();'/>
                                         <cc1:CalendarExtender ID="Ce_Txt_Fecha_Baja" 
                                            runat="server" TargetControlID="Txt_Fecha_Baja" 
                                            Format="dd/MMM/yyyy"  PopupButtonID="Btn_Fecha_Baja" Enabled="True"  />
                                        ...
                                        <cc1:MaskedEditValidator 
                                            ...
                                            style="font-size:10px;background-color:#F0F8FF;color:Black;font-weight:bold;" 
                                            ErrorMessage="Mev_Mee_Txt_Fecha_Baja"/>
                                    </td>
                                </tr>   
                                <tr>    
                                    <td style="text-align:left;width:20%;">
                                    ...
                                    <td style="text-align:left;width:30%;">
                                        <asp:TextBox ID="Txt_Salario_Diario" runat="server" Width="81%" TabIndex="51" onblur="$('input[id$=Txt_Salario_Diario]').formatCurrency({colorize:true, region: 'es-MX'});"/>
                                        ...
                                        <cc1:MaskedEditValidator
                                            ...
                                            style="font-size:9px;" ErrorMessage="MEV_Txt_Salario_Diario"/>--%>
                                    </td>
                                    <td style="text-align:left;width:20%;">
                                        &nbsp;&nbsp;Salario D. Integrado
                                    </td>
                                    <td style="text-align:left;width:30%;">
                                        <asp:TextBox ID="Txt_Salario_Diario_Integrado" runat="server" Width="98%" TabIndex="52" onblur="$('input[id$=Txt_Salario_Diario_Integrado]').formatCurrency({colorize:true, region: 'es-MX'});"/>
                                        ...
                                        <cc1:MaskedEditValidator
                                            ...
                                            Display="Dynamic" 
                                            TooltipMessage="Monto entre $0.00 y $1,000,000.00"
                                            style="font-size:9px;" ErrorMessage="MEV_Txt_Salario_Diario_Integrado"/>--%>
                                    </td>
                                </tr> 
                                <tr>    
                                    <td style="text-align:left;width:20%;">
                                    ...
                                    <td style="text-align:left;width:30%;">
                                       <asp:TextBox ID="Txt_No_Licencia" runat="server" Width="98%" MaxLength="20"
                                    ...
                                    <td style="text-align:left;width:30%;">
                                        <asp:TextBox ID="Txt_Fecha_Vencimiento_Licencia" runat="server" Width="85%" onblur='this.value = this.value.toLowerCase();'
                                            TabIndex="54" MaxLength="20"/>
                                        ...
                                        <cc1:MaskedEditValidator 
                                            ...
                                            style="font-size:10px;background-color:#F0F8FF;color:Black;font-weight:bold;" 
                                            ErrorMessage="Mev_Txt_Fecha_Vencimiento_Licencia"/>
                                    </td>
                                </tr>
                                <tr>    
                                    <td style="text-align:left;width:20%;">
                                    ...
                                    <td style="text-align:left;width:30%;">
                                        <asp:TextBox ID="Txt_No_Seguro_Poliza_Empleado" MaxLength="20" runat="server" Width="98%" 
                                            onkeyup='this.value = this.value.toUpperCase();' TabIndex="55"/>
                                        <cc1:FilteredTextBoxExtender ID="FTE_Txt_No_Seguro_Poliza_Empleado" runat="server"
                                    ...
                                    <td style="text-align:left;width:30%;">
                                        <asp:TextBox ID="Txt_Beneficiario_Empleado" MaxLength="100" runat="server" Width="98%" 
                                            onkeyup='this.value = this.value.toUpperCase();' TabIndex="56"/>
                                        <cc1:FilteredTextBoxExtender ID="FTE_Txt_Beneficiario_Empleado" runat="server"
                ...
                <div style="overflow:auto;height:400px;width:97%;vertical-align:top;border-style: outset;color:White;" runat="server">
                                  ...
                                  <table width="100%">
                                   ...
                                   <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td style="width:30%;text-align:left;">
                                                <asp:TextBox ID="Txt_Busqueda_Fecha_Inicio" runat="server" Width="85%" MaxLength="1" TabIndex="14" onkeyup='this.value = this.value.toLowerCase();'/>
                                        ...
                                        <td style="width:30%;text-align:left;">
                                                <asp:TextBox ID="Txt_Busqueda_Fecha_Fin" runat="server" Width="85%" MaxLength="1" TabIndex="15" onkeyup='this.value = this.value.toLowerCase();'/>
