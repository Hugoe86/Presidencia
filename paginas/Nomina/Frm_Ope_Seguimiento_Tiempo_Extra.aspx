<%@ Page Language="C#" MasterPageFile="~/paginas/Paginas_Generales/MasterPage.master" AutoEventWireup="true" CodeFile="Frm_Ope_Seguimiento_Tiempo_Extra.aspx.cs" Inherits="paginas_Nomina_Frm_Ope_Seguimiento_Tiempo_Extra" Title="Seguimiento de Tiempo Extra" %>
...
<asp:UpdatePanel ID="UPnl_Autorizacion_Horas_Extra" runat="server" UpdateMode="Conditional">
  <ContentTemplate>       
  
    <asp:HiddenField ID="Hf_No_Hora_Extra" runat="server" />
    <asp:HiddenField ID="Hf_Estatus" runat="server" />
    
    <table width="98%"  border="0" cellspacing="0" class="estilo_fuente">
        <tr align="center">
            <td class="label_titulo">Tiempo Horas Extra</td>
        </tr>
        <tr>
            <td>
    ...
    <center>
        <asp:Panel ID="Pnl_Gral_Autirizar_Hrs_Extra" runat="server" CssClass="drag" HorizontalAlign="Center" Width="650px"
            ...
            <asp:Panel ID="Pnl_Header_Autirizar_Hrs_Extra" runat="server" 
                    ...
                    <tr>
                        <td style="color:Black;font-size:12;font-weight:bold;">
                           <asp:Image ID="Img_Informacion" runat="server"  ImageUrl="~/paginas/imagenes/paginas/C_Tips_Md_N.png" />
                             Informacion: Autorizaci&oacute;n de Horas Extra 
                        </td>
                                             ...
                                             >
                                                <Columns>           
                                                        ...
                                                        <asp:TemplateField HeaderText="Autorizar">
                                                            <ItemTemplate>
                                                                <asp:Button ID="Btn_Autorizar_Hora_Extra" runat="server" Text="Autorizar"
                                                                    OnClick="Btn_Autorizar_Hora_Extra_Click" style="border-style:none;background-color:#FFFFFF"
                                                                    ...
                                                                    />
                                                                <asp:Button ID="Btn_Rechazar_Hora_Extra" runat="server" Text="Rechazar"
                                                                    OnClick="Btn_Rechazar_Hora_Extra_Click" style="border-style:none;background-color:#FFFFFF;"
                                                                    onmouseover="this.style.backgroundColor='#FFFFCC';this.style.cursor='hand';this.style.color='DarkBlue';this.style.borderStyle='none';this.style.borderColor='Silver';"
                                                                    onmouseout="this.style.backgroundColor='#FFFFFF';this.style.color='Black';this.style.borderStyle='none';"                                                                    
                                                                    />
                                                            </ItemTemplate>
