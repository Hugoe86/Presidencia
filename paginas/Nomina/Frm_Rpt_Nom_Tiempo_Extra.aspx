...
AutoEventWireup="true" CodeFile="Frm_Rpt_Nom_Tiempo_Extra.aspx.cs" Inherits="paginas_Nomina_Frm_Rpt_Nom_Tiempo_Extra" 
                    ...
                    <table width="98%"  border="0" cellspacing="0">
                            ...
                            <tr>
                                ...
                                <td class="button_autorizar" style="width:80%; text-align:left; cursor:default;">
                                    <asp:DropDownList ID="Cmb_Tipo_Reporte" runat="server" Width="100%" TabIndex="3" >
                                        <asp:ListItem Value ="TIEMPO EXTRA">TIEMPO EXTRA</asp:ListItem>
                                        <asp:ListItem Value ="DIA FESTIVO">DIA FESTIVO</asp:ListItem>
                                        <asp:ListItem Value ="PRIMA DOMINICAL">PRIMA DOMINICAL</asp:ListItem>
                                    </asp:DropDownList>
                                </td> 
                            </tr>
                        </table>
                     ...
                     <asp:Panel ID="Pnl_Fechas" runat="server" Width="100%" GroupingText="Fechas">  
                         <table width="100%"> 
                             ...
                             <asp:HiddenField ID="Hdn_Fecha_Inicial" runat="server" />
                             <asp:HiddenField ID="Hdn_Fecha_Final" runat="server" />
                        </table>
