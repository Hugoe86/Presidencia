<%@ Page Language="C#" MasterPageFile="~/paginas/Paginas_Generales/MasterPage.master" AutoEventWireup="true" CodeFile="Frm_Rpt_Nom_Sueldos_Netos_Totales_Efectivo.aspx.cs" Inherits="paginas_Nomina_Frm_Rpt_Nom_Sueldos_Netos_Totales_Efectivo" Title="Untitled Page" %>
        ...
        <ContentTemplate>
            ...
            <div style="width:100%;">
                <table width="98%"  border="0" cellspacing="0" class="estilo_fuente">
                    ...
                    <tr align="center">
                        <td class="label_titulo" colspan="2">Reporte de Sueldos Netos y Efectivos</td>
                    </tr>
                    <tr>
                        <td colspan ="2">
                  ...
                  <asp:Panel ID="Panel1" runat="server" GroupingText="Filtros de reporte" Width="96%">
                    <center>
                        <table width="98%">
                            ...
                            <tr>
                                <td style="width:14%; text-align:left; cursor:default;" class="button_autorizar">
                                    <asp:Label ID="Lbl_Empleado" runat="server" Text="Empleado"></asp:Label>
                                </td>
                                <td style="width:19%; text-align:left; cursor:default;" class="button_autorizar">
                                ...
                                <td colspan="4" style="width:66%; text-align:left; vertical-align:middle;cursor:default;" class="button_autorizar">
                            ...
                            <tr>
                                <td style="width:14%; text-align:left; cursor:default;" class="button_autorizar" rowspan="2">
                                    <asp:Label ID="Lbl_Tipo_Reporte" runat="server" Text="* Tipo Reporte"></asp:Label>
                                </td>
                                <td style=" text-align:left; cursor:default; width:19%;"  rowspan="2" class="button_autorizar">
                                    <asp:RadioButtonList ID="Rbl_Sueldos" runat="server" >
                                        <asp:ListItem Text="Sueldos Netos" Value="0" Selected="True"></asp:ListItem>
                                        <asp:ListItem Text="Totales Efectivo" Value="1"></asp:ListItem>
                                    </asp:RadioButtonList>
                                </td>
                                ...
                                <td style="text-align:left; width:21%; cursor:default;" class="button_autorizar">
                                ...
                                <td style="width:22%; text-align:left; cursor:default;" class="button_autorizar">
                                    <asp:DropDownList ID="Cmb_Periodo" runat="server" Width="95%"></asp:DropDownList>
                                </td>
                            </tr>
                            <tr>
                                <td style="width:13%; text-align:left; cursor:default;" class="button_autorizar">
                                    <asp:Label ID="Lbl_Tipo" runat="server" Text=" Tipo Nomina "></asp:Label>
                                </td>
                                <td style="width:53%; text-align:left; cursor:default;" class="button_autorizar" colspan="3">
