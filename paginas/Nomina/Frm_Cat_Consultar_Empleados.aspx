<%@ Page Language="C#" MasterPageFile="~/paginas/Paginas_Generales/MasterPage.master" AutoEventWireup="true" CodeFile="Frm_Cat_Consultar_Empleados.aspx.cs" Inherits="paginas_Nomina_Frm_Cat_Empleados" Title="Consultar Empleados" %>
                            ...
                            <td style="width:90%;">
                                <table width="100%" class="estilo_fuente">                                                                           
                                    ...
                                    <tr>                    
                                        ...
                                        <td style="width:30%;text-align:left;">
                                            <asp:TextBox ID="Txt_No_Empleado" runat="server" Width="98%" TabIndex="7" MaxLength="20" onkeyup='this.value = this.value.toUpperCase();'/> 
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3" style="width:30%;text-align:left; display:none;">
                        ...
                        <ContentTemplate>
                            ...
                            <table style="width:100%;">
                                <tr>
                                    ...
                                    <td style="width:30%;text-align:left;">
                                        <asp:TextBox ID="Txt_Fecha_Nacimiento_Empleado" runat="server" Width="84%" TabIndex="16" MaxLength="11" Height="18px" onblur='this.value = this.value.toLowerCase();'/>
                                ...
                                <tr>
                                    ...
                                    <td style="width:30%;text-align:left;">
                                        <asp:TextBox ID="Txt_RFC_Empleado" runat="server" Width="98%" TabIndex="18"
                                    ...
                                    <td style="width:30%;text-align:left;">
                                        <asp:TextBox ID="Txt_CURP_Empleado" runat="server" Width="98%" TabIndex="19"
                                ...
                                <tr>
                                    ...
                                    <td colspan="3" style="width:80%;text-align:left;">
                                        <asp:TextBox ID="Txt_Domicilio_Empleado" runat="server" Width="99.5%" TabIndex="20" MaxLength="100" onkeyup='this.value = this.value.toUpperCase();'/>
                                ...
                                <tr>
                                    ...
                                    <td style="width:30%;text-align:left;">
                                        <asp:TextBox ID="Txt_Colonia_Empleado" runat="server" Width="98%" TabIndex="21" MaxLength="100" onkeyup='this.value = this.value.toUpperCase();'/>
                                ...
                                <tr>
                                    ...
                                    <td style="width:30%;text-align:left;">
                                        <asp:TextBox ID="Txt_Ciudad_Empleado" runat="server" Width="98%" TabIndex="23" MaxLength="50" onkeyup='this.value = this.value.toUpperCase();'/>
                                    ...
                                    <td style="width:30%;text-align:left;">
                                        <asp:TextBox ID="Txt_Estado_Empleado" runat="server" Width="98%" TabIndex="24" MaxLength="50" onkeyup='this.value = this.value.toUpperCase();'/>
                                ...
                                <tr>
                                    ...
                                    <td style="width:30%;text-align:left;">
                                        <asp:TextBox ID="Txt_Telefono_Casa_Empleado" runat="server" Width="98%" TabIndex="25" MaxLength="20"/>
                                        <cc1:FilteredTextBoxExtender ID="FTE_Txt_Telefono_Casa_Empleado" runat="server"
                                            TargetControlID="Txt_Telefono_Casa_Empleado" FilterType="Numbers" 
                                            ValidChars="- " Enabled="True"/>
                                    </td>
                                    <td style="width:20%;text-align:left;">
                                        &nbsp;&nbsp;Celular
                                    ...
                                    <td style="width:30%;text-align:left;">
                                        <asp:TextBox ID="Txt_Celular_Empleado" runat="server" Width="98%" TabIndex="26" MaxLength="20"/>
                                        <cc1:FilteredTextBoxExtender ID="FTE_Txt_Celular_Empleado" runat="server"
                                            TargetControlID="Txt_Celular_Empleado" FilterType="Numbers" 
                                            ValidChars="- " Enabled="True"/>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td style="width:30%;text-align:left;">
                                        <asp:TextBox ID="Txt_Nextel_Empleado" runat="server" Width="98%" TabIndex="27" MaxLength="20"/>
                                    ...
                                    <td style="width:30%;text-align:left;">
                                        <asp:TextBox ID="Txt_Telefono_Oficina_Empleado" runat="server" Width="98%" TabIndex="28" MaxLength="20"/>
                                        <cc1:FilteredTextBoxExtender ID="FTE_Txt_Telefono_Oficina_Empleado" runat="server"
                                            TargetControlID="Txt_Telefono_Oficina_Empleado" FilterType="Numbers" 
                                            ValidChars="- " Enabled="True"/>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td style="width:20%;text-align:left;">
                                        <asp:TextBox ID="Txt_Extension_Empleado" runat="server" Width="98%" TabIndex="29" MaxLength="10"/>
                                    ...
                                    <td style="width:20%;text-align:left;">
                                        <asp:TextBox ID="Txt_Fax_Empleado" runat="server" Width="98%" TabIndex="30" MaxLength="20"/>
                                ...
                                <tr>
                                    ...
                                    <td colspan="3" style="width:80%;text-align:left;">
                                        <asp:TextBox ID="Txt_Correo_Electronico_Empleado" runat="server" Width="99.5%" TabIndex="31" MaxLength="100"/>
                        ...
                        <ContentTemplate>
                             <table style="width:100%;">
                                ...
                                <tr>    
                                    ...
                                    <td style="text-align:left;width:30%;">  
                                        <asp:TextBox ID="Txt_No_Tarjeta" runat="server" Width="98%" 
                                ...
                                <tr>    
                                    ...
                                    <td style="text-align:left;width:30%;">
                                        <asp:DropDownList ID="Cmb_Bancos" runat="server" Width="100%"/>                                                   
                                    </td>
                                    <td style="text-align:left;width:20%;">
                                        &nbsp;&nbsp;No Cuenta Bancaria
                                    </td>
                                ...
                                <tr>    
                                    ...
                                    <td style="text-align:left;width:30%;">
                                        <asp:TextBox ID="Txt_Fecha_Inicio" runat="server" Width="85%" onblur='this.value = this.value.toLowerCase();'/>
                                    ...
                                    <td style="text-align:left;width:30%;">
                                        <asp:TextBox ID="Txt_Fecha_Termino" runat="server" Width="85%" onblur='this.value = this.value.toLowerCase();'/>
                                ...
                                <tr>    
                                    ...
                                    <td style="text-align:left;width:30%;">  
                                        <asp:DropDownList ID="Cmb_Tipo_Finiquito" runat="server" Width="100%" />                                                                                                          
                                    </td>
                                    <td style="text-align:left;width:20%;">
                                        &nbsp;&nbsp;Fecha de Baja
                                    </td>
                                ...
                                <tr>    
                                    ...
                                    <td style="text-align:left;width:30%;">
                                        <asp:TextBox ID="Txt_Salario_Diario" runat="server" Width="81%" />
                                    ...
                                    <td style="text-align:left;width:30%;">
                                        <asp:TextBox ID="Txt_Salario_Diario_Integrado" runat="server" Width="98%"/>
                                ...
                                <tr>    
                                    ...
                                    <td style="text-align:left;width:30%;">
                                       <asp:TextBox ID="Txt_No_Licencia" runat="server" Width="98%" 
                                        onkeyup='this.value = this.value.toUpperCase();' MaxLength="20"/> 
                                ...
                                <tr>    
                                    ...
                                    <td style="text-align:left;width:30%;">
                                        <asp:TextBox ID="Txt_No_Seguro_Poliza_Empleado" MaxLength="20" runat="server" Width="98%" onkeyup='this.value = this.value.toUpperCase();'/>
                                    ...
                                    <td style="text-align:left;width:30%;">
                                        <asp:TextBox ID="Txt_Beneficiario_Empleado" MaxLength="100" runat="server" Width="98%" onkeyup='this.value = this.value.toUpperCase();'/>
