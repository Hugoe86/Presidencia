<%@ Page Language="C#" MasterPageFile="~/paginas/Paginas_Generales/MasterPage.master" AutoEventWireup="true" CodeFile="Frm_Cat_Nom_Historial_Vacaciones.aspx.cs" Inherits="paginas_Nomina_Frm_Cat_Nom_Historial_Vacaciones" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Cph_Area_Trabajo2" Runat="Server">
    ...
    <script src="../../javascript/Js_Busqueda_Empleados.js" type="text/javascript"></script>
</asp:Content>
   ...
   <table id="tabla_cabecera" width="830px"  border="0" cellspacing="0" class="estilo_fuente">
        <tr align="center">
            <td colspan="2" class="label_titulo">
                <br />Consultar Periodos Vacaciones<br /><br />
            </td>
        </tr>
    ...
    <table id="Tbl_Periodos_Vacacionales"></table>
