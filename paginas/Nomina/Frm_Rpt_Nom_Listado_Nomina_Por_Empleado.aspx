<%@ Page Language="C#" MasterPageFile="~/paginas/Paginas_Generales/MasterPage.master" AutoEventWireup="true" CodeFile="Frm_Rpt_Nom_Listado_Nomina_Por_Empleado.aspx.cs" Inherits="paginas_Nomina_Frm_Rpt_Nom_Listado_Nomina_Por_Empleado" Title="Untitled Page" %>
        ...
        <div style="width:98%; background-color:White;">
            ...
            <table width="100%">
                ...
                <tr>
                    ...
                    <td class="button_autorizar" style="width:30%; text-align:left; cursor:default;">
                        <asp:DropDownList ID="Cmb_Banco" runat="server" Width="100%"/>
                    </td>
                    <td class="button_autorizar" style="width:20%; text-align:left; cursor:default;">
                        Reporte
                    </td>
                    <td class="button_autorizar" style="width:30%; text-align:left; cursor:default;">
                         <asp:RadioButtonList ID="Rbl_Reporte" runat="server" >
                            <asp:ListItem Text="Reporte Nomina Por Empleado" Value="0" Selected="True"></asp:ListItem>
                            <asp:ListItem Text="Listado Nomina Por Empleado" Value="1"></asp:ListItem>
                        </asp:RadioButtonList>
                    </td>
                </tr>
            </table> 
