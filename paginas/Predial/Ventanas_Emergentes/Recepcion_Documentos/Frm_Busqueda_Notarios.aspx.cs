...
public partial class paginas_Predial_Ventanas_Emergentes_Recepcion_Documentos_Frm_Busqueda_Notarios : System.Web.UI.Page
{
    ...
    private void Cargar_Grid(int Page_Index)
    {
        ...
        try
        {
            ...
            {
                Int32 aux;
                Int32.TryParse(Txt_No_Notario.Text.Trim(), out aux);
                Notarios_Negocio.P_Notario_ID = String.Format("{0:00000}", aux);
            }
