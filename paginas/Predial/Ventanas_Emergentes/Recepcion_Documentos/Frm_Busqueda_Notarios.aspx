<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Frm_Busqueda_Notarios.aspx.cs" Inherits="paginas_Predial_Ventanas_Emergentes_Recepcion_Documentos_Frm_Busqueda_Notarios" %>
                            ...
                            <asp:Label ID="Lbl_Mensaje_Error" runat="server" Text="" CssClass="estilo_fuente_mensaje_error" />
                                    ...
                                    <tr>
                                        ...
                                        <td style="width:38%;text-align:left;font-size:11px;">
                                           ...
                                           <cc1:FilteredTextBoxExtender ID="Fte_Txt_Busqueda_No_Notaria" runat="server" FilterType="Numbers"
                                                TargetControlID="Txt_Numero_Notaria"/>
                                            <cc1:TextBoxWatermarkExtender ID="Twm_Txt_Busqueda_No_Notaria" runat="server" 
                                                TargetControlID ="Txt_Numero_Notaria" WatermarkText="Búsqueda por Nota&iacute;a" 
                                        ...
                                        <asp:TextBox ID="Txt_RFC" runat="server" Width="98%" MaxLength="15" />
                                            ...
                                            <cc1:TextBoxWatermarkExtender ID="Twm_Txt_Busqueda_RFC" runat="server" 
                                                ...
                                                WatermarkCssClass="watermarked"/>
                                            <asp:TextBox ID="Txt_No_Notario" runat="server" Width="98%" MaxLength="10" Visible="false"/>
                                            <cc1:FilteredTextBoxExtender ID="Fte_Txt_Busqueda_Numero_Notario" runat="server" 
                                                FilterType="Numbers, LowercaseLetters, UppercaseLetters" 
                                                TargetControlID="Txt_No_Notario"/>
                                            <cc1:TextBoxWatermarkExtender ID="Twe_Txt_Busqueda_Numero_Notario" runat="server" 
                                                TargetControlID ="Txt_No_Notario" WatermarkText="Búsqueda por No Notaria" 
                                                WatermarkCssClass="watermarked"/>
                                        </td>
                                    </tr>                                    
                                    <tr>
