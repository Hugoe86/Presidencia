...
public partial class paginas_Predial_Ventanas_Emergentes_Frm_Resumen_Predio : System.Web.UI.Page
{
    #region Variables
    ...
    {
        string Ventana_Modal = "Abrir_Ventana_Modal('Resumen_Predial/Frm_Convenio_Detalles_Pre_Resumen_Predial.aspx?No_Convenio=" + Grid_Convenios_Cuenta.SelectedRow.Cells[1].Text.Trim() + "', 'center:yes;resizable:no;status:no ;dialogWidth:680px;dialogHeight:400px;dialogHide:true;help:no;scroll:no ');";
    ...
    private void Cargar_Ventana_Emergente_Estado_Cuenta()
    {
        ...
        {
            string Ventana_Modal_Estado_Cuenta = "Abrir_Ventana_Estado_Cuenta('Resumen_Predial/Frm_Estado_Cuenta.aspx?Cuenta_Predial=" + Txt_Cuenta_Predial.Text.Trim() + "', 'height=600,width=800,scrollbars=1');";
    ...
    private void Cargar_Ventana_Emergente_Validacion_Orden_Variacion()
    {
        ...
        Parametros += "&Fecha_Orden_Variacion=" + DateTime.ParseExact(Grid_Historial_Movimientos.SelectedRow.Cells[3].Text, "dd/MM/yy", null).ToString("dd-MM-yyyy");
        ...
        ScriptManager.RegisterStartupScript(this, this.GetType(), "Validacion Orden Variacion", "window.showModalDialog('Resumen_Predial/Frm_Validacion_Orden_Variacion.aspx" + Parametros + ", null " + Propiedades, true);
    }
    ...
    protected void Bloquear_Controles()
    {
        ...
        Img_Btn_Imprimir_Estado_Cuenta.Enabled = false;
        Btn_Estado_Cuenta.Enabled = false;
    }
    ///******************************************************************************* 
    ...
    private void Cargar_Generales_Cuenta(DataTable dataTable)
    {
        ...
        try
        {
            ...
            if (!String.IsNullOrEmpty(dataTable.Rows[0][Cat_Pre_Cuentas_Predial.Campo_Cuota_Anual].ToString()))
            {
                ...
                Txt_Cuota_Bimestral_Impuestos.Text = "$ " + String.Format("{0:#,###,###.00}", Convert.ToDecimal(Cuota_Bimestral));
            }
    ...
    protected void Habilitar_Controles()
    {
        ...
        Img_Btn_Imprimir_Estado_Cuenta.Enabled = true;
    ...
    {
        var Rs_Consulta_Ope_Resumen_Predio = new Cls_Ope_Pre_Resumen_Predio_Negocio(); //Variable de conexión hacia la capa de Negocios
        ...
        {
            if (Dr_Movs[Ope_Pre_Ordenes_Variacion.Campo_Estatus_Orden].ToString().Trim() == "ACEPTADA" && Dr_Movs["ESTATUS_CONTRARECIBO"].ToString().Trim() != "PAGADO" && Dr_Movs["ESTATUS_CONTRARECIBO"].ToString().Trim() != "DIRECTA")
            {
        ...
        {
            if (Dt_Resumen_Predio_Movimientos.Rows[x][Ope_Pre_Ordenes_Variacion.Campo_Estatus_Orden].ToString().Trim() == "RECHAZADA" || Dt_Resumen_Predio_Movimientos.Rows[x][Ope_Pre_Ordenes_Variacion.Campo_Estatus_Orden].ToString().Trim() == "POR VALIDAR")
                pendientes = "true";
        ...
        for (int x = 0; x < Dt_Resumen_Predio_Movimientos.Rows.Count; x++)
        {
            if (Dt_Resumen_Predio_Movimientos.Rows[x][Ope_Pre_Ordenes_Variacion.Campo_Estatus_Orden].ToString().Trim() == "ACEPTADA" && Comparar_Estatus_Vigente == "True")
            {
                if (pendientes == "false")
                    ...
                    Dt_Resumen_Predio_Movimientos.Rows[x][Ope_Pre_Ordenes_Variacion.Campo_Estatus_Orden] = "BAJA_TEMPORAL";
    ...
    private void Cargar_Ventana_Emergente_Convenios_Traslado()
    {
        ...
        String Parametros = "?Cuenta_Predial_ID=" + Hdf_Cuenta_Predial_ID.Value;
        ...
        ScriptManager.RegisterStartupScript(this, this.GetType(), "Convenios de Traslado", "window.showModalDialog('Convenios/Frm_Convenios_Traslado.aspx" + Parametros + ", null " + Propiedades, true);
    }
    ...
    private void Cargar_Ventana_Emergente_Convenios_Predial()
    {
        ...
        String Propiedades = ", 'center:yes;resizable:yes;status:no;dialogWidth:680px;dialogHeight:800px;dialogHide:true;help:no;scroll:yes');";
        //Grid_Convenios_Cuenta.Attributes.Add("onclick", Ventana_Modal + Parametros + Propiedades);
        ScriptManager.RegisterStartupScript(this, this.GetType(), "Convenios de Traslado", "window.showModalDialog('Convenios/Frm_Convenios_Predial.aspx" + Parametros + ", null " + Propiedades, true);
    }
    ...
    private void Cargar_Ventana_Emergente_Convenios_Fraccionamientos()
    {
        ...
        String Propiedades = ", 'center:yes;resizable:yes;status:no;dialogWidth:680px;dialogHeight:800px;dialogHide:true;help:no;scroll:yes');";
        //Grid_Convenios_Cuenta.Attributes.Add("onclick", Ventana_Modal + Parametros + Propiedades);
        ScriptManager.RegisterStartupScript(this, this.GetType(), "Convenios de Traslado", "window.showModalDialog('Convenios/Frm_Convenios_Fraccionamiento.aspx" + Parametros + ", null " + Propiedades, true);
    }
    ...
    private void Cargar_Ventana_Emergente_Convenios_Derechos_Supervision()
    {
        ...
        String Propiedades = ", 'center:yes;resizable:yes;status:no;dialogWidth:680px;dialogHeight:800px;dialogHide:true;help:no;scroll:yes');";
        //Grid_Convenios_Cuenta.Attributes.Add("onclick", Ventana_Modal + Parametros + Propiedades);
        ScriptManager.RegisterStartupScript(this, this.GetType(), "Convenios de Traslado", "window.showModalDialog('Convenios/Frm_Convenios_Derechos_Supervision.aspx" + Parametros + ", null " + Propiedades, true);
    }
    ...
    protected void Img_Btn_Imprimir_Historial_Movimientos_Click(object sender, ImageClickEventArgs e)
    {
        ...
        //instacia la clase de negocio
        var Rs_Consulta_Ope_Resumen_Predio = new Cls_Ope_Pre_Resumen_Predio_Negocio(); //Variable de conexión hacia la capa de Negocios
        var Resumen_Predio_Historial_Movimientos = new Ds_Pre_Resumen_Predio_Generales();
        try
        {
            Rs_Consulta_Ope_Resumen_Predio.P_Cuenta_Predial = Txt_Cuenta_Predial.Text.Trim();
            DataTable Dt_Resumen_Predio_Movimientos = Rs_Consulta_Ope_Resumen_Predio.Consultar_Historial_Movimientos();
