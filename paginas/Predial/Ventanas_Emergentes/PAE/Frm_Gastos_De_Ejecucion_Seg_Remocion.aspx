<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Frm_Gastos_De_Ejecucion_Seg_Remocion.aspx.cs" Inherits="paginas_Predial_Ventanas_Emergentes_PAE_Frm_Gastos_De_Ejecucion_Seg_Remocion" Culture="es-MX" %>
                ...
                <asp:Panel ID="Pnl_Gastos" runat="server" Width="99%" Height="99%">
                   ...
                   <%----------------------------------- Notifiaciones---------------------------------------------------------%>
                    ...
                    <%----------------------------------- Depositarios ---------------------------------------------------------%>
                        <tr>
                            <td>
                                <asp:Label ID="Lbl_Figura" runat="server" Text="Figura" />
                            </td>
                            <td colspan="3">
                                <asp:DropDownList ID="Cmb_Depositario" runat="server" TabIndex="7" Width="99%">
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td>
                                <asp:Label ID="Lbl_Domicilio" runat="server" Text="Domicilio" />
                            </td>
                            <td colspan="3">
                        ...
                        <tr>
                            <td colspan="4" style="text-align:right;" align="right">
                                <asp:ImageButton ID="Btn_Agregar_Depositario" runat="server" Height="20px" 
                                    ImageUrl="~/paginas/imagenes/paginas/sias_add.png" 
                                     TabIndex="10" 
                                    ToolTip="Agregar Costo" Width="20px" 
                                    onclick="Btn_Agregar_Depositario_Click" />
                            </td>                                    
                        </tr>
                        <tr>
                            <td colspan="4" align="right">
                                <asp:GridView ID="Grid_Cambio_Depositario" runat="server" AllowPaging="True" 
                                    AllowSorting="True" AutoGenerateColumns="False" HeaderStyle-CssClass="tblHead" 
                                    
                                    PageSize="2" Style="white-space: normal;" Width="100%" 
                                    onselectedindexchanged="Grid_Cambio_Depositario_SelectedIndexChanged" 
                                    onpageindexchanging="Grid_Cambio_Depositario_PageIndexChanging">
                                    <Columns>
                                        <asp:BoundField DataField="DEPOSITARIO" HeaderText="Depositario">
                                            <ItemStyle HorizontalAlign="Center" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="NOMBRE" HeaderText="Nombre">
                                            <ItemStyle HorizontalAlign="Center" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="DOMICILIO" HeaderText="Direccion">
                                            <ItemStyle HorizontalAlign="Center" />
                                        </asp:BoundField>
                                        <asp:TemplateField>
                                            <ItemTemplate>
                                                <asp:ImageButton ID="Btn_Eliminar_Costo1" runat="server" CommandName="Select" 
                                                    Height="20px" ImageUrl="~/paginas/imagenes/paginas/delete.png" TabIndex="10" 
                                                    ToolTip="Eliminar" Width="20px" />
                                            </ItemTemplate>
                                            <HeaderStyle Width="2%" />
                                        </asp:TemplateField>
