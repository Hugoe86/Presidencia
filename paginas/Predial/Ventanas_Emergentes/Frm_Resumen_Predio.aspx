<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Frm_Resumen_Predio.aspx.cs"
    Inherits="paginas_Predial_Ventanas_Emergentes_Frm_Resumen_Predio" %>
...
<body>
    ...
    <div>
        ...
        <table width="98%" class="estilo_fuente">
            ...
            <tr style="background-color: #36C;">
                <td style="text-align: left; font-size: 15px; color: #FFF;" colspan="4">
                    <asp:ImageButton ID="Img_Btn_Imprimir_Estado_Cuenta" runat="server" ImageUrl="../../imagenes/gridview/grid_print.png"
                        Style="vertical-align: top; float: right;" Height="18px" CausesValidation="false"
                        OnClick="Img_Btn_Imprimir_Estado_Cuenta_Click" />
                    Estado de cuenta
