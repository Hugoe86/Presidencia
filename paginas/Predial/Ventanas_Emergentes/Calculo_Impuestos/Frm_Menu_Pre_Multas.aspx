<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Frm_Menu_Pre_Multas.aspx.cs" Inherits="paginas_Predial_Ventanas_Emergentes_Calculo_Impuestos_Frm_Menu_Pre_Tasas_Traslado_Dominio" %>
            ...
            <tr >
                ...
                <td>
                    <asp:GridView runat="server" AllowPaging="True" AutoGenerateColumns="False" 
                        GridLines="None" CssClass="GridView_1" Width="100%" ID="Grid_Multas" 
                        onselectedindexchanged="Grid_Multas_SelectedIndexChanged" 
                        onpageindexchanging="Grid_Multas_PageIndexChanging" >
                        <AlternatingRowStyle CssClass="GridAltItem"></AlternatingRowStyle>
                        <Columns>
                            <asp:ButtonField CommandName="Select" ImageUrl="~/paginas/imagenes/gridview/blue_button.png" ButtonType="Image">
                                <ItemStyle Width="30px"></ItemStyle>
                            </asp:ButtonField>
                            <asp:BoundField DataField="MULTA_ID" HeaderText="Multa_ID" 
                                SortExpression="MULTA_ID" Visible="false" >
                            ...
                            <asp:BoundField DataField="MULTA_CUOTA_ID" 
                                HeaderText="Multa_Cuota_ID" SortExpression="MULTA_CUOTA_ID" Visible="false" >
                                <FooterStyle Font-Size="0pt" Width="0px" />
                                <HeaderStyle Font-Size="0pt" Width="0px" />
                                <ItemStyle Font-Size="0pt" Width="0px" />
                            </asp:BoundField>
