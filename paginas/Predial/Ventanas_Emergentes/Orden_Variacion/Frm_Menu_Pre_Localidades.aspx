<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Frm_Menu_Pre_Localidades.aspx.cs" Inherits="paginas_Predial_Ventanas_Emergentes_Orden_Variacion_Frm_Menu_Pre_Localidades" %>
...
<body>
    <form id="Frm_Menu_Pre_Localidades" method="post" runat="server">
            ...
            <tr >
                ...
                <td>
                    <asp:GridView runat="server" AllowPaging="True" AutoGenerateColumns="False" 
                        GridLines="None" CssClass="GridView_1" Width="100%" ID="Grid_Colonias" onpageindexchanging="Grid_Localidades_PageIndexChanging" 
                        onselectedindexchanged="Grid_Localidades_SelectedIndexChanged" >
                        <AlternatingRowStyle CssClass="GridAltItem"></AlternatingRowStyle>
                        <Columns>
                            <asp:ButtonField CommandName="Select" ImageUrl="~/paginas/imagenes/gridview/blue_button.png" ButtonType="Image">
                                <ItemStyle Width="30px"></ItemStyle>
                            </asp:ButtonField>
                            <asp:BoundField DataField="LOCALIDAD_ID" HeaderText="Localidad_ID" 
                                SortExpression="LOCALIDAD_ID">
