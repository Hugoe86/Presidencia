<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Frm_Reporte_Cuentas_Excluidas.aspx.cs" Inherits="paginas_Predial_Ventanas_Emergentes_Frm_Reporte_Cuentas_Excluidas" %>
        ...
        <table  style="width:98%;" border="0" cellspacing="0" class="estilo_fuente">
            ...
            <tr class="barra_busqueda">
                ...
                <td align="left">
                    <asp:ImageButton ID="Btn_Exportar_Excel" runat="server" 
                        ToolTip="Exportar a Excel" CssClass="Img_Button" TabIndex="1"
            ...
            <tr >
                <td class="style2">
                    &nbsp;</td>
                <td>
                    <asp:GridView ID="Grid_Cuentas_Excluidas"  runat="server" 
