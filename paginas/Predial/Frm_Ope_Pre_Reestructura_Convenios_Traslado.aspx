<%@ Page Title="" Language="C#" MasterPageFile="~/paginas/Paginas_Generales/MasterPage.master"
    AutoEventWireup="true" CodeFile="Frm_Ope_Pre_Reestructura_Convenios_Traslado.aspx.cs"
    Inherits="paginas_Predial_Frm_Ope_Pre_Reestructura_Convenios_Traslado" %>
                ...
                <table width="100%" class="estilo_fuente">
                    <tr align="center">
                        <td class="label_titulo">
                            Reestructura de Convenios al Impuesto por Traslado
                        </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <%--<tr>
                        <td style="text-align:left;" colspan="4">
                            <asp:GridView ID="Grid_Contrarecibos_Pendientes" runat="server" 
                                ...
                                DataKeyNames="CUENTA_PREDIAL_ID" HeaderStyle-CssClass="tblHead" 
                                onpageindexchanging="Grid_Contrarecibos_Pendientes_PageIndexChanging" 
                                onselectedindexchanged="Grid_Contrarecibos_Pendientes_SelectedIndexChanged" 
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="FECHA_CALCULO" DataFormatString="{0:d-MMM-yyyy}" 
                                        HeaderText="Fecha">
                                        <ItemStyle HorizontalAlign="Center" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="MONTO_RECARGOS" DataFormatString="{0:c2}" 
                                        HeaderText="Recargos">
                                        <ItemStyle HorizontalAlign="Right" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="DESC_RECARGO" DataFormatString="{0:c2}" 
                                        HeaderText="Descuento Recargos">
                                        <ItemStyle HorizontalAlign="Right" />
                                        <ItemStyle HorizontalAlign="Center" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="MONTO_MULTA" DataFormatString="{0:c2}" 
                                        HeaderText="Multas">
                                        <ItemStyle HorizontalAlign="Right" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="DESC_MULTA" DataFormatString="{0:c2}" 
                                        HeaderText="Descuento Multas">
                                        <ItemStyle HorizontalAlign="Right" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="MONTO_TOTAL_CALCULO" DataFormatString="{0:c2}" 
                                        HeaderText="Importe">
                                        <ItemStyle HorizontalAlign="Right" />
                                    </asp:BoundField>
                    ...
                    <tr>
                        <td colspan="4" style="text-align: left;">
                            <asp:GridView ID="Grid_Convenios_Impuestos_Traslado" runat="server" AutoGenerateColumns="False"
                                ...
                                OnPageIndexChanging="Grid_Convenios_Impuestos_Traslados_PageIndexChanging" OnSelectedIndexChanged="Grid_Convenios_Impuestos_Traslados_SelectedIndexChanged"
                                Style="white-space: normal;" Width="100%">
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="NO_REESTRUCTURA" HeaderText="No. reestructura8" Visible="false" />
                                    ...
                                    <asp:BoundField DataField="ANIO" HeaderText="Anio11" Visible="False">
                                        <ItemStyle HorizontalAlign="Center" />
                                    </asp:BoundField>
                                </Columns>
                                <SelectedRowStyle CssClass="GridSelected" />
                        ...
                        <tr>
                            ...
                            <td style="text-align: left; width: 30%;">
                                <asp:TextBox ID="Txt_Descuento_Multas" runat="server" Width="96.4%" AutoPostBack="True"
                                    OnTextChanged="Txt_Descuento_Multas_TextChanged" Visible="false" />
                            </td>
                            ...
                            <td colspan="4">
                                ...
                                <asp:GridView ID="Grid_Parcialidades" runat="server" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="MONTO_IMPUESTO" DataFormatString="{0:c2}" HeaderText="Impuesto Traslado">
                                            <FooterStyle Font-Bold="True" HorizontalAlign="Right" />
                                            <ItemStyle HorizontalAlign="Right" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="MONTO_IMPUESTO_DIVISION" DataFormatString="{0:c2}" HeaderText="Impuesto División">
                                            <FooterStyle Font-Bold="True" HorizontalAlign="Right" />
                                            <ItemStyle HorizontalAlign="Right" />
                                        </asp:BoundField>
