...
public partial class paginas_Predial_Frm_Ope_Pre_PAE_Embargos : System.Web.UI.Page
{
    #region PageLoad
    ...
    private void Limpiar_Formulario()
    {
        ...
        Grid_Embargos_Generadas.DataSource = null;
    ...
    ///******************************************************************************* 
    ///NOMBRE DE LA FUNCIÓN : Crea_Tabla_Listas_Para_Embargar
    ...
    ///CAUSA_MODIFICACIÓN:
    ///*******************************************************************************
    protected DataTable Crea_Tabla_Listas_Para_Embargar()
    {
    ...
    ///******************************************************************************* 
    ///NOMBRE DE LA FUNCIÓN : Llenar_DataRow_A_Embargar
    ...
    ///CAUSA_MODIFICACIÓN:
    ///*******************************************************************************
    protected void Llenar_DataRow_A_Embargar(DataTable Dt_Generadas, DataTable Dt_Busqueda_ID, int Contador, Cls_Ope_Pre_Generar_Adeudo_Predial_Negocio Rs_Consulta_Adeudos)
    {
    ...
    ///******************************************************************************* 
    ///NOMBRE DE LA FUNCIÓN : Llenar_DataRow_Embargos
    ///DESCRIPCIÓN          : Agrega una nueva fila a las cuentas omitidas y Calcula el Perido, Rezago, etc
    ///PARAMETROS: 
    ///CREO                 : Armando Zavala Moreno
    ...
    /// CAUSA_MODIFICACIÓN: 
    ///*******************************************************************************************************
    public void Calcula_Adeudos_A_Embargar(Cls_Ope_Pre_Generar_Adeudo_Predial_Negocio Rs_Consulta_Adeudos, DataTable Dt_Busqueda_Cuentas, DataTable Dt_Cuentas, int Contador,Boolean Omitir)
    {
        try
        {
            ...
            if (Rs_Consulta_Adeudos.p_Total_Rezago > 1)
            {
                ...
                {
                    Llenar_DataRow_A_Embargar(Dt_Cuentas, Dt_Busqueda_Cuentas, Contador, Rs_Consulta_Adeudos);
                }
            }
        }
        catch (Exception ex)
    ...
    ///******************************************************************************* 
    ///NOMBRE DE LA FUNCIÓN: Regresa_Cuentas_Embargar_y_Omitir
    ...
    ///CAUSA_MODIFICACIÓN:
    ///*******************************************************************************
    private void Regresa_Cuentas_Embargar_y_Omitir()
    {
        ...
        DataTable Dt_Listas_Embargo = Crea_Tabla_Listas_Para_Embargar();//Tabla para Cuentas A Embargar
        ...
        try
        {
            ...
            Rs_Consulta_Etapas.P_Proceso_Actual = "REQUERIMIENTO";//Filtro cuentas en proceso de requerimiento
            ...
            else
            {
                if (Cmb_Despacho_Filtro.SelectedIndex > 1)
                {
                    Rs_Consulta_Etapas.P_Despacho_Id = Cmb_Despacho_Filtro.SelectedValue;
                }
                ...
                if (Dt_Pae_Etapas != null)
                {
                                    ...
                                    if (Dt_Busqueda_Cuentas.Rows[Contador][0].ToString() != "")
                                    {
                                        ...
                                        if (Fecha_Notificacion != null && Fecha_Notificacion != "")
                                        {
                                            ...
                                            if (Dias_Transcurridos.Days > 5)
                                            {
                                                ...
                                                {   //Cuentas a Embargar
                                                    Calcula_Adeudos_A_Embargar(Rs_Consulta_Adeudos, Dt_Busqueda_Cuentas, Dt_Listas_Embargo, Contador, false);
                                                }
                                                else//Cuentas Omitidas
                                                {
                                                    Calcula_Adeudos_A_Embargar(Rs_Consulta_Adeudos, Dt_Busqueda_Cuentas, Dt_Omitida, Contador, true);
                                                }
                                            }
                                        }
                                    }
                    ...
                    Grid_Cuentas_Generar.DataSource = Dt_Listas_Embargo;
                    Grid_Cuentas_Generar.DataBind();
                    Session["Grid_Determinar"] = Dt_Listas_Embargo;//Mantiene el DataTable para hacer la paginacion del Grid
                    Txt_Adeudo_Determinar.Text = Dt_Listas_Embargo.Rows.Count.ToString();
                    ...
                    if (Dt_Listas_Embargo.Rows.Count < 1 && Dt_Omitida.Rows.Count < 1)
                    {
            ...
            if (Dt_Generadas != null || Dt_Omitida != null)
            {
                ...
                if (Dt_Generadas != null)
                {
                    for (int Conta_Generadas = 0; Conta_Generadas < Dt_Generadas.Rows.Count; Conta_Generadas++)
                    {
                        ...
                        Actualizar_Cuentas.P_Proceso_Actual = "EMBARGO";
                        Actualizar_Cuentas.P_Proceso_Anterior = "REQUERIMIENTO";
                ...
                if (Dt_Omitida != null)
                {
                    for (int Cuenta_Omitida = 0; Cuenta_Omitida < Dt_Omitida.Rows.Count; Cuenta_Omitida++)
                    {
                        ...
                        Actualizar_Cuentas.P_Proceso_Actual = "EMBARGO";
                        Actualizar_Cuentas.P_Proceso_Anterior = "REQUERIMIENTO";
                        Actualizar_Cuentas.P_Motivo_Omision = Dt_Omitida.Rows[Cuenta_Omitida]["MOTIVO_OMISIÓN"].ToString();
                        Actualizar_Cuentas.P_Estatus = "PENDIENTE";
    ...
    protected void Btn_Nuevo_Click(object sender, ImageClickEventArgs e)
    {
        try
        {
            ...
            if (Btn_Nuevo.AlternateText == "Nuevo")
            {
                ...
                Grid_Embargos_Generadas.DataBind();
            }
            else
            {
    ...
    protected void Btn_Imprimir_Click(object sender, ImageClickEventArgs e)
    {
        ...
        {
            Limpia_Mensaje_Error();
            Regresa_Cuentas_Embargar_y_Omitir();
        }
        else
        {
        }
    ...
    ///******************************************************************************* 
    ///NOMBRE DE LA FUNCIÓN : Btn_Buscar_Embargos_Click
    ...
    ///CAUSA_MODIFICACIÓN:
    ///*******************************************************************************
    protected void Btn_Buscar_Embargos_Click(object sender, ImageClickEventArgs e)
    {
        ...
        try
        {
            ...
            if (Comprobacion_Termida != true)
            {
                ...
                Grid_Embargos_Generadas.DataSource = Dt_Embargos_Generados;
                Grid_Embargos_Generadas.DataBind();
                Session["Grid_Embargos_Generadas"] = Dt_Embargos_Generados;
    ...
    ///CAUSA_MODIFICACIÓN:
    ///*******************************************************************************
    protected void Grid_Embargos_Generadas_PageIndexChanging(object sender, GridViewPageEventArgs e)
    {
        try
        {
            Grid_Embargos_Generadas.PageIndex = e.NewPageIndex;
            Grid_Embargos_Generadas.DataSource = Session["Grid_Embargos_Generadas"];
            Grid_Embargos_Generadas.DataBind();
        }
        catch (Exception Ex)
        {
