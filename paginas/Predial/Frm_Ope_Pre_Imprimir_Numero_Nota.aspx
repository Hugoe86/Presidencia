<%@ Page Title="" Language="C#" MasterPageFile="~/paginas/Paginas_Generales/MasterPage.master"
    AutoEventWireup="true" CodeFile="Frm_Ope_Pre_Imprimir_Numero_Nota.aspx.cs" Inherits="paginas_Predial_Frm_Ope_Pre_Imprimir_Numero_Nota" %>
                ...
                <table width="100%" class="estilo_fuente">
                    <tr align="center">
                        <td colspan="4" class="label_titulo">
                            Órdenes de variación por imprimir número de nota
                        </td>
                    </tr>
                    <tr>
                        <td colspan="4">
                ...
                <table width="98%" class="estilo_fuente">
                    ...
                    <tr style="background-color: #36C;">
                        <td style="text-align: left; font-size: 15px; color: #FFF;" colspan="4">
                            Ordenes de variación por imprimir número de nota
                        </td>
                    </tr>
                    <tr align="center">
                        <td colspan="4">
                            <asp:GridView ID="Grid" runat="server" AllowPaging="True" CssClass="GridView_1" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="CUENTA" HeaderText="No. Nota" Visible="True">
                    ...
                    <tr>
                        ...
                        <td style="text-align: left; width: 30%;">
                            <asp:TextBox ID="TextBox2" runat="server" Width="96.4%" />
                        </td>
                        <td style="text-align: left; width: 20%; text-align: right;">
                            Superficie Total (m&sup2;)
                        </td>
                        <td style="text-align: left; width: 30%;">
                            <asp:TextBox ID="TextBox3" runat="server" Width="96.4%" />
                        </td>
                    </tr>
                    <tr>
                        <td style="text-align: left; width: 20%;">
                    ...
                    <tr>
                        ...
                        <td style="text-align: left; width: 30%;">
                            <asp:TextBox ID="TextBox55" runat="server" Width="96.4%" />
                        </td>
                        <td style="text-align: left; width: 20%; text-align: right;">
                            Hasta periodo
                        </td>
