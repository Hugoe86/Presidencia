<%@ Page Language="C#" MasterPageFile="~/paginas/Paginas_Generales/MasterPage.master" AutoEventWireup="true" CodeFile="Frm_Ope_Pre_Certificaciones.aspx.cs" Inherits="paginas_predial_Frm_Ope_Pre_Certificaciones" Title="Certificaciones" Culture="auto" UICulture="auto"%>
...
function Abrir_Resumen(Url, Propiedades) {
    ...
    <asp:ScriptManager ID="ScptM_Contribuyentes" runat="server" EnableScriptGlobalization="true" EnableScriptLocalization="true" />
        ...
        <ContentTemplate>
            ...
            <div id="Div_Requisitos" style="background-color:#ffffff; width:100%; height:100%;">
                <table width="98%"  border="0" cellspacing="0" class="estilo_fuente">
                    <tr align="center">
                        <td class="label_titulo" colspan="2">Certificaciones</td>
                    </tr>
                    <tr>
                        <td>
                ...
                <table width="98%" class="estilo_fuente">
                    <tr>
                        ...
                        <td style="text-align:left;width:10%;text-align:right; ">
                            <asp:ImageButton ID="Btn_Mostrar_Busqueda_Avanzada" runat="server" 
                                Height="24px" ImageUrl="~/paginas/imagenes/paginas/Busqueda_00001.png" TabIndex="10" 
                                ToolTip="Búsqueda Avanzada de Cuenta Predial" Width="24px" 
                                onclick="Btn_Mostrar_Busqueda_Avanzada_Click" />
                            <asp:ImageButton ID="Btn_Detalles_Certificaciones" runat="server" Height="24px" 
                                ImageUrl="~/paginas/imagenes/paginas/icono_consultar.png" TabIndex="10" 
                    ...
                    <tr>
                        ...
                        <td style="text-align:left;" colspan="4">
                            <asp:DropDownList ID="Cmb_Tipos_Documentos" runat="server" Width="100%">
                                <asp:ListItem Text="&lt;SELECCIONE&gt;" Value="SELECCIONE" />
                                <asp:ListItem Text="POR PAGAR" Value="POR PAGAR" />
                                <asp:ListItem Text="PAGADA" Value="PAGADA" />
                    ...
                    <tr>
                        ...
                        <td colspan="4" style="text-align:left;width:80%;">
                            <asp:TextBox ID="Txt_Propietario" runat="server" TabIndex="10" MaxLength="250"
                                TextMode="SingleLine" Width="98.6%" AutoPostBack="True"/>
                        </td>
                    </tr>
                    <tr>
                    <td>Calle</td>
                    <td><asp:TextBox ID="Txt_Calle" runat="server" ReadOnly="True" Width="96.4%"/></td>
                    <td></td>
                    <td align="right">Colonia</td>
                    <td><asp:TextBox ID="Txt_Colonia" runat="server" ReadOnly="True" Width="96.4%"/></td>
                    </tr>
                    <tr>
                    <td>No. exterior</td>
                    <td colspan="4"><asp:TextBox ID="Txt_No_Exterior" runat="server" ReadOnly="True" Width="98.6%"/></td>
                    <td></td>
                    </tr>
                    <tr>
                    <td align="left">No. interior</td>
                    <td colspan="4"><asp:TextBox ID="Txt_No_Interior" runat="server" ReadOnly="True" Width="98.6%"/></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td colspan="4" style="text-align:left;width:80%;">
                            <asp:TextBox ID="Txt_Observaciones" runat="server" style="text-transform:uppercase" 
                                MaxLength="250" TabIndex="10" TextMode="MultiLine" Width="98.6%" />
                    ...
                    <tr>
                        ...
                        <td colspan="4" style="text-align:left;width:80%;">
                            <asp:TextBox ID="Txt_Confronto" runat="server" AutoPostBack="True" 
                                MaxLength="250" TabIndex="10" TextMode="SingleLine" Width="98.6%" />
                        </td>
                    </tr>
                    <tr>
                        <td style="text-align:left;width:20%;">
                        ...
                        <td style="text-align:left;width:5%;text-align:right;">
                            &nbsp;</td>
                    ...
                    <td style="text-align:left;width:20%;" >
                            ...
                            <cc1:TextBoxWatermarkExtender ID="TBWE_Txt_Fecha" runat="server" 
                                TargetControlID="Txt_Fecha" WatermarkCssClass="watermarked" 
                                WatermarkText="Dia/Mes/Año" Enabled="True"/>
                            <cc1:CalendarExtender runat="server" ID ="CE_Txt_Fecha" Format = "dd/MM/yyyy" TargetControlID="Txt_Fecha"  Enabled="True" PopupButtonID="Img_Calendario"/> 
                        </td>
                    </tr>
                    <tr>
                        <td style="text-align:left;width:20%;">
                        ...
                        <td style="text-align:left;width:30%;">
                            <asp:TextBox ID="Txt_No_Recibo_Pago" runat="server" 
                                Width="96.4%"/>
                        </td>
                        <td style="text-align:left;width:5%;text-align:right;">
                            &nbsp;</td>
                       <td style="text-align:right;width:30%;">
                        ...
                        <td>
                            ...
                            <cc1:TextBoxWatermarkExtender ID="TextBoxWatermarkExtender2" runat="server" 
                                TargetControlID="Txt_Fecha_Vencimiento" WatermarkCssClass="watermarked" 
                                WatermarkText="Dia/Mes/Año" Enabled="True"/>
                        </td>
                    </tr>
                    ...
                    <caption>
                        ...
                        <tr align="center">
                            <td colspan="5">
                                <br />
                                <asp:GridView ID="Grid_Certificaciones" runat="server" AllowPaging="True" 
                                    AutoGenerateColumns="False" CssClass="GridView_1" 
                                    HeaderStyle-CssClass="tblHead" PageSize="5" style="white-space:normal;" 
                                    Width="100%" 
                                    onpageindexchanging="Grid_Certificaciones_PageIndexChanging" 
                                    onselectedindexchanged="Grid_Certificaciones_SelectedIndexChanged" 
                                    onrowcommand="Grid_Certificaciones_RowCommand" 
                                    onrowdatabound="Grid_Certificaciones_RowDataBound">
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="Nombre_Documento" HeaderText="Tipo documento" 
                                        ...
                                        <asp:ButtonField ButtonType="Image" CommandName="Print" 
