...
public partial class paginas_Predial_Frm_Ope_Pre_Convenios_Predial : System.Web.UI.Page
{
    ...
    ///DESCRIPCIÓN          : Establece el evento onclik del control para abrir la ventana emergente del Resumen de Predial con la ruta y parámetros necesarios
    ///PARAMETROS: 
    ///CREO                 : Antonio Salvador Benavides Guardado
    ///FECHA_CREO           : 21/Otubre/2011
    ///MODIFICO: 
    ...
    private void Inicializa_Controles()
    {
        try
        {
            ...
            Btn_Ocultar_Ordenes_Pendientes_Click(null, null);
        ...
        try
        {
            ...
            switch (Operacion)
            {
                case "Inicial":
                    ...
                    Btn_Mostrar_Ordenes_Pendientes.Enabled = false;
                ...
                case "Nuevo":
                    ...
                    Btn_Mostrar_Ordenes_Pendientes.Enabled = true;
                    break;
            ...
            Btn_Mostrar_Busqueda_Avanzada_Cuentas_Predial.Enabled = Habilitado;
    ...
    private void Cargar_Grid_Convenios(Int32 Pagina)
    {
        ...
        try
        {
            ...
            if (Txt_Busqueda.Text.Trim() != "")
            {
                ...
                Convenios_Predial.P_Filtros_Dinamicos += " OR 'CPRE' || TO_NUMBER(" + Ope_Pre_Convenios_Predial.Campo_No_Convenio
                    + ") LIKE '" + Txt_Busqueda.Text.Trim().ToUpper() + "')";
            ...
            Convenios_Predial.P_Campos_Dinamicos = Ope_Pre_Convenios_Predial.Campo_No_Convenio + ", ";
            Convenios_Predial.P_Campos_Dinamicos += Ope_Pre_Convenios_Predial.Campo_Cuenta_Predial_Id + ", ";
            Convenios_Predial.P_Campos_Dinamicos += Ope_Pre_Convenios_Predial.Campo_Contribuyente_Id + ", ";
            Convenios_Predial.P_Campos_Dinamicos += Ope_Pre_Convenios_Predial.Campo_Realizo + ", ";
            Convenios_Predial.P_Campos_Dinamicos += Ope_Pre_Convenios_Predial.Campo_Estatus + ", ";
            Convenios_Predial.P_Campos_Dinamicos += Ope_Pre_Convenios_Predial.Campo_Fecha + ", ";
            Convenios_Predial.P_Campos_Dinamicos += Ope_Pre_Convenios_Predial.Campo_No_Reestructura + ", ";
            Convenios_Predial.P_Campos_Dinamicos += Ope_Pre_Convenios_Predial.Campo_Anticipo + ", ";
            Convenios_Predial.P_Campos_Dinamicos += Ope_Pre_Convenios_Predial.Campo_Periodicidad_Pago + ", 'CPRE' || TO_NUMBER(";
            Convenios_Predial.P_Campos_Dinamicos += Ope_Pre_Convenios_Predial.Campo_No_Convenio + ") FOLIO_CONVENIO";
            ...
            if (Dt_Convenios_Predial != null)
            {
                ...
                Grid_Convenios.Columns[9].Visible = true;
                Dt_Convenios_Predial.DefaultView.RowFilter = "ESTATUS IN " + Cmb_Busqueda_General.SelectedValue;
                ...
                Grid_Convenios.Columns[9].Visible = false;

                Session.Remove("Dt_Convenios_Predial");
                Session["Dt_Convenios_Predial"] = Dt_Convenios_Predial;
            }
        }
        catch (Exception Ex)
        {
    ...
    ///*******************************************************************************************************
    /// NOMBRE_FUNCIÓN: Grid_Ordenes_Variacion_PageIndexChanging
    /// DESCRIPCIÓN: Maneja el evento cambio de pagina del grid ordenes_variacion, 
    ///             manda llamar al método que carga el grid en la pagina seleccionada
    /// PARÁMETROS:
    /// 		1. sender
    /// 		2. e
    /// CREO: Roberto González Oseguera
    /// FECHA_CREO: 03-nov-2011
    /// MODIFICÓ: 
    /// FECHA_MODIFICÓ: 
    /// CAUSA_MODIFICACIÓN: 
    ///*******************************************************************************************************
    ...
    protected void Grid_Ordenes_Variacion_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        try
        {
            if (Grid_Ordenes_Variacion.SelectedRow.Cells[0].Text != ""
                && Int32.TryParse(Grid_Ordenes_Variacion.SelectedRow.Cells[6].Text, out Anio_Orden))
            {
                Aplicar_Datos_Variacion(
                    Grid_Ordenes_Variacion.SelectedRow.Cells[0].Text,
                    Anio_Orden,
                    Grid_Ordenes_Variacion.SelectedRow.Cells[7].Text
                    );

                Consultar_Datos_Cuenta_Predial();

                // volver a consultar con los datos aplicados
    ...
    ///*******************************************************************************************************
    /// NOMBRE_FUNCIÓN: Aplicar_Variacion
    /// DESCRIPCIÓN: Aplicar la orden de variacion que se recibe como parámetro
    /// PARÁMETROS:
    /// 		1. Numero_Orden: Numero de orden de variacion a aplicar
    /// 		2. Anio: Año de la orden de variacion
    /// CREO: Roberto González Oseguera
    /// FECHA_CREO: 03-nov-2011
    /// MODIFICÓ: 
    /// FECHA_MODIFICÓ: 
    /// CAUSA_MODIFICACIÓN: 
    ///*******************************************************************************************************
    private void Aplicar_Datos_Variacion(String Numero_Orden, Int32 Anio, String Numero_Contrarecibo)
    {
        ...
        Orden_Variacion.P_Generar_Orden_Anio = Anio.ToString();
        Orden_Variacion.P_Cmmd = Cmd;

        Dt_Orden_Variacion = Orden_Variacion.Consultar_Ordenes_Variacion();

        if (Aplicar_Variacion(ref Cmd, Numero_Orden, Anio.ToString()))
        {
            Orden_Variacion.P_Año = Anio;
            ...
            Orden_Variacion.P_Observaciones_Año = Convert.ToInt32(Grid_Ordenes_Variacion.SelectedRow.Cells[6].Text);
            Orden_Variacion.P_Observaciones_Descripcion = "APLICACION TEMPORAL DESDE CONVENIO DE PREDIAL";
            Orden_Variacion.P_Observaciones_Usuraio = Orden_Variacion.P_Usuario;
            Orden_Variacion.Insertar_Observaciones_Variacion();


            if (Numero_Contrarecibo != "")
            {
                Orden_Variacion.P_Contrarecibo_No_Contrarecibo = Numero_Contrarecibo;
                Orden_Variacion.P_Contrarecibo_Anio = (short)Anio;
                Orden_Variacion.P_Contrarecibo_Estatus = "APLICADO";
        ...
        AjaxControlToolkit.ToolkitScriptManager.RegisterStartupScript(this, this.GetType(), "Convenios de predial",
                                            "alert('La Orden fue aplicada');", true);
    ...
    ///*******************************************************************************************************
    /// NOMBRE_FUNCIÓN: Cargar_Grid_Ordenes_Variacion
    /// DESCRIPCIÓN: Consulta las órdenes de variación de la cuenta y las carga en el grid 
    ///             ordenes_vairacion en la página que llega como parámetro
    /// PARÁMETROS:
    /// 		1. Pagina: numero entero de la pagina que se va a cargar
    /// CREO: Roberto González Oseguera
    /// FECHA_CREO: 03-nov-2011
    /// MODIFICÓ: 
    /// FECHA_MODIFICÓ: 
    ...
    {
        Cls_Ope_Pre_Convenios_Predial_Negocio Orden_Variacion = new Cls_Ope_Pre_Convenios_Predial_Negocio();
        DataTable Dt_Orden_Variacion;
        if (Txt_Cuenta_Predial.Text.Length > 0)
        {
            Orden_Variacion.P_Filtros_Dinamicos = Ope_Pre_Ordenes_Variacion.Tabla_Ope_Pre_Ordenes_Variacion + "."
                                                  ...
                                                  + Hdf_Cuenta_Predial_ID.Value + "' AND "
            ...
            Orden_Variacion.P_Contrarecibo_Estatus = " IN ('POR PAGAR','VALIDADO') ";
            ...
            Dt_Orden_Variacion = Orden_Variacion.Consultar_Ordenes_Variacion();
            Grid_Ordenes_Variacion.Columns[6].Visible = true;
            Grid_Ordenes_Variacion.Columns[7].Visible = true;
            Grid_Ordenes_Variacion.DataSource = Dt_Orden_Variacion;
            Grid_Ordenes_Variacion.PageIndex = Pagina;
            Grid_Ordenes_Variacion.DataBind();
            Grid_Ordenes_Variacion.Columns[6].Visible = false;
            Grid_Ordenes_Variacion.Columns[7].Visible = false;
            Grid_Ordenes_Variacion.Visible = true;
        }
    }

    ///*******************************************************************************************************
    /// NOMBRE_FUNCIÓN: Cargar_Ordenes_Variacion
    /// DESCRIPCIÓN: Manda llamar al método que carga el grid ordenes_variacion en la primera página (carga inicial)
    /// PARÁMETROS:
    /// CREO: Roberto González Oseguera
    /// FECHA_CREO: 03-nov-2011
    /// MODIFICÓ: 
    ...
    /// CAUSA_MODIFICACIÓN: 
    ///*******************************************************************************************************
    private void Cargar_Ordenes_Variacion()
    {
        Cargar_Grid_Ordenes_Variacion(0);
    }
    ...
    ///CAUSA_MODIFICACIÓN:
    ///*******************************************************************************    
    private Boolean Aplicar_Variacion(ref OracleCommand Cmmd, String Numero_Orden, String Anio)
    {
        ...
        Ordenes_Variacion.P_Orden_Variacion_ID = Numero_Orden;
        Ordenes_Variacion.P_Año = Convert.ToInt16(Anio);
    ...
    ///CAUSA_MODIFICACIÓN
    ///*******************************************************************************
    private Int32 Obtener_Dato_Consulta(ref OracleCommand Cmmd, String Campo, String Tabla, String Condiciones, Int32 Dato_Defuatl)
    {
        String Mi_SQL;
    ...
    ///DESCRIPCIÓN          : Consulta los datos del convenio seleccionado y los 
                                            ...
                                            if (Ultima_Parcialidad_Incluida != Ultima_Parcialidad_Seleccionada)
                                            {
                                                ...
                                                foreach (DataRow Drw_Adeudo in Dt_Adeudos.Rows)
                                                {
                                                    ...
                                                    if (Drw_Adeudo["Anio"].ToString() == Ultima_Parcialidad_Incluida.Substring(2, 4))
                                                    {
                                                        ...
                                                        // si el bimestre es el ultimo del año, agregar monto a sumar
                                                        if (Ultimo_Bimestre_Incluido >= 6)
                                                        {
                                                            Monto_A_Sumar += Monto_Parcialidades * Multiplicador++;
                                                            Ultimo_Bimestre_Incluido++;
                                                            break;
                                                        }

                                                        if (Convert.ToDecimal(Drw_Adeudo["ADEUDO_BIMESTRE_" + (Ultimo_Bimestre_Incluido + 1)]) > 0)
                                                        {
                                                            // recorrer los bimestres siguientes hasta que el monto a sumar sea diferente de cero
                                                            while (Ultimo_Bimestre_Incluido < 6)
                                                            {
                                                                Monto_A_Sumar += Monto_Parcialidades * Multiplicador++;
                                                                Ultimo_Bimestre_Incluido++;
                                                                // para evitar que si no se encuentran adeudos, monto a sumar se quede en ceros
                                                                if (Monto_A_Sumar > 0)
                                                                {
                                                                    break;
                                                                }
                ...
                if (Dt_Adeudos != null)
                {
                    if (Dt_Adeudos.Rows.Count > 0)
                    {
                            ...
                            Monto_Parcial > 0)
                        {
                            ...
                            {
                                Monto_Moratorios = Convert.ToDecimal(Txt_Monto_Moratorios.Text) - Convert.ToDecimal(Txt_Descuento_Recargos_Moratorios.Text)
                                    - Convert.ToDecimal(Txt_Descuento_Recargos_Moratorios.Text);
                            }
                            if (Hdn_Monto_Impuesto.Value != "")
                            {
                            ...
                            //Txt_Total_Anticipo.Text = Convert.ToDouble(Dr_Parcialidades["MONTO_IMPORTE"].ToString()).ToString("###,###,###,##0.00");
                            //Txt_Porcentaje_Anticipo.Text = ((Convert.ToDouble(Txt_Total_Anticipo.Text) / Convert.ToDouble(Txt_Sub_Total.Text)) * 100).ToString("0.00");
                            //Txt_Total_Convenio.Text = (Convert.ToDouble(Txt_Sub_Total.Text) - Convert.ToDouble(Txt_Total_Anticipo.Text)).ToString("###,###,###,##0.00");
                                            ...
                                            foreach (DataRow Drw_Adeudo in Dt_Adeudos.Rows)
                                            {
                                                ...
                                                if (Drw_Adeudo["Anio"].ToString() == Ultima_Parcialidad_Incluida.Substring(2, 4))
                                                {
                                                    ...
                                                    while (Monto_A_Sumar <= Tmp_Monto_A_Sumar)
                                                    {
                                                        ...
                                                        if (Ultimo_Bimestre_Incluido < 6)
                                                        {
                                                            if (Convert.ToDecimal(Dt_Adeudos.Rows[Indice_Fila]["ADEUDO_BIMESTRE_" + (Ultimo_Bimestre_Incluido + 1)]) > 0)
                                                            {
                                                                // agregar el monto del siguiente bimestre
                                                                Monto_A_Sumar = Convert.ToDecimal(Drw_Adeudo["ADEUDO_BIMESTRE_" + (Ultimo_Bimestre_Incluido + 1)])
                                                                    + (Convert.ToDecimal(Drw_Adeudo["ADEUDO_BIMESTRE_" + (Ultimo_Bimestre_Incluido + 1)]) * Multiplicador++);
                                                            }
                                                            else
                                                            {
                                                                Ultimo_Bimestre_Incluido++;
                                                        ...
                                                        else
                                                        {
                                                            ...
                                                            // si no es la ultima fila de la tabla, asignar utilizar la siguiente fila
                                                            if (Indice_Fila < Dt_Adeudos.Rows.Count)
                                                            {
                                                                Indice_Fila++;
                                                            }
                                                            else // si ya se alcanzó la ultima fila, asignar valor al monto_A_Asignar
                                                            {
    ...
    protected void Leer_Parametros_Parcialidades_Hasta_No_Pago(String No_Pago, Decimal Nuevo_Monto)
    {
        ...
        foreach (GridViewRow Row in Grid_Parcialidades.Rows)
        {
            ...
            else  // se llego al adeudo modificado, tomar fecha y periodo del adeudo
            {
    ...
    private bool Validar_Componentes()
    {
        ...
        if ((Convert.ToDouble(Txt_Monto_Recargos.Text) + Convert.ToDouble(Txt_Monto_Moratorios.Text) + Convert.ToDouble(Hdn_Monto_Impuesto.Value) + Convert.ToDouble(Txt_Adeudo_Honorarios.Text)) != 0.00)
        {
            ...
            {
                if (Txt_Solicitante.Text == "")         // validar NOMBRE SOLICITANTE
                {
                    if (!Validacion) { Mensaje_Error = Mensaje_Error + "<br>"; }
                    Mensaje_Error = Mensaje_Error + "+ Indique el nombre del solicitante.";
                    Validacion = false;
                }
                if (Txt_RFC.Text == "")                 // validar RFC SOLICITANTE
                {
                    if (!Validacion) { Mensaje_Error = Mensaje_Error + "<br>"; }
    ...
    ///*******************************************************************************
    ///NOMBRE DE LA FUNCIÓN : Cargar_Datos_Variacion
    ///DESCRIPCIÓN          : Cargar datos generales de la cuenta predial desde la ultima 
    ///                     orden de variacion ACEPTADA
    ///PARAMETROS:
    ///CREO                 : Roberto González Oseguera
    ///FECHA_CREO           : 17-feb-2011
    ///MODIFICO:
    ///FECHA_MODIFICO
    ///CAUSA_MODIFICACIÓN
    ///*******************************************************************************
    private void Cargar_Datos_Variacion()
    {
        var Consulta_Datos_Orden = new Cls_Ope_Pre_Calculo_Impuesto_Traslado_Negocio();
        var Orden_Variacion = new Cls_Ope_Pre_Orden_Variacion_Negocio();

        // especificar parametros para consulta de ordenes aceptadas de la cuenta predial
        Orden_Variacion.P_Incluir_Campos_Foraneos = true;
        Orden_Variacion.P_Join_Contrarecibo = true;
        // indicar los estatus de contrarecibo que no se van a incluir 
        ...
        DataTable Dt_Ordenes_Variacion = Orden_Variacion.Consultar_Ordenes_Variacion_Contrarecibos();

        if (Dt_Ordenes_Variacion != null && Dt_Ordenes_Variacion.Rows.Count > 0)
        {
            // obtener informacion de orden de variacion y su contrarecibo
            int Anio_Orden;
            int.TryParse(Dt_Ordenes_Variacion.Rows[0][Ope_Pre_Ordenes_Variacion.Campo_Anio].ToString(), out Anio_Orden);
            Consulta_Datos_Orden.P_No_Orden_Variacion = Dt_Ordenes_Variacion.Rows[0][Ope_Pre_Ordenes_Variacion.Campo_No_Orden_Variacion].ToString();
            Consulta_Datos_Orden.P_Anio_Orden = Anio_Orden;
            Consulta_Datos_Orden.P_Incluir_Campos_Foraneos = true;
            DataTable Dt_Datos_Orden = Consulta_Datos_Orden.Consultar_Ordenes_Variacion();
            ...
            if (Dt_Datos_Orden != null && Dt_Datos_Orden.Rows.Count > 0)
            {
                ...
                // Muestra los datos de la orden en los campos correspondientes
                Txt_Propietario.Text = Propietario;
                Txt_Calle.Text = Dt_Datos_Orden.Rows[0]["NOMBRE_CALLE_UBICACION"].ToString();
                Txt_Colonia.Text = Dt_Datos_Orden.Rows[0]["NOMBRE_COLONIA_UBICACION"].ToString();
                Txt_No_Exterior.Text = Dt_Datos_Orden.Rows[0][Ope_Pre_Ordenes_Variacion.Campo_No_Exterior].ToString();
                Txt_No_Interior.Text = Dt_Datos_Orden.Rows[0][Ope_Pre_Ordenes_Variacion.Campo_No_Interior].ToString();
            }
        }
    }
    ...
    private void Habilitar_Parcialidades_Manuales()
    {
        ...
        if (Numero_Parcialidades >= 0 && Numero_Parcialidades == Grid_Convenios.Rows.Count)
        {
        ...
        else if (Numero_Parcialidades >= 0) // generar a tabla a partir de los datos en la pagina (fecha convenio)
        {
    ...
    protected void Grid_Convenios_PageIndexChanging(object sender, GridViewPageEventArgs e)
    {
        ...
        try
        {
            Dt_Convenios_Predial = (DataTable)Session["Dt_Convenios_Predial"];
            // si se obtuvieron valores de convenios, cargar en el grid
            if (Dt_Convenios_Predial != null)
            {
                Grid_Convenios.SelectedIndex = (-1);
    ...
    protected void Btn_Nuevo_Click(object sender, ImageClickEventArgs e)
    {
        ...
        try
        {
            ...
            if (Btn_Nuevo.ToolTip == "Nuevo")
            {
                ...
                Limpiar_Controles();
                Grid_Ordenes_Variacion.Visible = false;
    ...
    ///*******************************************************************************
    ///NOMBRE DE LA FUNCIÓN : Alta_Convenio
    ...
    private void Alta_Convenio()
    {
        ...
        try
        {
            ...
            if (Convenios_Predial.Alta_Convenio_Predial())
            {
    ...
    private void Modificar_Convenio()
    {
        ...
        try
        {
            if (Cmb_Estatus.SelectedValue == "CANCELADO")
            {
                ...
                {
                    AjaxControlToolkit.ToolkitScriptManager.RegisterStartupScript(this, this.GetType(),
                        "Convenios de impuesto predial", "alert('No se pueden Cancelar Convenios con parcialidades Pagadas');", true);
                    Aceptar_Cambio = false;
                }
                else // eliminar el pasivo y constinuar con la modificacion
                {
                    // datos generales para el pasivo
                    Rs_Pasivo.P_Referencia = "CPRE" + Convert.ToInt32(Hdf_No_Convenio.Value);
            ...
            if (Aceptar_Cambio)
            {
                ...
                Convenio_Predial.P_Total_Honorarios = Convert.ToDecimal(Txt_Adeudo_Honorarios.Text);
    ...
    protected void Btn_Modificar_Click(object sender, ImageClickEventArgs e)
    {
        ...
        Lbl_Mensaje_Error.Text = "";
        Img_Error.Visible = false;
        // si se asigno un valor al campo oculto con el id de la cuenta predial, hay un convenio seleccionado
        if (Hdf_Cuenta_Predial_ID.Value != "")
        {
            ...
            try
            {
                ...
                {
                    // verificar que hay un numero de convenio seleccionado
                    if (Hdf_No_Convenio.Value.Trim() != "")
                    {
                        ...
                        else if (Grid_Parcialidades.Rows[0].Cells[8].Text == "POR PAGAR")
                        {
                    ...
                    {
                        Lbl_Mensaje_Error.Text = "Seleccione el Registro que desea modificar.";
                        Lbl_Mensaje_Error.Visible = true;
                        Img_Error.Visible = true;
                    }
                }
            ...
            //else
            //{
            //    AjaxControlToolkit.ToolkitScriptManager.RegisterStartupScript(this, this.GetType(), "Convenios de impuesto predial", "alert('No puede modificar este convenio ya que tiene una o más reestructuras.');", true);
            //}
        }
        else if (Grid_Convenios.SelectedIndex > -1)
        {
            AjaxControlToolkit.ToolkitScriptManager.RegisterStartupScript(this, this.GetType(), "Convenios de impuesto predial", "alert('Seleccione un convenio a modificar, por favor.');", true);
        }
    }
    ...
    ///*******************************************************************************************************
    /// NOMBRE_FUNCIÓN: Btn_Mostrar_Ordenes_Pendientes_Click
    /// DESCRIPCIÓN: Mostrar el contenedor del grid con las órdenes de variación pendientes de aplicar
    ...
    /// CAUSA_MODIFICACIÓN: 
    ///*******************************************************************************************************
    protected void Btn_Mostrar_Ordenes_Pendientes_Click(object sender, ImageClickEventArgs e)
    {
        Tr_Contenedor_Ordenes_Pendientes.Visible = true;
        Tr_Encabezado_Ordenes_Pendientes.Visible = true;
    }

    ///*******************************************************************************************************
    /// NOMBRE_FUNCIÓN: Btn_Ocultar_Ordenes_Pendientes_Click
    /// DESCRIPCIÓN: Ocultar el contenedor del grid con las órdenes de variación pendientes de aplicar
    /// PARÁMETROS: sender y e
    /// CREO: Roberto González Oseguera
    /// FECHA_CREO: 20-dic-2011
    /// MODIFICÓ: 
    ...
    /// CAUSA_MODIFICACIÓN: 
    ///*******************************************************************************************************
    protected void Btn_Ocultar_Ordenes_Pendientes_Click(object sender, ImageClickEventArgs e)
    {
        Tr_Contenedor_Ordenes_Pendientes.Visible = false;
        Tr_Encabezado_Ordenes_Pendientes.Visible = false;
    }
    ...
    {
        var Consultar_Cuenta = new Cls_Ope_Pre_Calculo_Impuesto_Traslado_Negocio();
        var Rs_Consulta_Adeudos = new Cls_Ope_Pre_Generar_Adeudo_Predial_Negocio();
        ...
        if (Txt_Cuenta_Predial.Text.Trim() != "")
        {
            ...
            Consultar_Cuenta.P_Incluir_Campos_Foraneos = true;
            Consultar_Cuenta.P_Cuenta_Predial_ID = Hdf_Cuenta_Predial_ID.Value;
            Dt_Cuentas_Predial = Consultar_Cuenta.Consultar_Datos_Cuenta_Predial();
            if (Dt_Cuentas_Predial.Rows.Count > 0)
            {
                ...
                else
                {
                    ...
                    Txt_Calle.Text = Dt_Cuentas_Predial.Rows[0]["NOMBRE_CALLE_UBICACION"].ToString();
                    Txt_Colonia.Text = Dt_Cuentas_Predial.Rows[0]["NOMBRE_COLONIA_UBICACION"].ToString();
                    ...
                    if (Cmb_Tipo_Solicitante.SelectedValue == "PROPIETARIO")
                    {
                        ...
                        Txt_RFC.Text = Dt_Cuentas_Predial.Rows[0]["RFC_PROPIETARIO"].ToString();
                    }
                    Hdf_RFC_Propietario.Value = Dt_Cuentas_Predial.Rows[0]["RFC_PROPIETARIO"].ToString();
                }
                ...
                if (Validar_Existe_Convenio_Activo("", Hdf_Cuenta_Predial_ID.Value, out No_Convenio_Activo))
                {
                    ...
                    {
                        AjaxControlToolkit.ToolkitScriptManager.RegisterStartupScript(this, this.GetType()
                            , "Convenios de impuesto predial", "alert('Existe un Convenio INCUMPLIDO para esta Cuenta, sólo se puede reestructurar.');", true);
                    }
                    else
                    {
                        AjaxControlToolkit.ToolkitScriptManager.RegisterStartupScript(this, this.GetType()
    ...
    private Boolean Validar_Existe_Convenio_Activo(String No_Convenio, String Cuenta_Predial_ID, out String No_Convenio_Activo)
    {
        ...
        else
        {
            ...
            {
                Rs_Convenios_Activos.P_Estatus = " IN ('ACTIVO','PENDIENTE','INCUMPLIDO')";
                // especificar que valide el estatus del convenio
                ...
                if (Dt_Convenios_Activos.Rows.Count > 0)
                {
                    ...
                    foreach (DataRow Convenio in Dt_Convenios_Activos.Rows)
                    {
                        ...
                        if (Estatus_Convenio.Contains("ACTIVO") || Estatus_Convenio.Contains("PENDIENTE") || Estatus_Convenio.Contains("INCUMPLIDO"))
                        {
    ...
    /// DESCRIPCIÓN: Calcula el total a descontar sumando los descuentos a recargos 
    ...
    protected void Btn_Imprimir_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (Hdf_No_Convenio.Value != "")
        {
            // verificar que el calculo tiene estatus LISTO
            if (Cmb_Estatus.SelectedValue == "ACTIVO")
            {
                try
                {
                ...
                if (descuento[Ope_Pre_Descuentos_Predial.Campo_Estatus].ToString() == "VIGENTE")
                {
                    ...
                    if (Hasta_Anio_Convenio == Hasta_Anio_Descuento && Hasta_Bimestre_Convenio == Hasta_Bimestre_Descuento)
                    {
                        ...
                        if (Descuento_Recargos_Moratorios > 0 || Descuento_Recargos_Ordinarios > 0)
                        {
                            ...
                            {
                                Lbl_Mensaje_Error.Text = "El descuento en recargos ordinarioa ($"
    ...
    protected void Cmb_Busqueda_General_SelectedIndexChanged(object sender, EventArgs e)
    {
        Cargar_Grid_Convenios(0);
    }
}
