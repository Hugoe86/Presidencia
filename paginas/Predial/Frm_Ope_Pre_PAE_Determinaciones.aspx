<%@ Page Title="" Language="C#" MasterPageFile="~/paginas/Paginas_Generales/MasterPage.master"
    AutoEventWireup="true" CodeFile="Frm_Ope_Pre_PAE_Determinaciones.aspx.cs" Inherits="paginas_Predial_Frm_Ope_Pre_PAE_Determinaciones" Culture="es-MX"
...
<asp:Content ID="Content3" ContentPlaceHolderID="Cph_Area_Trabajo1" runat="Server">
    <cc1:ToolkitScriptManager ID="Tsm_Determinaciones" runat="server"  AsyncPostBackTimeout="3600" EnableScriptGlobalization="true"/>    
        ...
        <ContentTemplate>
            ...
            <div id="Div_Contenido" style="background-color: #ffffff; width: 100%; height: 100%;">
                                    ...
                                    <tr>
                                        <td align="left" style="width: 59%;">
                                            ...
                                            <asp:ImageButton ID="Btn_Subir_Archivo" runat="server" ToolTip="Subir archivo" CssClass="Img_Button"
                                                TabIndex="5" ImageUrl="~/paginas/imagenes/paginas/sias_upload.png" OnClick="Btn_Subir_Archivo_Click" />
                    ...
                    <table width="98%" class="estilo_fuente">
                        ...
                        <tr>
                            ...
                            <td style="text-align: left; width: 30%;">
                                <asp:TextBox ID="Txt_Colonia" runat="server" Width="87%"></asp:TextBox>
                            ...
                            <td style="text-align: left; width: 30%;">
                                <asp:TextBox ID="Txt_Calle" runat="server" Width="87%"></asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td style="text-align: left; width: 30%;">
                                <asp:TextBox ID="Txt_Rezago_Mayor" runat="server" Width="96.4%" />
                                <cc1:FilteredTextBoxExtender ID="Fte_Txt_Rezago_Mayor" runat="server" TargetControlID="Txt_Rezago_Mayor"
                            ...
                            <td style="text-align: left; width: 30%;">
                                <asp:TextBox ID="Txt_Rezago_Menor" runat="server" Width="96.4%" />
                                <cc1:FilteredTextBoxExtender ID="Fte_Txt_Rezago_Menor" runat="server" TargetControlID="Txt_Rezago_Menor"
                                    FilterType="Numbers,Custom" ValidChars="." />
                            </td>
                        </tr>
                        <%---------------- Cuentas omitidas ----------------%>
                        ...
                        <tr>
                            ...
                            <td colspan="3" style="text-align: left; width: 80%; vertical-align: top;">
                                <asp:TextBox ID="Txt_Comentarios" runat="server" TabIndex="10" MaxLength="250" TextMode="MultiLine"
                                    Width="98.6%" AutoPostBack="True" onkeyup='this.value=this.value.toUpperCase();'/>
                    ...
                    <table width="98%" class="estilo_fuente">
                        <caption>
                            ...
                            <tr>
                                ...
                                <td style="text-align: left; width: 30%;">
                                    <asp:TextBox ID="Txt_Cuenta_Predial" runat="server" Width="84%" onkeyup='this.value=this.value.toUpperCase();' />
                            ...
                            <tr>
                                ...
                                <td colspan="2" style="text-align: left; width: 20%; text-align: right;">
                                    <asp:Label ID="Lbl_Busqueda" runat="server" Text="Buscar Determinaciones"></asp:Label>
                                    <asp:ImageButton ID="Btn_Buscar_Determinaciones" runat="server" 
                            ...
                            <tr align="center">
                                <td colspan="4">
                                    <asp:GridView ID="Grid_Determinaciones_Generadas" runat="server" 
                                        AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
                                        CssClass="GridView_1" HeaderStyle-CssClass="tblHead" PageSize="5" Style="white-space: normal;"
                                        Width="100%" 
                                        onpageindexchanging="Grid_Determinaciones_Generadas_PageIndexChanging">
                                        <Columns>
                ...
                <asp:Panel ID="Pnl_Subir_Archivo" runat="server" Style="display:none;border-style:outset;border-color:Silver;background-image:url(~/paginas/imagenes/paginas/Sias_Fondo_Azul.PNG);background-repeat:repeat-y;max-width:850px;"  CssClass="drag">
                    ...
                    <br />
                    <br />
                    <asp:Button ID="Btn_Cargar_Archivo" runat="server" Text="Aceptar" OnClick="Btn_Cargar_Archivo_Click" />                    
