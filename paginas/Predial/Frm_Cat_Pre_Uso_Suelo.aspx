<%@ Page Language="C#" MasterPageFile="~/paginas/Paginas_Generales/MasterPage.master" AutoEventWireup="true" CodeFile="Frm_Cat_Pre_Uso_Suelo.aspx.cs" Inherits="paginas_predial_Frm_Cat_Pre_Uso_Suelo" Title="Catalogo de Uso de Suelo" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Cph_Area_Trabajo1" Runat="Server">
    <asp:ScriptManager ID="ScptM_Uso_Suelo" runat="server" />
        ...
        <ContentTemplate>
            ...
            <div id="Div_Requisitos" style="background-color:#ffffff; width:100%; height:100%;">
                <table width="98%"  border="0" cellspacing="0" class="estilo_fuente">
                    <tr align="center">
                        <td class="label_titulo" colspan="2">Catálogo de Uso de Predio</td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr class="barra_busqueda" align="right">
                        ...
                        <td>Búsqueda:
                            <asp:TextBox ID="Txt_Busqueda_Uso_Suelo" runat="server" Width="130px"></asp:TextBox>
                            <asp:ImageButton ID="Btn_Buscar_Uso_Suelo" runat="server" CausesValidation="false"
                                ImageUrl="~/paginas/imagenes/paginas/busqueda.png" ToolTip="Buscar" 
                                onclick="Btn_Buscar_Uso_Suelo_Click" />
                            <cc1:TextBoxWatermarkExtender ID="TWE_Txt_Busqueda_Uso_Suelo" runat="server" WatermarkText="<Identificador>" TargetControlID="Txt_Busqueda_Uso_Suelo" WatermarkCssClass="watermarked"></cc1:TextBoxWatermarkExtender>
                            <cc1:FilteredTextBoxExtender ID="FTE_Txt_Busqueda_Uso_Suelo" runat="server" TargetControlID="Txt_Busqueda_Uso_Suelo" InvalidChars="<,>,&,',!," FilterType="Custom, UppercaseLetters, LowercaseLetters, Numbers" ValidChars="Ññ.,:;()áéíóúÁÉÍÓÚ ">
                ...
                <center>
                    <table width="96%">
                        <tr>
                            <td colspan="4">
                                <asp:HiddenField ID="Hdf_Uso_Suelo_ID" runat="server" />
                            </td>
                        </tr>
                        <tr>
                            <td style="width:18%; text-align:left;">
                                <asp:Label ID="Lbl_ID_Uso_Suelo" 
                                    runat="server" Text="Uso Predio ID" CssClass="estilo_fuente"></asp:Label></td>
                            <td style="width:32%">
                                <asp:TextBox ID="Txt_ID_Uso_Suelo" runat="server" Width="98%" 
                    ...
                    <br />                                
                    <asp:GridView ID="Grid_Uso_Suelo" runat="server" CssClass="GridView_1"
                        AutoGenerateColumns="False" AllowPaging="True" PageSize="5" Width="96%"
                        onselectedindexchanged="Grid_Uso_Suelo_SelectedIndexChanged" GridLines="None"
                        onpageindexchanging="Grid_Uso_Suelo_PageIndexChanging">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="USO_SUELO_ID" HeaderText="Uso de Predio ID" 
                                SortExpression="USO_SUELO_ID" />
