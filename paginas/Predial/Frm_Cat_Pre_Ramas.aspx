<%@ Page Language="C#" MasterPageFile="~/paginas/Paginas_Generales/MasterPage.master" AutoEventWireup="true" CodeFile="Frm_Cat_Pre_Ramas.aspx.cs" Inherits="paginas_Predial_Frm_Cat_Pre_Ramas" Title="Catálogo de Ramas"%>
                ...
                <div id="General" style="background-color:#ffffff; width:100%; height:100%;">
                                ...
                                <tr class="barra_busqueda">
                                    ...
                                    <td align="right" style="width:50%">
                                        ...
                                        <asp:ImageButton ID="Btn_Busqueda" runat="server" 
                                            ...
                                            TabIndex="2" onclick="Btn_Buscar_Rama_Click"/>
                    ...
                    <table border="0" cellspacing="0" class="estilo_fuente" style="width: 98%;">
                        ...
                        <td style="width:18%">
                                Clave</td>
                            <td style="width:32%">
                                <asp:TextBox ID="Txt_Clave" runat="server" Width="92%" Text="" MaxLength="2"></asp:TextBox>
                                <cc1:FilteredTextBoxExtender ID="Txt_Clave_FilteredTextBoxExtender" 
                                    runat="server" Enabled="True" TargetControlID="Txt_Clave" FilterType="Numbers">
                        ...
                        <tr>
                            ...
                            <td align="center" colspan="4">
                                <asp:GridView ID="Grid_Ramas" runat="server" AllowPaging="true" 
                                    AutoGenerateColumns="False" CssClass="GridView_1" 
                                    EmptyDataText="&quot;No se encontraron registros&quot;" GridLines="none" 
                                    PageSize="5" Style="white-space:normal" Width="96%" 
                                    onpageindexchanged="Grid_Ramas_SelectedIndexChanged" 
                                    onpageindexchanging="Grid_Ramas_PageIndexChanging" 
                                    onselectedindexchanged="Grid_Ramas_SelectedIndexChanged">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="RAMA_ID" HeaderText="Id" Visible="false">
