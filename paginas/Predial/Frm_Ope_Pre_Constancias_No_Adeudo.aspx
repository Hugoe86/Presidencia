<%@ Page Title="" Language="C#" MasterPageFile="~/paginas/Paginas_Generales/MasterPage.master"
    AutoEventWireup="true" CodeFile="Frm_Ope_Pre_Constancias_No_Adeudo.aspx.cs" Inherits="paginas_Predial_Frm_Ope_Pre_Constancias_No_Adeudo"
    Culture="es-MX" %>
                ...
                <table width="98%" class="estilo_fuente">
                    <tr>
                        ...
                        <td style="width: 82%; text-align: left;" colspan="3">
                            ...
                            Detalles cuenta:
                            <asp:ImageButton ID="Btn_Detalles_Constancias_No_Adeudo" runat="server" ToolTip="Detalles de la cuenta"
                    ...
                    <tr>
                        ...
                        <td style="text-align: left; width: 30%;">
                            <asp:DropDownList ID="Cmb_Periodo_Bimestres" runat="server" AutoPostBack="True" OnSelectedIndexChanged="Cmb_Periodo_Bimestres_SelectedIndexChanged">
                                <asp:ListItem>&nbsp; 3 &nbsp;</asp:ListItem>
                            </asp:DropDownList>
                            <asp:DropDownList ID="Cmb_Periodo_Años" runat="server" AutoPostBack="True" OnSelectedIndexChanged="Cmb_Periodo_Años_SelectedIndexChanged">
                                <asp:ListItem>&nbsp; 2011 &nbsp;</asp:ListItem>
                            </asp:DropDownList>
                            <asp:DropDownList ID="Cmb_Hasta_Bimestre" runat="server" AutoPostBack="True" OnSelectedIndexChanged="Cmb_Hasta_Bimestre_SelectedIndexChanged">
                                <asp:ListItem>&nbsp; 3 &nbsp;</asp:ListItem>
                            </asp:DropDownList>
                            <asp:DropDownList ID="Cmb_Hasta_Anio" runat="server" AutoPostBack="True" OnSelectedIndexChanged="Cmb_Hasta_Anio_SelectedIndexChanged">
                                <asp:ListItem>&nbsp; 2011 &nbsp;</asp:ListItem>
                            </asp:DropDownList>
                        </td>
                    ...
                    <tr>
                        ...
                        <td style="text-align: left; width: 30%;">
                            <asp:TextBox ID="Txt_Adeudo_Total" runat="server" Width="96.4%" />
                        </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        ...
                        <td style="text-align: left; width: 30%;">
                            <asp:TextBox ID="Txt_Fecha" runat="server" Width="85%" Enabled="false" />
                    ...
                    <caption>
                        ...
                        <tr align="center">
                            <td colspan="4">
                                <br />
                                <asp:GridView ID="Grid_Constancias_No_Adeudo" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                    CssClass="GridView_1" HeaderStyle-CssClass="tblHead" PageSize="5" Style="white-space: normal;"
                                    Width="100%" OnPageIndexChanging="Grid_Constancias_No_Adeudo_PageIndexChanging"
                                    OnSelectedIndexChanged="Grid_Constancias_No_Adeudo_SelectedIndexChanged" OnRowCommand="Grid_Constancias_No_Adeudo_RowCommand"
                                    OnRowDataBound="Grid_Constancias_No_Adeudo_RowDataBound">
                                    <Columns>
                                        <asp:ButtonField ButtonType="Image" CommandName="Select" ImageUrl="~/paginas/imagenes/gridview/blue_button.png">
                                            <ItemStyle HorizontalAlign="Center" Width="5%" />
                                        </asp:ButtonField>
                                        <asp:BoundField DataField="Cuenta_Predial" HeaderStyle-Width="15%" HeaderText="Cuenta predial"
                                            SortExpression="Cuenta_Predial">
                                            <HeaderStyle Width="15%" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="Nombre_Propietario" HeaderStyle-Width="30%" HeaderText="Propietario"
                                            SortExpression="Nombre_Propietario">
                                            <HeaderStyle Width="30%" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="Periodo" HeaderStyle-Width="12%" HeaderText="Al bimestre"
                                        ...
                                        <asp:BoundField DataField="INICIALES" HeaderText="Iniciales" SortExpression="Iniciales" />
