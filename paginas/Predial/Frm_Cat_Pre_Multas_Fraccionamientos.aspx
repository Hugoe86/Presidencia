<%@ Page Language="C#" MasterPageFile="~/paginas/Paginas_Generales/MasterPage.master"
    AutoEventWireup="true" CodeFile="Frm_Cat_Pre_Multas_Fraccionamientos.aspx.cs"
    Inherits="paginas_predial_Frm_Cat_Pre_Multas_Fraccionamientos" Title="Catalogo de Multas de Fraccionamientos" %>
            ...
            <div id="Div_Requisitos" style="background-color: #ffffff; width: 100%; height: 100%;">
                <table width="98%" border="0" cellspacing="0" class="estilo_fuente">
                    <tr align="center">
                        <td colspan="2" class="label_titulo">
                            Catálogo de Multas de Fraccionamientos
                        </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr class="barra_busqueda" align="right">
                        ...
                        <td>
                            ...
                            <cc1:TextBoxWatermarkExtender ID="TWE_Txt_Busqueda_Multa" runat="server" WatermarkText="<Descripción>"
                ...
                <cc1:TabContainer ID="Tab_Contenedor_Pestagnas" runat="server" Width="98%" ActiveTabIndex="0">
                    <cc1:TabPanel runat="server" HeaderText="TabPanel1" ID="TabPanel1" Width="100%">
                        <HeaderTemplate>
                            Multas Fraccionamientos</HeaderTemplate>
                        <ContentTemplate>
                            <center>
                                <table width="100%">
                                    <tr>
                    ...
                    <cc1:TabPanel runat="server" HeaderText="TabPanel2" ID="TabPanel2" Width="100%">
                        <HeaderTemplate>
                            Multas Fraccionamientos - Cuotas</HeaderTemplate>
                        <ContentTemplate>
                            <center>
                                <table width="100%">
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 35%; text-align: left;">
                                            <asp:TextBox ID="Txt_Monto" runat="server" Width="98%" MaxLength="6" AutoPostBack="true" OnTextChanged="Txt_Monto_TextChanged"></asp:TextBox>
