...
public partial class paginas_Predial_Frm_Ope_Pre_Resumen_Catastro : System.Web.UI.Page
{
    #region Variables
        ...
        try
        {
            ...
            if (Txt_Cuenta_Predial.Text.Trim() != "")
            {
                ...
                if (Ds_Impuestos.Tables[0].Rows.Count - 1 > 0)
                {
                    ...
                    //if (!string.IsNullOrEmpty(Ds_Impuestos.Tables[0].Rows[0]["Tipo_Predio_ID"].ToString().Trim()))
                    //{
                    //    Txt_Tipo_Periodo_Impuestos.Text = Ds_Impuestos.Tables[0].Rows[0]["Tipo_Predio_ID"].ToString().Trim();
                    //}
                    ...
                    {
                        if (!string.IsNullOrEmpty(Dt_Cuota_Detalles.Rows[0]["Plazo_Financiamiento"].ToString().Trim()))
                        {
                            Txt_Plazo_Financiamiento.Text = Dt_Cuota_Detalles.Rows[0]["Plazo_Financiamiento"].ToString().Trim();
                        }
                        ...
                        if (!string.IsNullOrEmpty(Dt_Cuota_Detalles.Rows[0]["Total_Cuota_Fija"].ToString().Trim()))
                        {
                            Txt_Total_Impuesto.Text = Dt_Cuota_Detalles.Rows[0]["Total_Cuota_Fija"].ToString().Trim();
                        }
                        ...
                        if (!string.IsNullOrEmpty(Dt_Cuota_Detalles.Rows[0]["Fundamento_Legal"].ToString().Trim()))
                        {
                            Txt_Fundamento_Legal.Text = Dt_Cuota_Detalles.Rows[0]["Fundamento_Legal"].ToString().Trim();
                        }
                        ...
                        if (!string.IsNullOrEmpty(Dt_Cuota_Detalles.Rows[0]["Tipo"].ToString().Trim()))
                        {
                            ...
                            if (Dt_Cuota_Detalles.Rows[0]["Tipo"].ToString().Trim() == "FINANCIAMIENTO")
                            {
                                if (!string.IsNullOrEmpty(Dt_Cuota_Detalles.Rows[0]["Excedente_Construccion_Total"].ToString().Trim()))
                                {
                                    //Txt_Financiamiento_Total_Construccion.Text = Dt_Cuota_Detalles.Rows[0]["Excedente_Construccion_Total"].ToString().Trim();
                                }
                                if (!string.IsNullOrEmpty(Dt_Cuota_Detalles.Rows[0]["Excedente_Valor_Total"].ToString().Trim()))
                                {
                                    //Txt_Financiamiento_Total_Valor.Text = Dt_Cuota_Detalles.Rows[0]["Excedente_Valor_Total"].ToString().Trim();
                                }
                            }
                            //Sino es por financiamientoi obtener el resultado total
                            else
                            {
                                if (!string.IsNullOrEmpty(Dt_Cuota_Detalles.Rows[0]["Excedente_Construccion_Total"].ToString().Trim()))
                                {
                                    //Txt_Excedente_Construccion_Resultado.Text = Dt_Cuota_Detalles.Rows[0]["Excedente_Construccion_Total"].ToString().Trim();
                                }
                                if (!string.IsNullOrEmpty(Dt_Cuota_Detalles.Rows[0]["Excedente_Valor_Total"].ToString().Trim()))
                                {
                                    //Txt_Excedente_Valor_Resultador.Text = Dt_Cuota_Detalles.Rows[0]["Excedente_Valor_Total"].ToString().Trim();
                                }
                            }
                        }
                    }
    ...
    private void Cargar_Generales_Cuenta(DataTable dataTable)
    {
        ...
        try
        {
            ...
            if (dataTable.Rows[0][Cat_Pre_Cuentas_Predial.Campo_Fecha_Avaluo].ToString() != "" && dataTable.Rows[0][Cat_Pre_Cuentas_Predial.Campo_Fecha_Avaluo] != null)
            {
                ...
                Txt_Fecha_Avaluo_Impuestos.Text = String.Format("{0:dd/MMM/yyyy}", dataTable.Rows[0][Cat_Pre_Cuentas_Predial.Campo_Fecha_Avaluo].ToString());
            }
            ...
            {
                Txt_Fecha_Termino_Extencion.Text = String.Format("{0:dd/MMM/yyyy}", dataTable.Rows[0][Cat_Pre_Cuentas_Predial.Campo_Termino_Exencion].ToString());
            ...
            //{
            //M_Orden_Negocio.P_No_Copropietarios_Cuenta = dataTable.Rows[0]["LISTA_PROPIETARIOS_ID"].ToString();
            ...
            if (Dt_Agregar_Co_Propietarios.Rows.Count - 1 >= 0)
            {
                for (int x = 0; x <= Dt_Agregar_Co_Propietarios.Rows.Count - 1; x++)
                {
                    ...
                    {
                        Txt_Copropietarios_Propietario.Text = Dt_Agregar_Co_Propietarios.Rows[0]["Nombre_Contribuyente"].ToString().Trim() + "," + Txt_Copropietarios_Propietario.Text;
                    }
                }
            }
            //Cargar_Grid_Co(0);
    ...
    private void Cargar_Datos_Cuota_Fija(String Cuota_Fija_ID)
    {
        ...
        try
        {
            ...
            {
                Txt_Plazo_Financiamiento.Text = Dt_Cuota_Detalles.Rows[0][Ope_Pre_Cuotas_Fijas.Campo_Plazo_Financiamiento].ToString();
                Txt_Cuota_Fija.Text = Dt_Cuota_Detalles.Rows[0]["Tipo"].ToString();
                //Txt_Cuota_Minima.Text = Dt_Cuota_Detalles.Rows[0]["Cuota_Minima"].ToString();
                //Txt_Excedente_Construccion_Multiplicador.Text = Dt_Cuota_Detalles.Rows[0]["Excedente_Contruccion"].ToString();
                //Txt_Excedente_Construccion_Multiplicando.Text = Dt_Cuota_Detalles.Rows[0]["Tasa_Valor"].ToString();

                //Txt_Excedente_Valor_Multiplicador.Text = Dt_Cuota_Detalles.Rows[0]["Excedente_Valor"].ToString();
                //Txt_Excedente_Valor_Multiplicando.Text = Dt_Cuota_Detalles.Rows[0]["Tasa_Valor"].ToString();

                Txt_Total_Impuesto.Text = Dt_Cuota_Detalles.Rows[0]["Total_Cuota_Fija"].ToString();
                if (Dt_Cuota_Detalles.Rows[0]["Tipo"].ToString() == "FINANCIAMIENTO")
                {
                    //Txt_Financiamiento_Total_Construccion.Text = Dt_Cuota_Detalles.Rows[0]["Excedente_Construccion_Total"].ToString();
                    //Txt_Financiamiento_Total_Valor.Text = Dt_Cuota_Detalles.Rows[0]["Excedente_Valor_Total"].ToString();
                }
                else
                {
                    //Txt_Excedente_Construccion_Resultado.Text = Dt_Cuota_Detalles.Rows[0]["Excedente_Construccion_Total"].ToString();
                    //Txt_Excedente_Valor_Resultador.Text = Dt_Cuota_Detalles.Rows[0]["Excedente_Valor_Total"].ToString();
                }
                Txt_Fundamento_Legal.Text = Dt_Cuota_Detalles.Rows[0]["Articulo"].ToString() + " " + Dt_Cuota_Detalles.Rows[0]["Inciso"].ToString() + " " + Dt_Cuota_Detalles.Rows[0]["Observaciones"].ToString();
                //Txt_Excedente_Construccion_Total.Text = Dt_Cuota_Detalles.Rows[0][Ope_Pre_Cuotas_Fijas.Campo_Excedente_Construccion_Total].ToString();
                if (Dt_Cuota_Detalles.Rows[0]["Tasa_Valor"].ToString() != string.Empty)
                {
                    Txt_Tasa_Impuestos.Text = Dt_Cuota_Detalles.Rows[0]["Tasa_Valor"].ToString();
                }
                //Txt_Total_Cuota_Fija.Text = Dt_Cuota_Detalles.Rows[0][Ope_Pre_Cuotas_Fijas.Campo_Total_Cuota_Fija].ToString();
    ...
    private void Habilitar_Todo()
    {
        ...
        Txt_Tipo_Predio_General.Enabled = false;
        ...
        Txt_Copropietarios_Propietario.Enabled = false;
        ...
        Txt_Plazo_Financiamiento.Enabled = false;
        //Txt_Cuota_Minima.Enabled = false;
        //Txt_Excedente_Construccion_Multiplicador.Enabled = false;
        //Txt_Excedente_Construccion_Multiplicando.Enabled = false;
        //Txt_Excedente_Construccion_Resultado.Enabled = false;
        //Txt_Excedente_Valor_Multiplicador.Enabled = false;
        //Txt_Excedente_Valor_Multiplicando.Enabled = false;
        //Txt_Excedente_Valor_Resultador.Enabled = false;
        Txt_Fundamento_Legal.Enabled = false;
        //Txt_Financiamiento_Total_Construccion.Enabled = false;
        //Txt_Financiamiento_Total_Valor.Enabled = false;
    ...
    private void Limpiar_Todo()
    {
        ...
        //Txt_Excedente_Construccion_Multiplicador.Text = "";
        //Txt_Excedente_Construccion_Multiplicando.Text = "";
        //Txt_Excedente_Construccion_Resultado.Text = "";
        //Txt_Excedente_Valor_Multiplicador .Text ="";
        //Txt_Excedente_Valor_Multiplicando.Text = "";
        //Txt_Excedente_Valor_Resultador.Text = "";
        Txt_Fundamento_Legal.Text = "";
        //Txt_Financiamiento_Total_Construccion.Text = "";
        //Txt_Financiamiento_Total_Valor.Text = "";
    ...
    protected DataTable Asignar_Datos_Impuestos()
    {
        ...
        try
        {
            ...
            Impuestos["Periodo_Corriente"] = Txt_Tasa_Impuestos.Text.Trim();
            ...
            Impuestos["Cuota_Fija"] = Txt_Cuota_Fija_Impuestos.Text.Trim();
            //Detalles
            Impuestos["Cuota_Fija_Por"] = Txt_Cuota_Fija.Text.Trim();
            Impuestos["Plazo_Financiamiento"] = Txt_Plazo_Financiamiento.Text.Trim();
            //Impuestos["Cuota_Minima"] = Txt_Cuota_Minima.Text.Trim();
            //Impuestos["Excedente_Construccion_Multiplicador"] = Txt_Excedente_Construccion_Multiplicador.Text.Trim();
            //Impuestos["Excedente_Construccion_Multiplicando"] = Txt_Excedente_Construccion_Multiplicando.Text.Trim();
            //Impuestos["Excedente_Valor_Multiplicador"] = Txt_Excedente_Valor_Multiplicador.Text.Trim();
            //Impuestos["Excedente_Valor_Multiplicando"] = Txt_Excedente_Valor_Multiplicando.Text.Trim();
            Impuestos["Total_Impuesto"] = Txt_Total_Impuesto.Text.Trim();
            Impuestos["Fundamento_Legal"] = Txt_Fundamento_Legal.Text.Trim();
            //if ((Txt_Excedente_Construccion_Resultado.Text.Trim()) != "")
            //{
            //    Total_Construccion = Txt_Excedente_Construccion_Resultado.Text.Trim();
            //}
            //else if (Txt_Financiamiento_Total_Construccion.Text.Trim() != "")
            //{
            //    Total_Construccion = Txt_Financiamiento_Total_Construccion.Text.Trim();
            //}
            Impuestos["Excedente_Construccion_Resultado"] = Total_Construccion;
            //if (Txt_Excedente_Valor_Resultador.Text.Trim() != "")
            //{
            //    Impuestos["Cuota_Fija"] = Txt_Excedente_Valor_Resultador.Text.Trim();
            //}
            //else
            //{
            //    Impuestos["Cuota_Fija"] = Txt_Financiamiento_Total_Valor.Text.Trim();
            //}
