...
AutoEventWireup="true" CodeFile="Frm_Ope_Pre_PAE_Seguimiento_A_Determinaciones.aspx.cs" Inherits="paginas_Predial_Frm_Ope_Pre_PAE_Seguimiento_A_Determinaciones" Culture="es-MX"
...
<asp:Content ID="Content2" ContentPlaceHolderID="Cph_Area_Trabajo2" runat="Server">    
        ...
        function beginRequest(sender, args) {
            ...
            $(function() {
                $('.Gastos_Honorarios').click(function() {
                    var id = $(this).attr('id_cuenta');         
                    Abrir_Ventana_Modal('Ventanas_Emergentes/PAE/Frm_Gastos_De_Ejecucion.aspx?Proceso=DETERMINACION&Cuenta_Predial='+id, 'center:yes;resizable:yes;status:no;dialogWidth:525px;dialogHeight:475px;dialogHide:true;help:no;scroll:no');
                });
 ...
 <asp:Content ID="Content3" ContentPlaceHolderID="Cph_Area_Trabajo1" runat="Server">
    <cc1:ToolkitScriptManager ID="Tool_ScriptManager" runat="server"  AsyncPostBackTimeout="3600" EnableScriptGlobalization="true"></cc1:ToolkitScriptManager>
...
<%--                                            <asp:ImageButton ID="Btn_Nuevo" runat="server" ToolTip="Nuevo" CssClass="Img_Button"
                                            ...
                                            <asp:ImageButton ID="Btn_Busca_Deter" runat="server" ToolTip="Buscar" CssClass="Img_Button"
                                                TabIndex="4" ImageUrl="~/paginas/imagenes/paginas/icono_consultar.png" 
                                                onclick="Btn_Busca_Deter_Click" />
                            ...
                            <tr>
                                ...
                                <td style="text-align: left; width: 30%;">
                                    ...
                                    <asp:ImageButton ID="Btn_Busca_Contribuyente" runat="server" Height="22px" 
                                        ...
                                        onclick="Btn_Busca_Contribuyente_Click" Width="22px" />
                                </td>
                            </tr>
                            <tr>
                                <td style="text-align: left; width: 20%;">
                            ...
                            <tr align="center">
                                <td colspan="4">
                                    <asp:GridView ID="Grid_Determinaciones_Generadas" runat="server" 
                                        ...
                                        onselectedindexchanged="Grid_Determinaciones_Generadas_SelectedIndexChanged">
                                        <Columns>       
