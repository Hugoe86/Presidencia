<%@ Page Language="C#" MasterPageFile="~/paginas/Paginas_Generales/MasterPage.master"
    AutoEventWireup="true" CodeFile="Frm_Ope_Pre_Descuentos_Derechos_Sup.aspx.cs"
    Inherits="paginas_Predial_Frm_Ope_Pre_Descuentos_Derechos_Sup" Culture="es-MX"
    Title="Descuentos de Derechos de Supervisión" UICulture="es-MX" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Cph_Area_Trabajo1" runat="Server">
                ...
                <table width="100%" class="estilo_fuente">
                    <tr align="center">
                        <td colspan="4" class="label_titulo">
                            Descuentos de Derechos de Supervisión
                        </td>
                    </tr>
                    <tr>
                        <td colspan="4">
    ...
    <%--Ventana Modal --%>
    <cc1:ModalPopupExtender ID="Mpe_Busqueda_Impuestos" runat="server" BackgroundCssClass="popUpStyle"
        BehaviorID="Busqueda_Impuestos" PopupControlID="Pnl_Busqueda_Contenedor" TargetControlID="Btn_Comodin_Open"
                                ...
                                <table width="100%">
                                    ...
                                    <tr>
                                        <td style="width: 100%; text-align: left;" colspan="4">
                                            <center>
                                                <asp:Button ID="Btn_Busqueda_Impuestos" runat="server" Text="Busqueda de Impuestos"
