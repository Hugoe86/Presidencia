...
public partial class paginas_predial_Frm_Cat_Pre_Multas_Derechos_Supervision : System.Web.UI.Page{
    ...
    #region Page_Load
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!IsPostBack)
                {
                    Configuracion_Acceso("Frm_Cat_Pre_Multas_Derechos_Supervision.aspx");
    ...
    #region Metodos
        ...
        #region Grid
            ...
            private void Llenar_Tabla_Multas_Cuotas(int Pagina, DataTable Tabla) {
                ...
                Grid_Multas_Cuotas.DataBind();
                Grid_Multas_Cuotas.Columns[1].Visible = false;
                Session["Dt_Multas_Cuotas"] = Tabla;
            }
    ...
    #region Grids
        ...
        protected void Grid_Multas_Cuotas_PageIndexChanging(object sender, GridViewPageEventArgs e){
            try{
                if (Session["Dt_Multas_Cuotas"] != null){
                    DataTable tabla = (DataTable)Session["Dt_Multas_Cuotas"];
            ...
            try{
                if (Btn_Nuevo.AlternateText.Equals("Nuevo")){
                    ...
                    if (Validar_Componentes_Generales()){
                        ...
                        Multa.P_Multas_Cuotas = (DataTable)Session["Dt_Multas_Cuotas"];
                        Multa.Alta_Multa();
                        Configuracion_Formulario(true);
                        Limpiar_Catalogo();
                        Session["Dt_Multas_Cuotas"] = null;
                        Llenar_Tabla_Multas(Grid_Multas_Generales.PageIndex);
                        ScriptManager.RegisterStartupScript(this, this.GetType(), "Catalogo de Multas de Derechos de Supervisión", "alert('Alta de Multa Exitosa');", true);
                        Btn_Nuevo.AlternateText = "Nuevo";
                        Btn_Nuevo.ImageUrl = "~/paginas/imagenes/paginas/icono_nuevo.png";
            ...
            try{
                if (Btn_Modificar.AlternateText.Equals("Modificar")){
                    ...
                    if (Validar_Componentes_Generales()){
                        ...
                        Limpiar_Catalogo();
                        Llenar_Tabla_Multas(Grid_Multas_Generales.PageIndex);
                        ScriptManager.RegisterStartupScript(this, this.GetType(), "Catalogo de Multas de Derechos de Supervisión", "alert('Actualización de Multa Exitosa');", true);
                        Btn_Modificar.AlternateText = "Modificar";
                        Btn_Modificar.ImageUrl = "~/paginas/imagenes/paginas/icono_modificar.png";
                        Btn_Salir.AlternateText = "Salir";
                        Btn_Salir.ImageUrl = "~/paginas/imagenes/paginas/icono_salir.png";
        ...
        protected void Btn_Eliminar_Click(object sender, EventArgs e){
            try{
                if (Grid_Multas_Generales.Rows.Count > 0 && Grid_Multas_Generales.SelectedIndex > (-1)){
                    ...
                    Grid_Multas_Generales.SelectedIndex = (-1);
                    Llenar_Tabla_Multas(Grid_Multas_Generales.PageIndex);
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "Catálogo de Multas de Derechos de Supervision", "alert('La Multa fue eliminada exitosamente');", true);
        ...
        protected void Btn_Salir_Click(object sender, EventArgs e){
            try{
                if (Btn_Salir.AlternateText.Equals("Salir")){
                    ...
                    Limpiar_Catalogo();
                    Tab_Contenedor_Pestagnas.TabIndex = 0;
                    Session.Remove("Dt_Multas_Cuotas");
                    Btn_Salir.AlternateText = "Salir";
                    Btn_Salir.ImageUrl = "~/paginas/imagenes/paginas/icono_salir.png";
                    Grid_Multas_Cuotas.Enabled = true;
                }
                    ...
                    if (Validar_Componentes_Cuotas()){
                        ...
                        if (tabla == null){
                            if (Session["Dt_Multas_Cuotas"] == null){
                                ...
                                tabla = (DataTable)Session["Dt_Multas_Cuotas"];
                            }
                        }
                        foreach (DataRow Dr_Registro in tabla.Rows)
                        {
                            ...
                            {
                                ScriptManager.RegisterStartupScript(this, this.GetType(), "Catalogo de Multas de Derechos de Supervisión", "alert('Año y monto ya existentes. Registro no agregado.');", true);
                                return;
                            }
                        }
                        ...
                        if (Validar_Componentes_Cuotas()){
                            ...
                            if (Session["Dt_Multas_Cuotas"] != null){
                                ...
                                foreach (DataRow Dr_Registro in tabla.Rows)
                                {
                                    ...
                                    {
                                        ScriptManager.RegisterStartupScript(this, this.GetType(), "Catalogo de Multas de Derechos de Supervisión", "alert('Año y monto ya existentes. Registro no Modificado.');", true);
                                        return;
                                    }
                                    indice++;
                                }
                                ...
                                tabla.Rows[registro][2] = Txt_Monto.Text.Trim();
