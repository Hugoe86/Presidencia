            ...
            <div id="Div_Contenido" style="background-color:#ffffff; width:100%; height:100%;">
               ...
               <table width="98%"  border="0" cellspacing="0">
                ...
                <asp:Panel ID ="Pnl_Configuracion" runat="server" CssClass="Cpe_Panel" >
                    <asp:Label ID="Lbl_Cmb_Tipo_Generacion" runat="server" Text="Tipo de generación" CssClass="Etiqueta_Campo" ></asp:Label>
                ...
                <asp:Panel ID="Pnl_Parametros" runat="server" CssClass="Cpe_Panel" >
                    ...
                    <asp:Panel id="Pnl_Contenedor_Parametros" runat="server" EnableViewState="true">
                        ...
                        <asp:Label ID="Lbl_Salario_Minimo" runat="server" Text="Salario mínimo" CssClass="Etiqueta_Campo" ></asp:Label>
                ...
                <asp:ImageButton ID="Btn_Aplicar_Adeudos" runat="server" ImageUrl="~/paginas/imagenes/paginas/accept.png"
                    ...
                    OnClientClick="return confirm('Se aplicarán los adeudos a las cuentas predial ¿Esta seguro que desea continuar?');"
