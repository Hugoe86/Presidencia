<%@ Page Title="" Language="C#" MasterPageFile="~/paginas/Paginas_Generales/MasterPage.master" AutoEventWireup="true" CodeFile="Frm_Ope_Caj_ReApertura_Turno_Caja_Autorizacion.aspx.cs" Inherits="paginas_Predial_Frm_Ope_Caj_ReApertura_Turno_Caja_Autorizacion" %>
        ...
        <ContentTemplate>
            ...
            <div id="Div_Contenedor_Principal" style ="width:98%; background-color:White;">
                ...
                <table width="98%"  border="0" cellspacing="0" class="estilo_fuente">
                    <tr align="center">
                        <td class="label_titulo">Autorización de Reapertura de Turno de Caja</td>
                    </tr>
                    <tr>
                        <td>
                ...
                <asp:Panel ID="Pnl_Filtros_Busqueda" runat="server" GroupingText="Opciones de Búsqueda">
                    <table width="100%">
                        ...
                        <tr>
                            ...
                            <td colspan="3" style="width:80%; text-align:left; cursor:default;">
                                <asp:DropDownList ID="Cmb_Modulos" runat="server" Width="98%" 
                                    AutoPostBack="true" onselectedindexchanged="Cmb_Modulos_SelectedIndexChanged">
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td colspan="3" style="width:80%; text-align:left; cursor:default;">
                                <asp:DropDownList ID="Cmb_Cajas" runat="server" Width="98%">
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td colspan="2" style="text-align:left; width:50%;">
                                <asp:Button ID="Btn_Abrir_Cierre_Turno" runat="server" 
                                    Text="Autorización de Reapertura de Turno" Enabled="false"
                                    OnClick="Btn_Abrir_Cierre_Turno_Click" Width="231px"/>
                                <cc1:ConfirmButtonExtender ID="ConfirmButtonExtender_Btn_Abrir_Cierre_Turno" ConfirmText="¿Esta seguro de ReAperturar el turno seleccionado?" TargetControlID="Btn_Abrir_Cierre_Turno" runat="server" />
                            </td>
                            <td colspan="2" style="text-align:right; width:50%;">
                                <asp:ImageButton ID="Btn_Busqueda_Turnos_Caja" runat="server" ImageUrl="~/paginas/imagenes/paginas/Busqueda_00001.png"
                                    OnClick="Btn_Busqueda_Turnos_Caja_Click" style="width:32px; height:32px;"/>
                            </td>
                        </tr>                    
                    </table>
                </asp:Panel>
                ...
                <table width="100%">
                    ...
                    <tr>
                        <td style="width:100%;" colspan="4">
                            <asp:GridView ID="Grid_Turnos_Caja" runat="server" CssClass="GridView_1" 
                                Width="100%" AutoGenerateColumns="False"  
                                GridLines="None" HeaderStyle-CssClass="tblHead" 
                                OnSelectedIndexChanged="Grid_Turnos_Caja_SelectedIndexChanged" 
                                EnableModelValidation="True">
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="NO_TURNO" HeaderText="No. Turno">
                                        ...
                                        <asp:BoundField DataField="No_Caja" 
                                            HeaderText="# Caja">
                                        </asp:BoundField>
