<%@ Page Language="C#" MasterPageFile="~/paginas/Paginas_Generales/MasterPage.master"
    AutoEventWireup="true" CodeFile="Frm_Rpt_Pre_Ordenes_Variacion_Aplicadas.aspx.cs"
    Inherits="paginas_Predial_Frm_Rpt_Pre_Ordenes_Variacion_Aplicadas" Title="Untitled Page" %>
                ...
                <table width="98%" class="estilo_fuente">
                    ...
                    <tr>
                        <td style="text-align: left; width: 25%">
                            Grupo</td>
                        <td style="text-align: left; width: 25%">
                            <asp:DropDownList ID="Cmb_Grupos" runat="server" Width="98%">
                            </asp:DropDownList>
                        </td>
                        <td style="text-align: right; width: 25%">
                            Tipo Predio</td>
                        <td style="text-align: left; width: 25%">
                            <asp:DropDownList ID="Cmb_Tipos_Predio" runat="server" Width="98%">
                            </asp:DropDownList>
                        </td>
                    </tr>
                </table>
