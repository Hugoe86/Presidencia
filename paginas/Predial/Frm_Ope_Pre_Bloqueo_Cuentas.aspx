<%@ Page Title="" Language="C#" MasterPageFile="~/paginas/Paginas_Generales/MasterPage.master"
    AutoEventWireup="true" CodeFile="Frm_Ope_Pre_Bloqueo_Cuentas.aspx.cs" Inherits="paginas_Predial_Frm_Ope_Pre_Bloqueo_Cuentas" %>
                        ...
                        <td colspan="4">
                            <asp:GridView ID="Grid" runat="server" AllowPaging="True" CssClass="GridView_1" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="ID" HeaderText="CUENTA_ID" Visible="false">
                                        <FooterStyle HorizontalAlign="Left" />
                                        <HeaderStyle HorizontalAlign="Left" Width="12%" />
                                        <ItemStyle HorizontalAlign="Left" Width="12%" />
                                    </asp:BoundField>
