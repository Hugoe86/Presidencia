...
public partial class paginas_Predial_Frm_Rpt_Pre_Notas_Rechazadas : System.Web.UI.Page
{
    ///*******************************************************************************
        ...
        {
            {
                ...
                Ordenes.P_Campos_Dinamicos += Ope_Pre_Observaciones.Tabla_Ope_Pre_Observaciones_Orden_Variacion + "." + Ope_Pre_Observaciones.Campo_Fecha_Creo + " AS FECHA_RECHAZO, ";
                Ordenes.P_Campos_Dinamicos += Ope_Pre_Observaciones.Tabla_Ope_Pre_Observaciones_Orden_Variacion + "." + Ope_Pre_Observaciones.Campo_Descripcion + " AS CONCEPTO_RECHAZO, ";
                ...
                Ordenes.P_Filtros_Dinamicos += Ope_Pre_Ordenes_Variacion.Tabla_Ope_Pre_Ordenes_Variacion + "." + Ope_Pre_Ordenes_Variacion.Campo_Anio + " = " + Ope_Pre_Observaciones.Tabla_Ope_Pre_Observaciones_Orden_Variacion + "." + Ope_Pre_Observaciones.Campo_Año + " AND ";
                Ordenes.P_Filtros_Dinamicos += Ope_Pre_Ordenes_Variacion.Tabla_Ope_Pre_Ordenes_Variacion + "." + Ope_Pre_Ordenes_Variacion.Campo_Estatus_Orden + " = 'RECHAZADA' ";
                if (Txt_Fecha_Inicio.Text.Trim() != "" && Txt_Fecha_Termino.Text.Trim() != "")
                {
                    Ordenes.P_Filtros_Dinamicos += " AND " + Ope_Pre_Ordenes_Variacion.Tabla_Ope_Pre_Ordenes_Variacion + "." + Ope_Pre_Ordenes_Variacion.Campo_Fecha_Creo + " >= '" + DateTime.ParseExact(Txt_Fecha_Inicio.Text, "dd/MMM/yyyy", null).ToString("dd-MM-yyyy") + "'";
                    Ordenes.P_Filtros_Dinamicos += " AND " + Ope_Pre_Ordenes_Variacion.Tabla_Ope_Pre_Ordenes_Variacion + "." + Ope_Pre_Ordenes_Variacion.Campo_Fecha_Creo + " < '" + DateTime.ParseExact(Txt_Fecha_Termino.Text, "dd/MMM/yyyy", null).AddDays(1).ToString("dd-MM-yyyy") + "'";
                }
                Ordenes.P_Ordenar_Dinamico = "";
                Ordenes.P_Ordenar_Dinamico += Ope_Pre_Observaciones.Tabla_Ope_Pre_Observaciones_Orden_Variacion + "." + Ope_Pre_Observaciones.Campo_Fecha_Creo + " DESC, ";
                ...
                Nombre_Repote_Crystal = "Rpt_Pre_Notas_Rechazadas.rpt";
                Nombre_Reporte = "Reporte de Notas Rechazadas";
                Dt_Datos_Ordenes = Ordenes.Consultar_Datos_Reporte_Movimientos();
                Dt_Datos_Ordenes.TableName = "Dt_Notas_Rechazadas";
