...
public partial class paginas_Predial_Frm_Ope_Pre_Reestructura_Convenios_Derechos_Supervision : System.Web.UI.Page
{
    ...
    private void Cargar_Grid_Convenios_Impuestos_Derechos_Supervision(Int32 Pagina)
    {
        try
        {
            ...
            if (Dt_Convenios_Derecho_Supervision != null)
            {
                ...
                Grid_Convenios_Impuestos_Derechos_Supervision.PageIndex = 0;
    ...
    private void Cargar_Convenio()
    {
        try
        {
            ...
            Convenios_Derechos_Supervision.P_Mostrar_Ultimo_Convenio = true;
            if (Grid_Convenios_Impuestos_Derechos_Supervision.SelectedIndex > (-1))
            {
                if (!Grid_Convenios_Impuestos_Derechos_Supervision.SelectedRow.Cells[9].Text.Replace("&nbsp;", "").Equals(""))
                {
                    Convenios_Derechos_Supervision.P_Mostrar_Detalles_Con_Reestructura = true;
                }
                else
                {
            ...
            if (Dt_Convenios_Derecho_Supervision != null)
            {
                if (Dt_Convenios_Derecho_Supervision.Rows.Count > 0)
                {
                    foreach (DataRow Row in Dt_Convenios_Derecho_Supervision.Rows)
                    {
                        ...
                        Txt_Numero_Reestructura.Text = Row[Ope_Pre_Convenios_Derechos_Supervision.Campo_No_Reestructura].ToString();
                        ...
                        Txt_Fecha.Text = Convert.ToDateTime(Row[Ope_Pre_Convenios_Derechos_Supervision.Campo_Fecha].ToString()).ToString("dd/MMM/yyyy");
                        ...
                        Hdf_Desc_Recargos.Value = Convert.ToDouble(Txt_Descuento_Recargos_Ordinarios.Text).ToString("0.00");
                        ...
                        Hdf_Desc_Multas.Value = Convert.ToDouble(Txt_Descuento_Multas.Text).ToString("0.00");
                        ...
                        Grid_Parcialidades.DataBind();
                        Grid_Pagos.DataSource = Convenios_Derechos_Supervision.P_Dt_Parcialidades_Pagadas;
    ...
    protected void Grid_Convenios_Impuestos_Derechos_Supervision_SelectedIndexChanged(object sender, EventArgs e)
    {
        if (Grid_Convenios_Impuestos_Derechos_Supervision.Rows.Count > 0)
        {
            ...
            Hdf_No_Impuesto_Derechos_Supervision.Value = Grid_Convenios_Impuestos_Derechos_Supervision.SelectedRow.Cells[10].Text;
            Cargar_Convenio();
    ...
    protected void Btn_Nuevo_Click(object sender, ImageClickEventArgs e)
    {
        if (Grid_Convenios_Impuestos_Derechos_Supervision.SelectedIndex > -1)
        {
            try
            {
                if (!Grid_Convenios_Impuestos_Derechos_Supervision.SelectedRow.Cells[6].Text.Equals("PAGADO") && Grid_Convenios_Impuestos_Derechos_Supervision.SelectedRow.Cells[6].Text == "INCUMPLIDO" && !Grid_Convenios_Impuestos_Derechos_Supervision.SelectedRow.Cells[6].Text.Equals("CANCELADO"))
                {
                    ...
                    else
                    {
                        if (Validar_Componentes())
                        {
                            ...
                            else
                            {
                                ...
                                {
                                    Convenios_Derechos_Supervision.P_Solicitante = Txt_Solicitante.Text.Trim();
                            ...
                            Convenios_Derechos_Supervision.P_Fecha = Convert.ToDateTime(Txt_Fecha.Text);
                            Convenios_Derechos_Supervision.P_Observaciones = Txt_Observaciones.Text;
                            ...
                            Convenios_Derechos_Supervision.P_Descuento_Multas = 0.00;
                            ...
                            Convenios_Derechos_Supervision.P_Propietario_ID = Hdf_Propietario_ID.Value;
                            Convenios_Derechos_Supervision.P_No_Descuento = Hdf_No_Descuento.Value;
                            if (Convenios_Derechos_Supervision.Alta_Reestructura_Convenio_Derecho_Supervision())
                            {
                                //Insertar_Pasivo("RDER" + Convenios_Derechos_Supervision.P_No_Convenio + Convenios_Derechos_Supervision.P_No_Reestructura);

                                //Imprimir_Reporte(Crear_Ds_Reestructura_Convenios_Derechos_Supervision(), "Rpt_Pre_Reestructura_Derechos_Supervision.rpt", "Reestructura de Convenio Derechos Supervision", "Window_Frm", "Convenio");
                                Imprimir_Convenio();

                                Imprimir_Reporte(Crear_Ds_Convenios_Folio("CDER" + Convert.ToInt32(Convenios_Derechos_Supervision.P_No_Convenio)), "Rpt_Pre_Folio_Convenios.rpt", "Rpt_Reestructura_Convenio_Derechos_Supervision", "Window_Rpt", "Folio");
                ...
                else if (Grid_Convenios_Impuestos_Derechos_Supervision.SelectedRow.Cells[6].Text != "INCUMPLIDO" && Grid_Convenios_Impuestos_Derechos_Supervision.SelectedRow.Cells[6].Text != "PAGADO")
                {
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "Reestructura de Convenios por Derechos de Supervisión", "alert('La reestructura aún esta vigente.');", true);
                }
                else
                {
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "Reestructura de Convenios por Derechos de Supervisión", "alert('La reestructura se encuentra pagada.');", true);
                }
            }
            catch (Exception Ex)
            {
        ...
        {
            ScriptManager.RegisterStartupScript(this, this.GetType(), "Reestructura de Convenios por Derechos de Supervisión", "alert('Seleccione un convenio o reestructura por favor.');", true);
        }
    }
    ...
    private DataSet Crear_Ds_Convenios_Folio(String Folio)
    {
        ...
        Dr_Convenio["TIPO_CONVENIO"] = "Reestructura de convenio de derechos de supervisión";
        String Domicilio = "";
    ...
    private void Insertar_Pasivo(String Referencia)
    {
        try
        {
            ...
            if (Dt_Clave.Rows.Count > 0)
            {
                ...
                Calculo_Impuesto_Traslado.P_Descripcion = "COBRO POR REESTRUCTURA DE CONVENIO DE DERECHOS DE SUPERVISION DE LA CUENTA PREDIAL " + Txt_Cuenta_Predial.Text;
    ...
    protected void Btn_Modificar_Click(object sender, ImageClickEventArgs e)
    {
        if (Grid_Convenios_Impuestos_Derechos_Supervision.SelectedIndex > -1)
        {
            try
            {
                if (!Grid_Convenios_Impuestos_Derechos_Supervision.SelectedRow.Cells[6].Text.Equals("PAGADO") && !Grid_Convenios_Impuestos_Derechos_Supervision.SelectedRow.Cells[9].Text.Replace("&nbsp;", "").Equals("") && !Grid_Convenios_Impuestos_Derechos_Supervision.SelectedRow.Cells[6].Text.Equals("INCUMPLIDO") && !Grid_Convenios_Impuestos_Derechos_Supervision.SelectedRow.Cells[6].Text.Equals("CANCELADO"))
                {
                    Boton_Pulsado = ((ImageButton)sender).ID;
                    Session["Boton_Pulsado"] = Boton_Pulsado;
                    ...
                    else
                    {
                        if (Validar_Componentes())
                        {
                            ...
                            //    {
                            //        ScriptManager.RegisterStartupScript(this, this.GetType(), "Convenios por Derechos de Supervisión", "alert('No se pueden Cancelar Reestructuras con parcialidades Pagadas');", true);
                            //        Aceptar_Cambio = false;
                            //    }
                            //    else
                            //    {
                            //        ScriptManager.RegisterStartupScript(this, this.GetType(), "Convenios por Derechos de Supervisión", "confirm('Confirme que desea Cancelar la Reestructura');", true);
                            //        Aceptar_Cambio = false;
                            //    }
                            //}
                            //else
                            ...
                            Convenios_Derechos_Supervision.P_Total_Convenio = Convert.ToDouble(Txt_Total_Convenio.Text);
                            Convenios_Derechos_Supervision.P_Usuario = Cls_Sessiones.Nombre_Empleado;
                            Convenios_Derechos_Supervision.P_No_Reestructura = Txt_Numero_Reestructura.Text.Trim();
                            Convenios_Derechos_Supervision.P_Dt_Parcialidades = Crear_Tabla_Parcialidades();
                            if (Convenios_Derechos_Supervision.Modificar_Reestructura_Convenio_Derecho_Supervision())
                            {
                                Cls_Ope_Pre_Impuestos_Derechos_Supervision_Negocio Mod_Pasivo = new Cls_Ope_Pre_Impuestos_Derechos_Supervision_Negocio();
                                Mod_Pasivo.Cancelar_Pasivo("RDER" + Convenios_Derechos_Supervision.P_No_Convenio + Convert.ToInt32(Convenios_Derechos_Supervision.P_No_Reestructura).ToString(), Cmb_Estatus.SelectedValue, Grid_Parcialidades.Rows[0].Cells[6].Text.Replace("$", ""));
                                if (Cmb_Estatus.SelectedValue == "ACTIVO")
                                {
                                    Imprimir_Reporte(Crear_Ds_Convenios_Folio("CDER" + Convert.ToInt32(Convenios_Derechos_Supervision.P_No_Convenio)), "Rpt_Pre_Folio_Convenios.rpt", "Rpt_Reestructura_Convenio_Derechos_Supervision", "Window_Rpt", "Folio");
                                    Imprimir_Convenio();
                            ...
                            {
                                ScriptManager.RegisterStartupScript(this, this.GetType(), "Reestructura de Convenios por Derechos de Supervisión", "alert('Actualización de Convenio por Derecho de Supervisión No fue Exitosa');", true);
                            }
                            //}
                        }
                    }
                }
                else if (Grid_Convenios_Impuestos_Derechos_Supervision.SelectedRow.Cells[9].Text.Replace("&nbsp;", "").Equals(""))
                {
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "Reestructura de Convenios por Derechos de Supervisión", "alert('No puede modificar este convenio');", true);
                }
                else if (Grid_Convenios_Impuestos_Derechos_Supervision.SelectedRow.Cells[6].Text.Equals("INCUMPLIDO"))
                {
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "Reestructura de Convenios por Derechos de Supervisión", "alert('La reestructura esta incumplida, es necesario generar una nueva reestructura para continuar.');", true);
                }
                else
                {
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "Reestructura de Convenios por Derechos de Supervisión", "alert('La reestructura se encuentra pagada.');", true);
        ...
        {
            ScriptManager.RegisterStartupScript(this, this.GetType(), "Reestructura de Convenios por Derechos de Supervisión", "alert('Seleccione una reestructura por favor.');", true);
        }
    }
    ...
    protected void Consultar_Datos_Cuenta_Predial()
    {
        ...
        if (Txt_Cuenta_Predial.Text.Trim() != "")
        {
            ...
            if (Dt_Cuentas_Predial.Rows.Count > 0)
            {
                ...
                Impuestos_Derechos_Supervision.P_Campos_Dinamicos = Ope_Pre_Impuestos_Derechos_Supervision.Campo_Usuario_Creo + ", " + Ope_Pre_Impuestos_Derechos_Supervision.Campo_Fecha_Creo;
    ...
    {
        Cls_Ope_Pre_Convenios_Derechos_Supervision_Negocio Convenios = new Cls_Ope_Pre_Convenios_Derechos_Supervision_Negocio();
        ...
        Double Sum_Multas = 0;
        Double Sum_Honorarios = 0;
        if (Grid_Convenios_Impuestos_Derechos_Supervision.SelectedRow.Cells[9].Text.Equals("&nbsp;"))
        {
        ...
        foreach (DataRow Row in Dt_Adeudos.Rows)
        {
            ...
            //    Sum_Totales += Convert.ToDouble(Row[Ope_Pre_Detalles_Impuestos_Derechos_Supervision.Campo_Total].ToString());
            //}
            if (Row[Ope_Pre_Detalles_Convenios_Derechos_Supervision.Campo_Monto_Impuesto] != null
                    && Row[Ope_Pre_Detalles_Convenios_Derechos_Supervision.Campo_Monto_Impuesto].ToString() != "")
            {
                Sum_Impuestos += Convert.ToDouble(Row[Ope_Pre_Detalles_Convenios_Derechos_Supervision.Campo_Monto_Impuesto].ToString());
            }
            else
            {
                Sum_Impuestos += 0.00;
            }
            if (Row[Ope_Pre_Detalles_Convenios_Derechos_Supervision.Campo_Recargos_Ordinarios] != null
                && Row[Ope_Pre_Detalles_Convenios_Derechos_Supervision.Campo_Recargos_Ordinarios].ToString() != "")
            {
                Sum_Recargos_Ordinarios += Convert.ToDouble(Row[Ope_Pre_Detalles_Convenios_Derechos_Supervision.Campo_Recargos_Ordinarios].ToString());
            }
            else
            {
                Sum_Recargos_Ordinarios += 0.00;
            }
            if (Row[Ope_Pre_Detalles_Convenios_Derechos_Supervision.Campo_Recargos_Moratorios] != null
                && Row[Ope_Pre_Detalles_Convenios_Derechos_Supervision.Campo_Recargos_Moratorios].ToString() != "")
            {
                Sum_Recargos_Moratorios += Convert.ToDouble(Row[Ope_Pre_Detalles_Convenios_Derechos_Supervision.Campo_Recargos_Moratorios].ToString());
            }
            else
            {
            ...
            if (Row[Ope_Pre_Detalles_Convenios_Derechos_Supervision.Campo_Monto_Multas] != null
                && Row[Ope_Pre_Detalles_Convenios_Derechos_Supervision.Campo_Monto_Multas].ToString() != "")
            {
                Sum_Multas += Convert.ToDouble(Row[Ope_Pre_Detalles_Convenios_Derechos_Supervision.Campo_Monto_Multas].ToString());
            }
            else
            {
                Sum_Multas += 0.00;
    ...
    ///CAUSA_MODIFICACIÓN:
    ///*******************************************************************************
    private DataSet Crear_Ds_Reestructura_Convenios_Derechos_Supervision()
    {
        Ds_Pre_Reestructura_Derechos_Supervision Ds_Reestructura_Derechos_Supervision = new Ds_Pre_Reestructura_Derechos_Supervision();
        ...
        DataTable Dt_Convenios_Derechos = Ds_Reestructura_Derechos_Supervision.Tables["Dt_Pre_Reestructura_Derechos_Supervision"];
        Convenios_Derechos.P_Mostrar_Detalles_Con_Reestructura = true;
        ...
        foreach (DataRow Dr_Temp in Dt_Temp.Rows)
        {
            ...
            Dr_Convenios_Derechos["NO_CONVENIO"] = Dr_Temp[Ope_Pre_Convenios_Derechos_Supervision.Campo_No_Convenio].ToString() + Dr_Temp[Ope_Pre_Convenios_Derechos_Supervision.Campo_No_Reestructura].ToString();
        ...
        Dt_Convenios_Derechos = Ds_Reestructura_Derechos_Supervision.Tables["Dt_Pre_Reestructura_Det_Derechos_Supervision"];
        ...
        Dt_Convenios_Derechos = Ds_Reestructura_Derechos_Supervision.Tables["Dt_Pre_Cuentas_Predial"];
        Cuentas_Predial.P_Cuenta_Predial_ID = Hdf_Cuenta_Predial_ID.Value;
        ...
        {
            Dt_Convenios_Derechos = Ds_Reestructura_Derechos_Supervision.Tables["Dt_Ate_Colonias"];
        ...
        {
            Dt_Convenios_Derechos = Ds_Reestructura_Derechos_Supervision.Tables["Dt_Pre_Calles"];
        ...
        return Ds_Reestructura_Derechos_Supervision;
    }
    ...
    {
        string Ruta_Plantilla = Server.MapPath("PlantillasWord/" + "Formato_Reestructura_Convenio_Der_Sup.docx");
        string Documento_Salida = Server.MapPath("../../Reporte/" + "Reestructura_Convenio_Der_Sup.docx");
        ...
        ReportDocument Reporte = new ReportDocument();
        String Nombre_Archivo = "Reestructura_Convenio_Der_Sup.docx";
        ...
        if (!DateTime.TryParse(Txt_Fecha_Calculo.Text, out Fecha_Convenio))
        ...
        try
        {
            ...
            String Pagina = "../Paginas_Generales/Frm_Apl_Mostrar_Reportes.aspx?Reporte=";
            Pagina = Pagina + "Reestructura_Convenio_Der_Sup.docx";
            ...
            if (Renglon_Actual.Cells[8].Text == "POR PAGAR")
            {
                ...
                if (DateTime.Compare(Fecha_Actual, Fecha_Vencimiento) == 1)
                {
                    if (Renglon_Actual.Cells[0].Text != "1")
                    {
                        ...
                        Convenio_Der_Sup.P_No_Reestructura = Txt_Numero_Reestructura.Text;
                        Convenio_Der_Sup.Convenio_Incumplido();
                        Cargar_Convenio();
                        ScriptManager.RegisterStartupScript(this, this.GetType(), "Reestructura de Convenios por Derecho de supervisión", "alert('Reestructura de Convenio Incumplida');", true);
                    }
                    else
                    {
                        ScriptManager.RegisterStartupScript(this, this.GetType(), "Reestructura de Convenios por Derecho de supervisión", "alert('La reestructura de convenio se encuentra vencida, sin embargo aún puede modificarla.');", true);
                    }
                }
                return;
            }
