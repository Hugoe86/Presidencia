<%@ Page Language="C#" MasterPageFile="~/paginas/Paginas_Generales/MasterPage.master" AutoEventWireup="true" CodeFile="Frm_Cat_Pre_Descuentos_Recargos.aspx.cs" Inherits="paginas_predial_Frm_Cat_Pre_Descuentos_Recargos" Title="Catalogo de Descuentos Recargos" %>
        ...
        <ContentTemplate>
            ...
            <div id="Div_Requisitos" style="background-color:#ffffff; width:100%; height:100%;">
                <table width="98%"  border="0" cellspacing="0" class="estilo_fuente">
                    <tr align="center">
                        <td colspan="2" class="label_titulo">Catálogo de Descuentos Recargos</td>
                    </tr>
                    <tr>
                        <td>
                          <div id="Div_Contenedor_Msj_Error" style="width:98%;" runat="server" visible="false">
                            <table style="width:100%;">
                              ...
                              <tr>
                                ...
                                <td style="width:90%;text-align:left;" valign="top" class="estilo_fuente_mensaje_error">
                    ...
                    <tr class="barra_busqueda" align="right">
                        ...
                        <td>Búsqueda:
                            ...
                            <asp:ImageButton ID="Btn_Buscar_Descuento" runat="server" CausesValidation="false"
                                ...
                                onclick="Btn_Buscar_Descuento_Click" />
                            <cc1:FilteredTextBoxExtender ID="FTE_Txt_Busqueda_Descuento" runat="server" 
                                TargetControlID="Txt_Busqueda_Descuento" FilterType="Numbers" Enabled="True"></cc1:FilteredTextBoxExtender>
                            <cc1:TextBoxWatermarkExtender ID="TWE_Txt_Busqueda_Descuento" runat="server" WatermarkText="<Año>" TargetControlID="Txt_Busqueda_Descuento" WatermarkCssClass="watermarked"></cc1:TextBoxWatermarkExtender>
                        </td>                        
                    </tr>
                </table>   
                <br />
                <table width="96%">
                    ...
                    <tr>
                        <td style="width:18%; text-align:left;">
                            <asp:Label ID="Lbl_ID_Descuento" runat="server" Text="Descuento ID" CssClass="estilo_fuente"></asp:Label></td>
                        <td style="width:82%">
                                    ...
                                    <tr>
                                        ...
                                        <td style="width:20%; text-align:left;">
                                            ...
                                            <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender12" 
                                                    ...
                                                    TargetControlID="Txt_Enero" ValidChars="0123456789." 
                                                    Enabled="True">
                                        ...
                                        <td style="width:20%; text-align:left;">
                                         ...
                                         <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender11" 
                                                    runat="server" FilterType="Custom, Numbers" 
                                                    TargetControlID="Txt_Febrero" ValidChars="0123456789." 
                                                    Enabled="True">
                                            </cc1:FilteredTextBoxExtender>
                                        </td>
                                        <td style="width:13%; text-align:left;">
                                        ...
                                        <td style="width:21%; text-align:left;">
                                           ...
                                           <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender10" 
                                                    runat="server" FilterType="Custom, Numbers" 
                                                    TargetControlID="Txt_Marzo" ValidChars="0123456789." 
                                                    Enabled="True">
                                            </cc1:FilteredTextBoxExtender>
                                        </td>
                                    </tr>    
                                    <tr>
                                        ...
                                        <td style="width:20%; text-align:left;">
                                           ...
                                           <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender9" 
                                                    runat="server" FilterType="Custom, Numbers" 
                                                    TargetControlID="Txt_Abril" ValidChars="0123456789." 
                                                    Enabled="True">
                                            </cc1:FilteredTextBoxExtender>
                                        </td>
                                        <td style="width:13%; text-align:left;">
                                        ...
                                        <td style="width:20%; text-align:left;">
                                           ...
                                           <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender8" 
                                                    runat="server" FilterType="Custom, Numbers" 
                                                    TargetControlID="Txt_Mayo" ValidChars="0123456789." 
                                                    Enabled="True">
                                            </cc1:FilteredTextBoxExtender>
                                        </td>
                                        <td style="width:13%; text-align:left;">
                                        ...
                                        <td style="width:21%; text-align:left;">
                                           ...
                                           <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender7" 
                                                    runat="server" FilterType="Custom, Numbers" 
                                                    TargetControlID="Txt_Junio" ValidChars="0123456789." 
                                                    Enabled="True">
                                            </cc1:FilteredTextBoxExtender>
                                        </td>
                                    </tr>    
                                    <tr>
                                        ...
                                        <td style="width:20%; text-align:left;">
                                           ...
                                           <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender6" 
                                                    runat="server" FilterType="Custom, Numbers" 
                                                    TargetControlID="Txt_Julio" ValidChars="0123456789." 
                                                    Enabled="True">
                                            </cc1:FilteredTextBoxExtender>
                                        </td>
                                        <td style="width:13%; text-align:left;">
                                        ...
                                        <td style="width:20%; text-align:left;">
                                           ...
                                           <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender5" 
                                                    runat="server" FilterType="Custom, Numbers" 
                                                    TargetControlID="Txt_Agosto" ValidChars="0123456789." 
                                                    Enabled="True">
                                            </cc1:FilteredTextBoxExtender>
                                        </td>
                                        <td style="width:13%; text-align:left;">
                                            <asp:Label ID="Lbl_Septiembre" runat="server" Text="Septiembre (%)" 
                                                CssClass="estilo_fuente"></asp:Label>
                                        </td>
                                        <td style="width:21%; text-align:left;">
                                       ...
                                       <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender3" 
                                                    runat="server" FilterType="Custom, Numbers" 
                                                    TargetControlID="Txt_Septiembre" ValidChars="0123456789." 
                                                    Enabled="True">
                                            </cc1:FilteredTextBoxExtender>
                                        </td>
                                    </tr>    
                                    <tr>
                                        ...
                                        <td style="width:20%; text-align:left;">
                                           ...
                                           <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender2" 
                                                    runat="server" FilterType="Custom, Numbers" 
                                                    TargetControlID="Txt_Octubre" ValidChars="0123456789." 
                                                    Enabled="True">
                                            </cc1:FilteredTextBoxExtender>
                                        </td>
                                        ...
                                        <td style="width:20%; text-align:left;">
                                           ...
                                           <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender1" 
                                                    runat="server" FilterType="Custom, Numbers" 
                                                    TargetControlID="Txt_Noviembre" ValidChars="0123456789." 
                                                    Enabled="True">
                                            </cc1:FilteredTextBoxExtender>
                                        </td>
                                        <td style="width:17%; text-align:left;">
                                        ...
                                        <td style="width:21%; text-align:left;">
                                           ...
                                           <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender4" 
                                                    runat="server" FilterType="Custom, Numbers" 
                                                    TargetControlID="Txt_Diciembre" ValidChars="0123456789." 
                                                    Enabled="True">
                                            </cc1:FilteredTextBoxExtender>
                                        </td>
                                    </tr>                                                        
                ...
                <br />                                
                <asp:GridView ID="Grid_Descuentos" runat="server" CssClass="GridView_1"
                    AutoGenerateColumns="False" AllowPaging="True" PageSize="5" Width="96%"
                    EmptyDataText="&quot;No se encontraron registros&quot;"
                    onselectedindexchanged="Grid_Descuentos_SelectedIndexChanged" 
                    GridLines= "None"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="DESCUENTO_ID" HeaderText="Descuento ID" 
                            SortExpression="DESCUENTO_ID" />
