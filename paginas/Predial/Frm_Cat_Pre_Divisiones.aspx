<%@ Page Language="C#" MasterPageFile="~/paginas/Paginas_Generales/MasterPage.master"
    AutoEventWireup="true" CodeFile="Frm_Cat_Pre_Divisiones.aspx.cs" Inherits="paginas_predial_Frm_Cat_Pre_Divisiones"
    Title="Catalogo de Divisiones" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Cph_Area_Trabajo1" runat="Server">
    <asp:ScriptManager ID="ScptM_Divisiones" runat="server" />
            ...
            <div id="Div_Requisitos" style="background-color: #ffffff; width: 100%; height: 100%;">
                <table width="98%" border="0" cellspacing="0" class="estilo_fuente">
                    ...
                    <tr class="barra_busqueda" align="right">
                        ...
                        <td>
                            Búsqueda:
                            <asp:TextBox ID="Txt_Busqueda_Division" runat="server" Width="130px"></asp:TextBox>
                            <asp:ImageButton ID="Btn_Buscar_Division" runat="server" CausesValidation="false"
                                ImageUrl="~/paginas/imagenes/paginas/busqueda.png" ToolTip="Buscar" OnClick="Btn_Buscar_Division_Click" />
                            <cc1:TextBoxWatermarkExtender ID="TWE_Txt_Busqueda_Division" runat="server" WatermarkText="<Descripción>"
                                TargetControlID="Txt_Busqueda_Division" WatermarkCssClass="watermarked">
                            </cc1:TextBoxWatermarkExtender>
                            <cc1:FilteredTextBoxExtender ID="FTE_Txt_Busqueda_Division" runat="server" TargetControlID="Txt_Busqueda_Division"
                ...
                <cc1:TabContainer ID="Tab_Contenedor_Pestagnas" runat="server" Width="98%" 
                    ...
                    <cc1:TabPanel runat="server" HeaderText="TabPanel1" ID="TabPanel1" Width="100%">
                        <HeaderTemplate>
                            Divisiones</HeaderTemplate>
                        <ContentTemplate>
                            <center>
                                <table width="100%">
                                    <tr>
                                        <td colspan="4">
                                            <asp:HiddenField ID="Hdf_Division_ID" runat="server" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width: 18%; text-align: left;">
                                            <asp:Label ID="Lbl_ID_Division" runat="server" Text="División ID" CssClass="estilo_fuente"></asp:Label>
                                        </td>
                                        <td style="width: 32%">
                                            <asp:TextBox ID="Txt_ID_Division" runat="server" Width="98%" MaxLength="10" Enabled="False"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                    ...
                    <cc1:TabPanel runat="server" HeaderText="TabPanel2" ID="TabPanel2" Width="100%">
                        <HeaderTemplate>
                            Divisiones - Impuestos</HeaderTemplate>
                        <ContentTemplate>
                            <center>
                                <table width="100%">
                                    <tr>
                                        <td colspan="4">
                                            <asp:HiddenField ID="Hdf_Division_Impuesto_ID" runat="server" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width: 18%; text-align: left;">
                                            <asp:Label ID="Lbl_Impuesto_ID" runat="server" Text="Divisi&oacute;n Impuesto ID"
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 35%; text-align: left;">
                                            <asp:TextBox ID="Txt_Tasa" runat="server" Width="98%" MaxLength="6" ></asp:TextBox>
                                ...
                                <br />
                                <asp:GridView ID="Grid_Divisiones_Impuesto" runat="server" CssClass="GridView_1"
                                    AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None"
                                    AllowPaging="True" Width="98%" OnPageIndexChanging="Grid_Divisiones_Impuesto_PageIndexChanging"
                                    PageSize="5">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="IMPUESTO_DIVISION_LOT_ID" HeaderText="IMPUESTO_DIVISION_LOT_ID"
                                            SortExpression="Id_Impuesto" />
                                        <asp:BoundField DataField="ANIO" HeaderText="Año" SortExpression="Identificador" />
                                        <asp:BoundField DataField="TASA" HeaderText="Tasa" SortExpression="Estatus" />
                                    </Columns>
                ...
                <table id="Tbl_Divisiones" border="0" cellspacing="0" class="estilo_fuente" style="width: 100%;">
                    <tr>
                        <asp:GridView ID="Grid_Divisiones_Generales" runat="server" CssClass="GridView_1"
                            AutoGenerateColumns="False" AllowPaging="True" PageSize="5" Width="98%" OnSelectedIndexChanged="Grid_Divisiones_Generales_SelectedIndexChanged"
                            GridLines="None" OnPageIndexChanging="Grid_Divisiones_Generales_PageIndexChanging"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="DIVISION_ID" HeaderText="Divisi&oacute;n ID" SortExpression="DIVISION_ID">
