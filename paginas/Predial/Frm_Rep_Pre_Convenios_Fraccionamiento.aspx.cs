...
public partial class paginas_Predial_Frm_Rep_Pre_Convenios_Fraccionamiento : System.Web.UI.Page
{
    ...
    private DataSet Crear_Ds_Exportar_Reporte()
    {
        ...
        if (Cmb_Incluir_Reestructuras.SelectedIndex > 0)
        {
            ...
            if (Cmb_Incluir_Reestructuras.SelectedIndex == 1)
            {
                ...
                Mensaje_Incluidos = "Convenios de fraccionamiento" + Mensaje_Incluidos;
            }
            ...
            else if (Cmb_Incluir_Reestructuras.SelectedIndex == 2)
            {
                ...
                Mensaje_Incluidos = "Reestructuras de fraccionamiento" + Mensaje_Incluidos;
            }
        }
        else
        {
            Mensaje_Incluidos = "Convenios y reestructuras de fraccionamiento" + Mensaje_Incluidos;
        }

        // agregar datos generales al dataset
        var Dr_Convenio = Ds_Convenio.Tables[0].NewRow();
        Dr_Convenio["Titulo"] = "Convenios de fraccionamiento";
        ...
        Dt_Convenios = Consulta_Convenios.Consultar_Convenios_Fraccionamiento_Reporte().Copy();
...
#region EVENTOS
    ...
    protected void Btn_Exportar_pdf_Click(object sender, ImageClickEventArgs e)
    {
        ...
        try
        {
            Exportar_Reporte(Crear_Ds_Exportar_Reporte(), "Rpt_Rep_Pre_Convenios_Traslado_Dominio.rpt", "Reporte_Convenios_Fraccionamiento", "pdf", ExportFormatType.PortableDocFormat);
        }
        catch (Exception Ex)
        {
            Lbl_Mensaje_Error.Visible = true;
    ...
    protected void Btn_Exportar_Excel_Click(object sender, ImageClickEventArgs e)
    {
        ...
        try
        {
            Exportar_Reporte(Crear_Ds_Exportar_Reporte(), "Rpt_Rep_Pre_Convenios_Traslado_Dominio.rpt", "Reporte_Convenios_Fraccionamiento", "xls", ExportFormatType.Excel);
        }
        catch (Exception Ex)
        {
            Lbl_Mensaje_Error.Visible = true;
