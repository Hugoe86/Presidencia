...
public partial class paginas_Predial_Frm_Ope_Pre_Convenios_Fraccionamiento : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            if (Page.PreviousPage != null)
            {
                ...
                Hdf_No_Impuesto_Fraccionamiento.Value = PreviousPage.No_Impuesto_Fraccionamiento;
                ...
                Impuesto.P_No_Impuesto_Fraccionamiento = Hdf_No_Impuesto_Fraccionamiento.Value;
                DataTable Tabla;
                Tabla = Impuesto.Consultar_Impuestos_Con_Convenio();
                if (Tabla != null && Tabla.Rows.Count != 0)
                {
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "Convenios por Impuestos de Fraccionamientos", "alert('Ya existe un Número de Convenio Vigente para este Impuesto');", true);
                ...
                if (Hdf_Cuenta_Predial_ID.Value != "")
                {
                    ...
                    Convenio.P_Filtros_Dinamicos = Ope_Pre_Convenios_Fraccionamientos.Campo_Estatus + " IN ('ACTIVO','PENDIENTE','INCUMPLIDO') AND " + Ope_Pre_Convenios_Fraccionamientos.Campo_Cuenta_Predial_ID + "='" + Convenio.P_Cuenta_Predial_ID + "'";
                    DataTable Dt_Convenio;
                    Dt_Convenio = Convenio.Consultar_Convenio_Fraccionamiento();
                    if (Dt_Convenio != null && Dt_Convenio.Rows.Count != 0)
                    {
                        ScriptManager.RegisterStartupScript(this, this.GetType(), "Convenios por Impuestos de Fraccionamientos", "alert('Ya existe un Número de Convenio para la cuenta predial " + Txt_Cuenta_Predial.Text + "');", true);
                        Btn_Salir_Click(null, null);
                    }
                }
            }
    ...
    ///DESCRIPCIÓN          : Llena la tabla de Convenios por Impuestos de Fraccionamientos con una consulta que puede o no tener Filtros.
    ///PARAMETROS           : 1. Pagina.  Pagina en la cual se mostrará el Grid_VIew
    ///CREO                 : Antonio Salvador Benavides Guardado
            ...
            if (Dt_Convenios_Fraccionamientos != null)
            {
                if (Dt_Convenios_Fraccionamientos.Rows.Count > 0)
                {
                    foreach (DataRow Row in Dt_Convenios_Fraccionamientos.Rows)
                    {
                        ...
                        Hdf_No_Descuento.Value = Row[Ope_Pre_Convenios_Traslados_Dominio.Campo_No_Descuento].ToString();
                        ...
                        Hdf_Desc_Recargos.Value = Convert.ToDouble(Row[Ope_Pre_Convenios_Fraccionamientos.Campo_Descuento_Recargos_Ordinarios]).ToString("###,###,##0.00");
                        ...
                        Hdf_Desc_Multas.Value = Convert.ToDouble(Row[Ope_Pre_Convenios_Fraccionamientos.Campo_Descuento_Multas]).ToString("###,###,##0.00");
    ...
    protected void Grid_Convenios_Impuestos_Fraccionamientos_SelectedIndexChanged(object sender, EventArgs e)
    {
        if (Grid_Convenios_Impuestos_Fraccionamientos.Rows.Count > 0)
        {
            ...
            //Hdf_Propietario_ID.Value = Grid_Convenios_Impuestos_Fraccionamientos.DataKeys[1].Value.ToString();
            Hdf_No_Convenio.Value = Grid_Convenios_Impuestos_Fraccionamientos.SelectedRow.Cells[1].Text;
            Hdf_No_Impuesto_Fraccionamiento.Value = Grid_Convenios_Impuestos_Fraccionamientos.SelectedRow.Cells[9].Text;
            Consultar_Datos_Cuenta_Predial();
            Cargar_Convenio();
            Panel_Datos.Visible = true;
            ...
            Cls_Ope_Pre_Impuestos_Fraccionamientos_Negocio Impuesto = new Cls_Ope_Pre_Impuestos_Fraccionamientos_Negocio();
            Impuesto.P_No_Impuesto_Fraccionamiento = Hdf_No_Impuesto_Fraccionamiento.Value;
            DataTable Dt_Imp = Impuesto.Consultar_Impuestos_Fraccionamiento();
            Txt_Fecha_Calculo.Text = Convert.ToDateTime(Dt_Imp.Rows[0][Ope_Pre_Impuestos_Fraccionamientos.Campo_Fecha_Creo].ToString()).ToString("dd/MMM/yyyy");
            Txt_Fecha_Vencimiento.Text = Convert.ToDateTime(Dt_Imp.Rows[0][Ope_Pre_Impuestos_Fraccionamientos.Campo_Fecha_Vencimiento].ToString()).ToString("dd/MMM/yyyy");
            Txt_Realizo.Text = Dt_Imp.Rows[0][Ope_Pre_Impuestos_Fraccionamientos.Campo_Usuario_Creo].ToString();
        }
            ...
            else
            {
                if (Validar_Componentes())
                {
                    ...
                    else
                    {
                        ...
                        {
                            Convenios_Fraccionamientos.P_Solicitante = Txt_Solicitante.Text.Trim().ToUpper();
                            Convenios_Fraccionamientos.P_RFC = Txt_RFC.Text.Trim().ToUpper();
                        }
                    }
                    ...
                    Convenios_Fraccionamientos.P_Fecha = Convert.ToDateTime(Txt_Fecha_Convenio.Text);
                    Convenios_Fraccionamientos.P_Observaciones = Txt_Observaciones.Text.ToUpper();
                    ...
                    Convenios_Fraccionamientos.P_Descuento_Multas = Convert.ToDouble(Txt_Descuento_Multas.Text);
                    ...
                    Convenios_Fraccionamientos.P_No_Impuesto_Fraccionamiento = Hdf_No_Impuesto_Fraccionamiento.Value;
                    Convenios_Fraccionamientos.P_Propietario_ID = Hdf_Propietario_ID.Value;
                    Convenios_Fraccionamientos.P_No_Descuento = Hdf_No_Descuento.Value.Trim();
                    Convenios_Fraccionamientos.P_Anio = Convert.ToDateTime(Txt_Fecha_Calculo.Text).ToString("yyyy");
                    Convenios_Fraccionamientos.P_Dt_Parcialidades = Crear_Tabla_Parcialidades();
                    if (Convenios_Fraccionamientos.Alta_Convenio_Fraccionamiento())
                    {
                        //Insertar_Pasivo("CFRA"+Convenios_Fraccionamientos.P_No_Convenio);
                        Hdf_No_Convenio.Value = Convenios_Fraccionamientos.P_No_Convenio;
                        Imprimir_Convenio();
                        Imprimir_Reporte(Crear_Ds_Convenios_Folio("CFRA" + Convert.ToInt32(Convenios_Fraccionamientos.P_No_Convenio)), "Rpt_Pre_Folio_Convenios.rpt", "Rpt_Convenio_Fraccionamiento", "Window_Frm", "Convenio");
                        Convenios_Fraccionamientos.Eliminar_Pasivo("IMP" + Convert.ToDateTime(Convenios_Fraccionamientos.Consultar_Datos_A_Eliminar().Rows[0][Ope_Pre_Impuestos_Fraccionamientos.Campo_Fecha_Creo].ToString()).ToString("yy") + Convenios_Fraccionamientos.P_No_Impuesto_Fraccionamiento);
                        Configuracion_Formulario(true);
                        Limpiar_Controles();
                        Cargar_Grid_Convenios_Impuestos_Fraccionamientos(0);
                        ScriptManager.RegisterStartupScript(this, this.GetType(), "Convenios por Fraccionamientos", "alert('Alta de Convenio por Fraccionamiento Exitosa');", true);
                        Btn_Nuevo.AlternateText = "Nuevo";
                        Btn_Nuevo.ImageUrl = "~/paginas/imagenes/paginas/icono_nuevo.png";
                        Btn_Modificar.Visible = true;
                    ...
                    {
                        ScriptManager.RegisterStartupScript(this, this.GetType(), "Convenios por Fraccionamientos", "alert('Alta de Convenio por Fraccionamiento No fue Exitosa');", true);
                    }
                }
            }
        }
    ...
    private DataSet Crear_Ds_Convenios_Folio(String Folio)
    {
        ...
        Dr_Convenio["TIPO_CONVENIO"] = "Convenio de fraccionamiento";
        String Domicilio = "";
    ...
    protected void Btn_Modificar_Click(object sender, ImageClickEventArgs e)
    {
        if (Grid_Convenios_Impuestos_Fraccionamientos.SelectedIndex > -1)
        {
            try
            {
                if (!Grid_Convenios_Impuestos_Fraccionamientos.SelectedRow.Cells[8].Text.Equals("PAGADO") && Grid_Convenios_Impuestos_Fraccionamientos.SelectedRow.Cells[10].Text.Replace("&nbsp;", "").Equals("") && !Grid_Convenios_Impuestos_Fraccionamientos.SelectedRow.Cells[6].Text.Equals("CANCELADO") && !Grid_Convenios_Impuestos_Fraccionamientos.SelectedRow.Cells[6].Text.Equals("INCUMPLIDO") && !Grid_Convenios_Impuestos_Fraccionamientos.SelectedRow.Cells[6].Text.Equals("CUENTA_CANCELADA"))
                {
                    Boton_Pulsado = ((ImageButton)sender).ID;
                    ...
                    else
                    {
                        if (Validar_Componentes())
                        {
                            ...
                            //    {
                            //        ScriptManager.RegisterStartupScript(this, this.GetType(), "Convenios por Fraccionamientos", "alert('No se pueden Cancelar Convenios con parcialidades Pagadas');", true);
                            //        Aceptar_Cambio = false;
                            //    }
                            //    else
                            //    {
                            //        ScriptManager.RegisterStartupScript(this, this.GetType(), "Convenios por Fraccionamientos", "confirm('Confirme que desea Cancelar el Convenio');", true);
                            //        Aceptar_Cambio = false;
                            //    }
                            //}
                            //else
                            ...
                            Convenios_Fraccionamientos.P_Dt_Parcialidades = Crear_Tabla_Parcialidades();
                            Convenios_Fraccionamientos.P_No_Descuento = Hdf_No_Descuento.Value.Trim();
                            if (Convenios_Fraccionamientos.Modificar_Convenio_Fraccionamiento())
                            {
                                Cls_Ope_Pre_Impuestos_Fraccionamientos_Negocio Mod_Conv = new Cls_Ope_Pre_Impuestos_Fraccionamientos_Negocio();
                                if (Cmb_Estatus.SelectedValue != "CANCELADO")
                                {
                                    Mod_Conv.Cancelar_Pasivo("CFRA" + Convert.ToInt32(Convenios_Fraccionamientos.P_No_Convenio), Cmb_Estatus.SelectedValue, Grid_Parcialidades.Rows[0].Cells[6].Text.Replace("$", ""));
                                }
                                else
                                {
                                    Insertar_Pasivo("IMP" + Convert.ToDateTime(Txt_Fecha_Calculo.Text).ToString("yy") + Grid_Convenios_Impuestos_Fraccionamientos.SelectedRow.Cells[9].Text);
                                }
                                if (Cmb_Estatus.SelectedValue == "ACTIVO")
                                {
                                    Imprimir_Convenio();
                ...
                else if (!Grid_Convenios_Impuestos_Fraccionamientos.SelectedRow.Cells[10].Text.Replace("&nbsp;", "").Equals(""))
                {
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "Convenios por Fraccionamientos", "alert('El convenio ya contiene reestructura(s)');", true);
                }
                else if (Grid_Convenios_Impuestos_Fraccionamientos.SelectedRow.Cells[6].Text.Equals("CUENTA_CANCELADA"))
                {
                }
                else if (Grid_Convenios_Impuestos_Fraccionamientos.SelectedRow.Cells[6].Text.Equals("CANCELADO"))
                {
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "Convenios por Fraccionamientos", "alert('El convenio se encuentra cancelado');", true);
                }
                else if (Grid_Convenios_Impuestos_Fraccionamientos.SelectedRow.Cells[6].Text.Equals("INCUMPLIDO"))
                {
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "Convenios por Fraccionamiento", "alert('El convenio esta incumplido, genere una reestructura');", true);
                }
                else
                {
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "Convenios por Fraccionamientos", "alert('No puede modificar el convenio porque ya contiene uno o más pagos realizados.');", true);
                }
            }
            catch (Exception Ex)
            {
        ...
        {
            ScriptManager.RegisterStartupScript(this, this.GetType(), "Convenios por Fraccionamientos", "alert('Seleccione un convenio por favor.');", true);
        }
    }
    ...
    private Boolean Validar_Existe_Convenio_Activo(String No_Impuesto_Fraccionamiento, String Cuenta_Predial_ID)
    {
        ...
        {
            Cls_Ope_Pre_Convenios_Fraccionamientos_Negocio Convenios_Fraccionamientos_Activos = new Cls_Ope_Pre_Convenios_Fraccionamientos_Negocio();
            Convenios_Fraccionamientos_Activos.P_Campos_Dinamicos = Ope_Pre_Convenios_Fraccionamientos.Campo_No_Convenio;
            Convenios_Fraccionamientos_Activos.P_Filtros_Dinamicos = "(";
            DataTable Dt_Convenios_Fraccionamientos_Activos;
            if (No_Impuesto_Fraccionamiento != "")
            {
                Convenios_Fraccionamientos_Activos.P_Filtros_Dinamicos += Ope_Pre_Convenios_Fraccionamientos.Campo_No_Impuesto_Fraccionamiento + "='" + No_Impuesto_Fraccionamiento + "' OR ";
            }
            if (Cuenta_Predial_ID != "")
            {
                Convenios_Fraccionamientos_Activos.P_Filtros_Dinamicos += Ope_Pre_Convenios_Fraccionamientos.Campo_Cuenta_Predial_ID + "='" + Cuenta_Predial_ID + "') AND ";
            }
            if (No_Impuesto_Fraccionamiento != "" || Cuenta_Predial_ID != "")
            {
                Convenios_Fraccionamientos_Activos.P_Filtros_Dinamicos += Ope_Pre_Convenios_Fraccionamientos.Campo_Estatus + " IN ('ACTIVO','PENDIENTE','INCUMPLIDO')";
                Dt_Convenios_Fraccionamientos_Activos = Convenios_Fraccionamientos_Activos.Consultar_Convenio_Fraccionamiento();
                if (Dt_Convenios_Fraccionamientos_Activos.Rows.Count > 0)
                {
    ...
    protected void Btn_Imprimir_Click(object sender, ImageClickEventArgs e)
    {
        ...
        {
            if (Grid_Convenios_Impuestos_Fraccionamientos.SelectedRow.Cells[8].Text.Equals("PAGADO"))
            {
                Imprimir_Convenio();
            }
            else
            {
                ...
                Lbl_Ecabezado_Mensaje.Text = "-El Convenio debe estar Pagado para poderlo Imprimir";
                Div_Contenedor_Msj_Error.Visible = true;
            }
        }
        else
        {
            Lbl_Ecabezado_Mensaje.Visible = true;
            Lbl_Ecabezado_Mensaje.Text = "-Seleccione un Convenio Pagado para Imprimir";
            Div_Contenedor_Msj_Error.Visible = true;
        }
    }
    ...
    {
        string Ruta_Plantilla = Server.MapPath("PlantillasWord/" + "Formato_Convenio_Fraccionamiento.docx");
        string Documento_Salida = Server.MapPath("../../Reporte/" + "Convenio_Fraccionamiento.docx");
        ...
        ReportDocument Reporte = new ReportDocument();
        String Nombre_Archivo = "Convenio_Fraccionamiento.docx";
        ...
        try
        {
            ...
            String Pagina = "../Paginas_Generales/Frm_Apl_Mostrar_Reportes.aspx?Reporte=";
            Pagina = Pagina + "Convenio_Fraccionamiento.docx";
    ...
    protected void Grid_Impuestos_Derechos_Supervision_SelectedIndexChanged(object sender, EventArgs e)
    {
        if (Grid_Impuestos_Derechos_Supervision.Rows.Count > 0)
        {
            ...
            {
                Hdf_No_Impuesto_Fraccionamiento.Value = Grid_Impuestos_Derechos_Supervision.SelectedRow.Cells[1].Text;
            ...
            {
                ScriptManager.RegisterStartupScript(this, this.GetType(), "Convenios por Impuestos de Fraccionamientos", "alert('Ya existe un Número de Convenio Activo para este Impuesto');", true);
                Btn_Salir_Click(null, null);
            }
        }
        Cargar_Ventana_Emergente_Resumen_Predio();
    ...
    private void Cargar_Grid_Impuestos_Derechos_Supervision(Int32 Pagina)
    {
        try
        {
            Cls_Ope_Pre_Impuestos_Fraccionamientos_Negocio Impuestos_Derecho_Supervision = new Cls_Ope_Pre_Impuestos_Fraccionamientos_Negocio();
            ...
            Impuestos_Derecho_Supervision.P_Campos_Dinamicos += Ope_Pre_Impuestos_Fraccionamientos.Campo_No_Impuesto_Fraccionamiento + ", ";
            Impuestos_Derecho_Supervision.P_Campos_Dinamicos += Ope_Pre_Impuestos_Fraccionamientos.Campo_Cuenta_Predial_ID + ", ";
            Impuestos_Derecho_Supervision.P_Campos_Dinamicos += Ope_Pre_Impuestos_Fraccionamientos.Campo_Fecha_Vencimiento + ", ";
            Impuestos_Derecho_Supervision.P_Campos_Dinamicos += Ope_Pre_Impuestos_Fraccionamientos.Campo_Estatus;
            if (Txt_Busqueda_No_Impuesto.Text.Trim() != "")
            {
                Impuestos_Derecho_Supervision.P_Filtros_Dinamicos = "(";
                Impuestos_Derecho_Supervision.P_Filtros_Dinamicos += Ope_Pre_Impuestos_Fraccionamientos.Campo_No_Impuesto_Fraccionamiento + " LIKE '%" + Txt_Busqueda_No_Impuesto.Text.Trim() + "%'";
            ...
            if (Txt_Busqueda_Cuenta_Predial.Text.Trim() != "")
            {
                ...
                Impuestos_Derecho_Supervision.P_Filtros_Dinamicos += Ope_Pre_Impuestos_Fraccionamientos.Campo_Cuenta_Predial_ID + " IN (SELECT " + Cat_Pre_Cuentas_Predial.Campo_Cuenta_Predial_ID + " FROM " + Cat_Pre_Cuentas_Predial.Tabla_Cat_Pre_Cuentas + " WHERE " + Cat_Pre_Cuentas_Predial.Campo_Cuenta_Predial + " LIKE '%" + Txt_Busqueda_Cuenta_Predial.Text.ToUpper() + "%')";
            }
            if (Impuestos_Derecho_Supervision.P_Filtros_Dinamicos != null && Impuestos_Derecho_Supervision.P_Filtros_Dinamicos != "")
            {
                Impuestos_Derecho_Supervision.P_Filtros_Dinamicos += " AND ";
            ...
            Impuestos_Derecho_Supervision.P_Filtros_Dinamicos += Ope_Pre_Impuestos_Fraccionamientos.Campo_Estatus + " = 'POR PAGAR'";

            if (Hdf_No_Impuesto_Fraccionamiento.Value.Length != 0)
            {
                Impuestos_Derecho_Supervision.P_Filtros_Dinamicos += " AND " + Ope_Pre_Impuestos_Fraccionamientos.Campo_No_Impuesto_Fraccionamiento + "='" + Hdf_No_Impuesto_Fraccionamiento.Value + "'";
            }
            if (Hdf_Cuenta_Predial_ID.Value.Length != 0)
            {
                Impuestos_Derecho_Supervision.P_Filtros_Dinamicos += " AND " + Ope_Pre_Impuestos_Fraccionamientos.Campo_Cuenta_Predial_ID + "='" + Hdf_Cuenta_Predial_ID.Value + "'";
            }
            if (Txt_Busqueda_No_Impuesto.Text.Length != 0)
            {
                Impuestos_Derecho_Supervision.P_Filtros_Dinamicos += " AND " + Ope_Pre_Impuestos_Fraccionamientos.Campo_No_Impuesto_Fraccionamiento + " LIKE '%" + Txt_Busqueda_No_Impuesto.Text + "%'";
            }
            if (Impuestos_Derecho_Supervision.P_Filtros_Dinamicos != null && Impuestos_Derecho_Supervision.P_Filtros_Dinamicos != "")
            {
                Impuestos_Derecho_Supervision.P_Filtros_Dinamicos += " AND ";
            ...
            DataTable Tabla = Impuestos_Derecho_Supervision.Consultar_Impuestos_Fraccionamiento();
            if (Tabla != null)
            {
            ...
            if (Renglon_Actual.Cells[8].Text == "POR PAGAR")
            {
                ...
                if (DateTime.Compare(Fecha_Actual, Fecha_Vencimiento) == 1)
                {
                    if (Renglon_Actual.Cells[0].Text != "1")
                    {
                        ...
                        Cargar_Convenio();
                        ScriptManager.RegisterStartupScript(this, this.GetType(), "Convenios por Fraccionamiento", "alert('Convenio incumplido');", true);
                    }
                    else
                    {
                        ScriptManager.RegisterStartupScript(this, this.GetType(), "Convenios por Fraccionamiento", "alert('El convenio se encuentra vencido, sin embargo aún puede modificarlo.');", true);
                    }
                }
                return;
            }
