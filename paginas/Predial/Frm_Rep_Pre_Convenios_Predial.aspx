<%@ Page Title="" Language="C#" MasterPageFile="~/paginas/Paginas_Generales/MasterPage.master"
    AutoEventWireup="true" CodeFile="Frm_Rep_Pre_Convenios_Predial.aspx.cs" Inherits="paginas_Predial_Frm_Rep_Pre_Convenios_Predial"
            ...
            <div id="Div_Contenido" style="background-color: #ffffff; width: 100%; height: 100%;">
                <table width="100%" class="estilo_fuente">
                    <tr align="center">
                        <td colspan="4" class="label_titulo">
                            Reporte de convenios de predial
                        </td>
                    </tr>
                    <tr>
                        <td colspan="4">
                                    ...
                                    <tr>
                                        <td align="left" style="width: 59%;">
                                            ...
                                            <asp:ImageButton ID="Btn_Exportar_Excel" runat="server" ToolTip="Exportar a Excel"
                                                CssClass="Img_Button" TabIndex="1" ImageUrl="~/paginas/imagenes/paginas/icono_rep_excel.png"
                ...
                <table width="98%" class="estilo_fuente">
                    ...
                    <tr>
                        ...
                        <td style="text-align: left; width: 30%;">
                            <asp:TextBox ID="Txt_Fecha_Inicial" runat="server" Width="84%" MaxLength="11" TabIndex="5" />
                        ...
                        <td style="text-align: left; width: 30%;">
                            <asp:TextBox ID="Txt_Fecha_Final" runat="server" Width="84%" MaxLength="11" Height="18px"
                                TabIndex="6" />
                    ...
                    <tr>
                        ...
                        <td style="text-align: left; width: 30%;">
                            <asp:DropDownList ID="Cmb_Tipo" runat="server" Width="97%" TabIndex="4">
                    ...
                    <tr>
                        ...
                        <td style="text-align: left; width: 30%;">
                            <asp:DropDownList ID="Cmb_Ordenar_Campo" runat="server" Width="97%" TabIndex="3">
                                <asp:ListItem Text="CONTRIBUYENTE" Value="NOMBRE_SOLICITANTE" />
                        ...
                        <td style="text-align: left; width: 30%;">
                            <asp:DropDownList ID="Cmb_Orden_Asc_Desc" runat="server" Width="97%" TabIndex="4">
