<%@ Page Title="" Language="C#" AutoEventWireup="true" MasterPageFile="~/paginas/Paginas_Generales/MasterPage.master"
CodeFile="Frm_Ope_Pre_PAE_Almoneda.aspx.cs" Inherits="paginas_Predial_Frm_Ope_Pre_PAE_Almoneda" %>
...
<!--SCRIPT PARA LA VALIDACION QUE NO EXPERE LA SESSION-->  
  ...
  <asp:Content ID="Content3" ContentPlaceHolderID="Cph_Area_Trabajo1" runat="Server">
    <cc1:ToolkitScriptManager ID="Tsm_Almonedas" runat="server"  AsyncPostBackTimeout="3600" EnableScriptGlobalization="true"/>    
                                            ...
                                            <table style="width: 100%; height: 28px;">
                                                <tr>
                                                    <td align="left" style="width: 59%;">
                                                        ...
                                                        <asp:ImageButton ID="Btn_Imprimir" runat="server" ToolTip="Imprimir" CssClass="Img_Button" OnClick="Btn_Imprimir_Click"
                ...
                <div id="Div_Generacion" runat="server">
                    ...
                    <%---------------- Cuentas Rezago ----------------%>
                        ...
                        <tr>
                            ...
                            <td>
                               <asp:DropDownList ID="Cmb_Despacho_Filtro" runat="server" AutoPostBack="true" 
                                    TabIndex="7" 
                                    Width="99%">
                                </asp:DropDownList>
                            </td>
                        ...
                        <tr align="center">
                            <td colspan="4">
                                <asp:GridView ID="Grid_Cuentas_Omitidas" runat="server" AllowPaging="True" CssClass="GridView_1"
                                    ...
                                    Style="white-space: normal;" OnPageIndexChanging="Grid_Cuentas_Omitidas_PageIndexChanging" OnSelectedIndexChanged="Grid_Cuentas_Omitidas_SelectedIndexChanged">
                                    <Columns>
                                        <asp:ButtonField ButtonType="Image" CommandName="Select" ImageUrl="~/paginas/imagenes/gridview/blue_button.png">
                                            <ItemStyle Width="4%" HorizontalAlign="Center" />
                                        </asp:ButtonField>
                                        <asp:BoundField DataField="CUENTA_PREDIAL_ID" HeaderText="Cuenta_Id"/>
                                        <asp:BoundField DataField="CUENTA_PREDIAL" HeaderText="Cuenta" HeaderStyle-Width="9%" >
                                            <HeaderStyle Width="9%" />
                                        </asp:BoundField>
                        ...
                        <%---------------- Cuentas a listas para Almonedas ----------------%>
                        <tr style="background-color: #36C;">
                            <td style="text-align: left; font-size: 15px; color: #FFF;" colspan="4">
                                Cuentas a generar almoneda
                            </td>
                        </tr>
                        <tr align="center">
                            <td colspan="4">
                                <asp:GridView ID="Grid_Cuentas_Generar" runat="server" AllowPaging="True" CssClass="GridView_1"
                                    AutoGenerateColumns="False" PageSize="5" Width="100%" AllowSorting="True" HeaderStyle-CssClass="tblHead"
                                    Style="white-space: normal;" OnPageIndexChanging="Grid_Cuentas_Generar_PageIndexChanging" OnSelectedIndexChanged="Grid_Cuentas_Generar_SelectedIndexChanged">
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="MULTAS" HeaderText="Multas" DataFormatString="{0:C2}"/>
                                        <asp:BoundField DataField="ADEUDO" HeaderText="Adeudo" DataFormatString="{0:C2}"/>
                                        <asp:BoundField DataField="NO.ALMONEDA" HeaderText="No. Almoneda" />
                                        <asp:TemplateField>
                                                    <ItemTemplate>
                        ...
                        <tr>
                            ...
                            <td style="text-align: left; width: 30%;">
                                <asp:TextBox ID="Txt_Total_Almoneda" runat="server" Width="96.4%" 
                                    ReadOnly="True" />
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td style="text-align: left; width: 30%;">
                                <asp:DropDownList ID="Cmb_Despachos" runat="server" Width="99%" TabIndex="7" OnSelectedIndexChanged="Cmb_Despachos_SelectedIndexChanged"
                                    AutoPostBack="true">
                                </asp:DropDownList>
                            <td style="text-align: left; width: 20%; text-align: right;">
                                Número de entrega
                    ...
                    <table width="98%" class="estilo_fuente">
                        <caption>
                            ...
                            <tr>
                                ...
                                <td style="text-align: left; width: 30%;">
                                    ...
                                    <asp:ImageButton ID="Btn_Seleccionar_Propietario" runat="server" Height="22px" 
                                        ...
                                        TabIndex="10"  OnClick="Btn_Seleccionar_Propietario_Click"
                            ...
                            <tr>
                                ...
                                <td style="text-align: left; width: 30%;">
                                    ...
                                    <asp:ImageButton ID="Btn_Busca_Domicilio" runat="server" Height="22px" 
                                        ImageUrl="~/paginas/imagenes/paginas/Busqueda_00001.png" OnClick="Btn_Busca_Domicilio_Click"
                                         Width="22px"  /><%--onclick="Btn_Busca_Domicilio_Click"--%>
                                </td>
                                <td style="text-align: left; width: 20%; text-align: right;">
                                    Tipo domicilio
                                </td>
                            ...
                            <tr>
                                ...
                                <td style="text-align: left; width: 30%;">
                                    <asp:DropDownList ID="Cmb_Estatus" runat="server" TabIndex="7" Width="99%">                                        <asp:ListItem Text="&lt;--SELECCIONE--&gt;" Value="0" />
                            ...
                            <tr>
                                ...
                                <td colspan="2" style="text-align: left; width: 20%; text-align: right;">
                                    <asp:Label ID="Lbl_Busqueda" runat="server" Text="Buscar Almonedas"></asp:Label>
                                    <asp:ImageButton ID="Btn_Buscar_Almonedas" runat="server" OnClick="Btn_Buscar_Almonedas_Click"
                                        ImageUrl="~/paginas/imagenes/paginas/icono_consultar.png"    
                                         /><%--onclick="Btn_Buscar_Determinaciones_Click"--%>
                                    &nbsp;
                                </td>
                            </tr>
                            <tr align="center">
                                <td colspan="4">
                                    <asp:GridView ID="Grid_Almonedas_Generadas" runat="server" 
                                        ...
                                        Width="100%" OnPageIndexChanging="Grid_Almonedas_Generadas_PageIndexChanging" >
                                        <Columns>
