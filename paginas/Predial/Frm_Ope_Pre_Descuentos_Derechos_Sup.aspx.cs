...
using Presidencia.Ope_Pre_Descuentos_Der_Sup.Negocio;
...
public partial class paginas_Predial_Frm_Ope_Pre_Descuentos_Derechos_Sup : System.Web.UI.Page
{
    #region Page_Load
    ...
    private void Cargar_Grid_Impuestos_Derechos_Supervision(Int32 Pagina)
    {
        try
        {
            ...
            //if (Hdf_No_Impuesto_Der_Sup.Value.Length != 0)
            //{
            //    Impuestos_Derecho_Supervision.P_Filtros_Dinamicos += " AND " + Ope_Pre_Impuestos_Derechos_Supervision.Campo_No_Impuesto_Derecho_Supervision + "='" + Hdf_No_Impuesto_Der_Sup.Value + "'";
            //}
            ...
            Impuestos_Derecho_Supervision.P_Filtros_Dinamicos += " AND " + Ope_Pre_Impuestos_Derechos_Supervision.Campo_No_Impuesto_Derecho_Supervision + " NOT IN (SELECT " + Ope_Pre_Descuento_Der_Sup.Tabla_Ope_Pre_Descuento_Der_Sup + "." + Ope_Pre_Descuento_Der_Sup.Campo_No_Impuesto_Derecho_Supervision + " FROM " + Ope_Pre_Descuento_Der_Sup.Tabla_Ope_Pre_Descuento_Der_Sup + " WHERE " + Ope_Pre_Descuento_Der_Sup.Campo_Estatus + " IN ('VIGENTE','BAJA'))";
    ...
    private void Cargar_Grid_Descuentos_Derechos_Supervision(Int32 Pagina)
    {
        try
        {
            Cls_Ope_Pre_Descuentos_Der_Sup_Negocio Descuentos = new Cls_Ope_Pre_Descuentos_Der_Sup_Negocio();
            ...
            switch (Indice)
            {
                ...
                case 2:
                    ...
                    try
                    {
                        ...
                        Descuentos.P_No_Impuesto_Derecho_Supervision = string.Format("{0:0000000000}", No_Impuesto);
                    }
                    catch
                    {
                        Descuentos.P_No_Impuesto_Derecho_Supervision = "";
                    }
                    break;
            }
    ...
    protected void Grid_Impuestos_Derechos_Supervision_SelectedIndexChanged(object sender, EventArgs e)
    {
        if (Grid_Impuestos_Derechos_Supervision.Rows.Count > 0)
        {
            ...
            Cls_Ope_Pre_Descuentos_Der_Sup_Negocio Descuento = new Cls_Ope_Pre_Descuentos_Der_Sup_Negocio();
            Descuento.P_No_Impuesto_Derecho_Supervision = Hdf_No_Impuesto_Der_Sup.Value;
            ...
            if (Dt_Descuento_Existente != null && Dt_Descuento_Existente.Rows.Count > 0)
            {
                ...
                ScriptManager.RegisterStartupScript(this, this.GetType(), "Descuentos de Derechos de Supervisión", "alert('Descuento ya aplicado al Impuesto seleccionado')", true);
            }
            ...
            Impuesto.P_No_Impuesto_Derecho_Supervision = Hdf_No_Impuesto_Der_Sup.Value;
            ...
            if (Dt_Impuesto.Rows.Count == 0)
            {
                ...
                if (Dt_Impuesto.Rows.Count == 0 || (Dt_Impuesto.Rows.Count > 0 && Dt_Impuesto.Rows[0][Ope_Pre_Convenios_Derechos_Supervision.Campo_No_Reestructura].ToString().Equals("")))
                {
                    ...
                    Impuesto.P_No_Impuesto_Derecho_Supervision = Hdf_No_Impuesto_Der_Sup.Value;
                    Impuesto.Consultar_Impuestos_Derecho_Supervisions();
                    Dt_Impuesto = Impuesto.P_Dt_Detalles_Impuestos_Derechos_Supervision;//Almacena los costos del impuesto
                }
                else
                {
        ...
        else
        {
            if (Validar_Campos())
            {
                try
                {
                    ...
                    Cls_Ope_Pre_Impuestos_Derechos_Supervision_Negocio Impuesto = new Cls_Ope_Pre_Impuestos_Derechos_Supervision_Negocio();
                    Impuesto.P_No_Impuesto_Derecho_Supervision = Hdf_No_Impuesto_Der_Sup.Value;
                    Dt_Impuesto = Impuesto.Consultar_Impuestos_Derecho_Supervisions();
                    Insertar_Pasivo("DER" + Convert.ToDateTime(Dt_Impuesto.Rows[0][Ope_Pre_Impuestos_Derechos_Supervision.Campo_Fecha_Creo].ToString()).ToString("yy") + Convert.ToInt32(Hdf_No_Impuesto_Der_Sup.Value), Descuento);
                    Imprimir_Reporte(Crear_Ds_Descuentos(), "Rpt_Ope_Pre_Descuentos_Der_Sup.rpt", "Descuento_Derechos_Supervision");
                    Configuracion_Formulario(false);
                    Limpiar_Componentes();
                    Cargar_Grid_Descuentos_Derechos_Supervision(Grid_Descuentos_Der_Sup.PageIndex);
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "Descuentos de Derechos de Supervisión", "alert('Alta de Descuento Exitosa');", true);
                    ...
                    else
                    {
                        if (Validar_Campos())
                        {
                            try
                            {
                                ...
                                {
                                    Eliminar_Pasivo("DER" + Convert.ToDateTime(Dt_Impuesto.Rows[0][Ope_Pre_Impuestos_Derechos_Supervision.Campo_Fecha_Creo].ToString()).ToString("yy") + Convert.ToInt32(Hdf_No_Impuesto_Der_Sup.Value));
                                }
                                if (Cmb_Estatus.SelectedValue == "VIGENTE")
                                {
                                    Imprimir_Reporte(Crear_Ds_Descuentos(), "Rpt_Ope_Pre_Descuentos_Der_Sup.rpt", "Descuento_Derechos_Supervision");
                                ...
                                Limpiar_Componentes();
                                Cargar_Grid_Descuentos_Derechos_Supervision(Grid_Descuentos_Der_Sup.PageIndex);
                                ScriptManager.RegisterStartupScript(this, this.GetType(), "Descuentos de Derechos de Supervisión", "alert('Actualización de Descuento Exitosa');", true);
    ...
    protected void Txt_Porcentaje_Desc_Recargos_Text_Changed(object sender, EventArgs e)
    {
        ...
        else
        {
            try
            {
                ...
                {
                    if (Dr_Desc[Cat_Pre_Rangos_De_Descuento_Por_Rol.Campo_Tipo].ToString().Equals("DER.SUP."))
                    {
                        if (Convert.ToDouble(Txt_Prcentaje_Desc_Recargos.Text) > Convert.ToDouble(Dr_Desc[Cat_Pre_Rangos_De_Descuento_Por_Rol.Campo_Porcentaje].ToString()))
                        {
                            ...
                            Entro = true;
                            ScriptManager.RegisterStartupScript(this, this.GetType(), "Descuento a Derechos de Supervisión", "alert('El descuento máximo a otorgar en recargos es del: " + Dr_Desc[Cat_Pre_Rangos_De_Descuento_Por_Rol.Campo_Porcentaje].ToString() + "%.')", true);
                        }
                        else
                        {
                            Calcular_Total_A_Pagar();
                ...
                if (Dt_Desc.Rows.Count == 0 || !Entro)
                {
                    Txt_Prcentaje_Desc_Recargos.Text = "0.00";
                    Txt_Monto_Desc_Recargo.Text = "0.00";
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "Descuento a Derechos de Supervisión", "alert('No tiene privilegios para dar descuentos en recargos.')", true);
                }
            }
            catch
            {
        ...
        else
        {
            try
            {
                ...
                foreach (DataRow Dr_Desc in Dt_Desc.Rows)
                {
                    if (Dr_Desc[Cat_Pre_Rangos_De_Descuento_Por_Rol.Campo_Tipo].ToString().Equals("MULTAS"))
                    {
                        if (Convert.ToDouble(Txt_Porcentaje_Desc_Multas.Text) > Convert.ToDouble(Dr_Desc[Cat_Pre_Rangos_De_Descuento_Por_Rol.Campo_Porcentaje].ToString()))
                        {
                            ...
                            Entro = true;
                            ScriptManager.RegisterStartupScript(this, this.GetType(), "Descuento a Derechos de Supervisión", "alert('El descuento máximo a otorgar en multas es del: " + Dr_Desc[Cat_Pre_Rangos_De_Descuento_Por_Rol.Campo_Porcentaje].ToString() + "%.')", true);
                        }
                        else
                        {
                            Calcular_Total_A_Pagar();
                ...
                if (Dt_Desc.Rows.Count == 0 || !Entro)
                {
                    Txt_Porcentaje_Desc_Multas.Text = "0.00";
                    Txt_Monto_Desc_Multas.Text = "0.00";
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "Descuento a Derechos de Supervisión", "alert('No tiene privilegios para dar descuentos en multas.')", true);
                }
            }
            catch
            {
                    ...
                    foreach (DataRow Dr_Desc in Dt_Desc.Rows)
                    {
                        if (Dr_Desc[Cat_Pre_Rangos_De_Descuento_Por_Rol.Campo_Tipo].ToString().Equals("MULTAS"))
                        {
                            if (Convert.ToDouble(Txt_Porcentaje_Desc_Multas.Text) > Convert.ToDouble(Dr_Desc[Cat_Pre_Rangos_De_Descuento_Por_Rol.Campo_Porcentaje].ToString()))
                            {
                                ...
                                Txt_Monto_Desc_Multas.Text = (Monto_Multas * Convert.ToDouble(Dr_Desc[Cat_Pre_Rangos_De_Descuento_Por_Rol.Campo_Porcentaje].ToString()) / 100).ToString("#,###,###,###,###,###,###,##0.00");
                                Entro = true;
                                ScriptManager.RegisterStartupScript(this, this.GetType(), "Descuento a Derechos de Supervisión", "alert('El monto de descuento máximo a otorgar en multas es de: " + Txt_Monto_Desc_Multas.Text + ".')", true);
                            }
                            else
                            {
                                Calcular_Total_A_Pagar();
                    ...
                    foreach (DataRow Dr_Desc in Dt_Desc.Rows)
                    {
                        if (Dr_Desc[Cat_Pre_Rangos_De_Descuento_Por_Rol.Campo_Tipo].ToString().Equals("DER.SUP."))
                        {
                            if (Convert.ToDouble(Txt_Prcentaje_Desc_Recargos.Text) > Convert.ToDouble(Dr_Desc[Cat_Pre_Rangos_De_Descuento_Por_Rol.Campo_Porcentaje].ToString()))
                            {
                                ...
                                Txt_Monto_Desc_Recargo.Text = (Monto_Recargos * Convert.ToDouble(Dr_Desc[Cat_Pre_Rangos_De_Descuento_Por_Rol.Campo_Porcentaje].ToString()) / 100).ToString("#,###,###,###,###,###,###,##0.00");
                                Entro = true;
                                ScriptManager.RegisterStartupScript(this, this.GetType(), "Descuento a Derechos de Supervisión", "alert('El monto de descuento máximo a otorgar en multas es de: " + Txt_Monto_Desc_Recargo.Text + ".')", true);
                            }
                            else
                            {
                                Calcular_Total_A_Pagar();
    ...
    protected void Grid_Descuentos_Der_Sup_Selected_Index_Changed(object sender, EventArgs e)
    {
        if (Grid_Descuentos_Der_Sup.SelectedIndex > -1)
        {
            ...
            if (Dt_Descuentos.Rows.Count > 0)
            {
                ...
                Hdf_No_Impuesto_Der_Sup.Value = Dt_Descuentos.Rows[0][Ope_Pre_Descuento_Der_Sup.Campo_No_Impuesto_Derecho_Supervision].ToString();
                ...
                Llenar_Costos(Dt_Impuesto);
                Txt_Fecha_Inicial.Text = Convert.ToDateTime(Dt_Descuentos.Rows[0][Ope_Pre_Descuento_Der_Sup.Campo_Fecha_Inicial].ToString()).ToString("dd/MMM/yyyy");
                Txt_Fecha_Vencimiento.Text = Convert.ToDateTime(Dt_Descuentos.Rows[0][Ope_Pre_Descuento_Der_Sup.Campo_Fecha_Vencimiento].ToString()).ToString("dd/MMM/yyyy");
                Txt_Realizo.Text = Dt_Descuentos.Rows[0][Ope_Pre_Descuento_Der_Sup.Campo_Realizo].ToString();
                Txt_Observaciones.Text = Dt_Descuentos.Rows[0][Ope_Pre_Descuento_Der_Sup.Campo_Observaciones].ToString();
                Txt_Prcentaje_Desc_Recargos.Text = Convert.ToDouble(Dt_Descuentos.Rows[0][Ope_Pre_Descuento_Der_Sup.Campo_Desc_Recargo].ToString()).ToString("##0.00");
                Txt_Porcentaje_Desc_Multas.Text = Convert.ToDouble(Dt_Descuentos.Rows[0][Ope_Pre_Descuento_Der_Sup.Campo_Desc_Multa].ToString()).ToString("##0.00");
                Txt_Monto_Desc_Multas.Text = Convert.ToDouble(Dt_Descuentos.Rows[0][Ope_Pre_Descuento_Der_Sup.Campo_Monto_Multas].ToString()).ToString("#,###,###,###,###,###,###,##0.00");
                Txt_Monto_Desc_Recargo.Text = Convert.ToDouble(Dt_Descuentos.Rows[0][Ope_Pre_Descuento_Der_Sup.Campo_Monto_Recargos].ToString()).ToString("#,###,###,###,###,###,###,##0.00");
                Txt_Total_Por_Pagar.Text = "$ " + Convert.ToDouble(Dt_Descuentos.Rows[0][Ope_Pre_Descuento_Der_Sup.Campo_Total_Por_Pagar].ToString()).ToString("#,###,###,###,###,###,###,##0.00");
                Cmb_Estatus.SelectedValue = Dt_Descuentos.Rows[0][Ope_Pre_Descuento_Der_Sup.Campo_Estatus].ToString();
                Calcular_Total_A_Pagar();
                Txt_Cuenta_Predial_TextChanged();
                Cls_Ope_Pre_Convenios_Impuestos_Traslado_Dominio_Negocio Cuenta_Pendiente = new Cls_Ope_Pre_Convenios_Impuestos_Traslado_Dominio_Negocio();
                Cuenta_Pendiente.P_Cuenta_Predial_ID = Hdf_Cuenta_Predial_ID.Value;
    ...
    protected Boolean Convenio_Con_Descuento()
    {
        ...
        Convenio.P_Filtros_Dinamicos = Ope_Pre_Convenios_Derechos_Supervision.Campo_No_Descuento + "='" + Hdf_No_Descuento.Value + "' AND " + Ope_Pre_Convenios_Derechos_Supervision.Campo_Estatus + " IN ('ACTIVO','INCUMPLIDO')";
    ...
    private DataTable Obtener_Dato_Consulta(DataTable Dt_Convenio)
    {
        ...
        try
        {
            Mi_SQL = "SELECT SUM(" + Ope_Pre_Detalles_Convenios_Derechos_Supervision.Campo_Monto_Multas + ") AS MONTO, SUM(" + Ope_Pre_Detalles_Convenios_Derechos_Supervision.Campo_Monto_Impuesto + ") AS IMPORTE, SUM(" + Ope_Pre_Detalles_Convenios_Derechos_Supervision.Campo_Recargos_Ordinarios + ") AS RECARGOS FROM " + Ope_Pre_Detalles_Convenios_Derechos_Supervision.Tabla_Ope_Pre_Detalles_Convenios_Derechos_Supervision + " WHERE " + Ope_Pre_Detalles_Convenios_Derechos_Supervision.Campo_No_Convenio + "='" + Dt_Convenio.Rows[0][Ope_Pre_Convenios_Derechos_Supervision.Campo_No_Convenio].ToString() + "' AND ";
            if (Dt_Convenio.Rows[0][Ope_Pre_Convenios_Derechos_Supervision.Campo_No_Reestructura].ToString() == "1")
            {
                Mi_SQL += Ope_Pre_Detalles_Convenios_Derechos_Supervision.Campo_No_Reestructura + " IS NULL AND ";
            }
            else
            {
                Mi_SQL += Ope_Pre_Detalles_Convenios_Derechos_Supervision.Campo_No_Reestructura + "=" + (Convert.ToInt32(Dt_Convenio.Rows[0][Ope_Pre_Convenios_Derechos_Supervision.Campo_No_Reestructura].ToString()) - 1) + " AND ";
            }
            Mi_SQL += Ope_Pre_Detalles_Convenios_Derechos_Supervision.Campo_Estatus + "='CANCELADO'";
    ...
    private String Obtener_Dato_Consulta(String No_Impuesto)
    {
        ...
        try
        {
            Mi_SQL = "SELECT 'DER'||TO_CHAR(" + Ope_Pre_Impuestos_Derechos_Supervision.Campo_Fecha_Creo + ",'YY')||TO_NUMBER(" + Ope_Pre_Impuestos_Derechos_Supervision.Campo_No_Impuesto_Derecho_Supervision + ") AS FOLIO FROM " + Ope_Pre_Impuestos_Derechos_Supervision.Tabla_Ope_Pre_Impuestos_Derechos_Supervision + " WHERE " + Ope_Pre_Impuestos_Derechos_Supervision.Campo_No_Impuesto_Derecho_Supervision + "='" + No_Impuesto + "'";
    ...
    ///CAUSA_MODIFICACIÓN
    ///*******************************************************************************
    private void Insertar_Pasivo(String Referencia, Cls_Ope_Pre_Descuentos_Der_Sup_Negocio Descuento)
    {
        try
        {
            ...
            if (Descuento.P_Monto_Multas > 0)
            {
                ...
                if (Dt_Clave.Rows.Count > 0)
                {
                    ...
                    Calculo_Impuesto_Traslado.P_Monto_Total_Pagar = (Descuento.P_Monto_Multas * -1).ToString("0.00");
                    ...
                    Calculo_Impuesto_Traslado.P_Fecha_Vencimiento_Pasivo = Descuento.P_Fecha_Vencimiento.ToString("dd/MMM/yyyy");
                    Calculo_Impuesto_Traslado.Alta_Pasivo();
                }
            }
            if (Descuento.P_Monto_Recargos > 0)
            {
                Claves_Ingreso.P_Tipo = "DERECHOS DE SUPERVISION";
                ...
                if (Dt_Clave.Rows.Count > 0)
                {
                    ...
                    Calculo_Impuesto_Traslado.P_Clave_Ingreso_ID = Dt_Clave.Rows[0][Cat_Pre_Claves_Ingreso_Det.Campo_Clave_Ingreso_ID].ToString();
                    Calculo_Impuesto_Traslado.P_Dependencia_ID = Dt_Clave.Rows[0][Cat_Pre_Claves_Ingreso.Campo_Dependencia_ID].ToString();
                    Calculo_Impuesto_Traslado.P_Monto_Total_Pagar = (Descuento.P_Monto_Recargos * -1).ToString("0.00");
                    Calculo_Impuesto_Traslado.P_Fecha_Tramite = DateTime.Now.ToString("dd/MMM/yyyy");
                    Calculo_Impuesto_Traslado.P_Cuenta_Predial_ID = Hdf_Cuenta_Predial_ID.Value;
                    Calculo_Impuesto_Traslado.P_Fecha_Vencimiento_Pasivo = Descuento.P_Fecha_Vencimiento.ToString("dd/MMM/yyyy");
                    Calculo_Impuesto_Traslado.Alta_Pasivo();
    ...
    {
        Ds_Ope_Pre_Descuentos_Der_Sup Ds_Descuentos = new Ds_Ope_Pre_Descuentos_Der_Sup();
        DataRow Dr_Descuentos;

        foreach (DataTable Dt_Descuentos in Ds_Descuentos.Tables)
        {
            if (Dt_Descuentos.TableName == "Dt_Ope_Pre_Descuentos_Der_Sup")
            {
                ...
                Dr_Descuentos["DERECHOS_SUPERVISION"] = "$ " + Txt_Monto_Impuesto_Der_Sup.Text.Replace("$", "");
