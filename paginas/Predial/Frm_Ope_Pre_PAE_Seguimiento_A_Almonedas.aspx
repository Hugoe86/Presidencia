<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/paginas/Paginas_Generales/MasterPage.master" CodeFile="Frm_Ope_Pre_PAE_Seguimiento_A_Almonedas.aspx.cs" Inherits="paginas_Predial_Frm_Ope_Pre_PAE_Seguimiento_A_Almonedas" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Cph_Area_Trabajo2" runat="Server">    
        ...
        function beginRequest(sender, args) {
            ...
            $(function() {
                $('.Gastos_Honorarios').click(function() {
                    var id = $(this).attr('id_cuenta');         
                    var Adeudo = $(this).attr('Adeudo');
                    var Estatus = $(this).attr('Estatus');
                    var NO_DETALLE_ETAPA = $(this).attr('NO_DETALLE_ETAPA');
                    Abrir_Ventana_Modal('Ventanas_Emergentes/PAE/Frm_Gastos_De_Ejecucion_Almonedas.aspx?Proceso=ALMONEDA&Cuenta_Predial='+id+'&Adeudo='+Adeudo+'&Estatus='+Estatus+'&NO_DETALLE_ETAPA='+NO_DETALLE_ETAPA, 'center:yes;resizable:yes;status:no;dialogWidth:525px;dialogHeight:750px;dialogHide:true;help:no;scroll:no');
                });
            });    
           $(function() {
                $('.Postores').click(function() {
                    var NO_DETALLE_ETAPA = $(this).attr('NO_DETALLE_ETAPA');        
                    var POSTURA_LEGAL = $(this).attr('POSTURA_LEGAL');
                    Abrir_Ventana_Modal('Ventanas_Emergentes/PAE/Frm_Postores_Almonedas.aspx?NO_DETALLE_ETAPA='+NO_DETALLE_ETAPA+'&POSTURA_LEGAL='+POSTURA_LEGAL, 'center:yes;resizable:yes;status:no;dialogWidth:500px;dialogHeight:270px;dialogHide:true;help:no;scroll:no');
                });
            }); 
        }
 ...
 <asp:Content ID="Content3" ContentPlaceHolderID="Cph_Area_Trabajo1" runat="Server">
    <cc1:ToolkitScriptManager ID="Tsm_Seguimiento_Almoneda" runat="server"  AsyncPostBackTimeout="3600" EnableScriptGlobalization="true"/>    
                                ...
                                <table style="width: 100%; height: 28px;">
                                    <tr>
                                        <td align="left" style="width: 59%;">
                                            ...
                                            <asp:ImageButton ID="Btn_Busca_Almonedas" runat="server" ToolTip="Buscar" CssClass="Img_Button"
                                                TabIndex="4" ImageUrl="~/paginas/imagenes/paginas/icono_consultar.png" OnClick="Btn_Busca_Almonedas_Click" />
                    ...
                    <table width="98%" class="estilo_fuente">
                        <caption>
                            ...
                            <tr>
                                ...
                                <td style="text-align: left; width: 30%;">
                                    <asp:TextBox ID="Txt_Contribuyente" runat="server" Width="84%" 
                                        Enabled="False" />
                                    <asp:ImageButton ID="Btn_Busca_Contribuyente" runat="server" Height="22px" 
                                        ImageUrl="~/paginas/imagenes/paginas/Busqueda_00001.png" Width="22px" OnClick="Btn_Busca_Contribuyente_Click"/>
                                </td>
                            </tr>
                            <tr>
                                <td style="text-align: left; width: 20%;">
                            ...
                            <tr align="center">
                                <td colspan="4">
                                    <asp:GridView ID="Grid_Almonedas_Generadas" runat="server" 
                                        AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
                                        CssClass="GridView_1" HeaderStyle-CssClass="tblHead" PageSize="5" Style="white-space: normal;"
                                        Width="100%" OnSelectedIndexChanged="Grid_Almonedas_Generadas_SelectedIndexChanged">
                                        <Columns>       
                                            ...
                                            <asp:BoundField DataField="VALOR_AVALUO" HeaderText="Valor Avaluo" DataFormatString="{0:C2}" >
                                                <ItemStyle HorizontalAlign="Center"/>
                                            </asp:BoundField>
                                            <asp:BoundField DataField="POSTURA_LEGAL" HeaderText="Postura Legal" DataFormatString="{0:C2}" >
                                                <ItemStyle HorizontalAlign="Center"/>
                                            </asp:BoundField>
                                            <asp:TemplateField>
                                                    <ItemTemplate>
                                                        <asp:ImageButton ID="Btn_Postores" runat="server" Height="20px" 
                                                            ImageUrl="~/paginas/imagenes/paginas/add_up.png" TabIndex="10"                         
                                                            CommandName="Select"
                                                            ToolTip="Agregar Gastos Ejecucion" Width="20px"                                                                                                                        
                                                            class="Postores" id_cuenta='<%# Eval("NO_DETALLE_ETAPA") %>' POSTURA_LEGAL='<%# Eval ("POSTURA_LEGAL") %>' />                                                            
                                                    </ItemTemplate>
                                                    <HeaderStyle Width="2%"/>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField>
                                                    <ItemTemplate>
                                                        <asp:ImageButton ID="Btn_Detalle_Cuenta" runat="server" Height="20px" 
                                                            ...
                                                            CommandName="Select"
                                                            ToolTip="Agregar Gastos Ejecucion" Width="20px"                                                                                                                        
                                                            class="Gastos_Honorarios" id_cuenta='<%# Eval("CUENTA") %>' Adeudo='<%# Eval("ADEUDO") %>' Estatus='<%# Eval("ESTATUS") %>' NO_DETALLE_ETAPA='<%# Eval("NO_DETALLE_ETAPA") %>'/>                                                            
                                                    </ItemTemplate>
                                                    <HeaderStyle Width="2%"/>
                                            </asp:TemplateField>
                                        </Columns>
