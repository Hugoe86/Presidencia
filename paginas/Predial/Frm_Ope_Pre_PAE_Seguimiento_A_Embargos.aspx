...
AutoEventWireup="true" CodeFile="Frm_Ope_Pre_PAE_Seguimiento_A_Embargos.aspx.cs" 
Inherits="paginas_Predial_Frm_Ope_Pre_PAE_Seguimiento_A_Embargos" Culture="es-MX"%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Cph_Area_Trabajo2" runat="Server">    
        ...
        function beginRequest(sender, args) {
            ...
            $(function() {
                $('.Gastos_Honorarios').click(function() {
                    var id = $(this).attr('id_cuenta');         
                    Abrir_Ventana_Modal('Ventanas_Emergentes/PAE/Frm_Gastos_De_Ejecucion.aspx?Proceso=EMBARGO&Cuenta_Predial='+id, 'center:yes;resizable:yes;status:no;dialogWidth:525px;dialogHeight:475px;dialogHide:true;help:no;scroll:no');
                });
 ...
 <asp:Content ID="Content3" ContentPlaceHolderID="Cph_Area_Trabajo1" runat="Server">
    <cc1:ToolkitScriptManager ID="Tsm_Embargo" runat="server"  AsyncPostBackTimeout="3600" EnableScriptGlobalization="true"/>    
                                ...
                                <table style="width: 100%; height: 28px;">
                                    <tr>
                                        <td align="left" style="width: 59%;">
                                            ...
                                            <asp:ImageButton ID="Btn_Busca_Embargos" runat="server" ToolTip="Buscar" CssClass="Img_Button"
                                                TabIndex="4" ImageUrl="~/paginas/imagenes/paginas/icono_consultar.png" 
                                                onclick="Btn_Busca_Embargos_Click" />
                ...
                <div id="Div_Generadas" runat="server">
                    <table width="98%" class="estilo_fuente">
                        <caption>
                            ...
                            <tr align="center">
                                <td colspan="4">
                                    <asp:GridView ID="Grid_Embargos_Generados" runat="server" 
                                        ...
                                        onselectedindexchanged="Grid_Embargos_Generados_SelectedIndexChanged">
                                        <Columns>       
