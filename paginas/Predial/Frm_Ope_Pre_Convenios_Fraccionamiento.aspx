<%@ Page Title="" Language="C#" MasterPageFile="~/paginas/Paginas_Generales/MasterPage.master"
    AutoEventWireup="true" CodeFile="Frm_Ope_Pre_Convenios_Fraccionamiento.aspx.cs"
    Inherits="paginas_Predial_Frm_Ope_Pre_Convenios_Fraccionamiento" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<%@ PreviousPageType VirtualPath="~/paginas/Predial/Frm_Ope_Pre_Impuesto_Fraccionamiento.aspx" %>
                    ...
                    <tr>
                        <td style="text-align: left;">
                            <asp:GridView ID="Grid_Convenios_Impuestos_Fraccionamientos" runat="server" AutoGenerateColumns="False"
                                ...
                                Width="100%" DataKeyNames="CUENTA_PREDIAL_ID,PROPIETARIO_ID" OnPageIndexChanging="Grid_Convenios_Impuestos_Fraccionamientos_PageIndexChanging"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="NO_IMPUESTO_FRACCIONAMIENTO" HeaderText="Impuesto Id"
                                        Visible="false">
                                        <ItemStyle HorizontalAlign="Center" />
                                    </asp:BoundField>
