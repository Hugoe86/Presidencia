<%@ Page Language="C#" MasterPageFile="~/paginas/Paginas_Generales/MasterPage.master" AutoEventWireup="true" CodeFile="Frm_Cat_Pre_Colonias_Sector.aspx.cs" Inherits="paginas_Predial_Frm_Cat_Pre_Colonias_Sector" %>
            ...
            <div id="Div_Colonias" style="background-color:#ffffff; width:100%; height:100%;">
                ...
                <br />
                    ...
                    <tr>
                        ...
                        <td style="text-align:left;width:20%;">
                            <asp:DropDownList ID="Cmb_Sector" runat="server" Width="99%" TabIndex="7" ></asp:DropDownList>
                        </td>
                        <td style="text-align:left;width:20%;">
                            *Clave
                        </td>
                        <td style="text-align:left;width:20%;">
                            <asp:TextBox ID="Txt_Clave" runat="server" Width="97%" TabIndex="7" Enabled = "false"> 
                            </asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td style="text-align:left;width:30%;">
                            <asp:DropDownList ID="Cmb_Tipo" runat="server" Width="99%" TabIndex="7" Enabled = "false">
                        ...
                        <td style="text-align:left;width:30%;">
                            <asp:DropDownList ID="Cmb_Estatus" runat="server" Width="99%" TabIndex="7" Enabled = "false">
                    ...
                    <tr>
                        ...
                        <td style="text-align:left;width:80%; vertical-align:top;" colspan="3" >
                            <asp:TextBox ID="Txt_Comentarios" runat="server" TabIndex="10" MaxLength="250"
                                TextMode="MultiLine" Width="98.6%" AutoPostBack="True" Enabled = "false"/>
