<%@ Page Title="" Language="C#" MasterPageFile="~/paginas/Paginas_Generales/MasterPage.master"
    AutoEventWireup="true" CodeFile="Frm_Ope_Pre_Reactivaciones_Pago.aspx.cs" Inherits="paginas_Predial_Frm_Ope_Pre_Reactivaciones_Pago" %>
            ...
            <div id="Div_Contenido" style="background-color: #ffffff; width: 100%; height: 100%;">
                ...
                <table width="98%" class="estilo_fuente">
                    ...
                    <tr>
                        ...
                        <td style="text-align: left; width: 30%;" colspan="3">
                            <asp:TextBox ID="Txt_Motivo" runat="server" Width="99.2%" ReadOnly="True" BorderStyle="Solid"
                    ...
                    <tr>
                        ...
                        <td colspan="3" style="text-align: left; width: 80%; vertical-align: top;">
                            <asp:TextBox ID="Txt_Observaciones" runat="server" ReadOnly="True" BorderStyle="Solid"
                                BorderWidth="1" TextMode="MultiLine" Width="99.2%" />
                        </td>
                    </tr>
                    <tr align="center">
                        <td colspan="4">
                            <asp:GridView ID="Grid_Cancelacion" runat="server" AllowPaging="True" CssClass="GridView_1"
                                ...
                                OnSelectedIndexChanged="Grid_Cancelacion_SelectedIndexChanged" EnableModelValidation="True">
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="MONTO" HeaderText="Monto" Visible="false" DataFormatString="{0:c}" />
                                    <asp:BoundField DataField="MOTIVO" HeaderText="Motivo_Cancelacion" Visible="True" />
