...
public partial class paginas_Predial_Frm_Ope_Pre_PAE_Seguimiento_A_Remocion : System.Web.UI.Page
{
    #region Page_load
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            Ventana_Modal = "Abrir_Ventana_Modal('Ventanas_Emergentes/Btn_Busca_Contribuyente.aspx', 'center:yes;resizable:yes;status:no;dialogWidth:580px;dialogHeight:450px;dialogHide:true;help:no;scroll:no');";
    ...
    private void Limpiar_Formulario()
    {
        ...
        Grid_Remociones_Generados.DataSource = null;
    ...
    private bool Validar_Componentes()
    {
        ...
        if (Grid_Remociones_Generados.Rows.Count < 1)
        {
    ...
    ///DESCRIPCIÓN          : Devuelve un DataTable con la estructura para las remociones generadas
    ///PARAMETROS: 
    ///CREO                 : Angel E. Trejo
    ///FECHA_CREO           : 14/03/2012 05:46:00 p.m.
    ///MODIFICO: 
    ///FECHA_MODIFICO:
    ///CAUSA_MODIFICACIÓN:
    ///*******************************************************************************
    protected DataTable Crear_Tabla_Remociones_Generados()
    {
        DataTable Dt_Requerimientos_Generados = new DataTable();
        Dt_Requerimientos_Generados.Columns.Add(new DataColumn("CUENTA", typeof(String)));
        Dt_Requerimientos_Generados.Columns.Add(new DataColumn("ADEUDO", typeof(Decimal)));
        Dt_Requerimientos_Generados.Columns.Add(new DataColumn("FOLIO", typeof(String)));
        Dt_Requerimientos_Generados.Columns.Add(new DataColumn("ASIGNADO", typeof(String)));
        Dt_Requerimientos_Generados.Columns.Add(new DataColumn("ENTREGA", typeof(String)));
        Dt_Requerimientos_Generados.Columns.Add(new DataColumn("FECHA", typeof(String)));
        Dt_Requerimientos_Generados.Columns.Add(new DataColumn("ESTATUS", typeof(String)));
        Dt_Requerimientos_Generados.Columns.Add(new DataColumn("NO_DETALLE_ETAPA", typeof(String)));
        return Dt_Requerimientos_Generados;
    }
    ///******************************************************************************* 
    ///NOMBRE DE LA FUNCIÓN : Llenar_DataRow_Remociones
    ...
    ///CAUSA_MODIFICACIÓN:
    ///*******************************************************************************
    protected void Llenar_DataRow_Remociones(DataTable Dt_Generadas, DataTable Dt_Busqueda, Int32 Cont_Busqueda)
    {
        DataRow Dr_Remociones;
        Dr_Remociones = Dt_Generadas.NewRow();
        ...
        Dr_Remociones["CUENTA"] = Dt_Busqueda.Rows[Cont_Busqueda]["CUENTA_PREDIAL"].ToString(); ;
        Dr_Remociones["ADEUDO"] = Dt_Busqueda.Rows[Cont_Busqueda]["TOTAL"].ToString();
        Dr_Remociones["FOLIO"] = Dt_Busqueda.Rows[Cont_Busqueda][Ope_Pre_Pae_Det_Etapas.Campo_Folio].ToString();
        Dr_Remociones["ASIGNADO"] = Dt_Busqueda.Rows[Cont_Busqueda][Cat_Pre_Despachos_Externos.Campo_Despacho].ToString();
        Dr_Remociones["ENTREGA"] = Dt_Busqueda.Rows[Cont_Busqueda][Ope_Pre_Pae_Etapas.Campo_Numero_Entrega].ToString();
        Dr_Remociones["FECHA"] = Fecha_Notificacion;
        Dr_Remociones["ESTATUS"] = Dt_Busqueda.Rows[Cont_Busqueda][Ope_Pre_Pae_Det_Etapas.Campo_Estatus].ToString();
        Dr_Remociones["NO_DETALLE_ETAPA"] = Dt_Busqueda.Rows[Cont_Busqueda][Ope_Pre_Pae_Det_Etapas.Campo_No_Detalle_Etapa].ToString();
        Dt_Generadas.Rows.Add(Dr_Remociones);//Se asigna la nueva fila a la tabla      
    }
    ///******************************************************************************* 
    ...
    ///******************************************************************************* 
    ///NOMBRE DE LA FUNCIÓN: Buscar_Remociones
    ...
    ///CAUSA_MODIFICACIÓN:
    ///*******************************************************************************
    public void Buscar_Remociones()
    {
        Cls_Ope_Pre_Pae_Etapas_Negocio Etapas_PAE = new Cls_Ope_Pre_Pae_Etapas_Negocio();
        DataTable Dt_Cuentas_Predial;
        DataTable Dt_Remociones_Generadas = Crear_Tabla_Remociones_Generados();//Se crea la tabla para pasarla algrid
            ...
            if (Comprobacion_Termida != true)
            {
                if (Session["CUENTAS_PREDIAL_CONTRIBUYENTE"] != null && Session["CUENTAS_PREDIAL_CONTRIBUYENTE"].ToString() != "")
                {
                    ...
                    for (int Cont_Contribuyente = 0; Cont_Contribuyente < Dt_Cuentas_Predial.Rows.Count; Cont_Contribuyente++)
                    {
                        ...
                        {
                            Llenar_DataRow_Remociones(Dt_Remociones_Generadas, Dt_Busqueda, Contador);
                        }
                    }
                }
                else
                ...
                Grid_Remociones_Generados.DataSource = Dt_Remociones_Generadas;
                Grid_Remociones_Generados.DataBind();
    ...
    ///PARAMETROS: 
    ///CREO                 : Angel E. Trejo
    ///FECHA_CREO           : 15/03/2012 08:44:00 a.m.
    ///MODIFICO: 
    ///FECHA_MODIFICO:
    ///CAUSA_MODIFICACIÓN:
    ///*******************************************************************************
    protected void Btn_Busca_Remociones_Click(object sender, ImageClickEventArgs e)
    {
        Buscar_Remociones();
    }
    ///******************************************************************************* 
    ...
    #region Grid
    ///******************************************************************************* 
    ///NOMBRE DE LA FUNCIÓN : Grid_Remociones_Generadas_SelectedIndexChanging
    ///DESCRIPCIÓN          : Maneja la paginación del GridView de Remociones Generadas
    ///PARAMETROS: 
    ///CREO                 : Angel Antonio Escamilla Trejo
    ///FECHA_CREO           : 23/03/2012 05:44:00 p.m.
    ///MODIFICO: 
    ///FECHA_MODIFICO:
    ///CAUSA_MODIFICACIÓN:
    ///*******************************************************************************
    protected void Grid_Remociones_Generados_PageIndexChanging(object sender, GridViewPageEventArgs e)
    {
        try
        {
            Grid_Remociones_Generados.PageIndex = e.NewPageIndex;
            Grid_Remociones_Generados.DataSource = Session["Grid_Remociones_Generadas"];
            Grid_Remociones_Generados.DataBind();
        }
        catch (Exception Ex)
        {
    ...
    ///******************************************************************************* 
    ///NOMBRE DE LA FUNCIÓN : Grid_Remociones_Generados_SelectedIndexChanged
    ...
    ///CAUSA_MODIFICACIÓN:
    ///*******************************************************************************
    protected void Grid_Remociones_Generados_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        Cls_Ope_Pre_Pae_Depositario_Negocios Rs_Depositario = new Cls_Ope_Pre_Pae_Depositario_Negocios();
        ...
        DataTable Dt_Depositario = (DataTable)Session["Depositarios"];
        DataTable Dt_Remociones_Generadas = (DataTable)Session["Grid_Remociones_Generadas"];
        String No_Detalle_Etapa;
        String Estatus = "";

        if ((Dt_Honorarios != null && Dt_Honorarios.Rows.Count > 0) || (Dt_Publicaciones != null && Dt_Publicaciones.Rows.Count > 0) || (Dt_Notificaciones != null && Dt_Notificaciones.Rows.Count > 0) || (Dt_Depositario != null && Dt_Depositario.Rows.Count > 0))
        {
            try
            {
                No_Detalle_Etapa = Dt_Remociones_Generadas.Rows[Grid_Remociones_Generados.SelectedIndex + (Grid_Remociones_Generados.PageSize * Grid_Remociones_Generados.PageIndex)]["NO_DETALLE_ETAPA"].ToString();
                if (Dt_Notificaciones != null)
                {
                    ...
                    Rs_Notificaciones.P_Proceso = "REMOCION";
                    Estatus = Dt_Notificaciones.Rows[0]["ESTATUS"].ToString();
                    Rs_Notificaciones.Alta_Notificaciones();
                }
                if (Estatus == "")
                {
                    Estatus = Dt_Remociones_Generadas.Rows[Grid_Remociones_Generados.SelectedIndex + (Grid_Remociones_Generados.PageSize * Grid_Remociones_Generados.PageIndex)]["ESTATUS"].ToString();
                }
                if (Dt_Honorarios != null)
                {
                    for (int Conta_Ejecucion = 0; Conta_Ejecucion < Dt_Honorarios.Rows.Count; Conta_Ejecucion++)
                    {
                        ...
                        Rs_Honorarios.P_Proceso = "REMOCION";
                ...
                if (Dt_Publicaciones != null)
                {
                    for (int Conta_Publicacion = 0; Conta_Publicacion < Dt_Publicaciones.Rows.Count; Conta_Publicacion++)
                    {
                        ...
                        Rs_Publicaciones.P_Proceso = "REMOCION";
                        Rs_Publicaciones.P_Estatus = Estatus;
                        Rs_Publicaciones.Alta_Publicaciones();
                    }
                }
                if (Dt_Depositario != null)
                {
                    for (int Conta_Bienes = 0; Conta_Bienes < Dt_Depositario.Rows.Count; Conta_Bienes++)
                    {
                        Rs_Depositario.P_No_Detalle_Etapa = No_Detalle_Etapa;
                        Rs_Depositario.P_Figura = Dt_Depositario.Rows[Conta_Bienes]["DEPOSITARIO"].ToString();
                        Rs_Depositario.P_Nombre_Depositario = Dt_Depositario.Rows[Conta_Bienes]["NOMBRE"].ToString();
                        Rs_Depositario.P_Domicilio_Depositario = Dt_Depositario.Rows[Conta_Bienes]["DOMICILIO"].ToString();
                        Rs_Depositario.Alta_Depositario();
                    }
                }
                Session.Remove("Honorarios");
                Session.Remove("Publicaciones");
                Session.Remove("Notificaciones");
                Session.Remove("Depositarios");
                ...
                ScriptManager.RegisterStartupScript(this, this.GetType(), "Seguimiento a Remociones", "alert('Alta Exitosa');", true);
                int Pagina = Grid_Remociones_Generados.PageIndex;
                Buscar_Remociones();
                Session["Generadas"] = Dt_Remociones_Generadas;
                Grid_Remociones_Generados.PageIndex = Pagina;
            }
            catch (Exception Ex)
            {
                Mensaje_Error(Ex.Message);
