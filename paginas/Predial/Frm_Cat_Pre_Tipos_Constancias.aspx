<%@ Page Language="C#" MasterPageFile="~/paginas/Paginas_Generales/MasterPage.master" AutoEventWireup="true" CodeFile="Frm_Cat_Pre_Tipos_Constancias.aspx.cs" Inherits="paginas_predial_Frm_Cat_Pre_Tipos_Constancias" Title="Catalogo de Tipos de Constancias" %>
        ...
        <ContentTemplate>
            ...
            <div id="Div_Requisitos" style="background-color:#ffffff; width:100%; height:100%;">
                <table width="98%"  border="0" cellspacing="0" class="estilo_fuente">
                    <tr align="center">
                        <td class="label_titulo" colspan="2">Tipos de Constancias</td>
                    </tr>
                    <tr>
                        <td>
                ...
                <center>
                    <table width="96%">
                        <tr>
                            <td colspan="4">
                                <asp:HiddenField ID="Hdf_Tipo_Constancia_ID" runat="server" />
                            </td>
                        </tr>
                        <tr>
                            <td style="width:18%; text-align:left;">
                                *Clave</td>
                            <td style="width:32%">
                                <asp:TextBox ID="Txt_Clave" runat="server" Enabled="False" MaxLength="50" Style="text-transform: uppercase"
                            ...
                            <td style="width:18%; text-align:left;">
                                <asp:CheckBox ID="Ckb_Certificacion" runat="server" ></asp:CheckBox>
                            </td>
                        </tr>    
                        <tr>
                            <td style="width:18%; text-align:left;">
                                *Nombre</td>
                            <td style="width:32%">
                                <asp:TextBox ID="Txt_Nombre" runat="server" Enabled="False" MaxLength="50" Style="text-transform: uppercase" 
                                    Width="98%"></asp:TextBox>
                            </td>
                            <td style="text-align:right">
                                *Año</td>
                            <td style="width:35%">
                                <asp:DropDownList ID="Cmb_Años" runat="server" Width="95%">
                        ...
                        <tr>
                            <td style="width:18%; text-align:left;">
                                *Costo</td>
                            <td style="width:32%">
                                <asp:TextBox ID="Txt_Costo" runat="server" Enabled="False" MaxLength="10" onBlur="this.value=formatCurrency(this.value);"
                                    Width="98%"></asp:TextBox>
                                    <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender6" runat="server" TargetControlID="Txt_Costo"
                                    FilterType="Numbers,Custom" ValidChars="." />
                            </td>
                            <td style="width:15%; text-align:left; text-align:right;">
                                &nbsp; *Estatus</td>
                            <td style="width:35%">
                        ...
                        <tr>
                            <td style="width:18%; text-align:left; vertical-align:top;">
                                *Descripción</td>
                            <td colspan="3" style="width:82%;text-align:center;">
                                <asp:TextBox ID="Txt_Descripcion" runat="server" Rows="2" Width="99%" MaxLength="256" Style="text-transform: uppercase"
                    ...
                    <br />                                
                    <asp:GridView ID="Grid_Tipos_Constancias" runat="server" CssClass="GridView_1"
                        AutoGenerateColumns="False" AllowPaging="True" PageSize="5" Width="96%"
                        onselectedindexchanged="Grid_Tipos_Constancias_SelectedIndexChanged" 
                        GridLines= "None"
                        onpageindexchanging="Grid_Tipos_Constancias_PageIndexChanging">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="CERTIFICACION" HeaderText="Certificado" 
                                SortExpression="CERTIFICACION" />
                        </Columns>
