...
CodeFile="Frm_Ope_Pre_PAE_Requerimientos.aspx.cs" Inherits="paginas_Predial_Frm_Ope_Pre_PAE_Requerimientos" %>
...
<!--SCRIPT PARA LA VALIDACION QUE NO EXPERE LA SESSION-->  
 ...
 <asp:Content ID="Content3" ContentPlaceHolderID="Cph_Area_Trabajo1" runat="Server">
    <cc1:ToolkitScriptManager ID="Tsm_Requerimiento" runat="server"  AsyncPostBackTimeout="3600" EnableScriptGlobalization="true"/>    
                    ...
                    <%---------------- Cuentas Rezago ----------------%>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:DropDownList ID="Cmb_Filtro_Despachos" runat="server" AutoPostBack="true" 
                                    TabIndex="7" 
                                    Width="99%">
                                </asp:DropDownList>
                        ...
                        <tr align="center">
                            <td colspan="4">
                                <asp:GridView ID="Grid_Cuentas_Omitidas" runat="server" AllowPaging="True" CssClass="GridView_1"
                                    ...
                                    onpageindexchanging="Grid_Cuentas_Omitidas_PageIndexChanging" onselectedindexchanged="Grid_Cuentas_Omitidas_SelectedIndexChanged" 
                                    >
                                    <Columns>
                        ...
                        <tr style="background-color: #36C;">
                            <td style="text-align: left; font-size: 15px; color: #FFF;" colspan="4">
                                Cuentas a generar requerimientos
                            </td>
                        </tr>
                        <tr align="center">
                            <td colspan="4">
                                <asp:GridView ID="Grid_Cuentas_Generar" runat="server" AllowPaging="True" CssClass="GridView_1"
                                    AutoGenerateColumns="False" PageSize="5" Width="100%" AllowSorting="True" HeaderStyle-CssClass="tblHead"
                                    Style="white-space: normal;" 
                                    onpageindexchanging="Grid_Cuentas_Generar_PageIndexChanging" onselectedindexchanged="Grid_Cuentas_Generar_SelectedIndexChanged" 
                                    >
                                    <Columns>
                                        <asp:BoundField DataField="CUENTA_PREDIAL_ID" HeaderText="Cuenta_Id"/>
                                        <asp:BoundField DataField="CUENTA_PREDIAL" HeaderText="Cuenta" HeaderStyle-Width="13%" />
                                        <asp:BoundField DataField="PERIODO_CORRIENTE" HeaderText="Periodo corriente" />
                                        <asp:BoundField DataField="CORRIENTE" HeaderText="Corriente" DataFormatString="{0:C2}"/>
                                        <asp:BoundField DataField="PERIODO_REZAGO" HeaderText="Periodo rezago" />
                                        <asp:BoundField DataField="REZAGO" HeaderText="Rezago" DataFormatString="{0:C2}"/>
                        ...
                        <tr>
                            ...
                            <td style="text-align: left; width: 30%;">
                                <asp:TextBox ID="Txt_Total_Requerimiento" runat="server" Width="96.4%" 
                                    ReadOnly="True" />
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td style="text-align: left; width: 30%;">
                                <asp:DropDownList ID="Cmb_Despachos" runat="server" Width="99%" TabIndex="7" 
                                    AutoPostBack="true" onselectedindexchanged="Cmb_Despachos_SelectedIndexChanged">
                                    <asp:ListItem> Municipio </asp:ListItem>
                                </asp:DropDownList>
                                <%--<asp:ImageButton ID="Btn_Filtro_Despacho" runat="server" Height="22px" 
                                        ImageUrl="~/paginas/imagenes/paginas/Busqueda_00001.png"
                                        TabIndex="10" 
                                        ToolTip="Consultar por despacho" Width="22px" />
                            </td>--%>
                            <td style="text-align: left; width: 20%; text-align: right;">
                                Número de entrega
                            </td>
                        ...
                        <caption>
                            ...
                            <tr>
                                ...
                                <td style="text-align: left; width: 30%;">
                                    ...
                                    <asp:ImageButton ID="Btn_Seleccionar_Propietario" runat="server" Height="22px" 
                                        ImageUrl="~/paginas/imagenes/paginas/Busqueda_00001.png"
                                        TabIndex="10" 
                                        ToolTip="Seleccionar Propietario" Width="22px" onclick="Btn_Seleccionar_Propietario_Click" 
                            ...
                            <tr>
                                ...
                                <td colspan="2" style="text-align: left; width: 20%; text-align: right;">
                                    <asp:Label ID="Lbl_Busqueda" runat="server" Text="Buscar Requerimientos"></asp:Label>
                                    <asp:ImageButton ID="Btn_Buscar_Requerimientos" runat="server" 
                                        ImageUrl="~/paginas/imagenes/paginas/icono_consultar.png" onclick="Btn_Buscar_Requerimientos_Click"  
                                         />
                                    &nbsp;
                                </td>
                            </tr>
