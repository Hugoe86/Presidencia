<%@ Page Language="C#" MasterPageFile="~/paginas/Paginas_Generales/MasterPage.master" AutoEventWireup="true" CodeFile="Frm_Cat_Pre_Multas_Derechos_Supervision.aspx.cs" Inherits="paginas_predial_Frm_Cat_Pre_Multas_Derechos_Supervision" Title="Catalogo de Multas de Derechos de Supervision" Culture="es-MX"%>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Cph_Area_Trabajo1" Runat="Server">
    <asp:ScriptManager ID="ScptM_Multas" runat="server" EnableScriptGlobalization="true" EnableScriptLocalization="true"/>
        ...
        <ContentTemplate>
            ...
            <div id="Div_Requisitos" style="background-color:#ffffff; width:100%; height:100%;">
                <table width="98%"  border="0" cellspacing="0" class="estilo_fuente">
                    <tr align="center">
                        <td colspan="2" class="label_titulo">Catálogo de Multas de Derechos de Supervisión</td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr class="barra_busqueda" align="right">
                        ...
                        <td>Búsqueda:
                            ...
                            <asp:ImageButton ID="Btn_Buscar_Multa" runat="server" CausesValidation="false"
                                ImageUrl="~/paginas/imagenes/paginas/busqueda.png" ToolTip="Buscar" 
                                onclick="Btn_Buscar_Multa_Click" />
                            <cc1:TextBoxWatermarkExtender ID="TWE_Txt_Busqueda_Multa" runat="server" WatermarkText="<Descripción>" TargetControlID="Txt_Busqueda_Multa" WatermarkCssClass="watermarked"></cc1:TextBoxWatermarkExtender>    
                            <cc1:FilteredTextBoxExtender ID="FTE_Txt_Busqueda_Multa" runat="server" TargetControlID="Txt_Busqueda_Multa" InvalidChars="<,>,&,',!," FilterType="Custom, UppercaseLetters, LowercaseLetters, Numbers" ValidChars="Ññ.,:;()áéíóúÁÉÍÓÚ ">
                ...
                <cc1:TabContainer ID="Tab_Contenedor_Pestagnas" runat="server" Width="98%"
                    ...
                    <cc1:TabPanel  runat="server" HeaderText="TabPanel1"  ID="TabPanel1"  Width="100%"  >
                        <HeaderTemplate>Multas Derechos Supervisión</HeaderTemplate>
                        <ContentTemplate>
                            <center>
                                <table width="100%">
                                    <tr>
                                    ...
                                    <tr>
                                        <td style="width:18%; text-align:left;"><asp:Label ID="Lbl_ID_Multa" runat="server" 
                                                Text="Multa ID" CssClass="estilo_fuente"></asp:Label></td>
                                        <td style="width:32%">
                                            <asp:TextBox ID="Txt_ID_Multa" runat="server" Width="98%" MaxLength="10" 
                                    ...
                                    <tr>
                                        ...
                                        <td style="width:15%; text-align:right;"><asp:Label ID="Lbl_Estatus" runat="server" Text="* Estatus" CssClass="estilo_fuente"></asp:Label></td>
                                        <td style="width:35%">
                                    ...
                                    <tr>
                                        ...
                                        <td style="width:35%">
                                            <asp:TextBox ID="Txt_Desde" runat="server" Width="98%" MaxLength="4" Enabled="false"></asp:TextBox>
                                            <cc1:FilteredTextBoxExtender ID="FTE_Txt_Desde" 
                                            runat="server" TargetControlID="Txt_Desde" FilterType="Numbers" ValidChars="0123456789"/>
                                            <cc1:TextBoxWatermarkExtender ID="TBWME_Txt_Desde" runat="server" TargetControlID="Txt_Desde" WatermarkText="<Año>" WatermarkCssClass="watermarked"/>
                                        </td>
                                        ...
                                        <td style="width:35%">
                                            <asp:TextBox ID="Txt_Hasta" runat="server" Width="98%" MaxLength="4" Enabled="false"></asp:TextBox>
                                            <cc1:FilteredTextBoxExtender ID="FTE_Txt_Hasta" 
                                            runat="server" TargetControlID="Txt_Hasta" FilterType="Numbers" ValidChars="0123456789"/>
                                            <cc1:TextBoxWatermarkExtender ID="TBWME_Txt_Hasta" runat="server" TargetControlID="Txt_Hasta" WatermarkText="<Año>" WatermarkCssClass="watermarked"/>
                                        </td>
                    ...
                    <cc1:TabPanel  runat="server" HeaderText="TabPanel2"  ID="TabPanel2"  Width="100%"  >
                        <HeaderTemplate>Multas Derechos Supervision - Cuotas</HeaderTemplate>
                        <ContentTemplate>
                            <center>
                                <table width="100%">
                                    <tr>
                                    ...
                                    <tr>
                                        <td style="width:18%; text-align:left;"><asp:Label ID="Lbl_Impuesto_ID" 
                                                runat="server" Text="Multa Cuota ID" CssClass="estilo_fuente"></asp:Label></td>
                                        <td style="width:32%">
                                            <asp:TextBox ID="Txt_Multa_Cuota_ID" runat="server" Width="98%" MaxLength="10" 
                                                Enabled="False"></asp:TextBox>
                                        </td>
                                    </tr>                                    
                                    <tr>
                                        ...
                                        <td style="width:35%; text-align:left;">
                                            <asp:TextBox ID="Txt_Monto" runat="server" Width="98%" OnTextChanged="Txt_Monto_TextChanged" AutoPostBack="true"></asp:TextBox>
                                            <cc1:FilteredTextBoxExtender ID="MEE_Txt_Monto" runat="server" TargetControlID="Txt_Monto" FilterType="Numbers, Custom" ValidChars="0123456789.,"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="3">&nbsp;</td>
                                        <td style="width:15%;">
                                            <asp:ImageButton ID="Btn_Agregar_Cuota" runat="server" 
                                                ImageUrl="~/paginas/imagenes/paginas/sias_add.png" 
                                                AlternateText="Agregar" onclick="Btn_Agregar_Cuota_Click" />
                                            <asp:ImageButton ID="Btn_Modificar_Cuota" runat="server" 
                                                ImageUrl="~/paginas/imagenes/paginas/actualizar_detalle.png" 
                                                AlternateText="Modificar" onclick="Btn_Modificar_Cuota_Click" />
                                            <asp:ImageButton ID="Btn_Quitar_Cuota" runat="server" 
                                ...
                                <br />
                                <asp:GridView ID="Grid_Multas_Cuotas" runat="server" 
                                    AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" 
                                    GridLines="None" AllowPaging="True" Width="98%"
                                    OnPageIndexChanging="Grid_Multas_Cuotas_PageIndexChanging" 
                                    PageSize="5" >
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="MULTA_CUOTA_ID" 
                                            HeaderText="MULTA_CUOTA_ID" SortExpression="Id_Cuota" />
                ...
                <table id="Tbl_Multas" border="0" cellspacing="0" class="estilo_fuente" style="width: 100%;">
                    <tr>
                <asp:GridView ID="Grid_Multas_Generales" runat="server" CssClass="GridView_1"
                                    AutoGenerateColumns="False" AllowPaging="True" PageSize="5" Width="98%"
                                    onselectedindexchanged="Grid_Multas_Generales_SelectedIndexChanged" 
                                    GridLines= "None"
                                    onpageindexchanging="Grid_Multas_Generales_PageIndexChanging" 
                            EnableModelValidation="True">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="MULTA_ID" HeaderText="Multa ID" 
                                            SortExpression="MULTA_ID" >
                                        <HeaderStyle Width="5%" />
                                        </asp:BoundField>
