<%@ Page Title="" Language="C#" MasterPageFile="~/paginas/Paginas_Generales/MasterPage.master"
    AutoEventWireup="true" CodeFile="Frm_Ope_Pre_Reestructura_Convenios_Derechos_Supervision.aspx.cs"
    Inherits="paginas_Predial_Frm_Ope_Pre_Reestructura_Convenios_Derechos_Supervision" %>
                ...
                <table width="100%" class="estilo_fuente">
                    <tr align="center">
                        <td class="label_titulo">
                            Reestructura de Convenios de Derechos de Supervisión
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td style="text-align: left;" colspan="4">
                            <asp:GridView ID="Grid_Convenios_Impuestos_Derechos_Supervision" runat="server" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="NO_REESTRUCTURA" HeaderText="No Reestructura">
                                        <ItemStyle HorizontalAlign="Center" />
                                    </asp:BoundField>
                    ...
                    <table width="98%" class="estilo_fuente">
                        ...
                        <tr>
                            ...
                            <td style="text-align: left; width: 30%;">
                                ...
                                <cc1:TextBoxWatermarkExtender ID="Twe_Txt_Fecha_Calculo" runat="server" Enabled="True"
                                    TargetControlID="Txt_Fecha_Calculo" WatermarkCssClass="watermarked" WatermarkText="Dia/Mes/Año" />
                                <cc1:CalendarExtender ID="Dtp_Txt_Fecha_Calculo" runat="server" Format="dd/MMM/yyyy"
                                    PopupButtonID="" TargetControlID="Txt_Fecha_Calculo">
                        ...
                        <tr>
                            ...
                            <td style="text-align: left; width: 30%;">
                                <asp:DropDownList ID="Cmb_Estatus" runat="server" TabIndex="7" Width="99%" OnSelectedIndexChanged="Cmb_Estatus_Selected_Index_Changed"
                                    AutoPostBack="true">
                        ...
                        <tr>
                            ...
                            <td style="text-align: left; width: 30%;">
                                ...
                                <cc1:TextBoxWatermarkExtender ID="Twe_Txt_Fecha" runat="server" TargetControlID="Txt_Fecha"
                                    WatermarkCssClass="watermarked" WatermarkText="Dia/Mes/Año" Enabled="True" />
                                <cc1:CalendarExtender ID="DtpTxt_Fecha" runat="server" TargetControlID="Txt_Fecha"
                                    Format="dd/MMM/yyyy">
                                </cc1:CalendarExtender>
                            </td>
                        </tr>
