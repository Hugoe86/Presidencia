...
public partial class paginas_Predial_Frm_Ope_Pre_Estados_Cuenta : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (!IsPostBack)
            {
                ...
                Session["ESTATUS_CUENTAS"] = "IN ('BLOQUEADA','VIGENTE','BAJA','TEMPORAL','SUSPENDIDA')";
    ...
    protected void Habilitar_Botones()
    {
        ...
        Txt_Cod_Pos_Propietario.Enabled = false;
        ...
        Txt_Valor_Fiscal_General.Enabled = false;
        Txt_Efectos_General.Enabled = false;
        Txt_Tasa_General.Enabled = false;
        Txt_Cuota_Bimestral_General.Enabled = false;
        Txt_Ultimo_Movimiento.Enabled = false;
    ...
    protected void Limpiar_Controles()
    {
        ...
        Txt_Valor_Fiscal_General.Text = "";
        Txt_Efectos_General.Text = "";
        Txt_Tasa_General.Text = "";
        Txt_Cuota_Bimestral_General.Text = "";
        Txt_Ultimo_Movimiento.Text = "";
        Hdn_Cuota_Anual.Value = "";
    ...
    private void Cargar_Generales_Cuenta(DataTable dataTable)
    {
        ...
        try
        {
            ...
            else if (!String.IsNullOrEmpty(dataTable.Rows[0]["Colonia_Notificacion"].ToString()))
            {
            ...
            else if (!String.IsNullOrEmpty(dataTable.Rows[0]["Calle_Notificacion"].ToString()))
            {
    ...
    private void Llenar_Combo_Anios(DataTable Dt_Anios)
    {
        ...
        catch (Exception Ex)
        {
            ...
            throw new Exception("Llenar_Combo_Anios: " + Ex.Message);
    ...
    protected void Grid_Estado_Cuenta_PageIndexChanging(object sender, GridViewPageEventArgs e)
    {
        ...
        {
            Llenar_Grid_Estado_Cuenta(Hdn_Cuenta_Predial_ID.Value, false, e.NewPageIndex, true);
        }
        else if (Session["Cuenta_Predial_ID"] != null)
        {
            Llenar_Grid_Estado_Cuenta(Session["Cuenta_Predial_ID"].ToString().Trim(), false, e.NewPageIndex, true);
        }
    }
        ...
        if (Txt_Cuenta_Predial.Text.Trim() != "")
        {
            ...
            if (Dt_Cuentas_Predial.Rows.Count > 0)
            {
                ...
                if (Txt_Cuenta_Predial.Text.Trim() != "")
                {
                    ...
                    {
                        //Mensaje_Error("Falto Informacion");
                    }
    ...
    {
        String Cuenta_Predial_ID = Hdn_Cuenta_Predial_ID.Value;
        Llenar_Grid_Estado_Cuenta(Cuenta_Predial_ID, false, 0, false);
    }
    ///******************************************************************************* 
    ...
    protected DataTable Asignar_Datos_Generales()
    {
        ...
        try
        {
            ...
            Generales["Colonia"] = Txt_Colonia_General.Text.Trim();
            Generales["Ubicacion"] = Txt_Ubicacion_General.Text.Trim();
            Generales["Numero_Exterior"] = Txt_Numero_Exterior_General.Text.Trim();
            Generales["Numero_Interior"] = Txt_Numero_Interior_General.Text.Trim();
            Generales["Efectos"] = Txt_Efectos_General.Text.Trim();
