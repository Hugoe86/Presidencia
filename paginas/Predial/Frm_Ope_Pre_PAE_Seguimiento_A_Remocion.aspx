...
CodeFile="Frm_Ope_Pre_PAE_Seguimiento_A_Remocion.aspx.cs" Inherits="paginas_Predial_Frm_Ope_Pre_PAE_Seguimiento_A_Remocion" %>
        ...
        function beginRequest(sender, args) {
            ...
            $(function() {
                $('.Gastos_Honorarios').click(function() {
                    var id = $(this).attr('id_cuenta');         
                    Abrir_Ventana_Modal('Ventanas_Emergentes/PAE/Frm_Gastos_De_Ejecucion_Seg_Remocion.aspx?Proceso=REMOCION&Cuenta_Predial='+id, 'center:yes;resizable:yes;status:no;dialogWidth:520px;dialogHeight:620px;dialogHide:true;help:no;scroll:no');
                });
                                ...
                                <table style="width: 100%; height: 28px;">
                                    <tr>
                                        <td align="left" style="width: 59%;">
                                            ...
                                            <asp:ImageButton ID="Btn_Busca_Remociones" runat="server" ToolTip="Buscar" CssClass="Img_Button"
                                                TabIndex="4" ImageUrl="~/paginas/imagenes/paginas/icono_consultar.png" onclick="Btn_Busca_Remociones_Click"
                                                 />
                ...
                <div id="Div_Generadas" runat="server">
                    <table width="98%" class="estilo_fuente">
                        <caption>
                            ...
                            <tr>
                                ...
                                <td style="text-align: left; width: 30%;">
                                    <asp:TextBox ID="Txt_Fecha_Inicial" runat="server" Height="18px" MaxLength="11" TabIndex="12" 
                                        Width="84%" AutoPostBack="true" OnTextChanged="Txt_Fecha_Inicial_TextChanged" />
                                ...
                                <td style="text-align: left; width: 30%;">
                                    <asp:TextBox ID="Txt_Fecha_Final" runat="server" Height="18px" MaxLength="11" TabIndex="12" 
                                        Width="84%" AutoPostBack="true" OnTextChanged="Txt_Fecha_Final_TextChanged"/>
                            ...
                            <tr align="center">
                                <td colspan="4">
                                    <asp:GridView ID="Grid_Remociones_Generados" runat="server" 
                                        AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
                                        CssClass="GridView_1" HeaderStyle-CssClass="tblHead" PageSize="5" Style="white-space: normal;"
                                        Width="100%" 
                                        onselectedindexchanged="Grid_Remociones_Generados_SelectedIndexChanged" 
                                        onpageindexchanging="Grid_Remociones_Generados_PageIndexChanging">
                                        <Columns>       
