...
public partial class paginas_Predial_Frm_Ope_Pre_Cancelacion_Pago : System.Web.UI.Page
{
    ...
    private void Consulta_Caja_Empleado()
    {
        ...
        Cls_Ope_Pre_Cancelacion_Pago_Negocio Rs_Consulta_Cat_Pre_Cajas = new Cls_Ope_Pre_Cancelacion_Pago_Negocio(); //Variable de conexión hacia la capa de Negocios
    ...
    private void Consulta_Acumulado_Recibos_Cancelados()
    {
        ...
        Cls_Ope_Pre_Cancelacion_Pago_Negocio Rs_Consulta = new Cls_Ope_Pre_Cancelacion_Pago_Negocio(); //Variable de conexión hacia la capa de Negocios
    ...
    protected void Grid_Cancelacion_SelectedIndexChanged(object sender, EventArgs e)
    {
        try
        {
            if (Grid_Cancelacion.SelectedIndex > (-1))
            {
                ...
                {
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "Cancelación De Pagos", "alert('El pago se encuentra cancelado.')", true);
                    Grid_Cancelacion.SelectedIndex = -1;
                }
                else
                {
        ...
        try
        {
            ...
            else
            {
                if (Validar_Componentes())
                {
                    ...
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "Formulario de Operación de Cancelación de Pagos", "alert('Alta de Cancelación de pago Exitoso');", true);
                    //Btn_Nuevo.AlternateText = "Nuevo";
                    //Btn_Nuevo.ImageUrl = "~/paginas/imagenes/paginas/icono_nuevo.png";
