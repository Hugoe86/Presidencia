...
public partial class paginas_Predial_Frm_Ope_Pre_Validacion_Ordenes_Variacion : System.Web.UI.Page
{
    ...
    private String Mensajes_Validacion = "";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (!IsPostBack)
            {
                ...
                Txt_Observaciones_Cuenta.Attributes.Add("onkeypress", " Validar_Longitud_Texto(this, 250);");
                Txt_Observaciones_Cuenta.Attributes.Add("onkeyup", " Validar_Longitud_Texto(this, 250);");

                Txt_Observaciones_Validacion.Attributes.Add("onkeypress", " Validar_Longitud_Texto(this, 255);");
                Txt_Observaciones_Validacion.Attributes.Add("onkeyup", " Validar_Longitud_Texto(this, 255);");
            }
    ...
    {
        String Ventana_Modal = "Abrir_Ventana_Emergente('Ventanas_Emergentes/Resumen_Predial/Frm_Adeudo_Diferencias.aspx";
        String Propiedades = ", 'Adeudos_Diferencias', 'resizable=no,status=no,width=750,scrollbars=yes');";
        Btn_Vista_Adeudos.Attributes.Add("onclick", Ventana_Modal + "?Cuenta_Predial=" + Txt_Cuenta_Predial.Text.Trim() + "&Anio_Orden=" + Convert.ToDateTime(Grid_Ordenes_Variacion.SelectedRow.Cells[5].Text).Year.ToString() + "'" + Propiedades);
    }
    ...
    {
        String Ventana_Modal = "Abrir_Ventana_Emergente('Ventanas_Emergentes/Frm_Resumen_Predio.aspx";
        String Propiedades = ", 'Resumen_Predio', 'resizable=yes,status=no,width=750,scrollbars=yes');";
    ...
    private void Limpiar_Todo()
    {
        ...
        Btn_Validar.AlternateText = "Validar";
    ...
    {
        Cargar_Grid_Ordenes_Variacion(Pagina, Busqueda_Ordenes_Variacion_Por.Orden_Variacion);
    }

    private void Cargar_Grid_Ordenes_Variacion(Int32 Pagina, Busqueda_Ordenes_Variacion_Por Tipo_Busqueda)
    {
        ...
        try
        {
            ...
            Orden_Variacion.P_Generar_Orden_Estatus = Cmb_Busqueda_Estatus_Ordenes.SelectedValue;// "POR VALIDAR";
            ...
            if (Txt_Busqueda.Text.Trim() != ""
                && Tipo_Busqueda == Busqueda_Ordenes_Variacion_Por.Orden_Variacion)
            {
                //Orden_Variacion.P_Cuenta_Predial = "LIKE UPPER('%" + Txt_Busqueda.Text + "%')";
                Orden_Variacion.P_Orden_Variacion_ID = "LIKE '%" + Txt_Busqueda.Text + "%'";
                //Orden_Variacion.P_Generar_Orden_Movimiento_ID = "LIKE '%" + Txt_Busqueda.Text + "%'";
            }
            else
            {
                if (Hdn_Cuenta_Predial.Value.Trim() != ""
                    && Tipo_Busqueda == Busqueda_Ordenes_Variacion_Por.Cuenta_Predial)
                {
                    Orden_Variacion.P_Cuenta_Predial = "LIKE UPPER('%" + Hdn_Cuenta_Predial.Value + "%')";
                }
            }
            Orden_Variacion.P_Maximo_Registros = 50001;
            Dt_Ordenes_Variacion = Orden_Variacion.Consultar_Ordenes_Variacion();
            //DataTable Dt_Limitado_Ordenes_Variacion = new DataTable();
            //Dt_Limitado_Ordenes_Variacion = Dt_Ordenes_Variacion.Clone();
            //DataRow Dr_Limitado_Orden_Variacion;
            //foreach (DataRow Dr_Orden_Variacion in Dt_Ordenes_Variacion.Rows)
            //{
            //    Dr_Limitado_Orden_Variacion = Dt_Limitado_Ordenes_Variacion.NewRow();
            //    Dr_Limitado_Orden_Variacion.ItemArray = Dr_Orden_Variacion.ItemArray;
            //    Dt_Limitado_Ordenes_Variacion.Rows.Add(Dr_Limitado_Orden_Variacion);
            //}
            Grid_Ordenes_Variacion.DataSource = Dt_Ordenes_Variacion;// Dt_Limitado_Ordenes_Variacion;
            Grid_Ordenes_Variacion.PageIndex = Pagina;
            Grid_Ordenes_Variacion.DataBind();

            Session["Dt_Ordenes_Variacion"] = null;
            Session["Dt_Ordenes_Variacion"] = Dt_Ordenes_Variacion;

            if (Dt_Ordenes_Variacion.Rows.Count < Orden_Variacion.P_Maximo_Registros)
            {
                Txt_Total_Movimientos.Text = Dt_Ordenes_Variacion.Rows.Count.ToString();
            }
            else
            {
                Txt_Total_Movimientos.Text = "+" + (Orden_Variacion.P_Maximo_Registros - 1).ToString();
            }
        }
        catch (Exception Ex)
        {
    ...
    private void Mensaje_Error(String P_Mensaje)
    {
        ...
        Img_Error1.Visible = true;
        Lbl_Mensaje_Error1.Text += P_Mensaje + "</br>";
    }
    ...
    private void Mensaje_Error()
    {
        ...
        Img_Error1.Visible = false;
        Lbl_Mensaje_Error1.Text = "";
        Lbl_Encabezado_Error1.Text = "";
    }
    ...
    private void Estado_Botones(int P_Estado)
    {
        switch (P_Estado)
        {
            case 0: //Estado inicial                
                ...
                Btn_Validar.ImageUrl = "~/paginas/imagenes/paginas/accept.png";
            ...
            case 3: //Modificar
                ...
                Btn_Validar.AlternateText = "Actualizar";
                Btn_Validar.ToolTip = "Actualizar";
                ...
                Btn_Validar.ImageUrl = "~/paginas/imagenes/paginas/save-as.png";
    ...
    private void Configurar_Estatus_Controles(Boolean Estatus_Activo)
    {
        ...
        //Btn_Validar.Enabled = Estatus_Activo;
        Txt_Observaciones_Validacion.Enabled = Estatus_Activo;

        //Grid_Ordenes_Variacion.Visible = !Estatus_Activo;
        Panel_Resumen.Visible = !Estatus_Activo;
        Panel_Detalle.Visible = Estatus_Activo;
        if (Panel_Detalle.Visible)
        {
    ...
    {
        Grid_Ordenes_Variacion.Enabled = !Estatus_Activo;
        Cmb_Estatus_Orden_Variacion.Enabled = Estatus_Activo;
        //Btn_Validar.Enabled = Estatus_Activo;
        Txt_Observaciones_Validacion.Enabled = Estatus_Activo;
    }
    ...
    private void Inicializa_Controles()
    {
        try
        {
            Cmb_Busqueda_Estatus_Ordenes.SelectedIndex = 0;
            Configurar_Estatus_Controles(false);
            Estado_Botones(Const_Estado_Inicial);
            Txt_Total_Movimientos.Style["text-align"] = "right";
        }
        catch (Exception Ex)
        {
            Mensaje_Error(Ex.Message);
    ...
    private Boolean Cargar_Datos_Cuenta()
    {
        ...
        try
        {
            ...
            if (Dt_Cuenta_Predial.Rows.Count > 0)
            {
                ...
                if (Dt_Cuenta_Predial.Rows[0][Cat_Pre_Cuentas_Predial.Campo_Colonia_ID] != DBNull.Value)
                {
                    Hdn_Colonia_ID.Value = Dt_Cuenta_Predial.Rows[0][Cat_Pre_Cuentas_Predial.Campo_Colonia_ID].ToString().Trim();
                    Clave_Colonia = Obtener_Dato_Consulta(ref Cmd, Cat_Ate_Colonias.Campo_Clave, Cat_Ate_Colonias.Tabla_Cat_Ate_Colonias, Cat_Ate_Colonias.Campo_Colonia_ID + " = '" + Hdn_Colonia_ID.Value + "'");
                ...
                if (Dt_Cuenta_Predial.Rows[0][Cat_Pre_Cuentas_Predial.Campo_Calle_ID] != DBNull.Value)
                {
                    Hdn_Calle_ID.Value = Dt_Cuenta_Predial.Rows[0][Cat_Pre_Cuentas_Predial.Campo_Calle_ID].ToString().Trim();
                    Clave_Calle = Obtener_Dato_Consulta(ref Cmd, Cat_Pre_Calles.Campo_Clave, Cat_Pre_Calles.Tabla_Cat_Pre_Calles, Cat_Pre_Calles.Campo_Calle_ID + " = '" + Hdn_Calle_ID.Value + "'");
                    Txt_Calle_Cuenta.Text = Clave_Calle + " " + HttpUtility.HtmlDecode(Dt_Cuenta_Predial.Rows[0]["NOMBRE_CALLE"].ToString().Trim().ToUpper());
                }
                if (Dt_Cuenta_Predial.Rows[0][Cat_Pre_Cuentas_Predial.Campo_Estado_Predio_ID] != DBNull.Value)
                {
                    Txt_Estado_Predio.Text = Dt_Cuenta_Predial.Rows[0]["DESCRIPCION_ESTADO_PREDIO"].ToString().Trim().ToUpper();
                }
                if (Dt_Cuenta_Predial.Rows[0][Cat_Pre_Cuentas_Predial.Campo_Tipo_Predio_ID] != DBNull.Value)
                {
                ...
                if (Dt_Cuenta_Predial.Rows[0][Cat_Pre_Cuentas_Predial.Campo_Superficie_Total] != DBNull.Value)
                {
                ...
                if (Dt_Cuenta_Predial.Rows[0][Cat_Pre_Cuentas_Predial.Campo_Clave_Catastral] != DBNull.Value)
                {
                    Txt_Catastral.Text = Dt_Cuenta_Predial.Rows[0][Cat_Pre_Cuentas_Predial.Campo_Clave_Catastral].ToString().Trim().ToUpper();
                }
                if (Dt_Cuenta_Predial.Rows[0][Cat_Pre_Cuentas_Predial.Campo_Valor_Fiscal] != DBNull.Value)
                {
                    Txt_Valor_Fiscal.Text = Convert.ToDouble(Dt_Cuenta_Predial.Rows[0][Cat_Pre_Cuentas_Predial.Campo_Valor_Fiscal]).ToString("##,###,##0.00");
                }
                if (Dt_Cuenta_Predial.Rows[0][Cat_Pre_Cuentas_Predial.Campo_Efectos] != DBNull.Value)
                {
                    Txt_Efectos.Text = Dt_Cuenta_Predial.Rows[0][Cat_Pre_Cuentas_Predial.Campo_Efectos].ToString().Trim();
                }
                if (Dt_Cuenta_Predial.Rows[0][Cat_Pre_Cuentas_Predial.Campo_Periodo_Corriente] != DBNull.Value)
                {
                ...
                if (Dt_Cuenta_Predial.Rows[0][Cat_Pre_Cuentas_Predial.Campo_Cuota_Anual] != DBNull.Value)
                {
                ...
                if (Dt_Cuenta_Predial.Rows[0][Cat_Pre_Cuentas_Predial.Campo_Cuota_Fija] != DBNull.Value)
                {
                    ...
                    if (Dt_Cuenta_Predial.Rows[0][Cat_Pre_Cuentas_Predial.Campo_Cuota_Fija].ToString().ToUpper() == "SI")
                    {
                        ...
                        if (Dt_Cuenta_Predial.Rows[0][Cat_Pre_Cuentas_Predial.Campo_No_Couta_Fija] != DBNull.Value)
                        {
                ...
                if (Dt_Cuenta_Predial.Rows[0][Cat_Pre_Cuentas_Predial.Campo_Termino_Exencion] != DBNull.Value)
                {
                    if (Convert.ToDateTime(Dt_Cuenta_Predial.Rows[0][Cat_Pre_Cuentas_Predial.Campo_Termino_Exencion].ToString()) != DateTime.MinValue)
                    {
                        CE_Txt_Termino_Exencion.SelectedDate = Convert.ToDateTime(Dt_Cuenta_Predial.Rows[0][Cat_Pre_Cuentas_Predial.Campo_Termino_Exencion].ToString());
                    }
                }
                if (Dt_Cuenta_Predial.Rows[0][Cat_Pre_Cuentas_Predial.Campo_Fecha_Avaluo] != DBNull.Value)
                {
                    if (Convert.ToDateTime(Dt_Cuenta_Predial.Rows[0][Cat_Pre_Cuentas_Predial.Campo_Fecha_Avaluo].ToString()) != DateTime.MinValue)
                    {
                        CE_Txt_Fecha_Avaluo.SelectedDate = Convert.ToDateTime(Dt_Cuenta_Predial.Rows[0][Cat_Pre_Cuentas_Predial.Campo_Fecha_Avaluo].ToString());
                    }
                }
                if (Dt_Cuenta_Predial.Rows[0][Cat_Pre_Cuentas_Predial.Campo_Diferencia_Construccion] != DBNull.Value)
                {
                ...
                if (Dt_Cuenta_Predial.Rows[0][Cat_Pre_Cuentas_Predial.Campo_Costo_m2] != DBNull.Value)
                {
                    Txt_Costo_M2.Text = Convert.ToDouble(Dt_Cuenta_Predial.Rows[0][Cat_Pre_Cuentas_Predial.Campo_Costo_m2]).ToString("##,###,##0.00");
                }
                if (Dt_Cuenta_Predial.Rows[0][Cat_Pre_Cuentas_Predial.Campo_Porcentaje_Exencion] != DBNull.Value)
                {
                ...
                if (Dt_Cuenta_Predial.Rows[0][Cat_Pre_Cuentas_Predial.Campo_Tasa_Predial_ID] != DBNull.Value)
                {
                ...
                if (Dt_Cuenta_Predial.Rows[0][Cat_Pre_Cuentas_Predial.Campo_Colonia_ID_Notificacion] != DBNull.Value)
                {
                    ...
                    Clave_Colonia = Obtener_Dato_Consulta(ref Cmd, Cat_Ate_Colonias.Campo_Clave, Cat_Ate_Colonias.Tabla_Cat_Ate_Colonias, Cat_Ate_Colonias.Campo_Colonia_ID + " = '" + Hdn_Colonia_ID_Notificacion.Value + "'");
                ...
                if (Dt_Cuenta_Predial.Rows[0][Cat_Pre_Cuentas_Predial.Campo_Calle_ID_Notificacion] != DBNull.Value)
                {
                    ...
                    Clave_Calle = Obtener_Dato_Consulta(ref Cmd, Cat_Pre_Calles.Campo_Clave, Cat_Pre_Calles.Tabla_Cat_Pre_Calles, Cat_Pre_Calles.Campo_Calle_ID + " = '" + Hdn_Calle_ID_Notificacion.Value + "'");
                ...
                if (Dt_Cuenta_Predial.Rows[0][Cat_Pre_Cuentas_Predial.Campo_Colonia_Notificacion] != DBNull.Value)
                {
                ...
                if (Dt_Cuenta_Predial.Rows[0][Cat_Pre_Cuentas_Predial.Campo_Calle_Notificacion] != DBNull.Value)
                {
                ...
                if (Dt_Cuenta_Predial.Rows[0][Cat_Pre_Cuentas_Predial.Campo_No_Exterior_Notificacion] != DBNull.Value)
                {
                ...
                if (Dt_Cuenta_Predial.Rows[0][Cat_Pre_Cuentas_Predial.Campo_No_Interior_Notificacion] != DBNull.Value)
                {
                ...
                if (Dt_Cuenta_Predial.Rows[0][Cat_Pre_Cuentas_Predial.Campo_Codigo_Postal] != DBNull.Value)
                {
                    Txt_CP.Text = Dt_Cuenta_Predial.Rows[0][Cat_Pre_Cuentas_Predial.Campo_Codigo_Postal].ToString().Trim().ToUpper();
                }
                //if (Dt_Cuenta_Predial.Rows[0][Cat_Pre_Cuentas_Predial.Campo_No_Diferencia] != DBNull.Value)
                //{
                //    Txt_DI.Text = Dt_Cuenta_Predial.Rows[0][Cat_Pre_Cuentas_Predial.Campo_No_Diferencia].ToString().ToUpper();
                //}
                if (Dt_Cuenta_Predial.Rows[0][Cat_Pre_Cuentas_Predial.Campo_Estado_Notificacion] != DBNull.Value)
                {
                ...
                if (Dt_Cuenta_Predial.Rows[0][Cat_Pre_Cuentas_Predial.Campo_Ciudad_Notificacion] != DBNull.Value)
                {
    ...
    ///******************************************************************************* 
    ///NOMBRE DE LA FUNCIÓN : Cargar_Variacion_Orden
    ...
    private Boolean Cargar_Variacion_Orden()
    {
        ...
        DataRow[] Arr_Dr_Datos_Variacion;
        ...
        Orden_Variacion.P_Incluir_Campos_Foraneos = true;
        Orden_Variacion.P_Cuenta_Predial_ID = Grid_Ordenes_Variacion.DataKeys[Grid_Ordenes_Variacion.SelectedIndex].Values[1].ToString();
        Orden_Variacion.P_Orden_Variacion_ID = Grid_Ordenes_Variacion.SelectedRow.Cells[1].Text;
        Orden_Variacion.P_Año = Convert.ToDateTime(Grid_Ordenes_Variacion.SelectedRow.Cells[5].Text).Year;
        Orden_Variacion.P_Observaciones_No_Orden_Variacion = Grid_Ordenes_Variacion.SelectedRow.Cells[1].Text;
        ...
        if (Dt_Variacion_Cuenta != null)
        {
            ...
            if (Arr_Dr_Variacion_Cuenta.Length > 0)
            {
                ...
                Arr_Dr_Datos_Variacion = Dt_Variacion_Cuenta.Select("NOMBRE_CAMPO = '" + Ope_Pre_Ordenes_Variacion.Campo_Estatus_Cuenta + "'");
                if (Arr_Dr_Datos_Variacion.Length > 0)
                {
                    Estatus_Cuenta = Arr_Dr_Datos_Variacion[0]["DATO_NUEVO"].ToString();
                }
                ...
                foreach (DataRow Dr_Variacion_Cuenta in Dt_Variacion_Cuenta.Rows)
                {
                    ...
                    switch (Dr_Variacion_Cuenta["NOMBRE_CAMPO"].ToString())
                    {
                        ...
                        case Ope_Pre_Ordenes_Variacion.Campo_Movimiento_ID:
                            ...
                            Hdn_Grupo_Movimiento_ID.Value = Obtener_Dato_Consulta(ref Cmd, Cat_Pre_Movimientos.Campo_Grupo_Id, Cat_Pre_Movimientos.Tabla_Cat_Pre_Movimientos, Cat_Pre_Movimientos.Campo_Movimiento_ID + " = '" + Hdn_Movimiento_ID.Value + "'");
                            break;
                        ...
                        case Ope_Pre_Ordenes_Variacion.Campo_Tasa_Predial_ID:
                            ...
                            Dato_Nuevo = Obtener_Dato_Consulta(ref Cmd, Cat_Pre_Tasas_Predial.Campo_Identificador + " || ' - ' || " + Cat_Pre_Tasas_Predial.Campo_Descripcion, Cat_Pre_Tasas_Predial.Tabla_Cat_Pre_Tasas_Predial, Dr_Variacion_Cuenta["NOMBRE_CAMPO"].ToString() + " = '" + Dr_Variacion_Cuenta["DATO_NUEVO"].ToString() + "'");
                            Txt_Tasa_Descripcion.Text = HttpUtility.HtmlDecode(Dato_Nuevo);
                            if (Convert.ToBoolean(Dr_Variacion_Cuenta["DIFERENTE"]))
                            {
                                Dato_Anterior = Obtener_Dato_Consulta(ref Cmd, Cat_Pre_Tasas_Predial.Campo_Identificador + " || ' - ' || " + Cat_Pre_Tasas_Predial.Campo_Descripcion, Cat_Pre_Tasas_Predial.Tabla_Cat_Pre_Tasas_Predial, Dr_Variacion_Cuenta["NOMBRE_CAMPO"].ToString() + " = '" + Dr_Variacion_Cuenta["DATO_ANTERIOR"].ToString() + "'");
                        ...
                        case Ope_Pre_Ordenes_Variacion.Campo_Tasa_ID:
                            ...
                            Dato_Nuevo = Obtener_Dato_Consulta(ref Cmd, Cat_Pre_Tasas_Predial_Anual.Campo_Tasa_Anual, Cat_Pre_Tasas_Predial_Anual.Tabla_Cat_Pre_Tasas_Predial_Anual, Dr_Variacion_Cuenta["NOMBRE_CAMPO"].ToString() + " = '" + Dr_Variacion_Cuenta["DATO_NUEVO"].ToString() + "'");
                            Txt_Tasa_Porcentaje.Text = Dato_Nuevo;
                            if (Convert.ToBoolean(Dr_Variacion_Cuenta["DIFERENTE"]))
                            {
                                Dato_Anterior = Obtener_Dato_Consulta(ref Cmd, Cat_Pre_Tasas_Predial_Anual.Campo_Tasa_Anual, Cat_Pre_Tasas_Predial_Anual.Tabla_Cat_Pre_Tasas_Predial_Anual, Dr_Variacion_Cuenta["NOMBRE_CAMPO"].ToString() + " = '" + Dr_Variacion_Cuenta["DATO_ANTERIOR"].ToString() + "'");
                        ...
                        case Ope_Pre_Ordenes_Variacion.Campo_Calle_ID:
                            ...
                            Dato_Nuevo = Obtener_Dato_Consulta(ref Cmd, Cat_Pre_Calles.Campo_Nombre, Cat_Pre_Calles.Tabla_Cat_Pre_Calles, Dr_Variacion_Cuenta["NOMBRE_CAMPO"].ToString() + " = '" + Dr_Variacion_Cuenta["DATO_NUEVO"].ToString() + "'");
                            Clave_Calle = Obtener_Dato_Consulta(ref Cmd, Cat_Pre_Calles.Campo_Clave, Cat_Pre_Calles.Tabla_Cat_Pre_Calles, Cat_Pre_Calles.Campo_Calle_ID + " = '" + Dr_Variacion_Cuenta["DATO_NUEVO"].ToString() + "'");
                            Txt_Calle_Cuenta.Text = Clave_Calle + " " + HttpUtility.HtmlDecode(Dato_Nuevo);
                            if (Convert.ToBoolean(Dr_Variacion_Cuenta["DIFERENTE"]))
                            {
                                Dato_Anterior = Obtener_Dato_Consulta(ref Cmd, Cat_Pre_Calles.Campo_Nombre, Cat_Pre_Calles.Tabla_Cat_Pre_Calles, Dr_Variacion_Cuenta["NOMBRE_CAMPO"].ToString() + " = '" + Dr_Variacion_Cuenta["DATO_ANTERIOR"].ToString() + "'");
                                Clave_Calle = Obtener_Dato_Consulta(ref Cmd, Cat_Pre_Calles.Campo_Clave, Cat_Pre_Calles.Tabla_Cat_Pre_Calles, Cat_Pre_Calles.Campo_Calle_ID + " = '" + Dr_Variacion_Cuenta["DATO_ANTERIOR"].ToString() + "'");
                        ...
                        case Ope_Pre_Ordenes_Variacion.Campo_Colonia_ID:
                            ...
                            Dato_Nuevo = Obtener_Dato_Consulta(ref Cmd, Cat_Ate_Colonias.Campo_Nombre, Cat_Ate_Colonias.Tabla_Cat_Ate_Colonias, Dr_Variacion_Cuenta["NOMBRE_CAMPO"].ToString() + " = '" + Dr_Variacion_Cuenta["DATO_NUEVO"].ToString() + "'");
                            Clave_Colonia = Obtener_Dato_Consulta(ref Cmd, Cat_Ate_Colonias.Campo_Clave, Cat_Ate_Colonias.Tabla_Cat_Ate_Colonias, Cat_Ate_Colonias.Campo_Colonia_ID + " = '" + Dr_Variacion_Cuenta["DATO_NUEVO"].ToString() + "'");
                            Txt_Colonia_Cuenta.Text = Clave_Colonia + " " + HttpUtility.HtmlDecode(Dato_Nuevo);
                            if (Convert.ToBoolean(Dr_Variacion_Cuenta["DIFERENTE"]))
                            {
                                Dato_Anterior = Obtener_Dato_Consulta(ref Cmd, Cat_Ate_Colonias.Campo_Nombre, Cat_Ate_Colonias.Tabla_Cat_Ate_Colonias, Dr_Variacion_Cuenta["NOMBRE_CAMPO"].ToString() + " = '" + Dr_Variacion_Cuenta["DATO_ANTERIOR"].ToString() + "'");
                                Clave_Colonia = Obtener_Dato_Consulta(ref Cmd, Cat_Ate_Colonias.Campo_Clave, Cat_Ate_Colonias.Tabla_Cat_Ate_Colonias, Cat_Ate_Colonias.Campo_Colonia_ID + " = '" + Dr_Variacion_Cuenta["DATO_ANTERIOR"].ToString() + "'");
                        ...
                        case Ope_Pre_Ordenes_Variacion.Campo_Calle_ID_Notificacion:
                            if (Dr_Variacion_Cuenta["DATO_NUEVO"].ToString() != "")
                            {
                                ...
                                Dato_Nuevo = Obtener_Dato_Consulta(ref Cmd, Cat_Pre_Calles.Campo_Nombre, Cat_Pre_Calles.Tabla_Cat_Pre_Calles, Cat_Pre_Calles.Campo_Calle_ID + " = '" + Hdn_Calle_ID_Notificacion.Value + "'");
                                Clave_Calle = Obtener_Dato_Consulta(ref Cmd, Cat_Pre_Calles.Campo_Clave, Cat_Pre_Calles.Tabla_Cat_Pre_Calles, Cat_Pre_Calles.Campo_Calle_ID + " = '" + Hdn_Calle_ID_Notificacion.Value + "'");
                                Calle_ID_Notificacion_Nuevo = Clave_Calle + " " + HttpUtility.HtmlDecode(Dato_Nuevo);
                            }
                            if (Dr_Variacion_Cuenta["DATO_ANTERIOR"].ToString() != "")
                            {
                                Dato_Anterior = Obtener_Dato_Consulta(ref Cmd, Cat_Pre_Calles.Campo_Nombre, Cat_Pre_Calles.Tabla_Cat_Pre_Calles, Cat_Pre_Calles.Campo_Calle_ID + " = '" + Dr_Variacion_Cuenta["DATO_ANTERIOR"].ToString() + "'");
                                Clave_Calle = Obtener_Dato_Consulta(ref Cmd, Cat_Pre_Calles.Campo_Clave, Cat_Pre_Calles.Tabla_Cat_Pre_Calles, Cat_Pre_Calles.Campo_Calle_ID + " = '" + Dr_Variacion_Cuenta["DATO_ANTERIOR"].ToString() + "'");
                        ...
                        case Ope_Pre_Ordenes_Variacion.Campo_Colonia_ID_Notificacion:
                            if (Dr_Variacion_Cuenta["DATO_NUEVO"].ToString() != "")
                            {
                                ...
                                Dato_Nuevo = Obtener_Dato_Consulta(ref Cmd, Cat_Ate_Colonias.Campo_Nombre, Cat_Ate_Colonias.Tabla_Cat_Ate_Colonias, Cat_Ate_Colonias.Campo_Colonia_ID + " = '" + Hdn_Colonia_ID_Notificacion.Value + "'");
                                Clave_Colonia = Obtener_Dato_Consulta(ref Cmd, Cat_Ate_Colonias.Campo_Clave, Cat_Ate_Colonias.Tabla_Cat_Ate_Colonias, Cat_Ate_Colonias.Campo_Colonia_ID + " = '" + Hdn_Colonia_ID_Notificacion.Value + "'");
                                Colonia_ID_Notificacion_Nuevo = Clave_Colonia + " " + HttpUtility.HtmlDecode(Dato_Nuevo);
                            }
                            if (Dr_Variacion_Cuenta["DATO_ANTERIOR"].ToString() != "")
                            {
                                Dato_Anterior = Obtener_Dato_Consulta(ref Cmd, Cat_Ate_Colonias.Campo_Nombre, Cat_Ate_Colonias.Tabla_Cat_Ate_Colonias, Cat_Ate_Colonias.Campo_Colonia_ID + " = '" + Dr_Variacion_Cuenta["DATO_ANTERIOR"].ToString() + "'");
                                Clave_Colonia = Obtener_Dato_Consulta(ref Cmd, Cat_Ate_Colonias.Campo_Clave, Cat_Ate_Colonias.Tabla_Cat_Ate_Colonias, Cat_Ate_Colonias.Campo_Colonia_ID + " = '" + Dr_Variacion_Cuenta["DATO_ANTERIOR"].ToString() + "'");
                        ...
                        case Ope_Pre_Ordenes_Variacion.Campo_Estado_ID_Notificacion:
                            if (Dr_Variacion_Cuenta["DATO_NUEVO"].ToString() != "")
                            {
                                ...
                                Dato_Nuevo = Obtener_Dato_Consulta(ref Cmd, Cat_Pre_Estados.Campo_Nombre, Cat_Pre_Estados.Tabla_Cat_Pre_Estados, Cat_Pre_Estados.Campo_Estado_ID + " = '" + Hdn_Estado_ID_Notificacion.Value + "'");
                                Estado_ID_Notificacion_Nuevo = HttpUtility.HtmlDecode(Dato_Nuevo);
                            }
                            if (Dr_Variacion_Cuenta["DATO_ANTERIOR"].ToString() != "")
                            {
                                Dato_Anterior = Obtener_Dato_Consulta(ref Cmd, Cat_Pre_Estados.Campo_Nombre, Cat_Pre_Estados.Tabla_Cat_Pre_Estados, Cat_Pre_Estados.Campo_Estado_ID + " = '" + Dr_Variacion_Cuenta["DATO_ANTERIOR"].ToString() + "'");
                        ...
                        case Ope_Pre_Ordenes_Variacion.Campo_Ciudad_ID_Notificacion:
                            if (Dr_Variacion_Cuenta["DATO_NUEVO"].ToString() != "")
                            {
                                ...
                                Dato_Nuevo = Obtener_Dato_Consulta(ref Cmd, Cat_Pre_Ciudades.Campo_Nombre, Cat_Pre_Ciudades.Tabla_Cat_Pre_Ciudades, Cat_Pre_Ciudades.Campo_Ciudad_ID + " = '" + Hdn_Ciudad_ID_Notificacion.Value + "'");
                                Ciudad_ID_Notificacion_Nuevo = HttpUtility.HtmlDecode(Dato_Nuevo);
                            }
                            if (Dr_Variacion_Cuenta["DATO_ANTERIOR"].ToString() != "")
                            {
                                Dato_Anterior = Obtener_Dato_Consulta(ref Cmd, Cat_Pre_Ciudades.Campo_Nombre, Cat_Pre_Ciudades.Tabla_Cat_Pre_Ciudades, Cat_Pre_Ciudades.Campo_Ciudad_ID + " = '" + Dr_Variacion_Cuenta["DATO_ANTERIOR"].ToString() + "'");
                        ...
                        case Ope_Pre_Ordenes_Variacion.Campo_Estado_Predio_ID:
                            Dato_Nuevo = Obtener_Dato_Consulta(ref Cmd, Cat_Pre_Estados_Predio.Campo_Descripcion, Cat_Pre_Estados_Predio.Tabla_Cat_Pre_Estados_Predio, Dr_Variacion_Cuenta["NOMBRE_CAMPO"].ToString() + " = '" + Dr_Variacion_Cuenta["DATO_NUEVO"].ToString() + "'");
                            Txt_Estado_Predio.Text = Dato_Nuevo;
                            if (Convert.ToBoolean(Dr_Variacion_Cuenta["DIFERENTE"]))
                            {
                                Dato_Anterior = Obtener_Dato_Consulta(ref Cmd, Cat_Pre_Estados_Predio.Campo_Descripcion, Cat_Pre_Estados_Predio.Tabla_Cat_Pre_Estados_Predio, Dr_Variacion_Cuenta["NOMBRE_CAMPO"].ToString() + " = '" + Dr_Variacion_Cuenta["DATO_ANTERIOR"].ToString() + "'");
                        ...
                        case Ope_Pre_Ordenes_Variacion.Campo_Tipo_Predio_ID:
                            ...
                            Dato_Nuevo = Obtener_Dato_Consulta(ref Cmd, Cat_Pre_Tipos_Predio.Campo_Descripcion, Cat_Pre_Tipos_Predio.Tabla_Cat_Pre_Tipos_Predio, Dr_Variacion_Cuenta["NOMBRE_CAMPO"].ToString() + " = '" + Dr_Variacion_Cuenta["DATO_NUEVO"].ToString() + "'");
                            Txt_Tipo_Predio.Text = Dato_Nuevo;
                            if (Convert.ToBoolean(Dr_Variacion_Cuenta["DIFERENTE"]))
                            {
                                Dato_Anterior = Obtener_Dato_Consulta(ref Cmd, Cat_Pre_Tipos_Predio.Campo_Descripcion, Cat_Pre_Tipos_Predio.Tabla_Cat_Pre_Tipos_Predio, Dr_Variacion_Cuenta["NOMBRE_CAMPO"].ToString() + " = '" + Dr_Variacion_Cuenta["DATO_ANTERIOR"].ToString() + "'");
                        ...
                        case Ope_Pre_Ordenes_Variacion.Campo_Uso_Suelo_ID:
                            ...
                            Dato_Nuevo = Obtener_Dato_Consulta(ref Cmd, Cat_Pre_Uso_Suelo.Campo_Descripcion, Cat_Pre_Uso_Suelo.Tabla_Cat_Pre_Uso_Suelo, Dr_Variacion_Cuenta["NOMBRE_CAMPO"].ToString() + " = '" + Dr_Variacion_Cuenta["DATO_NUEVO"].ToString() + "'");
                            Txt_Uso_Predio.Text = Dato_Nuevo;
                            if (Convert.ToBoolean(Dr_Variacion_Cuenta["DIFERENTE"]))
                            {
                                Dato_Anterior = Obtener_Dato_Consulta(ref Cmd, Cat_Pre_Uso_Suelo.Campo_Descripcion, Cat_Pre_Uso_Suelo.Tabla_Cat_Pre_Uso_Suelo, Dr_Variacion_Cuenta["NOMBRE_CAMPO"].ToString() + " = '" + Dr_Variacion_Cuenta["DATO_ANTERIOR"].ToString() + "'");
                        ...
                        case Ope_Pre_Ordenes_Variacion.Campo_Cuota_Minima_ID:
                            Dato_Nuevo = Obtener_Dato_Consulta(ref Cmd, Cat_Pre_Cuotas_Minimas.Campo_Cuota, Cat_Pre_Cuotas_Minimas.Tabla_Cat_Pre_Cuotas_Minimas, Dr_Variacion_Cuenta["NOMBRE_CAMPO"].ToString() + " = '" + Dr_Variacion_Cuenta["DATO_NUEVO"].ToString() + "'");
                            if (Dato_Nuevo != "")
                            {
                            ...
                            //if (Convert.ToBoolean(Dr_Variacion_Cuenta["DIFERENTE"]))
                            //{
                            //    Dato_Anterior = Obtener_Dato_Consulta(ref Cmd, Cat_Pre_Cuotas_Minimas.Campo_Cuota, Cat_Pre_Cuotas_Minimas.Tabla_Cat_Pre_Cuotas_Minimas, Dr_Variacion_Cuenta["NOMBRE_CAMPO"].ToString() + " = '" + Dr_Variacion_Cuenta["DATO_ANTERIOR"].ToString() + "'");
                            //    if (Dato_Anterior != "")
                            //    {
                        ...
                        case Ope_Pre_Ordenes_Variacion.Campo_Superficie_Construida:
                            ...
                            if (Convert.ToBoolean(Dr_Variacion_Cuenta["DIFERENTE"]) || Estatus_Cuenta == "PENDIENTE")
                            {
                        ...
                        case Ope_Pre_Cuotas_Fijas.Campo_No_Cuota_Fija:
                            ...
                            {
                                if (Hdn_No_Cuota_Fija_Nuevo.Value.Trim().Length == 5)
                                {
                                    Session["Cuota_Fija_Nueva"] = Convert.ToDecimal(Obtener_Dato_Consulta(ref Cmd, Ope_Pre_Cuotas_Fijas.Campo_Total_Cuota_Fija, Ope_Pre_Cuotas_Fijas.Tabla_Ope_Pre_Cuotas_Fijas, Ope_Pre_Cuotas_Fijas.Campo_Caso_Especial_Id + " = '" + Hdn_No_Cuota_Fija_Nuevo.Value + "'"));
                                }
                                else
                                {
                                    Session["Cuota_Fija_Nueva"] = Convert.ToDecimal(Obtener_Dato_Consulta(ref Cmd, Ope_Pre_Cuotas_Fijas.Campo_Total_Cuota_Fija, Ope_Pre_Cuotas_Fijas.Tabla_Ope_Pre_Cuotas_Fijas, Ope_Pre_Cuotas_Fijas.Campo_No_Cuota_Fija + " = '" + Hdn_No_Cuota_Fija_Nuevo.Value + "'"));
                                }
                            }
                            Hdn_No_Cuota_Fija_Anterior.Value = Dr_Variacion_Cuenta["DATO_ANTERIOR"].ToString();
                            if (Hdn_No_Cuota_Fija_Anterior.Value != "")
                            {
                                if (Hdn_No_Cuota_Fija_Anterior.Value.Trim().Length == 5)
                                {
                                    Session["Cuota_Fija_Anterior"] = Convert.ToDecimal(Obtener_Dato_Consulta(ref Cmd, Ope_Pre_Cuotas_Fijas.Campo_Total_Cuota_Fija, Ope_Pre_Cuotas_Fijas.Tabla_Ope_Pre_Cuotas_Fijas, Ope_Pre_Cuotas_Fijas.Campo_Caso_Especial_Id + " = '" + Hdn_No_Cuota_Fija_Anterior.Value + "'"));
                                }
                                else
                                {
                                    Session["Cuota_Fija_Anterior"] = Convert.ToDecimal(Obtener_Dato_Consulta(ref Cmd, Ope_Pre_Cuotas_Fijas.Campo_Total_Cuota_Fija, Ope_Pre_Cuotas_Fijas.Tabla_Ope_Pre_Cuotas_Fijas, Ope_Pre_Cuotas_Fijas.Campo_No_Cuota_Fija + " = '" + Hdn_No_Cuota_Fija_Anterior.Value + "'"));
                                }
                            }
                            if (Txt_Cuota_Fija.Text == "SI")
                            {
    ...
    ///******************************************************************************* 
    ///NOMBRE DE LA FUNCIÓN : Cargar_Variacion_Propietario
    ...
    private Boolean Cargar_Variacion_Propietarios()
    {
        ...
        try
        {
            ...
            Ordenes_Variacion.P_Año = Convert.ToDateTime(Grid_Ordenes_Variacion.Rows[Grid_Ordenes_Variacion.SelectedIndex].Cells[5].Text).Year;
        ...
        if (HttpUtility.HtmlDecode(Txt_Domicilio_Foraneo.Text).Trim() == "SI")
        {
            ...
            if (HttpUtility.HtmlDecode(Hdn_Colonia_Notificacion_Nuevo.Value).Trim() != "")
            {
                if (HttpUtility.HtmlDecode(Hdn_Colonia_Notificacion_Nuevo.Value).ToUpper().Trim() != Txt_Colonia_Propietario.Text.Trim())
                {
                    ...
                    if (Txt_Estatus.Text.Trim() != "CANCELADA"
                        && Txt_Estatus.ToolTip.Trim() != "CANCELADA")
                    {
    ...
    {
        Cls_Ope_Pre_Orden_Variacion_Negocio Ordenes_Variacion = new Cls_Ope_Pre_Orden_Variacion_Negocio();
        Ordenes_Variacion.P_Orden_Variacion_ID = Grid_Ordenes_Variacion.SelectedRow.Cells[1].Text;
        if (Txt_Busqueda.Text.Trim() != "")
        {
        ...
        Ordenes_Variacion.P_Generar_Orden_Anio = Convert.ToDateTime(Grid_Ordenes_Variacion.SelectedRow.Cells[5].Text).Year.ToString();
        Ordenes_Variacion.P_Observaciones_No_Orden_Variacion = Grid_Ordenes_Variacion.SelectedRow.Cells[1].Text;
        Ordenes_Variacion.P_Año = Convert.ToDateTime(Grid_Ordenes_Variacion.SelectedRow.Cells[5].Text).Year;
    ...
    ///CAUSA_MODIFICACIÓN:
    ///*******************************************************************************    
    private Boolean Aplicar_Variacion(ref OracleCommand Cmmd)
    {
        Cls_Ope_Pre_Orden_Variacion_Negocio Ordenes_Variacion = new Cls_Ope_Pre_Orden_Variacion_Negocio();
        ...
        {
            throw new Exception("Error al Aplicar Variación: " + ex.ToString());
        }
            ...
            if (Dt_Cuotas_Fijas != null)
            {
                if (Dt_Cuotas_Fijas.Rows.Count > 0)
                {
                    ...
                    if (Dt_Cuotas_Fijas.Rows[0][Ope_Pre_Cuotas_Fijas.Campo_Total_Cuota_Fija].ToString() != "")
                    {
                        ...
                        if (Dt_Cuotas_Fijas.Rows[0][Ope_Pre_Cuotas_Fijas.Campo_Total_Cuota_Fija] != DBNull.Value)
                        {
                            Total_Cuota_Fija = Convert.ToDecimal(Dt_Cuotas_Fijas.Rows[0][Ope_Pre_Cuotas_Fijas.Campo_Total_Cuota_Fija]);
                        }
                        if (Dt_Cuotas_Fijas.Rows[0][Ope_Pre_Cuotas_Fijas.Campo_Excedente_Construccion_Total] != DBNull.Value)
                        {
                            Excedente_Construccion_Total = Convert.ToDecimal(Dt_Cuotas_Fijas.Rows[0][Ope_Pre_Cuotas_Fijas.Campo_Excedente_Construccion_Total]);
                        }
                        if (Dt_Cuotas_Fijas.Rows[0][Ope_Pre_Cuotas_Fijas.Campo_Excedente_Valor_Total] != DBNull.Value)
                        {
                            Excedente_Valor_Total = Convert.ToDecimal(Dt_Cuotas_Fijas.Rows[0][Ope_Pre_Cuotas_Fijas.Campo_Excedente_Valor_Total]);
                        }

                        Txt_Cuota_Minima_Aplicar.Text = (Total_Cuota_Fija - (Excedente_Construccion_Total + Excedente_Valor_Total)).ToString("##,###,##0.00");
                    ...
                    {
                        Txt_Excedente_Construccion_Total.Text = Convert.ToDecimal(Dt_Cuotas_Fijas.Rows[0][Ope_Pre_Cuotas_Fijas.Campo_Excedente_Construccion_Total]).ToString("##,###,##0.00");
                    ...
                    {
                        Txt_Excedente_Valor_Total.Text = Convert.ToDecimal(Dt_Cuotas_Fijas.Rows[0][Ope_Pre_Cuotas_Fijas.Campo_Excedente_Valor_Total]).ToString("##,###,##0.00");
        ...
        try
        {
            ...
            if (Txt_Valor_Fiscal.Text.Trim() != "" && Txt_Tasa_Porcentaje.Text.Trim() != "")
            {
                if (Txt_Cuota_Anual.Text.Trim() != "")
                {
                    ...
                    {
                        Factor = Convert.ToDecimal(Txt_Tasa_Porcentaje.Text.Trim()) / 1000;
                    }
                    if (Txt_Valor_Fiscal.Text.Trim() != "")
                    {
                        Valor_Fiscal = Convert.ToDecimal(Txt_Valor_Fiscal.Text.Trim());
                    }
                    Couta = Valor_Fiscal * Factor;
                    if (Txt_Porcentaje_Exencion.Text.Trim() != "")
                    {
                        Couta = Couta - (Couta * ((Convert.ToDecimal(Txt_Porcentaje_Exencion.Text.Trim())) / 100));
                    }
                    Txt_Cuota_Anual.Text = Couta.ToString("##,###,##0.00");

                    if (!String.IsNullOrEmpty(Txt_Cuota_Minima_Anual.Text))
                    {
                        if (Hdn_Cuota_Minima.Value.Trim() != "")
                        {
                            Couta = Convert.ToDecimal(Hdn_Cuota_Minima.Value);
                        }
                        if (Convert.ToDecimal(Txt_Cuota_Anual.Text.Trim()) < Couta)
                        {
                            Txt_Cuota_Anual.Text = Couta.ToString("##,###,##0.00");
                        }
                    }
    ...
    protected void Btn_Modificar_Click(object sender, ImageClickEventArgs e)
    {
        ...
        try
        {
            //if (Txt_Cuenta_Predial.Text.Trim() != "")
            {
                Mensajes_Validacion += Btn_Modificar.AlternateText + "</br>";
                if (Btn_Modificar.AlternateText.Equals("Modificar"))
                {
                    if (Hdn_No_Orden_Variacion.Value.Trim() != "")
                    {
                        Estado_Botones(Const_Estado_Modificar);
                        Configurar_Estatus_Controles(true);
                        Configurar_Edicion_Controles(false);
                        Configurar_Controles_Validacion(true);
                    }
                    else
                    {
                        Mensaje_Error("Seleccione una Orden de Variación para Validar.");
                    }
                }
                else
                {
                    Mensajes_Validacion += "Validadando Componentes" + "</br>";
                    if (Validar_Historial_Ordenes_Variacion())
                    {
                        if (Validar_Componentes())
                        {
                            Cls_Ope_Pre_Orden_Variacion_Negocio Orden_Variacion = new Cls_Ope_Pre_Orden_Variacion_Negocio();
                            Orden_Variacion.P_Generar_Orden_Estatus = Cmb_Estatus_Orden_Variacion.SelectedValue;
                            ...
                            Mensajes_Validacion += "Modificando Estatus Orden Variación" + "</br>";
                            if (Orden_Variacion.Modificar_Orden_Variacion())
                            {
                                if (Txt_Observaciones_Validacion.Text.Trim() != "")
                                {
                                    Orden_Variacion.P_Observaciones_No_Orden_Variacion = Orden_Variacion.P_Orden_Variacion_ID;
                                    Orden_Variacion.P_Observaciones_Año = Convert.ToDateTime(Grid_Ordenes_Variacion.SelectedRow.Cells[5].Text).Year;
                                    Orden_Variacion.P_Observaciones_Descripcion = Txt_Observaciones_Validacion.Text;
                                    Orden_Variacion.P_Observaciones_Usuraio = Orden_Variacion.P_Usuario;
                                    Mensajes_Validacion += "Insertando Observaciones Variación" + "</br>";
                                    Orden_Variacion.Insertar_Observaciones_Variacion();
                                }
                                if (Cmb_Estatus_Orden_Variacion.SelectedIndex == 1
                                    && Hdn_Contrarecibo.Value.Trim() == "")
                                {

                                    Mensajes_Validacion += "Aplicando Variación" + "</br>";
                                    if (Aplicar_Variacion(ref Cmd))
                                    {
                                        if ((Hdn_Grupo_Movimiento_ID.Value != null && Hdn_Grupo_Movimiento_ID.Value != "")
                                            && (Hdn_Tipo_Predio_ID.Value != null && Hdn_Tipo_Predio_ID.Value != ""))
                                        {
                                            //Arma el No de Nota
                                            Int32 No_Nota_Consecutivo = Convert.ToInt32(Obtener_Dato_Consulta(ref Cmd, "NVL(MAX(" + Ope_Pre_Ordenes_Variacion.Campo_No_Nota + "), 0) + 1", Ope_Pre_Ordenes_Variacion.Tabla_Ope_Pre_Ordenes_Variacion, Ope_Pre_Ordenes_Variacion.Campo_Anio + " || " + Ope_Pre_Ordenes_Variacion.Campo_Grupo_Movimiento_ID + " || " + Ope_Pre_Ordenes_Variacion.Campo_Tipo_Predio_ID + " = '" + DateTime.Now.Year.ToString() + Hdn_Grupo_Movimiento_ID.Value + Hdn_Tipo_Predio_ID.Value + "' ORDER BY " + Ope_Pre_Ordenes_Variacion.Campo_No_Nota, "1").Trim());
                                            Int32 No_Nota_Inicial = Convert.ToInt32(Obtener_Dato_Consulta(ref Cmd, "NVL(" + Cat_Pre_Grupos_Movimiento_Detalles.Campo_Folio_Inicial + ", 0)", Cat_Pre_Grupos_Movimiento_Detalles.Tabla_Cat_Pre_Grupos_Movimiento_Detalles, Cat_Pre_Grupos_Movimiento_Detalles.Campo_Año + " || " + Cat_Pre_Grupos_Movimiento_Detalles.Campo_Grupo_Movimiento_ID + " || " + Cat_Pre_Grupos_Movimiento_Detalles.Campo_Tipo_Predio_ID + " = '" + DateTime.Now.Year.ToString() + Hdn_Grupo_Movimiento_ID.Value + Hdn_Tipo_Predio_ID.Value + "'", "1").Trim());

                                            Orden_Variacion.P_No_Nota = No_Nota_Consecutivo > No_Nota_Inicial ? No_Nota_Consecutivo : No_Nota_Inicial;
                                            Orden_Variacion.P_Grupo_Movimiento_ID = Hdn_Grupo_Movimiento_ID.Value;
                                            Orden_Variacion.P_Tipo_Predio_ID = Hdn_Tipo_Predio_ID.Value;
                                            Orden_Variacion.P_Fecha_Nota = DateTime.Now;
                                            Orden_Variacion.P_No_Nota_Impreso = "NO";
                                            Orden_Variacion.P_Usuario_Valido = Cls_Sessiones.Nombre_Empleado;
                                            //Inserta el No de Nota
                                            Mensajes_Validacion += "Modificando No. Nota Orden Variación" + "</br>";
                                            if (Orden_Variacion.Modificar_Orden_Variacion())
                                            {
                                                Mensajes_Validacion += "Commit Variación" + "</br>";
                                                Trans.Commit();
                                                Limpiar_Sesiones_Pagina();
                                                Cargar_Grid_Ordenes_Variacion(0);
                                                Configurar_Estatus_Controles(false);
                                                Configurar_Controles_Validacion(false);
                                                ScriptManager.RegisterStartupScript(this, this.GetType(), "Validación de Órdenes de Variaciíon", "alert('La Orden fue modificada');", true);
                                                Estado_Botones(Const_Estado_Inicial);
                                            }
                                            else
                                            {
                                                Trans.Rollback();
                                                throw new Exception("No se aplicó el Número de Nota de la Orden de Variación");
                                            }
                                        }
                                        else
                                        {
                                            Trans.Rollback();
                                            throw new Exception("No hay Grupo de Movimiento o Tipo de Predio para aplicar la Orden de Variación");
                                        }
                                    }
                                    else
                                    {
                                        Trans.Rollback();
                                        throw new Exception("No se aplicó la Variación de la Orden");
                                    }
                                }
                                else
                                {
                                    if (Hdn_Contrarecibo.Value.Trim() != "")
                                    {
                                        Orden_Variacion.P_Contrarecibo_No_Contrarecibo = Hdn_Contrarecibo.Value;
                                        Orden_Variacion.P_Contrarecibo_Anio = (short)Convert.ToDateTime(Grid_Ordenes_Variacion.SelectedRow.Cells[5].Text).Year;
                                        if (Cmb_Estatus_Orden_Variacion.SelectedIndex == 1)
                                        {
                                            Orden_Variacion.P_Contrarecibo_Estatus = "VALIDADO";
                                        }
                                        else
                                        {
                                            Orden_Variacion.P_Contrarecibo_Estatus = "RECHAZADO";
                                        }
                                        Orden_Variacion.P_Contrarecibo_Usuario = Cls_Sessiones.Nombre_Empleado;
                                        Mensajes_Validacion += "Modificando Contrarecibo" + "</br>";
                                        Orden_Variacion.Modificar_Contrarecibo();
                                    }

                                    Mensajes_Validacion += "Commit Modificación Orden Variación" + "</br>";
                                    Trans.Commit();
                                    Limpiar_Sesiones_Pagina();
                                    Cargar_Grid_Ordenes_Variacion(0);
                                    Configurar_Estatus_Controles(false);
                            ...
                            {
                                Trans.Rollback();
                                throw new Exception("No se pudo modificar el Estatus de la Orden de Variación");
                            }

                            //Cambia el Estatus de la Cuenta de PENDIENTE a VIGENTE
                            if (Txt_Estatus.Text.Trim() == "PENDIENTE")
                            {
                                Orden_Variacion.P_Estatus_Cuenta = "VIGENTE";
                                if (!Orden_Variacion.Modificar_Orden_Variacion())
                                {
                                    Trans.Rollback();
                                    throw new Exception("No se pudo modificar el Estatus de la Cuenta en la Orden de Variación");
                                }
                            }

                            Mensajes_Validacion += "Cerrando Conexión" + "</br>";
                        }
                    }
                    else
                    {
                        Lbl_Mensaje_Error.Text = "Esta Orden No puede ser Validada ya que existen Órdenes anteriores pendientes Por Validar";
                        Lbl_Mensaje_Error1.Text = Lbl_Mensaje_Error.Text;
                    }
                }
            }
            //else
            //{
            //    Mensaje_Error("Favor de seleccionar una cuenta");
            //}
        }
        catch (Exception Ex)
        {
        ...
        {
            Cn.Close();
            //Mensaje_Error(Mensajes_Validacion);
        }
    }
    ...
    private Boolean Validar_Historial_Ordenes_Variacion()
    {
        ...
        if (Dt_Ordenes_Variacion != null)
        {
            ...
            {
                if (Dt_Ordenes_Variacion.Rows[0][Ope_Pre_Ordenes_Variacion.Campo_Anio] != System.DBNull.Value
                    && Dt_Ordenes_Variacion.Rows[0][Ope_Pre_Ordenes_Variacion.Campo_No_Orden_Variacion] != System.DBNull.Value)
                {
                    if (Dt_Ordenes_Variacion.Rows[0][Ope_Pre_Ordenes_Variacion.Campo_Anio].ToString() == Convert.ToDateTime(Grid_Ordenes_Variacion.SelectedRow.Cells[5].Text).Year.ToString()
                        && Dt_Ordenes_Variacion.Rows[0][Ope_Pre_Ordenes_Variacion.Campo_No_Orden_Variacion].ToString() == Hdn_No_Orden_Variacion.Value)
                    {
    ...
    {
        Cargar_Grid_Copropietarios_Cuenta(e.NewPageIndex);
        ...
        try
        {
            ...
            foreach (GridViewRow Fila_Grid in Grid_Diferencias.Rows)
            {
                ...
                if (Periodo_Rezago_Validado)
                {
                    ...
                    if (Fila_Grid.Cells[6].Text.Trim() != "")
                    {
                        if (Fila_Grid.Cells[6].Text.Trim() == "ALTA")
                        {
                            Suma_Importes_Periodos_Rezago_Alta += Convert.ToDouble(Fila_Grid.Cells[7].Text.Replace("$", ""));
                        }
                        else
                        {
                            if (Fila_Grid.Cells[6].Text.Trim() == "BAJA")
                            {
    ...
    protected void Grid_Ordenes_Variacion_PageIndexChanging(object sender, GridViewPageEventArgs e)
    {
        try
        {
            ...
            //if (Hdn_Cuenta_Predial.Value.Trim() != "")
            //{
            //    Cargar_Grid_Ordenes_Variacion(e.NewPageIndex, Busqueda_Ordenes_Variacion_Por.Cuenta_Predial);
            //}
            //else
            //{
        ...
        catch (Exception Ex)
        {
            ...
            Lbl_Encabezado_Error1.Text = Ex.Message;
            Lbl_Mensaje_Error1.Text = "";
        }
    }
    ...
    protected void Grid_Ordenes_Variacion_SelectedIndexChanged(object sender, EventArgs e)
    {
        try
        {
            Limpiar_Todo();
            Limpiar_Sesiones_Pagina();
            if (Cmb_Busqueda_Estatus_Ordenes.SelectedIndex == 0)
            {
                Btn_Modificar.Enabled = true;
                Btn_Validar.Enabled = true;
            }
            ...
            Hdn_No_Orden_Variacion.Value = Grid_Ordenes_Variacion.SelectedRow.Cells[1].Text;
            Hdn_Contrarecibo.Value = Grid_Ordenes_Variacion.DataKeys[Grid_Ordenes_Variacion.SelectedIndex].Values[0].ToString();
            Txt_Cuenta_Predial.Text = HttpUtility.HtmlDecode(Grid_Ordenes_Variacion.SelectedRow.Cells[6].Text).Trim();
            Hdn_Cuenta_ID.Value = HttpUtility.HtmlDecode(Grid_Ordenes_Variacion.SelectedDataKey.Values[1].ToString()).Trim();
            ...
            if (Cargar_Variacion_Orden())
            {
                ...
                if (Cmb_Busqueda_Estatus_Ordenes.SelectedItem.Text == "POR VALIDAR")
                {
                    if (!Validar_Historial_Ordenes_Variacion())
                    {
                        Btn_Modificar.Enabled = false;
    ...
    private bool Validar_Componentes()
    {
        ...
        if (!Validacion)
        {
            ...
            Lbl_Mensaje_Error1.Text = HttpUtility.HtmlDecode(Mensaje_Error);
        }
    ...
    ///CAUSA_MODIFICACIÓN
    ///*******************************************************************************
    private String Obtener_Dato_Consulta(ref OracleCommand Cmmd, String Campo, String Tabla, String Condiciones)
    {
    ...
    ///CAUSA_MODIFICACIÓN
    ///*******************************************************************************
    private String Obtener_Dato_Consulta(ref OracleCommand Cmmd, String Campo, String Tabla, String Condiciones, String Dato_Salida_Default)
    {
        String Mi_SQL;
    ...
    protected void Btn_Mostrar_Busqueda_Avanzada_Cuenta_Predial_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (Busqueda_Ubicaciones)
        {
            if (Session["CUENTA_PREDIAL_ID"] != null)
            {
                ...
                Hdn_Cuenta_Predial.Value = Cuenta_Predial;
                Cargar_Grid_Ordenes_Variacion(0, Busqueda_Ordenes_Variacion_Por.Cuenta_Predial);
                if (Panel_Detalle.Visible)
                {
                    Btn_Salir_Click(sender, null);
                }
    ...
    ///DESCRIPCIÓN          : Reasigna los datos de las sesiones para la consulta de la Vista Previa de Adeudos.
    ///PARAMETROS:     
    ///CREO                 : Antonio Salvador Benavides Guardado
    ...
    ///CAUSA_MODIFICACIÓN
    ///*******************************************************************************
    private Boolean Cancelar_Adeudos_Cuenta(ref OracleCommand Cmmd)
    {
        Cls_Ope_Pre_Orden_Variacion_Negocio Orden_Variacion = new Cls_Ope_Pre_Orden_Variacion_Negocio();
        ...
        try
        {
            if (HttpUtility.HtmlDecode(Txt_Cuenta_Predial.Text).Trim() != "")
            {
                Orden_Variacion.P_Cuenta_Predial_ID = Hdn_Cuenta_ID.Value;
                Dt_Adeudos = Orden_Variacion.Consultar_Adeudos_Predial();
                if (Dt_Adeudos != null)
                {
                    if (Dt_Adeudos.Rows.Count > 0)
                    {
                        Dt_Diferencias = new DataTable();
                        Dt_Diferencias.Columns.Add(new DataColumn("VALOR_FISCAL", typeof(Double)));
                        Dt_Diferencias.Columns.Add(new DataColumn("TIPO", typeof(String)));
                        Dt_Diferencias.Columns.Add(new DataColumn("IMPORTE", typeof(Double)));
                        Dt_Diferencias.Columns.Add(new DataColumn("CUOTA_BIMESTRAL", typeof(Double)));
                        ...
                        foreach (DataRow Dr_Adeudos in Dt_Adeudos.Rows)
                        {
                            ...
                            {
                                Dr_Diferencias["VALOR_FISCAL"] = Convert.ToDouble(Dr_Adeudos[Ope_Pre_Adeudos_Predial.Campo_Cuota_Anual]);
                            }
                            Dr_Diferencias["TIPO"] = "ALTA";
                            if (Dr_Adeudos[Ope_Pre_Adeudos_Predial.Campo_Cuota_Anual] != System.DBNull.Value)
                            {
                                Dr_Diferencias["IMPORTE"] = Convert.ToDouble(Dr_Adeudos[Ope_Pre_Adeudos_Predial.Campo_Cuota_Anual]);
                            }
                            Dr_Diferencias["CUOTA_BIMESTRAL"] = Convert.ToDouble(Dr_Adeudos[Ope_Pre_Adeudos_Predial.Campo_Cuota_Anual]) / 6;
                            if (Dr_Adeudos["AÑO"] != System.DBNull.Value)
                            {
                                Dr_Diferencias["PERIODO"] = "1/" + Dr_Adeudos["AÑO"].ToString() + " - 6/" + Dr_Adeudos["AÑO"].ToString();
                            }
                        ...
                        Orden_Variacion.Alta_Diferencias();

                        Dt_Diferencias = new DataTable();
                        Dt_Diferencias.Columns.Add(new DataColumn("CUOTA_ANUAL", typeof(Double)));
                        Dt_Diferencias.Columns.Add(new DataColumn("BIMESTRE_1", typeof(Double)));
                        Dt_Diferencias.Columns.Add(new DataColumn("BIMESTRE_2", typeof(Double)));
                        Dt_Diferencias.Columns.Add(new DataColumn("BIMESTRE_3", typeof(Double)));
                        Dt_Diferencias.Columns.Add(new DataColumn("BIMESTRE_4", typeof(Double)));
                        Dt_Diferencias.Columns.Add(new DataColumn("BIMESTRE_5", typeof(Double)));
                        Dt_Diferencias.Columns.Add(new DataColumn("BIMESTRE_6", typeof(Double)));
                        ...
                        foreach (DataRow Dr_Adeudos in Dt_Adeudos.Rows)
                        {
                            ...
                            if (Dr_Adeudos[Ope_Pre_Adeudos_Predial.Campo_Cuota_Anual] != System.DBNull.Value)
                            {
                                Dr_Diferencias["CUOTA_ANUAL"] = Convert.ToDouble(Dr_Adeudos[Ope_Pre_Adeudos_Predial.Campo_Cuota_Anual]);
                            }
                            if (Dr_Adeudos["AÑO"] != System.DBNull.Value)
                            {
                        ...
                        Orden_Variacion.P_Cuenta_Predial_ID = Orden_Variacion.P_Cuenta_Predial_ID;
    ...
    ///CAUSA_MODIFICACIÓN
    ///*******************************************************************************
    private Boolean Reactivar_Adeudos_Cuenta(ref OracleCommand Cmmd)
    {
        Cls_Ope_Pre_Orden_Variacion_Negocio Orden_Variacion = new Cls_Ope_Pre_Orden_Variacion_Negocio();
        ...
        try
        {
            ...
            {
                Orden_Variacion.P_Cuenta_Predial_ID = Hdn_Cuenta_ID.Value;
                Dt_Ordenes_Variacion = Orden_Variacion.Consultar_Ultima_Orden_Con_Adeudos();
                if (Dt_Ordenes_Variacion != null)
                {
                    if (Dt_Ordenes_Variacion.Rows.Count > 0)
                    {
                        Orden_Variacion.P_Generar_Orden_No_Orden = Dt_Ordenes_Variacion.Rows[0][Ope_Pre_Diferencias.Campo_No_Orden_Variacion].ToString();
                        Orden_Variacion.P_Generar_Orden_Anio = Dt_Ordenes_Variacion.Rows[0][Ope_Pre_Diferencias.Campo_Anio].ToString();
                        ...
                        if (Dt_Diferencias != null)
                        {
                            if (Dt_Diferencias.Rows.Count > 0)
                            {
                                ...
                                Dt_Adeudos.Columns.Add(new DataColumn("CUOTA_ANUAL", typeof(Double)));
                                Dt_Adeudos.Columns.Add(new DataColumn("BIMESTRE_1", typeof(Double)));
                                Dt_Adeudos.Columns.Add(new DataColumn("BIMESTRE_2", typeof(Double)));
                                Dt_Adeudos.Columns.Add(new DataColumn("BIMESTRE_3", typeof(Double)));
                                Dt_Adeudos.Columns.Add(new DataColumn("BIMESTRE_4", typeof(Double)));
                                Dt_Adeudos.Columns.Add(new DataColumn("BIMESTRE_5", typeof(Double)));
                                Dt_Adeudos.Columns.Add(new DataColumn("BIMESTRE_6", typeof(Double)));
                                ...
                                foreach (DataRow Dr_Diferencias in Dt_Diferencias.Rows)
                                {
                                    ...
                                    if (Dr_Diferencias["VALOR_FISCAL"] != System.DBNull.Value
                                        && Dr_Diferencias["TASA"] != System.DBNull.Value)
                                    {
                                        Dr_Adeudos["CUOTA_ANUAL"] = Convert.ToDouble(Dr_Diferencias["VALOR_FISCAL"]) * Convert.ToDouble(Dr_Diferencias["TASA"]);
                                    }
                                    ...
                                    if (Dr_Diferencias["CUOTA_BIMESTRAL"] != System.DBNull.Value)
                                    {
                                        if (Desde_Bimestre != 0 && Hasta_Bimestre != 0)
                                        {
                                            for (Cont_Bimestres = Desde_Bimestre; Cont_Bimestres <= Hasta_Bimestre; Cont_Bimestres++)
                                            {
                                                Dr_Adeudos["BIMESTRE_" + Cont_Bimestres.ToString()] = Convert.ToDouble(Dr_Diferencias["CUOTA_BIMESTRAL"]);
                                            }
                                        }
                                    }
                                ...
                                Orden_Variacion.P_Cuenta_Predial_ID = Orden_Variacion.P_Cuenta_Predial_ID;
                                Orden_Variacion.P_Diferencias_Estatus = "VIGENTE";
    ...
    private void Limpiar_Sesiones_Pagina()
    {
        ...
        Session.Remove("Dt_Ordenes_Variacion");
    }
}
