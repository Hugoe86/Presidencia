...
CodeFile="Frm_Ope_Pre_Pae_Remocion_Cambio_Depositorio.aspx.cs" Inherits="paginas_Predial_Frm_Ope_Pre_Pae_Remocion_Cambio_Depositorio" %>
...
<!--SCRIPT PARA LA VALIDACION QUE NO EXPERE LA SESSION-->  
  ...
  <asp:Content ID="Content3" ContentPlaceHolderID="Cph_Area_Trabajo1" runat="Server">
    <cc1:ToolkitScriptManager ID="Tsm_Remocion" runat="server"  AsyncPostBackTimeout="3600" EnableScriptGlobalization="true"/>    
                            ...
                            <table width="100%" class="estilo_fuente">
                                <tr align="center">
                                    <td class="label_titulo">
                                        Remoción o Cambio de Depositario
                                    </td>
                                </tr>
                        ...
                        <caption>
                            ...
                            <tr>
                                ...
                                <td style="text-align: left; width: 30%;">
                                    ...
                                    <asp:ImageButton ID="Btn_Busca_Domicilio" runat="server" Height="22px" 
                                        ImageUrl="~/paginas/imagenes/paginas/Busqueda_00001.png" 
                                         Width="22px" onclick="Btn_Busca_Domicilio_Click"  /><%--onclick="Btn_Busca_Domicilio_Click"--%>
                                </td>
                                <td style="text-align: left; width: 20%; text-align: right;">
                                    Tipo domicilio
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="2" style="text-align: left; width: 20%; text-align: right;">
                                    <asp:Label ID="Lbl_Busqueda" runat="server" Text="Buscar Remoción o Cambio de Depositario"></asp:Label>
                                    <asp:ImageButton ID="Btn_Buscar_Remociones" runat="server" 
                                        ImageUrl="~/paginas/imagenes/paginas/icono_consultar.png" onclick="Btn_Buscar_Remociones_Click"/>
                                    &nbsp;
                                </td>
                            </tr>
                            <tr align="center">
                                <td colspan="4">
                                    <asp:GridView ID="Grid_Remociones_Generadas" runat="server" 
                                        AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
                                        CssClass="GridView_1" HeaderStyle-CssClass="tblHead" PageSize="5" Style="white-space: normal;"
                                        Width="100%" onpageindexchanging="Grid_Remociones_Generadas_PageIndexChanging">
                                        <Columns>
