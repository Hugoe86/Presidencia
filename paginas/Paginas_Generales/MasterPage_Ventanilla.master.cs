...
public partial class Paginas_Generales_paginas_MasterPage : System.Web.UI.MasterPage
{
        ...
        switch (p_intTipo)
        {
            ...
            */
            ...
            case 2:
                ...
                principal.Style.Add("height", "642px");
                ...
                contenido_fondo_login.Style.Add("background-image", "url(../imagenes/master/Fondo_Login_Ventanilla.jpg)");
                ...
                pie_login.Style.Add("top", "611px");
                pie_login.Style.Add("height", "51px");
                pie_login.Style.Add("width", "980px");
                pie_login.Style.Add("background-image", "url(../imagenes/master/pie_login2.jpg)");
    ...
    protected void Page_Load(object sendre, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            if (Convert.ToBoolean(Cls_Sessiones.Mostrar_Menu))
            {
                ...
                Do_Asignar_Estilo(1);
                m_strTitulo = "SISTEMA INTEGRAL ADMINISTRATIVO CON SAP";
                Lbl_Usuario.Text = Cls_Sessiones.Nombre_Ciudadano;
            }
            else
            {
                Do_Asignar_Estilo(2);
    ...
    ///*******************************************************************************************************
    ///NOMBRE_FUNCIÓN: Btn_Menu_Portafolio_Click
    ///DESCRIPCIÓN: Redireccionar a la página Frm_Cat_Ven_Portafolio
    ...
    ///CAUSA_MODIFICACIÓN: 
    ///*******************************************************************************************************
    protected void Btn_Menu_Portafolio_Click(object sender, ImageClickEventArgs e)
    {
        Response.Redirect("../Ventanilla/Frm_Cat_Ven_Portafolio.aspx");
    }

    ///*******************************************************************************************************
    ///NOMBRE_FUNCIÓN: Btn_Menu_Atencion_Ciudadana_Click
    ///DESCRIPCIÓN: Redireccionar a la página Frm_Ope_Ven_Registrar_Peticion
    ///PARÁMETROS: NO APLICA
    ///CREO: Roberto González Oseguera
    ///FECHA_CREO: 05-jun-2012
    ///MODIFICÓ: 
    ...
    ///CAUSA_MODIFICACIÓN: 
    ///*******************************************************************************************************
    protected void Btn_Menu_Atencion_Ciudadana_Click(object sender, ImageClickEventArgs e)
    {
        Response.Redirect("../Ventanilla/Frm_Ope_Ven_Registrar_Peticion.aspx");
    }

    ///*******************************************************************************************************
    ///NOMBRE_FUNCIÓN: Btn_Menu_Tramites_Click
    ///DESCRIPCIÓN: Redireccionar a la página Frm_Ope_Ven_Lista_Tramites
    ///PARÁMETROS: NO APLICA
    ///CREO: Roberto González Oseguera
    ///FECHA_CREO: 05-jun-2012
    ///MODIFICÓ: 
    ...
    ///CAUSA_MODIFICACIÓN: 
    ///*******************************************************************************************************
    protected void Btn_Menu_Tramites_Click(object sender, ImageClickEventArgs e)
    {
        Response.Redirect("../Ventanilla/Frm_Ope_Ven_Lista_Tramites.aspx");
    }

    ///*******************************************************************************************************
    ///NOMBRE_FUNCIÓN: Btn_Menu_Consultar_Tramites_Click
    ///DESCRIPCIÓN: Redireccionar a la página Frm_Rpt_Ven_Consultar_Tramites
    ///PARÁMETROS: NO APLICA
    ///CREO: Roberto González Oseguera
    ///FECHA_CREO: 05-jun-2012
    ///MODIFICÓ: 
    ...
    ///CAUSA_MODIFICACIÓN: 
    ///*******************************************************************************************************
    protected void Btn_Menu_Consultar_Tramites_Click(object sender, ImageClickEventArgs e)
    {
