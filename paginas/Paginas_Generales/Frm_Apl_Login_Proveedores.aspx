...
<asp:Content ID="Cph_Area_Trabajo2" ContentPlaceHolderID="Cph_Area_Trabajo2" Runat="Server">
    ...
    <div id="tabla" style="position:absolute; width:200px; height:300px;  top:237px;right:80px">           
        <table>
            ...
            <tr>
                <td>
                    <asp:TextBox ID="Txt_Password" runat="server" Columns="15" MaxLength="15" TextMode="Password"
                       ontextchanged="Txt_Password_TextChanged" AutoPostBack="true"></asp:TextBox>
            ...
            <tr>
                <td>
                    <asp:ImageButton ID="Btn_Aceptar" runat="server" 
                        ...
                        ImageUrl="~/paginas/imagenes/paginas/sias_entrar.png" onclick="Btn_Aceptar_Click"/>                                           
                </td>
            </tr>
        </table>
    </div>
    <div id="mensaje" style="position:absolute; width:450px; height:300px;  top:340px;right:60px" >
        <asp:ImageButton ID="Btn_Img_Mensaje" runat="server" ImageUrl="~/paginas/imagenes/paginas/sias_warning.png" style="visibility: hidden"/>
