        ...
        switch (p_intTipo)
        {
            ...
            */
            case 1:                
                ...
                encabezado.Style.Add("background-image", "url(" + Page.ResolveUrl("~/paginas/imagenes/master/encabezado_proveedores.png") + ")");            
                ...
                pie.Style.Add("background-image", "url(" + Page.ResolveUrl("~/paginas/imagenes/master/pie_login2.jpg") + ")");
            ...
            case 2:
                ...
                contenido_fondo_login.Style.Add("background-image", "url(" + Page.ResolveUrl("~/paginas/imagenes/master/fondo_login_proveedores.png") + ")");
                ...
                pie_login.Style.Add("background-image", "url(" + Page.ResolveUrl("~/paginas/imagenes/master/pie_login_proveedores.png") + ")");
    ...
    protected void Page_Load(object sendre, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            if (Convert.ToBoolean(Cls_Sessiones.Mostrar_Menu))
            {
                ...
                if (Cls_Sessiones.Datos_Proveedor != null)
                {
                    Lbl_Usuario.Text = ((DataTable)Cls_Sessiones.Datos_Proveedor).Rows[0]["NOMBRE"].ToString() + " / " +
                    ((DataTable)Cls_Sessiones.Datos_Proveedor).Rows[0]["COMPANIA"].ToString();
                }
            }
            else
            {
