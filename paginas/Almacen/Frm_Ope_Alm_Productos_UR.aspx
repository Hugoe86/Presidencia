<%@ Page Language="C#" MasterPageFile="~/paginas/Paginas_Generales/MasterPage.master" AutoEventWireup="true" CodeFile="Frm_Ope_Alm_Productos_UR.aspx.cs" 
        ...
        <ContentTemplate>
            ...
            <div id="Div_Generales" style="background-color:#ffffff; width:100%; height:100%;">
                <table width="98%"  border="0" cellspacing="0" class="estilo_fuente">
                    <tr align="center">
                        <td class="label_titulo" colspan="2">Reporte de productos entregados a Unidad Responsable</td>
                    </tr>
                    <tr>
                        <td>
                ...
                <center>
                    <div id="Div_Datos_Producto" style="background-color:#ffffff; width:100%; height:100%;">
                        <table width="98%">
                            ...
                            <tr>
                                <td style="text-align:left;">
                                    <asp:Label ID="Lbl_UR" runat="server" Text="Unidad Responsable" CssClass="estilo_fuente"></asp:Label>
                                </td>
                                <td colspan="3" style="text-align:left;">
                                    <asp:DropDownList ID="Cmb_UR" runat="server" Width="99%">
                                    </asp:DropDownList>
                                </td>
                            </tr>                            
                            ...
                            <tr style="background-color: #3366CC; display:none;">
                                                ...
                                                <asp:Panel ID="Pnl_Listado_Entradas" runat="server" Width="100%" style="overflow:auto; border-width:thin;" GroupingText="Entradas">                              
                                                    <asp:GridView ID="Grid_Entradas" runat="server" CssClass="GridView_1"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:BoundField DataField="NO_ENTRADA" HeaderText="Orden Compra" SortExpression="NO_ENTRADA">
                                                                <ItemStyle Font-Size="Small" HorizontalAlign="Center" />
                                                            </asp:BoundField>
                                                        </Columns>
                                                ...
                                                <asp:Panel ID="Pnl_Listado_Salidas" runat="server" Width="100%" style="overflow:auto; border-width:thin;" GroupingText="Salidas">                          
                                                    <asp:GridView ID="Grid_Salidas" runat="server" CssClass="GridView_1"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:BoundField DataField="UR" HeaderText="Unidad Responsable" SortExpression="NO_SALIDA" >
                                                                <ItemStyle Font-Size="Small" HorizontalAlign="Center" />
                                                            </asp:BoundField>                                                            
                                                        </Columns>
                                                        <PagerStyle CssClass="GridHeader" />
                                                ...
                                                <asp:Panel ID="Pnl_Listado_Entradas_Ajuste" runat="server" Width="100%" style="height:300px; overflow:auto; border-width:thin;" GroupingText="Entradas de Ajuste">                              
                                                    <asp:GridView ID="Grid_Entradas_Ajuste" runat="server" CssClass="GridView_1"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:BoundField DataField="NO_AJUSTE" HeaderText="No. Ajuste" SortExpression="NO_AJUSTE">
                                                                <ItemStyle Font-Size="Small" HorizontalAlign="Center" />
                                                            </asp:BoundField>
                                                        </Columns>
                                                        <PagerStyle CssClass="GridHeader" />
