...
AutoEventWireup="true" CodeFile="Frm_Ope_Alm_Requisiciones_Transitorias.aspx.cs" 
Inherits="paginas_Almacen_Frm_Ope_Alm_Requisiciones_Transitorias" %>
           ...
           <asp:UpdateProgress ID="Upgrade" runat="server" AssociatedUpdatePanelID="Upd_Panel" DisplayAfter="0">
            ...
            <div id="Div_Contenido" style="width: 97%; height: 100%;">
                <table width="97%"  border="0" cellspacing="0" class="estilo_fuente">
                   <tr>
                      <td class="label_titulo">Ordenes de Salida</td>
                   </tr>
                                ...
                                <td>
                                    <asp:GridView ID="Grid_Requisiciones_Stock" runat="server" 
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="FOLIO_OC" 
                                                HeaderText="O. Compra">
                                                <HeaderStyle HorizontalAlign="Left" />
                                                <ItemStyle Width="110px" Font-Size="X-Small" HorizontalAlign="Left" />
                                            </asp:BoundField>
                                            <asp:BoundField DataField="FOLIO_REQ" HeaderText="Requisición" >
                                                <HeaderStyle HorizontalAlign="Left" />
                                                <ItemStyle Width="110px" Font-Size="X-Small" />
                                            </asp:BoundField>
                                            <asp:BoundField DataField="NO_ORDEN_COMPRA" HeaderText="Orden Compra" Visible="False">
                                                <HeaderStyle HorizontalAlign="Left" />
                                            ...
                                            <asp:BoundField DataField="NO_REQUISICION" HeaderText="No. Requisicion" Visible="False" >
                                                <HeaderStyle HorizontalAlign="Left" />
                                            </asp:BoundField>
                                        </Columns>
                            ...
                            <table style="width: 99%;" class="estilo_fuente">
                                <tr>
                                    ...
                                    <td align="left" style="width:20%;">
                                        <asp:TextBox ID="Txt_Folio" runat="server" Enabled="false" Width="95%"></asp:TextBox>
                                    </td>
                                    <td style="width:05%;">
                                        Fecha Autorización
                                    </td>
                                    <td align="left" style="width:25%;">
                                        <asp:TextBox ID="Txt_Fecha_Autorizacion" runat="server" DataFormatString="{0:dd/MMM/yyyy}" Enabled="false" Width="95%"></asp:TextBox>
                                    </td>
                                  </tr>
                                  <tr>
                                    <td style="width:10%;">
                                    ...
                                    <td align="left" style="width:20%;">
                                        <asp:TextBox ID="Txt_Orden_Compra" runat="server" Enabled="false" Width="95%"></asp:TextBox>
                                    </td>
                                    <td style="width:10%;">
                                        Partida
                                    </td>
                                    <td align="left" style="width:30%;">
                                        <asp:TextBox ID="Txt_Partida" runat="server"  Enabled="false" Width="95%"></asp:TextBox>
                                    </td>
                                  </tr>
                                  <tr>
                                    <td >
                                    ...
                                    <td align="left" colspan="3">
                                        <asp:TextBox ID="Txt_Unidad_Responsable" runat="server" Width="98%" Enabled="False" 
                                  ...
                                  <tr>
                                        ...
                                        <td align="left" colspan="3" >
                                            <asp:TextBox ID="Txt_Financiamiento" runat="server" Enabled="false" Width="98%"></asp:TextBox>
                                        </td>
                                  </tr>
                                ...
                                <tr >
                                    ...
                                    <td align="left" colspan="3" >
                                         <asp:TextBox ID="Txt_Justificacion" runat="server"
                                          Width="98%" Height="50px" TextMode="MultiLine" MaxLength="249" 
                                ...
                                <tr>
                                 ...
                                 <tr>
                                   <td >
                                       <asp:Label ID="Lbl_Empleado" runat="server" Text="Recibe"></asp:Label> 
                                   </td>
                                    <td >
                                          <asp:DropDownList ID="Cmb_Empleados_UR" runat="server" Width="300px">
                                          </asp:DropDownList>
                                        <br />
                                   </td>
                                ...
                                <tr>
                                    <td colspan="4">
                                        <asp:GridView ID="Grid_Productos_Requisicion" runat="server"  
                                            ...
                                            <RowStyle CssClass="GridItem" Font-Size="Small" />
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Ctd. a Entregar">
                                                    <ItemTemplate>                                                    
                                                            <asp:TextBox ID="Txt_Cantidad_A_Entregar"  runat="server" Width="74px"
                                                                ...
                                                                ></asp:TextBox>  
                                                                <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender1" runat="server"
                                                                     TargetControlID="Txt_Cantidad_A_Entregar" InvalidChars="<,>,&,',!,"
                                                                     FilterType="Numbers" 
                                                                     Enabled="True">   
                                                                </cc1:FilteredTextBoxExtender>
