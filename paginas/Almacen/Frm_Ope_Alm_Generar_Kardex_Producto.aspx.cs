...
public partial class paginas_Almacen_Frm_Ope_Alm_Generar_Kardex_Producto : System.Web.UI.Page {
    ...
    #region "Page Load"
        ...
        protected void Page_Load(object sender, EventArgs e)  {
            ...
            if(!IsPostBack){
                ...
                Cargar_Partidas();
                Cmb_Mostrar_Detalles.Items.Clear();
                Cmb_Mostrar_Detalles.Items.Add("SI");
                Cmb_Mostrar_Detalles.Items.Add("NO");
                Cmb_Mostrar_Detalles.SelectedIndex = 0;
            }
        }
    ...
    #region "Eventos"
        ...
        protected void Btn_Buscar_Click(object sender, ImageClickEventArgs e) {
            ...
            Grid_Entradas.DataSource = Dt_Entradas;
            Grid_Entradas.DataBind();

            Grid_Entradas_Ajuste.DataSource = Dt_Entradas_Ajuste;
            Grid_Entradas_Ajuste.DataBind();

            Grid_Salidas.DataSource = Dt_Salidas;
            Grid_Salidas.DataBind();

            Grid_Salidas_Ajuste.DataSource = Dt_Salidas_Ajuste;
            Grid_Salidas_Ajuste.DataBind();

            Grid_Comprometido.DataSource = Dt_Comprometidos;
            Grid_Comprometido.DataBind();
            if (Cmb_Mostrar_Detalles.SelectedValue == "SI")
            {
                Grid_Entradas.Visible = true;
                Grid_Entradas_Ajuste.Visible = true;
                Grid_Salidas.Visible = true;
                Grid_Salidas_Ajuste.Visible = true;
                Grid_Comprometido.Visible = true;
            }
            else
            {
                Grid_Entradas.Visible = false;
                Grid_Entradas_Ajuste.Visible = false;
                Grid_Salidas.Visible = false;
                Grid_Salidas_Ajuste.Visible = false;
                Grid_Comprometido.Visible = false;
            }
