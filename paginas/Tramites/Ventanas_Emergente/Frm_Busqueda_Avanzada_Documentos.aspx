<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Frm_Busqueda_Avanzada_Documentos.aspx.cs" 
Inherits="paginas_Tramites_Ventanas_Emergente_Frm_Busqueda_Avanzada_Documentos" %>
    ...
    <form id="Frm_Busqueda_Avanzada_Tramites" runat="server">
        ...
        <div id="Div_Cuerpo" style="width: 98%;" runat="server" visible="true">
            ...
            <table width="99%">   
                <tr>
                    <td style="width:15%">
                        <asp:Label ID="Lbl_Nombre_Documento" runat="server"  Text="Nombre" Width="100%"></asp:Label> 
                    </td>
                    <td style="width:80%">
                        <asp:TextBox ID="Txt_Nombre_Documento" runat="server" Width="98%"></asp:TextBox>
                    </td> 
                                ...
                                <asp:GridView ID="Grid_Solicitud_Tramite" runat="server" CssClass="GridView_1"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="NOMBRE" HeaderText="Nombre" 
                                            ...
                                            <HeaderStyle HorizontalAlign="Left" Width="95%" Font-Size="13px" />
                                            <ItemStyle HorizontalAlign="Left" Width="95%" Font-Size="12px" />
                                        </asp:BoundField>                                             
