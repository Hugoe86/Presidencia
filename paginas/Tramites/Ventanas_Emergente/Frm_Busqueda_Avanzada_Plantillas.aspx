<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Frm_Busqueda_Avanzada_Plantillas.aspx.cs" Inherits="paginas_Tramites_Ventanas_Emergente_Frm_Busqueda_Avanzada_Plantillas" %>
    ...
    <form id="Frm_Busqueda_Avanzada_Tramites" runat="server">
        ...
        <div id="Div_Cuerpo" style="width: 98%;" runat="server" visible="true">
            ...
            <table width="99%">   
                <tr>
                    <td style="width:15%">
                        <asp:Label ID="Lbl_Nombre_Plantilla" runat="server"  Text="Nombre de la plantilla" Width="100%"></asp:Label> 
                    </td>
                    <td style="width:80%">
                        <asp:TextBox ID="Txt_Nombre_Plantilla" runat="server" Width="98%"></asp:TextBox>
                    </td> 
