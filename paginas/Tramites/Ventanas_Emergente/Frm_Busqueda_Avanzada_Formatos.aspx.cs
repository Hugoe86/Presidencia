...
public partial class paginas_Tramites_Ventanas_Emergente_Frm_Busqueda_Avanzada_Formatos : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            Session["BUSQUEDA_FORMATOS"] = false;
        }
        Frm_Busqueda_Avanzada_Tramites.Page.Title = "Búsqueda Avanzada de Formatos";
    ...
    protected void Btn_Aceptar_Click(object sender, ImageClickEventArgs e)
    {
        try
        {
            Session["BUSQUEDA_FORMATOS"] = true;
            //Cierra la ventana
            string Pagina = "<script language='JavaScript'>";
            Pagina += "window.close();";
            Pagina += "</script>";
    ...
    protected void Grid_Tramites_Generales_SelectedIndexChanged(object sender, EventArgs e)
    {
        try
        {
            Session["FORMATO_ID"] = Grid_Tramites_Generales.SelectedRow.Cells[1].Text;
    ...
    ///*******************************************************************************
    /// NOMBRE DE LA FUNCION    : Buscar_Formatos
    ...
    /// CAUSA_MODIFICACION:
    ///*******************************************************************************
    private void Buscar_Formatos(int Indice_Pagina)
    {
        ...
        try
        {
            if (Txt_Nombre_Formato.Text != "")
            {
                Negocio_Plantillas.P_Nombre = Txt_Nombre_Formato.Text;

                Dt_Consulta = Negocio_Plantillas.Consultar_Formatos();
