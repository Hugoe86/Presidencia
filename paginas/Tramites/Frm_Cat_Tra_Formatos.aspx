...
CodeFile="Frm_Cat_Tra_Formatos.aspx.cs" Inherits="paginas_Tramites_Frm_Cat_Tra_Formatos" 
Title="Catalogo de formatos"%>
        ...
        <ContentTemplate>
           ...
           <div id="Div_Contenido" style="background-color: #ffffff; width: 100%; height: 100%;">
                <table width = "98%" border="0" cellspacing="0">                     
                    <tr>
                        <td colspan ="4" class="label_titulo">Catálogo de Formatos</td>
                    </tr>
                    ...
                    <td colspan = "2" align = "left" >
                        ...
                        <asp:ImageButton ID="Btn_Eliminar" runat="server" ToolTip="Eliminar" CssClass="Img_Button" ImageUrl="~/paginas/imagenes/paginas/icono_eliminar.png"
                            onclick="Btn_Eliminar_Click" OnClientClick="return confirm('¿Está seguro de eliminar el formato seleccionada?');"/>
                ...
                <div id="Div_Plantilla_id" runat="server" style="display:none">
                    <table width="98%">
                        <tr>
                            <td >
                                <asp:HiddenField ID="Hdf_Formato_ID" runat="server" />
                            </td>
                        </tr>
                    </table>
                     <table width="98%">
                    ...
                    <table width="98%">
                        <tr>
                            ...
                            <td  style="width:85%" align="left">
                                <asp:TextBox ID="Txt_Nombre" runat="server" MaxLength="100" Width="95%" ></asp:TextBox>   
                            ...
                            <td style="width:100%;text-align:center;vertical-align:top;">
                                <center>
                                    <div id="Div_Tramites_Generales" runat="server" 
                                        ...
                                        <asp:GridView ID="Grid_Formatos" runat="server" AutoGenerateColumns="False" 
                                            CssClass="GridView_1" Width="100%"  
                                            EmptyDataText="No se encontraron datos"
                                            onselectedindexchanged="Grid_Formatos_SelectedIndexChanged" 
                                            GridLines="None">
                                            ...
                                            <Columns>
                                                ...
                                                <%-- 1 --%>
                                                <asp:BoundField DataField="Formato_ID" HeaderText="ID" Visible="True">
                                                    <HeaderStyle HorizontalAlign="Left" Width="0%" />
                                                    <ItemStyle HorizontalAlign="Left" Width="0%" />
                                                </asp:BoundField>  
                                                <%-- 2 --%>  
                                                <asp:BoundField DataField="Nombre" HeaderText="Nombre del formato" Visible="True">
