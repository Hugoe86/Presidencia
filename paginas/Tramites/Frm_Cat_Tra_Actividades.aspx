...
AutoEventWireup="true" CodeFile="Frm_Cat_Tra_Actividades.aspx.cs" Inherits="paginas_Tramites_Frm_Cat_Tra_Actividades" %>
        ...
        <ContentTemplate>
           ...
           <div id="Div_Contenido" style="background-color: #ffffff; width: 100%; height: 100%;">
                <table width = "98%" border="0" cellspacing="0">                     
                    <tr>
                        <td colspan ="4" class="label_titulo">Catálogo Tipos de actividades</td>
                    </tr>
                                    ...
                                    <div id="Div_Avance_Obra" runat="server" 
                                        ...
                                        <asp:GridView ID="Grid_Inspector" runat="server" AutoGenerateColumns="False" 
                                            ...
                                            <Columns>
                                                ...
                                                <%-- 1 --%>
                                                <asp:BoundField DataField="ACTIVIDAD_ID" HeaderText="ID" Visible="True">
