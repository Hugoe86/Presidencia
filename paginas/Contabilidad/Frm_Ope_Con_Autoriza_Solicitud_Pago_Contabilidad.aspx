 ...
 // Cerrar el mes seleccionado
        ...
        function Rechazar_Solicitud(Control) {
            ...
            if ($(Control).is(':checked')) 
            {
                ...
                if (x1 == true) {
                    comentario = prompt('Ingresa Algun Comentario Sobre el Rechazo de la Solicitud', 'NINGUNO'); 
                    MostrarProgress();
        ...
        <ContentTemplate>
            ...
            <div id="Div_Parametros_Contabilidad" >
                <table width="98%"  border="0" cellspacing="0" class="estilo_fuente">
                    <tr align="center">
                        <td colspan="2" class="label_titulo">Autorizacion de Solicitud de Pagos (Contabilidad)</td>
                    </tr>
                    <tr>
                        <td colspan="2">&nbsp;
                    ...
                    <tr class="barra_busqueda" align="right">
                        <td align="left">
                            <asp:ImageButton ID="Btn_Salir" runat="server" ToolTip="Inicio" CssClass="Img_Button" 
                                TabIndex="3" ImageUrl="~/paginas/imagenes/paginas/icono_salir.png" onclick="Btn_Salir_Click" />  <%--onclick="Btn_Salir_Click"--%>
                        </td>
                        <td style="width:50%">
                        </td> 
                    </tr>          
