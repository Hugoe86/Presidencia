<%@ Page Language="C#" MasterPageFile="~/paginas/Paginas_Generales/MasterPage.master" AutoEventWireup="true" CodeFile="Frm_Ope_Compromisos.aspx.cs" Inherits="paginas_Contabilidad_Frm_Ope_Compromisos" Title="Untitled Page" %>
           ...
           <%-- <asp:UpdateProgress ID="Uprg_Polizas" runat="server" AssociatedUpdatePanelID="Upd_Panel" DisplayAfter="0">
            ...
            <div id="Div_Compromisos" style="background-color:#ffffff; width:98%; height:100%;">
                <table width="100%" class="estilo_fuente">
                    <tr align="center">
                        <td class="label_titulo">Compromisos</td>
                    </tr>
                    <tr>
                        <td >&nbsp;
                        ...
                        <asp:Panel ID="Pnl_Datos_Generales" runat="server" GroupingText="Datos del Monto Comprometido" Width="98%" BackColor="White">
                            <table width="100%" class="estilo_fuente">
                                ...
                                <tr>
                                    ...
                                    <td colspan="1">Partida</td>
                                    <td colspan="3">
                                        <asp:DropDownList ID="Cmb_Partida" runat="server" width="99%" AutoPostBack="true" Enabled = "false"></asp:DropDownList>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td colspan="1">Unidad Responsable</td>
                                    <td colspan="2">
                                        <asp:DropDownList ID="Cmb_Unidad_Responsable" runat="server" width="99%" Enabled = "false"
                                ...
                                <tr>
                                    <td colspan="1">Fuente de Financiamiento</td>
                                    ...
                                    <td colspan="1">Area Funcional</td>
                                    <td colspan="3">
                                ...
                                <tr>
                                 <td colspan="1">Monto Disponible</td>
                                    <td colspan="2">
                                        <asp:TextBox ID="Txt_Monto_Disponible" runat="server" Width="98%" Enabled="false"></asp:TextBox>
                                    </td>
                                    <td colspan="1">*Monto Comprometido</td>
                                    <td colspan="3">
                                        <asp:TextBox ID="Txt_Monto_Comprometido" runat="server" Width="96%" AutoPostBack="true"
                                            ontextchanged="Txt_Monto_Comprometido_TextChanged"></asp:TextBox>
                                ...
                                <tr>
                                    <td>*Concepto</td>
                                    <td colspan="6">
                                        <asp:TextBox ID="Txt_Concepto" runat="server" TextMode="MultiLine" Width="98%"></asp:TextBox>
                            ...
                            ********************************************************--%>
                            <asp:GridView ID="Grid_Compromisos" runat="server" AllowPaging="True" CssClass="GridView_1" 
                                ...
                                <Columns>         
                                    ...
                                    <asp:BoundField DataField="No_Compromiso" HeaderText="No Compromiso" 
