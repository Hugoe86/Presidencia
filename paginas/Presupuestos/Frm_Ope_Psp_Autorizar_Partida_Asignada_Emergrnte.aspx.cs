...
public partial class paginas_Presupuestos_Frm_Ope_Psp_Autorizar_Partida_Asignada_Emergrnte : System.Web.UI.Page
{
    #region PAGE LOAD
    ...
    ///CAUSA_MODIFICACIÓN...:
    ///*********************************************************************************************************
    private DataTable Crear_Dt_Partida_Aprobada()
    {
        ...
        try
        {
            if (Dt_Session != null)
            {
                ...
                {
                    //creamos las columnas del datatable donde se guardaran los datos
                    Dt_Partida_Aprobada.Columns.Add("DEPENDENCIA_ID", System.Type.GetType("System.String"));
                    Dt_Partida_Aprobada.Columns.Add("FUENTE_FINANCIAMIENTO_ID", System.Type.GetType("System.String"));
                    Dt_Partida_Aprobada.Columns.Add("PROYECTO_ID", System.Type.GetType("System.String"));
                    Dt_Partida_Aprobada.Columns.Add("CAPITULO_ID", System.Type.GetType("System.String"));
                    Dt_Partida_Aprobada.Columns.Add("PARTIDA_ID", System.Type.GetType("System.String"));
                    Dt_Partida_Aprobada.Columns.Add("ANIO", System.Type.GetType("System.String"));
                    Dt_Partida_Aprobada.Columns.Add("TOTAL_ENE", System.Type.GetType("System.String"));
                    Dt_Partida_Aprobada.Columns.Add("TOTAL_FEB", System.Type.GetType("System.String"));
                    Dt_Partida_Aprobada.Columns.Add("TOTAL_MAR", System.Type.GetType("System.String"));
                    Dt_Partida_Aprobada.Columns.Add("TOTAL_ABR", System.Type.GetType("System.String"));
                    Dt_Partida_Aprobada.Columns.Add("TOTAL_MAY", System.Type.GetType("System.String"));
                    Dt_Partida_Aprobada.Columns.Add("TOTAL_JUN", System.Type.GetType("System.String"));
                    Dt_Partida_Aprobada.Columns.Add("TOTAL_JUL", System.Type.GetType("System.String"));
                    Dt_Partida_Aprobada.Columns.Add("TOTAL_AGO", System.Type.GetType("System.String"));
                    Dt_Partida_Aprobada.Columns.Add("TOTAL_SEP", System.Type.GetType("System.String"));
                    Dt_Partida_Aprobada.Columns.Add("TOTAL_OCT", System.Type.GetType("System.String"));
                    Dt_Partida_Aprobada.Columns.Add("TOTAL_NOV", System.Type.GetType("System.String"));
                    Dt_Partida_Aprobada.Columns.Add("TOTAL_DIC", System.Type.GetType("System.String"));
                    Dt_Partida_Aprobada.Columns.Add("TOTAL", System.Type.GetType("System.String"));

                    foreach (DataRow Dr_Sessiones in Dt_Session.Rows)
                    {
                        //Obtenemos la partida id y la clave
                        Partida_Id = Dr_Sessiones["PARTIDA_ID"].ToString().Trim();
                        Programa_ID = Dr_Sessiones["PROYECTO_ID"].ToString().Trim();
                        Fuente_Financiamiento_ID = Dr_Sessiones["FUENTE_FINANCIAMIENTO_ID"].ToString().Trim();
                        Capitulo_ID = Dr_Sessiones["CAPITULO_ID"].ToString().Trim();
                        Dependencia_ID = Dr_Sessiones["DEPENDENCIA_ID"].ToString().Trim();
                        Anio = Hf_Anio.Value.Trim();
                        Iguales = false;
                        //verificamos si la partida no a sido ya agrupada
                        if (Dt_Partida_Aprobada.Rows.Count > 0)
                        {
                            ...
                            {
                                if (Dr_Partidas["PARTIDA_ID"].ToString().Trim().Equals(Partida_Id) && Dr_Partidas["FUENTE_FINANCIAMIENTO_ID"].ToString().Trim().Equals(Fuente_Financiamiento_ID) && Dr_Partidas["PROYECTO_ID"].ToString().Trim().Equals(Programa_ID))
                                {
                                    Iguales = true;
                                }
                            }
                        ...
                        if (!Iguales)
                        {
                            foreach (DataRow Dr_Session in Dt_Session.Rows)
                            {
                                if (Dr_Session["PARTIDA_ID"].ToString().Trim().Equals(Partida_Id) && Dr_Session["FUENTE_FINANCIAMIENTO_ID"].ToString().Trim().Equals(Fuente_Financiamiento_ID) && Dr_Session["PROYECTO_ID"].ToString().Trim().Equals(Programa_ID))
                                {
                                    Ene = Ene + Convert.ToDouble(String.IsNullOrEmpty(Dr_Session["ENERO"].ToString()) ? "0" : Dr_Session["ENERO"].ToString().Trim());
                                    Feb = Feb + Convert.ToDouble(String.IsNullOrEmpty(Dr_Session["FEBRERO"].ToString()) ? "0" : Dr_Session["FEBRERO"].ToString().Trim());
                                    Mar = Mar + Convert.ToDouble(String.IsNullOrEmpty(Dr_Session["MARZO"].ToString()) ? "0" : Dr_Session["MARZO"].ToString().Trim());
        ...
        try
        {
            switch (Btn_Nuevo.ToolTip)
            {
                ...
                case "Guardar":
                    if (Validar_Datos())
                    {
                        Dt_Partidas_Asignadas = Crear_Dt_Partida_Aprobada();
    ...
    protected void Grid_Dependencias_Presupuestadas_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        try
        {
            if (Grid_Dependencias_Presupuestadas.SelectedIndex > (-1))
            {
                ...
                Txt_Unidad_Responsable.Text = HttpUtility.HtmlDecode(Grid_Dependencias_Presupuestadas.SelectedRow.Cells[3].Text).Trim();
                Txt_Total_Ajuste.Text = String.Format("{0:c}", Convert.ToDouble(String.IsNullOrEmpty(Grid_Dependencias_Presupuestadas.SelectedRow.Cells[5].Text.Trim()) ? "0" : Grid_Dependencias_Presupuestadas.SelectedRow.Cells[5].Text.Replace("$", "").Trim()));
                Hf_Anio.Value = Grid_Dependencias_Presupuestadas.SelectedRow.Cells[4].Text.Trim();
                Llenar_Combo_Capitulos();
