<%@ Page Language="C#" MasterPageFile="~/paginas/Paginas_Generales/MasterPage.master" AutoEventWireup="true" CodeFile="Frm_Ope_Psp_Clasificacion_Analitica_Gasto.aspx.cs" Inherits="paginas_Presupuestos_Frm_Ope_Psp_Clasificacion_Analitica_Gasto" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Cph_Area_Trabajo2" Runat="Server">
    ...
    <script src="../../javascript/Js_Ope_Psp_Clasificacion_Analitica_Gasto.js" type="text/javascript"></script>
</asp:Content>
                    ...
                    <table style="width:99%; " border="0" cellspacing="0">
                        <tr align="center">
                            <td colspan="4" class="label_titulo">
                                Clasificación por Analítica  del Gasto
                            </td>
                        </tr>
                        <tr align="left">
                            <td colspan="4">
                  ...
                  <div id="Div_CAG" runat="server">
                   <center>
                        ...
                        <div style="text-align:center">
                            <table id="Grid_CAG"></table>
                        </div>
                        <div style="width:99%; ">
                            <center>
                                <div id="Div_Detalles" class="easyui-window">
                                    <center>
                                        <table id="Grid_Detalles"></table>
                                    </center>
                                </div>
                            </center>
                        </div>
