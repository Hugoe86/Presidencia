<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Frm_Ope_Psp_Asignar_Partida_Emergente.aspx.cs" Inherits="paginas_Presupuestos_Frm_Ope_Psp_Asignar_Partida_Emergente" %>
...
//            }
    ...
    <body>
        <form id="Frm_Ope_Psp_Asignar_Partida_Emergente" runat="server">
                            ...
                            <table style="width: 100%; text-align: center;">
                                ...
                                <tr>
                                    ...
                                    <td colspan="8" style="text-align: left;">
                                        <asp:DropDownList ID="Cmb_Capitulos" runat="server" Style="width: 99%;" TabIndex="4"
                                    ...
                                    <td colspan="3" style="text-align: left;">
                                        ...
                                        <asp:DropDownList ID="Cmb_Estatus" runat="server" Style="width: 50%; font-size:x-small;"></asp:DropDownList>
                                    </td>
                                </tr>
                                <tr>
