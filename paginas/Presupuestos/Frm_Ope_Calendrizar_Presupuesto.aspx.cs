        ...
        #region (Metodos Generales)
            ...
            private void Agregar_Fila_Dt_Partidas_Asignadas()
            {
                ...
                try
                {
                    ...
                    Fila["PROYECTO_ID"] = Hf_Programa.Value.Trim();
                ...
                try 
                {
                    ...
                    if(Cmb_Unidad_Responsable.SelectedIndex > 0)
                    {
                        ...
                        if (Dt_Datos_Dependencia != null) 
                        {
                            ...
                            {
                                Txt_Programa.Text = Dt_Datos_Dependencia.Rows[0]["PROGRAMA"].ToString().Trim();
                                Txt_Limite_Presupuestal.Text = String.Format("{0:c}", Dt_Datos_Dependencia.Rows[0]["LIMITE_PRESUPUESTAL"]);
                                Hf_Anio.Value = Dt_Datos_Dependencia.Rows[0]["ANIO_PRESUPUESTAR"].ToString().Trim();
                                ...
                                if (Dt_Datos_Dependencia.Rows[0]["ESTATUS"].ToString().Trim().Equals("RECHAZADO"))
                                {
                                ...
                                {
                                    if (Dt_Datos_Dependencia.Rows[0]["ESTATUS"].ToString().Trim().Equals("AUTORIZADO"))
                                    {
                                        Cmb_Estatus.Items.Clear();
                                ...
                                Cmb_Estatus.SelectedValue = Dt_Datos_Dependencia.Rows[0]["ESTATUS"].ToString().Trim();
                            }
                        }
                    }
                }
