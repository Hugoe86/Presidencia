...
public partial class paginas_Catastro_Frm_Ope_Cat_Seguimiento_Avaluos_Urbanos_Re : System.Web.UI.Page
{
            ...
            if (Grid_Avaluos_Urbanos.SelectedIndex > -1)
            {
                if (Grid_Avaluos_Urbanos.SelectedRow.Cells[4].Text == "POR VALIDAR" || Grid_Avaluos_Urbanos.SelectedRow.Cells[4].Text == "RECHAZADO")
                {
                    ...
                    else
                    {
                        ...
                        if ((Avaluo.Modificar_Observaciones_Avaluo_Re()))
                        {
                            ...
                            {
                                Imprimir_Reporte(Crear_Ds_Avaluo_Urbano(), "Rpt_Ope_Cat_Folio_Pago_Avaluo.rpt", "Rpt_Folio_Pago_Avaluo_Urbano", "Window_Frm", "Avaluo");
    ...
    private DataSet Crear_Ds_Avaluo_Urbano()
    {
        ...
        String Nombre_Perito = Obtener_Dato_Consulta("SELECT " + Cat_Ort_Inspectores.Campo_Nombre + " FROM " + Cat_Ort_Inspectores.Tabla_Cat_Ort_Inspectores + " WHERE " + Cat_Ort_Inspectores.Campo_Inspector_ID + " = '" + Perito_Id + "'").ToUpper();
        ...
        Dr_Renglon_Nuevo["NUMERO_PERITO"] = Convert.ToInt16(Perito_Id);
        ...
        Dr_Renglon_Nuevo["FOLIO_PAGO"] = Obtener_Dato_Consulta("SELECT " + Ope_Tra_Solicitud.Campo_Clave_Solicitud + " FROM " + Ope_Tra_Solicitud.Tabla_Ope_Tra_Solicitud + " WHERE " + Ope_Tra_Solicitud.Campo_Solicitud_ID + " = '" + Hdf_Solicitud_Id.Value + "'");
    ...
    {
        String Contenido = "";
        Contenido = "Su Solicitud ha sido atendida. Favor de pasar a pagar en las cajas de Presidencia de Irapuato, su folio de pago se encuentra adjunto a este correo. Favor de imprimirlo dos veces";
        try
        {
    ...
    protected void Grid_Colindancias_SelectedIndexChanged(object sender, EventArgs e)
    {
        if (Grid_Colindancias.SelectedIndex > -1)
        {
            ...
            if (Dt_Medidas != null)
            {
                foreach (DataRow Dr_Renglon in Dt_Medidas.Rows)
                {
                    if (Dr_Renglon[Ope_Cat_Colindancias_Aur.Campo_Medida_Colindancia].ToString() == Grid_Colindancias.SelectedRow.Cells[1].Text.ToUpper() && Dr_Renglon["ACCION"].ToString() != "BAJA")
                    {
