...
public partial class paginas_Catastro_Frm_Ope_Cat_Seguimiento_Avaluo_Rustico_Regimen : System.Web.UI.Page
{
    ...
    protected void Btn_Siguiente_Fase_Click(object sender, ImageClickEventArgs e)
    {
        try
        {
            if (Grid_Avaluos_Urbanos.SelectedIndex > -1)
            {
                ...
                else if (Hdf_Estatus_Anterior.Value == "2 REVISION")
                {
    ...
    private void Cargar_Datos_Avaluo(DataTable Dt_Avaluo)
    {
        if (Dt_Avaluo.Rows.Count > 0)
        {
            ...
            Hdf_Estatus_Anterior.Value = Dt_Avaluo.Rows[0][Ope_Cat_Avaluo_Rustico.Campo_Estatus_Anterior].ToString();
        }
    }
    ///*******************************************************************************
