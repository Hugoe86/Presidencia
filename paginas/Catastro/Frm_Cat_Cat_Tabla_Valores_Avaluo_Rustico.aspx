<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Frm_Cat_Cat_Tabla_Valores_Avaluo_Rustico.aspx.cs"
    MasterPageFile="~/paginas/Paginas_Generales/MasterPage.master" Inherits="paginas_Catastro_Frm_Cat_Cat_Tabla_Valores_Avaluo_Rustico"
    Title="Catálogo de Tabla de Valores Rústico" %>
                ...
                <table width="98%" border="0" cellspacing="0" class="estilo_fuente">
                    <tr align="center">
                        <td colspan="2" class="label_titulo">
                            Cat&aacute;logo de Tabla de valores Rústico
                        </td>
                    </tr>
                    <tr>
                        <td class="style1">
                                    ...
                                    <td colspan="4">
                                        <asp:GridView ID="Grid_Valores" runat="server" AllowPaging="True" 
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="VALOR_CONSTRU_RUSTICO_ID" HeaderStyle-Width="15%" 
                                                ...
                                                <asp:BoundField DataField="VALOR_M2" DataFormatString="{0:c2}" 
                                                    HeaderStyle-Width="30%" HeaderText="Valor por Hectárea">
