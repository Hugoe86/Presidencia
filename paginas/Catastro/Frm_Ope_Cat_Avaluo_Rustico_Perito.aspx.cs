...
public partial class paginas_Catastro_Frm_Ope_Cat_Avaluo_Rustico_Perito : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (!IsPostBack)
            {
                ...
                {
                    //Validar que el trámite exista o no...
                    Hdf_Solicitud_Id.Value = Session["Tramite_Id"].ToString();
                    if (Obtener_Dato_Consulta("SELECT " + Ope_Cat_Avaluo_Urbano.Campo_No_Avaluo + " FROM " + Ope_Cat_Avaluo_Urbano.Tabla_Ope_Cat_Avaluo_Urbano + " WHERE " + Ope_Cat_Avaluo_Urbano.Campo_Solicitud_Id + " = '" + Session["Tramite_Id"] + "'").Trim() != "")
                    {
                    ...
                    String Consulta = "SELECT " + Ope_Cat_Avaluo_Rustico.Campo_No_Avaluo + " FROM " + Ope_Cat_Avaluo_Rustico.Tabla_Ope_Cat_Avaluo_Rustico + " WHERE " + Ope_Cat_Avaluo_Rustico.Campo_Solicitud_Id + " = '" + Session["Tramite_Id"] + "'";
                    ...
                    else if (Obtener_Dato_Consulta(Consulta).Trim() != "" && Session["Postback_grid"] == null)
                    {
                        ...
                        Aval_Urb.P_Solicitud_Id = Hdf_Solicitud_Id.Value;
                    ...
                    Txt_Uso_Constru.Attributes.Add("OnKeyPress", " ValidarCaracteres(this,250)");
                    Txt_Uso_Constru.Attributes.Add("OnKeyUp", " ValidarCaracteres(this,250)");
                    Txt_Uso_Constru.Attributes.Add("OnKeyPress", " ValidarCaracteres(this,250)");
                    Txt_Uso_Constru.Attributes.Add("OnKeyUp", " ValidarCaracteres(this,250)");

                    Txt_Medida_Colindancia.Attributes.Add("OnKeyPress", " ValidarCaracteres(this,150)");
                    Txt_Medida_Colindancia.Attributes.Add("OnKeyUp", " ValidarCaracteres(this,150)");
                    Txt_Medida_Colindancia.Attributes.Add("OnKeyPress", " ValidarCaracteres(this,150)");
                    Txt_Medida_Colindancia.Attributes.Add("OnKeyUp", " ValidarCaracteres(this,150)");
                    //Limpiar_Formulario();
                }
    ...
    private void Configuracion_Formulario(Boolean Enabled)
    {
        ...
        Txt_Clave_Catastral.Enabled=!Enabled;
    ...
    protected void Btn_Nuevo_Click(object sender, ImageClickEventArgs e)
    {
        try
        {
            if (Btn_Nuevo.AlternateText.Equals("Nuevo"))
            {
                ...
                Dt_Medidas.Columns.Add(Ope_Cat_Colindancias_Ara.Campo_No_Colindancia, typeof(String));
                Dt_Medidas.Columns.Add(Ope_Cat_Colindancias_Ara.Campo_Medida_Colindancia, typeof(String));
                ...
                if (Cmb_Estatus.SelectedValue == "POR VALIDAR" || Cmb_Estatus.SelectedValue == "RECHAZADO" || Cmb_Estatus.SelectedValue == "PAGADO")
                {
                    if (Btn_Modificar.AlternateText.Equals("Modificar"))
                    {
                        if (Cmb_Estatus.SelectedValue == "PAGADO")
                        {
                            ...
                            {
                                ScriptManager.RegisterStartupScript(this, this.GetType(), "Avalúo Rústico", "alert('No es posible actualizar el Avalúo');", true);
                                return;
                            }
                    ...
                    else
                    {
                        if (Validar_Componentes())
                        {
                            ...
                            if ((Avaluo.Modificar_Avaluo_Rustico()))
                            {
                                ...
                                //if (Cmb_Estatus.SelectedValue == "PAGADO")
                                //{
                                //    Insertar_Pasivo("AR" + Hdf_Anio_Avaluo.Value + "/" + Convert.ToInt16(Hdf_No_Avaluo.Value));
    ...
    private DataSet Crear_Ds_Avaluo_Urbano_Reporte()
    {
        ...
        Dr_Avaluo["FECHA"] = Convert.ToDateTime(Dt_Avaluo.Rows[0][Ope_Cat_Avaluo_Rustico.Campo_Fecha_Autorizo].ToString());
        ...
        Dr_Avaluo["NO_VALUADOR"] = Convert.ToInt16(Dt_Perito_Externo.Rows[0][Ope_Cat_Avaluo_Rustico.Campo_Perito_Externo_Id].ToString());
        ...
        {
            if (Dr_Renglon_Actual[Ope_Cat_Documentos_Ara.Campo_Documento].ToString().Trim() == "ANEXO_1")
            {
                Dr_Avaluo["ANEXO_1"] = Convertir_Imagen_A_Cadena_Bytes(System.Drawing.Image.FromFile(Server.MapPath(Dr_Renglon_Actual[Ope_Cat_Documentos_Ara.Campo_Ruta_Documento].ToString())));
            }
            else if (Dr_Renglon_Actual[Ope_Cat_Documentos_Ara.Campo_Documento].ToString().Trim() == "ANEXO_2")
            {
                Dr_Avaluo["ANEXO_2"] = Convertir_Imagen_A_Cadena_Bytes(System.Drawing.Image.FromFile(Server.MapPath(Dr_Renglon_Actual[Ope_Cat_Documentos_Ara.Campo_Ruta_Documento].ToString()))); ;
            }
        }
        ...
        foreach (DataRow Dr_Renglon in Dt_Calculos.Rows)
        {
            ...
            Dr_Avaluo["SUPERFICIE_HA"] = Convert.ToDouble(Dr_Renglon[Ope_Cat_Calc_Terreno_Ara.Campo_Superficie].ToString());
            Dr_Avaluo["VALOR_HA"] = Convert.ToDouble(Dr_Renglon[Cat_Cat_Tab_Val_Const_Rustico.Campo_Valor_M2].ToString());
            Dr_Avaluo["FACTOR"] = Convert.ToDouble(Dr_Renglon[Ope_Cat_Calc_Terreno_Ara.Campo_Factor].ToString());
            Dr_Avaluo["VALOR_PARCIAL"] = Convert.ToDouble(Dr_Renglon[Ope_Cat_Calc_Terreno_Ara.Campo_Valor_Parcial].ToString());
            Dr_Avaluo["GRUPO"] = "A";
        ...
        foreach (DataRow Dr_Renglon in Dt_Valores_Construccion.Rows)
        {
            ...
            Dr_Avaluo["CROQUIS"] = Dr_Renglon[Ope_Cat_Calc_Valor_Const_Ara.Campo_Croquis].ToString();
            Dr_Avaluo["TIPO"] = Convert.ToInt16(Dr_Renglon["TIPO"].ToString());
            Dr_Avaluo["EDO"] = Convert.ToInt16(Dr_Renglon["CON_SERV"].ToString());
            Dr_Avaluo["SUPERFICIE_M2"] = Convert.ToDouble(Dr_Renglon[Ope_Cat_Calc_Valor_Const_Ara.Campo_Superficie_M2].ToString());
            Dr_Avaluo["VALOR_PARCIAL"] = Convert.ToDouble(Dr_Renglon[Ope_Cat_Calc_Valor_Const_Ara.Campo_Valor_Parcial].ToString());
            Dr_Avaluo["EDAD"] = Dr_Renglon[Ope_Cat_Calc_Valor_Const_Ara.Campo_Edad_Constru].ToString();
            Dr_Avaluo["FACTOR"] = Convert.ToDouble(Dr_Renglon[Ope_Cat_Calc_Valor_Const_Ara.Campo_Factor].ToString());
            Dr_Avaluo["USO"] = Dr_Renglon[Ope_Cat_Calc_Valor_Const_Ara.Campo_Uso_Constru].ToString();
    ...
    protected void Btn_Imprimir_Click(object sender, ImageClickEventArgs e)
    {
        ...
        //{
            if (Cmb_Estatus.SelectedValue == "PAGADO")
            {
                Imprimir_Reporte(Crear_Ds_Avaluo_Urbano_Reporte(), "Rpt_Ope_Cat_Avaluo_Rustico.rpt", "Avaluo_Rustico", "Window_Frm", "Avaluo_Rustico");
            }
        //}
    }
    ...
    private void Cargar_Datos_Avaluo(DataTable Dt_Avaluo)
    {
        if (Dt_Avaluo.Rows.Count > 0)
        {
            ...
            try
            {
                ...
                Cmb_Tipo_Construccion.SelectedValue = Dt_Avaluo.Rows[0][Ope_Cat_Avaluo_Rustico.Campo_Uso].ToString();
                if (Cmb_Tipo_Construccion.SelectedValue != Dt_Avaluo.Rows[0][Ope_Cat_Avaluo_Rustico.Campo_Uso].ToString())
                {
                    Cmb_Tipo_Construccion.SelectedValue = "OTRO";
                    Txt_Uso_Constru.Text = Dt_Avaluo.Rows[0][Ope_Cat_Avaluo_Rustico.Campo_Uso].ToString();
            ...
            Hdf_Solicitud_Id.Value = Dt_Avaluo.Rows[0][Ope_Cat_Avaluo_Rustico.Campo_Solicitud_Id].ToString();
            Cmb_Revision.SelectedValue = Dt_Avaluo.Rows[0][Ope_Cat_Avaluo_Rustico.Campo_Permitir_Revision].ToString();
        }
    }
    ...
    private void Crear_Dt_Valores_Construccion()
    {
        ...
        Dt_Valores_Construccion.Columns.Add("EDAD_CONSTRU", typeof(String));
    ...
    private void Guardar_Imagenes(DataTable Dt_Documentos)
    {
        ...
        {
            Directory.CreateDirectory(Server.MapPath("../Catastro/Archivos_Ara/" + Hdf_Anio_Avaluo.Value + "_" + Hdf_No_Avaluo.Value + "/"));
        }
        foreach (DataRow Dr_Renglon in Dt_Documentos.Rows)
        {
            if (Dr_Renglon["ACCION"].ToString() == "ALTA")
            {
                ...
                FileStream Escribir_Archivo = new FileStream(Server.MapPath("../Catastro/Archivos_Ara/" + Hdf_Anio_Avaluo.Value + "_" + Hdf_No_Avaluo.Value + "/" + Dr_Renglon["RUTA_DOCUMENTO"].ToString()), FileMode.Create, FileAccess.Write);
