<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Frm_Ope_Cat_Avaluo_Urbano_Re.aspx.cs"
    Inherits="paginas_Catastro_Frm_Ope_Cat_Avaluo_Urbano_Re" MasterPageFile="~/paginas/Paginas_Generales/MasterPage.master"
    Title="Avalúo Urbano Regularizacion" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Cph_Area_Trabajo1" runat="Server">
    ...
    <asp:UpdatePanel ID="Upd_Otros_Pagos" runat="server">
        <ContentTemplate>
                ...
                <table width="98%" border="0" cellspacing="0" class="estilo_fuente">
                    <tr align="center">
                        <td colspan="2" class="label_titulo">
                            Avalúos Urbanos Regularización
                        </td>
                    </tr>
                    <tr>
                        <td class="style1">
                    ...
                    <tr class="barra_busqueda" align="right">
                        <td align="left" >
                            <asp:ImageButton ID="Btn_Autorizar_Avaluo" runat="server" TabIndex="1" OnClientClick="return confirm('¿Está seguro de que desea autorizar el Avaluo?');"
                                ...
                                AlternateText="Autorizar" OnClick="Btn_Autorizar_Click" ToolTip="Autorizado"
                                Visible="false" />
                        ...
                        <table width="98%" border="0" cellspacing="0" class="estilo_fuente">
                            ...
                            <tr>
                                ...
                                <td style="text-align: left; width: 30%;">
                                    <asp:TextBox ID="Txt_Clave_Tramite" runat="server" Width="85%" Enabled="false" Style="text-transform: uppercase"
                                        AutoPostBack="true"></asp:TextBox>
                                    <asp:ImageButton ID="Btn_Mostrar_Busqueda_Avanzada_Solicitudes" runat="server" Height="24px"
                                        ImageUrl="~/paginas/imagenes/paginas/Busqueda_00001.png" TabIndex="7" ToolTip="Búsqueda Avanzada Solicitudes"
                            ...
                            <tr>
                                ...
                                <td style="text-align: left; width: 30%;">
                                    <asp:DropDownList ID="Cmb_Motivo_Avaluo" runat="server" Width="98%" TabIndex="9"
                                        Enabled="false">
                                    </asp:DropDownList>
                                </td>
                            ...
                            <tr>
                                ...
                                <td style="text-align: left; width: 30%;">
                                    <asp:TextBox ID="Txt_Cuenta_Predial" runat="server" Width="98%" Enabled="false" Style="text-transform: uppercase"></asp:TextBox>
                                    <asp:ImageButton ID="Btn_Mostrar_Busqueda_Avanzada_Cuentas_Predial" runat="server"
                                        ...
                                        ToolTip="Búsqueda Avanzada de Cuenta Predial" Width="24px" Visible="false" />
                                    <asp:HiddenField ID="Hdf_Cuenta_Predial_Id" runat="server" />
                                </td>
                                <td style="text-align: left; width: 20%; text-align: Left;">
                                </td>
                                <td style="text-align: left; width: 30%;">
                                    &nbsp; Reg.<asp:TextBox ID="Txt_Region" runat="server" Width="10%" TabIndex="10"
                                    ...
                                    &nbsp; Mzna.<asp:TextBox ID="Txt_Manzana" runat="server" Width="10%" TabIndex="11"
                                        Enabled="false" Style="text-transform: uppercase" />
                                    ...
                                    &nbsp; Lote<asp:TextBox ID="Txt_Lote" runat="server" Width="10%" TabIndex="12" Enabled="false"
                            ...
                            <tr>
                                ...
                                <td style="text-align: left; width: 30%;">
                                    <asp:TextBox ID="Txt_Propietario" runat="server" Width="98%" TabIndex="9" Enabled="false"
                                        Style="text-transform: uppercase"></asp:TextBox>
                                </td>
                                <td style="text-align: Left; width: 20%;">
                                    Estatus
                            ...
                            <tr>
                                ...
                                <td style="text-align: left; width: 30%;">
                                    <asp:TextBox ID="Txt_Domicilio_Not" runat="server" Width="98%" TabIndex="9" Enabled="false"
                                        Style="text-transform: uppercase"></asp:TextBox>
                                </td>
                                <td style="text-align: left; width: 20%; text-align: Left;">
                                    Colonia
                                ...
                                <td style="text-align: left; width: 30%;">
                                    <asp:TextBox ID="Txt_Colonia_Not" runat="server" Width="96.4%" TabIndex="11" Enabled="false"
                                        Style="text-transform: uppercase" />
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td style="text-align: left; width: 30%;">
                                    <asp:TextBox ID="Txt_Localidad_Not" runat="server" Width="98%" TabIndex="9" Enabled="false"
                                        Style="text-transform: uppercase"></asp:TextBox>
                                </td>
                                <td style="text-align: left; width: 20%; text-align: Left;">
                                    Municipio
                                ...
                                <td style="text-align: left; width: 30%;">
                                    <asp:TextBox ID="Txt_Municipio_Not" runat="server" Width="96.4%" TabIndex="11" Enabled="false"
                                        Style="text-transform: uppercase" />
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td style="text-align: left; width: 30%;">
                                    <asp:TextBox ID="Txt_Solicitante" runat="server" Width="98%" TabIndex="13" Enabled="false"
                                        Style="text-transform: uppercase"></asp:TextBox>
                                </td>
                                <td style="text-align: left; width: 20%; text-align: Left;">
                                ...
                                <td style="text-align: left; width: 30%;">
                                    <asp:TextBox ID="Txt_Motivo" runat="server" Width="96.4%" TabIndex="11" Enabled="false"
                                        Style="text-transform: uppercase" />
                                </td>
                            </tr>
                            <tr>
                                            ...
                                            <asp:TemplateField>
                                                ...
                                                <ItemTemplate>
                                                    <asp:RadioButton ID="Rdb_Columna_A" runat="server" GroupName="Grp_Rbd_Constru_Dominante"
                                                        name="<%=Rdb_Columna_A.ClientID %>" Width="98%" TabIndex="16" />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:BoundField DataField="COLUMNA_B" HeaderStyle-Width="20%">
                                                <ItemStyle HorizontalAlign="Left" Width="20%" />
                                            ...
                                            <asp:TemplateField>
                                                ...
                                                <ItemTemplate>
                                                    <asp:RadioButton ID="Rdb_Columna_B" runat="server" GroupName="Grp_Rbd_Constru_Dominante"
                                                        name="<%=Rdb_Columna_B.ClientID %>" Width="98%" TabIndex="16" />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:BoundField DataField="COLUMNA_C" HeaderStyle-Width="20%">
                                                <ItemStyle HorizontalAlign="Left" Width="20%" />
                                            ...
                                            <asp:TemplateField>
                                                ...
                                                <ItemTemplate>
                                                    <asp:RadioButton ID="Rdb_Columna_C" runat="server" GroupName="Grp_Rbd_Constru_Dominante"
                                                        name="<%=Rdb_Columna_C.ClientID %>" Width="98%" TabIndex="16" />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
                                        <SelectedRowStyle CssClass="GridSelected" />
                            ...
                            <tr>
                                ...
                                <td style="text-align: right; width: 30%;">
                                    <asp:TextBox ID="Txt_Dens_Construccion" runat="server" MaxLength="6" TabIndex="19"
                            ...
                            <tr>
                                ...
                                <td colspan="3" style="text-align: right; width: 30%;">
                                    <asp:TextBox ID="Txt_Uso" runat="server" Rows="3" Style="float: left; text-transform: uppercase"
                                        TextMode="MultiLine" Width="96.4%" TabIndex="22" />
                                </td>
                            </tr>
                            <tr>
                                <td style="text-align: left; width: 20%;">
                                ...
                                <td colspan="4" style="text-align: center;">
                                    <asp:GridView ID="Grid_Elementos_Construccion" runat="server" AllowPaging="False"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="ELEMENTOS_CONSTRUCCION" HeaderStyle-Width="5%" HeaderText="Referencia">
                                                <HeaderStyle HorizontalAlign="Left" Width="0%" />
                                                <ItemStyle HorizontalAlign="Left" Width="0%" />
                                            </asp:BoundField>
                                            <asp:TemplateField HeaderText="A">
                                                ...
                                                <ItemTemplate>
                                                    <asp:TextBox ID="Txt_A" runat="server" CssClass="text_cantidades_grid" Font-Size="X-Small"
                                                        name="<%=Txt_A.ClientID %>" Style="text-transform: uppercase" Width="80%" TabIndex="23"></asp:TextBox>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="B">
                                                ...
                                                <ItemTemplate>
                                                    <asp:TextBox ID="Txt_B" runat="server" CssClass="text_cantidades_grid" Font-Size="X-Small"
                                                        name="<%=Txt_B.ClientID %>" Style="text-transform: uppercase" Width="80%" TabIndex="24"></asp:TextBox>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="C">
                                                ...
                                                <ItemTemplate>
                                                    <asp:TextBox ID="Txt_C" runat="server" CssClass="text_cantidades_grid" Font-Size="X-Small"
                                                        name="<%=Txt_C.ClientID %>" Style="text-transform: uppercase" Width="80%" TabIndex="25"></asp:TextBox>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="D">
                                                ...
                                                <ItemTemplate>
                                                    <asp:TextBox ID="Txt_D" runat="server" CssClass="text_cantidades_grid" Font-Size="X-Small"
                                                        name="<%=Txt_D.ClientID %>" Style="text-transform: uppercase" Width="80%" TabIndex="26"></asp:TextBox>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="E">
                                                ...
                                                <ItemTemplate>
                                                    <asp:TextBox ID="Txt_E" runat="server" CssClass="text_cantidades_grid" Font-Size="X-Small"
                                                        name="<%=Txt_E.ClientID %>" TabIndex="27" Style="text-transform: uppercase" Width="90%"></asp:TextBox>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="F">
                                                ...
                                                <ItemTemplate>
                                                    <asp:TextBox ID="Txt_F" runat="server" CssClass="text_cantidades_grid" Font-Size="X-Small"
                                                        name="<%=Txt_F.ClientID %>" TabIndex="28" Style="text-transform: uppercase" Width="90%"></asp:TextBox>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="G">
                                                ...
                                                <ItemTemplate>
                                                    <asp:TextBox ID="Txt_G" runat="server" CssClass="text_cantidades_grid" Font-Size="X-Small"
                                                        name="<%=Txt_G.ClientID %>" TabIndex="29" Style="text-transform: uppercase" Width="90%"></asp:TextBox>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="H">
                                                ...
                                                <ItemTemplate>
                                                    <asp:TextBox ID="Txt_H" runat="server" CssClass="text_cantidades_grid" Font-Size="X-Small"
                                                        name="<%=Txt_H.ClientID %>" TabIndex="30" Style="text-transform: uppercase" Width="90%"></asp:TextBox>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="I">
                                                ...
                                                <ItemTemplate>
                                                    <asp:TextBox ID="Txt_I" runat="server" CssClass="text_cantidades_grid" Font-Size="X-Small"
                                                        name="<%=Txt_I.ClientID %>" TabIndex="31" Style="text-transform: uppercase" Width="90%"></asp:TextBox>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="J">
                                                ...
                                                <ItemTemplate>
                                                    <asp:TextBox ID="Txt_J" runat="server" CssClass="text_cantidades_grid" Font-Size="X-Small"
                                                        name="<%=Txt_J.ClientID %>" TabIndex="32" Style="text-transform: uppercase" Width="90%"></asp:TextBox>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="K">
                                                ...
                                                <ItemTemplate>
                                                    <asp:TextBox ID="Txt_K" runat="server" CssClass="text_cantidades_grid" Font-Size="X-Small"
                                                        name="<%=Txt_K.ClientID %>" TabIndex="33" Style="text-transform: uppercase" Width="90%"></asp:TextBox>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="L">
                                                ...
                                                <ItemTemplate>
                                                    <asp:TextBox ID="Txt_L" runat="server" CssClass="text_cantidades_grid" Font-Size="X-Small"
                                                        name="<%=Txt_L.ClientID %>" TabIndex="34" Style="text-transform: uppercase" Width="90%"></asp:TextBox>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="M">
                                                ...
                                                <ItemTemplate>
                                                    <asp:TextBox ID="Txt_M" runat="server" CssClass="text_cantidades_grid" Font-Size="X-Small"
                                                        name="<%=Txt_M.ClientID %>" TabIndex="35" Style="text-transform: uppercase" Width="90%"></asp:TextBox>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="N">
                                                ...
                                                <ItemTemplate>
                                                    <asp:TextBox ID="Txt_N" runat="server" CssClass="text_cantidades_grid" Font-Size="X-Small"
                                                        name="<%=Txt_N.ClientID %>" TabIndex="36" Style="text-transform: uppercase" Width="90%"></asp:TextBox>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="O">
                                                ...
                                                <ItemTemplate>
                                                    <asp:TextBox ID="Txt_O" runat="server" CssClass="text_cantidades_grid" Font-Size="X-Small"
                                                        name="<%=Txt_O.ClientID %>" TabIndex="37" Style="text-transform: uppercase" Width="90%"></asp:TextBox>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
                                        <SelectedRowStyle CssClass="GridSelected" />
                            ...
                            <tr>
                                ...
                                <td colspan="3" style="width: 98%; text-align: left;">
                                    <asp:TextBox ID="Txt_Observaciones" runat="server" Rows="3" Style="float: left; text-transform: uppercase"
                                        TextMode="MultiLine" Width="96.4%" TabIndex="38" />
                                </td>
                            </tr>
                            <tr>
                                <td>
                                            ...
                                            <asp:TemplateField HeaderText="Superficie M2">
                                                ...
                                                <ItemTemplate>
                                                    <asp:TextBox ID="Txt_Superficie_M2" runat="server" AutoPostBack="true" CssClass="text_cantidades_grid"
                                                        ...
                                                        Width="80%" TabIndex="39"></asp:TextBox>
                                            ...
                                            <asp:TemplateField HeaderStyle-Width="5%" HeaderText="">
                                                <ItemTemplate>
                                                    <asp:ImageButton ID="Btn_Valor_Tramo" runat="server" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>"
                                                        ...
                                                        TabIndex="39" ToolTip="Seleccionar Valor M2" Width="22px" />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                    ...
                                    <asp:GridView ID="Grid_Valores_Construccion" runat="server" AllowPaging="False" AllowSorting="True"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Tipo">
                                                ...
                                                <ItemTemplate>
                                                    <asp:TextBox ID="Txt_Tipo" runat="server" AutoPostBack="true" CssClass="text_cantidades_grid"
                                                        TabIndex="40" Font-Size="X-Small" name="<%=Txt_Tipo.ClientID %>" OnTextChanged="Txt_Tipo_Constru_TextChanged"
                                            ...
                                            <asp:TemplateField HeaderText="Con Serv">
                                                ...
                                                <ItemTemplate>
                                                    <asp:TextBox ID="Txt_Con_Serv" runat="server" AutoPostBack="true" CssClass="text_cantidades_grid"
                                                        TabIndex="40" Font-Size="X-Small" name="<%=Txt_Con_Serv.ClientID %>" OnTextChanged="Txt_Con_Serv_Constru_TextChanged"
                                                        Width="80%"></asp:TextBox>
                                            ...
                                            <asp:TemplateField HeaderText="Superficie M2">
                                                ...
                                                <ItemTemplate>
                                                    <asp:TextBox ID="Txt_Superficie_M2" runat="server" AutoPostBack="true" CssClass="text_cantidades_grid"
                                                        TabIndex="40" Font-Size="X-Small" name="<%=Txt_Superficie_M2.ClientID %>" OnTextChanged="Txt_Superficie_M2_Constru_TextChanged"
                                                        Width="80%"></asp:TextBox>
                                                    <cc1:FilteredTextBoxExtender ID="FTE_Txt_Superficie_M2" runat="server" Enabled="True"
                                                        FilterType="Custom, Numbers" TargetControlID="Txt_Superficie_M2" ValidChars="0123456789.,">
                                                    </cc1:FilteredTextBoxExtender>
                                            ...
                                            <asp:TemplateField HeaderText="Factor">
                                                ...
                                                <ItemTemplate>
                                                    <asp:TextBox ID="Txt_Factor" runat="server" AutoPostBack="true" CssClass="text_cantidades_grid"
                                                        TabIndex="40" Font-Size="X-Small" name="<%=Txt_Factor.ClientID %>" OnTextChanged="Txt_Factor_Constru_TextChanged"
                                                        Width="80%"></asp:TextBox>
                                                    <cc1:FilteredTextBoxExtender ID="FTE_Txt_Importe_Grid" runat="server" Enabled="True"
                            ...
                            <tr id="Tr1" runat="server">
                                ...
                                <td colspan="3" style="width: 80%">
                                    <asp:TextBox ID="Txt_Medida_Colindancia" Style="text-transform: uppercase" runat="server"
                                        TextMode="MultiLine" Rows="3" Width="98%" TabIndex="41"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td>
            ...
            <table Style="display:none" id="Tab_Ejemplo" runat="server">
            <tr style="background-color: #3366CC">
                                <td colspan="4" style="text-align: left; font-size: 15px; color: #FFFFFF;">
                            ...
                            <tr id="Tr_Fila_Fotografias_Bien" runat="server">
                                ...
                                <td style="text-align: left; width: 30%" class="style1">
                                    <asp:DropDownList ID="Cmb_Documento" runat="server" Width="98%" TabIndex="43">
                            ...
                            <tr>
                                ...
                                <td style="text-align: left; width: 30%;">
                                    <asp:TextBox ID="Txt_Inpa" runat="server" AutoPostBack="true" Enabled="false" MaxLength="6"
                                        TabIndex="46" OnTextChanged="Txt_Inpa_TextChanged" Style="text-transform: uppercase"
                                        Width="98%"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td style="text-align: left; width: 30%;">
                                    <asp:TextBox ID="Txt_Inpr" runat="server" AutoPostBack="true" Enabled="false" MaxLength="6"
                                        OnTextChanged="Txt_Inpr_TextChanged" Style="text-transform: uppercase" TabIndex="47"
                                        Width="98%"></asp:TextBox>
                                </td>
                                <td style="text-align: left; width: 20%; text-align: left;">
                                    V.R.
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:CheckBox ID="Chk_Pago_Avaluo" runat="server" Font-Size="X-Small" Width="98%"
                                        TabIndex="48" />
                                </td>
                                <td style="text-align: left; width: 20%">
                                    Importe del Avalúo
    ...
    <cc1:ModalPopupExtender ID="Mpe_Busqueda_Solicitud" runat="server" TargetControlID="Btn_Comodin_Open_Busqueda_Solicitudes"
        PopupControlID="Pnl_Busqueda_Contenedor_Solicitudes" BackgroundCssClass="popUpStyle"
        BehaviorID="Busqueda_Solicitudes" CancelControlID="Btn_Comodin_Close_Busqueda_Solicitudes"
    ...
    <asp:Panel ID="Pnl_Busqueda_Contenedor_Solicitudes" runat="server" CssClass="drag"
        HorizontalAlign="Center" Width="650px" Style="display: none; border-style: outset;
        border-color: Silver; background-image: url(~/paginas/imagenes/paginas/Sias_Fondo_Azul.PNG);
            ...
            <ContentTemplate>
                <div style="color: #5D7B9D">
                    <table width="100%">
                        <tr>
                            <td align="left" style="text-align: left;">
                                <asp:UpdateProgress ID="UpdateProgress1" runat="server" AssociatedUpdatePanelID="Upnl_Filtros_Busqueda_Prestamos"
                                    DisplayAfter="0">
                                    <ProgressTemplate>
                                        <div id="progressBackgroundFilter1" class="progressBackgroundFilter">
                                        </div>
