...
public partial class paginas_Catastro_Frm_Ope_Cat_Avaluo_Urbano_Re : System.Web.UI.Page
{
    ...
    private void Llenar_Tabla_Avaluos_Urbanos(int Pagina)
    {
        try
        {
            Cls_Ope_Cat_Avaluo_Urbano_Reg_Negocio Avaluo_Urb = new Cls_Ope_Cat_Avaluo_Urbano_Reg_Negocio();
            ...
            Grid_Avaluos_Urbanos.DataSource = Avaluo_Urb.Consultar_Avaluo_Urbano_Re();
    ...
    protected void Grid_Avaluos_Urbanos_SelectedIndexChanged(object sender, EventArgs e)
    {
        if (Grid_Avaluos_Urbanos.SelectedIndex > -1)
        {
            ...
            Cls_Ope_Cat_Avaluo_Urbano_Reg_Negocio Aval_Urb = new Cls_Ope_Cat_Avaluo_Urbano_Reg_Negocio();
            Aval_Urb.P_No_Avaluo = Hdf_No_Avaluo.Value;
            Aval_Urb.P_Anio_Avaluo = Hdf_Anio_Avaluo.Value;
            Session["Dt_Tabla_Valores_Construccion"] = Aval_Urb.Consultar_Tabla_Valores_Construccion_Re();
            Dt_Avaluo = Aval_Urb.Consultar_Avaluo_Urbano_Re();
            Cargar_Datos_Avaluo(Dt_Avaluo);
            Cargar_Caracteristicas_Construccion(Aval_Urb.P_Dt_Caracteristicas_Terreno_Re);
            Cargar_Construccion(Aval_Urb.P_Dt_Construccion_Re);
            Crear_Tabla_Clasificacion_Zona(Aval_Urb.P_Dt_Clasificacion_Zona_Re);
            Crear_Tabla_Construccion_Dominante(Aval_Urb.P_Dt_Construccion_Dominante_Re);
            Crear_Tabla_Servicios_Zona(Aval_Urb.P_Dt_Servicios_Zona_Re);
            Session["Dt_Grid_Calculos"] = Aval_Urb.P_Dt_Calculo_Valor_Terreno_Re.Copy();
            Grid_Calculos.Columns[3].Visible = true;
            Grid_Calculos.DataSource = Aval_Urb.P_Dt_Calculo_Valor_Terreno_Re;
            Grid_Calculos.PageIndex = 0;
            Grid_Calculos.DataBind();
            Grid_Calculos.Columns[3].Visible = false;
            Session["Dt_Grid_Elementos_Construccion"] = Aval_Urb.P_Dt_Elementos_Construccion_Re.Copy();
            ...
            Grid_Elementos_Construccion.DataSource = Aval_Urb.P_Dt_Elementos_Construccion_Re;
            ...
            Session["Dt_Grid_Valores_Construccion"] = Aval_Urb.P_Dt_Calculo_Valor_Construccion_Re.Copy();

            Grid_Valores_Construccion.DataSource = Aval_Urb.P_Dt_Calculo_Valor_Construccion_Re;
            Grid_Valores_Construccion.PageIndex = 0;
            Grid_Valores_Construccion.DataBind();
            DataTable Dt_Archivos = Aval_Urb.P_Dt_Archivos_Re.Copy();
            ...
            DataTable Dt_Medidas = Aval_Urb.P_Dt_Medidas_Re.Copy();
            ...
            if (Dt_Avaluo.Rows[0][Ope_Cat_Avaluo_Urbano_Re.Campo_Estatus].ToString() != "AUTORIZADO")
            {
            ...
            foreach (DataRow Dr_Renglon_Actual in Dt_Tramites.Rows)
            {
                ...
                {
                    Txt_Motivo.Text = Dr_Renglon_Actual["MOTIVO_REGULARIZACION"].ToString();

                }
            }
            Dt_Motivos_Rechazo = Aval_Urb.Consultar_Motivos_Rechazo_Avaluo_Re();
            Session["Dt_Motivos_Rechazo"] = Dt_Motivos_Rechazo.Copy();
            Tab_Ejemplo.Style["display"] = "inherit";
    ...
    ///DESCRIPCIÓN: Muestra los datos del avaluo.
    ///PROPIEDADES:     Enabled: Especifica si estara habilitado o no el componente
    ///            
    ///CREO: Miguel Angel Bedolla Moreno
    ///FECHA_CREO: 05/May_2012
    ...
    private void Cargar_Datos_Avaluo(DataTable Dt_Avaluo)
    {
        if (Dt_Avaluo.Rows.Count > 0)
        {
            ...
            Cls_Ope_Cat_Avaluo_Urbano_Reg_Negocio Aval_Rust = new Cls_Ope_Cat_Avaluo_Urbano_Reg_Negocio();

            Txt_Clave_Tramite.Text = Dt_Avaluo.Rows[0]["CLAVE_SOLICITUD"].ToString();

            if (Dt_Avaluo.Rows[0][Ope_Cat_Avaluo_Urbano.Campo_Inpa].ToString() == "")
            {
                Txt_Inpa.Text = "0.00";
            }
            else
            ...
            if (Dt_Avaluo.Rows[0][Ope_Cat_Avaluo_Urbano.Campo_Inpr].ToString() == "")
            {
                Txt_Inpr.Text = "0.00";
            }
            else
            ...
            Oficios.P_Departamento_Catastro = "REGULARIZACION";
    ...
    protected void Btn_Nuevo_Click(object sender, ImageClickEventArgs e)
    {
        try
        {
            if (Btn_Nuevo.AlternateText.Equals("Nuevo"))
            {
                ...
                Crear_Dt_Calculos();
                Cls_Ope_Cat_Avaluo_Urbano_Reg_Negocio Avaluo = new Cls_Ope_Cat_Avaluo_Urbano_Reg_Negocio();
                Dt_Elementos_Construccion = Avaluo.Consultar_Tabla_Elementos_Construccion_Re();
                ...
                Dt_Elementos_Construccion = Avaluo.Consultar_Tabla_Clasificacion_Zona_Re();
                Crear_Tabla_Clasificacion_Zona(Dt_Elementos_Construccion);
                Dt_Elementos_Construccion = Avaluo.Consultar_Tabla_Servicios_Zona_Re();
                Crear_Tabla_Servicios_Zona(Dt_Elementos_Construccion);
                Dt_Elementos_Construccion = Avaluo.Consultar_Tabla_Const_Dominante_Re();
                Crear_Tabla_Construccion_Dominante(Dt_Elementos_Construccion);
                Avaluo.P_Anio_Avaluo = DateTime.Now.Year.ToString();
                Session["Dt_Tabla_Valores_Construccion"] = Avaluo.Consultar_Tabla_Valores_Construccion_Re();
            ...
            else
            {
                if (Validar_Componentes())
                {
                    ...
                    Avaluo.P_Dt_Calculo_Valor_Construccion_Re = (DataTable)Session["Dt_Grid_Valores_Construccion"];
                    Avaluo.P_Dt_Calculo_Valor_Terreno_Re = (DataTable)Session["Dt_Grid_Calculos"];
                    Avaluo.P_Dt_Caracteristicas_Terreno_Re = Crear_Tabla_Caracteristicas_Terreno1();
                    Avaluo.P_Dt_Construccion_Re = Crear_Tabla_Construccion_Terreno();
                    Avaluo.P_Dt_Elementos_Construccion_Re = (DataTable)Session["Dt_Grid_Elementos_Construccion"];
                    Avaluo.P_Dt_Archivos_Re = (DataTable)Session["Dt_Documentos"];
                    Avaluo.P_Dt_Medidas_Re = (DataTable)Session["Dt_Medidas"];
                    ...
                    Avaluo.P_Dt_Clasificacion_Zona_Re = (DataTable)Session["Dt_Grid_Clasificacion_Zona"];
                    Avaluo.P_Dt_Servicios_Zona_Re = (DataTable)Session["Dt_Grid_Servicios_Zona"];
                    Avaluo.P_Dt_Construccion_Dominante_Re = (DataTable)Session["Dt_Grid_Construccion_Dominante"];
                    Avaluo.P_Solicitud_Id = Hdf_Solicitud_Id.Value;
                    if ((Avaluo.Alta_Valor_Construccion_Re()))
                    {
                        ...
                        Guardar_Imagenes(Avaluo.P_Dt_Archivos_Re);
    ...
    protected void Btn_Modificar_Click(object sender, ImageClickEventArgs e)
    {
        try
        {
            ...
            {
                if (Cmb_Estatus.SelectedValue == "POR VALIDAR" || Cmb_Estatus.SelectedValue == "RECHAZADO")
                {
                    Configuracion_Formulario(false);
            ...
            else
            {
                if (Validar_Componentes())
                {
                    ...
                    Avaluo.P_Dt_Calculo_Valor_Construccion_Re = (DataTable)Session["Dt_Grid_Valores_Construccion"];
                    Avaluo.P_Dt_Calculo_Valor_Terreno_Re = (DataTable)Session["Dt_Grid_Calculos"];
                    Avaluo.P_Dt_Caracteristicas_Terreno_Re = Crear_Tabla_Caracteristicas_Terreno();
                    Avaluo.P_Dt_Construccion_Re = Crear_Tabla_Construccion_Terreno();
                    Avaluo.P_Dt_Elementos_Construccion_Re = (DataTable)Session["Dt_Grid_Elementos_Construccion"];
                    Guardar_Grid_Clasificacion_Zona();
                    Guardar_Grid_Construccion_Dominante();
                    ...
                    Avaluo.P_Dt_Servicios_Zona_Re = (DataTable)Session["Dt_Grid_Servicios_Zona"];
                    Avaluo.P_Dt_Construccion_Dominante_Re = (DataTable)Session["Dt_Grid_Construccion_Dominante"];
                    Avaluo.P_Dt_Observaciones_Re = (DataTable)Session["Dt_Motivos_Rechazo"];
                    Avaluo.P_Region = Txt_Region.Text;
                    Avaluo.P_Lote = Txt_Lote.Text;
                    Avaluo.P_Manzana = Txt_Manzana.Text;
    ...
    private DataSet Crear_Ds_Avaluo_Urbano()
    {
        ...
        Avaluo.P_Anio_Avaluo = Hdf_Anio_Avaluo.Value;
        Avaluo.P_No_Avaluo = Hdf_No_Avaluo.Value;
        DataTable Dt_Avaluo = Avaluo.Consultar_Avaluo_Urbano_Re();
    ...
    protected void Btn_Salir_Click(object sender, ImageClickEventArgs e)
    {
        ...
        {
            Response.Redirect("../Catastro/Frm_Ope_Cat_Avaluo_Urbano_Re.aspx");
        }
        else
        {
            Limpiar_Formulario();
            ...
            Btn_Autorizar_Avaluo.Visible = false;
            Tab_Ejemplo.Style["display"] = "none";
            Grid_Documentos.Columns[4].Visible = true;
            //Response.Redirect("../Catastro/Frm_Ope_Cat_Avaluo_Urbano_Re.aspx");
        }
    }
    ...
    protected void Guardar_Dt_Elementos_Construccion()
    {
        ...
        for (int i = 0; i < Dt_Elementos_Construccion.Rows.Count; i++)
        {
            ...
            TextBox Txt_N_Temporal = (TextBox)Grid_Elementos_Construccion.Rows[i].Cells[15].FindControl("Txt_N");
            TextBox Txt_O_Temporal = (TextBox)Grid_Elementos_Construccion.Rows[i].Cells[16].FindControl("Txt_O");
            Dt_Elementos_Construccion.Rows[i]["ELEMENTO_CONSTRUCCION_A"] = Txt_A_Temporal.Text;

            Dt_Elementos_Construccion.Rows[i]["ELEMENTO_CONSTRUCCION_B"] = Txt_B_Temporal.Text;
            Dt_Elementos_Construccion.Rows[i]["ELEMENTO_CONSTRUCCION_C"] = Txt_C_Temporal.Text;
            Dt_Elementos_Construccion.Rows[i]["ELEMENTO_CONSTRUCCION_D"] = Txt_D_Temporal.Text;
            Dt_Elementos_Construccion.Rows[i]["ELEMENTO_CONSTRUCCION_E"] = Txt_E_Temporal.Text;
            Dt_Elementos_Construccion.Rows[i]["ELEMENTO_CONSTRUCCION_F"] = Txt_F_Temporal.Text;
            Dt_Elementos_Construccion.Rows[i]["ELEMENTO_CONSTRUCCION_G"] = Txt_G_Temporal.Text;
            Dt_Elementos_Construccion.Rows[i]["ELEMENTO_CONSTRUCCION_H"] = Txt_H_Temporal.Text;
            Dt_Elementos_Construccion.Rows[i]["ELEMENTO_CONSTRUCCION_I"] = Txt_I_Temporal.Text;
            Dt_Elementos_Construccion.Rows[i]["ELEMENTO_CONSTRUCCION_J"] = Txt_J_Temporal.Text;
            Dt_Elementos_Construccion.Rows[i]["ELEMENTO_CONSTRUCCION_K"] = Txt_K_Temporal.Text;
            Dt_Elementos_Construccion.Rows[i]["ELEMENTO_CONSTRUCCION_L"] = Txt_L_Temporal.Text;
            Dt_Elementos_Construccion.Rows[i]["ELEMENTO_CONSTRUCCION_M"] = Txt_M_Temporal.Text;
            Dt_Elementos_Construccion.Rows[i]["ELEMENTO_CONSTRUCCION_N"] = Txt_N_Temporal.Text;
            Dt_Elementos_Construccion.Rows[i]["ELEMENTO_CONSTRUCCION_O"] = Txt_O_Temporal.Text;
        }
    }
    ...
    private void Cargar_Generales_Cuenta(DataTable dataTable)
    {
        ...
        try
        {
            ...
            //    Txt_Localidad.Text = Dt_Estado_Predio.Rows[0]["Descripcion"].ToString();
            //}
            ...
            else if (!String.IsNullOrEmpty(dataTable.Rows[0]["Estado_Notificacion"].ToString()))
            {
                ...
                Txt_Localidad.Text = Txt_Localidad_Not.Text;
            }
    ...
    private void Calcular_Valor_Total_Predio()
    {
        ...
        {
            if (Valor_Inpa > 0)
                Valor_Vr = (Valor_Total_Predio * Valor_Inpr) / Valor_Inpa;
            else
                Valor_Vr = 0;
        }
        catch
    ...
    private void Calcular_Precio_Avaluo()
    {
        ...
        Precio_Avaluo = ((Valor_Total_Predio * Convert.ToDouble(Hdf_Factor_Cobro2.Value)) + Convert.ToDouble(Hdf_Base_Cobro.Value));
    ...
    {
        if (!Directory.Exists(Server.MapPath("../Catastro/Archivos_Avaluo_Re/" + Hdf_Anio_Avaluo.Value + "_" + Hdf_No_Avaluo.Value + "/")))
        {
            Directory.CreateDirectory(Server.MapPath("../Catastro/Archivos_Avaluo_Re/" + Hdf_Anio_Avaluo.Value + "_" + Hdf_No_Avaluo.Value + "/"));
        }
        foreach (DataRow Dr_Renglon in Dt_Documentos.Rows)
        {
            if (Dr_Renglon["ACCION"].ToString() == "ALTA")
            {
                ...
                FileStream Escribir_Archivo = new FileStream(Server.MapPath("../Catastro/Archivos_Avaluo_Re/" + Hdf_Anio_Avaluo.Value + "_" + Hdf_No_Avaluo.Value + "/" + Dr_Renglon["RUTA_DOCUMENTO"].ToString()), FileMode.Create, FileAccess.Write);
    ...
    protected void Grid_Solicitudes_SelectedIndexChanged(object sender, EventArgs e)
    {
        if (Grid_Solicitudes.SelectedIndex > -1)
        {
            ...
            if (Grid_Solicitudes.SelectedRow.Cells[2].Text != "&nbsp;" && Grid_Solicitudes.SelectedRow.Cells[2].Text != "")
            {
                ...
                Txt_Motivo.Text = Grid_Solicitudes.SelectedRow.Cells[6].Text;
                Cargar_Datos();
            }
            else
            {
    ...
    ///*******************************************************************************
    ///NOMBRE DE LA FUNCIÓN: Busqueda_Solicitudes_Click
    ///DESCRIPCIÓN: evento del boton de busqueda de solicitudes
    ///PROPIEDADES:     
    ///            
    ///CREO: Miguel Angel Bedolla Moreno
    ///FECHA_CREO: 05/May_2012
    ...
    private void Llenar_Tabla_Solicitudes(int Pagina)
    {
        try
        {
            Cls_Ope_Cat_Avaluo_Urbano_Reg_Negocio Solicitud_Tramite = new Cls_Ope_Cat_Avaluo_Urbano_Reg_Negocio();
            DataTable Dt_Tramites = new DataTable(); ;
    ...
    ///CAUSA_MODIFICACIÓN
    ///*******************************************************************************
    protected void Btn_Autorizar_Click(object sender, ImageClickEventArgs e)
    {
        try
        {
            if (Grid_Avaluos_Urbanos.SelectedIndex > -1)
            {
                ...
                if ((Avaluo.Modificar_Estatus_Avaluo_Urbano_Regularizacion()))
                {
                    if (Chk_Pago_Avaluo.Checked)
                    {
                        Imprimir_Reporte_Folio(Crear_Ds_Avaluo_Urbano_Folio(), "Rpt_Ope_Cat_Folio_Pago_Avaluo_Re.rpt", "Rpt_Folio_Pago_Avaluo_Rustico", "Window_Frm", "Avaluo");
                    }
    ...
    private DataSet Crear_Ds_Avaluo_Urbano_Folio()
    {
        ...
        String Nombre_Perito = Obtener_Dato_Consulta("SELECT " + Ope_Tra_Solicitud.Campo_Nombre_Solicitante + "||' '||" + Ope_Tra_Solicitud.Campo_Apellido_Paterno + "||' '||" + Ope_Tra_Solicitud.Campo_Apellido_Materno + " FROM " + Ope_Tra_Solicitud.Tabla_Ope_Tra_Solicitud + " WHERE " + Ope_Tra_Solicitud.Campo_Solicitud_ID + " = '" + Hdf_Solicitud_Id.Value + "'").ToUpper();
        String E_Mail = Obtener_Dato_Consulta("SELECT " + Ope_Tra_Solicitud.Campo_Correo_Electronico + " FROM " + Ope_Tra_Solicitud.Tabla_Ope_Tra_Solicitud + " WHERE " + Ope_Tra_Solicitud.Campo_Solicitud_ID + " = '" + Hdf_Solicitud_Id.Value + "'");
        ...
        Dr_Renglon_Nuevo["RFC"] = "";
        Dr_Renglon_Nuevo["NUMERO_PERITO"] = 0;
        Dr_Renglon_Nuevo["NUMERO_AVALUO"] = Txt_No_Avaluo.Text;
        Dr_Renglon_Nuevo["PAGO_PRESIDENCIA"] = Convert.ToDouble(Txt_Precio_Avaluo.Text);
        Dr_Renglon_Nuevo["DIRECCION"] = Txt_Ubicacion_Predio.Text + ", " + Txt_Localidad.Text;
        Dr_Renglon_Nuevo["CUENTA_PREDIAL"] = Txt_Cuenta_Predial.Text;
        Dr_Renglon_Nuevo["IMPORTE_AVALUO_LETRAS"] = Cantidad.ToCustomCardinal(Txt_Precio_Avaluo.Text.Replace(",", "")).ToUpper();
        Dr_Renglon_Nuevo["IMPORTE_AVALUO"] = Convert.ToDouble(Txt_Precio_Avaluo.Text);
        Dr_Renglon_Nuevo["FOLIO_PAGO"] = Folio;
    ...
    private void Enviar_Correo_Cuenta(String E_Mail, String Url_Adjunto)
    {
        ...
        try
        {
            if (E_Mail.Trim().Length > 0)
            {
                ...
                mail.P_Subject = "Avalúo Urbano Autorizado: " + Txt_No_Avaluo.Text;
