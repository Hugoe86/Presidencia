<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Frm_Ope_Cat_Autorizacion_Avaluo_Urbano.aspx.cs"
    Inherits="paginas_Catastro_Frm_Ope_Cat_Autorizacion_Avaluo_Urbano" MasterPageFile="~/paginas/Paginas_Generales/MasterPage.master"
    Title="Autorización: Avalúo Urbano" %>
                    ...
                    <table width="98%" border="0" cellspacing="0" class="estilo_fuente">
                        <tr align="center">
                            <td colspan="2" class="label_titulo">
                                Autorización: Aval&uacute;os Urbanos
                            </td>
                        </tr>
                        <tr>
                            <td class="style1">
                        ...
                        <tr class="barra_busqueda" align="right">
                            <td align="left" style="width: 50%">
                                ...
                                <asp:ImageButton ID="Btn_Regimen" runat="server" TabIndex="2" OnClientClick="return confirm('¿Está seguro de pasar el Avalúo Urbano a Revisiones de Régimen en Condominio?');"
                            ...
                            <td align="right" style="width: 50%">
                                Búsqueda:
                                <asp:DropDownList ID="Cmb_Busqueda" runat="server" Width="25%">
                                ...
                                <asp:TextBox ID="Txt_Busqueda" runat="server" Width="25%" TabIndex="6" Style="text-transform: uppercase">
                                </asp:TextBox>
                        ...
                        <tr class="barra_busqueda" align="right">
                            ...
                            <td align="right" style="width: 50%">
                                ...
                                <asp:DropDownList ID="Cmb_Busqueda_Avaluo_Estatus" runat="server" Width="58%" OnSelectedIndexChanged="Cmb_Busqueda_Avaluo_Estatus_SelectedIndexChanged"
                                    AutoPostBack="true">
                            ...
                            <tr>
                                <td>
                                    ...
                                    <div id="Div_Datos_Avaluo" runat="server" visible="false">
                                        <table width="98%" border="0" cellspacing="0" class="estilo_fuente">
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: left; width: 30%;">
                                                    <asp:TextBox ID="Txt_Cuenta_Predial" runat="server" Width="80%" TabIndex="9" Enabled="false"
                                                        Style="text-transform: uppercase">
                                                    </asp:TextBox>
                                                ...
                                                <td style="text-align: left; width: 30%;">
                                                    &nbsp; Reg.<asp:TextBox ID="Txt_Region" runat="server" Width="10%" TabIndex="11"
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: left; width: 30%;">
                                                    <asp:TextBox ID="Txt_Ubicacion_Predio" runat="server" Width="98%" TabIndex="9" Enabled="false"
                                                ...
                                                <td style="text-align: left; width: 30%;">
                                                    <asp:TextBox ID="Txt_Colonia" runat="server" Width="96.4%" TabIndex="11" Enabled="false"
                                                        Style="text-transform: uppercase" />
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td style="text-align: left; width: 30%;">
                                                    <asp:TextBox ID="Txt_Localidad" runat="server" Width="98%" TabIndex="9" Enabled="false"
                                                        Style="text-transform: uppercase"></asp:TextBox>
                                                </td>
                                                <td style="text-align: left; width: 20%; text-align: Left;">
                                                    Municipio
                                                ...
                                                <td style="text-align: left; width: 30%;">
                                                    <asp:TextBox ID="Txt_Municipio" runat="server" Width="96.4%" TabIndex="11" Enabled="false"
                                                        Style="text-transform: uppercase" />
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: left; width: 30%;">
                                                    <asp:TextBox ID="Txt_Solicitante" runat="server" Width="98%" TabIndex="9" Enabled="false"
                                                        Style="text-transform: uppercase"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                            ...
                                                            <asp:TemplateField HeaderStyle-Width="5%" HeaderText="">
                                                                <ItemTemplate>
                                                                    <asp:ImageButton ID="Btn_Valor_Tramo" runat="server" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>"
                                                                        ...
                                                                        TabIndex="10" ToolTip="Seleccionar Valor M2" Width="22px" />
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: left; width: 30%;">
                                                    <asp:TextBox ID="Txt_Inpa" runat="server" Enabled="false" Style="text-transform: uppercase"
                                                        TabIndex="9" Width="98%"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td style="text-align: left; width: 30%;">
                                                    <asp:TextBox ID="Txt_Inpr" runat="server" Enabled="false" Style="text-transform: uppercase"
                                                        TabIndex="9" Width="98%"></asp:TextBox>
                                                </td>
                                                <td style="text-align: left; width: 20%; text-align: left;">
                                                    V.R.
                                    ...
                                    <div id="Div_Observaciones" runat="server" visible="false">
                                                ...
                                                <td colspan="4">
                                                    <asp:GridView ID="Grid_Observaciones" runat="server" AllowPaging="True" AllowSorting="True"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:BoundField DataField="FECHA_CREO" HeaderStyle-Width="10%" HeaderText="Fecha"
                                            ...
                                            <tr>
                                                <td colspan="4">
                                                    <asp:GridView ID="Grid_Observaciones_Corregidas" runat="server" AllowPaging="True"
                                                        AllowSorting="True" AutoGenerateColumns="False" CssClass="GridView_1" EmptyDataText="&quot;No se encontraron registros&quot;"
                                                        HeaderStyle-CssClass="tblHead" OnPageIndexChanging="Grid_Observaciones_Corregidas_PageIndexChanging"
                                        ...
                                        <tr>
                                            <td>
                                                <asp:DropDownList ID="Cmb_Firmante" runat="server" Width="40%" TabIndex="4">
                                                    <asp:ListItem Text="SELECCIONE FIRMANTE" Selected="False"></asp:ListItem>
