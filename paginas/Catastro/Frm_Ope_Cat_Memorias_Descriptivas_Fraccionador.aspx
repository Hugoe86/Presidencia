<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Frm_Ope_Cat_Memorias_Descriptivas_Fraccionador.aspx.cs" 
    MasterPageFile="~/paginas/Paginas_Generales/MasterPage_Peritos_Externos.master" 
    Inherits="paginas_Catastro_Frm_Ope_Cat_Memorias_Descriptivas_Fraccionador" %>
                ...
                <table width="100%" class="estilo_fuente">
                    <tr align="center">
                        <td class="label_titulo">
                            Memorias Descriptivas Fraccionador
                        </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <table width="98%" border="0" cellspacing="0" class="estilo_fuente">
                        ...
                        <td style="text-align: left; width: 20%;">
                            ...
                            <td style="text-align: left; width: 30%;" colspan="3">
                                <asp:TextBox ID="Txt_Ubicacion" runat="server" Width="98%" TabIndex="3"
