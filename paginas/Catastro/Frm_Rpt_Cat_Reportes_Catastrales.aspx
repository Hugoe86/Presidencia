<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Frm_Rpt_Cat_Reportes_Catastrales.aspx.cs" Inherits="paginas_Catastro_Frm_Rpt_Cat_Reportes_Catastrales" MasterPageFile="~/paginas/Paginas_Generales/MasterPage.master" Title="Reportes de Asignación y Modificación"%>
                ...
                <table width="100%" class="estilo_fuente">
                    <tr align="center">
                        <td class="label_titulo">
                           Reportes Asignación/Modificacón de Claves y Cedulas
                        </td>
                    </tr>
                    <tr>
                        <td>
                            ...
                            <table style="width:100%;height:28px;">
                                <tr>
                                    <td align="left" style="width:59%;">
                                        <asp:ImageButton ID="Btn_Exportar_Claves" runat="server" TabIndex="5" ImageUrl="~/paginas/imagenes/gridview/pdf.png"
                                            Width="24px" CssClass="Img_Button" AlternateText="Reporte Asignación/Modificación Claves" 
                                            onclick="Btn_Exportar_Claves_Click" />
                                        <asp:ImageButton ID="Btn_Exportar_Cedulas" runat="server" TabIndex="5" ImageUrl="~/paginas/imagenes/gridview/pdf.png"
                                            Width="24px" CssClass="Img_Button" AlternateText="Reporte Asignación/Modificación Cedulas" 
                                            onclick="Btn_Exportar_Cedulas_Click" />    
