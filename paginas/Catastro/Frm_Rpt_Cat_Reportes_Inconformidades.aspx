<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Frm_Rpt_Cat_Reportes_Inconformidades.aspx.cs" Inherits="paginas_Catastro_Frm_Rpt_Cat_Reportes_Inconformidades" MasterPageFile="~/paginas/Paginas_Generales/MasterPage.master" Title="Reportes de Inconformidades"%>
                            ...
                            <table style="width:100%;height:28px;">
                                <tr>
                                    <td align="left" style="width:59%;">
                                        <asp:ImageButton ID="Btn_Exportar_Inconformidades" runat="server" TabIndex="5" ImageUrl="~/paginas/imagenes/gridview/pdf.png"
                                            Width="24px" CssClass="Img_Button" AlternateText="Reporte Inconformidades" 
                                            onclick="Btn_Exportar_Inconformidades_Click" />
                                        <asp:ImageButton ID="Btn_Exportar_Solicitudes" runat="server" TabIndex="5" ImageUrl="~/paginas/imagenes/gridview/pdf.png"
                                            Width="24px" CssClass="Img_Button" AlternateText="Reporte Solicitudes" 
                                            onclick="Btn_Exportar_Solicitudes_Click" />    
