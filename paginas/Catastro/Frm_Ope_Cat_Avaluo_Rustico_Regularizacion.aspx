<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Frm_Ope_Cat_Avaluo_Rustico_Regularizacion.aspx.cs"
    Inherits="paginas_Catastro_Frm_Ope_Cat_Avaluo_Rustico_Regularizacion" MasterPageFile="~/paginas/Paginas_Generales/MasterPage.master"
    Title="Avalúo Rústico Regularizacion" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Cph_Area_Trabajo1" runat="Server">
    ...
    <asp:UpdatePanel ID="Upd_Otros_Pagos" runat="server">
                ...
                <table width="98%" border="0" cellspacing="0" class="estilo_fuente">
                    <tr align="center">
                        <td colspan="2" class="label_titulo">
                            Avalúos Rústico Regularización
                        </td>
                    </tr>
                    <tr>
                        <td class="style1">
                    ...
                    <tr class="barra_busqueda" align="right">
                        <td align="left">
                            <asp:ImageButton ID="Btn_Autorizar_Avaluo" runat="server" TabIndex="1" OnClientClick="return confirm('¿Está seguro de que desea autorizar el Avaluo?');"
                                ...
                                <div id="Div_Grid_Avaluo" runat="server" visible="true">
                                    <tr style="background-color: #3366CC">
                                        <td style="text-align: left; font-size: 15px; color: #FFFFFF;">
                                            Avalúos Rústicos Regularización
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="center">
                                            <tr align="center">
                                                <td>
                                                    <asp:GridView ID="Grid_Avaluos_Urbanos_Regularizacion" runat="server" AllowPaging="True"
                                                        ...
                                                        OnSelectedIndexChanged="Grid_Avaluos_Urbanos_Regularizacion_SelectedIndexChanged"
                                                        OnPageIndexChanging="Grid_Avaluos_Urbanos_Regularizacion_PageIndexChanging">
                                                        <Columns>
                                                            ...
                                                            <asp:BoundField DataField="VECES_RECHAZO" HeaderText="Veces Rechazado" Visible="false">
                                    ...
                                    <table width="98%" border="0" cellspacing="0" class="estilo_fuente">
                                        ...
                                        <td style="text-align: left; width: 20%;">
                                         ...
                                         <td style="text-align: left; width: 30%;">
                                                <asp:TextBox ID="Txt_Clave_Tramite" runat="server" Width="85%"  Enabled="false"
                                                ...
                                                <asp:ImageButton ID="Btn_Mostrar_Busqueda_Avanzada_Solicitudes" runat="server" Height="24px"
                                                    ImageUrl="~/paginas/imagenes/paginas/Busqueda_00001.png" TabIndex="9" ToolTip="Búsqueda Avanzada Solicitudes"
                                            ...
                                            <td style="text-align: left; width: 20%;">
                                                <asp:TextBox ID="Txt_Motivo_Regularizacion" runat="server" Width="97%"  Enabled="false"
                                            ...
                                            <td style="text-align: left; width: 30%;">
                                                <asp:TextBox ID="Txt_No_Avaluo" runat="server" Width="98%"  Enabled="false"
                                                    Style="text-transform: uppercase" />
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td style="text-align: left; width: 30%;">
                                                <asp:TextBox ID="Txt_Cuenta_Predial" runat="server" Width="98%"  Enabled="false"
                                                    Style="text-transform: uppercase" OnTextChanged="Txt_Cuenta_Predial_TextChanged"
                                                    AutoPostBack="true"></asp:TextBox>
                                               <%-- <asp:ImageButton ID="Btn_Mostrar_Busqueda_Avanzada_Cuentas_Predial" runat="server" visble="false"
                                ...
                                <td style="width: 30%; text-align: left;">
                                   ...
                                   <asp:ImageButton ID="Btn_Mostrar_Busqueda_Avanzada_Recepcion_Oficios" runat="server"
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: left; width: 30%;">
                                                <asp:TextBox ID="Txt_Propietario" runat="server" Width="98%"  Enabled="false"
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: left; width: 30%;">
                                                <asp:TextBox ID="Txt_Domicilio_Not" runat="server" Width="98%"  Enabled="false"
                                                    Style="text-transform: uppercase"></asp:TextBox>
                                            </td>
                                            <td style="text-align: left; width: 20%; text-align: Left;">
                                                *Municipio
                                            ...
                                            <td style="text-align: left; width: 30%;">
                                                <asp:TextBox ID="Txt_Municipio_Notificar" runat="server" Width="96.4%" 
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: left; width: 30%;">
                                                <asp:TextBox ID="Txt_Localidad" runat="server" Width="98%"  Enabled="false"
                                                    Style="text-transform: uppercase"></asp:TextBox>
                                            </td>
                                            <td style="text-align: left; width: 20%; text-align: Left;">
                                                *Fecha
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: left; width: 30%;">
                                                <asp:TextBox ID="Txt_Solicitante" runat="server" Width="98%" TabIndex="10" Enabled="false"
                                                    Style="text-transform: uppercase"></asp:TextBox>
                                            </td>
                                            <td style="text-align: left; width: 20%;">
                                                *Nombre del Predio
                                            ...
                                            <td style="text-align: left; width: 30%;">
                                                <asp:TextBox ID="Txt_Nombre_Predio" runat="server" Width="98%" TabIndex="11" Enabled="false"
                                                    Style="text-transform: uppercase"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td style="text-align: left; width: 80%;" colspan="3">
                                                <asp:TextBox ID="Txt_Uso_Constru" runat="server" Enabled="false" TextMode="MultiLine" TabIndex="12"
                                                    Rows="3" Width="99%" Style="text-transform: uppercase"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: left; width: 30%;">
                                                <asp:DropDownList ID="Cmb_Coordenadas" runat="server" Width="96.4%" TabIndex="13"
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: left; width: 30%;">
                                                    <asp:TextBox ID="Txt_X_Horas" runat="server" Width="96.4%" Style="text-transform: uppercase"
                                                        Enabled="false" MaxLength="3" TabIndex="14" />
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: left; width: 30%;">
                                                    <asp:TextBox ID="Txt_X_Segundos" Enabled="false" runat="server" Width="96.4%" Style="text-transform: uppercase"
                                                        MaxLength="6" TabIndex="16" OnTextChanged="Txt_X_Segundos_TextChanged" AutoPostBack="true" />
                                                ...
                                                <td style="text-align: left; width: 30%;">
                                                    <asp:DropDownList ID="Cmb_Latitud" runat="server" Width="96.4%" TabIndex="17" Enabled="false">
                                                        <asp:ListItem Text="<SELECCIONE>" Value="SELECCIONE"></asp:ListItem>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: left; width: 30%;">
                                                    <asp:TextBox ID="Txt_Y_Segundos" runat="server" Width="96.4%" Style="text-transform: uppercase"
                                                        MaxLength="6" TabIndex="20" OnTextChanged="Txt_Y_Segundos_TextChanged" AutoPostBack="true" />
                                                ...
                                                <td style="text-align: left; width: 30%;">
                                                    <asp:DropDownList ID="Cmb_Longitud" runat="server" Width="96.4%" TabIndex="21" Enabled="false">
                                                        <asp:ListItem Text="<SELECCIONE>" Value="SELECCIONE"></asp:ListItem>
                                        ...
                                        <div id="Div_UTM" runat="server" visible="false" style="width: 98%;">
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: left; width: 30%;">
                                                    <asp:TextBox ID="Txt_Coordenadas_UTM" Enabled="false" runat="server" Width="96.4%" TabIndex="22" />
                                                </td>
                                                <td style="text-align: left; width: 20%;">
                                                    Coordenadas Y
                                                </td>
                                                <td style="text-align: left; width: 30%;">
                                                    <asp:TextBox ID="Txt_Coordenadas_UTM_Y" Enabled="false" runat="server" Width="96.4%" TabIndex="23" />
                                                </td>
                                            </tr>
                                        </div>
                                        <tr style="background-color: #3366CC">
                                                ...
                                                <asp:GridView ID="Grid_Elementos_Construccion" runat="server" AllowPaging="False"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="A">
                                                            ...
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="Txt_A" runat="server" CssClass="text_cantidades_grid" Font-Size="X-Small" TabIndex="24"
                                                                    name="<%=Txt_A.ClientID %>" Style="text-transform: uppercase" Width="90%"></asp:TextBox>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="B">
                                                            ...
                                                            <ItemStyle HorizontalAlign="Center" Width="9%" />
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="Txt_B" runat="server" CssClass="text_cantidades_grid" Font-Size="X-Small" TabIndex="25"
                                                                    name="<%=Txt_B.ClientID %>" Style="text-transform: uppercase" Width="90%"></asp:TextBox>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="C">
                                                            ...
                                                            <ItemStyle HorizontalAlign="Center" Width="9%" />
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="Txt_C" runat="server" CssClass="text_cantidades_grid" Font-Size="X-Small" TabIndex="26"
                                                                    name="<%=Txt_C.ClientID %>" Style="text-transform: uppercase" Width="90%"></asp:TextBox>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="D">
                                                            ...
                                                            <ItemStyle HorizontalAlign="Center" Width="9%" />
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="Txt_D" runat="server" CssClass="text_cantidades_grid" Font-Size="X-Small" TabIndex="27"
                                                                    name="<%=Txt_D.ClientID %>" Style="text-transform: uppercase" Width="90%"></asp:TextBox>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="E">
                                                            ...
                                                            <ItemStyle HorizontalAlign="Center" Width="9%" />
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="Txt_E" runat="server" CssClass="text_cantidades_grid" Font-Size="X-Small" TabIndex="28"
                                                                    name="<%=Txt_E.ClientID %>" Style="text-transform: uppercase" Width="90%"></asp:TextBox>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="F">
                                                            ...
                                                            <ItemStyle HorizontalAlign="Center" Width="9%" />
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="Txt_F" runat="server" CssClass="text_cantidades_grid" Font-Size="X-Small" TabIndex="29"
                                                                    name="<%=Txt_F.ClientID %>" Style="text-transform: uppercase" Width="90%"></asp:TextBox>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="G">
                                                            ...
                                                            <ItemStyle HorizontalAlign="Center" Width="9%" />
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="Txt_G" runat="server" CssClass="text_cantidades_grid" Font-Size="X-Small" TabIndex="30"
                                                                    name="<%=Txt_G.ClientID %>" Style="text-transform: uppercase" Width="90%"></asp:TextBox>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="H">
                                                            ...
                                                            <ItemStyle HorizontalAlign="Center" Width="9%" />
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="Txt_H" runat="server" CssClass="text_cantidades_grid" Font-Size="X-Small" TabIndex="31"
                                                                    name="<%=Txt_H.ClientID %>" Style="text-transform: uppercase" Width="90%"></asp:TextBox>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="I">
                                                            ...
                                                            <ItemStyle HorizontalAlign="Center" Width="9%" />
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="Txt_I" runat="server" CssClass="text_cantidades_grid" Font-Size="X-Small" TabIndex="32"
                                                                    name="<%=Txt_I.ClientID %>" Style="text-transform: uppercase" Width="90%"></asp:TextBox>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="J">
                                                            ...
                                                            <ItemStyle HorizontalAlign="Center" Width="9%" />
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="Txt_J" runat="server" CssClass="text_cantidades_grid" Font-Size="X-Small" TabIndex="33"
                                                                    name="<%=Txt_J.ClientID %>" Style="text-transform: uppercase" Width="90%"></asp:TextBox>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="K">
                                                            ...
                                                            <ItemStyle HorizontalAlign="Center" Width="9%" />
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="Txt_K" runat="server" CssClass="text_cantidades_grid" Font-Size="X-Small" TabIndex="34"
                                                                    name="<%=Txt_K.ClientID %>" Style="text-transform: uppercase" Width="90%"></asp:TextBox>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="L">
                                                            ...
                                                            <ItemStyle HorizontalAlign="Center" Width="9%" />
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="Txt_L" runat="server" CssClass="text_cantidades_grid" Font-Size="X-Small" TabIndex="35"
                                                                    name="<%=Txt_L.ClientID %>" Style="text-transform: uppercase" Width="90%"></asp:TextBox>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="M">
                                                            ...
                                                            <ItemStyle HorizontalAlign="Center" Width="9%" />
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="Txt_M" runat="server" CssClass="text_cantidades_grid" Font-Size="X-Small" TabIndex="36"
                                                                    name="<%=Txt_M.ClientID %>" Style="text-transform: uppercase" Width="90%"></asp:TextBox>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="N">
                                                            ...
                                                            <ItemStyle HorizontalAlign="Center" Width="9%" />
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="Txt_N" runat="server" CssClass="text_cantidades_grid" Font-Size="X-Small" TabIndex="37"
                                                                    name="<%=Txt_N.ClientID %>" Style="text-transform: uppercase" Width="90%"></asp:TextBox>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="O">
                                                            ...
                                                            <ItemStyle HorizontalAlign="Center" Width="9%" />
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="Txt_O" runat="server" CssClass="text_cantidades_grid" Font-Size="X-Small" TabIndex="38"
                                                                    name="<%=Txt_O.ClientID %>" Style="text-transform: uppercase" Width="90%"></asp:TextBox>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                    </Columns>
                                                    <SelectedRowStyle CssClass="GridSelected" />
                                                ...
                                                <asp:GridView ID="Grid_Descripcion_Terreno" runat="server" AllowPaging="False" AllowSorting="True"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField>
                                                            ...
                                                            <ItemTemplate>
                                                                <asp:CheckBox ID="Chk_Indicador_Valor_A" runat="server" CssClass="text_cantidades_grid" TabIndex="39"
                                                        ...
                                                        <asp:TemplateField>
                                                            ...
                                                            <ItemStyle HorizontalAlign="Center" Width="5%" />
                                                            <ItemTemplate>
                                                                <asp:CheckBox ID="Chk_Indicador_Valor_B" runat="server" CssClass="text_cantidades_grid" TabIndex="40"
                                                        ...
                                                        <asp:TemplateField>
                                                            ...
                                                            <ItemStyle HorizontalAlign="Center" Width="5%" />
                                                            <ItemTemplate>
                                                                <asp:CheckBox ID="Chk_Indicador_Valor_C" runat="server" CssClass="text_cantidades_grid" TabIndex="41"
                                                        ...
                                                        <asp:TemplateField>
                                                            ...
                                                            <ItemStyle HorizontalAlign="Center" Width="5%" />
                                                            <ItemTemplate>
                                                                <asp:CheckBox ID="Chk_Indicador_Valor_D" runat="server" CssClass="text_cantidades_grid" TabIndex="42"
                                                ...
                                                <asp:GridView ID="Grid_Calculos" runat="server" AllowPaging="False" AllowSorting="True"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="SUPERFICIE EN Ha.">
                                                            ...
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="Txt_Superficie_M2" runat="server" AutoPostBack="true" CssClass="text_cantidades_grid" TabIndex="43"
                                                        ...
                                                        <asp:TemplateField HeaderText="VALOR POR Ha.">
                                                            ...
                                                            <ItemStyle HorizontalAlign="right" Width="15%" />
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="Txt_Valor_M2" runat="server" CssClass="text_cantidades_grid" Enabled="false" TabIndex="43"
                                                        ...
                                                        <asp:TemplateField HeaderText="Factor">
                                                            ...
                                                            <ItemStyle HorizontalAlign="right" Width="15%" />
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="Txt_Factor" runat="server" AutoPostBack="true" CssClass="text_cantidades_grid" TabIndex="43"
                                                        ...
                                                        <asp:TemplateField HeaderText="">
                                                            ...
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="Txt_Total" runat="server" CssClass="text_cantidades_grid" Enabled="false" TabIndex="43"
                                                ...
                                                <asp:GridView ID="Grid_Valores_Construccion" runat="server" AllowPaging="False" AllowSorting="True"
                                                    ...
                                                    <Columns>
                                                        <asp:TemplateField HeaderText="CROQUIS">
                                                            ...
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="Txt_Croquis" runat="server" Style="text-transform: uppercase" Font-Size="X-Small" TabIndex="44"
                                                        ...
                                                        <asp:TemplateField HeaderText="TIPO">
                                                            ...
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="Txt_Tipo" runat="server" AutoPostBack="true" CssClass="text_cantidades_grid" TabIndex="44"
                                                        ...
                                                        <asp:TemplateField HeaderText="EDO.">
                                                            ...
                                                            <ItemStyle HorizontalAlign="right" Width="5%" />
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="Txt_Con_Serv" runat="server" AutoPostBack="true" CssClass="text_cantidades_grid" TabIndex="44"
                                                        ...
                                                        <asp:TemplateField HeaderText="Superficie M2">
                                                            ...
                                                            <ItemStyle HorizontalAlign="right" Width="15%" />
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="Txt_Superficie_M2" runat="server" AutoPostBack="true" CssClass="text_cantidades_grid" TabIndex="44"
                                                        ...
                                                        <asp:TemplateField HeaderText="Valor X M2">
                                                            ...
                                                            <ItemStyle HorizontalAlign="right" Width="15%" />
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="Txt_Valor_X_M2" runat="server" CssClass="text_cantidades_grid" Enabled="false" TabIndex="44"
                                                        ...
                                                        <asp:TemplateField HeaderText="Valor Construccion Id" Visible="false">
                                                            ...
                                                            <ItemStyle HorizontalAlign="right" Width="15%" />
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="Txt_Valor_Construccion_Id" runat="server" CssClass="text_cantidades_grid" TabIndex="44"
                                                        ...
                                                        <asp:TemplateField HeaderText="Valor Parcial">
                                                            ...
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="Txt_Total" runat="server" CssClass="text_cantidades_grid" Enabled="false" TabIndex="44"
                                                        ...
                                                        <asp:TemplateField HeaderText="EDAD">
                                                            ...
                                                            <ItemStyle HorizontalAlign="right" Width="10%" />
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="Txt_Edad" runat="server" AutoPostBack="true" CssClass="text_cantidades_grid" TabIndex="44"
                                                        ...
                                                        <asp:TemplateField HeaderText="Factor">
                                                            ...
                                                            <ItemStyle HorizontalAlign="right" Width="10%" />
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="Txt_Factor" runat="server" AutoPostBack="true" CssClass="text_cantidades_grid" TabIndex="44"
                                                        ...
                                                        <asp:TemplateField HeaderText="USO">
                                                            ...
                                                            <ItemStyle HorizontalAlign="right" Width="10%" />
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="Txt_Uso" runat="server" CssClass="text_cantidades_grid" Font-Size="X-Small" TabIndex="44"
                                        ...
                                        <tr id="Tr1" runat="server">
                                            ...
                                            <td colspan="3" style="width: 80%">
                                                <asp:TextBox ID="Txt_Medida_Colindancia" Style="text-transform: uppercase" runat="server" TabIndex="45"
                                        ...
                                        <tr id="Tr_Fila_Fotografias_Bien" runat="server">
                                            ...
                                            <td style="text-align: left; width: 30%" class="style1">
                                                <asp:DropDownList ID="Cmb_Documento" runat="server" Width="98%" TabIndex="47">
                                            ...
                                            <td style="width: 30%" class="style2">
                                                <asp:FileUpload ID="Fup_Documento" runat="server" Width="98%" TabIndex="48" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="3" style="width: 98%; text-align: left;">
                                                <asp:TextBox ID="Txt_Observaciones" runat="server" Rows="3" Style="float: left; text-transform: uppercase"
                                                    TextMode="MultiLine" Width="96.4%" TabIndex="50" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:CheckBox ID="Chk_Pago_Avaluo" runat="server" Font-Size="X-Small" Width="98%" TabIndex="51" />
                                            </td>
                                            <td style="text-align: left; width: 20%">
                                                Importe del Avalúo
                                            </td>
      ...
      <cc1:ModalPopupExtender ID="Mpe_Busqueda_Oficios" runat="server" TargetControlID="Btn_Comodin_Open_Busqueda_Oficios"
        PopupControlID="Pnl_Busqueda_Contenedor_Oficios" BackgroundCssClass="popUpStyle" BehaviorID="Busqueda_Oficios"
    ...
    <asp:Button ID="Btn_Comodin_Open_Busqueda_Solicitudes" runat="server" Style="background-color: transparent;
        border-style: none; display: none;" Text="" />
    <%--Ventana modal de búsqueda de Solicitudes--%>
                                            ...
                                            <asp:GridView ID="Grid_Solicitudes" runat="server" AllowPaging="True" AllowSorting="True"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="CUENTA_PREDIAL" HeaderText="Cuenta Predial">
                                                     ...
                                                     <asp:BoundField DataField="MOTIVO_REGULARIZACION" HeaderText="Motivo Regularizacion">
                                                        <HeaderStyle HorizontalAlign="Left" Width="20%" />
                                                        <ItemStyle HorizontalAlign="Left" Width="20%" />
                                                    </asp:BoundField>
                                                </Columns>
