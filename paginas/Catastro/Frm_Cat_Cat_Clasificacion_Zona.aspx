<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Frm_Cat_Cat_Clasificacion_Zona.aspx.cs" MasterPageFile="~/paginas/Paginas_Generales/MasterPage.master" Inherits="paginas_Catastro_Frm_Cat_Cat_Clasificacion_Zona" Title="Catálogo de Clasificacion de Zona"%>
                ...
                <table width="100%" class="estilo_fuente">
                    <tr align="center">
                        <td class="label_titulo">
                           Catálogo de Clasificación de Zona
                        </td>
                    </tr>
                    <tr>
                        <td>
                ...
                <table width="98%" class="estilo_fuente">
                    <tr>
                        ...
                        <td style="width:30%; text-align:left;">
                            <asp:TextBox  runat="server" ID="Txt_Clasificacion_Zona"  Width="98%" TabIndex="6"
                    ...
                    <tr>
                    <td>
                    <asp:HiddenField ID="Hdf_Clasificacion_Zona_Id" runat="server" />
                    </td>
                    </tr>
                    <tr>
                    <td colspan="4">
                    ...
                    <tr>
                        <td style="text-align:left;">
                            <asp:GridView ID="Grid_Clasificacion_Zona" runat="server" AllowSorting="true"
                                AutoGenerateColumns="False" CssClass="GridView_1" 
                                HeaderStyle-CssClass="tblHead" style="white-space:normal;" Width="100%" 
                                onpageindexchanging="Grid_Clasificacion_Zona_PageIndexChanging" 
                                onselectedindexchanged="Grid_Clasificacion_Zona_SelectedIndexChanged" PageSize="10" AllowPaging="true">
                                <Columns>
                                    <asp:ButtonField ButtonType="Image" CommandName="Select" 
                                        ImageUrl="~/paginas/imagenes/paginas/Select_Grid_Inner.png" Text="Button">
                                        <HeaderStyle Width="5%" />
                                    </asp:ButtonField>
                                    <asp:BoundField DataField="CLASIFICACION_ZONA_ID" HeaderText="Id" Visible="false">
                                        <ItemStyle HorizontalAlign="Center" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="CLASIFICACION_ZONA" HeaderText="Clasificación de Zona">
