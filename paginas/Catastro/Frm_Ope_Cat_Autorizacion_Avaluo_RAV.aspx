<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Frm_Ope_Cat_Autorizacion_Avaluo_RAV.aspx.cs" Inherits="paginas_Catastro_Frm_Ope_Cat_Autorizacion_Avaluo_RAV" 
MasterPageFile="~/paginas/Paginas_Generales/MasterPage.master" Title="Autorización: Avalúo Rústico Actualización de  Valor" %>
                ...
                <table width="98%" border="0" cellspacing="0" class="estilo_fuente">
                    <tr align="center">
                        <td colspan="4" class="label_titulo">
                           Autorización de Aval&uacute;os Rústicos
                        </td>
                    </tr>
                    <tr>
                        <td class="style1">
                                    ...
                                    <table width="98%" border="0" cellspacing="0" class="estilo_fuente">
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align:left;width:30%;">
                                                <asp:DropDownList ID="Cmb_Motivo_Avaluo" runat="server" Enabled="false" 
                                                    TabIndex="7" Width="98%">
                                                </asp:DropDownList>
                                            </td>
                                            ...
                                            <td style="text-align:left;width:30%;">
                                                <asp:TextBox ID="Txt_No_Avaluo" runat="server" Enabled="false" 
                                        ...
                                        <tr>
                                            <td style="text-align:left;width:20%;">
                                                *Cuenta Predial</td>
                                            <td style="text-align:left;width:30%;">
                                                <asp:TextBox ID="Txt_Cuenta_Predial" runat="server" Enabled="false" 
                                                    style="text-transform:uppercase" TabIndex="8" Width="83%">
                            </asp:TextBox>
                                            ...
                                            <td style="text-align:left;width:20%;text-align:Left;">
                                                Clave Catastral</td>
                                            <td style="text-align:left;width:30%;">
                                                <asp:TextBox ID="Txt_Clave_Catastral" runat="server" Enable="false" 
                                                    Enabled="false" MaxLength="20" style="text-transform:uppercase" TabIndex="9" 
                                                    Width="50%" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="text-align:left;width:20%;">
                                                *Propietario</td>
                                            <td style="text-align:left;width:30%;">
                                                <asp:TextBox ID="Txt_Propietario" runat="server" Enabled="false" 
                                                    style="text-transform:uppercase" TabIndex="16" Width="98%"></asp:TextBox>
                                            </td>
                                            <td style="text-align:Left;width:20%;">
                                                *Estatus</td>
                                            <td style="text-align:left;width:30%;">
                                                <asp:DropDownList ID="Cmb_Estatus" runat="server" TabIndex="17" width="98%">
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="3" style="text-align:left;width:30%;">
                                                <asp:TextBox ID="Txt_Domicilio_Not" runat="server" Enabled="false" 
                                                    style="text-transform:uppercase" TabIndex="18" Width="98%"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="text-align:left;width:20%;text-align:Left;">
                                                *Municipio</td>
                                            <td style="text-align:left;width:30%;">
                                                <asp:TextBox ID="Txt_Municipio_Notificar" runat="server" Enabled="false" 
                                                    MaxLength="100" style="text-transform:uppercase" TabIndex="19" Width="96.4%" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="text-align:left;width:20%;">
                                            ...
                                            <td colspan="3" style="text-align:left;width:30%;">
                                                <asp:TextBox ID="Txt_Ubicacion_Predio" runat="server" Enabled="false" 
                                                    style="text-transform:uppercase" TabIndex="12" Width="98%"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="text-align:left;width:20%;">
                                            ...
                                            <td style="text-align:left;width:30%;">
                                                <asp:TextBox ID="Txt_Localidad" runat="server" Enabled="false" 
                                                    style="text-transform:uppercase" TabIndex="14" Width="98%"></asp:TextBox>
                                            </td>
                                            <td style="text-align:left;width:20%;text-align:Left;">
                                                *Fecha</td>
                                            <td style="text-align:left;width:30%;">
                                                <asp:TextBox ID="Txt_Fecha" runat="server" Enabled="false" 
                                                    style="text-transform:uppercase" TabIndex="15" Width="96.4%" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="text-align:left;width:20%;">
                                            ...
                                            <td style="text-align:left;width:30%;">
                                                <asp:TextBox ID="Txt_Solicitante" runat="server" Enabled="false" 
                                                    style="text-transform:uppercase" TabIndex="22" Width="98%"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="3" style="text-align: left; width: 80%;">
                                                <asp:TextBox ID="Txt_Uso_Constru" runat="server" Enabled="false" Rows="3" 
                                                    style="text-transform:uppercase" TextMode="MultiLine" Width="99%"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr style="background-color: #3366CC">
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align:left;width:30%;">
                                                <asp:DropDownList ID="Cmb_Coordenadas" runat="server" AutoPostBack="true" 
                                                    Enabled="false" OnSelectedIndexChanged="Cmb_Coordenadas_SelectedIndexChanged" 
                                                    TabIndex="10" Width="96.4%">
                                        ...
                                        <div ID="Div_Cartograficas" runat="server" style="width:98%;" visible="false">
                                            <tr style="background-color: #3366CC">
                                                <td colspan="4" style="text-align:left; font-size:15px; color:#FFFFFF;">
                                                    Coordenadas X
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: left;width:30% ;">
                                                    <asp:TextBox ID="Txt_X_Horas" runat="server" Enabled="false" MaxLength="3" 
                                                        style="text-transform:uppercase" TabIndex="7" Width="96.4%" />
                                                    <cc1:FilteredTextBoxExtender ID="Ftbe_Txt_X_Horas" runat="server" 
                                                        FilterType="Numbers" TargetControlID="Txt_X_Horas">
                                                ...
                                                <td style="text-align:left;width:30%;">
                                                    <asp:TextBox ID="Txt_X_Minutos" runat="server" Enabled="false" MaxLength="3" 
                                                        style="text-transform:uppercase" TabIndex="8" Width="96.4%" />
                                                    <cc1:FilteredTextBoxExtender ID="Ftbe_Txt_X_Minutos" runat="server" 
                                                        FilterType="Numbers" TargetControlID="Txt_X_Minutos">
                                                    </cc1:FilteredTextBoxExtender>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td style="text-align:left;width:30%;">
                                                    <asp:TextBox ID="Txt_X_Segundos" runat="server" AutoPostBack="true" 
                                                        Enabled="false" MaxLength="6" OnTextChanged="Txt_X_Segundos_TextChanged" 
                                                        style="text-transform:uppercase" TabIndex="9" Width="96.4%" />
                                                    <cc1:FilteredTextBoxExtender ID="Ftbe_Txt_X_Segundos" runat="server" 
                                                        FilterType="Numbers, Custom" TargetControlID="Txt_X_Segundos" 
                                                ...
                                                <td style="text-align:left;width:30%;">
                                                    <asp:DropDownList ID="Cmb_Latitud" runat="server" Enabled="false" TabIndex="10" 
                                                        Width="96.4%">
                                                        <asp:ListItem Text="&lt;SELECCIONE&gt;" Value="SELECCIONE"></asp:ListItem>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: left;width:30%;">
                                                    <asp:TextBox ID="Txt_Y_Horas" runat="server" Enabled="false" MaxLength="3" 
                                                        style="text-transform:uppercase" TabIndex="10" Width="96.4%" />
                                                    <cc1:FilteredTextBoxExtender ID="Ftbe_Txt_Y_Horas" runat="server" 
                                                        FilterType="Numbers" TargetControlID="Txt_Y_Horas">
                                                    </cc1:FilteredTextBoxExtender>
                                                </td>
                                                <td style="text-align:left;width:20%;">
                                                    Minutos (&#39;)
                                                ...
                                                <td style="text-align:left;width:30%;">
                                                    <asp:TextBox ID="Txt_Y_Minutos" runat="server" Enabled="false" MaxLength="3" 
                                                        style="text-transform:uppercase" TabIndex="11" Width="96.4%" />
                                                    <cc1:FilteredTextBoxExtender ID="Ftbe_Txt_Y_Minutos" runat="server" 
                                                        FilterType="Numbers" TargetControlID="Txt_Y_Minutos">
                                                    </cc1:FilteredTextBoxExtender>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td style="text-align:left;width:30%;">
                                                    <asp:TextBox ID="Txt_Y_Segundos" runat="server" AutoPostBack="true" 
                                                        MaxLength="6" OnTextChanged="Txt_Y_Segundos_TextChanged" 
                                                        style="text-transform:uppercase" TabIndex="12" Width="96.4%" />
                                                    <cc1:FilteredTextBoxExtender ID="Ftbe_Txt_Y_Segundos" runat="server" 
                                                        FilterType="Numbers, Custom" TargetControlID="Txt_Y_Segundos" 
                                                        ValidChars="0123456789.">
                                                    </cc1:FilteredTextBoxExtender>
                                                </td>
                                                <td style="text-align:left;width:20%;">
                                                ...
                                                <td style="text-align:left;width:30%;">
                                                    <asp:DropDownList ID="Cmb_Longitud" runat="server" Enabled="false" 
                                                        TabIndex="13" Width="96.4%">
                                                        <asp:ListItem Text="&lt;SELECCIONE&gt;" Value="SELECCIONE"></asp:ListItem>
                                        ...
                                        <div ID="Div_UTM" runat="server" style="width:98%;" visible="false">
                                            <tr style="background-color: #3366CC">
                                                <td colspan="4" style="text-align:left; font-size:15px; color:#FFFFFF;">
                                                    Coordenadas UTM
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align:left;width:30%;">
                                                    <asp:TextBox ID="Txt_Coordenadas_UTM" runat="server" Enabled="false" 
                                                        Width="96.4%" />
                                                </td>
                                                <td style="text-align:left;width:20%;">
                                                    Coordenadas Y
                                                ...
                                                <td style="text-align:left;width:30%;">
                                                    <asp:TextBox ID="Txt_Coordenadas_UTM_Y" runat="server" Enabled="false" 
                                                        Width="96.4%" />
                                                </td>
                                            </tr>
                                        </div>
                                        ...
                                        <tr>
                                            <td colspan="4">
                                                <asp:GridView ID="Grid_Descripcion_Terreno" runat="server" AllowPaging="False" 
                                                    ...
                                                    <Columns>
                                                        <asp:BoundField DataField="DESC_CONSTRU_RUSTICO_ID" HeaderStyle-Width="10%" 
                                                            HeaderText="Id" Visible="false">
                                                        ...
                                                        <asp:BoundField DataField="DESCRIPCION_RUSTICO_ID1" HeaderStyle-Width="10%" 
                                                            HeaderText="Id_Detalles" Visible="false">
                                                            <HeaderStyle HorizontalAlign="Left" Width="10%" />
                                                            <ItemStyle HorizontalAlign="Left" Width="10%" />
                                                        </asp:BoundField>
                                                        ...
                                                        <asp:TemplateField>
                                                            ...
                                                            <ItemTemplate>
                                                                <asp:CheckBox ID="Chk_Indicador_Valor_A" runat="server" AutoPostBack="true" 
                                                                    CssClass="text_cantidades_grid" Font-Size="X-Small" 
                                                                    name="<%=Chk_Indicador_Valor_A.ClientID %>" 
                                                                    OnCheckedChanged="Chk_Indicador_Valor_CheckedChanged" />
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:BoundField DataField="DESCRIPCION_RUSTICO_ID2" HeaderStyle-Width="10%" 
                                                            HeaderText="Id_Detalles" Visible="false">
                                                            <HeaderStyle HorizontalAlign="Left" Width="10%" />
                                                            <ItemStyle HorizontalAlign="Left" Width="10%" />
                                                        </asp:BoundField>
                                                        ...
                                                        <asp:TemplateField>
                                                            ...
                                                            <ItemStyle HorizontalAlign="Center" Width="5%" />
                                                            <ItemTemplate>
                                                                <asp:CheckBox ID="Chk_Indicador_Valor_B" runat="server" AutoPostBack="true" 
                                                                    CssClass="text_cantidades_grid" Font-Size="X-Small" 
                                                                    name="<%=Chk_Indicador_Valor_B.ClientID %>" 
                                                                    OnCheckedChanged="Chk_Indicador_Valor_CheckedChanged" />
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:BoundField DataField="DESCRIPCION_RUSTICO_ID3" HeaderStyle-Width="10%" 
                                                            HeaderText="Id_Detalles" Visible="false">
                                                            <HeaderStyle HorizontalAlign="Left" Width="10%" />
                                                            <ItemStyle HorizontalAlign="Left" Width="10%" />
                                                        </asp:BoundField>
                                                        ...
                                                        <asp:TemplateField>
                                                            ...
                                                            <ItemStyle HorizontalAlign="Center" Width="5%" />
                                                            <ItemTemplate>
                                                                <asp:CheckBox ID="Chk_Indicador_Valor_C" runat="server" AutoPostBack="true" 
                                                                    CssClass="text_cantidades_grid" Font-Size="X-Small" 
                                                                    name="<%=Chk_Indicador_Valor_C.ClientID %>" 
                                                                    OnCheckedChanged="Chk_Indicador_Valor_CheckedChanged" />
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:BoundField DataField="DESCRIPCION_RUSTICO_ID4" HeaderStyle-Width="10%" 
                                                            HeaderText="Id_Detalles" Visible="false">
                                                            <HeaderStyle HorizontalAlign="Left" Width="10%" />
                                                            <ItemStyle HorizontalAlign="Left" Width="10%" />
                                                        </asp:BoundField>
                                                        ...
                                                        <asp:TemplateField>
                                                            ...
                                                            <ItemStyle HorizontalAlign="Center" Width="5%" />
                                                            <ItemTemplate>
                                                                <asp:CheckBox ID="Chk_Indicador_Valor_D" runat="server" AutoPostBack="true" 
                                                                    CssClass="text_cantidades_grid" Font-Size="X-Small" 
                                                                    name="<%=Chk_Indicador_Valor_D.ClientID %>" 
                                                                    OnCheckedChanged="Chk_Indicador_Valor_CheckedChanged" />
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                    </Columns>
                                        ...
                                        <tr>
                                            <td colspan="4">
                                                <asp:GridView ID="Grid_Calculos" runat="server" AllowPaging="False" 
                                                    ...
                                                    Style="white-space: normal;" Width="100%">
                                                    <Columns>
                                                        <asp:BoundField DataField="TIPO_CONSTRU_RUSTICO_ID" HeaderStyle-Width="5%" 
                                                            HeaderText="Id_Construccion" Visible="false">
                                                            <HeaderStyle HorizontalAlign="Left" Width="0%" />
                                                            <ItemStyle HorizontalAlign="Left" Width="0%" />
                                                        </asp:BoundField>
                                                        <asp:BoundField DataField="IDENTIFICADOR" HeaderStyle-Width="5%" 
                                                        ...
                                                        <asp:BoundField DataField="VALOR_CONSTRU_RUSTICO_ID" HeaderStyle-Width="5%" 
                                                            HeaderText="Id_Valor" Visible="false">
                                                            <HeaderStyle HorizontalAlign="Left" Width="0%" />
                                                            <ItemStyle HorizontalAlign="Left" Width="0%" />
                                                        </asp:BoundField>
                                                ...
                                                <asp:GridView ID="Grid_Valores_Construccion" runat="server" AllowPaging="False" 
                                                    ...
                                                    <Columns>
                                                        <asp:TemplateField HeaderText="REFERENCIA">
                                                            ...
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="Txt_Croquis" runat="server" Font-Size="X-Small" 
                                                                    name="<%=Txt_Croquis.ClientID %>" style="text-transform:uppercase" Width="97%"></asp:TextBox>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        ...
                                                        <asp:TemplateField HeaderText="EDAD">
                                                            ...
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="Txt_Edad" runat="server" Font-Size="X-Small" 
                                                                    name="<%=Txt_Edad.ClientID %>" style="text-transform:uppercase" Width="98%"></asp:TextBox>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Factor">
                                                            <HeaderStyle HorizontalAlign="right" Width="10%" />
                                                        ...
                                                        <asp:TemplateField HeaderText="USO">
                                                            ...
                                                            <ItemStyle HorizontalAlign="right" Width="10%" />
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="Txt_Uso" runat="server" Font-Size="X-Small" 
                                                                    name="<%=Txt_Uso.ClientID %>" style="text-transform:uppercase" Width="97%"></asp:TextBox>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                    </Columns>
                                                    <SelectedRowStyle CssClass="GridSelected" />
                                        ...
                                        <tr style="background-color: #3366CC">
                                            <td colspan="4" style="text-align:left; font-size:15px; color:#FFFFFF;">
                                                VII. VALOR TOTAL DEL PREDIO ACTUAL
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="text-align:left;width:20%;">
                                            ...
                                            <td style="text-align:left;width:30%;">
                                                <asp:TextBox ID="Txt_Cuota_Anual_Actual" runat="server" Enabled="false" 
                                                    style="text-transform:uppercase" TabIndex="9" Width="98%"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr style="background-color: #3366CC">
                                            <td colspan="4" style="text-align:left; font-size:15px; color:#FFFFFF;">
                                                VIII. VALOR TOTAL ANTERIOR DEL PREDIO
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="text-align:left;width:20%;">
                                            ...
                                            <td style="text-align:left;width:30%;">
                                                <asp:TextBox ID="Txt_Valor_Total_Predio_Anterior" runat="server" 
                                                    Enabled="false" style="text-transform:uppercase" TabIndex="9" Width="98%"></asp:TextBox>
                                            </td>
                                            <td style="text-align:left;width:20%;text-align:left;">
                                            ...
                                            <td style="text-align:left;width:30%;">
                                                <asp:TextBox ID="Txt_Cuota_Anual_Anterior" runat="server" Enabled="false" 
                                                    style="text-transform:uppercase" TabIndex="11" Width="96.4%" />
                                            </td>
                                        </tr>
                                        <tr style="background-color: #3366CC">
                                        ...
                                        <tr ID="Tr1" runat="server">
                                            <td class="style1" style="text-align: left; width: 20%">
                                        ...
                                        <tr>
                                            <td colspan="4">
                                                <asp:GridView ID="Grid_Colindancias" runat="server" AllowPaging="True" 
                                                    AllowSorting="True" AutoGenerateColumns="False" CssClass="GridView_1" 
                                                    EmptyDataText="&quot;No se encontraron registros&quot;" 
                                                    HeaderStyle-CssClass="tblHead" 
                                                    OnPageIndexChanging="Grid_Colindancias_PageIndexChanging" 
                                                    OnSelectedIndexChanged="Grid_Colindancias_SelectedIndexChanged" PageSize="15" 
                                                    Style="white-space: normal;" Width="100%">
                                                    <Columns>
                                                        <asp:BoundField DataField="NO_COLINDANCIA" HeaderStyle-Width="15%" 
                                                            HeaderText="ID" Visible="false">
                                                            <HeaderStyle HorizontalAlign="Left" Width="0%" />
                                                            <ItemStyle HorizontalAlign="Left" Width="0%" />
                                                        </asp:BoundField>
                                                        <asp:BoundField DataField="MEDIDA_COLINDANCIA" HeaderStyle-Width="96.5%" 
                                                            HeaderText="MEDIDAS Y COLINDANCIAS">
                                                            <HeaderStyle HorizontalAlign="Left" Width="70%" />
                                                            <ItemStyle HorizontalAlign="Left" Width="70%" />
                                                        </asp:BoundField>
                                        ...
                                        <tr>
                                            <td colspan="4" style="text-align: left; width: 20%;">
                                                <asp:GridView ID="Grid_Documentos" runat="server" AllowPaging="False" 
                                                    ...
                                                    OnDataBound="Grid_Documentos_DataBound" PageSize="20" 
                                                    Style="white-space: normal;" Width="100%">
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField DataField="ANIO_DOCUMENTO" HeaderText="Anio Documento" 
                                                            Visible="false">
                                                            <ItemStyle HorizontalAlign="Center" />
                                                        </asp:BoundField>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="3" style="width: 98%; text-align: left;">
                                                <asp:TextBox ID="Txt_Observaciones" runat="server" Rows="3" 
                                                    Style="float: left; text-transform: uppercase" TabIndex="36" 
                                                    TextMode="MultiLine" Width="96.4%" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
