<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Frm_Cat_Cat_Reg_Condominio.aspx.cs" 
Inherits="paginas_Catastro_Frm_Cat_Cat_Reg_Condominio" MasterPageFile="~/paginas/Paginas_Generales/MasterPage.master" 
Title="Catálogo de Regimen de Condominios" %>
                ...
                <table width="98%" border="0" cellspacing="0" class="estilo_fuente">
                    <tr align="center">
                        <td colspan="3" class="label_titulo">
                            Cat&aacute;logo de Regimen de Condominio
                        </td>
                    </tr>
                    <tr>
                        <td class="style1">
                    ...
                    <table width="98%" class="estilo_fuente">
                        ...
                        <tr>
                            <td style="text-align: left; width: 20%;">
                                <asp:HiddenField ID="hdf_Reg_Condominio_Id" runat="server" />
                            </td>
                        </tr>
                        <tr>
                            <td style="text-align: left; width: 20%;">
                            ...
                            <td style="text-align: left; width: 30%;">
                                <asp:TextBox ID="Txt_Documento" runat="server" Width="98%" TabIndex="9" Enabled="false"
                        ...
                        <td style="text-align: left; width: 20%; text-align: Left;">
                            ...
                            <td style="text-align: left; width: 30%;">
                                <asp:DropDownList ID="Cmb_Tipo" runat="server" Width="99%" TabIndex="12" Enabled="false">
                                ...
                                <tr>
                            <td colspan="4">
                                <asp:GridView ID="Grid_Regimen_Condominio" runat="server" AllowPaging="True" AllowSorting="True"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="REGIMEN_CONDOMINIO_ID" HeaderStyle-Width="15%" HeaderText="ID"
                                            Visible="false">
                                            <HeaderStyle HorizontalAlign="Left" Width="0%" />
                                            <ItemStyle HorizontalAlign="Left" Width="0%" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="NOMBRE_DOCUMENTO" HeaderText="Nombre del Documento">
