<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Frm_Cat_Cat_Motivos_Avaluo.aspx.cs" MasterPageFile="~/paginas/Paginas_Generales/MasterPage.master" Inherits="paginas_Catastro_Frm_Cat_Cat_Motivos_Avaluo" Title="Catálogo de Motivos de Avalúo"%>
                                    ...
                                    <td align="right" style="width:41%;">
                                        <table style="width:100%;height:28px;">
                                            <tr>
                                                ...
                                                <td style="width:55%;">
                                                    <asp:TextBox ID="Txt_Busqueda" runat="server" MaxLength="100" TabIndex="5"  ToolTip = "Buscar" Width="180px" style="text-transform:uppercase"/>
                ...
                <table width="98%" class="estilo_fuente">
                    <tr>
                        ...
                        <td colspan="3" style="width:82%; text-align:left;">
                            <asp:TextBox TextMode="MultiLine" runat="server" ID="Txt_Motivo_Avaluo_Descripcion" Rows="3" Width="96.4%" Style="float: left; text-transform:uppercase"/>
                            <asp:HiddenField ID="Hdf_Motivo_Avaluo_Id" runat="server" />
                        </td>
                    </tr>
                    <tr>
                    <td style="text-align:left;width:20%;">
                    ...
                    <tr>
                        <td style="text-align:left;">
                            <asp:GridView ID="Grid_Motivos_Avaluo" runat="server" AllowSorting="true"
                                AutoGenerateColumns="False" CssClass="GridView_1" 
                                HeaderStyle-CssClass="tblHead" style="white-space:normal;" Width="100%" 
                                onpageindexchanging="Grid_Motivos_Avaluo_PageIndexChanging" 
                                onselectedindexchanged="Grid_Motivos_Avaluo_SelectedIndexChanged" PageSize="10" AllowPaging="true">
                                <Columns>
                                    <asp:ButtonField ButtonType="Image" CommandName="Select" 
                                        ImageUrl="~/paginas/imagenes/paginas/Select_Grid_Inner.png" Text="Button">
                                        <HeaderStyle Width="5%" />
                                    </asp:ButtonField>
                                    <asp:BoundField DataField="MOTIVO_AVALUO_ID" HeaderText="Id" Visible="false">
                                        <ItemStyle HorizontalAlign="Center" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="MOTIVO_AVALUO_DESCRIPCION" HeaderText="Motivo del Avaluo">
