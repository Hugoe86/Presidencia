...
public partial class paginas_Catastro_Frm_Cat_Cat_Seguimiento_Avaluos_Urbanos_Regimen : System.Web.UI.Page
{
    ...
    private void Cargar_Datos_Avaluo(DataTable Dt_Avaluo)
    {
        if (Dt_Avaluo.Rows.Count > 0)
        {
            ...
            Hdf_Estatus_Anterior.Value = Dt_Avaluo.Rows[0][Ope_Cat_Avaluo_Urbano.Campo_Estatus_Anterior].ToString();
        }
    }
        ...
        try
        {
            if (Grid_Avaluos_Urbanos.SelectedIndex > -1)
            {
                ...
                else
                {
                    ...
                    Avaluo.P_Estatus_Anterior = Hdf_Estatus_Anterior.Value;
    ...
    protected void Btn_Siguiente_Fase_Click(object sender, ImageClickEventArgs e)
    {
        try
        {
            if (Grid_Avaluos_Urbanos.SelectedIndex > -1)
            {
                ...
                if (Hdf_Estatus_Anterior.Value == "POR VALIDAR")
                {
                    Cmb_Motivos_Rechazo.SelectedIndex = Cmb_Motivos_Rechazo.Items.IndexOf(Cmb_Motivos_Rechazo.Items.FindByText("SE AUTORIZO PARA PRIMER REVISION"));
                }
                else if (Hdf_Estatus_Anterior.Value == "2_REVISION")
                {
                ...
                else if (Hdf_Estatus_Anterior.Value == "POR AUTORIZAR")
                {
                    Cmb_Motivos_Rechazo.SelectedIndex = Cmb_Motivos_Rechazo.Items.IndexOf(Cmb_Motivos_Rechazo.Items.FindByText("SE AUTORIZO PARA TERCER REVISION"));
                }
                ...
                //Avaluo.P_Estatus = Hdf_Estatus_Anterior.Value;
                Avaluo.P_Veces_Rechazo = (Convert.ToInt16(Grid_Avaluos_Urbanos.SelectedRow.Cells[4].Text)).ToString();
                Avaluo.P_Observaciones_Perito = Txt_Observaciones_Rechazo.Text.ToUpper();
                Avaluo.P_Solicitud_Id = Hdf_Solicitud_Id.Value;
                if ((Avaluo.Modificar_Observaciones_Avaluo_Au()))
                {
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "Avalúo Rústico", "alert('El avalúo pasó a la etapa de revisiones pertinente.');", true);
                    Btn_Salir_Click(null, null);
                }
                else
                {
