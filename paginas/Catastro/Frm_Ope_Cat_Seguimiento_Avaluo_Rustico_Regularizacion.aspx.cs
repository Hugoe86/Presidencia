...
public partial class paginas_Catastro_Frm_Ope_Cat_Seguimiento_Avaluo_Rustico_Regularizacion : System.Web.UI.Page
{
    ...
    private void Llenar_Tabla_Avaluos_Urbanos(int Pagina)
    {
        try
        {
            ...
            Grid_Avaluos_Urbanos.DataSource = Avaluo_Urb.Consultar_Avaluo_Rustico_Regularizacion();
            ...
            if (Grid_Avaluos_Urbanos.SelectedIndex > -1)
            {
                if (Grid_Avaluos_Urbanos.SelectedRow.Cells[8].Text == "POR VALIDAR" || Grid_Avaluos_Urbanos.SelectedRow.Cells[8].Text == "RECHAZADO")
                {
                    ...
                    else
                    {
                        ...
                        if ((Avaluo.Modificar_Observaciones_Arr()))
                        {
    ...
    protected void Grid_Avaluos_Urbanos_SelectedIndexChanged(object sender, EventArgs e)
    {
        if (Grid_Avaluos_Urbanos.SelectedIndex > -1)
        {
            ...
            {
                //Hdf_Base_Cobro.Value = Dt_Factores_Cobro.Rows[0][Cat_Cat_Factores_Cobro_Avaluos.Campo_Base_Cobro_PE].ToString();
                //Hdf_Factor_Cobro1.Value = Dt_Factores_Cobro.Rows[0][Cat_Cat_Factores_Cobro_Avaluos.Campo_Factor_Cobro_1PE].ToString();
                //Hdf_Factor_Cobro2.Value = Dt_Factores_Cobro.Rows[0][Cat_Cat_Factores_Cobro_Avaluos.Campo_Factor_Cobro_2PE].ToString();
