<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Frm_Ope_Cat_Seguimiento_Avaluo_Rustico_Regimen.aspx.cs" Inherits="paginas_Catastro_Frm_Ope_Cat_Seguimiento_Avaluo_Rustico_Regimen" 
MasterPageFile="~/paginas/Paginas_Generales/MasterPage.master"
    Title="Seguimiento: Avalúo Rústico De Régimen En Condominio" %>
                ...
                <table width="98%" border="0" cellspacing="0" class="estilo_fuente">
                    <tr align="center">
                        <td colspan="4" class="label_titulo">
                            Seguimiento: Aval&uacute;os Rústico De Régimen En Condominio
                        </td>
                    </tr>
                    <tr>
                        <td class="style1">
                    ...
                    <tr class="barra_busqueda" align="right">
                        ...
                        <asp:ImageButton ID="Btn_Siguiente_Fase" runat="server" TabIndex="1" OnClientClick="return confirm('¿Está seguro de pasar el Avalúo Rústico a la fase de revisiones correspondiente?');"
                                ImageUrl="~/paginas/imagenes/paginas/accept.png" Width="24px" CssClass="Img_Button" 
                                AlternateText="Sig_Fase" OnClick = "Btn_Siguiente_Fase_Click" ToolTip="Realizar Revisión Pertinente"/>
                ...
                <center>
                    ...
                    <tr style="background-color: #3366CC">
                        ...
                        <td style="text-align:left;width:20%;">
                            ...
                            <asp:HiddenField ID="Hdf_Estatus_Anterior" runat="server" />
                        </td>
                        </tr>
                      <tr>
                    ...
                    <tr>
                        <td style="text-align:left;width:20%;">
                            *Cuenta Predial</td>
                        <td style="text-align:left;width:30%;">
                            <asp:TextBox ID="Txt_Cuenta_Predial" runat="server" Width="98%" 
                            ...
                            <td colspan="4" style="text-align: left; width: 20%;">
                                ...
                                <tr>
                                    ...
                                    <td colspan="3" style="width:98%; text-align:left;">
                                        <asp:TextBox ID="Txt_Observaciones" runat="server" Rows="5" 
