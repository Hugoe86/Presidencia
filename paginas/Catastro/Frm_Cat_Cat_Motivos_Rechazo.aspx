<%@ Page Language="C#"  MasterPageFile="~/paginas/Paginas_Generales/MasterPage.master" AutoEventWireup="true" CodeFile="Frm_Cat_Cat_Motivos_Rechazo.aspx.cs" Inherits="paginas_Catastro_Frm_Cat_Cat_Motivos_Rechazo" Title="Catálogo de Motivos de Rechazo"%>
                ...
                <table width="98%" class="estilo_fuente">
                    <tr>
                        ...
                        <td colspan="3" style="width:82%; text-align:left;">
                            <asp:TextBox TextMode="MultiLine" runat="server" ID="Txt_Motivo_Descripcion" Rows="3" Width="96.4%" Style="float: left; text-transform:uppercase"/>
                    ...
                    <tr>
                        <td style="text-align:left;">
                            <asp:GridView ID="Grid_Motivos_Rechazo" runat="server" AllowSorting="true"
                                AutoGenerateColumns="False" CssClass="GridView_1" 
                                HeaderStyle-CssClass="tblHead" style="white-space:normal;" Width="100%" 
                                onpageindexchanging="Grid_Motivos_Rechazo_PageIndexChanging" 
                                onselectedindexchanged="Grid_Motivos_Rechazo_SelectedIndexChanged" PageSize="10" AllowPaging="true">
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="MOTIVO_DESCRIPCION" HeaderText="Motivo del Rechazo">
