<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Frm_Cat_Cat_Descripcion_Construccion_Rustico.aspx.cs" 
        Inherits="paginas_Catastro_Frm_Cat_Cat_Descripcion_Construccion_Rustico" 
        MasterPageFile="~/paginas/Paginas_Generales/MasterPage.master" Title="Catálogo de Descripcion Construcción Rustico" %>
                ...
                <table width="98%" border="0" cellspacing="0" class="estilo_fuente">
                    <tr align="center">
                        <td colspan="3" class="label_titulo">
                            Cat&aacute;logo de Descripcion Agrológico
                        </td>
                    </tr>
                    <tr>
                        <td class="style1">
                    ...
                    <table width="98%" class="estilo_fuente">
                        ...
                        <tr style="background-color: #3366CC" align="center">
                            <td style="text-align: center; font-size: 15px; color: #FFFFFF;" colspan="4" >
                                Descripcion de Construcción Rustico
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            <td style="text-align: left; width: 20%;">
                                <asp:HiddenField ID="Hdf_Descript_Construccion_Id" runat="server" />
                            </td>
                        </tr>
                        <tr>
                            <td style="text-align: left; width: 20%;">
                                *Descripcion de Construcción
                            </td>
                            <td style="text-align: left; width: 30%;">
                                <asp:TextBox ID="Txt_Identificador_Contruccion" runat="server" Width="98%" TabIndex="9" Enabled="false"
                        ...
                        <tr>
                            <td colspan="4">
                                <asp:GridView ID="Grid_Descripcion_Construccion_Rustico" runat="server" AllowPaging="True" AllowSorting="True"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="DESC_CONSTRU_RUSTICO_ID" HeaderStyle-Width="15%" HeaderText="ID"
                                            Visible="false">
                                            <HeaderStyle HorizontalAlign="Left" Width="0%" />
                                            <ItemStyle HorizontalAlign="Left" Width="0%" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="IDENTIFICADOR" HeaderStyle-Width="15%" HeaderText="Tipo de Construcción">
