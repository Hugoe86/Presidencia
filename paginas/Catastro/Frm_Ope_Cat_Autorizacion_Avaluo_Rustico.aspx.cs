...
public partial class paginas_Catastro_Frm_Ope_Cat_Autorizacion_Avaluo_Rustico : System.Web.UI.Page
{
    ...
    protected void Btn_Modificar_Click(object sender, ImageClickEventArgs e)
    {
        try
        {
            ...
            {
                if (Grid_Avaluos_Urbanos.SelectedRow.Cells[8].Text == "POR AUTORIZAR")
                {
                    ...
                    else
                    {
                        ...
                        Avaluo.P_Importe_Avaluo = Convert.ToDouble(Txt_Precio_Avaluo.Text).ToString();
                        //Avaluo.P_Uso = Txt_Uso.Text;
                        if ((Avaluo.Modificar_Observaciones_Ara()))
                        {
                            if (Cmb_Estatus.SelectedValue == "RECHAZADO")
                            {
                                Enviar_Correo_Cuenta_Rechazo();
    ...
    protected void Btn_Regimen_Click(object sender, ImageClickEventArgs e)
    {
        try
        {
            if (Grid_Avaluos_Urbanos.SelectedIndex > -1 && Grid_Avaluos_Urbanos.SelectedRow.Cells[8].Text == "POR AUTORIZAR")
            {
                Cls_Ope_Cat_Avaluo_Rustico_Negocio Avaluo = new Cls_Ope_Cat_Avaluo_Rustico_Negocio();
                ...
                Avaluo.P_Estatus_Anterior = "POR AUTORIZAR";
                Avaluo.P_Veces_Rechazo = (Convert.ToInt16(Grid_Avaluos_Urbanos.SelectedRow.Cells[4].Text)).ToString();
                Avaluo.P_Observaciones_Perito = Txt_Observaciones_Rechazo.Text.ToUpper();
                Avaluo.P_Solicitud_Id = Hdf_Solicitud_Id.Value;
                if ((Avaluo.Modificar_Observaciones_Ara()))
    ...
    ///CAUSA_MODIFICACIÓN:
    ///*******************************************************************************
    private void Imprimir_Reporte_Avaluo(DataSet Ds_Convenios, String Nombre_Reporte, String Nombre_Archivo, String Formato, String Tipo)
    {
        ReportDocument Reporte = new ReportDocument();
        String File_Path = Server.MapPath("../Rpt/Catastro/" + Nombre_Reporte);
        try
    ...
    private void Enviar_Correo_Cuenta(String E_Mail, String Url_Adjunto)
    {
        ...
        try
        {
            ...
            {
                String Clave_Tramite = Obtener_Dato_Consulta("SELECT " + Ope_Tra_Solicitud.Campo_Clave_Solicitud + " FROM " + Ope_Tra_Solicitud.Tabla_Ope_Tra_Solicitud + " WHERE " + Ope_Tra_Solicitud.Campo_Solicitud_ID + " = '" + Hdf_Solicitud_Id.Value + "'");
                Contenido = "Su avalúo Rústico No. " + Txt_No_Avaluo.Text + " con Clave de Trámite: " + Clave_Tramite + " ha sido Autorizado. Favor de pasar a pagar en las cajas de Presidencia de Irapuato, su folio de pago se encuentra adjunto a este correo. Favor de imprimirlo dos veces.";
    ...
    private void Enviar_Correo_Cuenta_Rechazo()
    {
        ...
        try
        {
            ...
            {
                String Clave_Tramite = Obtener_Dato_Consulta("SELECT " + Ope_Tra_Solicitud.Campo_Clave_Solicitud + " FROM " + Ope_Tra_Solicitud.Tabla_Ope_Tra_Solicitud + " WHERE " + Ope_Tra_Solicitud.Campo_Solicitud_ID + " = '" + Hdf_Solicitud_Id.Value + "'");
                Contenido = "Su avalúo rústico No. " + Txt_No_Avaluo.Text + " con Clave de Trámite: " + Clave_Tramite + " ha sido Rechazado. Favor de corregirlo.";
                Cls_Mail mail = new Cls_Mail();
                mail.P_Servidor = Cls_Cat_Ate_Peticiones_Datos.Consulta_Parametros().Rows[0][Apl_Parametros.Campo_Servidor_Correo].ToString();
                mail.P_Envia = Cls_Cat_Ate_Peticiones_Datos.Consulta_Parametros().Rows[0][Apl_Parametros.Campo_Correo_Saliente].ToString();
                mail.P_Password = Cls_Cat_Ate_Peticiones_Datos.Consulta_Parametros().Rows[0][Apl_Parametros.Campo_Password_Correo].ToString();
                mail.P_Recibe = E_Mail.Trim();
                mail.P_Subject = "Avalúo Rústico Rechazado";
                mail.P_Texto = Contenido;
    ...
    protected void Btn_Imprimir_Click(object sender, ImageClickEventArgs e)
    {
        ...
        {
            Imprimir_Reporte_Avaluo(Crear_Ds_Avaluo_Urbano_Reporte(), "Rpt_Ope_Cat_Avaluo_Rustico.rpt", "Avaluo_Rustico", "Window_Frm", "Avaluo_Rustico");
        }
    }
