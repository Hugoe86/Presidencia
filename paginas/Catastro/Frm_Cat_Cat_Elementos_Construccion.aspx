<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/paginas/Paginas_Generales/MasterPage.master" CodeFile="Frm_Cat_Cat_Elementos_Construccion.aspx.cs" Inherits="paginas_Catastro_Frm_Cat_Cat_Elementos_Construccion" Title="Catálogo de Elementos de Construccion" %>
                ...
                <table width="98%" class="estilo_fuente">
                    <tr>
                        ...
                        <td style="width:30%; text-align:left;">
                            <asp:TextBox  runat="server" ID="Txt_Elemento_Construccion"  Width="98%" TabIndex="6" 
                    ...
                    <tr>
                    <td>
                    <asp:HiddenField ID="Hdf_Elemento_Construccion_Id" runat="server" />
                    </td>
                    </tr>
                    <tr>
                    <td colspan="4">
                    ...
                    <tr>
                        <td style="text-align:left;">
                            <asp:GridView ID="Grid_Elemento_Construccion" runat="server" AllowSorting="true"
                                AutoGenerateColumns="False" CssClass="GridView_1" 
                                HeaderStyle-CssClass="tblHead" style="white-space:normal;" Width="100%" 
                                onpageindexchanging="Grid_Elemento_Construccion_PageIndexChanging" 
                                onselectedindexchanged="Grid_Elemento_Construccion_SelectedIndexChanged" PageSize="10" AllowPaging="true">
                                <Columns>
                                    <asp:ButtonField ButtonType="Image" CommandName="Select" 
                                        ImageUrl="~/paginas/imagenes/paginas/Select_Grid_Inner.png" Text="Button">
                                        <HeaderStyle Width="5%" />
                                    </asp:ButtonField>
                                    <asp:BoundField DataField="ELEMENTOS_CONSTRUCCION_ID" HeaderText="Id" Visible="false">
                                        <ItemStyle HorizontalAlign="Center" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="ELEMENTOS_CONSTRUCCION" HeaderText="Elemento de Construccion ">
