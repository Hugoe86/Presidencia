<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Frm_Ope_Cat_Autorizacion_Avaluo_Urbano_Av.aspx.cs"
    Inherits="paginas_Catastro_Frm_Ope_Cat_Autorizacion_Avaluo_Urbano_Av" MasterPageFile="~/paginas/Paginas_Generales/MasterPage.master"
    Title="Autorización Avalúo Urbano Actualización de Valor" %>
                    ...
                    <table width="98%" border="0" cellspacing="0" class="estilo_fuente">
                        <tr align="center">
                            <td colspan="4" class="label_titulo">
                                Autorización: Aval&uacute;os Urbanos Actualización de Valor
                            </td>
                        </tr>
                        <tr>
                            <td class="style1">
                        ...
                        <tr class="barra_busqueda" align="right" style="width: 50%">
                            ...
                            <td align="right" class="style1" colspan="2" style="width: 50%">
                                <table style="width: 100%; height: 28px;">
                                    <tr>
                                        ...
                                        <td style="width: 80%;">
                                            <asp:DropDownList ID="Cmb_Busqueda_Avaluo_Estatus" runat="server" Width="40%" OnSelectedIndexChanged="Cmb_Busqueda_Avaluo_Estatus_SelectedIndexChanged"
                                                AutoPostBack="true">
                                                <asp:ListItem Text="POR AUTORIZAR" Value="POR AUTORIZAR" />
                                                <asp:ListItem Text="AUTORIZADO" Value="AUTORIZADO" />
                                            </asp:DropDownList>
                                            <asp:TextBox ID="Txt_Busqueda" runat="server" Width="45%" TabIndex="6" Style="text-transform: uppercase"></asp:TextBox>
                                    ...
                                    <div id="Div_Datos_Avaluo" runat="server" visible="false">
                                        <table width="98%" border="0" cellspacing="0" class="estilo_fuente">
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: left; width: 30%;">
                                                    <asp:CheckBox ID="Chk_Fotogrametria" runat="server" TabIndex="13" Text="" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                                ...
                                                                <asp:TemplateField HeaderText="B">
                                                                    ...
                                                                    <ItemTemplate>
                                                                        <asp:TextBox ID="Txt_B" runat="server" CssClass="text_cantidades_grid" Font-Size="X-Small"
                                                                            name="<%=Txt_B.ClientID %>" Style="text-transform: uppercase" Width="90%" TabIndex="30"></asp:TextBox>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="C">
                                                                    ...
                                                                    <ItemTemplate>
                                                                        <asp:TextBox ID="Txt_C" runat="server" CssClass="text_cantidades_grid" Font-Size="X-Small"
                                                                            name="<%=Txt_C.ClientID %>" Style="text-transform: uppercase" Width="90%" TabIndex="30"></asp:TextBox>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="D">
                                                                    ...
                                                                    <ItemTemplate>
                                                                        <asp:TextBox ID="Txt_D" runat="server" CssClass="text_cantidades_grid" Font-Size="X-Small"
                                                                            name="<%=Txt_D.ClientID %>" Style="text-transform: uppercase" Width="90%" TabIndex="30"></asp:TextBox>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="E">
                                                                    ...
                                                                    <ItemTemplate>
                                                                        <asp:TextBox ID="Txt_E" runat="server" CssClass="text_cantidades_grid" Font-Size="X-Small"
                                                                            name="<%=Txt_E.ClientID %>" Style="text-transform: uppercase" Width="90%" TabIndex="30"></asp:TextBox>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="F">
                                                                    ...
                                                                    <ItemTemplate>
                                                                        <asp:TextBox ID="Txt_F" runat="server" CssClass="text_cantidades_grid" Font-Size="X-Small"
                                                                            name="<%=Txt_F.ClientID %>" Style="text-transform: uppercase" Width="90%" TabIndex="30"></asp:TextBox>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="G">
                                                                    ...
                                                                    <ItemTemplate>
                                                                        <asp:TextBox ID="Txt_G" runat="server" CssClass="text_cantidades_grid" Font-Size="X-Small"
                                                                            name="<%=Txt_G.ClientID %>" Style="text-transform: uppercase" Width="90%" TabIndex="30"></asp:TextBox>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="H">
                                                                    ...
                                                                    <ItemTemplate>
                                                                        <asp:TextBox ID="Txt_H" runat="server" CssClass="text_cantidades_grid" Font-Size="X-Small"
                                                                            name="<%=Txt_H.ClientID %>" Style="text-transform: uppercase" Width="90%" TabIndex="30"></asp:TextBox>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="I">
                                                                    ...
                                                                    <ItemTemplate>
                                                                        <asp:TextBox ID="Txt_I" runat="server" CssClass="text_cantidades_grid" Font-Size="X-Small"
                                                                            name="<%=Txt_I.ClientID %>" Style="text-transform: uppercase" Width="90%" TabIndex="30"></asp:TextBox>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="J">
                                                                    ...
                                                                    <ItemTemplate>
                                                                        <asp:TextBox ID="Txt_J" runat="server" CssClass="text_cantidades_grid" Font-Size="X-Small"
                                                                            name="<%=Txt_J.ClientID %>" Style="text-transform: uppercase" Width="90%" TabIndex="30"></asp:TextBox>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                    ...
                                    <td colspan="4" style="text-align:left; font-size:15px; color:#FFFFFF;">
                                        ...
                                        <tr>
                                            ...
                                            <tr style="background-color: #3366CC">
                                                ...
                                                <td colspan="2">
                                                    <asp:DropDownList ID="Cmb_Firmante" runat="server" Width="99%">
                                            ...
                                            <tr>
                                                <td colspan="4">
                                                    <asp:GridView ID="Grid_Observaciones_Corregidas" runat="server" AllowPaging="True"
                                                        ...
                                                        <Columns>
                                                            <asp:BoundField DataField="MOTIVO_DESCRIPCION" HeaderStyle-Width="70%" HeaderText="Motivo">
                                                                <HeaderStyle HorizontalAlign="Left" Width="70%" />
                                                                <ItemStyle HorizontalAlign="Left" Width="70%" />
                                                            </asp:BoundField>
                                                            <asp:BoundField DataField="USUARIO_CREO" HeaderStyle-Width="20%" HeaderText="Realizó observaciones">
