<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Frm_Cat_Cat_Valores_Inpr.aspx.cs" Inherits="paginas_Catastro_Frm_Cat_Cat_Valores_Inpr" MasterPageFile="~/paginas/Paginas_Generales/MasterPage.master"%>
        ...
        <ContentTemplate>
            ...
            <div id="Div_Calles" style="background-color:#ffffff; width:100%; height:100%;">
                <table width="98%"  border="0" cellspacing="0" class="estilo_fuente">
                    <tr align="center">
                        <td colspan="2" class="label_titulo">Cat&aacute;logo de I.N.P.R.</td>
                    </tr>
                    <tr>
                        <td class="style1">
...
<%--                            <asp:ImageButton ID="Btn_Eliminar" runat="server" TabIndex="3"
                ...
                <br />
                        ...
                        <td style="text-align:left;width:20%;">
                            <asp:HiddenField ID="Hdf_Inpr_Id" runat="server" />
                        </td>
                        </tr>
                            <tr>
                            ...
                            *I.N.P.R.
                            ...
                            <asp:TextBox ID="Txt_Valor_Inpr" runat="server" Width="94.4%" Style="float: left; text-transform:uppercase" AutoPostBack="true" OnTextChanged="Txt_Valor_Inpr_TextChanged" MaxLength="12"/>
                            <cc1:FilteredTextBoxExtender FilterType="Numbers,Custom" runat="server" ID="FTB_Txt_Valor_Inpr" TargetControlID="Txt_Valor_Inpr" ValidChars="1234567890.,"/>
                            </td>
                            </tr>
                            <tr>
                            <td>
                            ...
                            <asp:HiddenField ID="hdf_Valor_Inpr" runat="server" />
                            </td>
                            <td>
                            </td>
                            <td>
                            ...
                            <td>
                            <asp:ImageButton ID="Btn_Agregar_Inpr" runat="server"
                                Height="24px" ImageUrl="~/paginas/imagenes/paginas/sias_add.png" 
                                OnClick="Btn_Agregar_Valor_Click"
                                TabIndex="10" ToolTip="Agregar I.n.p.r." Width="24px" />
                                &nbsp; &nbsp; 
                            <asp:ImageButton ID="Btn_Actualizar_Inpr" runat="server"
                                Height="24px" ImageUrl="~/paginas/imagenes/paginas/Actualizar_Detalle.png" 
                                OnClick="Btn_Actualizar_Valor_Click"
                                TabIndex="10" ToolTip="Actualizar I.n.p.r." Width="24px" />
                                &nbsp; &nbsp;
                            <asp:ImageButton ID="Btn_Eliminar_Inpr" runat="server"
                                Height="24px" ImageUrl="~/paginas/imagenes/paginas/quitar.png" 
                                OnClick="Btn_Eliminar_Valor_Click"
                                TabIndex="10" ToolTip="Eliminar I.n.p.r." Width="24px" />
                            </td>
                            </tr>
                            <tr>
                            <td colspan="4">
                            <asp:GridView ID="Grid_Inpr" runat="server" AllowPaging="True" AllowSorting="True" 
                                                AutoGenerateColumns="False" CssClass="GridView_1" 
                                                EmptyDataText="&quot;No se encontraron registros&quot;"
                                                HeaderStyle-CssClass="tblHead" PageSize="10" style="white-space:normal;" 
                                                Width="100%"
                                                OnSelectedIndexChanged = "Grid_Inpr_SelectedIndexChanged"
                                                OnPageIndexChanging = "Grid_Inpr_PageIndexChanging">
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="VALOR_INPR_ID" HeaderStyle-Width="15%" HeaderText="Id" Visible="false">
                                                    ...
                                                    <asp:BoundField DataField="VALOR_INPR" HeaderStyle-Width="15%" HeaderText="I.N.P.R." DataFormatString="{0:N2}">
                                                    <HeaderStyle HorizontalAlign="Center" Width="50%" />
