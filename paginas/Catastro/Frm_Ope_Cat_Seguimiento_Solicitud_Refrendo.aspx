<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Frm_Ope_Cat_Seguimiento_Solicitud_Refrendo.aspx.cs" MasterPageFile="~/paginas/Paginas_Generales/MasterPage.master" Inherits="paginas_Frm_Ope_Cat_Seguimiento_Solicitud_Refrendo" %>
                ...
                <table width="100%" class="estilo_fuente">
                    <tr align="center">
                        <td class="label_titulo" >
                            Seguimiento: Solicitud de Refrendo
                        </td>
                    </tr>
                    <tr>
                        <td>
                ...
                <div id="Div_Grid_Peritos" runat="server">
                    <tr style="background-color: #3366CC">
                                ...
                                <td align="center" colspan="4">
                                            <asp:GridView ID="Grid_Peritos_Externos" runat="server" AllowPaging="True" AllowSorting="True" 
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="USUARIO" HeaderText="E-Mail">
                            ...
                            <asp:HiddenField ID="Hdf_Estatus_Perito_Externo" runat="server" />
                              <asp:HiddenField ID="Hdf_Importe_Total_Pago" runat="server" />
                            <br />
