<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Frm_Ope_Cat_Autorizacion_Avaluo_Rustico.aspx.cs" Inherits="paginas_Catastro_Frm_Ope_Cat_Autorizacion_Avaluo_Rustico" 
MasterPageFile="~/paginas/Paginas_Generales/MasterPage.master" Title="Autorización: Avalúo Rústico" %>
                ...
                <table width="98%" border="0" cellspacing="0" class="estilo_fuente">
                    <tr align="center">
                        <td colspan="4" class="label_titulo">
                            Autorización: Aval&uacute;os Rústico
                        </td>
                    </tr>
                    <tr>
                        <td class="style1">
                    ...
                    <tr class="barra_busqueda" align="right">
                        ...
                        <asp:ListItem Text="Cuenta Predial" Value="CUENTA" />
                            ...
                            <asp:TextBox ID="Txt_Busqueda" runat="server" Width="25%" TabIndex="5" Style="text-transform: uppercase"></asp:TextBox>
