<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Frm_Ope_Cat_Seguimiento_Avaluos_Urbanos_Inconformidades.aspx.cs" 
Inherits="paginas_Catastro_Frm_Ope_Cat_Seguimiento_Avaluos_Urbanos_Inconformidades" MasterPageFile="~/paginas/Paginas_Generales/MasterPage.master" Title="Seguimiento: Avalúo Urbano Inconformidades" %>
        ...
        <ContentTemplate>
            ...
            <div id="Div_Calles" style="background-color:#ffffff; width:100%; height:100%;">
                <table width="98%"  border="0" cellspacing="0" class="estilo_fuente">
                    <tr align="center">
                        <td colspan="2" class="label_titulo">Seguimiento: Aval&uacute;os Urbanos Inconformidades</td>
                    </tr>
                    <tr>
                        <td class="style1">
                ...
                <br />
                    ...
                    <tr>
                        ...
                        <td style="width: 30%; text-align: left;">
                            <asp:TextBox runat="server" ID="Txt_Avaluo_Av" Width="85%"
                                Style="float: left; text-transform: uppercase" MaxLength="50" Enabled="false"/>
                                <asp:ImageButton ID="Btn_Busqueda_Avaluos_Av" runat="server" 
                                ...
                                ToolTip="Búsqueda Avanzada de Avalúos de Actualización de Valor" Width="24px" />
