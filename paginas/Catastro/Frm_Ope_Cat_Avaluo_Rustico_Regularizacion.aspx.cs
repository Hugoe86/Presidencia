...
public partial class paginas_Catastro_Frm_Ope_Cat_Avaluo_Rustico_Regularizacion : System.Web.UI.Page
{
    ...
    private void Configuracion_Formulario(Boolean Enabled)
    {
        ...
        Grid_Avaluos_Urbanos_Regularizacion.Enabled = Enabled;
    ...
    private void Limpiar_Formulario()
    {
        ...
        Txt_Precio_Avaluo.Text = "";
        Txt_Motivo_Regularizacion.Text = "";
    ...
    private void Llenar_Tabla_Avaluos_Urbanos(int Pagina)
    {
        try
        {
            Cls_Ope_Cat_Avaluo_Rustico_Regularizacion_Negocio Avaluo_Urb = new Cls_Ope_Cat_Avaluo_Rustico_Regularizacion_Negocio();
            if (Txt_Busqueda.Text.Trim() != "")
            {
                Avaluo_Urb.P_Folio = Txt_Busqueda.Text.Trim();
            }
           
            Grid_Avaluos_Urbanos_Regularizacion.Columns[1].Visible = true;
            Grid_Avaluos_Urbanos_Regularizacion.Columns[2].Visible = true;
            Grid_Avaluos_Urbanos_Regularizacion.DataSource = Avaluo_Urb.Consultar_Avaluo_Rustico_Regularizacion();
            Grid_Avaluos_Urbanos_Regularizacion.PageIndex = Pagina;
            Grid_Avaluos_Urbanos_Regularizacion.DataBind();
            Grid_Avaluos_Urbanos_Regularizacion.Columns[1].Visible = false;
            Grid_Avaluos_Urbanos_Regularizacion.Columns[2].Visible = false;
        }
        catch (Exception Ex)
        {
            Lbl_Ecabezado_Mensaje.Text = Ex.Message;
    ...
    protected void Btn_Nuevo_Click(object sender, ImageClickEventArgs e)
    {
        try
        {
            if (Btn_Nuevo.AlternateText.Equals("Nuevo"))
            {
                ...
                Crear_Dt_Calculos();
                Cls_Ope_Cat_Avaluo_Rustico_Regularizacion_Negocio Avaluo = new Cls_Ope_Cat_Avaluo_Rustico_Regularizacion_Negocio();
                Avaluo.P_Anio_Avaluo = DateTime.Now.Year.ToString();
                DataTable Dt_Elementos_Construccion = Avaluo.Consultar_Tabla_Elementos_Construccion_Regularizacion();
                ...
                Session["Dt_Tabla_Valores_Construccion"] = Avaluo.Consultar_Tabla_Valores_Construccion_Regularizacion();

                DataTable Dt_Caracteristicas = Avaluo.Consultar_Tabla_Caracteristicas_Terreno_Regularizacion();
                ...
                Dt_Medidas.Columns.Add(Ope_Cat_Colindancias_Arr.Campo_No_Colindancia, typeof(String));
                Dt_Medidas.Columns.Add(Ope_Cat_Colindancias_Arr.Campo_Medida_Colindancia, typeof(String));
            ...
            else
            {
                if (Validar_Componentes())
                {
                    ...
                    if ((Avaluo.Alta_Avaluo_Rustico_Regularizacion()))
                    {
    ...
    protected void Btn_Modificar_Click(object sender, ImageClickEventArgs e)
    {
        try
        {
            if (Grid_Avaluos_Urbanos_Regularizacion.SelectedIndex > -1)
            {
                if (Grid_Avaluos_Urbanos_Regularizacion.SelectedRow.Cells[8].Text == "POR VALIDAR" || Grid_Avaluos_Urbanos_Regularizacion.SelectedRow.Cells[8].Text == "RECHAZADO" )
                {
                    if (Btn_Modificar.AlternateText.Equals("Modificar"))
                    {
                        if (Grid_Avaluos_Urbanos_Regularizacion.SelectedRow.Cells[8].Text == "PAGADO")
                        {
                            Cls_Ope_Cat_Avaluo_Rustico_Regularizacion_Negocio Avaluo = new Cls_Ope_Cat_Avaluo_Rustico_Regularizacion_Negocio();
                            Avaluo.P_Anio_Avaluo = Hdf_Anio_Avaluo.Value;
                            Avaluo.P_No_Avaluo = Hdf_No_Avaluo.Value;
                            DateTime DaTi = Convert.ToDateTime(Avaluo.Consultar_Avaluo_Rustico_Regularizacion().Rows[0][Ope_Cat_Avaluo_Urbano.Campo_Fecha_Autorizo].ToString());
                    ...
                    else
                    {
                        if (Validar_Componentes())
                        {
                            ...
                            Avaluo.P_Ubicacion = Txt_Ubicacion_Predio.Text.ToUpper();
                            Avaluo.P_Localidad_Municipio = Txt_Localidad.Text.ToUpper();
                            Avaluo.P_Grados_X = Txt_X_Horas.Text.Trim();
                            if (Cmb_Coordenadas.SelectedValue == "CART")
                            {
                                Avaluo.P_Tipo = Cmb_Coordenadas.SelectedValue;
                                Avaluo.P_Coordenadas_UTM = "";
                            ...
                            Avaluo.P_Uso_Constru = Txt_Uso_Constru.Text;
                            Avaluo.P_Valor_Total_Predio = Txt_Valor_Total_Predio.Text.Replace(",", "");
                            Avaluo.P_Observaciones = Txt_Observaciones.Text.ToUpper();
                            ...
                            Avaluo.P_Nombre_Predio = Txt_Nombre_Predio.Text.ToUpper();
                            Avaluo.P_Estatus = Cmb_Estatus.SelectedValue;
                            Avaluo.P_Veces_Rechazo = Grid_Avaluos_Urbanos_Regularizacion.SelectedRow.Cells[4].Text;
                            //Guardar Dt's
                            Guardar_Grid_Calculos();
                            Guardar_Grid_Descripcion_Terreno();
                            Guardar_Grid_Valores_Construccion();
                            ...
                            else if (Grid_Avaluos_Urbanos_Regularizacion.SelectedRow.Cells[8].Text == "PAGADO")
                            {
                            ...
                            if ((Avaluo.Modificar_Avaluo_Rustico_Regularizacion()))
                            {
    ...
    private DataSet Crear_Ds_Avaluo_Urbano()
    {
        ...
        Avaluo.P_No_Avaluo = Hdf_No_Avaluo.Value;
        Avaluo.P_Anio_Avaluo = Hdf_Anio_Avaluo.Value;
        DataTable Dt_Avaluo = Avaluo.Consultar_Avaluo_Rustico_Regularizacion();
    ...
    private DataSet Crear_Ds_Avaluo_Urbano_Reporte()
    {
        ...
        if (!String.IsNullOrEmpty(Dt_Avaluo.Rows[0][Ope_Cat_Avaluo_Rustico_R.Campo_Fecha_Autorizo].ToString()))
            Dr_Avaluo["FECHA"] = Convert.ToDateTime(Dt_Avaluo.Rows[0][Ope_Cat_Avaluo_Rustico_R.Campo_Fecha_Autorizo].ToString());
        ...
        Dr_Avaluo["NO_VALUADOR"] = Convert.ToInt16(Dt_Perito_Externo.Rows[0][Ope_Cat_Avaluo_Rustico_R.Campo_Perito_Externo_Id].ToString());
        ...
        {
            if (Dr_Renglon_Actual[Ope_Cat_Documentos_Arr.Campo_Documento].ToString().Trim() == "ANEXO_1")
            {
                Ruta_Archivo = Server.MapPath(Dr_Renglon_Actual[Ope_Cat_Documentos_Arr.Campo_Ruta_Documento].ToString());
                if (File.Exists(Ruta_Archivo))
                    Dr_Avaluo["ANEXO_1"] = Convertir_Imagen_A_Cadena_Bytes(System.Drawing.Image.FromFile(Server.MapPath(Dr_Renglon_Actual[Ope_Cat_Documentos_Arr.Campo_Ruta_Documento].ToString())));
            }
            else if (Dr_Renglon_Actual[Ope_Cat_Documentos_Arr.Campo_Documento].ToString().Trim() == "ANEXO_2")
            {
                Ruta_Archivo = Server.MapPath(Dr_Renglon_Actual[Ope_Cat_Documentos_Arr.Campo_Ruta_Documento].ToString());
                if (File.Exists(Ruta_Archivo))
                    Dr_Avaluo["ANEXO_2"] = Convertir_Imagen_A_Cadena_Bytes(System.Drawing.Image.FromFile(Server.MapPath(Dr_Renglon_Actual[Ope_Cat_Documentos_Arr.Campo_Ruta_Documento].ToString()))); ;
            }
        }
    ...
    private void Enviar_Correo_Cuenta(String E_Mail, String Url_Adjunto)
    {
        ...
        try
        {
            if (E_Mail.Trim().Length > 0)
            {
                ...
                mail.P_Subject = "Avalúo Rústico Autorizado: " + Txt_No_Avaluo.Text;
    ...
    ///CAUSA_MODIFICACIÓN
    ///*******************************************************************************
    protected void Grid_Avaluos_Urbanos_Regularizacion_PageIndexChanging(object sender, GridViewPageEventArgs e)
    {
    ...
    ///CAUSA_MODIFICACIÓN:
    ///*******************************************************************************
    protected void Grid_Avaluos_Urbanos_Regularizacion_SelectedIndexChanged(object sender, EventArgs e)
    {
        if (Grid_Avaluos_Urbanos_Regularizacion.SelectedIndex > -1)
        {
            Cls_Cat_Cat_Parametros_Negocio Par = new Cls_Cat_Cat_Parametros_Negocio();
            ...
            DataTable Dt_Avaluo;
            Hdf_Anio_Avaluo.Value = Grid_Avaluos_Urbanos_Regularizacion.SelectedRow.Cells[2].Text;
            Hdf_No_Avaluo.Value = Grid_Avaluos_Urbanos_Regularizacion.SelectedRow.Cells[1].Text;
            Cls_Ope_Cat_Avaluo_Rustico_Regularizacion_Negocio Aval_Urb = new Cls_Ope_Cat_Avaluo_Rustico_Regularizacion_Negocio();
            Aval_Urb.P_No_Avaluo = Hdf_No_Avaluo.Value;
            Aval_Urb.P_Anio_Avaluo = Hdf_Anio_Avaluo.Value;
            Session["Dt_Tabla_Valores_Construccion"] = Aval_Urb.Consultar_Tabla_Valores_Construccion_Regularizacion();
            Dt_Avaluo = Aval_Urb.Consultar_Avaluo_Rustico_Regularizacion();
            ...
            Dt_Motivos_Rechazo = Aval_Urb.Consultar_Motivos_Rechazo_Avaluo_Regularizacion();
            Session["Dt_Motivos_Rechazo"] = Dt_Motivos_Rechazo.Copy();
           
            if (Cmb_Estatus.SelectedItem.Text == "AUTORIZADO")
            {
            ...
            foreach (DataRow Dr_Renglon_Actual in Dt_Tramites.Rows)
            {
                ...
                {
                    Txt_Motivo_Regularizacion.Text = Dr_Renglon_Actual["MOTIVO_REGULARIZACION"].ToString();
    ...
    ///DESCRIPCIÓN: Carga los datos de una avaluo seleccionado en en grid
    ///PROPIEDADES:     
    ///            
    ///CREO: Miguel Angel Bedolla Moreno
    ///FECHA_CREO: 23/May/2012
    ...
    private void Cargar_Datos_Avaluo(DataTable Dt_Avaluo)
    {
        ...
        {
            Hdf_No_Avaluo.Value = Dt_Avaluo.Rows[0][Ope_Cat_Avaluo_Rustico_R.Campo_No_Avaluo].ToString();
            Hdf_Anio_Avaluo.Value = Dt_Avaluo.Rows[0][Ope_Cat_Avaluo_Rustico_R.Campo_Anio_Avaluo].ToString();
            Hdf_Cuenta_Predial_Id.Value = Dt_Avaluo.Rows[0][Ope_Cat_Avaluo_Rustico_R.Campo_Cuenta_Predial_Id].ToString();
            Cmb_Motivo_Avaluo.SelectedIndex = Cmb_Motivo_Avaluo.Items.IndexOf(Cmb_Motivo_Avaluo.Items.FindByValue(HttpUtility.HtmlDecode(Dt_Avaluo.Rows[0][Ope_Cat_Avaluo_Rustico_R.Campo_Motivo_Avaluo_Id].ToString())));
            Txt_No_Avaluo.Text = Dt_Avaluo.Rows[0]["AVALUO"].ToString();
            Txt_Cuenta_Predial.Text = Dt_Avaluo.Rows[0]["CUENTA_PREDIAL"].ToString();
            Txt_Clave_Catastral.Text = Dt_Avaluo.Rows[0][Ope_Cat_Avaluo_Rustico_R.Campo_Clave_Catastral].ToString();
            Txt_Propietario.Text = Dt_Avaluo.Rows[0][Ope_Cat_Avaluo_Rustico_R.Campo_Propietario].ToString();
            Cmb_Estatus.SelectedValue = Dt_Avaluo.Rows[0][Ope_Cat_Avaluo_Rustico_R.Campo_Estatus].ToString();
            Txt_Domicilio_Not.Text = Dt_Avaluo.Rows[0][Ope_Cat_Avaluo_Rustico_R.Campo_Domicilio_Notificacion].ToString();
            Txt_Municipio_Notificar.Text = Dt_Avaluo.Rows[0][Ope_Cat_Avaluo_Rustico_R.Campo_Municipio_Notificacion].ToString();
            Txt_Ubicacion_Predio.Text = Dt_Avaluo.Rows[0][Ope_Cat_Avaluo_Rustico_R.Campo_Ubicacion].ToString();
            Txt_Localidad.Text = Dt_Avaluo.Rows[0][Ope_Cat_Avaluo_Rustico_R.Campo_Localidad_Municipio].ToString();
            Txt_Fecha.Text = Convert.ToDateTime(Dt_Avaluo.Rows[0][Ope_Cat_Avaluo_Rustico_R.Campo_Fecha_Creo].ToString()).ToString("dd/MMM/yyyy");
            Txt_Solicitante.Text = Dt_Avaluo.Rows[0][Ope_Cat_Avaluo_Rustico_R.Campo_Solicitante].ToString();
            Txt_Nombre_Predio.Text = Dt_Avaluo.Rows[0][Ope_Cat_Avaluo_Rustico_R.Campo_Nombre_Predio].ToString();
            Txt_X_Horas.Text = Dt_Avaluo.Rows[0][Ope_Cat_Avaluo_Rustico_R.Campo_Coord_X_Grados].ToString();
            Txt_X_Minutos.Text = Dt_Avaluo.Rows[0][Ope_Cat_Avaluo_Rustico_R.Campo_Coord_X_Minutos].ToString();
            Txt_X_Segundos.Text = Dt_Avaluo.Rows[0][Ope_Cat_Avaluo_Rustico_R.Campo_Coord_X_Segundos].ToString();
            Txt_Uso_Constru.Text = Dt_Avaluo.Rows[0][Ope_Cat_Avaluo_Rustico_R.Campo_Uso_Constru].ToString().Trim();
            if (Dt_Avaluo.Rows[0][Ope_Cat_Avaluo_Rustico_R.Campo_Orientacion_X].ToString().Trim() != "")
            {
                Cmb_Latitud.SelectedValue = Dt_Avaluo.Rows[0][Ope_Cat_Avaluo_Rustico_R.Campo_Orientacion_X].ToString().Trim();
            }
            else
            {
                Cmb_Latitud.SelectedValue = "SELECCIONE";
            }
            Txt_Y_Horas.Text = Dt_Avaluo.Rows[0][Ope_Cat_Avaluo_Rustico_R.Campo_Coord_Y_Grados].ToString();
            Txt_Y_Minutos.Text = Dt_Avaluo.Rows[0][Ope_Cat_Avaluo_Rustico_R.Campo_Coord_Y_Minutos].ToString();
            Txt_Y_Segundos.Text = Dt_Avaluo.Rows[0][Ope_Cat_Avaluo_Rustico_R.Campo_Coord_Y_Segundos].ToString();
            if (Dt_Avaluo.Rows[0][Ope_Cat_Avaluo_Rustico_R.Campo_Orientacion_Y].ToString().Trim() != "")
            {
                Cmb_Longitud.SelectedValue = Dt_Avaluo.Rows[0][Ope_Cat_Avaluo_Rustico_R.Campo_Orientacion_Y].ToString().Trim();
            }
            else
            {
                Cmb_Longitud.SelectedValue = "SELECCIONE";
            }
            Txt_Coordenadas_UTM.Text = Dt_Avaluo.Rows[0][Ope_Cat_Avaluo_Rustico_R.Campo_Coordenadas_UTM].ToString().Trim();
            Txt_Coordenadas_UTM_Y.Text = Dt_Avaluo.Rows[0][Ope_Cat_Avaluo_Rustico_R.Campo_Coordenadas_UTM_Y].ToString().Trim();
            if (Dt_Avaluo.Rows[0][Ope_Cat_Avaluo_Rustico_R.Campo_Tipo].ToString().Trim() == "")
            {
                Cmb_Coordenadas.SelectedIndex = 0;
            }
            else
            ...
            Txt_Observaciones.Text = Dt_Avaluo.Rows[0][Ope_Cat_Avaluo_Rustico_R.Campo_Observaciones].ToString();
           
            Txt_Valor_Total_Predio.Text = Convert.ToDouble(Dt_Avaluo.Rows[0][Ope_Cat_Avaluo_Rustico_R.Campo_Valor_Total_Predio].ToString()).ToString("#,###,###,###,###,###,###,##0.00");
           


            Hdf_Solicitud_Id.Value = Dt_Avaluo.Rows[0][Ope_Cat_Avaluo_Rustico_R.Campo_Solicitud_Id].ToString();
            ...
            Oficios.P_No_Oficio = Dt_Avaluo.Rows[0][Ope_Cat_Avaluo_Urbano_Re.Campo_No_Oficio].ToString();
            Dt_Oficios = Oficios.Consultar_Oficios_Avaluos();
            if (Dt_Oficios.Rows.Count > 0)
            {
                Txt_Oficio.Text = Dt_Oficios.Rows[0][Ope_Cat_Recepcion_Oficios.Campo_No_Oficio_Recepcion].ToString();
            }
            else
            {
                Txt_Oficio.Text = "";
    ...
    ///DESCRIPCIÓN:Evento de la caja de texto de cuanta predial
    ///PROPIEDADES:     
    ///            
    ///CREO: Miguel Angel Bedolla Moreno
    ///FECHA_CREO: 23/May/2012
    ...
    ///DESCRIPCIÓN:Establece formato al los vaores con cierto numero de decimales
    ///PROPIEDADES:     
    ///            
    ///CREO: Miguel Angel Bedolla Moreno
    ///FECHA_CREO: 23/May/2012
    ...
    ///DESCRIPCIÓN: Asigna los valores del Grid
    ///PARAMETROS: 
    ///CREO: Miguel Angel Bedolla Moreno
    ///FECHA_CREO: 24/May/2012
    ///MODIFICO: 
    ...
    ///DESCRIPCIÓN: Guarda las descripciones de terrenos
    ///PARAMETROS: 
    ///CREO: Miguel Angel Bedolla Moreno
    ///FECHA_CREO: 24/May/2012
    ///MODIFICO: 
    ...
    ///DESCRIPCIÓN: Asigna las referencias de el grid de Descripcion de terrenos
    ///PARAMETROS: 
    ///CREO: Miguel Angel Bedolla Moreno
    ///FECHA_CREO: 24/May/2012
    ///MODIFICO: 
    ...
    ///DESCRIPCIÓN: Realiza los calculos para obtener los valores de la construccion
    ///PARAMETROS: 
    ///CREO: Miguel Angel Bedolla Moreno
    ///FECHA_CREO: 23/May/2012
    ///MODIFICO: 
    ...
    private Boolean Validar_Componentes()
    {
        ...
        if (Txt_Uso_Constru.Text.Trim() == "")
        {
            Msj_Error += "<br/>";
            Msj_Error += "+ Ingrese el Uso de la construcción.";
            Valido = false;
        }
        ...
        if (Grid_Colindancias.Rows.Count == 0)
        {
            Msj_Error += "<br/>";
            Msj_Error += "+ Ingrese las Medidas y Colindancias.";
            Valido = false;
        }
    ...
    private void Crear_Dt_Calculos()
    {
        ...
        Cls_Ope_Cat_Avaluo_Rustico_Regularizacion_Negocio avaluo = new Cls_Ope_Cat_Avaluo_Rustico_Regularizacion_Negocio();
        avaluo.P_Anio_Avaluo = DateTime.Now.Year.ToString();
        Dt_Calculos = avaluo.Consultar_Tabla_Terreno_Regularizacion();
    ...
    private void Calcular_Precio_Avaluo()
    {
        ...
        Precio_Avaluo = (Importe_Terreno + (Construccion * Factor));
    ...
    protected void Btn_Salir_Click(object sender, ImageClickEventArgs e)
    {
        ...
        else
        {
            ...
            Configuracion_Formulario(true);
            Llenar_Tabla_Avaluos_Urbanos(Grid_Avaluos_Urbanos_Regularizacion.PageIndex);
            Btn_Salir.AlternateText = "Salir";
            Btn_Salir.ImageUrl = "~/paginas/imagenes/paginas/icono_salir.png";
            Grid_Avaluos_Urbanos_Regularizacion.SelectedIndex = -1;
    ...
    protected void Guardar_Grid_Valores_Construccion()
    {
        ...
        for (int i = 0; i < Dt_Valores_Construccion.Rows.Count; i++)
        {
            ...
            Dt_Valores_Construccion.Rows[i]["EDAD_CONSTRU"] = Txt_Edad.Text.ToUpper();
    ...
    protected void Grid_Solicitudes_SelectedIndexChanged(object sender, EventArgs e)
    {
        if (Grid_Solicitudes.SelectedIndex > -1)
        {
            ...
            if (Grid_Solicitudes.SelectedRow.Cells[2].Text != "&nbsp;" && Grid_Solicitudes.SelectedRow.Cells[2].Text != "")
            {
                ...
                Txt_Solicitante.Text = Grid_Solicitudes.SelectedRow.Cells[3].Text;
                Txt_Cuenta_Predial.Text = Grid_Solicitudes.SelectedRow.Cells[5].Text;
                Txt_Motivo_Regularizacion.Text = Grid_Solicitudes.SelectedRow.Cells[6].Text;
    ...
    ///DESCRIPCIÓN: muestra la consulta de todas las solicitudes existentes
    ///PROPIEDADES:     
    ///            
    ///CREO: Miguel Angel Bedolla Moreno
    ///FECHA_CREO: 05/May_2012
    ...
    ///*******************************************************************************
    ///NOMBRE DE LA FUNCIÓN: Llenar_Tabla_Solicitudes
    ///DESCRIPCIÓN: Realiza el llenado de todos los Campos del grid
    ///PROPIEDADES:   
    ///            
    ///CREO: Miguel Angel Bedolla Moreno
    ///FECHA_CREO: 05/May_2012
    ...
    private void Llenar_Tabla_Solicitudes(int Pagina)
    {
        try
        {
            Cls_Ope_Cat_Avaluo_Rustico_Regularizacion_Negocio Solicitud_Tramite = new Cls_Ope_Cat_Avaluo_Rustico_Regularizacion_Negocio();
               DataTable Dt_Tramites=new DataTable();;
    ...
    ///DESCRIPCIÓN: Cierra la ventana modal
    ///PROPIEDADES:     
    ///            
    ///CREO: Miguel Angel Bedolla Moreno
    ///FECHA_CREO: 05/May_2012
    ...
    ///DESCRIPCIÓN: Crea la referencia de la tabla Construccion Dominante
    ///PROPIEDADES:     
    ///            
    ///CREO: Miguel Angel Bedolla Moreno
    ///FECHA_CREO: 05/May_2012
    ...
    ///DESCRIPCIÓN: Evento del combo de coordenadas
    ///PROPIEDADES:     
    ///            
    ///CREO: Miguel Angel Bedolla Moreno
    ///FECHA_CREO: 05/May_2012
    ...
    ///DESCRIPCIÓN: Evento de Caja de texto
    ///PROPIEDADES:     
    ///            
    ///CREO: Miguel Angel Bedolla Moreno
    ///FECHA_CREO: 05/May_2012
    ...
    ///DESCRIPCIÓN: Realiza la agregacion de las medidas de colindancia al grid
    ///PARAMETROS: 
    ///CREO: Miguel Angel Bedolla Moreno
    ///FECHA_CREO: 23/May/2012
    ///MODIFICO: 
    ...
    protected void Btn_Agregar_Med_Col_Click(object sender, ImageClickEventArgs e)
    {
        if (Txt_Medida_Colindancia.Text.Trim() != "")
        {
            ...
            foreach (DataRow Dr_Renglon in Dt_Medidas.Rows)
            {
                if (Dr_Renglon[Ope_Cat_Colindancias_Arr.Campo_Medida_Colindancia].ToString() == Txt_Medida_Colindancia.Text.ToUpper() && Dr_Renglon["ACCION"].ToString() != "BAJA")
                {
                    Entro = true;
                    break;
                }
            ...
            if (!Entro)
            {
                ...
                Dr_Nuevo[Ope_Cat_Colindancias_Arr.Campo_No_Colindancia] = " ";
                Dr_Nuevo["ACCION"] = "ALTA";
                Dr_Nuevo[Ope_Cat_Colindancias_Arr.Campo_Medida_Colindancia] = Txt_Medida_Colindancia.Text.ToUpper();
    ...
    ///DESCRIPCIÓN: Establece la paginacion del Grid para ver la pagina q el usuario selecciones
    ///PARAMETROS: 
    ///CREO: Miguel Angel Bedolla Moreno
    ///FECHA_CREO: 23/May/2012
    ///MODIFICO: 
    ...
    ///DESCRIPCIÓN: Realiza la consulta de los valores de la fila seleccionada
    ///PARAMETROS: 
    ///CREO: Miguel Angel Bedolla Moreno
    ///FECHA_CREO: 23/May/2012
    ///MODIFICO: 
    ...
    {
        if (!Directory.Exists(Server.MapPath("../Catastro/Archivos_Avaluo_Arr/" + Hdf_Anio_Avaluo.Value + "_" + Hdf_No_Avaluo.Value + "/")))
        {
            Directory.CreateDirectory(Server.MapPath("../Catastro/Archivos_Arr/" + Hdf_Anio_Avaluo.Value + "_" + Hdf_No_Avaluo.Value + "/"));
        }
        foreach (DataRow Dr_Renglon in Dt_Documentos.Rows)
        {
            if (Dr_Renglon["ACCION"].ToString() == "ALTA")
            {
                ...
                FileStream Escribir_Archivo = new FileStream(Server.MapPath("../Catastro/Archivos_Arr/" + Hdf_Anio_Avaluo.Value + "_" + Hdf_No_Avaluo.Value + "/" + Dr_Renglon["RUTA_DOCUMENTO"].ToString()), FileMode.Create, FileAccess.Write);
    ...
    ///*******************************************************************************
    ///NOMBRE DE LA FUNCIÓN: Bt_Autorizar_Click
    ///DESCRIPCIÓN: Realiza la modificacion del estado del avaluo
    ///PROPIEDADES:     
    ///            
    ///CREO: Miguel Angel Bedolla Moreno
    ///FECHA_CREO: 05/May_2012
    ...
    protected void Bt_Autorizar_Click(object sender, ImageClickEventArgs e)
    {
        try
        {
            if (Grid_Avaluos_Urbanos_Regularizacion.SelectedIndex > -1)
            {
                ...
                Avaluo.P_Anio_Avaluo = Hdf_Anio_Avaluo.Value;
                Avaluo.P_Estatus = "AUTORIZADO";
                Avaluo.P_Importe_Avaluo = Convert.ToDouble(Txt_Precio_Avaluo.Text.Trim()).ToString();
                Avaluo.P_Solicitud_Id = Hdf_Solicitud_Id.Value;
                if (Chk_Pago_Avaluo.Checked)
                {
                    Avaluo.P_Generar_Cobro = "SI";
                }
                else
                {
                    Avaluo.P_Generar_Cobro = "NO";
                }
                if ((Avaluo.Modificar_Estatus_Avaluo_Rustico_Regularizacion()))
                {
                    if (Chk_Pago_Avaluo.Checked)
                    {
                        Imprimir_Reporte_Folio(Crear_Ds_Avaluo_Urbano_Folio(), "Rpt_Ope_Cat_Folio_Pago_Avaluo_Rustico.rpt", "Rpt_Folio_Pago_Avaluo_Rustico", "Window_Frm", "Avaluo");
                    }
    ...
    ///DESCRIPCIÓN: Realiza la busqueda de los propietarios en base a cuenta predial
    ///PARAMETROS: 
    ///CREO: jtoledo
    ///FECHA_CREO: 03/Ago/2011 06:31:08 p.m.
    ///MODIFICO: 
    ...
    ///DESCRIPCIÓN: Carga los datos de los propietarios en base a cuenta predial
    ///PARAMETROS: 
    ///CREO: jtoledo
    ///FECHA_CREO: 03/Ago/2011 06:31:08 p.m.
    ///MODIFICO: 
    ...
    ///DESCRIPCIÓN: Realiza la busqueda de las cuentas predial
    ///PARAMETROS: 
    ///CREO: jtoledo
    ///FECHA_CREO: 03/Ago/2011 06:31:08 p.m.
    ///MODIFICO: 
    ...
    ///CAUSA_MODIFICACIÓN:
    ///*******************************************************************************
    private DataSet Crear_Ds_Avaluo_Urbano_Folio()
    {
        Cls_Ope_Cat_Avaluo_Rustico_Regularizacion_Negocio Avaluo = new Cls_Ope_Cat_Avaluo_Rustico_Regularizacion_Negocio();
        Cls_Cat_Cat_Peritos_Externos_Negocio Perito_Interno = new Cls_Cat_Cat_Peritos_Externos_Negocio();
        Ds_Ope_Cat_Folio_Pago_Avaluo_Rustico Folio_Avaluo = new Ds_Ope_Cat_Folio_Pago_Avaluo_Rustico();
        ...
        String Folio = Obtener_Dato_Consulta("SELECT " + Ope_Tra_Solicitud.Campo_Clave_Solicitud + " FROM " + Ope_Tra_Solicitud.Tabla_Ope_Tra_Solicitud + " WHERE " + Ope_Tra_Solicitud.Campo_Solicitud_ID + " = '" + Hdf_Solicitud_Id.Value + "'");
        String Nombre_Perito = Obtener_Dato_Consulta("SELECT " + Cat_Cat_Peritos_Externos.Campo_Nombre + "||' '||" + Cat_Cat_Peritos_Externos.Campo_Apellido_Paterno + "||' '||" + Cat_Cat_Peritos_Externos.Campo_Apellido_Materno + " FROM " + Cat_Cat_Peritos_Externos.Tabla_Cat_Cat_Peritos_Externos + " WHERE " + Cat_Cat_Peritos_Externos.Campo_Perito_Externo_Id + " = '" + Perito_Id + "'").ToUpper();
        String E_Mail = Obtener_Dato_Consulta("SELECT " + Cat_Cat_Peritos_Externos.Campo_Usuario + " FROM " + Cat_Cat_Peritos_Externos.Tabla_Cat_Cat_Peritos_Externos + " WHERE " + Cat_Cat_Peritos_Externos.Campo_Perito_Externo_Id + " = '" + Perito_Id + "'");
        String Rfc = Obtener_Dato_Consulta("SELECT " + Cat_Cat_Peritos_Externos.Campo_Observaciones + " FROM " + Cat_Cat_Peritos_Externos.Tabla_Cat_Cat_Peritos_Externos + " WHERE " + Cat_Cat_Peritos_Externos.Campo_Perito_Externo_Id + " = '" + Perito_Id + "'");
        DataTable Dt_Folio_Avaluo = Folio_Avaluo.Tables["Dt_Folio"];
        DataRow Dr_Renglon_Nuevo = Dt_Folio_Avaluo.NewRow();
        Dr_Renglon_Nuevo["NOMBRE"] = Nombre_Perito;
        Dr_Renglon_Nuevo["RFC"] = Rfc;
        Dr_Renglon_Nuevo["PERITO_EXTERNO_ID"] = Convert.ToInt16(Perito_Id).ToString();
        Dr_Renglon_Nuevo["FOLIO"] = Folio;
    ...
    ///CAUSA_MODIFICACIÓN:
    ///*******************************************************************************
    private void Imprimir_Reporte_Folio(DataSet Ds_Convenios, String Nombre_Reporte, String Nombre_Archivo, String Formato, String Tipo)
    {
        ReportDocument Reporte = new ReportDocument();
        String File_Path = Server.MapPath("../Rpt/Catastro/" + Nombre_Reporte);
        try
