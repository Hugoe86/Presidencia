<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Ope_Cat_Segunda_Revision_Avaluo_Urbano.aspx.cs"
    Inherits="paginas_Catastro_Ope_Cat_Segunda_Revision_Avaluo_Urbano" MasterPageFile="~/paginas/Paginas_Generales/MasterPage.master"
    Title="Segunda Revisión: Avalúo Urbano" %>
                    ...
                    <table width="98%" border="0" cellspacing="0" class="estilo_fuente">
                        <tr align="center">
                            <td colspan="4" class="label_titulo">
                                Seguimiento: Aval&uacute;os Urbanos
                            </td>
                        </tr>
                        <tr>
                            <td class="style1">
                        ...
                        <tr class="barra_busqueda" align="right">
                            <td colspan="3" align="left">
                                ...
                                <asp:ImageButton ID="Btn_Imprimir" runat="server" TabIndex="3" ImageUrl="~/paginas/imagenes/gridview/grid_print.png"
                                    Width="24px" CssClass="Img_Button" AlternateText="Imprimir" OnClick="Btn_Imprimir_Click" Visible="false" />
