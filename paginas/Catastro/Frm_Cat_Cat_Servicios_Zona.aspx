<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/paginas/Paginas_Generales/MasterPage.master" CodeFile="Frm_Cat_Cat_Servicios_Zona.aspx.cs" Inherits="paginas_Catastro_Frm_Cat_Cat_Servicios_Zona" Title="Catálogo de Servicios de Zona"%>
                ...
                <table width="98%" class="estilo_fuente">
                    <tr>
                        ...
                        <td style="width:30%; text-align:left;">
                            <asp:TextBox  runat="server" ID="Txt_Servicio"  Width="98%" TabIndex="6" 
                                Style="float: left; text-transform:uppercase" MaxLength="30"/>
                        </td>
                        <td style="text-align:left;width:20%;">
                        *Estatus
                    </td>
                    ...
                    <tr>
                    <td>
                    <asp:HiddenField ID="Hdf_Servicio_Zona_Id" runat="server" />
                    </td>
                    </tr>
                    <tr>
                    <td colspan="4">
                    ...
                    <tr>
                        <td style="text-align:left;">
                            <asp:GridView ID="Grid_Servicios_Zona" runat="server" AllowSorting="true"
                                AutoGenerateColumns="False" CssClass="GridView_1" 
                                HeaderStyle-CssClass="tblHead" style="white-space:normal;" Width="100%" 
                                onpageindexchanging="Grid_Servicios_Zona_PageIndexChanging" 
                                onselectedindexchanged="Grid_Servicios_Zona_SelectedIndexChanged" PageSize="10" AllowPaging="true">
                                <Columns>
                                    <asp:ButtonField ButtonType="Image" CommandName="Select" 
                                        ImageUrl="~/paginas/imagenes/paginas/Select_Grid_Inner.png" Text="Button">
                                        <HeaderStyle Width="5%" />
                                    </asp:ButtonField>
                                    <asp:BoundField DataField="SERVICIOS_ZONA_ID" HeaderText="Id" Visible="false">
                                        <ItemStyle HorizontalAlign="Center" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="SERVICIOS_ZONA" HeaderText="Servicios de Zona">
