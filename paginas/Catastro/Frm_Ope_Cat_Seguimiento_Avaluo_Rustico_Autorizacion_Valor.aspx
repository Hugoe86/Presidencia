<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Frm_Ope_Cat_Seguimiento_Avaluo_Rustico_Autorizacion_Valor.aspx.cs" Inherits="paginas_Catastro_Frm_Ope_Cat_Seguimiento_Avaluo_Rustico_Autorizacion_Valor" 
MasterPageFile="~/paginas/Paginas_Generales/MasterPage.master" Title="Seguimiento Avalúo Rústico Actualización de Valor" %>
                ...
                <table width="98%" border="0" cellspacing="0" class="estilo_fuente">
                    <tr align="center">
                        <td colspan="4" class="label_titulo">
                           Seguimiento Aval&uacute;os Rústico
                        </td>
                    </tr>
                    <tr>
                        <td class="style1">
                ...
                <center>
                    ...
                    <tr>
                        <td style="text-align:left;width:20%;">
                            *Cuenta Predial</td>
                        <td style="text-align:left;width:30%;">
                            <asp:TextBox ID="Txt_Cuenta_Predial" runat="server" Width="83%" 
                                TabIndex="8" Enabled="false" style="text-transform:uppercase">
                            </asp:TextBox>
                        ...
                        <td style="text-align:left;width:20%;text-align:Left;">
                            Clave Catastral</td>
                        <td style="text-align:left;width:30%;">
                            <asp:TextBox ID="Txt_Clave_Catastral" Enable="false" runat="server" Width="50%" TabIndex="9" Enabled="false"  style="text-transform:uppercase" MaxLength="20"/>
                    ...
                    <tr>
                        ...
                        <td style="text-align:left;width:20%;text-align:Left;">
                            *Municipio</td>
                        <td style="text-align:left;width:30%;">
                            <asp:TextBox ID="Txt_Municipio_Notificar" runat="server" Width="96.4%" TabIndex="19" Enabled="false" style="text-transform:uppercase" MaxLength="100"/>
                        </td>
                    </tr>
                    <tr>
                        <td style="text-align:left;width:20%;">
                    ...
                    <tr>
                        ...
                        <td style="text-align:left;width:20%;text-align:Left;">
                            *Fecha</td>
                        <td style="text-align:left;width:30%;">
                            <asp:TextBox ID="Txt_Fecha" runat="server" Enabled="false" Width="96.4%" TabIndex="15"  style="text-transform:uppercase"/>
                        </td>
                    </tr>
                    <tr>
                        <td style="text-align:left;width:20%;">
                                        ...
                                        <tr>
                                         ...
                                         <tr>
                                            ...
                                            <td style="text-align: left; width: 80%;" colspan="3">
                                                <asp:TextBox ID="Txt_Uso_Constru" runat="server" Enabled="false" TextMode="MultiLine" Rows="3"
                                Width="99%" style="text-transform:uppercase"></asp:TextBox>
                                            </td>
                                        </tr>
                                         <tr style="background-color: #3366CC">
                    ...
                    <tr >
                        ...
                        <td style="text-align:left;width:30%;">
                            <asp:DropDownList ID="Cmb_Coordenadas" runat="server" Width="96.4%" TabIndex="10" Enabled="false" OnSelectedIndexChanged="Cmb_Coordenadas_SelectedIndexChanged" AutoPostBack="true">
                   ...
                   <tr>
                        ...
                        <td style="text-align: left;width:30% ;">
                            <asp:TextBox ID="Txt_X_Horas" runat="server" Width="96.4%" style="text-transform:uppercase" Enabled="false" MaxLength="3" TabIndex="7"/>
                        ...
                        <td style="text-align:left;width:30%;">
                            <asp:TextBox ID="Txt_X_Minutos" Enabled="false" runat="server" Width="96.4%" style="text-transform:uppercase" MaxLength="3" TabIndex="8"/>
                        ...
                        <td style="text-align:left;width:30%;">
                            <asp:TextBox ID="Txt_X_Segundos" Enabled="false" runat="server" Width="96.4%" style="text-transform:uppercase" MaxLength="6" TabIndex="9" OnTextChanged="Txt_X_Segundos_TextChanged" AutoPostBack="true"/>
                   ...
                   <td style="text-align: left;width:20% ;">
                        ...
                        <td style="text-align: left;width:30%;">
                            <asp:TextBox ID="Txt_Y_Horas" Enabled="false" runat="server" Width="96.4%" style="text-transform:uppercase" MaxLength="3" TabIndex="10"/>
                        ...
                        <td style="text-align:left;width:30%;">
                            <asp:TextBox ID="Txt_Y_Minutos" Enabled="false" runat="server" Width="96.4%" style="text-transform:uppercase" MaxLength="3" TabIndex="11"/>
                    ...
                    <tr style="background-color: #3366CC">
                                ...
                                <tr>
                                    <td colspan="4" style="text-align:center;">
                                        <asp:GridView ID="Grid_Elementos_Construccion" runat="server" AllowPaging="False" AllowSorting="True" AutoGenerateColumns="False" 
                                            CssClass="GridView_1" EmptyDataText="&quot;No se encontraron registros&quot;" HeaderStyle-CssClass="tblHead" 
                                            OnDataBound="Grid_Elementos_Construccion_DataBound" PageSize="18" style="white-space:normal;" Width="100%">
                                            <Columns>
