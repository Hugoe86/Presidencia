<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Frm_Cat_Cat_Calidad_Construccion.aspx.cs"
    MasterPageFile="~/paginas/Paginas_Generales/MasterPage.master" Inherits="paginas_Catastro_Frm_Cat_Cat_Calidad_Construccion"
    Title="Catálogo de Calidad de Construcción" %>
                ...
                <table width="100%" class="estilo_fuente">
                    <tr align="center">
                        <td class="label_titulo">
                            Catálogo de Calidad de Construcción
                        </td>
                    </tr>
                    <tr>
                        <td>
                ...
                <table width="98%" class="estilo_fuente">
                    ...
                    <td style="text-align: left; width: 20%;">
                        ...
                        <td style="width: 30%; text-align: left;">
                            <asp:DropDownList ID="Cmb_Tipos_Construccion" runat="server" Width="98%">
                            </asp:DropDownList>
                        </td>
                        <td style="text-align: left; width: 20%;">
                            *Calidad
                        ...
                        <td style="width: 30%; text-align: left;">
                            <asp:TextBox runat="server" ID="Txt_Calidad" Width="96.4%"
                                Style="float: left; text-transform: uppercase" MaxLength="50"/>
                            <asp:HiddenField ID="Hdf_Calidad_Id" runat="server" />
                        </td>
                    </tr>
                    <tr>
                        <td style="text-align: left; width: 20%;">
                        ...
                        <td style="width: 30%;text-align: left;">
                            <asp:TextBox runat="server" ID="Txt_Clave_Calidad" Width="96.4%" Style="float: left;
                                text-transform: uppercase" MaxLength="3"/>
                                <cc1:FilteredTextBoxExtender ID="FTB_Txt_Clave_Calidad" runat="server" FilterType="Numbers" TargetControlID="Txt_Clave_Calidad" />
                        </td>
                        <td style="text-align: left; width: 20%;">
                        </td>
                        <td style="width: 30%; text-align:left;">
