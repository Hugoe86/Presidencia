<%@ Page Language="C#" AutoEventWireup="true" Culture="es-MX" CodeFile="Frm_Ope_Cat_Recepcion_Documentos_Perito_externo.aspx.cs" 
Inherits="paginas_Catastro_Frm_Ope_Cat_Recepcion_Documentos_Perito_externo" MasterPageFile="~/paginas/Paginas_Generales/MasterPage_Ventanilla.master"%>
            ...
            <div id="Div_Contenido" style="background-color: #ffffff; width: 100%; height: 100%;">
                ...
                <div id="Div_Grid_Datos_Peritos" runat="server" visible="true">
                      ...
                      <tr>
                        ...
                        <td style="text-align:left;width:30%;">
                            <asp:TextBox ID="Txt_Nombre" runat="server" Width="98%" 
                                TabIndex="3" Enabled="false" MaxLength="50" style="text-transform:uppercase"></asp:TextBox>
                        </td>
                        <td style="text-align:left;width:20%;text-align:left;">
                            *Apellido Paterno
                        </td>
                        <td style="text-align:left;width:30%;">
                            <asp:TextBox ID="Txt_Apellido_Paterno" runat="server" 
                                Width="98%" TabIndex="4" Enabled="false"  MaxLength="50" style="text-transform:uppercase"/>
                        </td>
                    ...
                    <tr>
                        ...
                        <td style="text-align:left;width:30%;">
                            <asp:TextBox ID="Txt_Apellido_Materno" runat="server" Width="98%" 
                                TabIndex="5" Enabled="false"  MaxLength="50" style="text-transform:uppercase"></asp:TextBox>
                        </td>
                        <td style="text-align:left;width:20%; vertical-align:top;">
                            *Correo Electronico
                        </td>
                        <td style="text-align:left;width:30%;">
                            <asp:TextBox ID="Txt_E_Mail" runat="server" TabIndex="6"
                    ...
                    <tr>
                        ...
                        <td style="text-align:left;width:30%;">
                            <asp:TextBox ID="Txt_Calle" runat="server" Width="98%" 
                                TabIndex="7" Enabled="false"  MaxLength="50" style="text-transform:uppercase"></asp:TextBox>
                        </td>
                        <td style="text-align:left;width:20%;text-align:left;">
                            *Colonia
                        </td>
                        <td style="text-align:left;width:30%;">
                            <asp:TextBox ID="Txt_Colonia" runat="server" Width="98%" TabIndex="8" Enabled="false"  MaxLength="50" style="text-transform:uppercase"/>
                        </td>
                    </tr>
                    <tr>
                        <td style="text-align:left;width:20%;text-align:left;">
                        ...
                        <td style="text-align:left;width:30%;">
                            <asp:TextBox ID="Txt_Ciudad" runat="server" Width="98%" TabIndex="9" Enabled="false"  MaxLength="20" style="text-transform:uppercase"/>
                        </td>
                        <td style="text-align:left;width:20%;text-align:left;">
                            *Estado
                        </td>
                        <td style="text-align:left;width:30%;">
                            <asp:TextBox ID="Txt_Estado" runat="server" Width="98%" TabIndex="10" Enabled="false"  MaxLength="20" style="text-transform:uppercase"/>
                        </td>
                    </tr>
                    <tr>
                        <td style="text-align:left;width:20%; vertical-align:top;">
                        ...
                        <td style="text-align:left;width:30%;">
                            <asp:TextBox ID="Txt_Telefono" runat="server" TabIndex="11" MaxLength="10"
                        ...
                        <td style="text-align:left;width:30%;">
                            <asp:TextBox ID="Txt_Celular" runat="server" TabIndex="12" MaxLength="10"
                                Width="98%" style="text-transform:uppercase;"  Enabled="false"/>
                    ...
                    <tr>
                        ...
                        <td style="text-align:left;width:30%;">
                            <asp:DropDownList ID="Cmb_Estatus" runat="server" Width="98%" TabIndex="13" Enabled="false">
                        ...
                        <td style="text-align:left;width:30%;" >
                            <asp:TextBox ID="Txt_Fecha" runat="server" Width="98%" Enabled="false"/>
                        </td>
                    </tr>
                    <tr>
                        <td style="text-align:left;width:20%; vertical-align:top;">
                        ...
                        <td style="text-align:left;width:30%;">
                            <asp:TextBox ID="Txt_Solicitud_Id" runat="server" TabIndex="15" MaxLength="15"
                                Width="98%" style="text-transform:uppercase;"  Enabled="false" />
                        </td>--%>
                   </tr>  
                    <tr> 
                        ...
                        <td colspan="3" style="text-align:left;width:30%;">
                            <asp:TextBox ID="Txt_Informacion" runat="server" TabIndex="16" MaxLength="250"
                                Width="99%" style="text-transform:uppercase;"  Enabled="false" Rows="3" TextMode="MultiLine"/>
                        </td>        
                    </tr>
                    </table>
                    </div>
                    ...
                    <table width="98%" class="estilo_fuente">
                        ...
                        <tr ID="Tr_Fila_Fotografias_Bien" runat="server" >
                            ...
                            <td style="text-align: left; width:30%" class="style1" >
                                <asp:TextBox ID="Txt_Nombre_Documento" runat="server"  Width="98%" TabIndex="17"/>
                            </td>
                            <td style="text-align: left; width:20%" class="style2">
                                Documento
                            </td>
                            <td style="width:30%" class="style2">
                                <asp:FileUpload ID="Fup_Documento" runat="server" Width="98%" TabIndex="18"/>
                            </td>
                         </tr>
                         <tr>
                            <td></td>
                            ...
                            <td colspan="4" style="text-align: left; width: 20%;">
                                <asp:GridView ID="Grid_Documentos" runat="server" AllowPaging="False" 
                                    ...
                                    <Columns>
                                        ...
                                        <%--<asp:BoundField DataField="RUTA_DOCUMENTO" HeaderText="Documento">
                                            <ItemStyle HorizontalAlign="Left" Width="40%"/>
                                        </asp:BoundField>--%>
                                        <asp:TemplateField>
                                             <ItemTemplate>
